...
const file_steammessages_parental_steamclient_proto_rawDesc = "" +
	"\n" +
	"(steammessages_parental.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\x1a$steammessages_parental_objects.proto\"\xd3\x01\n" +
	"(CParental_EnableParentalSettings_Request\x12\x1a\n" +
	"\bpassword\x18\x01 \x01(\tR\bpassword\x123\n" +
	"\bsettings\x18\x02 \x01(\v2\x17.steam.ParentalSettingsR\bsettings\x12\x1c\n" +
	...
	"\asteamid\x18\n" +
	" \x01(\x06R\asteamid\"]\n" +
	"&CParental_GetParentalSettings_Response\x123\n" +
	"\bsettings\x18\x01 \x01(\v2\x17.steam.ParentalSettingsR\bsettings\"I\n" +
	...
	"\bpassword\x18\x01 \x01(\tR\bpassword\x123\n" +
	"\bsettings\x18\x02 \x01(\v2\x17.steam.ParentalSettingsR\bsettings\x12!\n" +
	...
	"\asteamid\x18\n" +
	" \x01(\x06R\asteamid\")\n" +
	"'CParental_ApproveFeatureAccess_Response\"\xc0\x01\n" +
	"!CParental_RequestPlaytime_Request\x12!\n" +
	"\ftime_expires\x18\x01 \x01(\rR\vtimeExpires\x12^\n" +
	"\x1dcurrent_playtime_restrictions\x18\x02 \x01(\v2\x1a.steam.ParentalPlaytimeDayR\x1bcurrentPlaytimeRestrictions\x12\x18\n" +
	"\asteamid\x18\n" +
	" \x01(\x06R\asteamid\"B\n" +
	"\"CParental_RequestPlaytime_Response\x12\x1c\n" +
	"\trequestid\x18\x01 \x01(\x06R\trequestid\"\xd8\x01\n" +
	"!CParental_ApprovePlaytime_Request\x12\x18\n" +
	"\aapprove\x18\x01 \x01(\bR\aapprove\x12\x1c\n" +
	"\trequestid\x18\x02 \x01(\x06R\trequestid\x12a\n" +
	"\x15restrictions_approved\x18\x03 \x01(\v2,.steam.ParentalTemporaryPlaytimeRestrictionsR\x14restrictionsApproved\x12\x18\n" +
	"\asteamid\x18\n" +
	" \x01(\x06R\asteamid\"$\n" +
	...
	"\x0efamily_groupid\x18\x02 \x01(\x06R\rfamilyGroupid\"\xb7\x01\n" +
	"\x1eCParental_GetRequests_Response\x12H\n" +
	"\x10feature_requests\x18\x01 \x03(\v2\x1d.steam.ParentalFeatureRequestR\x0ffeatureRequests\x12K\n" +
	"\x11playtime_requests\x18\x02 \x03(\v2\x1e.steam.ParentalPlaytimeRequestR\x10playtimeRequests\"\x88\x01\n" +
	...
	"\vday_of_week\x18\x01 \x01(\rR\tdayOfWeek\x12!\n" +
	"\fminutes_used\x18\x02 \x01(\rR\vminutesUsed2\xaa\r\n" +
	"\bParental\x12{\n" +
	"\x16EnableParentalSettings\x12/.steam.CParental_EnableParentalSettings_Request\x1a0.steam.CParental_EnableParentalSettings_Response\x12~\n" +
	"\x17DisableParentalSettings\x120.steam.CParental_DisableParentalSettings_Request\x1a1.steam.CParental_DisableParentalSettings_Response\x12r\n" +
	"\x13GetParentalSettings\x12,.steam.CParental_GetParentalSettings_Request\x1a-.steam.CParental_GetParentalSettings_Response\x12\x84\x01\n" +
	"\x19GetSignedParentalSettings\x122.steam.CParental_GetSignedParentalSettings_Request\x1a3.steam.CParental_GetSignedParentalSettings_Response\x12r\n" +
	"\x13SetParentalSettings\x12,.steam.CParental_SetParentalSettings_Request\x1a-.steam.CParental_SetParentalSettings_Response\x12`\n" +
	"\rValidateToken\x12&.steam.CParental_ValidateToken_Request\x1a'.steam.CParental_ValidateToken_Response\x12i\n" +
	"\x10ValidatePassword\x12).steam.CParental_ValidatePassword_Request\x1a*.steam.CParental_ValidatePassword_Response\x12W\n" +
	"\n" +
	"LockClient\x12#.steam.CParental_LockClient_Request\x1a$.steam.CParental_LockClient_Response\x12r\n" +
	"\x13RequestRecoveryCode\x12,.steam.CParental_RequestRecoveryCode_Request\x1a-.steam.CParental_RequestRecoveryCode_Response\x12u\n" +
	"\x14RequestFeatureAccess\x12-.steam.CParental_RequestFeatureAccess_Request\x1a..steam.CParental_RequestFeatureAccess_Response\x12u\n" +
	"\x14ApproveFeatureAccess\x12-.steam.CParental_ApproveFeatureAccess_Request\x1a..steam.CParental_ApproveFeatureAccess_Response\x12f\n" +
	"\x0fRequestPlaytime\x12(.steam.CParental_RequestPlaytime_Request\x1a).steam.CParental_RequestPlaytime_Response\x12f\n" +
	"\x0fApprovePlaytime\x12(.steam.CParental_ApprovePlaytime_Request\x1a).steam.CParental_ApprovePlaytime_Response\x12Z\n" +
	"\vGetRequests\x12$.steam.CParental_GetRequests_Request\x1a%.steam.CParental_GetRequests_Response\x12~\n" +
	"\x17ReportPlaytimeAndNotify\x120.steam.CParental_ReportPlaytimeAndNotify_Request\x1a1.steam.CParental_ReportPlaytimeAndNotify_Response2\xea\x02\n" +
	"\x0eParentalClient\x12_\n" +
	"\x14NotifySettingsChange\x124.steam.CParental_ParentalSettingsChange_Notification\x1a\x11.steam.NoResponse\x12O\n" +
	"\fNotifyUnlock\x12,.steam.CParental_ParentalUnlock_Notification\x1a\x11.steam.NoResponse\x12K\n" +
	"\n" +
	"NotifyLock\x12*.steam.CParental_ParentalLock_Notification\x1a\x11.steam.NoResponse\x12S\n" +
	"\x12NotifyPlaytimeUsed\x12*.steam.CParental_PlaytimeUsed_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x02B3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_parental_steamclient_proto_goTypes = []any{
	(*CParental_EnableParentalSettings_Request)(nil),      // 0: steam.CParental_EnableParentalSettings_Request
	(*CParental_EnableParentalSettings_Response)(nil),     // 1: steam.CParental_EnableParentalSettings_Response
	(*CParental_DisableParentalSettings_Request)(nil),     // 2: steam.CParental_DisableParentalSettings_Request
	(*CParental_DisableParentalSettings_Response)(nil),    // 3: steam.CParental_DisableParentalSettings_Response
	(*CParental_GetParentalSettings_Request)(nil),         // 4: steam.CParental_GetParentalSettings_Request
	(*CParental_GetParentalSettings_Response)(nil),        // 5: steam.CParental_GetParentalSettings_Response
	(*CParental_GetSignedParentalSettings_Request)(nil),   // 6: steam.CParental_GetSignedParentalSettings_Request
	(*CParental_GetSignedParentalSettings_Response)(nil),  // 7: steam.CParental_GetSignedParentalSettings_Response
	(*CParental_SetParentalSettings_Request)(nil),         // 8: steam.CParental_SetParentalSettings_Request
	(*CParental_SetParentalSettings_Response)(nil),        // 9: steam.CParental_SetParentalSettings_Response
	(*CParental_ValidateToken_Request)(nil),               // 10: steam.CParental_ValidateToken_Request
	(*CParental_ValidateToken_Response)(nil),              // 11: steam.CParental_ValidateToken_Response
	(*CParental_ValidatePassword_Request)(nil),            // 12: steam.CParental_ValidatePassword_Request
	(*CParental_ValidatePassword_Response)(nil),           // 13: steam.CParental_ValidatePassword_Response
	(*CParental_LockClient_Request)(nil),                  // 14: steam.CParental_LockClient_Request
	(*CParental_LockClient_Response)(nil),                 // 15: steam.CParental_LockClient_Response
	(*CParental_RequestRecoveryCode_Request)(nil),         // 16: steam.CParental_RequestRecoveryCode_Request
	(*CParental_RequestRecoveryCode_Response)(nil),        // 17: steam.CParental_RequestRecoveryCode_Response
	(*CParental_RequestFeatureAccess_Request)(nil),        // 18: steam.CParental_RequestFeatureAccess_Request
	(*CParental_RequestFeatureAccess_Response)(nil),       // 19: steam.CParental_RequestFeatureAccess_Response
	(*CParental_ApproveFeatureAccess_Request)(nil),        // 20: steam.CParental_ApproveFeatureAccess_Request
	(*CParental_ApproveFeatureAccess_Response)(nil),       // 21: steam.CParental_ApproveFeatureAccess_Response
	(*CParental_RequestPlaytime_Request)(nil),             // 22: steam.CParental_RequestPlaytime_Request
	(*CParental_RequestPlaytime_Response)(nil),            // 23: steam.CParental_RequestPlaytime_Response
	(*CParental_ApprovePlaytime_Request)(nil),             // 24: steam.CParental_ApprovePlaytime_Request
	(*CParental_ApprovePlaytime_Response)(nil),            // 25: steam.CParental_ApprovePlaytime_Response
	(*CParental_GetRequests_Request)(nil),                 // 26: steam.CParental_GetRequests_Request
	(*CParental_GetRequests_Response)(nil),                // 27: steam.CParental_GetRequests_Response
	(*CParental_ReportPlaytimeAndNotify_Request)(nil),     // 28: steam.CParental_ReportPlaytimeAndNotify_Request
	(*CParental_ReportPlaytimeAndNotify_Response)(nil),    // 29: steam.CParental_ReportPlaytimeAndNotify_Response
	(*CParental_ParentalSettingsChange_Notification)(nil), // 30: steam.CParental_ParentalSettingsChange_Notification
	(*CParental_ParentalUnlock_Notification)(nil),         // 31: steam.CParental_ParentalUnlock_Notification
	(*CParental_ParentalLock_Notification)(nil),           // 32: steam.CParental_ParentalLock_Notification
	(*CParental_PlaytimeUsed_Notification)(nil),           // 33: steam.CParental_PlaytimeUsed_Notification
	(*ParentalSettings)(nil),                              // 34: steam.ParentalSettings
	(*ParentalPlaytimeDay)(nil),                           // 35: steam.ParentalPlaytimeDay
	(*ParentalTemporaryPlaytimeRestrictions)(nil),         // 36: steam.ParentalTemporaryPlaytimeRestrictions
	(*ParentalFeatureRequest)(nil),                        // 37: steam.ParentalFeatureRequest
	(*ParentalPlaytimeRequest)(nil),                       // 38: steam.ParentalPlaytimeRequest
	(*NoResponse)(nil),                                    // 39: steam.NoResponse
}
var file_steammessages_parental_steamclient_proto_depIdxs = []int32{
	34, // 0: steam.CParental_EnableParentalSettings_Request.settings:type_name -> steam.ParentalSettings
	34, // 1: steam.CParental_GetParentalSettings_Response.settings:type_name -> steam.ParentalSettings
	34, // 2: steam.CParental_SetParentalSettings_Request.settings:type_name -> steam.ParentalSettings
	35, // 3: steam.CParental_RequestPlaytime_Request.current_playtime_restrictions:type_name -> steam.ParentalPlaytimeDay
	36, // 4: steam.CParental_ApprovePlaytime_Request.restrictions_approved:type_name -> steam.ParentalTemporaryPlaytimeRestrictions
	37, // 5: steam.CParental_GetRequests_Response.feature_requests:type_name -> steam.ParentalFeatureRequest
	38, // 6: steam.CParental_GetRequests_Response.playtime_requests:type_name -> steam.ParentalPlaytimeRequest
	0,  // 7: steam.Parental.EnableParentalSettings:input_type -> steam.CParental_EnableParentalSettings_Request
	2,  // 8: steam.Parental.DisableParentalSettings:input_type -> steam.CParental_DisableParentalSettings_Request
	4,  // 9: steam.Parental.GetParentalSettings:input_type -> steam.CParental_GetParentalSettings_Request
	6,  // 10: steam.Parental.GetSignedParentalSettings:input_type -> steam.CParental_GetSignedParentalSettings_Request
	8,  // 11: steam.Parental.SetParentalSettings:input_type -> steam.CParental_SetParentalSettings_Request
	10, // 12: steam.Parental.ValidateToken:input_type -> steam.CParental_ValidateToken_Request
	12, // 13: steam.Parental.ValidatePassword:input_type -> steam.CParental_ValidatePassword_Request
	14, // 14: steam.Parental.LockClient:input_type -> steam.CParental_LockClient_Request
	16, // 15: steam.Parental.RequestRecoveryCode:input_type -> steam.CParental_RequestRecoveryCode_Request
	18, // 16: steam.Parental.RequestFeatureAccess:input_type -> steam.CParental_RequestFeatureAccess_Request
	20, // 17: steam.Parental.ApproveFeatureAccess:input_type -> steam.CParental_ApproveFeatureAccess_Request
	22, // 18: steam.Parental.RequestPlaytime:input_type -> steam.CParental_RequestPlaytime_Request
	24, // 19: steam.Parental.ApprovePlaytime:input_type -> steam.CParental_ApprovePlaytime_Request
	26, // 20: steam.Parental.GetRequests:input_type -> steam.CParental_GetRequests_Request
	28, // 21: steam.Parental.ReportPlaytimeAndNotify:input_type -> steam.CParental_ReportPlaytimeAndNotify_Request
	30, // 22: steam.ParentalClient.NotifySettingsChange:input_type -> steam.CParental_ParentalSettingsChange_Notification
	31, // 23: steam.ParentalClient.NotifyUnlock:input_type -> steam.CParental_ParentalUnlock_Notification
	32, // 24: steam.ParentalClient.NotifyLock:input_type -> steam.CParental_ParentalLock_Notification
	33, // 25: steam.ParentalClient.NotifyPlaytimeUsed:input_type -> steam.CParental_PlaytimeUsed_Notification
	1,  // 26: steam.Parental.EnableParentalSettings:output_type -> steam.CParental_EnableParentalSettings_Response
	3,  // 27: steam.Parental.DisableParentalSettings:output_type -> steam.CParental_DisableParentalSettings_Response
	5,  // 28: steam.Parental.GetParentalSettings:output_type -> steam.CParental_GetParentalSettings_Response
	7,  // 29: steam.Parental.GetSignedParentalSettings:output_type -> steam.CParental_GetSignedParentalSettings_Response
	9,  // 30: steam.Parental.SetParentalSettings:output_type -> steam.CParental_SetParentalSettings_Response
	11, // 31: steam.Parental.ValidateToken:output_type -> steam.CParental_ValidateToken_Response
	13, // 32: steam.Parental.ValidatePassword:output_type -> steam.CParental_ValidatePassword_Response
	15, // 33: steam.Parental.LockClient:output_type -> steam.CParental_LockClient_Response
	17, // 34: steam.Parental.RequestRecoveryCode:output_type -> steam.CParental_RequestRecoveryCode_Response
	19, // 35: steam.Parental.RequestFeatureAccess:output_type -> steam.CParental_RequestFeatureAccess_Response
	21, // 36: steam.Parental.ApproveFeatureAccess:output_type -> steam.CParental_ApproveFeatureAccess_Response
	23, // 37: steam.Parental.RequestPlaytime:output_type -> steam.CParental_RequestPlaytime_Response
	25, // 38: steam.Parental.ApprovePlaytime:output_type -> steam.CParental_ApprovePlaytime_Response
	27, // 39: steam.Parental.GetRequests:output_type -> steam.CParental_GetRequests_Response
	29, // 40: steam.Parental.ReportPlaytimeAndNotify:output_type -> steam.CParental_ReportPlaytimeAndNotify_Response
	39, // 41: steam.ParentalClient.NotifySettingsChange:output_type -> steam.NoResponse
	39, // 42: steam.ParentalClient.NotifyUnlock:output_type -> steam.NoResponse
	39, // 43: steam.ParentalClient.NotifyLock:output_type -> steam.NoResponse
	39, // 44: steam.ParentalClient.NotifyPlaytimeUsed:output_type -> steam.NoResponse
