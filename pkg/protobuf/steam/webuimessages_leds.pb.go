...
const file_webuimessages_leds_proto_rawDesc = "" +
	"\n" +
	"\x18webuimessages_leds.proto\x12\x05steam\x1a\venums.proto\x1a\x18steammessages_base.proto\x1a\x18webuimessages_base.proto\"8\n" +
	"\fCMsgLEDColor\x12\f\n" +
	"\x01r\x18\x01 \x01(\x02R\x01r\x12\f\n" +
	"\x01g\x18\x02 \x01(\x02R\x01g\x12\f\n" +
	"\x01b\x18\x03 \x01(\x02R\x01b\"\xf9\x02\n" +
	...
	"\x05color\x18\n" +
	" \x03(\v2\x13.steam.CMsgLEDColorR\x05color\x12%\n" +
	...
	"\x14is_service_available\x18\x01 \x01(\bR\x12isServiceAvailable\x125\n" +
	"\adevices\x18\x02 \x03(\v2\x1b.steam.CMsgLEDManagerDeviceR\adevices\"\x1e\n" +
	"\x1cCLEDManager_GetState_Request\"Q\n" +
	"\x1dCLEDManager_GetState_Response\x120\n" +
	"\x05state\x18\x01 \x01(\v2\x1a.steam.CMsgLEDManagerStateR\x05state\"'\n" +
	"%CLEDManager_StateChanged_Notification\"\x87\x01\n" +
	"\x1cCLEDManager_SetColor_Request\x12\x1b\n" +
	"\tdevice_id\x18\x01 \x01(\x05R\bdeviceId\x12)\n" +
	"\x05color\x18\x02 \x01(\v2\x13.steam.CMsgLEDColorR\x05color\x12\x1f\n" +
	...
	"brightness\"$\n" +
	"\"CLEDManager_SetBrightness_Response2\x90\x05\n" +
	"\n" +
	"LEDManager\x12U\n" +
	"\bGetState\x12#.steam.CLEDManager_GetState_Request\x1a$.steam.CLEDManager_GetState_Response\x12Z\n" +
	"\x12NotifyStateChanged\x12,.steam.CLEDManager_StateChanged_Notification\x1a\x16.steam.WebUINoResponse\x12[\n" +
	"\n" +
	"SetEnabled\x12%.steam.CLEDManager_SetEnabled_Request\x1a&.steam.CLEDManager_SetEnabled_Response\x12U\n" +
	"\bSetColor\x12#.steam.CLEDManager_SetColor_Request\x1a$.steam.CLEDManager_SetColor_Response\x12X\n" +
	"\tSetEffect\x12$.steam.CLEDManager_SetEffect_Request\x1a%.steam.CLEDManager_SetEffect_Response\x12U\n" +
	"\bSetSpeed\x12#.steam.CLEDManager_SetSpeed_Request\x1a$.steam.CLEDManager_SetSpeed_Response\x12d\n" +
	"\rSetBrightness\x12(.steam.CLEDManager_SetBrightness_Request\x1a).steam.CLEDManager_SetBrightness_Response\x1a\x04\x80\x97\"\x01B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_webuimessages_leds_proto_goTypes = []any{
	(*CMsgLEDColor)(nil),                          // 0: steam.CMsgLEDColor
	(*CMsgLEDManagerDevice)(nil),                  // 1: steam.CMsgLEDManagerDevice
	(*CMsgLEDManagerState)(nil),                   // 2: steam.CMsgLEDManagerState
	(*CLEDManager_GetState_Request)(nil),          // 3: steam.CLEDManager_GetState_Request
	(*CLEDManager_GetState_Response)(nil),         // 4: steam.CLEDManager_GetState_Response
	(*CLEDManager_StateChanged_Notification)(nil), // 5: steam.CLEDManager_StateChanged_Notification
	(*CLEDManager_SetColor_Request)(nil),          // 6: steam.CLEDManager_SetColor_Request
	(*CLEDManager_SetColor_Response)(nil),         // 7: steam.CLEDManager_SetColor_Response
	(*CLEDManager_SetEnabled_Request)(nil),        // 8: steam.CLEDManager_SetEnabled_Request
	(*CLEDManager_SetEnabled_Response)(nil),       // 9: steam.CLEDManager_SetEnabled_Response
	(*CLEDManager_SetEffect_Request)(nil),         // 10: steam.CLEDManager_SetEffect_Request
	(*CLEDManager_SetEffect_Response)(nil),        // 11: steam.CLEDManager_SetEffect_Response
	(*CLEDManager_SetSpeed_Request)(nil),          // 12: steam.CLEDManager_SetSpeed_Request
	(*CLEDManager_SetSpeed_Response)(nil),         // 13: steam.CLEDManager_SetSpeed_Response
	(*CLEDManager_SetBrightness_Request)(nil),     // 14: steam.CLEDManager_SetBrightness_Request
	(*CLEDManager_SetBrightness_Response)(nil),    // 15: steam.CLEDManager_SetBrightness_Response
	(*WebUINoResponse)(nil),                       // 16: steam.WebUINoResponse
}
var file_webuimessages_leds_proto_depIdxs = []int32{
	0,  // 0: steam.CMsgLEDManagerDevice.color:type_name -> steam.CMsgLEDColor
	1,  // 1: steam.CMsgLEDManagerState.devices:type_name -> steam.CMsgLEDManagerDevice
	2,  // 2: steam.CLEDManager_GetState_Response.state:type_name -> steam.CMsgLEDManagerState
	0,  // 3: steam.CLEDManager_SetColor_Request.color:type_name -> steam.CMsgLEDColor
	3,  // 4: steam.LEDManager.GetState:input_type -> steam.CLEDManager_GetState_Request
	5,  // 5: steam.LEDManager.NotifyStateChanged:input_type -> steam.CLEDManager_StateChanged_Notification
	8,  // 6: steam.LEDManager.SetEnabled:input_type -> steam.CLEDManager_SetEnabled_Request
	6,  // 7: steam.LEDManager.SetColor:input_type -> steam.CLEDManager_SetColor_Request
	10, // 8: steam.LEDManager.SetEffect:input_type -> steam.CLEDManager_SetEffect_Request
	12, // 9: steam.LEDManager.SetSpeed:input_type -> steam.CLEDManager_SetSpeed_Request
	14, // 10: steam.LEDManager.SetBrightness:input_type -> steam.CLEDManager_SetBrightness_Request
	4,  // 11: steam.LEDManager.GetState:output_type -> steam.CLEDManager_GetState_Response
	16, // 12: steam.LEDManager.NotifyStateChanged:output_type -> steam.WebUINoResponse
	9,  // 13: steam.LEDManager.SetEnabled:output_type -> steam.CLEDManager_SetEnabled_Response
	7,  // 14: steam.LEDManager.SetColor:output_type -> steam.CLEDManager_SetColor_Response
	11, // 15: steam.LEDManager.SetEffect:output_type -> steam.CLEDManager_SetEffect_Response
	13, // 16: steam.LEDManager.SetSpeed:output_type -> steam.CLEDManager_SetSpeed_Response
	15, // 17: steam.LEDManager.SetBrightness:output_type -> steam.CLEDManager_SetBrightness_Response
