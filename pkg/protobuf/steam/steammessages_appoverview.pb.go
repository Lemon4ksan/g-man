...
type CAppOverview struct {
	...
	XboxControllerSupport        *EAppControllerSupportLevel   `protobuf:"varint,31,opt,name=xbox_controller_support,json=xboxControllerSupport,enum=steam.EAppControllerSupportLevel,def=0" json:"xbox_controller_support,omitempty"`
...
const file_steammessages_appoverview_proto_rawDesc = "" +
	"\n" +
	"\x1fsteammessages_appoverview.proto\x12\x05steam\x1a\venums.proto\"\xc3\x04\n" +
	"\x1aCAppOverview_PerClientData\x12\x1d\n" +
	"\bclientid\x18\x01 \x01(\x04:\x010R\bclientid\x12\x1f\n" +
	"\vclient_name\x18\x02 \x01(\tR\n" +
	"clientName\x12U\n" +
	"\x0edisplay_status\x18\x03 \x01(\x0e2\x15.steam.EDisplayStatus:\x17k_EDisplayStatusInvalidR\rdisplayStatus\x12+\n" +
	...
	"$update_available_but_disabled_by_app\x18\x0e \x01(\bR\x1fupdateAvailableButDisabledByApp\"\x80\x15\n" +
	...
	"\asort_as\x18\x06 \x01(\tR\x06sortAs\x12B\n" +
	"\bapp_type\x18\a \x01(\x0e2\x14.steam.EProtoAppType:\x11k_EAppTypeInvalidR\aappType\x12\x1b\n" +
	...
	"\ticon_hash\x18\x1b \x01(\tR\biconHash\x12{\n" +
	"\x17xbox_controller_support\x18\x1f \x01(\x0e2!.steam.EAppControllerSupportLevel: k_EAppControllerSupportLevelNoneR\x15xboxControllerSupport\x12!\n" +
	...
	"\x18library_capsule_filename\x18* \x01(\tR\x16libraryCapsuleFilename\x12I\n" +
	"\x0fper_client_data\x18+ \x03(\v2!.steam.CAppOverview_PerClientDataR\rperClientData\x129\n" +
	...
	"\x1cbitfield_supported_languages\x18M \x01(\x04:\x010R\x1abitfieldSupportedLanguages\x12V\n" +
	"\x16remote_per_client_data\x18N \x03(\v2!.steam.CAppOverview_PerClientDataR\x13remotePerClientData\"\xbc\x01\n" +
	"\x13CAppOverview_Change\x126\n" +
	"\fapp_overview\x18\x01 \x03(\v2\x13.steam.CAppOverviewR\vappOverview\x12#\n" +
	...
	"$k_EHDRSupport_HDR_RequiresUserAction\x10\x04B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_appoverview_proto_goTypes = []any{
	...
	(EAppCloudStatus)(0),                     // 1: steam.EAppCloudStatus
	(EAppControllerSupportLevel)(0),          // 2: steam.EAppControllerSupportLevel
	(EAppGamepadGyroTrackpadSupportLevel)(0), // 3: steam.EAppGamepadGyroTrackpadSupportLevel
	(EAppHDRSupport)(0),                      // 4: steam.EAppHDRSupport
	...
	(EProtoAppType)(0),                       // 8: steam.EProtoAppType
}
var file_steammessages_appoverview_proto_depIdxs = []int32{
	0, // 0: steam.CAppOverview_PerClientData.display_status:type_name -> steam.EDisplayStatus
	8, // 1: steam.CAppOverview.app_type:type_name -> steam.EProtoAppType
	2, // 2: steam.CAppOverview.xbox_controller_support:type_name -> steam.EAppControllerSupportLevel
	5, // 3: steam.CAppOverview.per_client_data:type_name -> steam.CAppOverview_PerClientData
	5, // 4: steam.CAppOverview.remote_per_client_data:type_name -> steam.CAppOverview_PerClientData
	6, // 5: steam.CAppOverview_Change.app_overview:type_name -> steam.CAppOverview
