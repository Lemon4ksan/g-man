...
const file_steammessages_linkfilter_steamclient_proto_rawDesc = "" +
	"\n" +
	"*steammessages_linkfilter.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"u\n" +
	...
	"\x05count\x18\x02 \x01(\x04R\x05count2\x9a\x03\n" +
	"\x13CommunityLinkFilter\x12\x86\x01\n" +
	"\x19GetLinkFilterHashPrefixes\x123.steam.CCommunity_GetLinkFilterHashPrefixes_Request\x1a4.steam.CCommunity_GetLinkFilterHashPrefixes_Response\x12t\n" +
	"\x13GetLinkFilterHashes\x12-.steam.CCommunity_GetLinkFilterHashes_Request\x1a..steam.CCommunity_GetLinkFilterHashes_Response\x12\x83\x01\n" +
	"\x18GetLinkFilterListVersion\x122.steam.CCommunity_GetLinkFilterListVersion_Request\x1a3.steam.CCommunity_GetLinkFilterListVersion_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
