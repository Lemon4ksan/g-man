...
const file_steammessages_clientserver_proto_rawDesc = "" +
	"\n" +
	" steammessages_clientserver.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a\x1aencrypted_app_ticket.proto\"\x95\x01\n" +
	...
	"\x06tokens\x18\x02 \x03(\fR\x06tokens\"\xa1\x0e\n" +
	"\x15CMsgClientGamesPlayed\x12J\n" +
	"\fgames_played\x18\x01 \x03(\v2'.steam.CMsgClientGamesPlayed.GamePlayedR\vgamesPlayed\x12$\n" +
	...
	"\x0fparent_is_steam\x18\x03 \x01(\bR\rparentIsSteam\x1a\xa5\v\n" +
	"\n" +
	"GamePlayed\x12\x1e\n" +
	...
	"\x0evr_hmd_runtime\x18\x16 \x01(\rR\fvrHmdRuntime\x12<\n" +
	"\x0fgame_ip_address\x18\x17 \x01(\v2\x14.steam.CMsgIPAddressR\rgameIpAddress\x12?\n" +
	...
	"dlcContext\x12P\n" +
	"\x0fprocess_id_list\x18  \x03(\v2(.steam.CMsgClientGamesPlayed.ProcessInfoR\rprocessIdList\"P\n" +
	...
	"CMsgGSKick\x12\x19\n" +
	"\bsteam_id\x18\x01 \x01(\x06R\asteamId\x12!\n" +
	"\fedeny_reason\x18\x02 \x01(\x05R\vedenyReason\"\xb0\x02\n" +
	...
	"\atickets\x18\x04 \x03(\v2\x15.steam.CMsgAuthTicketR\atickets\x12\x17\n" +
	...
	"\n" +
	"app_id_aux\x18\x02 \x01(\rR\bappIdAux\"\xa6\x06\n" +
	"\x15CMsgClientLicenseList\x12\x1b\n" +
	"\aeresult\x18\x01 \x01(\x05:\x012R\aeresult\x12@\n" +
	"\blicenses\x18\x02 \x03(\v2$.steam.CMsgClientLicenseList.LicenseR\blicenses\x1a\xad\x05\n" +
	"\aLicense\x12\x1d\n" +
	"\n" +
	...
	"-bis_limited_account_allowed_to_invite_friends\x18\x04 \x01(\bR'bisLimitedAccountAllowedToInviteFriends\"\xdb\x01\n" +
	"\x1eCMsgClientRequestedClientStats\x12U\n" +
	"\rstats_to_send\x18\x01 \x03(\v21.steam.CMsgClientRequestedClientStats.StatsToSendR\vstatsToSend\x1ab\n" +
	"\vStatsToSend\x12\x1f\n" +
	"\vclient_stat\x18\x01 \x01(\rR\n" +
	"clientStat\x122\n" +
	"\x15stat_aggregate_method\x18\x02 \x01(\rR\x13statAggregateMethod\"\x8b\x02\n" +
	"\x0fCMsgClientStat2\x12B\n" +
	"\vstat_detail\x18\x01 \x03(\v2!.steam.CMsgClientStat2.StatDetailR\n" +
	...
	"\agame_id\x18\a \x01(\x06R\x06gameId\"\xe4\r\n" +
	"\x19CMsgClientConnectionStats\x12M\n" +
	"\vstats_logon\x18\x01 \x01(\v2,.steam.CMsgClientConnectionStats.Stats_LogonR\n" +
	"statsLogon\x12M\n" +
	"\vstats_vconn\x18\x02 \x01(\v2,.steam.CMsgClientConnectionStats.Stats_VConnR\n" +
	...
	"\n" +
	"bytes_recv\x18\x05 \x01(\x04R\tbytesRecv\x1a\xca\x06\n" +
	"\vStats_VConn\x12'\n" +
	"\x0fconnections_udp\x18\x01 \x01(\rR\x0econnectionsUdp\x12'\n" +
	"\x0fconnections_tcp\x18\x02 \x01(\rR\x0econnectionsTcp\x12G\n" +
	"\tstats_udp\x18\x03 \x01(\v2*.steam.CMsgClientConnectionStats.Stats_UDPR\bstatsUdp\x12%\n" +
	...
	"\x15micro_sec_max_latency\x18\x13 \x01(\rR\x12microSecMaxLatency\"\x9a\x02\n" +
	"\x1aCMsgClientServersAvailable\x12n\n" +
	"\x16server_types_available\x18\x01 \x03(\v28.steam.CMsgClientServersAvailable.Server_Types_AvailableR\x14serverTypesAvailable\x12@\n" +
	...
	"\buserdata\x18\x02 \x01(\fR\buserdata\"\xae\x01\n" +
	"+CMsgClientRequestEncryptedAppTicketResponse\x12\x15\n" +
	"\x06app_id\x18\x01 \x01(\rR\x05appId\x12\x1b\n" +
	"\aeresult\x18\x02 \x01(\x05:\x012R\aeresult\x12K\n" +
	"\x14encrypted_app_ticket\x18\x03 \x01(\v2\x19.steam.EncryptedAppTicketR\x12encryptedAppTicket\"\x87\x02\n" +
	...
	"\rofficer_count\x18\x03 \x01(\x05R\fofficerCount\"\xad\x01\n" +
	"!CMsgClientAMGetPersonaNameHistory\x12\x19\n" +
	"\bid_count\x18\x01 \x01(\x05R\aidCount\x12E\n" +
	"\x03Ids\x18\x02 \x03(\v23.steam.CMsgClientAMGetPersonaNameHistory.IdInstanceR\x03Ids\x1a&\n" +
	"\n" +
	"IdInstance\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\"\x84\x03\n" +
	")CMsgClientAMGetPersonaNameHistoryResponse\x12`\n" +
	"\tresponses\x18\x02 \x03(\v2B.steam.CMsgClientAMGetPersonaNameHistoryResponse.NameTableInstanceR\tresponses\x1a\xf4\x01\n" +
	"\x11NameTableInstance\x12\x1b\n" +
	"\aeresult\x18\x01 \x01(\x05:\x012R\aeresult\x12\x18\n" +
	"\asteamid\x18\x02 \x01(\x06R\asteamid\x12e\n" +
	"\x05names\x18\x03 \x03(\v2O.steam.CMsgClientAMGetPersonaNameHistoryResponse.NameTableInstance.NameInstanceR\x05names\x1aA\n" +
	...
	"\x06app_id\x18\x02 \x01(\rR\x05appId\"\x99\x06\n" +
	...
	"\tname_info\x18\x04 \x01(\v2#.steam.CMsgClientClanState.NameInfoR\bnameInfo\x12F\n" +
	"\vuser_counts\x18\x05 \x01(\v2%.steam.CMsgClientClanState.UserCountsR\n" +
	"userCounts\x128\n" +
	"\x06events\x18\x06 \x03(\v2 .steam.CMsgClientClanState.EventR\x06events\x12F\n" +
	"\rannouncements\x18\a \x03(\v2 .steam.CMsgClientClanState.EventR\rannouncements\x12*\n" +
	...
	"justPostedB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steammessages_clientserver_proto_goTypes = []any{
	(*CMsgClientRegisterAuthTicketWithCM)(nil),                                       // 0: steam.CMsgClientRegisterAuthTicketWithCM
	(*CMsgClientTicketAuthComplete)(nil),                                             // 1: steam.CMsgClientTicketAuthComplete
	(*CMsgClientP2PConnectionInfo)(nil),                                              // 2: steam.CMsgClientP2PConnectionInfo
	(*CMsgClientP2PConnectionFailInfo)(nil),                                          // 3: steam.CMsgClientP2PConnectionFailInfo
	(*CMsgClientNetworkingCertRequest)(nil),                                          // 4: steam.CMsgClientNetworkingCertRequest
	(*CMsgClientNetworkingCertReply)(nil),                                            // 5: steam.CMsgClientNetworkingCertReply
	(*CMsgClientNetworkingMobileCertRequest)(nil),                                    // 6: steam.CMsgClientNetworkingMobileCertRequest
	(*CMsgClientNetworkingMobileCertReply)(nil),                                      // 7: steam.CMsgClientNetworkingMobileCertReply
	(*CMsgClientGetAppOwnershipTicket)(nil),                                          // 8: steam.CMsgClientGetAppOwnershipTicket
	(*CMsgClientGetAppOwnershipTicketResponse)(nil),                                  // 9: steam.CMsgClientGetAppOwnershipTicketResponse
	(*CMsgClientSessionToken)(nil),                                                   // 10: steam.CMsgClientSessionToken
	(*CMsgClientGameConnectTokens)(nil),                                              // 11: steam.CMsgClientGameConnectTokens
	(*CMsgClientGamesPlayed)(nil),                                                    // 12: steam.CMsgClientGamesPlayed
	(*CMsgGSApprove)(nil),                                                            // 13: steam.CMsgGSApprove
	(*CMsgGSDeny)(nil),                                                               // 14: steam.CMsgGSDeny
	(*CMsgGSKick)(nil),                                                               // 15: steam.CMsgGSKick
	(*CMsgClientAuthList)(nil),                                                       // 16: steam.CMsgClientAuthList
	(*CMsgClientAuthListAck)(nil),                                                    // 17: steam.CMsgClientAuthListAck
	(*CMsgGameServerPolicyUpdate)(nil),                                               // 18: steam.CMsgGameServerPolicyUpdate
	(*CMsgClientLicenseList)(nil),                                                    // 19: steam.CMsgClientLicenseList
	(*CMsgClientIsLimitedAccount)(nil),                                               // 20: steam.CMsgClientIsLimitedAccount
	(*CMsgClientRequestedClientStats)(nil),                                           // 21: steam.CMsgClientRequestedClientStats
	(*CMsgClientStat2)(nil),                                                          // 22: steam.CMsgClientStat2
	(*CMsgClientInviteToGame)(nil),                                                   // 23: steam.CMsgClientInviteToGame
	(*CMsgClientChatInvite)(nil),                                                     // 24: steam.CMsgClientChatInvite
	(*CMsgClientConnectionStats)(nil),                                                // 25: steam.CMsgClientConnectionStats
	(*CMsgClientServersAvailable)(nil),                                               // 26: steam.CMsgClientServersAvailable
	(*CMsgClientReportOverlayDetourFailure)(nil),                                     // 27: steam.CMsgClientReportOverlayDetourFailure
	(*CMsgClientRequestEncryptedAppTicket)(nil),                                      // 28: steam.CMsgClientRequestEncryptedAppTicket
	(*CMsgClientRequestEncryptedAppTicketResponse)(nil),                              // 29: steam.CMsgClientRequestEncryptedAppTicketResponse
	(*CMsgClientWalletInfoUpdate)(nil),                                               // 30: steam.CMsgClientWalletInfoUpdate
	(*CMsgClientAMGetClanOfficers)(nil),                                              // 31: steam.CMsgClientAMGetClanOfficers
	(*CMsgClientAMGetClanOfficersResponse)(nil),                                      // 32: steam.CMsgClientAMGetClanOfficersResponse
	(*CMsgClientAMGetPersonaNameHistory)(nil),                                        // 33: steam.CMsgClientAMGetPersonaNameHistory
	(*CMsgClientAMGetPersonaNameHistoryResponse)(nil),                                // 34: steam.CMsgClientAMGetPersonaNameHistoryResponse
	(*CMsgClientDeregisterWithServer)(nil),                                           // 35: steam.CMsgClientDeregisterWithServer
	(*CMsgClientClanState)(nil),                                                      // 36: steam.CMsgClientClanState
	(*CMsgClientGamesPlayed_ProcessInfo)(nil),                                        // 37: steam.CMsgClientGamesPlayed.ProcessInfo
	(*CMsgClientGamesPlayed_GamePlayed)(nil),                                         // 38: steam.CMsgClientGamesPlayed.GamePlayed
	(*CMsgClientLicenseList_License)(nil),                                            // 39: steam.CMsgClientLicenseList.License
	(*CMsgClientRequestedClientStats_StatsToSend)(nil),                               // 40: steam.CMsgClientRequestedClientStats.StatsToSend
	(*CMsgClientStat2_StatDetail)(nil),                                               // 41: steam.CMsgClientStat2.StatDetail
	(*CMsgClientConnectionStats_Stats_Logon)(nil),                                    // 42: steam.CMsgClientConnectionStats.Stats_Logon
	(*CMsgClientConnectionStats_Stats_UDP)(nil),                                      // 43: steam.CMsgClientConnectionStats.Stats_UDP
	(*CMsgClientConnectionStats_Stats_VConn)(nil),                                    // 44: steam.CMsgClientConnectionStats.Stats_VConn
	(*CMsgClientServersAvailable_Server_Types_Available)(nil),                        // 45: steam.CMsgClientServersAvailable.Server_Types_Available
	(*CMsgClientAMGetPersonaNameHistory_IdInstance)(nil),                             // 46: steam.CMsgClientAMGetPersonaNameHistory.IdInstance
	(*CMsgClientAMGetPersonaNameHistoryResponse_NameTableInstance)(nil),              // 47: steam.CMsgClientAMGetPersonaNameHistoryResponse.NameTableInstance
	(*CMsgClientAMGetPersonaNameHistoryResponse_NameTableInstance_NameInstance)(nil), // 48: steam.CMsgClientAMGetPersonaNameHistoryResponse.NameTableInstance.NameInstance
	(*CMsgClientClanState_NameInfo)(nil),                                             // 49: steam.CMsgClientClanState.NameInfo
	(*CMsgClientClanState_UserCounts)(nil),                                           // 50: steam.CMsgClientClanState.UserCounts
	(*CMsgClientClanState_Event)(nil),                                                // 51: steam.CMsgClientClanState.Event
	(*CMsgAuthTicket)(nil),                                                           // 52: steam.CMsgAuthTicket
	(*EncryptedAppTicket)(nil),                                                       // 53: steam.EncryptedAppTicket
	(*CMsgIPAddress)(nil),                                                            // 54: steam.CMsgIPAddress
}
var file_steammessages_clientserver_proto_depIdxs = []int32{
	38, // 0: steam.CMsgClientGamesPlayed.games_played:type_name -> steam.CMsgClientGamesPlayed.GamePlayed
	52, // 1: steam.CMsgClientAuthList.tickets:type_name -> steam.CMsgAuthTicket
	39, // 2: steam.CMsgClientLicenseList.licenses:type_name -> steam.CMsgClientLicenseList.License
	40, // 3: steam.CMsgClientRequestedClientStats.stats_to_send:type_name -> steam.CMsgClientRequestedClientStats.StatsToSend
	41, // 4: steam.CMsgClientStat2.stat_detail:type_name -> steam.CMsgClientStat2.StatDetail
	42, // 5: steam.CMsgClientConnectionStats.stats_logon:type_name -> steam.CMsgClientConnectionStats.Stats_Logon
	44, // 6: steam.CMsgClientConnectionStats.stats_vconn:type_name -> steam.CMsgClientConnectionStats.Stats_VConn
	45, // 7: steam.CMsgClientServersAvailable.server_types_available:type_name -> steam.CMsgClientServersAvailable.Server_Types_Available
	53, // 8: steam.CMsgClientRequestEncryptedAppTicketResponse.encrypted_app_ticket:type_name -> steam.EncryptedAppTicket
	46, // 9: steam.CMsgClientAMGetPersonaNameHistory.Ids:type_name -> steam.CMsgClientAMGetPersonaNameHistory.IdInstance
	47, // 10: steam.CMsgClientAMGetPersonaNameHistoryResponse.responses:type_name -> steam.CMsgClientAMGetPersonaNameHistoryResponse.NameTableInstance
	49, // 11: steam.CMsgClientClanState.name_info:type_name -> steam.CMsgClientClanState.NameInfo
	50, // 12: steam.CMsgClientClanState.user_counts:type_name -> steam.CMsgClientClanState.UserCounts
	51, // 13: steam.CMsgClientClanState.events:type_name -> steam.CMsgClientClanState.Event
	51, // 14: steam.CMsgClientClanState.announcements:type_name -> steam.CMsgClientClanState.Event
	54, // 15: steam.CMsgClientGamesPlayed.GamePlayed.game_ip_address:type_name -> steam.CMsgIPAddress
	37, // 16: steam.CMsgClientGamesPlayed.GamePlayed.process_id_list:type_name -> steam.CMsgClientGamesPlayed.ProcessInfo
	43, // 17: steam.CMsgClientConnectionStats.Stats_VConn.stats_udp:type_name -> steam.CMsgClientConnectionStats.Stats_UDP
	48, // 18: steam.CMsgClientAMGetPersonaNameHistoryResponse.NameTableInstance.names:type_name -> steam.CMsgClientAMGetPersonaNameHistoryResponse.NameTableInstance.NameInstance
