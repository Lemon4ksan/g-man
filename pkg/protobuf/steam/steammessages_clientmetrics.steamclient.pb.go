...
type CClientMetrics_SteamPipeWorkStats_Operation struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Type          *ESteamPipeOperationType `protobuf:"varint,1,opt,name=type,enum=steam.ESteamPipeOperationType,def=0" json:"type,omitempty"`
...
type CClientMetrics_SteamPipeWorkStats_Notification struct {
	...
	WorkType      *ESteamPipeWorkType                            `protobuf:"varint,3,opt,name=work_type,json=workType,enum=steam.ESteamPipeWorkType,def=0" json:"work_type,omitempty"`
...
type CClientMetrics_ReportClientArgs_Notification struct {
	...
	GrMode                         *EGRMode               `protobuf:"varint,10,opt,name=gr_mode,json=grMode,enum=steam.EGRMode,def=0" json:"gr_mode,omitempty"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
type CClientMetrics_ClipShare_Notification struct {
	...
	ShareMethod   *EClipShareMethod      `protobuf:"varint,2,opt,name=share_method,json=shareMethod,enum=steam.EClipShareMethod,def=1" json:"share_method,omitempty"`
...
type CClientMetrics_ClipRange_Notification struct {
	state               protoimpl.MessageState                                   `protogen:"open.v1"`
	OriginalRangeMethod *EClipRangeMethod                                        `protobuf:"varint,1,opt,name=original_range_method,json=originalRangeMethod,enum=steam.EClipRangeMethod,def=1" json:"original_range_method,omitempty"`
...
type CClientMetrics_EndGameRecording_Notification struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RecordingType *EGameRecordingType    `protobuf:"varint,1,opt,name=recording_type,json=recordingType,enum=steam.EGameRecordingType,def=0" json:"recording_type,omitempty"`
...
type CClientMetrics_ClipRange_Notification_RelativeRangeEdge struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	OriginalRangeMethod *EClipRangeMethod      `protobuf:"varint,1,opt,name=original_range_method,json=originalRangeMethod,enum=steam.EClipRangeMethod,def=1" json:"original_range_method,omitempty"`
	LatestRangeMethod   *EClipRangeMethod      `protobuf:"varint,2,opt,name=latest_range_method,json=latestRangeMethod,enum=steam.EClipRangeMethod,def=1" json:"latest_range_method,omitempty"`
...
const file_steammessages_clientmetrics_steamclient_proto_rawDesc = "" +
	"\n" +
	"-steammessages_clientmetrics.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\x1a\x13clientmetrics.proto\x1a\venums.proto\"\x80\x01\n" +
	...
	"methodName\x12\x1d\n" +
	"\n" +
	"call_count\x18\x03 \x01(\rR\tcallCount\"\xb0\x02\n" +
	"-CClientMetrics_AppInterfaceStats_Notification\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x04R\x06gameId\x12Y\n" +
	"\x12interfaces_created\x18\x02 \x03(\v2*.steam.CClientMetrics_AppInterfaceCreationR\x11interfacesCreated\x12U\n" +
	"\x0emethods_called\x18\x03 \x03(\v2..steam.CClientMetrics_AppInterfaceMethodCountsR\rmethodsCalled\x124\n" +
	...
	"\x12connectivity_state\x18\x02 \x01(\rR\x11connectivityState\"\xc3\x01\n" +
	",CClientMetrics_IPv6Connectivity_Notification\x12\x17\n" +
	"\acell_id\x18\x01 \x01(\rR\x06cellId\x12G\n" +
	"\aresults\x18\x02 \x03(\v2-.steam.CClientMetrics_IPv6Connectivity_ResultR\aresults\x121\n" +
	"\x15private_ip_is_rfc6598\x18\x03 \x01(\bR\x12privateIpIsRfc6598\"\xce\x02\n" +
	"+CClientMetrics_SteamPipeWorkStats_Operation\x12U\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1e.steam.ESteamPipeOperationType:!k_ESteamPipeOperationType_InvalidR\x04type\x12\x17\n" +
	...
	"\x10sum_wait_time_ms\x18\a \x01(\x04R\rsumWaitTimeMs\"\xb5\x02\n" +
	".CClientMetrics_SteamPipeWorkStats_Notification\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12\x18\n" +
	"\adepotid\x18\x02 \x01(\rR\adepotid\x12Z\n" +
	"\twork_type\x18\x03 \x01(\x0e2\x19.steam.ESteamPipeWorkType:\"k_ESteamPipeClientWorkType_InvalidR\bworkType\x12R\n" +
	"\n" +
	"operations\x18\x04 \x03(\v22.steam.CClientMetrics_SteamPipeWorkStats_OperationR\n" +
	"operations\x12#\n" +
	"\rhardware_type\x18\x05 \x01(\rR\fhardwareType\"\xb0\x04\n" +
	...
	"\x06routes\x18\x03 \x03(\v2=.steam.CClientMetrics_ReportReactUsage_Notification.RouteDataR\x06routes\x12a\n" +
	"\n" +
	"components\x18\x04 \x03(\v2A.steam.CClientMetrics_ReportReactUsage_Notification.ComponentDataR\n" +
	"components\x12X\n" +
	"\aactions\x18\x05 \x03(\v2>.steam.CClientMetrics_ReportReactUsage_Notification.ActionDataR\aactions\x1a7\n" +
	"\tRouteData\x12\x14\n" +
	...
	"\x06errors\x18\x03 \x03(\v2:.steam.CClientMetrics_ReportClientError_Notification.ErrorR\x06errors\x12\x12\n" +
	...
	"+CClientMetrics_ClientBootstrap_Notification\x12G\n" +
	"\asummary\x18\x01 \x01(\v2-.steam.CClientMetrics_ClientBootstrap_SummaryR\asummary\"\xf0\x04\n" +
	")CClientMetrics_DownloadRates_Notification\x12\x17\n" +
	"\acell_id\x18\x01 \x01(\rR\x06cellId\x12P\n" +
	"\x05stats\x18\x02 \x03(\v2:.steam.CClientMetrics_DownloadRates_Notification.StatsInfoR\x05stats\x12'\n" +
	...
	"\rfiles_managed\x18\x15 \x01(\rR\ffilesManaged\"\x9e\x01\n" +
	":CClientMetrics_ContentDownloadResponse_Counts_Notification\x12\x17\n" +
	"\acell_id\x18\x01 \x01(\rR\x06cellId\x12G\n" +
	"\x04data\x18\x02 \x01(\v23.steam.CClientMetrics_ContentDownloadResponse_HostsR\x04data\"\xda\x04\n" +
	...
	"\x1dlibrary_low_perf_mode_enabled\x18\t \x01(\bR\x19libraryLowPerfModeEnabled\x128\n" +
	"\agr_mode\x18\n" +
	" \x01(\x0e2\x0e.steam.EGRMode:\x0fk_EGRMode_NeverR\x06grMode\"\xa5\x02\n" +
	...
	"\x1faccessibility_color_filter_name\x18\x05 \x01(\tR\x1caccessibilityColorFilterName\"\xe1\x01\n" +
	"%CClientMetrics_ClipShare_Notification\x12\x1b\n" +
	"\aeresult\x18\x01 \x01(\r:\x012R\aeresult\x12S\n" +
	"\fshare_method\x18\x02 \x01(\x0e2\x17.steam.EClipShareMethod:\x17k_EClipShareMethod_ChatR\vshareMethod\x12\x18\n" +
	"\aseconds\x18\x03 \x01(\x02R\aseconds\x12\x14\n" +
	"\x05bytes\x18\x04 \x01(\x04R\x05bytes\x12\x16\n" +
	"\x06gameid\x18\x05 \x01(\x06R\x06gameid\"\x84\x05\n" +
	"%CClientMetrics_ClipRange_Notification\x12p\n" +
	"\x15original_range_method\x18\x01 \x01(\x0e2\x17.steam.EClipRangeMethod:#k_EClipRangeMethod_CreateClipButtonR\x13originalRangeMethod\x12T\n" +
	"\x05start\x18\x02 \x01(\v2>.steam.CClientMetrics_ClipRange_Notification.RelativeRangeEdgeR\x05start\x12P\n" +
	"\x03end\x18\x03 \x01(\v2>.steam.CClientMetrics_ClipRange_Notification.RelativeRangeEdgeR\x03end\x12\x18\n" +
	"\aseconds\x18\x04 \x01(\x02R\aseconds\x12\x16\n" +
	"\x06gameid\x18\x05 \x01(\x06R\x06gameid\x1a\x8e\x02\n" +
	"\x11RelativeRangeEdge\x12p\n" +
	"\x15original_range_method\x18\x01 \x01(\x0e2\x17.steam.EClipRangeMethod:#k_EClipRangeMethod_CreateClipButtonR\x13originalRangeMethod\x12l\n" +
	"\x13latest_range_method\x18\x02 \x01(\x0e2\x17.steam.EClipRangeMethod:#k_EClipRangeMethod_CreateClipButtonR\x11latestRangeMethod\x12\x19\n" +
	"\bdelta_ms\x18\x03 \x01(\x05R\adeltaMs\"\xf9\x01\n" +
	",CClientMetrics_EndGameRecording_Notification\x12^\n" +
	"\x0erecording_type\x18\x01 \x01(\x0e2\x19.steam.EGameRecordingType:\x1ck_EGameRecordingType_UnknownR\rrecordingType\x12\x18\n" +
	...
	"\finstant_clip\x18\x05 \x01(\bR\vinstantClip\"\xe9\x02\n" +
	"+CClientMetrics_GamePerformance_Notification\x12]\n" +
	"\vframe_rates\x18\x02 \x03(\v2<.steam.CClientMetrics_GamePerformance_Notification.FrameRateR\n" +
	"frameRates\x12=\n" +
	"\vsystem_info\x18\x03 \x01(\v2\x1c.steam.UserSystemInformationR\n" +
	"systemInfo\x1a\x9b\x01\n" +
	"\tFrameRate\x12\x16\n" +
	...
	"\x13framegen_frame_rate\x18\x04 \x01(\rR\x11framegenFrameRate*q\n" +
	...
	"!k_EClipRangeMethod_PhaseRecording\x10\a2\x9f\r\n" +
	"\rClientMetrics\x12h\n" +
	"\x1dClientAppInterfaceStatsReport\x124.steam.CClientMetrics_AppInterfaceStats_Notification\x1a\x11.steam.NoResponse\x12f\n" +
	"\x1cClientIPv6ConnectivityReport\x123.steam.CClientMetrics_IPv6Connectivity_Notification\x1a\x11.steam.NoResponse\x12d\n" +
	"\x18SteamPipeWorkStatsReport\x125.steam.CClientMetrics_SteamPipeWorkStats_Notification\x1a\x11.steam.NoResponse\x12Z\n" +
	"\x10ReportReactUsage\x123.steam.CClientMetrics_ReportReactUsage_Notification\x1a\x11.steam.NoResponse\x12\\\n" +
	"\x11ReportClientError\x124.steam.CClientMetrics_ReportClientError_Notification\x1a\x11.steam.NoResponse\x12^\n" +
	"\x15ClientBootstrapReport\x122.steam.CClientMetrics_ClientBootstrap_Notification\x1a\x11.steam.NoResponse\x12`\n" +
	"\x19ClientDownloadRatesReport\x120.steam.CClientMetrics_DownloadRates_Notification\x1a\x11.steam.NoResponse\x12h\n" +
	"\x1dClientContentValidationReport\x124.steam.CClientMetrics_ContentValidation_Notification\x1a\x11.steam.NoResponse\x12b\n" +
	"\x17ClientCloudAppSyncStats\x124.steam.CClientMetrics_CloudAppSyncStats_Notification\x1a\x11.steam.NoResponse\x12x\n" +
	" ClientDownloadResponseCodeCounts\x12A.steam.CClientMetrics_ContentDownloadResponse_Counts_Notification\x1a\x11.steam.NoResponse\x12Z\n" +
	"\x10ReportClientArgs\x123.steam.CClientMetrics_ReportClientArgs_Notification\x1a\x11.steam.NoResponse\x12Z\n" +
	"\x10ReportLinuxStats\x123.steam.CClientMetrics_ReportLinuxStats_Notification\x1a\x11.steam.NoResponse\x12p\n" +
	"\x1bReportAccessibilitySettings\x12>.steam.CClientMetrics_ReportAccessibilitySettings_Notification\x1a\x11.steam.NoResponse\x12R\n" +
	"\x0fReportClipShare\x12,.steam.CClientMetrics_ClipShare_Notification\x1a\x11.steam.NoResponse\x12R\n" +
	"\x0fReportClipRange\x12,.steam.CClientMetrics_ClipRange_Notification\x1a\x11.steam.NoResponse\x12`\n" +
	"\x16ReportEndGameRecording\x123.steam.CClientMetrics_EndGameRecording_Notification\x1a\x11.steam.NoResponse\x12^\n" +
	"\x15ReportGamePerformance\x122.steam.CClientMetrics_GamePerformance_Notification\x1a\x11.steam.NoResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_clientmetrics_steamclient_proto_goTypes = []any{
	(ESteamPipeWorkType)(0),                                            // 0: steam.ESteamPipeWorkType
	(ESteamPipeOperationType)(0),                                       // 1: steam.ESteamPipeOperationType
	(EClipShareMethod)(0),                                              // 2: steam.EClipShareMethod
	(EClipRangeMethod)(0),                                              // 3: steam.EClipRangeMethod
	(*CClientMetrics_AppInterfaceCreation)(nil),                        // 4: steam.CClientMetrics_AppInterfaceCreation
	(*CClientMetrics_AppInterfaceMethodCounts)(nil),                    // 5: steam.CClientMetrics_AppInterfaceMethodCounts
	(*CClientMetrics_AppInterfaceStats_Notification)(nil),              // 6: steam.CClientMetrics_AppInterfaceStats_Notification
	(*CClientMetrics_IPv6Connectivity_Result)(nil),                     // 7: steam.CClientMetrics_IPv6Connectivity_Result
	(*CClientMetrics_IPv6Connectivity_Notification)(nil),               // 8: steam.CClientMetrics_IPv6Connectivity_Notification
	(*CClientMetrics_SteamPipeWorkStats_Operation)(nil),                // 9: steam.CClientMetrics_SteamPipeWorkStats_Operation
	(*CClientMetrics_SteamPipeWorkStats_Notification)(nil),             // 10: steam.CClientMetrics_SteamPipeWorkStats_Notification
	(*CClientMetrics_ReportReactUsage_Notification)(nil),               // 11: steam.CClientMetrics_ReportReactUsage_Notification
	(*CClientMetrics_ReportClientError_Notification)(nil),              // 12: steam.CClientMetrics_ReportClientError_Notification
	(*CClientMetrics_ClientBootstrap_Notification)(nil),                // 13: steam.CClientMetrics_ClientBootstrap_Notification
	(*CClientMetrics_DownloadRates_Notification)(nil),                  // 14: steam.CClientMetrics_DownloadRates_Notification
	(*CClientMetrics_ContentValidation_Notification)(nil),              // 15: steam.CClientMetrics_ContentValidation_Notification
	(*CClientMetrics_CloudAppSyncStats_Notification)(nil),              // 16: steam.CClientMetrics_CloudAppSyncStats_Notification
	(*CClientMetrics_ContentDownloadResponse_Counts_Notification)(nil), // 17: steam.CClientMetrics_ContentDownloadResponse_Counts_Notification
	(*CClientMetrics_ReportClientArgs_Notification)(nil),               // 18: steam.CClientMetrics_ReportClientArgs_Notification
	(*CClientMetrics_ReportLinuxStats_Notification)(nil),               // 19: steam.CClientMetrics_ReportLinuxStats_Notification
	(*CClientMetrics_ReportAccessibilitySettings_Notification)(nil),    // 20: steam.CClientMetrics_ReportAccessibilitySettings_Notification
	(*CClientMetrics_ClipShare_Notification)(nil),                      // 21: steam.CClientMetrics_ClipShare_Notification
	(*CClientMetrics_ClipRange_Notification)(nil),                      // 22: steam.CClientMetrics_ClipRange_Notification
	(*CClientMetrics_EndGameRecording_Notification)(nil),               // 23: steam.CClientMetrics_EndGameRecording_Notification
	(*CClientMetrics_GamePerformance_Notification)(nil),                // 24: steam.CClientMetrics_GamePerformance_Notification
	(*CClientMetrics_ReportReactUsage_Notification_RouteData)(nil),     // 25: steam.CClientMetrics_ReportReactUsage_Notification.RouteData
	(*CClientMetrics_ReportReactUsage_Notification_ComponentData)(nil), // 26: steam.CClientMetrics_ReportReactUsage_Notification.ComponentData
	(*CClientMetrics_ReportReactUsage_Notification_ActionData)(nil),    // 27: steam.CClientMetrics_ReportReactUsage_Notification.ActionData
	(*CClientMetrics_ReportClientError_Notification_Error)(nil),        // 28: steam.CClientMetrics_ReportClientError_Notification.Error
	(*CClientMetrics_DownloadRates_Notification_StatsInfo)(nil),        // 29: steam.CClientMetrics_DownloadRates_Notification.StatsInfo
	(*CClientMetrics_ClipRange_Notification_RelativeRangeEdge)(nil),    // 30: steam.CClientMetrics_ClipRange_Notification.RelativeRangeEdge
	(*CClientMetrics_GamePerformance_Notification_FrameRate)(nil),      // 31: steam.CClientMetrics_GamePerformance_Notification.FrameRate
	(*CClientMetrics_ClientBootstrap_Summary)(nil),                     // 32: steam.CClientMetrics_ClientBootstrap_Summary
	(*CClientMetrics_ContentDownloadResponse_Hosts)(nil),               // 33: steam.CClientMetrics_ContentDownloadResponse_Hosts
	(EGRMode)(0),                  // 34: steam.EGRMode
	(EGameRecordingType)(0),       // 35: steam.EGameRecordingType
	(*UserSystemInformation)(nil), // 36: steam.UserSystemInformation
	(*NoResponse)(nil),            // 37: steam.NoResponse
}
var file_steammessages_clientmetrics_steamclient_proto_depIdxs = []int32{
	4,  // 0: steam.CClientMetrics_AppInterfaceStats_Notification.interfaces_created:type_name -> steam.CClientMetrics_AppInterfaceCreation
	5,  // 1: steam.CClientMetrics_AppInterfaceStats_Notification.methods_called:type_name -> steam.CClientMetrics_AppInterfaceMethodCounts
	7,  // 2: steam.CClientMetrics_IPv6Connectivity_Notification.results:type_name -> steam.CClientMetrics_IPv6Connectivity_Result
	1,  // 3: steam.CClientMetrics_SteamPipeWorkStats_Operation.type:type_name -> steam.ESteamPipeOperationType
	0,  // 4: steam.CClientMetrics_SteamPipeWorkStats_Notification.work_type:type_name -> steam.ESteamPipeWorkType
	9,  // 5: steam.CClientMetrics_SteamPipeWorkStats_Notification.operations:type_name -> steam.CClientMetrics_SteamPipeWorkStats_Operation
	25, // 6: steam.CClientMetrics_ReportReactUsage_Notification.routes:type_name -> steam.CClientMetrics_ReportReactUsage_Notification.RouteData
	26, // 7: steam.CClientMetrics_ReportReactUsage_Notification.components:type_name -> steam.CClientMetrics_ReportReactUsage_Notification.ComponentData
	27, // 8: steam.CClientMetrics_ReportReactUsage_Notification.actions:type_name -> steam.CClientMetrics_ReportReactUsage_Notification.ActionData
	28, // 9: steam.CClientMetrics_ReportClientError_Notification.errors:type_name -> steam.CClientMetrics_ReportClientError_Notification.Error
	32, // 10: steam.CClientMetrics_ClientBootstrap_Notification.summary:type_name -> steam.CClientMetrics_ClientBootstrap_Summary
	29, // 11: steam.CClientMetrics_DownloadRates_Notification.stats:type_name -> steam.CClientMetrics_DownloadRates_Notification.StatsInfo
	33, // 12: steam.CClientMetrics_ContentDownloadResponse_Counts_Notification.data:type_name -> steam.CClientMetrics_ContentDownloadResponse_Hosts
	34, // 13: steam.CClientMetrics_ReportClientArgs_Notification.gr_mode:type_name -> steam.EGRMode
	2,  // 14: steam.CClientMetrics_ClipShare_Notification.share_method:type_name -> steam.EClipShareMethod
	3,  // 15: steam.CClientMetrics_ClipRange_Notification.original_range_method:type_name -> steam.EClipRangeMethod
	30, // 16: steam.CClientMetrics_ClipRange_Notification.start:type_name -> steam.CClientMetrics_ClipRange_Notification.RelativeRangeEdge
	30, // 17: steam.CClientMetrics_ClipRange_Notification.end:type_name -> steam.CClientMetrics_ClipRange_Notification.RelativeRangeEdge
	35, // 18: steam.CClientMetrics_EndGameRecording_Notification.recording_type:type_name -> steam.EGameRecordingType
	31, // 19: steam.CClientMetrics_GamePerformance_Notification.frame_rates:type_name -> steam.CClientMetrics_GamePerformance_Notification.FrameRate
	36, // 20: steam.CClientMetrics_GamePerformance_Notification.system_info:type_name -> steam.UserSystemInformation
	3,  // 21: steam.CClientMetrics_ClipRange_Notification.RelativeRangeEdge.original_range_method:type_name -> steam.EClipRangeMethod
	3,  // 22: steam.CClientMetrics_ClipRange_Notification.RelativeRangeEdge.latest_range_method:type_name -> steam.EClipRangeMethod
	6,  // 23: steam.ClientMetrics.ClientAppInterfaceStatsReport:input_type -> steam.CClientMetrics_AppInterfaceStats_Notification
	8,  // 24: steam.ClientMetrics.ClientIPv6ConnectivityReport:input_type -> steam.CClientMetrics_IPv6Connectivity_Notification
	10, // 25: steam.ClientMetrics.SteamPipeWorkStatsReport:input_type -> steam.CClientMetrics_SteamPipeWorkStats_Notification
	11, // 26: steam.ClientMetrics.ReportReactUsage:input_type -> steam.CClientMetrics_ReportReactUsage_Notification
	12, // 27: steam.ClientMetrics.ReportClientError:input_type -> steam.CClientMetrics_ReportClientError_Notification
	13, // 28: steam.ClientMetrics.ClientBootstrapReport:input_type -> steam.CClientMetrics_ClientBootstrap_Notification
	14, // 29: steam.ClientMetrics.ClientDownloadRatesReport:input_type -> steam.CClientMetrics_DownloadRates_Notification
	15, // 30: steam.ClientMetrics.ClientContentValidationReport:input_type -> steam.CClientMetrics_ContentValidation_Notification
	16, // 31: steam.ClientMetrics.ClientCloudAppSyncStats:input_type -> steam.CClientMetrics_CloudAppSyncStats_Notification
	17, // 32: steam.ClientMetrics.ClientDownloadResponseCodeCounts:input_type -> steam.CClientMetrics_ContentDownloadResponse_Counts_Notification
	18, // 33: steam.ClientMetrics.ReportClientArgs:input_type -> steam.CClientMetrics_ReportClientArgs_Notification
	19, // 34: steam.ClientMetrics.ReportLinuxStats:input_type -> steam.CClientMetrics_ReportLinuxStats_Notification
	20, // 35: steam.ClientMetrics.ReportAccessibilitySettings:input_type -> steam.CClientMetrics_ReportAccessibilitySettings_Notification
	21, // 36: steam.ClientMetrics.ReportClipShare:input_type -> steam.CClientMetrics_ClipShare_Notification
	22, // 37: steam.ClientMetrics.ReportClipRange:input_type -> steam.CClientMetrics_ClipRange_Notification
	23, // 38: steam.ClientMetrics.ReportEndGameRecording:input_type -> steam.CClientMetrics_EndGameRecording_Notification
	24, // 39: steam.ClientMetrics.ReportGamePerformance:input_type -> steam.CClientMetrics_GamePerformance_Notification
	37, // 40: steam.ClientMetrics.ClientAppInterfaceStatsReport:output_type -> steam.NoResponse
	37, // 41: steam.ClientMetrics.ClientIPv6ConnectivityReport:output_type -> steam.NoResponse
	37, // 42: steam.ClientMetrics.SteamPipeWorkStatsReport:output_type -> steam.NoResponse
	37, // 43: steam.ClientMetrics.ReportReactUsage:output_type -> steam.NoResponse
	37, // 44: steam.ClientMetrics.ReportClientError:output_type -> steam.NoResponse
	37, // 45: steam.ClientMetrics.ClientBootstrapReport:output_type -> steam.NoResponse
	37, // 46: steam.ClientMetrics.ClientDownloadRatesReport:output_type -> steam.NoResponse
	37, // 47: steam.ClientMetrics.ClientContentValidationReport:output_type -> steam.NoResponse
	37, // 48: steam.ClientMetrics.ClientCloudAppSyncStats:output_type -> steam.NoResponse
	37, // 49: steam.ClientMetrics.ClientDownloadResponseCodeCounts:output_type -> steam.NoResponse
	37, // 50: steam.ClientMetrics.ReportClientArgs:output_type -> steam.NoResponse
	37, // 51: steam.ClientMetrics.ReportLinuxStats:output_type -> steam.NoResponse
	37, // 52: steam.ClientMetrics.ReportAccessibilitySettings:output_type -> steam.NoResponse
	37, // 53: steam.ClientMetrics.ReportClipShare:output_type -> steam.NoResponse
	37, // 54: steam.ClientMetrics.ReportClipRange:output_type -> steam.NoResponse
	37, // 55: steam.ClientMetrics.ReportEndGameRecording:output_type -> steam.NoResponse
	37, // 56: steam.ClientMetrics.ReportGamePerformance:output_type -> steam.NoResponse
