...
const file_steammessages_credentials_steamclient_proto_rawDesc = "" +
	"\n" +
	"+steammessages_credentials.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"\xeb\x01\n" +
	...
	"\x14deprecated_ipaddress\x18\x04 \x01(\x05R\x13deprecatedIpaddress\x123\n" +
	"\n" +
	"ip_address\x18\x05 \x01(\v2\x14.steam.CMsgIPAddressR\tipAddress\"\xd9\t\n" +
	...
	"\x15deprecated_machine_id\x18\a \x01(\x04R\x13deprecatedMachineId\x12`\n" +
	"\fsession_data\x18\b \x03(\v2=.steam.CCredentials_GetSteamGuardDetails_Response.SessionDataR\vsessionData\x120\n" +
	...
	"\x06secret\x18\x02 \x01(\fR\x06secret2\x9e\x05\n" +
	"\vCredentials\x12{\n" +
	"\x14GetSteamGuardDetails\x120.steam.CCredentials_GetSteamGuardDetails_Request\x1a1.steam.CCredentials_GetSteamGuardDetails_Response\x12{\n" +
	"\x14ValidateEmailAddress\x120.steam.CCredentials_ValidateEmailAddress_Request\x1a1.steam.CCredentials_ValidateEmailAddress_Response\x12\x87\x01\n" +
	"\x18SteamGuardPhishingReport\x124.steam.CCredentials_SteamGuardPhishingReport_Request\x1a5.steam.CCredentials_SteamGuardPhishingReport_Response\x12\x8d\x01\n" +
	"\x1eGetCredentialChangeTimeDetails\x124.steam.CCredentials_LastCredentialChangeTime_Request\x1a5.steam.CCredentials_LastCredentialChangeTime_Response\x12{\n" +
	"\x14GetAccountAuthSecret\x120.steam.CCredentials_GetAccountAuthSecret_Request\x1a1.steam.CCredentials_GetAccountAuthSecret_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_credentials_steamclient_proto_goTypes = []any{
	(*CCredentials_GetSteamGuardDetails_Request)(nil),              // 0: steam.CCredentials_GetSteamGuardDetails_Request
	(*CCredentials_GetSteamGuardDetails_Response)(nil),             // 1: steam.CCredentials_GetSteamGuardDetails_Response
	(*CCredentials_ValidateEmailAddress_Request)(nil),              // 2: steam.CCredentials_ValidateEmailAddress_Request
	(*CCredentials_ValidateEmailAddress_Response)(nil),             // 3: steam.CCredentials_ValidateEmailAddress_Response
	(*CCredentials_SteamGuardPhishingReport_Request)(nil),          // 4: steam.CCredentials_SteamGuardPhishingReport_Request
	(*CCredentials_SteamGuardPhishingReport_Response)(nil),         // 5: steam.CCredentials_SteamGuardPhishingReport_Response
	(*CCredentials_LastCredentialChangeTime_Request)(nil),          // 6: steam.CCredentials_LastCredentialChangeTime_Request
	(*CCredentials_LastCredentialChangeTime_Response)(nil),         // 7: steam.CCredentials_LastCredentialChangeTime_Response
	(*CCredentials_GetAccountAuthSecret_Request)(nil),              // 8: steam.CCredentials_GetAccountAuthSecret_Request
	(*CCredentials_GetAccountAuthSecret_Response)(nil),             // 9: steam.CCredentials_GetAccountAuthSecret_Response
	(*CCredentials_GetSteamGuardDetails_Response_SessionData)(nil), // 10: steam.CCredentials_GetSteamGuardDetails_Response.SessionData
	(*CMsgIPAddress)(nil),                                          // 11: steam.CMsgIPAddress
}
var file_steammessages_credentials_steamclient_proto_depIdxs = []int32{
	11, // 0: steam.CCredentials_GetSteamGuardDetails_Request.ip_address:type_name -> steam.CMsgIPAddress
	10, // 1: steam.CCredentials_GetSteamGuardDetails_Response.session_data:type_name -> steam.CCredentials_GetSteamGuardDetails_Response.SessionData
	0,  // 2: steam.Credentials.GetSteamGuardDetails:input_type -> steam.CCredentials_GetSteamGuardDetails_Request
	2,  // 3: steam.Credentials.ValidateEmailAddress:input_type -> steam.CCredentials_ValidateEmailAddress_Request
	4,  // 4: steam.Credentials.SteamGuardPhishingReport:input_type -> steam.CCredentials_SteamGuardPhishingReport_Request
	6,  // 5: steam.Credentials.GetCredentialChangeTimeDetails:input_type -> steam.CCredentials_LastCredentialChangeTime_Request
	8,  // 6: steam.Credentials.GetAccountAuthSecret:input_type -> steam.CCredentials_GetAccountAuthSecret_Request
	1,  // 7: steam.Credentials.GetSteamGuardDetails:output_type -> steam.CCredentials_GetSteamGuardDetails_Response
	3,  // 8: steam.Credentials.ValidateEmailAddress:output_type -> steam.CCredentials_ValidateEmailAddress_Response
	5,  // 9: steam.Credentials.SteamGuardPhishingReport:output_type -> steam.CCredentials_SteamGuardPhishingReport_Response
	7,  // 10: steam.Credentials.GetCredentialChangeTimeDetails:output_type -> steam.CCredentials_LastCredentialChangeTime_Response
	9,  // 11: steam.Credentials.GetAccountAuthSecret:output_type -> steam.CCredentials_GetAccountAuthSecret_Response
