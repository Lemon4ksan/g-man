...
type CMsgProtoBufHeader struct {
	...
	SessionDisposition          *CMsgProtoBufHeader_ESessionDisposition `protobuf:"varint,38,opt,name=session_disposition,json=sessionDisposition,enum=steam.CMsgProtoBufHeader_ESessionDisposition,def=0" json:"session_disposition,omitempty"`
...
type CCommunity_ClanAnnouncementInfo struct {
	...
	BanCheckResult *EBanContentCheckResult `protobuf:"varint,16,opt,name=ban_check_result,json=banCheckResult,enum=steam.EBanContentCheckResult,def=0" json:"ban_check_result,omitempty"`
...
var file_steammessages_base_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		ExtensionType: (*bool)(nil),
		Field:         50024,
		Name:          "steam.allow_field_named_steam_id",
...
const file_steammessages_base_proto_rawDesc = "" +
	"\n" +
	"\x18steammessages_base.proto\x12\x05steam\x1a google/protobuf/descriptor.proto\"9\n" +
	"\rCMsgIPAddress\x12\x10\n" +
	"\x02v4\x18\x01 \x01(\aH\x00R\x02v4\x12\x10\n" +
	"\x02v6\x18\x02 \x01(\fH\x00R\x02v6B\x04\n" +
	"\x02ip\"s\n" +
	"\x13CMsgIPAddressBucket\x12D\n" +
	"\x13original_ip_address\x18\x01 \x01(\v2\x14.steam.CMsgIPAddressR\x11originalIpAddress\x12\x16\n" +
	...
	"\x10dst_gc_dir_index\x18\x02 \x01(\rR\rdstGcDirIndex\"\xe4\f\n" +
	...
	"\btoken_id\x18$ \x01(\x04R\atokenId\x12A\n" +
	"\n" +
	"routing_gc\x18% \x01(\v2\".steam.CMsgGCRoutingProtoBufHeaderR\troutingGc\x12{\n" +
	"\x13session_disposition\x18& \x01(\x0e2-.steam.CMsgProtoBufHeader.ESessionDisposition:\x1bk_ESessionDispositionNormalR\x12sessionDisposition\x12\x19\n" +
	...
	"\x03hdr\x18\x01 \x01(\v2\x1c.steam.CMsgKubeRPCPacket.HdrR\x03hdr\x12\x18\n" +
	...
	" \x01(\rR\x13rtime32LastModified\"\xb2\x01\n" +
	"\x16CClanMatchEventByRange\x12!\n" +
	"\frtime_before\x18\x01 \x01(\rR\vrtimeBefore\x12\x1f\n" +
	"\vrtime_after\x18\x02 \x01(\rR\n" +
	"rtimeAfter\x12\x1c\n" +
	"\tqualified\x18\x03 \x01(\rR\tqualified\x126\n" +
	"\x06events\x18\x04 \x03(\v2\x1e.steam.CClanEventUserNewsTupleR\x06events\"\xd0\x04\n" +
	...
	"\rvotedowncount\x18\x0f \x01(\x05R\rvotedowncount\x12l\n" +
	"\x10ban_check_result\x18\x10 \x01(\x0e2\x1d.steam.EBanContentCheckResult:#k_EBanContentCheckResult_NotScannedR\x0ebanCheckResult\x12\x16\n" +
	"\x06banned\x18\x11 \x01(\bR\x06banned\"\x86\n" +
	"\n" +
	"\x0eCClanEventData\x12\x10\n" +
	"\x03gid\x18\x01 \x01(\x06R\x03gid\x12!\n" +
	"\fclan_steamid\x18\x02 \x01(\x06R\vclanSteamid\x12\x1d\n" +
	"\n" +
	"event_name\x18\x03 \x01(\tR\teventName\x12L\n" +
	"\n" +
	"event_type\x18\x04 \x01(\x0e2\x1a.steam.EProtoClanEventType:\x11k_EClanOtherEventR\teventType\x12\x14\n" +
	...
	"eventNotes\x12\x1a\n" +
	"\bjsondata\x18\x0e \x01(\tR\bjsondata\x12S\n" +
	"\x11announcement_body\x18\x0f \x01(\v2&.steam.CCommunity_ClanAnnouncementInfoR\x10announcementBody\x12\x1c\n" +
	...
	"\x05pairs\x18\x01 \x03(\v2\x17.steam.CMsgKeyValuePairR\x05pairs\"\x93\x02\n" +
	" UserContentDescriptorPreferences\x12~\n" +
	"\x1econtent_descriptors_to_exclude\x18\x01 \x03(\v29.steam.UserContentDescriptorPreferences.ContentDescriptorR\x1bcontentDescriptorsToExclude\x1ao\n" +
	"\x11ContentDescriptor\x121\n" +
	"\x14content_descriptorid\x18\x01 \x01(\rR\x13contentDescriptorid\x12'\n" +
	"\x0ftimestamp_added\x18\x02 \x01(\rR\x0etimestampAdded\"\xf1\x04\n" +
	...
	"\rscreen_height\x18\x13 \x01(\rR\fscreenHeight*\xd8\x02\n" +
	...
	"\x1aallow_field_named_steam_id\x12\x1d.google.protobuf.FieldOptions\x18\xe8\x86\x03 \x01(\b:\x05falseR\x16allowFieldNamedSteamIdB2H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam"
...
var file_steammessages_base_proto_goTypes = []any{
	(EBanContentCheckResult)(0),                                // 0: steam.EBanContentCheckResult
	(EProtoClanEventType)(0),                                   // 1: steam.EProtoClanEventType
	(PartnerEventNotificationType)(0),                          // 2: steam.PartnerEventNotificationType
	(CMsgProtoBufHeader_ESessionDisposition)(0),                // 3: steam.CMsgProtoBufHeader.ESessionDisposition
	(*CMsgIPAddress)(nil),                                      // 4: steam.CMsgIPAddress
	(*CMsgIPAddressBucket)(nil),                                // 5: steam.CMsgIPAddressBucket
	(*CMsgGCRoutingProtoBufHeader)(nil),                        // 6: steam.CMsgGCRoutingProtoBufHeader
	(*CMsgProtoBufHeader)(nil),                                 // 7: steam.CMsgProtoBufHeader
	(*CMsgKubeRPCPacket)(nil),                                  // 8: steam.CMsgKubeRPCPacket
	(*CMsgMulti)(nil),                                          // 9: steam.CMsgMulti
	(*CMsgProtobufWrapped)(nil),                                // 10: steam.CMsgProtobufWrapped
	(*CMsgAuthTicket)(nil),                                     // 11: steam.CMsgAuthTicket
	(*CCDDBAppDetailCommon)(nil),                               // 12: steam.CCDDBAppDetailCommon
	(*CMsgAppRights)(nil),                                      // 13: steam.CMsgAppRights
	(*CCuratorPreferences)(nil),                                // 14: steam.CCuratorPreferences
	(*CLocalizationToken)(nil),                                 // 15: steam.CLocalizationToken
	(*CClanEventUserNewsTuple)(nil),                            // 16: steam.CClanEventUserNewsTuple
	(*CClanMatchEventByRange)(nil),                             // 17: steam.CClanMatchEventByRange
	(*CCommunity_ClanAnnouncementInfo)(nil),                    // 18: steam.CCommunity_ClanAnnouncementInfo
	(*CClanEventData)(nil),                                     // 19: steam.CClanEventData
	(*CBilling_Address)(nil),                                   // 20: steam.CBilling_Address
	(*CPackageReservationStatus)(nil),                          // 21: steam.CPackageReservationStatus
	(*CMsgKeyValuePair)(nil),                                   // 22: steam.CMsgKeyValuePair
	(*CMsgKeyValueSet)(nil),                                    // 23: steam.CMsgKeyValueSet
	(*UserContentDescriptorPreferences)(nil),                   // 24: steam.UserContentDescriptorPreferences
	(*UserSystemInformation)(nil),                              // 25: steam.UserSystemInformation
	(*CMsgKubeRPCPacket_Hdr)(nil),                              // 26: steam.CMsgKubeRPCPacket.Hdr
	(*UserContentDescriptorPreferences_ContentDescriptor)(nil), // 27: steam.UserContentDescriptorPreferences.ContentDescriptor
...
var file_steammessages_base_proto_depIdxs = []int32{
	4,  // 0: steam.CMsgIPAddressBucket.original_ip_address:type_name -> steam.CMsgIPAddress
	6,  // 1: steam.CMsgProtoBufHeader.routing_gc:type_name -> steam.CMsgGCRoutingProtoBufHeader
	3,  // 2: steam.CMsgProtoBufHeader.session_disposition:type_name -> steam.CMsgProtoBufHeader.ESessionDisposition
	26, // 3: steam.CMsgKubeRPCPacket.hdr:type_name -> steam.CMsgKubeRPCPacket.Hdr
	16, // 4: steam.CClanMatchEventByRange.events:type_name -> steam.CClanEventUserNewsTuple
	0,  // 5: steam.CCommunity_ClanAnnouncementInfo.ban_check_result:type_name -> steam.EBanContentCheckResult
	1,  // 6: steam.CClanEventData.event_type:type_name -> steam.EProtoClanEventType
	18, // 7: steam.CClanEventData.announcement_body:type_name -> steam.CCommunity_ClanAnnouncementInfo
	22, // 8: steam.CMsgKeyValueSet.pairs:type_name -> steam.CMsgKeyValuePair
	27, // 9: steam.UserContentDescriptorPreferences.content_descriptors_to_exclude:type_name -> steam.UserContentDescriptorPreferences.ContentDescriptor
	28, // 10: steam.msgpool_soft_limit:extendee -> google.protobuf.MessageOptions
	28, // 11: steam.msgpool_hard_limit:extendee -> google.protobuf.MessageOptions
	29, // 12: steam.php_output_always_number:extendee -> google.protobuf.FieldOptions
	29, // 13: steam.allow_field_named_steam_id:extendee -> google.protobuf.FieldOptions
