...
const file_steammessages_inventory_steamclient_proto_rawDesc = "" +
	"\n" +
	")steammessages_inventory.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"Q\n" +
	...
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12\x18\n" +
	"\asteamid\x18\x02 \x01(\x04R\asteamid\x12R\n" +
	"\aupdates\x18\x03 \x03(\v28.steam.CInventory_ModifyItems_Request.ItemPropertyUpdateR\aupdates\x12\x1c\n" +
	...
	"\tecurrency\x18\x01 \x01(\x05R\tecurrency\"\xe9\x01\n" +
	"\x1fCInventory_PurchaseInit_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\x05R\blanguage\x12N\n" +
	"\n" +
	"line_items\x18\x03 \x03(\v2/.steam.CInventory_PurchaseInit_Request.LineItemR\tlineItems\x1aD\n" +
	"\bLineItem\x12\x1c\n" +
	...
	"\x04tags\x18\x03 \x01(\tR\x04tags\"\x89\x01\n" +
	"&CInventoryClient_NewItems_Notification\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12I\n" +
	"\x12inventory_response\x18\x02 \x01(\v2\x1a.steam.CInventory_ResponseR\x11inventoryResponse2\xdc\v\n" +
	"\tInventory\x12R\n" +
	"\fGetInventory\x12&.steam.CInventory_GetInventory_Request\x1a\x1a.steam.CInventory_Response\x12R\n" +
	"\fExchangeItem\x12&.steam.CInventory_ExchangeItem_Request\x1a\x1a.steam.CInventory_Response\x12\x89\x01\n" +
	"\x1aGetEligiblePromoItemDefIDs\x124.steam.CInventory_GetEligiblePromoItemDefIDs_Request\x1a5.steam.CInventory_GetEligiblePromoItemDefIDs_Response\x12M\n" +
	"\fAddPromoItem\x12!.steam.CInventory_AddItem_Request\x1a\x1a.steam.CInventory_Response\x12T\n" +
	"\x0fSafeModifyItems\x12%.steam.CInventory_ModifyItems_Request\x1a\x1a.steam.CInventory_Response\x12X\n" +
	"\x0fConsumePlaytime\x12).steam.CInventory_ConsumePlaytime_Request\x1a\x1a.steam.CInventory_Response\x12P\n" +
	"\vConsumeItem\x12%.steam.CInventory_ConsumeItem_Request\x1a\x1a.steam.CInventory_Response\x12P\n" +
	"\x0fDevGenerateItem\x12!.steam.CInventory_AddItem_Request\x1a\x1a.steam.CInventory_Response\x12V\n" +
	"\x0eDevSetNextDrop\x12(.steam.CInventory_DevSetNextDrop_Request\x1a\x1a.steam.CInventory_Response\x12V\n" +
	"\x0eSplitItemStack\x12(.steam.CInventory_SplitItemStack_Request\x1a\x1a.steam.CInventory_Response\x12\\\n" +
	"\x11CombineItemStacks\x12+.steam.CInventory_CombineItemStacks_Request\x1a\x1a.steam.CInventory_Response\x12e\n" +
	"\x0eGetItemDefMeta\x12(.steam.CInventory_GetItemDefMeta_Request\x1a).steam.CInventory_GetItemDefMeta_Response\x12t\n" +
	"\x13GetUserPurchaseInfo\x12-.steam.CInventory_GetUserPurchaseInfo_Request\x1a..steam.CInventory_GetUserPurchaseInfo_Response\x12_\n" +
	"\fPurchaseInit\x12&.steam.CInventory_PurchaseInit_Request\x1a'.steam.CInventory_PurchaseInit_Response\x12Z\n" +
	"\x10PurchaseFinalize\x12*.steam.CInventory_PurchaseFinalize_Request\x1a\x1a.steam.CInventory_Response\x12P\n" +
	"\vInspectItem\x12%.steam.CInventory_InspectItem_Request\x1a\x1a.steam.CInventory_Response2k\n" +
	"\x0fInventoryClient\x12R\n" +
	"\x0eNotifyNewItems\x12-.steam.CInventoryClient_NewItems_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x02B3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_inventory_steamclient_proto_goTypes = []any{
	...
	(*CInventory_InspectItem_Request)(nil),                    // 19: steam.CInventory_InspectItem_Request
	(*CInventoryClient_NewItems_Notification)(nil),            // 20: steam.CInventoryClient_NewItems_Notification
	(*CInventory_ModifyItems_Request_ItemPropertyUpdate)(nil), // 21: steam.CInventory_ModifyItems_Request.ItemPropertyUpdate
	(*CInventory_PurchaseInit_Request_LineItem)(nil),          // 22: steam.CInventory_PurchaseInit_Request.LineItem
	(*NoResponse)(nil),                                        // 23: steam.NoResponse
}
var file_steammessages_inventory_steamclient_proto_depIdxs = []int32{
	21, // 0: steam.CInventory_ModifyItems_Request.updates:type_name -> steam.CInventory_ModifyItems_Request.ItemPropertyUpdate
	22, // 1: steam.CInventory_PurchaseInit_Request.line_items:type_name -> steam.CInventory_PurchaseInit_Request.LineItem
	...
	19, // 18: steam.Inventory.InspectItem:input_type -> steam.CInventory_InspectItem_Request
	20, // 19: steam.InventoryClient.NotifyNewItems:input_type -> steam.CInventoryClient_NewItems_Notification
	1,  // 20: steam.Inventory.GetInventory:output_type -> steam.CInventory_Response
	1,  // 21: steam.Inventory.ExchangeItem:output_type -> steam.CInventory_Response
	4,  // 22: steam.Inventory.GetEligiblePromoItemDefIDs:output_type -> steam.CInventory_GetEligiblePromoItemDefIDs_Response
	1,  // 23: steam.Inventory.AddPromoItem:output_type -> steam.CInventory_Response
	1,  // 24: steam.Inventory.SafeModifyItems:output_type -> steam.CInventory_Response
	1,  // 25: steam.Inventory.ConsumePlaytime:output_type -> steam.CInventory_Response
	1,  // 26: steam.Inventory.ConsumeItem:output_type -> steam.CInventory_Response
	1,  // 27: steam.Inventory.DevGenerateItem:output_type -> steam.CInventory_Response
	1,  // 28: steam.Inventory.DevSetNextDrop:output_type -> steam.CInventory_Response
	1,  // 29: steam.Inventory.SplitItemStack:output_type -> steam.CInventory_Response
	1,  // 30: steam.Inventory.CombineItemStacks:output_type -> steam.CInventory_Response
	13, // 31: steam.Inventory.GetItemDefMeta:output_type -> steam.CInventory_GetItemDefMeta_Response
	15, // 32: steam.Inventory.GetUserPurchaseInfo:output_type -> steam.CInventory_GetUserPurchaseInfo_Response
	17, // 33: steam.Inventory.PurchaseInit:output_type -> steam.CInventory_PurchaseInit_Response
	1,  // 34: steam.Inventory.PurchaseFinalize:output_type -> steam.CInventory_Response
	1,  // 35: steam.Inventory.InspectItem:output_type -> steam.CInventory_Response
	23, // 36: steam.InventoryClient.NotifyNewItems:output_type -> steam.NoResponse
