...
const file_steamnetworkingsockets_messages_udp_proto_rawDesc = "" +
	"\n" +
	")steamnetworkingsockets_messages_udp.proto\x12\x05steam\x1a+steamnetworkingsockets_messages_certs.proto\x1a%steamnetworkingsockets_messages.proto\"\x9a\x01\n" +
	...
	"\x10protocol_version\x18\x04 \x01(\rR\x0fprotocolVersion\"\xb9\x04\n" +
	...
	"\vping_est_ms\x18\x06 \x01(\rR\tpingEstMs\x12D\n" +
	"\x05crypt\x18\a \x01(\v2..steam.CMsgSteamDatagramSessionCryptInfoSignedR\x05crypt\x12=\n" +
	"\x04cert\x18\x04 \x01(\v2).steam.CMsgSteamDatagramCertificateSignedR\x04cert\x126\n" +
	"\x17legacy_protocol_version\x18\b \x01(\rR\x15legacyProtocolVersion\x12'\n" +
	"\x0fidentity_string\x18\n" +
	" \x01(\tR\x0eidentityString\x123\n" +
	"\x16legacy_client_steam_id\x18\x03 \x01(\x06R\x13legacyClientSteamId\x12d\n" +
	"\x16legacy_identity_binary\x18\t \x01(\v2..steam.CMsgSteamNetworkingIdentityLegacyBinaryR\x14legacyIdentityBinary\"\x9c\x04\n" +
	...
	"\x0eyour_timestamp\x18\x03 \x01(\x06R\ryourTimestamp\x12&\n" +
	"\x0fdelay_time_usec\x18\x04 \x01(\rR\rdelayTimeUsec\x12D\n" +
	"\x05crypt\x18\a \x01(\v2..steam.CMsgSteamDatagramSessionCryptInfoSignedR\x05crypt\x12=\n" +
	"\x04cert\x18\b \x01(\v2).steam.CMsgSteamDatagramCertificateSignedR\x04cert\x12'\n" +
	"\x0fidentity_string\x18\v \x01(\tR\x0eidentityString\x123\n" +
	"\x16legacy_server_steam_id\x18\x02 \x01(\x06R\x13legacyServerSteamId\x12d\n" +
	"\x16legacy_identity_binary\x18\n" +
	" \x01(\v2..steam.CMsgSteamNetworkingIdentityLegacyBinaryR\x14legacyIdentityBinary\"\xb6\x01\n" +
	...
	"\x10to_connection_id\x18\x03 \x01(\aR\x0etoConnectionId\"\xcb\x01\n" +
	"\x1aCMsgSteamSockets_UDP_Stats\x12?\n" +
	"\x05stats\x18\x01 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\x05stats\x12\x14\n" +
	...
	"%k_ESteamNetworkingUDPMsg_NoConnection\x10%B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steamnetworkingsockets_messages_udp_proto_goTypes = []any{
	(ESteamNetworkingUDPMsgID)(0),                   // 0: steam.ESteamNetworkingUDPMsgID
	(CMsgSteamSockets_UDP_Stats_Flags)(0),           // 1: steam.CMsgSteamSockets_UDP_Stats.Flags
	(*CMsgSteamSockets_UDP_ChallengeRequest)(nil),   // 2: steam.CMsgSteamSockets_UDP_ChallengeRequest
	(*CMsgSteamSockets_UDP_ChallengeReply)(nil),     // 3: steam.CMsgSteamSockets_UDP_ChallengeReply
	(*CMsgSteamSockets_UDP_ConnectRequest)(nil),     // 4: steam.CMsgSteamSockets_UDP_ConnectRequest
	(*CMsgSteamSockets_UDP_ConnectOK)(nil),          // 5: steam.CMsgSteamSockets_UDP_ConnectOK
	(*CMsgSteamSockets_UDP_ConnectionClosed)(nil),   // 6: steam.CMsgSteamSockets_UDP_ConnectionClosed
	(*CMsgSteamSockets_UDP_NoConnection)(nil),       // 7: steam.CMsgSteamSockets_UDP_NoConnection
	(*CMsgSteamSockets_UDP_Stats)(nil),              // 8: steam.CMsgSteamSockets_UDP_Stats
	(*CMsgSteamDatagramSessionCryptInfoSigned)(nil), // 9: steam.CMsgSteamDatagramSessionCryptInfoSigned
	(*CMsgSteamDatagramCertificateSigned)(nil),      // 10: steam.CMsgSteamDatagramCertificateSigned
	(*CMsgSteamNetworkingIdentityLegacyBinary)(nil), // 11: steam.CMsgSteamNetworkingIdentityLegacyBinary
	(*CMsgSteamDatagramConnectionQuality)(nil),      // 12: steam.CMsgSteamDatagramConnectionQuality
}
var file_steamnetworkingsockets_messages_udp_proto_depIdxs = []int32{
	9,  // 0: steam.CMsgSteamSockets_UDP_ConnectRequest.crypt:type_name -> steam.CMsgSteamDatagramSessionCryptInfoSigned
	10, // 1: steam.CMsgSteamSockets_UDP_ConnectRequest.cert:type_name -> steam.CMsgSteamDatagramCertificateSigned
	11, // 2: steam.CMsgSteamSockets_UDP_ConnectRequest.legacy_identity_binary:type_name -> steam.CMsgSteamNetworkingIdentityLegacyBinary
	9,  // 3: steam.CMsgSteamSockets_UDP_ConnectOK.crypt:type_name -> steam.CMsgSteamDatagramSessionCryptInfoSigned
	10, // 4: steam.CMsgSteamSockets_UDP_ConnectOK.cert:type_name -> steam.CMsgSteamDatagramCertificateSigned
	11, // 5: steam.CMsgSteamSockets_UDP_ConnectOK.legacy_identity_binary:type_name -> steam.CMsgSteamNetworkingIdentityLegacyBinary
	12, // 6: steam.CMsgSteamSockets_UDP_Stats.stats:type_name -> steam.CMsgSteamDatagramConnectionQuality
