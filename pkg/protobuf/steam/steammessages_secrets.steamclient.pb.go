...
const file_steammessages_secrets_steamclient_proto_rawDesc = "" +
	"\n" +
	"'steammessages_secrets.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"\xd0\x01\n" +
	"\x12CKeyEscrow_Request\x12-\n" +
	"\x13rsa_oaep_sha_ticket\x18\x01 \x01(\fR\x10rsaOaepShaTicket\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\fR\bpassword\x12N\n" +
	"\x05usage\x18\x03 \x01(\x0e2\x16.steam.EKeyEscrowUsage: k_EKeyEscrowUsageStreamingDeviceR\x05usage\x12\x1f\n" +
	...
	"\ttimestamp\x18\x04 \x01(\rR\ttimestamp\x12N\n" +
	"\x05usage\x18\x05 \x01(\x0e2\x16.steam.EKeyEscrowUsage: k_EKeyEscrowUsageStreamingDeviceR\x05usage\x12\x1f\n" +
	"\vdevice_name\x18\x06 \x01(\tR\n" +
	"deviceName\x12!\n" +
	"\fdevice_model\x18\a \x01(\tR\vdeviceModel\x12#\n" +
	"\rdevice_serial\x18\b \x01(\tR\fdeviceSerial\x124\n" +
	"\x16device_provisioning_id\x18\t \x01(\rR\x14deviceProvisioningId\"G\n" +
	"\x13CKeyEscrow_Response\x120\n" +
	"\x06ticket\x18\x01 \x01(\v2\x18.steam.CKeyEscrow_TicketR\x06ticket*7\n" +
	"\x0fEKeyEscrowUsage\x12$\n" +
	" k_EKeyEscrowUsageStreamingDevice\x10\x002M\n" +
	"\aSecrets\x12B\n" +
	"\tKeyEscrow\x12\x19.steam.CKeyEscrow_Request\x1a\x1a.steam.CKeyEscrow_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
