...
func (*CMsgRemoteClientAppStatus_AppStatus) Descriptor() ([]byte, []int) {
	return file_steammessages_remoteclient_proto_rawDescGZIP(), []int{6, 0}
}
...
func (*CMsgRemoteClientAppStatus_ShortcutInfo) Descriptor() ([]byte, []int) {
	return file_steammessages_remoteclient_proto_rawDescGZIP(), []int{6, 1}
}
...
func (*CMsgRemoteClientStartStream_ReservedGamepad) Descriptor() ([]byte, []int) {
	return file_steammessages_remoteclient_proto_rawDescGZIP(), []int{17, 0}
}
...
const file_steammessages_remoteclient_proto_rawDesc = "" +
	"\n" +
	" steammessages_remoteclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a*steammessages_remoteclient_discovery.proto\"\x96\x01\n" +
	"\x16CMsgRemoteClientStatus\x12\x1b\n" +
	"\tclient_id\x18\x01 \x01(\x04R\bclientId\x12\x1f\n" +
	"\vinstance_id\x18\x02 \x01(\x04R\n" +
	"instanceId\x12>\n" +
	"\x06status\x18\x03 \x01(\v2&.steam.CMsgRemoteClientBroadcastStatusR\x06status\"\xd5\x02\n" +
	...
	"\x06weight\x18\x04 \x01(\x02R\x06weight\"\xf9\x05\n" +
	"\rAppUpdateInfo\x12*\n" +
	...
	"\x18bytes_to_disc_per_second\x18\f \x01(\rR\x14bytesToDiscPerSecond\x12B\n" +
	"\x10progress_weights\x18\r \x03(\v2\x17.steam.AppStageProgressR\x0fprogressWeights\x12.\n" +
	"\x13time_deferred_until\x18\x0e \x01(\rR\x11timeDeferredUntil\x12&\n" +
	"\x0fsource_build_id\x18\x0f \x01(\rR\rsourceBuildId\x12&\n" +
	"\x0ftarget_build_id\x18\x10 \x01(\rR\rtargetBuildId\"\x89\x05\n" +
	"\x19CMsgRemoteClientAppStatus\x12Q\n" +
	"\x0estatus_updates\x18\x01 \x03(\v2*.steam.CMsgRemoteClientAppStatus.AppStatusR\rstatusUpdates\x1a\xa6\x03\n" +
	"\tAppStatus\x12\x15\n" +
	"\x06app_id\x18\x01 \x01(\rR\x05appId\x12*\n" +
	"\x11app_install_state\x18\x02 \x01(\rR\x0fappInstallState\x125\n" +
	"\vupdate_info\x18\x03 \x01(\v2\x14.steam.AppUpdateInfoR\n" +
	"updateInfo\x12R\n" +
	"\rshortcut_info\x18\x04 \x01(\v2-.steam.CMsgRemoteClientAppStatus.ShortcutInfoR\fshortcutInfo\x12,\n" +
	...
	"\x11download_complete\x18\b \x01(\bR\x10downloadComplete\x1ap\n" +
	...
	"categories\x12\x18\n" +
	"\aexepath\x18\x04 \x01(\tR\aexepath\"\xfc\x04\n" +
	"#CMsgRemoteClientDownloadsManagement\x12x\n" +
	"\x16change_queue_placement\x18\x01 \x01(\v2B.steam.CMsgRemoteClientDownloadsManagement.ChangeAppQueuePlacementR\x14changeQueuePlacement\x12r\n" +
	"\x15change_download_index\x18\x02 \x01(\v2>.steam.CMsgRemoteClientDownloadsManagement.ChangeDownloadIndexR\x13changeDownloadIndex\x120\n" +
	...
	"\x06app_id\x18\x02 \x01(\rR\x05appId\"\xf1\x01\n" +
	" CMsgRemoteClientAppUpdateStopped\x12\x15\n" +
	"\x06app_id\x18\x01 \x01(\rR\x05appId\x125\n" +
	"\vupdate_info\x18\x02 \x01(\v2\x14.steam.AppUpdateInfoR\n" +
	"updateInfo\x12!\n" +
	...
	"\x06result\x18\x01 \x01(\rR\x06result\"\x87\x01\n" +
	" CMsgRemoteClientDownloadingAppID\x12,\n" +
	"\x12downloading_app_id\x18\x01 \x01(\rR\x10downloadingAppId\x125\n" +
	"\vupdate_info\x18\x02 \x01(\v2\x14.steam.AppUpdateInfoR\n" +
	"updateInfo\"\xcc\x06\n" +
	...
	"\x14maximum_resolution_y\x18\b \x01(\x05R\x12maximumResolutionY\x12N\n" +
	"\bgamepads\x18\t \x03(\v22.steam.CMsgRemoteClientStartStream.ReservedGamepadR\bgamepads\x121\n" +
	"\x13audio_channel_count\x18\n" +
	" \x01(\x05:\x012R\x11audioChannelCount\x12H\n" +
	"\x13supported_transport\x18\v \x03(\x0e2\x17.steam.EStreamTransportR\x12supportedTransport\x12>\n" +
	...
	"\x12controller_subtype\x18\x02 \x01(\rR\x11controllerSubtype\"\x83\x04\n" +
	...
	"\n" +
	"auth_token\x18\x04 \x01(\fR\tauthToken\x12L\n" +
	"\ttransport\x18\x05 \x01(\x0e2\x17.steam.EStreamTransport:\x15k_EStreamTransportUDPR\ttransport\x12!\n" +
	...
	"!k_ERemoteClientPairWifiAPCanceled\x10\aB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steammessages_remoteclient_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_steammessages_remoteclient_proto_goTypes = []any{
	(ERemoteClientPairWifiAPResult)(0),                                  // 0: steam.ERemoteClientPairWifiAPResult
	(*CMsgRemoteClientStatus)(nil),                                      // 1: steam.CMsgRemoteClientStatus
	(*CMsgRemoteClientDownloadStatus)(nil),                              // 2: steam.CMsgRemoteClientDownloadStatus
	(*CMsgRemoteClientUploadStatus)(nil),                                // 3: steam.CMsgRemoteClientUploadStatus
	(*CMsgRemoteClientRestrictAutoUpdates)(nil),                         // 4: steam.CMsgRemoteClientRestrictAutoUpdates
	(*AppStageProgress)(nil),                                            // 5: steam.AppStageProgress
	(*AppUpdateInfo)(nil),                                               // 6: steam.AppUpdateInfo
	(*CMsgRemoteClientAppStatus)(nil),                                   // 7: steam.CMsgRemoteClientAppStatus
	(*CMsgRemoteClientDownloadsManagement)(nil),                         // 8: steam.CMsgRemoteClientDownloadsManagement
	(*CMsgRemoteClientUpdateDownloadsController)(nil),                   // 9: steam.CMsgRemoteClientUpdateDownloadsController
	(*CMsgRemoteClientPeerContentServerChanged)(nil),                    // 10: steam.CMsgRemoteClientPeerContentServerChanged
	(*CMsgRemoteClientDownloadingAppChanged)(nil),                       // 11: steam.CMsgRemoteClientDownloadingAppChanged
	(*CMsgRemoteClientSuspendLanPeerContent)(nil),                       // 12: steam.CMsgRemoteClientSuspendLanPeerContent
	(*CMsgRemoteClientDownloadScheduleChanged)(nil),                     // 13: steam.CMsgRemoteClientDownloadScheduleChanged
	(*CMsgRemoteClientDownloadScheduleItemChanged)(nil),                 // 14: steam.CMsgRemoteClientDownloadScheduleItemChanged
	(*CMsgRemoteClientAppUpdateStopped)(nil),                            // 15: steam.CMsgRemoteClientAppUpdateStopped
	(*CMsgRemoteClientAppUpdateInfoComplete)(nil),                       // 16: steam.CMsgRemoteClientAppUpdateInfoComplete
	(*CMsgRemoteClientDownloadingAppID)(nil),                            // 17: steam.CMsgRemoteClientDownloadingAppID
	(*CMsgRemoteClientStartStream)(nil),                                 // 18: steam.CMsgRemoteClientStartStream
	(*CMsgRemoteClientStartStreamResponse)(nil),                         // 19: steam.CMsgRemoteClientStartStreamResponse
	(*CMsgRemoteClientPing)(nil),                                        // 20: steam.CMsgRemoteClientPing
	(*CMsgRemoteClientPingResponse)(nil),                                // 21: steam.CMsgRemoteClientPingResponse
	(*CMsgRemoteClientAcceptEULA)(nil),                                  // 22: steam.CMsgRemoteClientAcceptEULA
	(*CMsgRemoteClientGetControllerConfig)(nil),                         // 23: steam.CMsgRemoteClientGetControllerConfig
	(*CMsgRemoteClientGetControllerConfigResponse)(nil),                 // 24: steam.CMsgRemoteClientGetControllerConfigResponse
	(*CMsgRemoteClientStreamingEnabled)(nil),                            // 25: steam.CMsgRemoteClientStreamingEnabled
	(*CMsgRemoteClientWifiAPStatus)(nil),                                // 26: steam.CMsgRemoteClientWifiAPStatus
	(*CMsgRemoteClientPairWifiAP)(nil),                                  // 27: steam.CMsgRemoteClientPairWifiAP
	(*CMsgRemoteClientPairWifiAPResponse)(nil),                          // 28: steam.CMsgRemoteClientPairWifiAPResponse
	(*CMsgRemoteClientAppStatus_AppStatus)(nil),                         // 29: steam.CMsgRemoteClientAppStatus.AppStatus
	(*CMsgRemoteClientAppStatus_ShortcutInfo)(nil),                      // 30: steam.CMsgRemoteClientAppStatus.ShortcutInfo
	(*CMsgRemoteClientDownloadsManagement_ChangeAppQueuePlacement)(nil), // 31: steam.CMsgRemoteClientDownloadsManagement.ChangeAppQueuePlacement
	(*CMsgRemoteClientDownloadsManagement_ChangeDownloadIndex)(nil),     // 32: steam.CMsgRemoteClientDownloadsManagement.ChangeDownloadIndex
	(*CMsgRemoteClientStartStream_ReservedGamepad)(nil),                 // 33: steam.CMsgRemoteClientStartStream.ReservedGamepad
	(*CMsgRemoteClientBroadcastStatus)(nil),                             // 34: steam.CMsgRemoteClientBroadcastStatus
	(EStreamTransport)(0),                                               // 35: steam.EStreamTransport
}
var file_steammessages_remoteclient_proto_depIdxs = []int32{
	34, // 0: steam.CMsgRemoteClientStatus.status:type_name -> steam.CMsgRemoteClientBroadcastStatus
	5,  // 1: steam.AppUpdateInfo.progress_weights:type_name -> steam.AppStageProgress
	29, // 2: steam.CMsgRemoteClientAppStatus.status_updates:type_name -> steam.CMsgRemoteClientAppStatus.AppStatus
	31, // 3: steam.CMsgRemoteClientDownloadsManagement.change_queue_placement:type_name -> steam.CMsgRemoteClientDownloadsManagement.ChangeAppQueuePlacement
	32, // 4: steam.CMsgRemoteClientDownloadsManagement.change_download_index:type_name -> steam.CMsgRemoteClientDownloadsManagement.ChangeDownloadIndex
	6,  // 5: steam.CMsgRemoteClientAppUpdateStopped.update_info:type_name -> steam.AppUpdateInfo
	6,  // 6: steam.CMsgRemoteClientDownloadingAppID.update_info:type_name -> steam.AppUpdateInfo
	33, // 7: steam.CMsgRemoteClientStartStream.gamepads:type_name -> steam.CMsgRemoteClientStartStream.ReservedGamepad
	35, // 8: steam.CMsgRemoteClientStartStream.supported_transport:type_name -> steam.EStreamTransport
	35, // 9: steam.CMsgRemoteClientStartStreamResponse.transport:type_name -> steam.EStreamTransport
	6,  // 10: steam.CMsgRemoteClientAppStatus.AppStatus.update_info:type_name -> steam.AppUpdateInfo
	30, // 11: steam.CMsgRemoteClientAppStatus.AppStatus.shortcut_info:type_name -> steam.CMsgRemoteClientAppStatus.ShortcutInfo
