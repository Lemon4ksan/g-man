...
type CGameServers_QueryByFakeIP_Request struct {
	...
	QueryType     *CGameServers_QueryByFakeIP_Request_EQueryType `protobuf:"varint,4,opt,name=query_type,json=queryType,enum=steam.CGameServers_QueryByFakeIP_Request_EQueryType,def=0" json:"query_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_steammessages_gameservers_steamclient_proto_rawDesc = "" +
	"\n" +
	"+steammessages_gameservers.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"K\n" +
	"*CGameServers_GetServerSteamIDsByIP_Request\x12\x1d\n" +
	"\n" +
	"server_ips\x18\x01 \x03(\tR\tserverIps\"\xae\x01\n" +
	"%CGameServers_IPsWithSteamIDs_Response\x12M\n" +
	"\aservers\x18\x01 \x03(\v23.steam.CGameServers_IPsWithSteamIDs_Response.ServerR\aservers\x1a6\n" +
	"\x06Server\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\x12\x18\n" +
	"\asteamid\x18\x02 \x01(\x06R\asteamid\"U\n" +
	"*CGameServers_GetServerIPsBySteamID_Request\x12'\n" +
	"\x0fserver_steamids\x18\x01 \x03(\x06R\x0eserverSteamids\"\xaa\x02\n" +
	...
	"\x06app_id\x18\x03 \x01(\rR\x05appId\x12b\n" +
	"\n" +
	"query_type\x18\x04 \x01(\x0e24.steam.CGameServers_QueryByFakeIP_Request.EQueryType:\rQuery_InvalidR\tqueryType\"S\n" +
	"\n" +
	"EQueryType\x12\x11\n" +
	...
	"\vQuery_Rules\x10\x03\"\xc2\x05\n" +
	"\x1bCMsgGameServerPingQueryData\x121\n" +
	"\tserver_ip\x18\x01 \x01(\v2\x14.steam.CMsgIPAddressR\bserverIp\x12\x1d\n" +
	"\n" +
	...
	"\x13sdr_location_string\x18\x15 \x01(\tR\x11sdrLocationString\"\xbd\x01\n" +
	"\x1eCMsgGameServerPlayersQueryData\x12F\n" +
	"\aplayers\x18\x01 \x03(\v2,.steam.CMsgGameServerPlayersQueryData.PlayerR\aplayers\x1aS\n" +
	"\x06Player\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05score\x18\x02 \x01(\rR\x05score\x12\x1f\n" +
	"\vtime_played\x18\x03 \x01(\rR\n" +
	"timePlayed\"\x90\x01\n" +
	"\x1cCMsgGameServerRulesQueryData\x12>\n" +
	"\x05rules\x18\x01 \x03(\v2(.steam.CMsgGameServerRulesQueryData.RuleR\x05rules\x1a0\n" +
	"\x04Rule\x12\x12\n" +
	"\x04rule\x18\x01 \x01(\tR\x04rule\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"\xf6\x01\n" +
	"%CGameServers_GameServerQuery_Response\x12?\n" +
	"\tping_data\x18\x01 \x01(\v2\".steam.CMsgGameServerPingQueryDataR\bpingData\x12H\n" +
	"\fplayers_data\x18\x02 \x01(\v2%.steam.CMsgGameServerPlayersQueryDataR\vplayersData\x12B\n" +
	"\n" +
	"rules_data\x18\x03 \x01(\v2#.steam.CMsgGameServerRulesQueryDataR\trulesData\"\xcc\x01\n" +
	"/CGameServers_ReportServerPingReply_Notification\x12C\n" +
	"\vserver_data\x18\x01 \x01(\v2\".steam.CMsgGameServerPingQueryDataR\n" +
	"serverData\x12\x17\n" +
	"\aping_ms\x18\x02 \x01(\rR\x06pingMs\x12;\n" +
	"\x1aclient_sdr_location_string\x18\x03 \x01(\tR\x17clientSdrLocationString\"*\n" +
	"(GameServerClient_QueryServerData_Request\"\xfa\x01\n" +
	")GameServerClient_QueryServerData_Response\x12?\n" +
	"\tping_data\x18\x01 \x01(\v2\".steam.CMsgGameServerPingQueryDataR\bpingData\x12H\n" +
	"\fplayers_data\x18\x02 \x01(\v2%.steam.CMsgGameServerPlayersQueryDataR\vplayersData\x12B\n" +
	"\n" +
	"rules_data\x18\x03 \x01(\v2#.steam.CMsgGameServerRulesQueryDataR\trulesData2\xcf\x03\n" +
	"\vGameServers\x12x\n" +
	"\x15GetServerSteamIDsByIP\x121.steam.CGameServers_GetServerSteamIDsByIP_Request\x1a,.steam.CGameServers_IPsWithSteamIDs_Response\x12x\n" +
	"\x15GetServerIPsBySteamID\x121.steam.CGameServers_GetServerIPsBySteamID_Request\x1a,.steam.CGameServers_IPsWithSteamIDs_Response\x12h\n" +
	"\rQueryByFakeIP\x12).steam.CGameServers_QueryByFakeIP_Request\x1a,.steam.CGameServers_GameServerQuery_Response\x12b\n" +
	"\x15ReportServerPingReply\x126.steam.CGameServers_ReportServerPingReply_Notification\x1a\x11.steam.NoResponse2\x8e\x01\n" +
	"\x10GameServerClient\x12t\n" +
	"\x0fQueryServerData\x12/.steam.GameServerClient_QueryServerData_Request\x1a0.steam.GameServerClient_QueryServerData_Response\x1a\x04\xc0\xb5\x18\x02B3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_gameservers_steamclient_proto_goTypes = []any{
	(CGameServers_QueryByFakeIP_Request_EQueryType)(0),      // 0: steam.CGameServers_QueryByFakeIP_Request.EQueryType
	(*CGameServers_GetServerSteamIDsByIP_Request)(nil),      // 1: steam.CGameServers_GetServerSteamIDsByIP_Request
	(*CGameServers_IPsWithSteamIDs_Response)(nil),           // 2: steam.CGameServers_IPsWithSteamIDs_Response
	(*CGameServers_GetServerIPsBySteamID_Request)(nil),      // 3: steam.CGameServers_GetServerIPsBySteamID_Request
	(*CGameServers_QueryByFakeIP_Request)(nil),              // 4: steam.CGameServers_QueryByFakeIP_Request
	(*CMsgGameServerPingQueryData)(nil),                     // 5: steam.CMsgGameServerPingQueryData
	(*CMsgGameServerPlayersQueryData)(nil),                  // 6: steam.CMsgGameServerPlayersQueryData
	(*CMsgGameServerRulesQueryData)(nil),                    // 7: steam.CMsgGameServerRulesQueryData
	(*CGameServers_GameServerQuery_Response)(nil),           // 8: steam.CGameServers_GameServerQuery_Response
	(*CGameServers_ReportServerPingReply_Notification)(nil), // 9: steam.CGameServers_ReportServerPingReply_Notification
	(*GameServerClient_QueryServerData_Request)(nil),        // 10: steam.GameServerClient_QueryServerData_Request
	(*GameServerClient_QueryServerData_Response)(nil),       // 11: steam.GameServerClient_QueryServerData_Response
	(*CGameServers_IPsWithSteamIDs_Response_Server)(nil),    // 12: steam.CGameServers_IPsWithSteamIDs_Response.Server
	(*CMsgGameServerPlayersQueryData_Player)(nil),           // 13: steam.CMsgGameServerPlayersQueryData.Player
	(*CMsgGameServerRulesQueryData_Rule)(nil),               // 14: steam.CMsgGameServerRulesQueryData.Rule
	(*CMsgIPAddress)(nil),                                   // 15: steam.CMsgIPAddress
	(*NoResponse)(nil),                                      // 16: steam.NoResponse
}
var file_steammessages_gameservers_steamclient_proto_depIdxs = []int32{
	12, // 0: steam.CGameServers_IPsWithSteamIDs_Response.servers:type_name -> steam.CGameServers_IPsWithSteamIDs_Response.Server
	0,  // 1: steam.CGameServers_QueryByFakeIP_Request.query_type:type_name -> steam.CGameServers_QueryByFakeIP_Request.EQueryType
	15, // 2: steam.CMsgGameServerPingQueryData.server_ip:type_name -> steam.CMsgIPAddress
	13, // 3: steam.CMsgGameServerPlayersQueryData.players:type_name -> steam.CMsgGameServerPlayersQueryData.Player
	14, // 4: steam.CMsgGameServerRulesQueryData.rules:type_name -> steam.CMsgGameServerRulesQueryData.Rule
	5,  // 5: steam.CGameServers_GameServerQuery_Response.ping_data:type_name -> steam.CMsgGameServerPingQueryData
	6,  // 6: steam.CGameServers_GameServerQuery_Response.players_data:type_name -> steam.CMsgGameServerPlayersQueryData
	7,  // 7: steam.CGameServers_GameServerQuery_Response.rules_data:type_name -> steam.CMsgGameServerRulesQueryData
	5,  // 8: steam.CGameServers_ReportServerPingReply_Notification.server_data:type_name -> steam.CMsgGameServerPingQueryData
	5,  // 9: steam.GameServerClient_QueryServerData_Response.ping_data:type_name -> steam.CMsgGameServerPingQueryData
	6,  // 10: steam.GameServerClient_QueryServerData_Response.players_data:type_name -> steam.CMsgGameServerPlayersQueryData
	7,  // 11: steam.GameServerClient_QueryServerData_Response.rules_data:type_name -> steam.CMsgGameServerRulesQueryData
	1,  // 12: steam.GameServers.GetServerSteamIDsByIP:input_type -> steam.CGameServers_GetServerSteamIDsByIP_Request
	3,  // 13: steam.GameServers.GetServerIPsBySteamID:input_type -> steam.CGameServers_GetServerIPsBySteamID_Request
	4,  // 14: steam.GameServers.QueryByFakeIP:input_type -> steam.CGameServers_QueryByFakeIP_Request
	9,  // 15: steam.GameServers.ReportServerPingReply:input_type -> steam.CGameServers_ReportServerPingReply_Notification
	10, // 16: steam.GameServerClient.QueryServerData:input_type -> steam.GameServerClient_QueryServerData_Request
	2,  // 17: steam.GameServers.GetServerSteamIDsByIP:output_type -> steam.CGameServers_IPsWithSteamIDs_Response
	2,  // 18: steam.GameServers.GetServerIPsBySteamID:output_type -> steam.CGameServers_IPsWithSteamIDs_Response
	8,  // 19: steam.GameServers.QueryByFakeIP:output_type -> steam.CGameServers_GameServerQuery_Response
	16, // 20: steam.GameServers.ReportServerPingReply:output_type -> steam.NoResponse
	11, // 21: steam.GameServerClient.QueryServerData:output_type -> steam.GameServerClient_QueryServerData_Response
