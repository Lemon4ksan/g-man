...
type CRemoteClient_Task struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          *ECLientTaskListType   `protobuf:"varint,1,opt,name=type,enum=steam.ECLientTaskListType,def=1" json:"type,omitempty"`
...
const file_steammessages_remoteclient_service_messages_proto_rawDesc = "" +
	"\n" +
	"1steammessages_remoteclient_service_messages.proto\x12\x05steam\"%\n" +
	...
	"\x12gaming_device_type\x18\x03 \x01(\rR\x10gamingDeviceType\"\xb2\x01\n" +
	"!CRemoteClient_Online_Notification\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12(\n" +
	"\x10remote_client_id\x18\x02 \x01(\x06R\x0eremoteClientId\x12I\n" +
	"\x0edevice_details\x18\x03 \x01(\v2\".steam.CRemoteClient_DeviceDetailsR\rdeviceDetails\"\x87\x01\n" +
	"\"CRemoteClient_Offline_Notification\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\x06R\tsessionId\x12\x18\n" +
	"\asteamid\x18\x02 \x01(\x06R\asteamid\x12(\n" +
	"\x10remote_client_id\x18\x03 \x01(\x06R\x0eremoteClientId\"\xab\x01\n" +
	"\x19CRemoteClient_ClientLogin\x12(\n" +
	"\x10remote_client_id\x18\x01 \x01(\x06R\x0eremoteClientId\x12\x19\n" +
	"\btoken_id\x18\x02 \x01(\x06R\atokenId\x12I\n" +
	"\x0edevice_details\x18\x03 \x01(\v2\".steam.CRemoteClient_DeviceDetailsR\rdeviceDetails\"\x90\x02\n" +
	"\x1bCRemoteClient_ClientDetails\x12(\n" +
	"\x10remote_client_id\x18\x01 \x01(\x06R\x0eremoteClientId\x12I\n" +
	"\x0edevice_details\x18\x02 \x01(\v2\".steam.CRemoteClient_DeviceDetailsR\rdeviceDetails\x12\x1b\n" +
	...
	"&CRemoteClient_GetRecentClients_Request\"g\n" +
	"'CRemoteClient_GetRecentClients_Response\x12<\n" +
	"\aclients\x18\x01 \x03(\v2\".steam.CRemoteClient_ClientDetailsR\aclients\"\xa4\x01\n" +
	"\x12CRemoteClient_Task\x12J\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1a.steam.ECLientTaskListType:\x1ak_EClientTask_DownloadClipR\x04type\x12\x17\n" +
	...
	"\x04task\x18\x02 \x01(\v2\x19.steam.CRemoteClient_TaskR\x04task\"&\n" +
	"$CRemoteClient_AddClientTask_Response\"\x86\x01\n" +
	"#CRemoteClient_TaskList_Notification\x12(\n" +
	"\x10remote_client_id\x18\x01 \x01(\x06R\x0eremoteClientId\x125\n" +
	"\btasklist\x18\x02 \x03(\v2\x19.steam.CRemoteClient_TaskR\btasklist\"\x8a\x01\n" +
	...
	"\tused_hevc\x18\x04 \x01(\bR\busedHevc\"\xec\b\n" +
	" CRemotePlayTogether_Notification\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12[\n" +
	"\rgroup_updated\x18\x02 \x01(\v24.steam.CRemotePlayTogether_Notification.GroupUpdatedH\x00R\fgroupUpdated\x1a\xdc\x01\n" +
	"\x06Player\x12\x18\n" +
	...
	"\asteamid\x18\x02 \x01(\x06R\asteamid\x1a\x99\x01\n" +
	"\x0eControllerSlot\x12\x16\n" +
	"\x06slotid\x18\x01 \x01(\rR\x06slotid\x12F\n" +
	"\x06player\x18\x02 \x01(\v2..steam.CRemotePlayTogether_Notification.PlayerR\x06player\x12'\n" +
	"\x0fcontroller_type\x18\x03 \x01(\x05R\x0econtrollerType\x1a\xfd\x03\n" +
	"\fGroupUpdated\x12!\n" +
	...
	"hostGameid\x12{\n" +
	"\x19controller_slots_obsolete\x18\x05 \x03(\v2?.steam.CRemotePlayTogether_Notification.ControllerSlot_obsoleteR\x17controllerSlotsObsolete\x12&\n" +
	"\x0fhas_new_players\x18\x06 \x01(\bR\rhasNewPlayers\x12Q\n" +
	"\fplayer_slots\x18\a \x03(\v2..steam.CRemotePlayTogether_Notification.PlayerR\vplayerSlots\x12a\n" +
	"\x10controller_slots\x18\b \x03(\v26.steam.CRemotePlayTogether_Notification.ControllerSlotR\x0fcontrollerSlotsB\t\n" +
	"\aMessage\"}\n" +
	...
	"\x0einvitation_url\x18\x01 \x01(\tR\rinvitationUrl\"\xf8\x05\n" +
	"\x1dCCMRemoteClient_ClientMessage\x12b\n" +
	"\x16create_session_request\x18\x01 \x01(\v2*.steam.CRemoteClient_CreateSession_RequestH\x00R\x14createSessionRequest\x12_\n" +
	"\x15start_pairing_request\x18\x02 \x01(\v2).steam.CRemoteClient_StartPairing_RequestH\x00R\x13startPairingRequest\x12f\n" +
	"\x18set_pairing_info_request\x18\x03 \x01(\v2+.steam.CRemoteClient_SetPairingInfo_RequestH\x00R\x15setPairingInfoRequest\x12b\n" +
	"\x16cancel_pairing_request\x18\x04 \x01(\v2*.steam.CRemoteClient_CancelPairing_RequestH\x00R\x14cancelPairingRequest\x12n\n" +
	"\x16register_status_update\x18\x05 \x01(\v26.steam.CRemoteClient_RegisterStatusUpdate_NotificationH\x00R\x14registerStatusUpdate\x12t\n" +
	"\x18unregister_status_update\x18\x06 \x01(\v28.steam.CRemoteClient_UnregisterStatusUpdate_NotificationH\x00R\x16unregisterStatusUpdate\x12U\n" +
	"\rremote_packet\x18\a \x01(\v2..steam.CRemoteClient_RemotePacket_NotificationH\x00R\fremotePacketB\t\n" +
	"\aMessage\"\xf5\x04\n" +
	"\x1dCCMRemoteClient_ServerMessage\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x05R\x06result\x12e\n" +
	"\x17create_session_response\x18\x02 \x01(\v2+.steam.CRemoteClient_CreateSession_ResponseH\x00R\x15createSessionResponse\x12b\n" +
	"\x16start_pairing_response\x18\x03 \x01(\v2*.steam.CRemoteClient_StartPairing_ResponseH\x00R\x14startPairingResponse\x12i\n" +
	"\x19set_pairing_info_response\x18\x04 \x01(\v2,.steam.CRemoteClient_SetPairingInfo_ResponseH\x00R\x16setPairingInfoResponse\x12e\n" +
	"\x17cancel_pairing_response\x18\x05 \x01(\v2+.steam.CRemoteClient_CancelPairing_ResponseH\x00R\x15cancelPairingResponse\x12M\n" +
	"\freply_packet\x18\x06 \x01(\v2(.steam.CRemoteClient_GetReplies_ResponseH\x00R\vreplyPacket\x12E\n" +
	"\aoffline\x18\a \x01(\v2).steam.CRemoteClient_Offline_NotificationH\x00R\aofflineB\t\n" +
	"\aMessage*5\n" +
	"\x13ECLientTaskListType\x12\x1e\n" +
	"\x1ak_EClientTask_DownloadClip\x10\x01B0Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam"
...
var file_steammessages_remoteclient_service_messages_proto_goTypes = []any{
	(ECLientTaskListType)(0),                                          // 0: steam.ECLientTaskListType
	(*CRemoteClient_CreateSession_Request)(nil),                       // 1: steam.CRemoteClient_CreateSession_Request
	(*CRemoteClient_CreateSession_Response)(nil),                      // 2: steam.CRemoteClient_CreateSession_Response
	(*CRemoteClient_DeleteSession_Notification)(nil),                  // 3: steam.CRemoteClient_DeleteSession_Notification
	(*CRemoteClient_StartPairing_Request)(nil),                        // 4: steam.CRemoteClient_StartPairing_Request
	(*CRemoteClient_StartPairing_Response)(nil),                       // 5: steam.CRemoteClient_StartPairing_Response
	(*CRemoteClient_SetPairingInfo_Request)(nil),                      // 6: steam.CRemoteClient_SetPairingInfo_Request
	(*CRemoteClient_SetPairingInfo_Response)(nil),                     // 7: steam.CRemoteClient_SetPairingInfo_Response
	(*CRemoteClient_GetPairingInfo_Request)(nil),                      // 8: steam.CRemoteClient_GetPairingInfo_Request
	(*CRemoteClient_GetPairingInfo_Response)(nil),                     // 9: steam.CRemoteClient_GetPairingInfo_Response
	(*CRemoteClient_CancelPairing_Request)(nil),                       // 10: steam.CRemoteClient_CancelPairing_Request
	(*CRemoteClient_CancelPairing_Response)(nil),                      // 11: steam.CRemoteClient_CancelPairing_Response
	(*CRemoteClient_CancelPairing_Notification)(nil),                  // 12: steam.CRemoteClient_CancelPairing_Notification
	(*CRemoteClient_RegisterStatusUpdate_Notification)(nil),           // 13: steam.CRemoteClient_RegisterStatusUpdate_Notification
	(*CRemoteClient_UnregisterStatusUpdate_Notification)(nil),         // 14: steam.CRemoteClient_UnregisterStatusUpdate_Notification
	(*CRemoteClient_DeviceDetails)(nil),                               // 15: steam.CRemoteClient_DeviceDetails
	(*CRemoteClient_Online_Notification)(nil),                         // 16: steam.CRemoteClient_Online_Notification
	(*CRemoteClient_Offline_Notification)(nil),                        // 17: steam.CRemoteClient_Offline_Notification
	(*CRemoteClient_ClientLogin)(nil),                                 // 18: steam.CRemoteClient_ClientLogin
	(*CRemoteClient_ClientDetails)(nil),                               // 19: steam.CRemoteClient_ClientDetails
	(*CRemoteClient_GetRecentClients_Request)(nil),                    // 20: steam.CRemoteClient_GetRecentClients_Request
	(*CRemoteClient_GetRecentClients_Response)(nil),                   // 21: steam.CRemoteClient_GetRecentClients_Response
	(*CRemoteClient_Task)(nil),                                        // 22: steam.CRemoteClient_Task
	(*CRemoteClient_AddClientTask_Request)(nil),                       // 23: steam.CRemoteClient_AddClientTask_Request
	(*CRemoteClient_AddClientTask_Response)(nil),                      // 24: steam.CRemoteClient_AddClientTask_Response
	(*CRemoteClient_TaskList_Notification)(nil),                       // 25: steam.CRemoteClient_TaskList_Notification
	(*CRemoteClient_MarkTaskComplete_Request)(nil),                    // 26: steam.CRemoteClient_MarkTaskComplete_Request
	(*CRemoteClient_MarkTaskComplete_Response)(nil),                   // 27: steam.CRemoteClient_MarkTaskComplete_Response
	(*CRemoteClient_RemotePacket_Notification)(nil),                   // 28: steam.CRemoteClient_RemotePacket_Notification
	(*CRemoteClient_ReplyPacket_Notification)(nil),                    // 29: steam.CRemoteClient_ReplyPacket_Notification
	(*CRemoteClient_GetReplies_Request)(nil),                          // 30: steam.CRemoteClient_GetReplies_Request
	(*CRemoteClient_GetReplies_Response)(nil),                         // 31: steam.CRemoteClient_GetReplies_Response
	(*CRemoteClient_AllocateRelayServer_Request)(nil),                 // 32: steam.CRemoteClient_AllocateRelayServer_Request
	(*CRemoteClient_AllocateRelayServer_Response)(nil),                // 33: steam.CRemoteClient_AllocateRelayServer_Response
	(*CRemoteClient_AllocateSDR_Request)(nil),                         // 34: steam.CRemoteClient_AllocateSDR_Request
	(*CRemoteClient_AllocateSDR_Response)(nil),                        // 35: steam.CRemoteClient_AllocateSDR_Response
	(*CRemoteClient_EnableSteamBroadcast_Notification)(nil),           // 36: steam.CRemoteClient_EnableSteamBroadcast_Notification
	(*CRemoteClient_DisableSteamBroadcast_Notification)(nil),          // 37: steam.CRemoteClient_DisableSteamBroadcast_Notification
	(*CRemoteClient_SteamBroadcast_Notification)(nil),                 // 38: steam.CRemoteClient_SteamBroadcast_Notification
	(*CRemoteClient_SteamToSteam_Notification)(nil),                   // 39: steam.CRemoteClient_SteamToSteam_Notification
	(*CRemotePlay_SessionStarted_Request)(nil),                        // 40: steam.CRemotePlay_SessionStarted_Request
	(*CRemotePlay_SessionStarted_Response)(nil),                       // 41: steam.CRemotePlay_SessionStarted_Response
	(*CRemotePlay_SessionStopped_Notification)(nil),                   // 42: steam.CRemotePlay_SessionStopped_Notification
	(*CRemotePlayTogether_Notification)(nil),                          // 43: steam.CRemotePlayTogether_Notification
	(*CRemoteClient_CreateRemotePlayTogetherInvitation_Request)(nil),  // 44: steam.CRemoteClient_CreateRemotePlayTogetherInvitation_Request
	(*CRemoteClient_CreateRemotePlayTogetherInvitation_Response)(nil), // 45: steam.CRemoteClient_CreateRemotePlayTogetherInvitation_Response
	(*CRemoteClient_DeleteRemotePlayTogetherInvitation_Request)(nil),  // 46: steam.CRemoteClient_DeleteRemotePlayTogetherInvitation_Request
	(*CRemoteClient_DeleteRemotePlayTogetherInvitation_Response)(nil), // 47: steam.CRemoteClient_DeleteRemotePlayTogetherInvitation_Response
	(*CRemoteClient_LookupRemotePlayTogetherInvitation_Request)(nil),  // 48: steam.CRemoteClient_LookupRemotePlayTogetherInvitation_Request
	(*CRemoteClient_LookupRemotePlayTogetherInvitation_Response)(nil), // 49: steam.CRemoteClient_LookupRemotePlayTogetherInvitation_Response
	(*CCMRemoteClient_ClientMessage)(nil),                             // 50: steam.CCMRemoteClient_ClientMessage
	(*CCMRemoteClient_ServerMessage)(nil),                             // 51: steam.CCMRemoteClient_ServerMessage
	(*CRemotePlayTogether_Notification_Player)(nil),                   // 52: steam.CRemotePlayTogether_Notification.Player
	(*CRemotePlayTogether_Notification_ControllerSlotObsolete)(nil),   // 53: steam.CRemotePlayTogether_Notification.ControllerSlot_obsolete
	(*CRemotePlayTogether_Notification_ControllerSlot)(nil),           // 54: steam.CRemotePlayTogether_Notification.ControllerSlot
	(*CRemotePlayTogether_Notification_GroupUpdated)(nil),             // 55: steam.CRemotePlayTogether_Notification.GroupUpdated
}
var file_steammessages_remoteclient_service_messages_proto_depIdxs = []int32{
	15, // 0: steam.CRemoteClient_Online_Notification.device_details:type_name -> steam.CRemoteClient_DeviceDetails
	15, // 1: steam.CRemoteClient_ClientLogin.device_details:type_name -> steam.CRemoteClient_DeviceDetails
	15, // 2: steam.CRemoteClient_ClientDetails.device_details:type_name -> steam.CRemoteClient_DeviceDetails
	19, // 3: steam.CRemoteClient_GetRecentClients_Response.clients:type_name -> steam.CRemoteClient_ClientDetails
	0,  // 4: steam.CRemoteClient_Task.type:type_name -> steam.ECLientTaskListType
	22, // 5: steam.CRemoteClient_AddClientTask_Request.task:type_name -> steam.CRemoteClient_Task
	22, // 6: steam.CRemoteClient_TaskList_Notification.tasklist:type_name -> steam.CRemoteClient_Task
	55, // 7: steam.CRemotePlayTogether_Notification.group_updated:type_name -> steam.CRemotePlayTogether_Notification.GroupUpdated
	1,  // 8: steam.CCMRemoteClient_ClientMessage.create_session_request:type_name -> steam.CRemoteClient_CreateSession_Request
	4,  // 9: steam.CCMRemoteClient_ClientMessage.start_pairing_request:type_name -> steam.CRemoteClient_StartPairing_Request
	6,  // 10: steam.CCMRemoteClient_ClientMessage.set_pairing_info_request:type_name -> steam.CRemoteClient_SetPairingInfo_Request
	10, // 11: steam.CCMRemoteClient_ClientMessage.cancel_pairing_request:type_name -> steam.CRemoteClient_CancelPairing_Request
	13, // 12: steam.CCMRemoteClient_ClientMessage.register_status_update:type_name -> steam.CRemoteClient_RegisterStatusUpdate_Notification
	14, // 13: steam.CCMRemoteClient_ClientMessage.unregister_status_update:type_name -> steam.CRemoteClient_UnregisterStatusUpdate_Notification
	28, // 14: steam.CCMRemoteClient_ClientMessage.remote_packet:type_name -> steam.CRemoteClient_RemotePacket_Notification
	2,  // 15: steam.CCMRemoteClient_ServerMessage.create_session_response:type_name -> steam.CRemoteClient_CreateSession_Response
	5,  // 16: steam.CCMRemoteClient_ServerMessage.start_pairing_response:type_name -> steam.CRemoteClient_StartPairing_Response
	7,  // 17: steam.CCMRemoteClient_ServerMessage.set_pairing_info_response:type_name -> steam.CRemoteClient_SetPairingInfo_Response
	11, // 18: steam.CCMRemoteClient_ServerMessage.cancel_pairing_response:type_name -> steam.CRemoteClient_CancelPairing_Response
	31, // 19: steam.CCMRemoteClient_ServerMessage.reply_packet:type_name -> steam.CRemoteClient_GetReplies_Response
	17, // 20: steam.CCMRemoteClient_ServerMessage.offline:type_name -> steam.CRemoteClient_Offline_Notification
	52, // 21: steam.CRemotePlayTogether_Notification.ControllerSlot.player:type_name -> steam.CRemotePlayTogether_Notification.Player
	53, // 22: steam.CRemotePlayTogether_Notification.GroupUpdated.controller_slots_obsolete:type_name -> steam.CRemotePlayTogether_Notification.ControllerSlot_obsolete
	52, // 23: steam.CRemotePlayTogether_Notification.GroupUpdated.player_slots:type_name -> steam.CRemotePlayTogether_Notification.Player
	54, // 24: steam.CRemotePlayTogether_Notification.GroupUpdated.controller_slots:type_name -> steam.CRemotePlayTogether_Notification.ControllerSlot
