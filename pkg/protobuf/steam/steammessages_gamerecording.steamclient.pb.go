...
const file_steammessages_gamerecording_steamclient_proto_rawDesc = "" +
	"\n" +
	"-steammessages_gamerecording.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\x1a&steammessages_clientserver_video.proto\"\x97\x02\n" +
	...
	"durationMs\x12&\n" +
	"\x0fstart_offset_ms\x18\x06 \x01(\rR\rstartOffsetMs\"\xc5\x02\n" +
	...
	"\x15total_file_size_bytes\x18\a \x01(\x04R\x12totalFileSizeBytes\x127\n" +
	"\tvideo_ids\x18\t \x03(\v2\x1a.steam.CVideoManagerClipIDR\bvideoIds\x12#\n" +
	"\rowner_steamid\x18\n" +
	...
	"\x04clip\x18\x02 \x01(\v2\x19.steam.CGameRecordingClipR\x04clip\x12=\n" +
	"\tvideo_def\x18\x03 \x03(\v2 .steam.CMsgVideoGameRecordingDefR\bvideoDef\"X\n" +
	"'CGameRecording_CreateShareClip_Response\x12-\n" +
	"\x04clip\x18\x01 \x01(\v2\x19.steam.CGameRecordingClipR\x04clip\"B\n" +
	...
	"\x04clip\x18\x01 \x01(\v2\x19.steam.CGameRecordingClipR\x04clip\"\x80\x02\n" +
	...
	"\x13representation_name\x18\x03 \x01(\tR\x12representationName\x12R\n" +
	"\x11segments_to_store\x18\x04 \x03(\v2&.steam.CVideo_GameRecordingSegmentInfoR\x0fsegmentsToStore\"\xa8\x01\n" +
	"0CVideo_BeginGameRecordingSegmentsUpload_Response\x12U\n" +
	"\x0fsegments_needed\x18\x01 \x03(\v2,.steam.CVideo_GameRecordingSegmentUploadInfoR\x0esegmentsNeeded\x12\x1d\n" +
	"\n" +
	...
	"\frecording_id\x18\x01 \x01(\x04R\vrecordingId\"\x94\x01\n" +
	";CVideo_GameRecordingGetNextBatchOfSegmentsToUpload_Response\x12U\n" +
	"\x0fsegments_needed\x18\x01 \x03(\v2,.steam.CVideo_GameRecordingSegmentUploadInfoR\x0esegmentsNeeded\"\xaa\x01\n" +
	"0CVideo_GameRecordingCommitSegmentUploads_Request\x12!\n" +
	"\frecording_id\x18\x01 \x01(\x04R\vrecordingId\x12S\n" +
	"\x11segments_uploaded\x18\x02 \x03(\v2&.steam.CVideo_GameRecordingSegmentInfoR\x10segmentsUploaded\"3\n" +
	"1CVideo_GameRecordingCommitSegmentUploads_Response2\xf8\x02\n" +
	"\x11GameRecordingClip\x12p\n" +
	"\x0fCreateShareClip\x12-.steam.CGameRecording_CreateShareClip_Request\x1a..steam.CGameRecording_CreateShareClip_Response\x12s\n" +
	"\x10DeleteSharedClip\x12..steam.CGameRecording_DeleteSharedClip_Request\x1a/.steam.CGameRecording_DeleteSharedClip_Response\x12|\n" +
	"\x13GetSingleSharedClip\x121.steam.CGameRecording_GetSingleSharedClip_Request\x1a2.steam.CGameRecording_GetSingleSharedClip_Response2\xf0\x04\n" +
	"\tVideoClip\x12\x93\x01\n" +
	" BeginGameRecordingSegmentsUpload\x126.steam.CVideo_BeginGameRecordingSegmentsUpload_Request\x1a7.steam.CVideo_BeginGameRecordingSegmentsUpload_Response\x12\x96\x01\n" +
	"!CommitGameRecordingSegmentsUpload\x127.steam.CVideo_CommitGameRecordingSegmentsUpload_Request\x1a8.steam.CVideo_CommitGameRecordingSegmentsUpload_Response\x12\xa7\x01\n" +
	"\x1eGetNextBatchOfSegmentsToUpload\x12A.steam.CVideo_GameRecordingGetNextBatchOfSegmentsToUpload_Request\x1aB.steam.CVideo_GameRecordingGetNextBatchOfSegmentsToUpload_Response\x12\x89\x01\n" +
	"\x14CommitSegmentUploads\x127.steam.CVideo_GameRecordingCommitSegmentUploads_Request\x1a8.steam.CVideo_GameRecordingCommitSegmentUploads_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_gamerecording_steamclient_proto_goTypes = []any{
	(*CVideoManagerClipID)(nil),                                         // 0: steam.CVideoManagerClipID
	(*CGameRecordingClip)(nil),                                          // 1: steam.CGameRecordingClip
	(*CGameRecording_CreateShareClip_Request)(nil),                      // 2: steam.CGameRecording_CreateShareClip_Request
	(*CGameRecording_CreateShareClip_Response)(nil),                     // 3: steam.CGameRecording_CreateShareClip_Response
	(*CGameRecording_DeleteSharedClip_Request)(nil),                     // 4: steam.CGameRecording_DeleteSharedClip_Request
	(*CGameRecording_DeleteSharedClip_Response)(nil),                    // 5: steam.CGameRecording_DeleteSharedClip_Response
	(*CGameRecording_GetSingleSharedClip_Request)(nil),                  // 6: steam.CGameRecording_GetSingleSharedClip_Request
	(*CGameRecording_GetSingleSharedClip_Response)(nil),                 // 7: steam.CGameRecording_GetSingleSharedClip_Response
	(*CVideo_BeginGameRecordingSegmentsUpload_Request)(nil),             // 8: steam.CVideo_BeginGameRecordingSegmentsUpload_Request
	(*CVideo_BeginGameRecordingSegmentsUpload_Response)(nil),            // 9: steam.CVideo_BeginGameRecordingSegmentsUpload_Response
	(*CVideo_CommitGameRecordingSegmentsUpload_Request)(nil),            // 10: steam.CVideo_CommitGameRecordingSegmentsUpload_Request
	(*CVideo_CommitGameRecordingSegmentsUpload_Response)(nil),           // 11: steam.CVideo_CommitGameRecordingSegmentsUpload_Response
	(*CVideo_GameRecordingGetNextBatchOfSegmentsToUpload_Request)(nil),  // 12: steam.CVideo_GameRecordingGetNextBatchOfSegmentsToUpload_Request
	(*CVideo_GameRecordingGetNextBatchOfSegmentsToUpload_Response)(nil), // 13: steam.CVideo_GameRecordingGetNextBatchOfSegmentsToUpload_Response
	(*CVideo_GameRecordingCommitSegmentUploads_Request)(nil),            // 14: steam.CVideo_GameRecordingCommitSegmentUploads_Request
	(*CVideo_GameRecordingCommitSegmentUploads_Response)(nil),           // 15: steam.CVideo_GameRecordingCommitSegmentUploads_Response
	(*CMsgVideoGameRecordingDef)(nil),                                   // 16: steam.CMsgVideoGameRecordingDef
	(*CVideo_GameRecordingSegmentInfo)(nil),                             // 17: steam.CVideo_GameRecordingSegmentInfo
	(*CVideo_GameRecordingSegmentUploadInfo)(nil),                       // 18: steam.CVideo_GameRecordingSegmentUploadInfo
}
var file_steammessages_gamerecording_steamclient_proto_depIdxs = []int32{
	0,  // 0: steam.CGameRecordingClip.video_ids:type_name -> steam.CVideoManagerClipID
	1,  // 1: steam.CGameRecording_CreateShareClip_Request.clip:type_name -> steam.CGameRecordingClip
	16, // 2: steam.CGameRecording_CreateShareClip_Request.video_def:type_name -> steam.CMsgVideoGameRecordingDef
	1,  // 3: steam.CGameRecording_CreateShareClip_Response.clip:type_name -> steam.CGameRecordingClip
	1,  // 4: steam.CGameRecording_GetSingleSharedClip_Response.clip:type_name -> steam.CGameRecordingClip
	17, // 5: steam.CVideo_BeginGameRecordingSegmentsUpload_Request.segments_to_store:type_name -> steam.CVideo_GameRecordingSegmentInfo
	18, // 6: steam.CVideo_BeginGameRecordingSegmentsUpload_Response.segments_needed:type_name -> steam.CVideo_GameRecordingSegmentUploadInfo
	18, // 7: steam.CVideo_GameRecordingGetNextBatchOfSegmentsToUpload_Response.segments_needed:type_name -> steam.CVideo_GameRecordingSegmentUploadInfo
	17, // 8: steam.CVideo_GameRecordingCommitSegmentUploads_Request.segments_uploaded:type_name -> steam.CVideo_GameRecordingSegmentInfo
	2,  // 9: steam.GameRecordingClip.CreateShareClip:input_type -> steam.CGameRecording_CreateShareClip_Request
	4,  // 10: steam.GameRecordingClip.DeleteSharedClip:input_type -> steam.CGameRecording_DeleteSharedClip_Request
	6,  // 11: steam.GameRecordingClip.GetSingleSharedClip:input_type -> steam.CGameRecording_GetSingleSharedClip_Request
	8,  // 12: steam.VideoClip.BeginGameRecordingSegmentsUpload:input_type -> steam.CVideo_BeginGameRecordingSegmentsUpload_Request
	10, // 13: steam.VideoClip.CommitGameRecordingSegmentsUpload:input_type -> steam.CVideo_CommitGameRecordingSegmentsUpload_Request
	12, // 14: steam.VideoClip.GetNextBatchOfSegmentsToUpload:input_type -> steam.CVideo_GameRecordingGetNextBatchOfSegmentsToUpload_Request
	14, // 15: steam.VideoClip.CommitSegmentUploads:input_type -> steam.CVideo_GameRecordingCommitSegmentUploads_Request
	3,  // 16: steam.GameRecordingClip.CreateShareClip:output_type -> steam.CGameRecording_CreateShareClip_Response
	5,  // 17: steam.GameRecordingClip.DeleteSharedClip:output_type -> steam.CGameRecording_DeleteSharedClip_Response
	7,  // 18: steam.GameRecordingClip.GetSingleSharedClip:output_type -> steam.CGameRecording_GetSingleSharedClip_Response
	9,  // 19: steam.VideoClip.BeginGameRecordingSegmentsUpload:output_type -> steam.CVideo_BeginGameRecordingSegmentsUpload_Response
	11, // 20: steam.VideoClip.CommitGameRecordingSegmentsUpload:output_type -> steam.CVideo_CommitGameRecordingSegmentsUpload_Response
	13, // 21: steam.VideoClip.GetNextBatchOfSegmentsToUpload:output_type -> steam.CVideo_GameRecordingGetNextBatchOfSegmentsToUpload_Response
	15, // 22: steam.VideoClip.CommitSegmentUploads:output_type -> steam.CVideo_GameRecordingCommitSegmentUploads_Response
