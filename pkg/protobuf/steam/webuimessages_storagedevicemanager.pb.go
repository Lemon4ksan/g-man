...
type CStorageDeviceManagerDrive struct {
	...
	AdoptStage       *EStorageFormatStage    `protobuf:"varint,9,opt,name=adopt_stage,json=adoptStage,enum=steam.EStorageFormatStage,def=0" json:"adopt_stage,omitempty"`
...
const file_webuimessages_storagedevicemanager_proto_rawDesc = "" +
	"\n" +
	"(webuimessages_storagedevicemanager.proto\x12\x05steam\x1a\venums.proto\x1a\x18steammessages_base.proto\x1a\x18webuimessages_base.proto\"2\n" +
	"0CStorageDeviceManager_IsServiceAvailable_Request\"V\n" +
	"1CStorageDeviceManager_IsServiceAvailable_Response\x12!\n" +
	"\fis_available\x18\x01 \x01(\bR\visAvailable\"\xef\x03\n" +
	...
	"\n" +
	"media_type\x18\a \x01(\x0e2\x1d.steam.EStorageDriveMediaType: k_EStorageDriveMediaType_InvalidR\tmediaType\x12%\n" +
	"\x0eis_unformatted\x18\b \x01(\bR\risUnformatted\x12Z\n" +
	"\vadopt_stage\x18\t \x01(\x0e2\x1a.steam.EStorageFormatStage:\x1dk_EStorageFormatStage_InvalidR\n" +
	"adoptStage\x12%\n" +
	"\x0eis_formattable\x18\n" +
	" \x01(\bR\risFormattable\x12,\n" +
	"\x12is_media_available\x18\v \x01(\bR\x10isMediaAvailable\"\xfe\x04\n" +
	...
	"\x0ffilesystem_type\x18\v \x01(\x0e2\".steam.EStorageBlockFileSystemType:%k_EStorageBlockFileSystemType_InvalidR\x0efilesystemType\x12\x1f\n" +
	"\vmount_paths\x18\f \x03(\tR\n" +
	"mountPaths\x12#\n" +
	"\ris_unmounting\x18\r \x01(\bR\fisUnmounting\x12*\n" +
	"\x11has_steam_library\x18\x0e \x01(\bR\x0fhasSteamLibrary\"\xd9\x02\n" +
	"\x1aCStorageDeviceManagerState\x129\n" +
	"\x06drives\x18\x01 \x03(\v2!.steam.CStorageDeviceManagerDriveR\x06drives\x12L\n" +
	"\rblock_devices\x18\x02 \x03(\v2'.steam.CStorageDeviceManagerBlockDeviceR\fblockDevices\x120\n" +
	...
	"&CStorageDeviceManager_GetState_Request\"b\n" +
	"'CStorageDeviceManager_GetState_Response\x127\n" +
	"\x05state\x18\x01 \x01(\v2!.steam.CStorageDeviceManagerStateR\x05state\"1\n" +
	...
	"&CStorageDeviceManager_TrimAll_Response2\xf0\x06\n" +
	"\x14StorageDeviceManager\x12\x87\x01\n" +
	"\x12IsServiceAvailable\x127.steam.CStorageDeviceManager_IsServiceAvailable_Request\x1a8.steam.CStorageDeviceManager_IsServiceAvailable_Response\x12i\n" +
	"\bGetState\x12-.steam.CStorageDeviceManager_GetState_Request\x1a..steam.CStorageDeviceManager_GetState_Response\x12d\n" +
	"\x12NotifyStateChanged\x126.steam.CStorageDeviceManager_StateChanged_Notification\x1a\x16.steam.WebUINoResponse\x12`\n" +
	"\x05Adopt\x12*.steam.CStorageDeviceManager_Adopt_Request\x1a+.steam.CStorageDeviceManager_Adopt_Response\x12`\n" +
	"\x05Eject\x12*.steam.CStorageDeviceManager_Eject_Request\x1a+.steam.CStorageDeviceManager_Eject_Response\x12c\n" +
	"\x06Format\x12+.steam.CStorageDeviceManager_Format_Request\x1a,.steam.CStorageDeviceManager_Format_Response\x12f\n" +
	"\aUnmount\x12,.steam.CStorageDeviceManager_Unmount_Request\x1a-.steam.CStorageDeviceManager_Unmount_Response\x12f\n" +
	"\aTrimAll\x12,.steam.CStorageDeviceManager_TrimAll_Request\x1a-.steam.CStorageDeviceManager_TrimAll_Response\x1a\x04\x80\x97\"\x01B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_webuimessages_storagedevicemanager_proto_goTypes = []any{
	(*CStorageDeviceManager_IsServiceAvailable_Request)(nil),  // 0: steam.CStorageDeviceManager_IsServiceAvailable_Request
	(*CStorageDeviceManager_IsServiceAvailable_Response)(nil), // 1: steam.CStorageDeviceManager_IsServiceAvailable_Response
	(*CStorageDeviceManagerDrive)(nil),                        // 2: steam.CStorageDeviceManagerDrive
	(*CStorageDeviceManagerBlockDevice)(nil),                  // 3: steam.CStorageDeviceManagerBlockDevice
	(*CStorageDeviceManagerState)(nil),                        // 4: steam.CStorageDeviceManagerState
	(*CStorageDeviceManager_GetState_Request)(nil),            // 5: steam.CStorageDeviceManager_GetState_Request
	(*CStorageDeviceManager_GetState_Response)(nil),           // 6: steam.CStorageDeviceManager_GetState_Response
	(*CStorageDeviceManager_StateChanged_Notification)(nil),   // 7: steam.CStorageDeviceManager_StateChanged_Notification
	(*CStorageDeviceManager_Eject_Request)(nil),               // 8: steam.CStorageDeviceManager_Eject_Request
	(*CStorageDeviceManager_Eject_Response)(nil),              // 9: steam.CStorageDeviceManager_Eject_Response
	(*CStorageDeviceManager_Adopt_Request)(nil),               // 10: steam.CStorageDeviceManager_Adopt_Request
	(*CStorageDeviceManager_Adopt_Response)(nil),              // 11: steam.CStorageDeviceManager_Adopt_Response
	(*CStorageDeviceManager_Format_Request)(nil),              // 12: steam.CStorageDeviceManager_Format_Request
	(*CStorageDeviceManager_Format_Response)(nil),             // 13: steam.CStorageDeviceManager_Format_Response
	(*CStorageDeviceManager_Unmount_Request)(nil),             // 14: steam.CStorageDeviceManager_Unmount_Request
	(*CStorageDeviceManager_Unmount_Response)(nil),            // 15: steam.CStorageDeviceManager_Unmount_Response
	(*CStorageDeviceManager_TrimAll_Request)(nil),             // 16: steam.CStorageDeviceManager_TrimAll_Request
	(*CStorageDeviceManager_TrimAll_Response)(nil),            // 17: steam.CStorageDeviceManager_TrimAll_Response
	(EStorageDriveMediaType)(0),                               // 18: steam.EStorageDriveMediaType
	(EStorageFormatStage)(0),                                  // 19: steam.EStorageFormatStage
	(EStorageBlockContentType)(0),                             // 20: steam.EStorageBlockContentType
	(EStorageBlockFileSystemType)(0),                          // 21: steam.EStorageBlockFileSystemType
	(*WebUINoResponse)(nil),                                   // 22: steam.WebUINoResponse
}
var file_webuimessages_storagedevicemanager_proto_depIdxs = []int32{
	18, // 0: steam.CStorageDeviceManagerDrive.media_type:type_name -> steam.EStorageDriveMediaType
	19, // 1: steam.CStorageDeviceManagerDrive.adopt_stage:type_name -> steam.EStorageFormatStage
	20, // 2: steam.CStorageDeviceManagerBlockDevice.content_type:type_name -> steam.EStorageBlockContentType
	21, // 3: steam.CStorageDeviceManagerBlockDevice.filesystem_type:type_name -> steam.EStorageBlockFileSystemType
	2,  // 4: steam.CStorageDeviceManagerState.drives:type_name -> steam.CStorageDeviceManagerDrive
	3,  // 5: steam.CStorageDeviceManagerState.block_devices:type_name -> steam.CStorageDeviceManagerBlockDevice
	4,  // 6: steam.CStorageDeviceManager_GetState_Response.state:type_name -> steam.CStorageDeviceManagerState
	0,  // 7: steam.StorageDeviceManager.IsServiceAvailable:input_type -> steam.CStorageDeviceManager_IsServiceAvailable_Request
	5,  // 8: steam.StorageDeviceManager.GetState:input_type -> steam.CStorageDeviceManager_GetState_Request
	7,  // 9: steam.StorageDeviceManager.NotifyStateChanged:input_type -> steam.CStorageDeviceManager_StateChanged_Notification
	10, // 10: steam.StorageDeviceManager.Adopt:input_type -> steam.CStorageDeviceManager_Adopt_Request
	8,  // 11: steam.StorageDeviceManager.Eject:input_type -> steam.CStorageDeviceManager_Eject_Request
	12, // 12: steam.StorageDeviceManager.Format:input_type -> steam.CStorageDeviceManager_Format_Request
	14, // 13: steam.StorageDeviceManager.Unmount:input_type -> steam.CStorageDeviceManager_Unmount_Request
	16, // 14: steam.StorageDeviceManager.TrimAll:input_type -> steam.CStorageDeviceManager_TrimAll_Request
	1,  // 15: steam.StorageDeviceManager.IsServiceAvailable:output_type -> steam.CStorageDeviceManager_IsServiceAvailable_Response
	6,  // 16: steam.StorageDeviceManager.GetState:output_type -> steam.CStorageDeviceManager_GetState_Response
	22, // 17: steam.StorageDeviceManager.NotifyStateChanged:output_type -> steam.WebUINoResponse
	11, // 18: steam.StorageDeviceManager.Adopt:output_type -> steam.CStorageDeviceManager_Adopt_Response
	9,  // 19: steam.StorageDeviceManager.Eject:output_type -> steam.CStorageDeviceManager_Eject_Response
	13, // 20: steam.StorageDeviceManager.Format:output_type -> steam.CStorageDeviceManager_Format_Response
	15, // 21: steam.StorageDeviceManager.Unmount:output_type -> steam.CStorageDeviceManager_Unmount_Response
	17, // 22: steam.StorageDeviceManager.TrimAll:output_type -> steam.CStorageDeviceManager_TrimAll_Response
