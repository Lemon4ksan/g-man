...
const file_steammessages_video_steamclient_proto_rawDesc = "" +
	"\n" +
	"%steammessages_video.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"b\n" +
	...
	"\x11hide_from_library\x18\b \x01(\b:\x05falseR\x0fhideFromLibrary\"Z\n" +
	"$CVideo_SetVideoBookmark_Notification\x122\n" +
	"\tbookmarks\x18\x01 \x03(\v2\x14.steam.VideoBookmarkR\tbookmarks\"_\n" +
	" CVideo_GetVideoBookmarks_Request\x12\x16\n" +
	"\x06appids\x18\x01 \x03(\rR\x06appids\x12#\n" +
	"\rupdated_since\x18\x02 \x01(\rR\fupdatedSince\"W\n" +
	"!CVideo_GetVideoBookmarks_Response\x122\n" +
	"\tbookmarks\x18\x01 \x03(\v2\x14.steam.VideoBookmarkR\tbookmarks\"I\n" +
	...
	"\x06app_id\x18\x01 \x01(\rR\x05appId\x12!\n" +
	"\fopf_settings\x18\x02 \x01(\tR\vopfSettings2\xab\x02\n" +
	"\x05Video\x12f\n" +
	"\x11ClientGetVideoURL\x12'.steam.CVideo_ClientGetVideoURL_Request\x1a(.steam.CVideo_ClientGetVideoURL_Response\x12R\n" +
	"\x10SetVideoBookmark\x12+.steam.CVideo_SetVideoBookmark_Notification\x1a\x11.steam.NoResponse\x12f\n" +
	"\x11GetVideoBookmarks\x12'.steam.CVideo_GetVideoBookmarks_Request\x1a(.steam.CVideo_GetVideoBookmarks_Response2e\n" +
	"\vVideoClient\x12P\n" +
	"\x12NotifyUnlockedH264\x12'.steam.CVideo_UnlockedH264_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x022\x87\x01\n" +
	"\n" +
	"FovasVideo\x12y\n" +
	"\x14ClientGetOPFSettings\x12/.steam.CFovasVideo_ClientGetOPFSettings_Request\x1a0.steam.CFovasVideo_ClientGetOPFSettings_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
