...
const file_steammessages_depotbuilder_steamclient_proto_rawDesc = "" +
	"\n" +
	",steammessages_depotbuilder.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"\x9d\x02\n" +
	...
	"\x12depot_build_handle\x18\x02 \x01(\x04R\x10depotBuildHandle\"\x93\x02\n" +
	".CContentBuilder_GetMissingDepotChunks_Response\x12c\n" +
	"\x0emissing_chunks\x18\x01 \x03(\v2<.steam.CContentBuilder_GetMissingDepotChunks_Response.ChunksR\rmissingChunks\x120\n" +
	...
	"prevReused\x122\n" +
	"\x15manifest_request_code\x18\x03 \x01(\x04R\x13manifestRequestCode\"\xe4\x02\n" +
	"&CContentBuilder_CommitAppBuild_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12]\n" +
	"\x0fdepot_manifests\x18\x02 \x03(\v24.steam.CContentBuilder_CommitAppBuild_Request.DepotsR\x0edepotManifests\x12\x1f\n" +
	...
	"\x15signed_install_script\x18\x01 \x01(\tR\x13signedInstallScript2\xe4\x05\n" +
	"\x0eContentBuilder\x12o\n" +
	"\x0eInitDepotBuild\x12-.steam.CContentBuilder_InitDepotBuild_Request\x1a..steam.CContentBuilder_InitDepotBuild_Response\x12u\n" +
	"\x10StartDepotUpload\x12/.steam.CContentBuilder_StartDepotUpload_Request\x1a0.steam.CContentBuilder_StartDepotUpload_Response\x12\x84\x01\n" +
	"\x15GetMissingDepotChunks\x124.steam.CContentBuilder_GetMissingDepotChunks_Request\x1a5.steam.CContentBuilder_GetMissingDepotChunks_Response\x12x\n" +
	"\x11FinishDepotUpload\x120.steam.CContentBuilder_FinishDepotUpload_Request\x1a1.steam.CContentBuilder_FinishDepotUpload_Response\x12o\n" +
	"\x0eCommitAppBuild\x12-.steam.CContentBuilder_CommitAppBuild_Request\x1a..steam.CContentBuilder_CommitAppBuild_Response\x12x\n" +
	"\x11SignInstallScript\x120.steam.CContentBuilder_SignInstallScript_Request\x1a1.steam.CContentBuilder_SignInstallScript_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
