...
const file_steammessages_clientserver_gameservers_proto_rawDesc = "" +
	"\n" +
	",steammessages_clientserver_gameservers.proto\x12\x05steam\x1a\x18steammessages_base.proto\"\xea\x02\n" +
	...
	"\n" +
	"is_valveds\x18\x02 \x01(\bR\tisValveds\"\xed\x01\n" +
	"\x10CMsgGSPlayerList\x128\n" +
	"\aplayers\x18\x01 \x03(\v2\x1e.steam.CMsgGSPlayerList.PlayerR\aplayers\x1a\x9e\x01\n" +
	"\x06Player\x12\x19\n" +
	"\bsteam_id\x18\x01 \x01(\x04R\asteamId\x120\n" +
	"\x14deprecated_public_ip\x18\x02 \x01(\rR\x12deprecatedPublicIp\x12\x14\n" +
	"\x05token\x18\x03 \x01(\fR\x05token\x121\n" +
	"\tpublic_ip\x18\x04 \x01(\v2\x14.steam.CMsgIPAddressR\bpublicIp\"\xa9\x01\n" +
	"\x11CMsgGSUserPlaying\x12\x19\n" +
	"\bsteam_id\x18\x01 \x01(\x06R\asteamId\x120\n" +
	"\x14deprecated_public_ip\x18\x02 \x01(\rR\x12deprecatedPublicIp\x12\x14\n" +
	"\x05token\x18\x03 \x01(\fR\x05token\x121\n" +
	"\tpublic_ip\x18\x04 \x01(\v2\x14.steam.CMsgIPAddressR\bpublicIp\"3\n" +
	"\x16CMsgGSDisconnectNotice\x12\x19\n" +
	"\bsteam_id\x18\x01 \x01(\x06R\asteamId\"\xa2\x06\n" +
	...
	"\x06region\x18\n" +
	" \x01(\tR\x06region\x12:\n" +
	"\aplayers\x18\v \x03(\v2 .steam.CMsgGameServerData.PlayerR\aplayers\x12\x1f\n" +
	...
	"maxServers\x12*\n" +
	"\x11sdr_ping_location\x18\x06 \x01(\tR\x0fsdrPingLocation\"\xea\n" +
	"\n" +
	" CMsgGMSClientServerQueryResponse\x12H\n" +
	"\aservers\x18\x01 \x03(\v2..steam.CMsgGMSClientServerQueryResponse.ServerR\aservers\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\x12^\n" +
	"\x13default_server_data\x18\x03 \x01(\v2..steam.CMsgGMSClientServerQueryResponse.ServerR\x11defaultServerData\x12%\n" +
	"\x0eserver_strings\x18\x04 \x03(\tR\rserverStrings\x1a\xa7\b\n" +
	"\x06Server\x120\n" +
	"\x14deprecated_server_ip\x18\x01 \x01(\rR\x12deprecatedServerIp\x12\x1d\n" +
	"\n" +
	"query_port\x18\x02 \x01(\rR\tqueryPort\x12!\n" +
	"\fauth_players\x18\x03 \x01(\rR\vauthPlayers\x121\n" +
	"\tserver_ip\x18\x04 \x01(\v2\x14.steam.CMsgIPAddressR\bserverIp\x12\x19\n" +
	...
	"\x1cct_clanmembers_dont_like_you\x18\x06 \x01(\x05R\x18ctClanmembersDontLikeYouB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steammessages_clientserver_gameservers_proto_goTypes = []any{
	(CMsgGMSClientServerQueryResponse_EFlags)(0),        // 0: steam.CMsgGMSClientServerQueryResponse.EFlags
	(*CMsgGSServerType)(nil),                            // 1: steam.CMsgGSServerType
	(*CMsgGSStatusReply)(nil),                           // 2: steam.CMsgGSStatusReply
	(*CMsgGSPlayerList)(nil),                            // 3: steam.CMsgGSPlayerList
	(*CMsgGSUserPlaying)(nil),                           // 4: steam.CMsgGSUserPlaying
	(*CMsgGSDisconnectNotice)(nil),                      // 5: steam.CMsgGSDisconnectNotice
	(*CMsgGameServerData)(nil),                          // 6: steam.CMsgGameServerData
	(*CMsgGameServerRemove)(nil),                        // 7: steam.CMsgGameServerRemove
	(*CMsgClientGMSServerQuery)(nil),                    // 8: steam.CMsgClientGMSServerQuery
	(*CMsgGMSClientServerQueryResponse)(nil),            // 9: steam.CMsgGMSClientServerQueryResponse
	(*CMsgGameServerOutOfDate)(nil),                     // 10: steam.CMsgGameServerOutOfDate
	(*CMsgGSAssociateWithClan)(nil),                     // 11: steam.CMsgGSAssociateWithClan
	(*CMsgGSAssociateWithClanResponse)(nil),             // 12: steam.CMsgGSAssociateWithClanResponse
	(*CMsgGSComputeNewPlayerCompatibility)(nil),         // 13: steam.CMsgGSComputeNewPlayerCompatibility
	(*CMsgGSComputeNewPlayerCompatibilityResponse)(nil), // 14: steam.CMsgGSComputeNewPlayerCompatibilityResponse
	(*CMsgGSPlayerList_Player)(nil),                     // 15: steam.CMsgGSPlayerList.Player
	(*CMsgGameServerData_Player)(nil),                   // 16: steam.CMsgGameServerData.Player
	(*CMsgGMSClientServerQueryResponse_Server)(nil),     // 17: steam.CMsgGMSClientServerQueryResponse.Server
	(*CMsgIPAddress)(nil),                               // 18: steam.CMsgIPAddress
}
var file_steammessages_clientserver_gameservers_proto_depIdxs = []int32{
	15, // 0: steam.CMsgGSPlayerList.players:type_name -> steam.CMsgGSPlayerList.Player
	18, // 1: steam.CMsgGSUserPlaying.public_ip:type_name -> steam.CMsgIPAddress
	16, // 2: steam.CMsgGameServerData.players:type_name -> steam.CMsgGameServerData.Player
	17, // 3: steam.CMsgGMSClientServerQueryResponse.servers:type_name -> steam.CMsgGMSClientServerQueryResponse.Server
	17, // 4: steam.CMsgGMSClientServerQueryResponse.default_server_data:type_name -> steam.CMsgGMSClientServerQueryResponse.Server
	18, // 5: steam.CMsgGSPlayerList.Player.public_ip:type_name -> steam.CMsgIPAddress
	18, // 6: steam.CMsgGMSClientServerQueryResponse.Server.server_ip:type_name -> steam.CMsgIPAddress
