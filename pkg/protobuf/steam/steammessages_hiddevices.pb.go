...
const file_steammessages_hiddevices_proto_rawDesc = "" +
	"\n" +
	"\x1esteammessages_hiddevices.proto\x12\x05steam\"\x8b\a\n" +
	"\x0eCHIDDeviceInfo\x12M\n" +
	"\blocation\x18\x01 \x01(\x0e2\x19.steam.EHIDDeviceLocation:\x16k_EDeviceLocationLocalR\blocation\x12\x12\n" +
	...
	"\x10delta_report_crc\x18\x04 \x01(\rR\x0edeltaReportCrc\"\xe7\x10\n" +
	"\x13CHIDMessageToRemote\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\rR\trequestId\x12H\n" +
	"\vdevice_open\x18\x02 \x01(\v2%.steam.CHIDMessageToRemote.DeviceOpenH\x00R\n" +
	"deviceOpen\x12K\n" +
	"\fdevice_close\x18\x03 \x01(\v2&.steam.CHIDMessageToRemote.DeviceCloseH\x00R\vdeviceClose\x12K\n" +
	"\fdevice_write\x18\x04 \x01(\v2&.steam.CHIDMessageToRemote.DeviceWriteH\x00R\vdeviceWrite\x12H\n" +
	"\vdevice_read\x18\x05 \x01(\v2%.steam.CHIDMessageToRemote.DeviceReadH\x00R\n" +
	"deviceRead\x12q\n" +
	"\x1adevice_send_feature_report\x18\x06 \x01(\v22.steam.CHIDMessageToRemote.DeviceSendFeatureReportH\x00R\x17deviceSendFeatureReport\x12n\n" +
	"\x19device_get_feature_report\x18\a \x01(\v21.steam.CHIDMessageToRemote.DeviceGetFeatureReportH\x00R\x16deviceGetFeatureReport\x12k\n" +
	"\x18device_get_vendor_string\x18\b \x01(\v20.steam.CHIDMessageToRemote.DeviceGetVendorStringH\x00R\x15deviceGetVendorString\x12n\n" +
	"\x19device_get_product_string\x18\t \x01(\v21.steam.CHIDMessageToRemote.DeviceGetProductStringH\x00R\x16deviceGetProductString\x12~\n" +
	"\x1fdevice_get_serial_number_string\x18\n" +
	" \x01(\v26.steam.CHIDMessageToRemote.DeviceGetSerialNumberStringH\x00R\x1bdeviceGetSerialNumberString\x12q\n" +
	"\x1adevice_start_input_reports\x18\v \x01(\v22.steam.CHIDMessageToRemote.DeviceStartInputReportsH\x00R\x17deviceStartInputReports\x12q\n" +
	"\x1adevice_request_full_report\x18\f \x01(\v22.steam.CHIDMessageToRemote.DeviceRequestFullReportH\x00R\x17deviceRequestFullReport\x12Z\n" +
	"\x11device_disconnect\x18\r \x01(\v2+.steam.CHIDMessageToRemote.DeviceDisconnectH\x00R\x10deviceDisconnect\x1a7\n" +
	"\n" +
	"DeviceOpen\x12)\n" +
	"\x04info\x18\x01 \x01(\v2\x15.steam.CHIDDeviceInfoR\x04info\x1a%\n" +
	...
	"\x06device\x18\x01 \x01(\rR\x06device\x1a\xaf\x01\n" +
	"\x10DeviceDisconnect\x12\x16\n" +
	"\x06device\x18\x01 \x01(\rR\x06device\x12o\n" +
	"\x10disconnectMethod\x18\x02 \x01(\x0e2!.steam.EHIDDeviceDisconnectMethod: k_EDeviceDisconnectMethodUnknownR\x10disconnectMethod\x12\x12\n" +
	"\x04data\x18\x03 \x01(\fR\x04dataB\t\n" +
	"\acommand\"\x88\a\n" +
	"\x15CHIDMessageFromRemote\x12]\n" +
	"\x12update_device_list\x18\x01 \x01(\v2-.steam.CHIDMessageFromRemote.UpdateDeviceListH\x00R\x10updateDeviceList\x12J\n" +
	"\bresponse\x18\x02 \x01(\v2,.steam.CHIDMessageFromRemote.RequestResponseH\x00R\bresponse\x12K\n" +
	"\areports\x18\x03 \x01(\v2/.steam.CHIDMessageFromRemote.DeviceInputReportsH\x00R\areports\x12M\n" +
	"\fclose_device\x18\x04 \x01(\v2(.steam.CHIDMessageFromRemote.CloseDeviceH\x00R\vcloseDevice\x12Z\n" +
	"\x11close_all_devices\x18\x05 \x01(\v2,.steam.CHIDMessageFromRemote.CloseAllDevicesH\x00R\x0fcloseAllDevices\x1aC\n" +
	"\x10UpdateDeviceList\x12/\n" +
	"\adevices\x18\x01 \x03(\v2\x15.steam.CHIDDeviceInfoR\adevices\x1a\\\n" +
	"\x0fRequestResponse\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\rR\trequestId\x12\x16\n" +
	"\x06result\x18\x02 \x01(\x05R\x06result\x12\x12\n" +
	"\x04data\x18\x03 \x01(\fR\x04data\x1a\xe3\x01\n" +
	"\x12DeviceInputReports\x12h\n" +
	"\x0edevice_reports\x18\x01 \x03(\v2A.steam.CHIDMessageFromRemote.DeviceInputReports.DeviceInputReportR\rdeviceReports\x1ac\n" +
	"\x11DeviceInputReport\x12\x16\n" +
	"\x06device\x18\x01 \x01(\rR\x06device\x126\n" +
	"\areports\x18\x02 \x03(\v2\x1c.steam.CHIDDeviceInputReportR\areports\x1a%\n" +
	...
	"%k_EDeviceDisconnectMethodOutputReport\x10\x03B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
