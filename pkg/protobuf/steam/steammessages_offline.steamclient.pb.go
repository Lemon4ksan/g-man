...
const file_steammessages_offline_steamclient_proto_rawDesc = "" +
	"\n" +
	"'steammessages_offline.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\x1a\x14offline_ticket.proto\"s\n" +
	"&COffline_GetOfflineLogonTicket_Request\x12\x1a\n" +
	"\bpriority\x18\x01 \x01(\rR\bpriority\x12-\n" +
	"\x12perform_encryption\x18\x02 \x01(\bR\x11performEncryption\"\xb6\x01\n" +
	"'COffline_GetOfflineLogonTicket_Response\x12+\n" +
	"\x11serialized_ticket\x18\x01 \x01(\fR\x10serializedTicket\x12\x1c\n" +
	"\tsignature\x18\x02 \x01(\fR\tsignature\x12@\n" +
	"\x10encrypted_ticket\x18\x03 \x01(\v2\x15.steam.Offline_TicketR\x0fencryptedTicket\"0\n" +
	...
	"\x15rtime32_creation_time\x18\x02 \x01(\aR\x13rtime32CreationTime\"m\n" +
	"/COffline_GetUnsignedOfflineLogonTicket_Response\x12:\n" +
	"\x06ticket\x18\x01 \x01(\v2\".steam.COffline_OfflineLogonTicketR\x06ticket2\x92\x02\n" +
	"\aOffline\x12v\n" +
	"\x15GetOfflineLogonTicket\x12-.steam.COffline_GetOfflineLogonTicket_Request\x1a..steam.COffline_GetOfflineLogonTicket_Response\x12\x8e\x01\n" +
	"\x1dGetUnsignedOfflineLogonTicket\x125.steam.COffline_GetUnsignedOfflineLogonTicket_Request\x1a6.steam.COffline_GetUnsignedOfflineLogonTicket_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_offline_steamclient_proto_goTypes = []any{
	...
	(*Offline_Ticket)(nil),                                  // 5: steam.Offline_Ticket
}
var file_steammessages_offline_steamclient_proto_depIdxs = []int32{
	5, // 0: steam.COffline_GetOfflineLogonTicket_Response.encrypted_ticket:type_name -> steam.Offline_Ticket
	3, // 1: steam.COffline_GetUnsignedOfflineLogonTicket_Response.ticket:type_name -> steam.COffline_OfflineLogonTicket
	0, // 2: steam.Offline.GetOfflineLogonTicket:input_type -> steam.COffline_GetOfflineLogonTicket_Request
	2, // 3: steam.Offline.GetUnsignedOfflineLogonTicket:input_type -> steam.COffline_GetUnsignedOfflineLogonTicket_Request
	1, // 4: steam.Offline.GetOfflineLogonTicket:output_type -> steam.COffline_GetOfflineLogonTicket_Response
	4, // 5: steam.Offline.GetUnsignedOfflineLogonTicket:output_type -> steam.COffline_GetUnsignedOfflineLogonTicket_Response
