...
const file_steammessages_gamerecording_objects_proto_rawDesc = "" +
	"\n" +
	")steammessages_gamerecording_objects.proto\x12\x05steam\x1a\venums.proto\"\xa5\x03\n" +
	"0CGameRecording_AudioSessionsChanged_Notification\x12[\n" +
	"\bsessions\x18\x01 \x03(\v2?.steam.CGameRecording_AudioSessionsChanged_Notification.SessionR\bsessions\x1a\x93\x02\n" +
	"\aSession\x12\x0e\n" +
	...
	"\bis_saved\x18\n" +
	" \x01(\bR\aisSavedB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steammessages_gamerecording_objects_proto_goTypes = []any{
	(*CGameRecording_AudioSessionsChanged_Notification)(nil),         // 0: steam.CGameRecording_AudioSessionsChanged_Notification
	(*CGameRecording_AudioSessionsChanged_Notification_Session)(nil), // 1: steam.CGameRecording_AudioSessionsChanged_Notification.Session
}
var file_steammessages_gamerecording_objects_proto_depIdxs = []int32{
	1, // 0: steam.CGameRecording_AudioSessionsChanged_Notification.sessions:type_name -> steam.CGameRecording_AudioSessionsChanged_Notification.Session
