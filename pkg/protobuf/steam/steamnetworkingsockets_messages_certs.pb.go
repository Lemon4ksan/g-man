...
type CMsgSteamDatagramCertificate struct {
	state                   protoimpl.MessageState                   `protogen:"open.v1"`
	KeyType                 *CMsgSteamDatagramCertificate_EKeyType   `protobuf:"varint,1,opt,name=key_type,json=keyType,enum=steam.CMsgSteamDatagramCertificate_EKeyType,def=0" json:"key_type,omitempty"`
...
const file_steamnetworkingsockets_messages_certs_proto_rawDesc = "" +
	"\n" +
	"+steamnetworkingsockets_messages_certs.proto\x12\x05steam\"\xb4\x01\n" +
	...
	"\ripv6_and_port\x18\x04 \x01(\fR\vipv6AndPort\"\xa4\x04\n" +
	"\x1cCMsgSteamDatagramCertificate\x12P\n" +
	"\bkey_type\x18\x01 \x01(\x0e2,.steam.CMsgSteamDatagramCertificate.EKeyType:\aINVALIDR\akeyType\x12\x19\n" +
	"\bkey_data\x18\x02 \x01(\fR\akeyData\x12&\n" +
	"\x0flegacy_steam_id\x18\x04 \x01(\x06R\rlegacySteamId\x12d\n" +
	"\x16legacy_identity_binary\x18\v \x01(\v2..steam.CMsgSteamNetworkingIdentityLegacyBinaryR\x14legacyIdentityBinary\x12'\n" +
	...
	"#CMsgSteamDatagramCertificateRequest\x127\n" +
	"\x04cert\x18\x01 \x01(\v2#.steam.CMsgSteamDatagramCertificateR\x04certB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steamnetworkingsockets_messages_certs_proto_goTypes = []any{
	(CMsgSteamDatagramCertificate_EKeyType)(0),      // 0: steam.CMsgSteamDatagramCertificate.EKeyType
	(*CMsgSteamNetworkingIdentityLegacyBinary)(nil), // 1: steam.CMsgSteamNetworkingIdentityLegacyBinary
	(*CMsgSteamDatagramCertificate)(nil),            // 2: steam.CMsgSteamDatagramCertificate
	(*CMsgSteamDatagramCertificateSigned)(nil),      // 3: steam.CMsgSteamDatagramCertificateSigned
	(*CMsgSteamDatagramCertificateRequest)(nil),     // 4: steam.CMsgSteamDatagramCertificateRequest
}
var file_steamnetworkingsockets_messages_certs_proto_depIdxs = []int32{
	0, // 0: steam.CMsgSteamDatagramCertificate.key_type:type_name -> steam.CMsgSteamDatagramCertificate.EKeyType
	1, // 1: steam.CMsgSteamDatagramCertificate.legacy_identity_binary:type_name -> steam.CMsgSteamNetworkingIdentityLegacyBinary
	2, // 2: steam.CMsgSteamDatagramCertificateRequest.cert:type_name -> steam.CMsgSteamDatagramCertificate
