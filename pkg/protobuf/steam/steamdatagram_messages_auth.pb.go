...
const file_steamdatagram_messages_auth_proto_rawDesc = "" +
	"\n" +
	"!steamdatagram_messages_auth.proto\x12\x05steam\x1a+steamnetworkingsockets_messages_certs.proto\"\xa0\a\n" +
	...
	"\fvirtual_port\x18\n" +
	" \x01(\rR\vvirtualPort\x12U\n" +
	"\fextra_fields\x18\b \x03(\v22.steam.CMsgSteamDatagramRelayAuthTicket.ExtraFieldR\vextraFields\x12;\n" +
	...
	"int64Value\x12#\n" +
	"\rfixed64_value\x18\x05 \x01(\x06R\ffixed64Value\"\xe5\x01\n" +
	...
	"\x05certs\x18\x05 \x03(\v2).steam.CMsgSteamDatagramCertificateSignedR\x05certs\"\x84\x01\n" +
	...
	"\x0edummy_steam_id\x18c \x01(\x06R\fdummySteamId\"\xa6\x01\n" +
	"1CMsgSteamDatagramSignedGameCoordinatorServerLogin\x12=\n" +
	"\x04cert\x18\x01 \x01(\v2).steam.CMsgSteamDatagramCertificateSignedR\x04cert\x12\x14\n" +
	...
	"\x10protocol_version\x18\x05 \x01(\rR\x0fprotocolVersionB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steamdatagram_messages_auth_proto_goTypes = []any{
	(*CMsgSteamDatagramRelayAuthTicket)(nil),                  // 0: steam.CMsgSteamDatagramRelayAuthTicket
	(*CMsgSteamDatagramSignedRelayAuthTicket)(nil),            // 1: steam.CMsgSteamDatagramSignedRelayAuthTicket
	(*CMsgSteamDatagramCachedCredentialsForApp)(nil),          // 2: steam.CMsgSteamDatagramCachedCredentialsForApp
	(*CMsgSteamDatagramGameCoordinatorServerLogin)(nil),       // 3: steam.CMsgSteamDatagramGameCoordinatorServerLogin
	(*CMsgSteamDatagramSignedGameCoordinatorServerLogin)(nil), // 4: steam.CMsgSteamDatagramSignedGameCoordinatorServerLogin
	(*CMsgSteamDatagramHostedServerAddressPlaintext)(nil),     // 5: steam.CMsgSteamDatagramHostedServerAddressPlaintext
	(*CMsgSteamDatagramRelayAuthTicket_ExtraField)(nil),       // 6: steam.CMsgSteamDatagramRelayAuthTicket.ExtraField
	(*CMsgSteamDatagramCertificateSigned)(nil),                // 7: steam.CMsgSteamDatagramCertificateSigned
}
var file_steamdatagram_messages_auth_proto_depIdxs = []int32{
	6, // 0: steam.CMsgSteamDatagramRelayAuthTicket.extra_fields:type_name -> steam.CMsgSteamDatagramRelayAuthTicket.ExtraField
	7, // 1: steam.CMsgSteamDatagramSignedRelayAuthTicket.certs:type_name -> steam.CMsgSteamDatagramCertificateSigned
	7, // 2: steam.CMsgSteamDatagramSignedGameCoordinatorServerLogin.cert:type_name -> steam.CMsgSteamDatagramCertificateSigned
