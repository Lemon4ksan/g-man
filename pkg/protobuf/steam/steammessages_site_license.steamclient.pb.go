...
const file_steammessages_site_license_steamclient_proto_rawDesc = "" +
	"\n" +
	",steammessages_site_license.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"\xca\x01\n" +
	...
	"\aeresult\x18\x02 \x01(\rR\aeresult\"\xee\x03\n" +
	"/CSiteManagerClient_TrackedPayments_Notification\x12\x17\n" +
	"\asite_id\x18\x01 \x01(\x06R\x06siteId\x12Z\n" +
	"\bpayments\x18\x02 \x03(\v2>.steam.CSiteManagerClient_TrackedPayments_Notification.PaymentR\bpayments\x1a\xc5\x02\n" +
	"\aPayment\x12\x18\n" +
	...
	"\x0favailable_seats\x18\x01 \x01(\rR\x0eavailableSeats2\xe4\x02\n" +
	"\x11SiteManagerClient\x12u\n" +
	"\x0eIncomingClient\x120.steam.CSiteManagerClient_IncomingClient_Request\x1a1.steam.CSiteManagerClient_IncomingClient_Response\x12h\n" +
	"\x1eClientSeatCheckoutNotification\x123.steam.CSiteLicense_ClientSeatCheckout_Notification\x1a\x11.steam.NoResponse\x12h\n" +
	"\x1bTrackedPaymentsNotification\x126.steam.CSiteManagerClient_TrackedPayments_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x022\xe4\x04\n" +
	"\vSiteLicense\x12x\n" +
	"\x13InitiateAssociation\x12/.steam.CSiteLicense_InitiateAssociation_Request\x1a0.steam.CSiteLicense_InitiateAssociation_Response\x12l\n" +
	"\x0fLCSAuthenticate\x12+.steam.CSiteLicense_LCSAuthenticate_Request\x1a,.steam.CSiteLicense_LCSAuthenticate_Response\x12o\n" +
	"\x10LCSAssociateUser\x12,.steam.CSiteLicense_LCSAssociateUser_Request\x1a-.steam.CSiteLicense_LCSAssociateUser_Response\x12u\n" +
	"\x12ClientSeatCheckout\x12..steam.CSiteLicense_ClientSeatCheckout_Request\x1a/.steam.CSiteLicense_ClientSeatCheckout_Response\x12\x84\x01\n" +
	"\x17ClientGetAvailableSeats\x123.steam.CSiteLicense_ClientGetAvailableSeats_Request\x1a4.steam.CSiteLicense_ClientGetAvailableSeats_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
