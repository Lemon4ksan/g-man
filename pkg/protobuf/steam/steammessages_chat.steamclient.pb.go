...
type CChatRoom_UpdateMessageReaction_Request struct {
	...
	ReactionType    *EChatRoomMessageReactionType `protobuf:"varint,5,opt,name=reaction_type,json=reactionType,enum=steam.EChatRoomMessageReactionType,def=0" json:"reaction_type,omitempty"`
...
type CChatRoom_ReportMessage_Request struct {
	...
	ReportReason  *EContentReportReason      `protobuf:"varint,6,opt,name=report_reason,json=reportReason,enum=steam.EContentReportReason,def=0" json:"report_reason,omitempty"`
	...
	SubjectType   *EContentReportSubjectType `protobuf:"varint,9,opt,name=subject_type,json=subjectType,enum=steam.EContentReportSubjectType,def=0" json:"subject_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CChatRoom_ResolveReport_Request struct {
	...
	Resolution         *EContentReportResolution  `protobuf:"varint,3,opt,name=resolution,enum=steam.EContentReportResolution,def=0" json:"resolution,omitempty"`
	Reason             *EContentReportReason      `protobuf:"varint,4,opt,name=reason,enum=steam.EContentReportReason,def=0" json:"reason,omitempty"`
	SubjectType        *EContentReportSubjectType `protobuf:"varint,5,opt,name=subject_type,json=subjectType,enum=steam.EContentReportSubjectType,def=0" json:"subject_type,omitempty"`
...
type CChatRoom_MessageReaction_Notification struct {
	...
	ReactionType    *EChatRoomMessageReactionType `protobuf:"varint,6,opt,name=reaction_type,json=reactionType,enum=steam.EChatRoomMessageReactionType,def=0" json:"reaction_type,omitempty"`
...
type CChatRoom_GetMessageHistory_Response_ChatMessage_MessageReaction struct {
	state          protoimpl.MessageState        `protogen:"open.v1"`
	ReactionType   *EChatRoomMessageReactionType `protobuf:"varint,1,opt,name=reaction_type,json=reactionType,enum=steam.EChatRoomMessageReactionType,def=0" json:"reaction_type,omitempty"`
...
const file_steammessages_chat_steamclient_proto_rawDesc = "" +
	"\n" +
	"$steammessages_chat.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\x1a(steammessages_clientserver_friends.proto\x1a\venums.proto\"*\n" +
	...
	"\rgame_metadata\x18\x04 \x01(\tR\fgameMetadata\"\xab\x05\n" +
	...
	"\x05roles\x18\x12 \x03(\v2\x10.steam.CChatRoleR\x05roles\x12:\n" +
	"\frole_actions\x18\x13 \x03(\v2\x17.steam.CChatRoleActionsR\vroleActions\x12@\n" +
	"\x1cwatching_broadcast_accountid\x18\x14 \x01(\rR\x1awatchingBroadcastAccountid\x12<\n" +
	"\rparty_beacons\x18\x16 \x03(\v2\x17.steam.CChatPartyBeaconR\fpartyBeacons\x12A\n" +
	...
	"\bdisabled\x18\x1a \x01(\bR\bdisabled\"\x90\x02\n" +
	"\x0fCChatRoomMember\x12\x1c\n" +
	"\taccountid\x18\x01 \x01(\rR\taccountid\x12M\n" +
	"\x05state\x18\x03 \x01(\x0e2\x19.steam.EChatRoomJoinState:\x1ck_EChatRoomJoinState_DefaultR\x05state\x12K\n" +
	"\x04rank\x18\x04 \x01(\x0e2\x19.steam.EChatRoomGroupRank:\x1ck_EChatRoomGroupRank_DefaultR\x04rank\x12(\n" +
	...
	"\x16accountid_last_message\x18\b \x01(\rR\x14accountidLastMessage\"\x9a\x02\n" +
	"\x13CChatRoomGroupState\x12C\n" +
	"\fheader_state\x18\x01 \x01(\v2 .steam.CChatRoomGroupHeaderStateR\vheaderState\x120\n" +
	"\amembers\x18\x02 \x03(\v2\x16.steam.CChatRoomMemberR\amembers\x12&\n" +
	"\x0fdefault_chat_id\x18\x04 \x01(\x04R\rdefaultChatId\x124\n" +
	"\n" +
	"chat_rooms\x18\x05 \x03(\v2\x15.steam.CChatRoomStateR\tchatRooms\x12.\n" +
	"\x06kicked\x18\a \x03(\v2\x16.steam.CChatRoomMemberR\x06kicked\"\x95\x04\n" +
	"\x12CUserChatRoomState\x12\x17\n" +
	"\achat_id\x18\x01 \x01(\x04R\x06chatId\x12\x1f\n" +
	"\vtime_joined\x18\x02 \x01(\rR\n" +
	"timeJoined\x12\"\n" +
	"\rtime_last_ack\x18\x03 \x01(\rR\vtimeLastAck\x12\x85\x01\n" +
	"\x1adesktop_notification_level\x18\x04 \x01(\x0e2!.steam.EChatRoomNotificationLevel:$k_EChatroomNotificationLevel_InvalidR\x18desktopNotificationLevel\x12\x83\x01\n" +
	"\x19mobile_notification_level\x18\x05 \x01(\x0e2!.steam.EChatRoomNotificationLevel:$k_EChatroomNotificationLevel_InvalidR\x17mobileNotificationLevel\x12*\n" +
	...
	"\x11time_first_unread\x18\b \x01(\rR\x0ftimeFirstUnread\"\xdc\x04\n" +
	"\x17CUserChatRoomGroupState\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\x12\x1f\n" +
	"\vtime_joined\x18\x02 \x01(\rR\n" +
	"timeJoined\x12J\n" +
	"\x14user_chat_room_state\x18\x03 \x03(\v2\x19.steam.CUserChatRoomStateR\x11userChatRoomState\x12\x85\x01\n" +
	"\x1adesktop_notification_level\x18\x04 \x01(\x0e2!.steam.EChatRoomNotificationLevel:$k_EChatroomNotificationLevel_InvalidR\x18desktopNotificationLevel\x12\x83\x01\n" +
	"\x19mobile_notification_level\x18\x05 \x01(\x0e2!.steam.EChatRoomNotificationLevel:$k_EChatroomNotificationLevel_InvalidR\x17mobileNotificationLevel\x12-\n" +
	...
	"\x17direct_messages_allowed\x18\b \x01(\bR\x15directMessagesAllowed\"\xc6\x01\n" +
	"&CChatRoom_CreateChatRoomGroup_Response\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\x120\n" +
	"\x05state\x18\x02 \x01(\v2\x1a.steam.CChatRoomGroupStateR\x05state\x12F\n" +
	"\x0fuser_chat_state\x18\x03 \x01(\v2\x1e.steam.CUserChatRoomGroupStateR\ruserChatState\"]\n" +
	...
	"\x1dCChatRoom_CreateRole_Response\x121\n" +
	"\aactions\x18\x02 \x01(\v2\x17.steam.CChatRoleActionsR\aactions\"@\n" +
	"\x1aCChatRoom_GetRoles_Request\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\"E\n" +
	"\x1bCChatRoom_GetRoles_Response\x12&\n" +
	"\x05roles\x18\x01 \x03(\v2\x10.steam.CChatRoleR\x05roles\"o\n" +
	...
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\x12\x17\n" +
	"\arole_id\x18\x02 \x01(\x04R\x06roleId\"V\n" +
	"!CChatRoom_GetRoleActions_Response\x121\n" +
	"\aactions\x18\x01 \x03(\v2\x17.steam.CChatRoleActionsR\aactions\"\x96\x01\n" +
	"$CChatRoom_ReplaceRoleActions_Request\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\x12\x17\n" +
	"\arole_id\x18\x02 \x01(\x04R\x06roleId\x121\n" +
	"\aactions\x18\x04 \x01(\v2\x17.steam.CChatRoleActionsR\aactions\"'\n" +
	...
	"inviteCode\x12\x17\n" +
	"\achat_id\x18\x03 \x01(\x04R\x06chatId\"\xe3\x01\n" +
	"$CChatRoom_JoinChatRoomGroup_Response\x120\n" +
	"\x05state\x18\x01 \x01(\v2\x1a.steam.CChatRoomGroupStateR\x05state\x12F\n" +
	"\x0fuser_chat_state\x18\x03 \x01(\v2\x1e.steam.CUserChatRoomGroupStateR\ruserChatState\x12 \n" +
	...
	"allowVoice\"W\n" +
	"!CChatRoom_CreateChatRoom_Response\x122\n" +
	"\tchat_room\x18\x01 \x01(\v2\x15.steam.CChatRoomStateR\bchatRoom\"_\n" +
	...
	"\tmax_count\x18\a \x01(\rR\bmaxCount\"\xb2\x01\n" +
	"\rServerMessage\x12U\n" +
	"\amessage\x18\x01 \x01(\x0e2\x1d.steam.EChatRoomServerMessage:\x1ck_EChatRoomServerMsg_InvalidR\amessage\x12!\n" +
	"\fstring_param\x18\x02 \x01(\tR\vstringParam\x12'\n" +
	"\x0faccountid_param\x18\x03 \x01(\rR\x0eaccountidParam\"\xd6\x05\n" +
	"$CChatRoom_GetMessageHistory_Response\x12S\n" +
	"\bmessages\x18\x01 \x03(\v27.steam.CChatRoom_GetMessageHistory_Response.ChatMessageR\bmessages\x12%\n" +
	"\x0emore_available\x18\x04 \x01(\bR\rmoreAvailable\x1a\xb1\x04\n" +
	"\vChatMessage\x12\x16\n" +
	"\x06sender\x18\x01 \x01(\rR\x06sender\x12)\n" +
	"\x10server_timestamp\x18\x02 \x01(\rR\x0fserverTimestamp\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x12\x18\n" +
	"\aordinal\x18\x04 \x01(\rR\aordinal\x12;\n" +
	"\x0eserver_message\x18\x05 \x01(\v2\x14.steam.ServerMessageR\rserverMessage\x12\x18\n" +
	"\adeleted\x18\x06 \x01(\bR\adeleted\x12e\n" +
	"\treactions\x18\a \x03(\v2G.steam.CChatRoom_GetMessageHistory_Response.ChatMessage.MessageReactionR\treactions\x1a\xec\x01\n" +
	"\x0fMessageReaction\x12p\n" +
	"\rreaction_type\x18\x01 \x01(\x0e2#.steam.EChatRoomMessageReactionType:&k_EChatRoomMessageReactionType_InvalidR\freactionType\x12\x1a\n" +
	...
	"%CChatRoom_GetMyChatRoomGroups_Request\"\x99\b\n" +
	...
	"\x0fdefault_chat_id\x18\x05 \x01(\x04R\rdefaultChatId\x124\n" +
	"\n" +
	"chat_rooms\x18\x06 \x03(\v2\x15.steam.CChatRoomStateR\tchatRooms\x12\x16\n" +
	...
	" \x03(\rR\n" +
	"topMembers\x121\n" +
	"\x15chat_group_avatar_sha\x18\v \x01(\fR\x12chatGroupAvatarSha\x12K\n" +
	"\x04rank\x18\f \x01(\x0e2\x19.steam.EChatRoomGroupRank:\x1ck_EChatRoomGroupRank_DefaultR\x04rank\x12&\n" +
	"\x0fdefault_role_id\x18\r \x01(\x04R\rdefaultRoleId\x12\x19\n" +
	"\brole_ids\x18\x0e \x03(\x04R\aroleIds\x12:\n" +
	"\frole_actions\x18\x0f \x03(\v2\x17.steam.CChatRoleActionsR\vroleActions\x12@\n" +
	"\x1cwatching_broadcast_accountid\x18\x10 \x01(\rR\x1awatchingBroadcastAccountid\x12\x14\n" +
	"\x05appid\x18\x11 \x01(\rR\x05appid\x12<\n" +
	"\rparty_beacons\x18\x12 \x03(\v2\x17.steam.CChatPartyBeaconR\fpartyBeacons\x12A\n" +
	...
	"\bdisabled\x18\x16 \x01(\bR\bdisabled\"\xc1\x01\n" +
	"\x14CChatRoomSummaryPair\x12Q\n" +
	"\x15user_chat_group_state\x18\x01 \x01(\v2\x1e.steam.CUserChatRoomGroupStateR\x12userChatGroupState\x12V\n" +
	"\rgroup_summary\x18\x02 \x01(\v21.steam.CChatRoom_GetChatRoomGroupSummary_ResponseR\fgroupSummary\"o\n" +
	"&CChatRoom_GetMyChatRoomGroups_Response\x12E\n" +
	"\x10chat_room_groups\x18\x01 \x03(\v2\x1b.steam.CChatRoomSummaryPairR\x0echatRoomGroups\"M\n" +
	"'CChatRoom_GetChatRoomGroupState_Request\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\"\\\n" +
	"(CChatRoom_GetChatRoomGroupState_Response\x120\n" +
	"\x05state\x18\x01 \x01(\v2\x1a.steam.CChatRoomGroupStateR\x05state\"\x82\x01\n" +
	...
	"\achat_id\x18\x06 \x01(\x04R\x06chatId\x12V\n" +
	"\rgroup_summary\x18\b \x01(\v21.steam.CChatRoom_GetChatRoomGroupSummary_ResponseR\fgroupSummary\x12Q\n" +
	"\x15user_chat_group_state\x18\t \x01(\v2\x1e.steam.CUserChatRoomGroupStateR\x12userChatGroupState\x12(\n" +
	...
	"inviteCode\"\xbc\x01\n" +
	" CChatRoom_GetInviteInfo_Response\x12V\n" +
	"\rgroup_summary\x18\x01 \x01(\v21.steam.CChatRoom_GetChatRoomGroupSummary_ResponseR\fgroupSummary\x12(\n" +
	...
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\"\x9c\x02\n" +
	")CChatRoom_GetInviteLinksForGroup_Response\x12\\\n" +
	"\finvite_links\x18\x01 \x03(\v29.steam.CChatRoom_GetInviteLinksForGroup_Response.LinkInfoR\vinviteLinks\x1a\x90\x01\n" +
	"\bLinkInfo\x12\x1f\n" +
	"\vinvite_code\x18\x01 \x01(\tR\n" +
	"inviteCode\x12'\n" +
	...
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\"\xf4\x01\n" +
	"\x1dCChatRoom_GetBanList_Response\x12@\n" +
	"\x04bans\x18\x01 \x03(\v2,.steam.CChatRoom_GetBanList_Response.BanInfoR\x04bans\x1a\x90\x01\n" +
	"\aBanInfo\x12\x1c\n" +
	...
	"\ftime_invited\x18\x03 \x01(\rR\vtimeInvited\"Y\n" +
	" CChatRoom_GetInviteList_Response\x125\n" +
	"\ainvites\x18\x01 \x03(\v2\x1b.steam.CChatRoomGroupInviteR\ainvites\"i\n" +
	...
	"\x1cvirtualize_members_threshold\x18\x03 \x01(\x05R\x1avirtualizeMembersThreshold\"\xba\x01\n" +
	"1CChatRoom_SetSessionActiveChatRoomGroups_Response\x12;\n" +
	"\vchat_states\x18\x01 \x03(\v2\x1a.steam.CChatRoomGroupStateR\n" +
	"chatStates\x12H\n" +
	"!virtualize_members_chat_group_ids\x18\x02 \x03(\x04R\x1dvirtualizeMembersChatGroupIds\"\xdc\b\n" +
	"-CChatRoom_SetUserChatGroupPreferences_Request\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\x12\x7f\n" +
	"\x16chat_group_preferences\x18\x02 \x01(\v2I.steam.CChatRoom_SetUserChatGroupPreferences_Request.ChatGroupPreferencesR\x14chatGroupPreferences\x12|\n" +
	"\x15chat_room_preferences\x18\x03 \x03(\v2H.steam.CChatRoom_SetUserChatGroupPreferences_Request.ChatRoomPreferencesR\x13chatRoomPreferences\x1a\x92\x03\n" +
	"\x14ChatGroupPreferences\x12\x85\x01\n" +
	"\x1adesktop_notification_level\x18\x01 \x01(\x0e2!.steam.EChatRoomNotificationLevel:$k_EChatroomNotificationLevel_InvalidR\x18desktopNotificationLevel\x12\x83\x01\n" +
	"\x19mobile_notification_level\x18\x02 \x01(\x0e2!.steam.EChatRoomNotificationLevel:$k_EChatroomNotificationLevel_InvalidR\x17mobileNotificationLevel\x124\n" +
	"\x16unread_indicator_muted\x18\x03 \x01(\bR\x14unreadIndicatorMuted\x126\n" +
	"\x17direct_messages_allowed\x18\x04 \x01(\bR\x15directMessagesAllowed\x1a\xf2\x02\n" +
	"\x13ChatRoomPreferences\x12\x17\n" +
	"\achat_id\x18\x01 \x01(\x04R\x06chatId\x12\x85\x01\n" +
	"\x1adesktop_notification_level\x18\x02 \x01(\x0e2!.steam.EChatRoomNotificationLevel:$k_EChatroomNotificationLevel_InvalidR\x18desktopNotificationLevel\x12\x83\x01\n" +
	"\x19mobile_notification_level\x18\x03 \x01(\x0e2!.steam.EChatRoomNotificationLevel:$k_EChatroomNotificationLevel_InvalidR\x17mobileNotificationLevel\x124\n" +
	"\x16unread_indicator_muted\x18\x04 \x01(\bR\x14unreadIndicatorMuted\"0\n" +
	".CChatRoom_SetUserChatGroupPreferences_Response\"\x84\x02\n" +
	"$CChatRoom_DeleteChatMessages_Request\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\x12\x17\n" +
	"\achat_id\x18\x02 \x01(\x04R\x06chatId\x12O\n" +
	"\bmessages\x18\x03 \x03(\v23.steam.CChatRoom_DeleteChatMessages_Request.MessageR\bmessages\x1aN\n" +
	"\aMessage\x12)\n" +
	...
	"maxResults\"\x92\x02\n" +
	" CChatRoom_SearchMembers_Response\x12^\n" +
	"\x10matching_members\x18\x01 \x03(\v23.steam.CChatRoom_SearchMembers_Response.MemberMatchR\x0fmatchingMembers\x12!\n" +
	"\fstatus_flags\x18\x02 \x01(\rR\vstatusFlags\x1ak\n" +
	"\vMemberMatch\x12\x1c\n" +
	"\taccountid\x18\x01 \x01(\x05R\taccountid\x12>\n" +
	"\apersona\x18\x02 \x01(\v2$.steam.CMsgClientPersonaState.FriendR\apersona\"\xd0\x02\n" +
	"'CChatRoom_UpdateMessageReaction_Request\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\x12\x17\n" +
	"\achat_id\x18\x02 \x01(\x04R\x06chatId\x12)\n" +
	"\x10server_timestamp\x18\x03 \x01(\rR\x0fserverTimestamp\x12\x18\n" +
	"\aordinal\x18\x04 \x01(\rR\aordinal\x12p\n" +
	"\rreaction_type\x18\x05 \x01(\x0e2#.steam.EChatRoomMessageReactionType:&k_EChatRoomMessageReactionType_InvalidR\freactionType\x12\x1a\n" +
	"\breaction\x18\x06 \x01(\tR\breaction\x12\x15\n" +
	"\x06is_add\x18\a \x01(\bR\x05isAdd\"M\n" +
	"(CChatRoom_UpdateMessageReaction_Response\x12!\n" +
	"\fnum_reactors\x18\x01 \x01(\rR\vnumReactors\"\xd4\x02\n" +
	...
	"\breactors\x18\x01 \x03(\rR\breactors\"\xc2\x03\n" +
	...
	"\rreport_reason\x18\x06 \x01(\x0e2\x1b.steam.EContentReportReason:\x1ek_EContentReportReason_InvalidR\freportReason\x12\x1f\n" +
	"\vreport_text\x18\a \x01(\tR\n" +
	"reportText\x12\x1a\n" +
	"\blanguage\x18\b \x01(\tR\blanguage\x12h\n" +
	"\fsubject_type\x18\t \x01(\x0e2 .steam.EContentReportSubjectType:#k_EContentReportSubjectType_InvalidR\vsubjectType\"\"\n" +
	" CChatRoom_ReportMessage_Response\"\x84\x04\n" +
	"\x1fCChatRoom_ResolveReport_Request\x12(\n" +
	"\x10subject_group_id\x18\x01 \x01(\x04R\x0esubjectGroupId\x12\x1d\n" +
	"\n" +
	"subject_id\x18\x02 \x01(\x04R\tsubjectId\x12f\n" +
	"\n" +
	"resolution\x18\x03 \x01(\x0e2\x1f.steam.EContentReportResolution:%k_EContentReportResolution_UnresolvedR\n" +
	"resolution\x12S\n" +
	"\x06reason\x18\x04 \x01(\x0e2\x1b.steam.EContentReportReason:\x1ek_EContentReportReason_InvalidR\x06reason\x12h\n" +
	"\fsubject_type\x18\x05 \x01(\x0e2 .steam.EContentReportSubjectType:#k_EContentReportSubjectType_InvalidR\vsubjectType\x12\"\n" +
	...
	"autocreate\"\x8e\x01\n" +
	"+CClanChatRooms_GetClanChatRoomInfo_Response\x12_\n" +
	"\x12chat_group_summary\x18\x01 \x01(\v21.steam.CChatRoom_GetChatRoomGroupSummary_ResponseR\x10chatGroupSummary\"u\n" +
	...
	"\x12mention_accountids\x18\x03 \x03(\rR\x11mentionAccountids\"\xc5\x03\n" +
	...
	"\ttimestamp\x18\x05 \x01(\rR\ttimestamp\x120\n" +
	"\bmentions\x18\x06 \x01(\v2\x14.steam.CChatMentionsR\bmentions\x12\x18\n" +
	"\aordinal\x18\a \x01(\rR\aordinal\x12;\n" +
	"\x0eserver_message\x18\b \x01(\v2\x14.steam.ServerMessageR\rserverMessage\x12*\n" +
	"\x11message_no_bbcode\x18\t \x01(\tR\x0fmessageNoBbcode\x12\x1b\n" +
	"\tchat_name\x18\n" +
	" \x01(\tR\bchatName\x12)\n" +
	"\x10notification_key\x18\v \x01(\tR\x0fnotificationKey\"\xb2\x02\n" +
	"*CChatRoom_ChatMessageModified_Notification\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\x12\x17\n" +
	"\achat_id\x18\x02 \x01(\x04R\x06chatId\x12Y\n" +
	"\bmessages\x18\x03 \x03(\v2=.steam.CChatRoom_ChatMessageModified_Notification.ChatMessageR\bmessages\x1al\n" +
	"\vChatMessage\x12)\n" +
	"\x10server_timestamp\x18\x01 \x01(\rR\x0fserverTimestamp\x12\x18\n" +
	"\aordinal\x18\x02 \x01(\rR\aordinal\x12\x18\n" +
	"\adeleted\x18\x03 \x01(\bR\adeleted\"\xdf\x01\n" +
	"(CChatRoom_MemberStateChange_Notification\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\x12.\n" +
	"\x06member\x18\x02 \x01(\v2\x16.steam.CChatRoomMemberR\x06member\x12_\n" +
	"\x06change\x18\x03 \x01(\x0e2!.steam.EChatRoomMemberStateChange:$k_EChatRoomMemberStateChange_InvalidR\x06change\"q\n" +
	"*CChatRoom_ChatRoomHeaderState_Notification\x12C\n" +
	"\fheader_state\x18\x01 \x01(\v2 .steam.CChatRoomGroupHeaderStateR\vheaderState\"\xb3\x01\n" +
	"/CChatRoom_ChatRoomGroupRoomsChange_Notification\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\x12&\n" +
	"\x0fdefault_chat_id\x18\x02 \x01(\x04R\rdefaultChatId\x124\n" +
	"\n" +
	"chat_rooms\x18\x03 \x03(\v2\x15.steam.CChatRoomStateR\tchatRooms\"y\n" +
	":CChatRoom_NotifyShouldRejoinChatRoomVoiceChat_Notification\x12\x17\n" +
	"\achat_id\x18\x01 \x01(\x04R\x06chatId\x12\"\n" +
	"\rchat_group_id\x18\x02 \x01(\x04R\vchatGroupId\"\xf6\x02\n" +
	";ChatRoomClient_NotifyChatGroupUserStateChanged_Notification\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\x12Q\n" +
	"\x15user_chat_group_state\x18\x02 \x01(\v2\x1e.steam.CUserChatRoomGroupStateR\x12userChatGroupState\x12V\n" +
	"\rgroup_summary\x18\x03 \x01(\v21.steam.CChatRoom_GetChatRoomGroupSummary_ResponseR\fgroupSummary\x12h\n" +
	"\vuser_action\x18\x04 \x01(\x0e2!.steam.EChatRoomMemberStateChange:$k_EChatRoomMemberStateChange_InvalidR\n" +
	"userAction\"\\\n" +
	...
	"\aoffline\x18\x03 \x01(\x05R\aoffline\"\xde\x04\n" +
	"2CChatRoomClient_MemberListViewUpdated_Notification\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\x12\x17\n" +
	"\aview_id\x18\x02 \x01(\x04R\x06viewId\x122\n" +
	"\x04view\x18\x03 \x01(\v2\x1e.steam.CChatRoomMemberListViewR\x04view\x12g\n" +
	"\amembers\x18\x04 \x03(\v2M.steam.CChatRoomClient_MemberListViewUpdated_Notification.MemberListViewEntryR\amembers\x12!\n" +
	"\fstatus_flags\x18\x05 \x01(\rR\vstatusFlags\x12J\n" +
	"\x0emember_summary\x18\x06 \x01(\v2#.steam.CChatRoomMemberSummaryCountsR\rmemberSummary\x12U\n" +
	"\x13subscribed_personas\x18\a \x03(\v2$.steam.CMsgClientPersonaState.FriendR\x12subscribedPersonas\x1a\x87\x01\n" +
	"\x13MemberListViewEntry\x12\x12\n" +
	"\x04rank\x18\x01 \x01(\x05R\x04rank\x12\x1c\n" +
	"\taccountid\x18\x02 \x01(\rR\taccountid\x12>\n" +
	"\apersona\x18\x03 \x01(\v2$.steam.CMsgClientPersonaState.FriendR\apersona\"\xe9\x02\n" +
	"&CChatRoom_MessageReaction_Notification\x12\"\n" +
	"\rchat_group_id\x18\x01 \x01(\x04R\vchatGroupId\x12\x17\n" +
	"\achat_id\x18\x02 \x01(\x04R\x06chatId\x12)\n" +
	"\x10server_timestamp\x18\x03 \x01(\rR\x0fserverTimestamp\x12\x18\n" +
	"\aordinal\x18\x04 \x01(\rR\aordinal\x12\x18\n" +
	"\areactor\x18\x05 \x01(\x06R\areactor\x12p\n" +
	"\rreaction_type\x18\x06 \x01(\x0e2#.steam.EChatRoomMessageReactionType:&k_EChatRoomMessageReactionType_InvalidR\freactionType\x12\x1a\n" +
	"\breaction\x18\a \x01(\tR\breaction\x12\x15\n" +
	"\x06is_add\x18\b \x01(\bR\x05isAdd\"\x85\"\n" +
	...
	"\x06in_web\x18\x04 \x01(\bR\x05inWeb\x12^\n" +
	"\bsettings\x18\n" +
	" \x01(\v2B.steam.CChatUsability_ClientUsabilityMetrics_Notification.SettingsR\bsettings\x12n\n" +
	"\x0evoice_settings\x18\v \x01(\v2G.steam.CChatUsability_ClientUsabilityMetrics_Notification.VoiceSettingsR\rvoiceSettings\x12\\\n" +
	"\bui_state\x18\f \x01(\v2A.steam.CChatUsability_ClientUsabilityMetrics_Notification.UIStateR\auiState\x12[\n" +
	"\ametrics\x18\r \x01(\v2A.steam.CChatUsability_ClientUsabilityMetrics_Notification.MetricsR\ametrics\x1a\xa1\v\n" +
	"\bSettings\x12:\n" +
	...
	"\x0fplay_ptt_sounds\x18\v \x01(\bR\rplayPttSounds\x1a\xb1\t\n" +
	"\aUIState\x12.\n" +
	...
	"\x12chat_window_height\x18\v \x01(\x05R\x10chatWindowHeight\x12\x84\x01\n" +
	"\x11category_collapse\x18\f \x01(\v2W.steam.CChatUsability_ClientUsabilityMetrics_Notification.UIState.CategoryCollapseStateR\x10categoryCollapse\x12@\n" +
	...
	"\x12-\n" +
	")k_EChatRoomMemberStateChange_RolesChanged\x10\f2\x87\x01\n" +
	"\x04Chat\x12\x7f\n" +
	"\x1aRequestFriendPersonaStates\x12/.steam.CChat_RequestFriendPersonaStates_Request\x1a0.steam.CChat_RequestFriendPersonaStates_Response2\xd5.\n" +
	"\bChatRoom\x12r\n" +
	"\x13CreateChatRoomGroup\x12,.steam.CChatRoom_CreateChatRoomGroup_Request\x1a-.steam.CChatRoom_CreateChatRoomGroup_Response\x12l\n" +
	"\x11SaveChatRoomGroup\x12*.steam.CChatRoom_SaveChatRoomGroup_Request\x1a+.steam.CChatRoom_SaveChatRoomGroup_Response\x12r\n" +
	"\x13RenameChatRoomGroup\x12,.steam.CChatRoom_RenameChatRoomGroup_Request\x1a-.steam.CChatRoom_RenameChatRoomGroup_Response\x12~\n" +
	"\x17SetChatRoomGroupTagline\x120.steam.CChatRoom_SetChatRoomGroupTagline_Request\x1a1.steam.CChatRoom_SetChatRoomGroupTagline_Response\x12{\n" +
	"\x16SetChatRoomGroupAvatar\x12/.steam.CChatRoom_SetChatRoomGroupAvatar_Request\x1a0.steam.CChatRoom_SetChatRoomGroupAvatar_Response\x12\x9c\x01\n" +
	"!SetChatRoomGroupWatchingBroadcast\x12:.steam.CChatRoom_SetChatRoomGroupWatchingBroadcast_Request\x1a;.steam.CChatRoom_SetChatRoomGroupWatchingBroadcast_Response\x12\x8d\x01\n" +
	"\x1cJoinMiniGameForChatRoomGroup\x125.steam.CChatRoom_JoinMiniGameForChatRoomGroup_Request\x1a6.steam.CChatRoom_JoinMiniGameForChatRoomGroup_Response\x12\x8a\x01\n" +
	"\x1bEndMiniGameForChatRoomGroup\x124.steam.CChatRoom_EndMiniGameForChatRoomGroup_Request\x1a5.steam.CChatRoom_EndMiniGameForChatRoomGroup_Response\x12X\n" +
	"\x0fMuteUserInGroup\x12!.steam.CChatRoom_MuteUser_Request\x1a\".steam.CChatRoom_MuteUser_Response\x12Z\n" +
	"\x11KickUserFromGroup\x12!.steam.CChatRoom_KickUser_Request\x1a\".steam.CChatRoom_KickUser_Response\x12f\n" +
	"\x0fSetUserBanState\x12(.steam.CChatRoom_SetUserBanState_Request\x1a).steam.CChatRoom_SetUserBanState_Response\x12d\n" +
	"\x13RevokeInviteToGroup\x12%.steam.CChatRoom_RevokeInvite_Request\x1a&.steam.CChatRoom_RevokeInvite_Response\x12W\n" +
	"\n" +
	"CreateRole\x12#.steam.CChatRoom_CreateRole_Request\x1a$.steam.CChatRoom_CreateRole_Response\x12Q\n" +
	"\bGetRoles\x12!.steam.CChatRoom_GetRoles_Request\x1a\".steam.CChatRoom_GetRoles_Response\x12W\n" +
	"\n" +
	"RenameRole\x12#.steam.CChatRoom_RenameRole_Request\x1a$.steam.CChatRoom_RenameRole_Response\x12Z\n" +
	"\vReorderRole\x12$.steam.CChatRoom_ReorderRole_Request\x1a%.steam.CChatRoom_ReorderRole_Response\x12W\n" +
	"\n" +
	"DeleteRole\x12#.steam.CChatRoom_DeleteRole_Request\x1a$.steam.CChatRoom_DeleteRole_Response\x12c\n" +
	"\x0eGetRoleActions\x12'.steam.CChatRoom_GetRoleActions_Request\x1a(.steam.CChatRoom_GetRoleActions_Response\x12o\n" +
	"\x12ReplaceRoleActions\x12+.steam.CChatRoom_ReplaceRoleActions_Request\x1a,.steam.CChatRoom_ReplaceRoleActions_Response\x12`\n" +
	"\rAddRoleToUser\x12&.steam.CChatRoom_AddRoleToUser_Request\x1a'.steam.CChatRoom_AddRoleToUser_Response\x12f\n" +
	"\x0fGetRolesForUser\x12(.steam.CChatRoom_GetRolesForUser_Request\x1a).steam.CChatRoom_GetRolesForUser_Response\x12o\n" +
	"\x12DeleteRoleFromUser\x12+.steam.CChatRoom_DeleteRoleFromUser_Request\x1a,.steam.CChatRoom_DeleteRoleFromUser_Response\x12l\n" +
	"\x11JoinChatRoomGroup\x12*.steam.CChatRoom_JoinChatRoomGroup_Request\x1a+.steam.CChatRoom_JoinChatRoomGroup_Response\x12\x8a\x01\n" +
	"\x1bInviteFriendToChatRoomGroup\x124.steam.CChatRoom_InviteFriendToChatRoomGroup_Request\x1a5.steam.CChatRoom_InviteFriendToChatRoomGroup_Response\x12o\n" +
	"\x12LeaveChatRoomGroup\x12+.steam.CChatRoom_LeaveChatRoomGroup_Request\x1a,.steam.CChatRoom_LeaveChatRoomGroup_Response\x12c\n" +
	"\x0eCreateChatRoom\x12'.steam.CChatRoom_CreateChatRoom_Request\x1a(.steam.CChatRoom_CreateChatRoom_Response\x12c\n" +
	"\x0eDeleteChatRoom\x12'.steam.CChatRoom_DeleteChatRoom_Request\x1a(.steam.CChatRoom_DeleteChatRoom_Response\x12c\n" +
	"\x0eRenameChatRoom\x12'.steam.CChatRoom_RenameChatRoom_Request\x1a(.steam.CChatRoom_RenameChatRoom_Response\x12f\n" +
	"\x0fReorderChatRoom\x12(.steam.CChatRoom_ReorderChatRoom_Request\x1a).steam.CChatRoom_ReorderChatRoom_Response\x12f\n" +
	"\x0fSendChatMessage\x12(.steam.CChatRoom_SendChatMessage_Request\x1a).steam.CChatRoom_SendChatMessage_Response\x12`\n" +
	"\rJoinVoiceChat\x12&.steam.CChatRoom_JoinVoiceChat_Request\x1a'.steam.CChatRoom_JoinVoiceChat_Response\x12c\n" +
	"\x0eLeaveVoiceChat\x12'.steam.CChatRoom_LeaveVoiceChat_Request\x1a(.steam.CChatRoom_LeaveVoiceChat_Response\x12l\n" +
	"\x11GetMessageHistory\x12*.steam.CChatRoom_GetMessageHistory_Request\x1a+.steam.CChatRoom_GetMessageHistory_Response\x12r\n" +
	"\x13GetMyChatRoomGroups\x12,.steam.CChatRoom_GetMyChatRoomGroups_Request\x1a-.steam.CChatRoom_GetMyChatRoomGroups_Response\x12x\n" +
	"\x15GetChatRoomGroupState\x12..steam.CChatRoom_GetChatRoomGroupState_Request\x1a/.steam.CChatRoom_GetChatRoomGroupState_Response\x12\x93\x01\n" +
	"\x1eSetAppChatRoomGroupForceActive\x127.steam.CChatRoom_SetAppChatRoomGroupForceActive_Request\x1a8.steam.CChatRoom_SetAppChatRoomGroupForceActive_Response\x12y\n" +
	"\"SetAppChatRoomGroupStopForceActive\x12@.steam.CChatRoom_SetAppChatRoomGroupStopForceActive_Notification\x1a\x11.steam.NoResponse\x12Q\n" +
	"\x0eAckChatMessage\x12,.steam.CChatRoom_AckChatMessage_Notification\x1a\x11.steam.NoResponse\x12i\n" +
	"\x10CreateInviteLink\x12).steam.CChatRoom_CreateInviteLink_Request\x1a*.steam.CChatRoom_CreateInviteLink_Response\x12l\n" +
	"\x11GetInviteLinkInfo\x12*.steam.CChatRoom_GetInviteLinkInfo_Request\x1a+.steam.CChatRoom_GetInviteLinkInfo_Response\x12`\n" +
	"\rGetInviteInfo\x12&.steam.CChatRoom_GetInviteInfo_Request\x1a'.steam.CChatRoom_GetInviteInfo_Response\x12{\n" +
	"\x16GetInviteLinksForGroup\x12/.steam.CChatRoom_GetInviteLinksForGroup_Request\x1a0.steam.CChatRoom_GetInviteLinksForGroup_Response\x12W\n" +
	"\n" +
	"GetBanList\x12#.steam.CChatRoom_GetBanList_Request\x1a$.steam.CChatRoom_GetBanList_Response\x12`\n" +
	"\rGetInviteList\x12&.steam.CChatRoom_GetInviteList_Request\x1a'.steam.CChatRoom_GetInviteList_Response\x12i\n" +
	"\x10DeleteInviteLink\x12).steam.CChatRoom_DeleteInviteLink_Request\x1a*.steam.CChatRoom_DeleteInviteLink_Response\x12\x93\x01\n" +
	"\x1eSetSessionActiveChatRoomGroups\x127.steam.CChatRoom_SetSessionActiveChatRoomGroups_Request\x1a8.steam.CChatRoom_SetSessionActiveChatRoomGroups_Response\x12\x8a\x01\n" +
	"\x1bSetUserChatGroupPreferences\x124.steam.CChatRoom_SetUserChatGroupPreferences_Request\x1a5.steam.CChatRoom_SetUserChatGroupPreferences_Response\x12o\n" +
	"\x12DeleteChatMessages\x12+.steam.CChatRoom_DeleteChatMessages_Request\x1a,.steam.CChatRoom_DeleteChatMessages_Response\x12]\n" +
	"\x14UpdateMemberListView\x122.steam.CChatRoom_UpdateMemberListView_Notification\x1a\x11.steam.NoResponse\x12`\n" +
	"\rSearchMembers\x12&.steam.CChatRoom_SearchMembers_Request\x1a'.steam.CChatRoom_SearchMembers_Response\x12x\n" +
	"\x15UpdateMessageReaction\x12..steam.CChatRoom_UpdateMessageReaction_Request\x1a/.steam.CChatRoom_UpdateMessageReaction_Response\x12\x87\x01\n" +
	"\x1aGetMessageReactionReactors\x123.steam.CChatRoom_GetMessageReactionReactors_Request\x1a4.steam.CChatRoom_GetMessageReactionReactors_Response\x12`\n" +
	"\rReportMessage\x12&.steam.CChatRoom_ReportMessage_Request\x1a'.steam.CChatRoom_ReportMessage_Response\x12`\n" +
	"\rResolveReport\x12&.steam.CChatRoom_ResolveReport_Request\x1a'.steam.CChatRoom_ResolveReport_Response2\x95\x02\n" +
	"\rClanChatRooms\x12|\n" +
	"\x13GetClanChatRoomInfo\x121.steam.CClanChatRooms_GetClanChatRoomInfo_Request\x1a2.steam.CClanChatRooms_GetClanChatRoomInfo_Response\x12\x85\x01\n" +
	"\x16SetClanChatRoomPrivate\x124.steam.CClanChatRooms_SetClanChatRoomPrivate_Request\x1a5.steam.CClanChatRooms_SetClanChatRoomPrivate_Response2\x99\t\n" +
	"\x0eChatRoomClient\x12a\n" +
	"\x19NotifyIncomingChatMessage\x121.steam.CChatRoom_IncomingChatMessage_Notification\x1a\x11.steam.NoResponse\x12a\n" +
	"\x19NotifyChatMessageModified\x121.steam.CChatRoom_ChatMessageModified_Notification\x1a\x11.steam.NoResponse\x12]\n" +
	"\x17NotifyMemberStateChange\x12/.steam.CChatRoom_MemberStateChange_Notification\x1a\x11.steam.NoResponse\x12g\n" +
	"\x1fNotifyChatRoomHeaderStateChange\x121.steam.CChatRoom_ChatRoomHeaderState_Notification\x1a\x11.steam.NoResponse\x12k\n" +
	"\x1eNotifyChatRoomGroupRoomsChange\x126.steam.CChatRoom_ChatRoomGroupRoomsChange_Notification\x1a\x11.steam.NoResponse\x12{\n" +
	"#NotifyShouldRejoinChatRoomVoiceChat\x12A.steam.CChatRoom_NotifyShouldRejoinChatRoomVoiceChat_Notification\x1a\x11.steam.NoResponse\x12x\n" +
	"\x1fNotifyChatGroupUserStateChanged\x12B.steam.ChatRoomClient_NotifyChatGroupUserStateChanged_Notification\x1a\x11.steam.NoResponse\x12[\n" +
	"\x18NotifyAckChatMessageEcho\x12,.steam.CChatRoom_AckChatMessage_Notification\x1a\x11.steam.NoResponse\x12j\n" +
	"\x18NotifyChatRoomDisconnect\x12;.steam.ChatRoomClient_NotifyChatRoomDisconnect_Notification\x1a\x11.steam.NoResponse\x12k\n" +
	"\x1bNotifyMemberListViewUpdated\x129.steam.CChatRoomClient_MemberListViewUpdated_Notification\x1a\x11.steam.NoResponse\x12Y\n" +
	"\x15NotifyMessageReaction\x12-.steam.CChatRoom_MessageReaction_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x022}\n" +
	"\rChatUsability\x12l\n" +
	"\x1cNotifyClientUsabilityMetrics\x129.steam.CChatUsability_ClientUsabilityMetrics_Notification\x1a\x11.steam.NoResponse2\x97\x01\n" +
	"\x13ChatUsabilityClient\x12z\n" +
	"#NotifyRequestClientUsabilityMetrics\x12@.steam.CChatUsability_RequestClientUsabilityMetrics_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x02B3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_chat_steamclient_proto_goTypes = []any{
	...
	(EChatRoomMessageReactionType)(0),                                                        // 4: steam.EChatRoomMessageReactionType
	(EChatRoomMemberStateChange)(0),                                                          // 5: steam.EChatRoomMemberStateChange
	(*CChat_RequestFriendPersonaStates_Request)(nil),                                         // 6: steam.CChat_RequestFriendPersonaStates_Request
	(*CChat_RequestFriendPersonaStates_Response)(nil),                                        // 7: steam.CChat_RequestFriendPersonaStates_Response
	(*CChatRoom_CreateChatRoomGroup_Request)(nil),                                            // 8: steam.CChatRoom_CreateChatRoomGroup_Request
	(*CChatRole)(nil),                                                                        // 9: steam.CChatRole
	(*CChatRoleActions)(nil),                                                                 // 10: steam.CChatRoleActions
	(*CChatPartyBeacon)(nil),                                                                 // 11: steam.CChatPartyBeacon
	(*CChatRoomGroupHeaderState)(nil),                                                        // 12: steam.CChatRoomGroupHeaderState
	(*CChatRoomMember)(nil),                                                                  // 13: steam.CChatRoomMember
	(*CChatRoomState)(nil),                                                                   // 14: steam.CChatRoomState
	(*CChatRoomGroupState)(nil),                                                              // 15: steam.CChatRoomGroupState
	(*CUserChatRoomState)(nil),                                                               // 16: steam.CUserChatRoomState
	(*CUserChatRoomGroupState)(nil),                                                          // 17: steam.CUserChatRoomGroupState
	(*CChatRoom_CreateChatRoomGroup_Response)(nil),                                           // 18: steam.CChatRoom_CreateChatRoomGroup_Response
	(*CChatRoom_SaveChatRoomGroup_Request)(nil),                                              // 19: steam.CChatRoom_SaveChatRoomGroup_Request
	(*CChatRoom_SaveChatRoomGroup_Response)(nil),                                             // 20: steam.CChatRoom_SaveChatRoomGroup_Response
	(*CChatRoom_RenameChatRoomGroup_Request)(nil),                                            // 21: steam.CChatRoom_RenameChatRoomGroup_Request
	(*CChatRoom_RenameChatRoomGroup_Response)(nil),                                           // 22: steam.CChatRoom_RenameChatRoomGroup_Response
	(*CChatRoom_SetChatRoomGroupTagline_Request)(nil),                                        // 23: steam.CChatRoom_SetChatRoomGroupTagline_Request
	(*CChatRoom_SetChatRoomGroupTagline_Response)(nil),                                       // 24: steam.CChatRoom_SetChatRoomGroupTagline_Response
	(*CChatRoom_SetChatRoomGroupAvatar_Request)(nil),                                         // 25: steam.CChatRoom_SetChatRoomGroupAvatar_Request
	(*CChatRoom_SetChatRoomGroupAvatar_Response)(nil),                                        // 26: steam.CChatRoom_SetChatRoomGroupAvatar_Response
	(*CChatRoom_SetChatRoomGroupWatchingBroadcast_Request)(nil),                              // 27: steam.CChatRoom_SetChatRoomGroupWatchingBroadcast_Request
	(*CChatRoom_SetChatRoomGroupWatchingBroadcast_Response)(nil),                             // 28: steam.CChatRoom_SetChatRoomGroupWatchingBroadcast_Response
	(*CChatRoom_JoinMiniGameForChatRoomGroup_Request)(nil),                                   // 29: steam.CChatRoom_JoinMiniGameForChatRoomGroup_Request
	(*CChatRoom_JoinMiniGameForChatRoomGroup_Response)(nil),                                  // 30: steam.CChatRoom_JoinMiniGameForChatRoomGroup_Response
	(*CChatRoom_EndMiniGameForChatRoomGroup_Request)(nil),                                    // 31: steam.CChatRoom_EndMiniGameForChatRoomGroup_Request
	(*CChatRoom_EndMiniGameForChatRoomGroup_Response)(nil),                                   // 32: steam.CChatRoom_EndMiniGameForChatRoomGroup_Response
	(*CChatRoom_MuteUser_Request)(nil),                                                       // 33: steam.CChatRoom_MuteUser_Request
	(*CChatRoom_MuteUser_Response)(nil),                                                      // 34: steam.CChatRoom_MuteUser_Response
	(*CChatRoom_KickUser_Request)(nil),                                                       // 35: steam.CChatRoom_KickUser_Request
	(*CChatRoom_KickUser_Response)(nil),                                                      // 36: steam.CChatRoom_KickUser_Response
	(*CChatRoom_SetUserBanState_Request)(nil),                                                // 37: steam.CChatRoom_SetUserBanState_Request
	(*CChatRoom_SetUserBanState_Response)(nil),                                               // 38: steam.CChatRoom_SetUserBanState_Response
	(*CChatRoom_RevokeInvite_Request)(nil),                                                   // 39: steam.CChatRoom_RevokeInvite_Request
	(*CChatRoom_RevokeInvite_Response)(nil),                                                  // 40: steam.CChatRoom_RevokeInvite_Response
	(*CChatRoom_CreateRole_Request)(nil),                                                     // 41: steam.CChatRoom_CreateRole_Request
	(*CChatRoom_CreateRole_Response)(nil),                                                    // 42: steam.CChatRoom_CreateRole_Response
	(*CChatRoom_GetRoles_Request)(nil),                                                       // 43: steam.CChatRoom_GetRoles_Request
	(*CChatRoom_GetRoles_Response)(nil),                                                      // 44: steam.CChatRoom_GetRoles_Response
	(*CChatRoom_RenameRole_Request)(nil),                                                     // 45: steam.CChatRoom_RenameRole_Request
	(*CChatRoom_RenameRole_Response)(nil),                                                    // 46: steam.CChatRoom_RenameRole_Response
	(*CChatRoom_ReorderRole_Request)(nil),                                                    // 47: steam.CChatRoom_ReorderRole_Request
	(*CChatRoom_ReorderRole_Response)(nil),                                                   // 48: steam.CChatRoom_ReorderRole_Response
	(*CChatRoom_DeleteRole_Request)(nil),                                                     // 49: steam.CChatRoom_DeleteRole_Request
	(*CChatRoom_DeleteRole_Response)(nil),                                                    // 50: steam.CChatRoom_DeleteRole_Response
	(*CChatRoom_GetRoleActions_Request)(nil),                                                 // 51: steam.CChatRoom_GetRoleActions_Request
	(*CChatRoom_GetRoleActions_Response)(nil),                                                // 52: steam.CChatRoom_GetRoleActions_Response
	(*CChatRoom_ReplaceRoleActions_Request)(nil),                                             // 53: steam.CChatRoom_ReplaceRoleActions_Request
	(*CChatRoom_ReplaceRoleActions_Response)(nil),                                            // 54: steam.CChatRoom_ReplaceRoleActions_Response
	(*CChatRoom_AddRoleToUser_Request)(nil),                                                  // 55: steam.CChatRoom_AddRoleToUser_Request
	(*CChatRoom_AddRoleToUser_Response)(nil),                                                 // 56: steam.CChatRoom_AddRoleToUser_Response
	(*CChatRoom_GetRolesForUser_Request)(nil),                                                // 57: steam.CChatRoom_GetRolesForUser_Request
	(*CChatRoom_GetRolesForUser_Response)(nil),                                               // 58: steam.CChatRoom_GetRolesForUser_Response
	(*CChatRoom_DeleteRoleFromUser_Request)(nil),                                             // 59: steam.CChatRoom_DeleteRoleFromUser_Request
	(*CChatRoom_DeleteRoleFromUser_Response)(nil),                                            // 60: steam.CChatRoom_DeleteRoleFromUser_Response
	(*CChatRoom_JoinChatRoomGroup_Request)(nil),                                              // 61: steam.CChatRoom_JoinChatRoomGroup_Request
	(*CChatRoom_JoinChatRoomGroup_Response)(nil),                                             // 62: steam.CChatRoom_JoinChatRoomGroup_Response
	(*CChatRoom_InviteFriendToChatRoomGroup_Request)(nil),                                    // 63: steam.CChatRoom_InviteFriendToChatRoomGroup_Request
	(*CChatRoom_InviteFriendToChatRoomGroup_Response)(nil),                                   // 64: steam.CChatRoom_InviteFriendToChatRoomGroup_Response
	(*CChatRoom_LeaveChatRoomGroup_Request)(nil),                                             // 65: steam.CChatRoom_LeaveChatRoomGroup_Request
	(*CChatRoom_LeaveChatRoomGroup_Response)(nil),                                            // 66: steam.CChatRoom_LeaveChatRoomGroup_Response
	(*CChatRoom_CreateChatRoom_Request)(nil),                                                 // 67: steam.CChatRoom_CreateChatRoom_Request
	(*CChatRoom_CreateChatRoom_Response)(nil),                                                // 68: steam.CChatRoom_CreateChatRoom_Response
	(*CChatRoom_DeleteChatRoom_Request)(nil),                                                 // 69: steam.CChatRoom_DeleteChatRoom_Request
	(*CChatRoom_DeleteChatRoom_Response)(nil),                                                // 70: steam.CChatRoom_DeleteChatRoom_Response
	(*CChatRoom_RenameChatRoom_Request)(nil),                                                 // 71: steam.CChatRoom_RenameChatRoom_Request
	(*CChatRoom_RenameChatRoom_Response)(nil),                                                // 72: steam.CChatRoom_RenameChatRoom_Response
	(*CChatRoom_ReorderChatRoom_Request)(nil),                                                // 73: steam.CChatRoom_ReorderChatRoom_Request
	(*CChatRoom_ReorderChatRoom_Response)(nil),                                               // 74: steam.CChatRoom_ReorderChatRoom_Response
	(*CChatRoom_SendChatMessage_Request)(nil),                                                // 75: steam.CChatRoom_SendChatMessage_Request
	(*CChatRoom_SendChatMessage_Response)(nil),                                               // 76: steam.CChatRoom_SendChatMessage_Response
	(*CChatRoom_JoinVoiceChat_Request)(nil),                                                  // 77: steam.CChatRoom_JoinVoiceChat_Request
	(*CChatRoom_JoinVoiceChat_Response)(nil),                                                 // 78: steam.CChatRoom_JoinVoiceChat_Response
	(*CChatRoom_LeaveVoiceChat_Request)(nil),                                                 // 79: steam.CChatRoom_LeaveVoiceChat_Request
	(*CChatRoom_LeaveVoiceChat_Response)(nil),                                                // 80: steam.CChatRoom_LeaveVoiceChat_Response
	(*CChatRoom_GetMessageHistory_Request)(nil),                                              // 81: steam.CChatRoom_GetMessageHistory_Request
	(*ServerMessage)(nil),                                                                    // 82: steam.ServerMessage
	(*CChatRoom_GetMessageHistory_Response)(nil),                                             // 83: steam.CChatRoom_GetMessageHistory_Response
	(*CChatRoom_GetMyChatRoomGroups_Request)(nil),                                            // 84: steam.CChatRoom_GetMyChatRoomGroups_Request
	(*CChatRoom_GetChatRoomGroupSummary_Response)(nil),                                       // 85: steam.CChatRoom_GetChatRoomGroupSummary_Response
	(*CChatRoomSummaryPair)(nil),                                                             // 86: steam.CChatRoomSummaryPair
	(*CChatRoom_GetMyChatRoomGroups_Response)(nil),                                           // 87: steam.CChatRoom_GetMyChatRoomGroups_Response
	(*CChatRoom_GetChatRoomGroupState_Request)(nil),                                          // 88: steam.CChatRoom_GetChatRoomGroupState_Request
	(*CChatRoom_GetChatRoomGroupState_Response)(nil),                                         // 89: steam.CChatRoom_GetChatRoomGroupState_Response
	(*CChatRoom_SetAppChatRoomGroupForceActive_Request)(nil),                                 // 90: steam.CChatRoom_SetAppChatRoomGroupForceActive_Request
	(*CChatRoom_SetAppChatRoomGroupForceActive_Response)(nil),                                // 91: steam.CChatRoom_SetAppChatRoomGroupForceActive_Response
	(*CChatRoom_SetAppChatRoomGroupStopForceActive_Notification)(nil),                        // 92: steam.CChatRoom_SetAppChatRoomGroupStopForceActive_Notification
	(*CChatRoom_AckChatMessage_Notification)(nil),                                            // 93: steam.CChatRoom_AckChatMessage_Notification
	(*CChatRoom_CreateInviteLink_Request)(nil),                                               // 94: steam.CChatRoom_CreateInviteLink_Request
	(*CChatRoom_CreateInviteLink_Response)(nil),                                              // 95: steam.CChatRoom_CreateInviteLink_Response
	(*CChatRoom_GetInviteLinkInfo_Request)(nil),                                              // 96: steam.CChatRoom_GetInviteLinkInfo_Request
	(*CChatRoom_GetInviteLinkInfo_Response)(nil),                                             // 97: steam.CChatRoom_GetInviteLinkInfo_Response
	(*CChatRoom_GetInviteInfo_Request)(nil),                                                  // 98: steam.CChatRoom_GetInviteInfo_Request
	(*CChatRoom_GetInviteInfo_Response)(nil),                                                 // 99: steam.CChatRoom_GetInviteInfo_Response
	(*CChatRoom_GetInviteLinksForGroup_Request)(nil),                                         // 100: steam.CChatRoom_GetInviteLinksForGroup_Request
	(*CChatRoom_GetInviteLinksForGroup_Response)(nil),                                        // 101: steam.CChatRoom_GetInviteLinksForGroup_Response
	(*CChatRoom_GetBanList_Request)(nil),                                                     // 102: steam.CChatRoom_GetBanList_Request
	(*CChatRoom_GetBanList_Response)(nil),                                                    // 103: steam.CChatRoom_GetBanList_Response
	(*CChatRoom_GetInviteList_Request)(nil),                                                  // 104: steam.CChatRoom_GetInviteList_Request
	(*CChatRoomGroupInvite)(nil),                                                             // 105: steam.CChatRoomGroupInvite
	(*CChatRoom_GetInviteList_Response)(nil),                                                 // 106: steam.CChatRoom_GetInviteList_Response
	(*CChatRoom_DeleteInviteLink_Request)(nil),                                               // 107: steam.CChatRoom_DeleteInviteLink_Request
	(*CChatRoom_DeleteInviteLink_Response)(nil),                                              // 108: steam.CChatRoom_DeleteInviteLink_Response
	(*CChatRoom_SetSessionActiveChatRoomGroups_Request)(nil),                                 // 109: steam.CChatRoom_SetSessionActiveChatRoomGroups_Request
	(*CChatRoom_SetSessionActiveChatRoomGroups_Response)(nil),                                // 110: steam.CChatRoom_SetSessionActiveChatRoomGroups_Response
	(*CChatRoom_SetUserChatGroupPreferences_Request)(nil),                                    // 111: steam.CChatRoom_SetUserChatGroupPreferences_Request
	(*CChatRoom_SetUserChatGroupPreferences_Response)(nil),                                   // 112: steam.CChatRoom_SetUserChatGroupPreferences_Response
	(*CChatRoom_DeleteChatMessages_Request)(nil),                                             // 113: steam.CChatRoom_DeleteChatMessages_Request
	(*CChatRoom_DeleteChatMessages_Response)(nil),                                            // 114: steam.CChatRoom_DeleteChatMessages_Response
	(*CChatRoom_UpdateMemberListView_Notification)(nil),                                      // 115: steam.CChatRoom_UpdateMemberListView_Notification
	(*CChatRoom_SearchMembers_Request)(nil),                                                  // 116: steam.CChatRoom_SearchMembers_Request
	(*CChatRoom_SearchMembers_Response)(nil),                                                 // 117: steam.CChatRoom_SearchMembers_Response
	(*CChatRoom_UpdateMessageReaction_Request)(nil),                                          // 118: steam.CChatRoom_UpdateMessageReaction_Request
	(*CChatRoom_UpdateMessageReaction_Response)(nil),                                         // 119: steam.CChatRoom_UpdateMessageReaction_Response
	(*CChatRoom_GetMessageReactionReactors_Request)(nil),                                     // 120: steam.CChatRoom_GetMessageReactionReactors_Request
	(*CChatRoom_GetMessageReactionReactors_Response)(nil),                                    // 121: steam.CChatRoom_GetMessageReactionReactors_Response
	(*CChatRoom_ReportMessage_Request)(nil),                                                  // 122: steam.CChatRoom_ReportMessage_Request
	(*CChatRoom_ReportMessage_Response)(nil),                                                 // 123: steam.CChatRoom_ReportMessage_Response
	(*CChatRoom_ResolveReport_Request)(nil),                                                  // 124: steam.CChatRoom_ResolveReport_Request
	(*CChatRoom_ResolveReport_Response)(nil),                                                 // 125: steam.CChatRoom_ResolveReport_Response
	(*CClanChatRooms_GetClanChatRoomInfo_Request)(nil),                                       // 126: steam.CClanChatRooms_GetClanChatRoomInfo_Request
	(*CClanChatRooms_GetClanChatRoomInfo_Response)(nil),                                      // 127: steam.CClanChatRooms_GetClanChatRoomInfo_Response
	(*CClanChatRooms_SetClanChatRoomPrivate_Request)(nil),                                    // 128: steam.CClanChatRooms_SetClanChatRoomPrivate_Request
	(*CClanChatRooms_SetClanChatRoomPrivate_Response)(nil),                                   // 129: steam.CClanChatRooms_SetClanChatRoomPrivate_Response
	(*CChatMentions)(nil),                                                                    // 130: steam.CChatMentions
	(*CChatRoom_IncomingChatMessage_Notification)(nil),                                       // 131: steam.CChatRoom_IncomingChatMessage_Notification
	(*CChatRoom_ChatMessageModified_Notification)(nil),                                       // 132: steam.CChatRoom_ChatMessageModified_Notification
	(*CChatRoom_MemberStateChange_Notification)(nil),                                         // 133: steam.CChatRoom_MemberStateChange_Notification
	(*CChatRoom_ChatRoomHeaderState_Notification)(nil),                                       // 134: steam.CChatRoom_ChatRoomHeaderState_Notification
	(*CChatRoom_ChatRoomGroupRoomsChange_Notification)(nil),                                  // 135: steam.CChatRoom_ChatRoomGroupRoomsChange_Notification
	(*CChatRoom_NotifyShouldRejoinChatRoomVoiceChat_Notification)(nil),                       // 136: steam.CChatRoom_NotifyShouldRejoinChatRoomVoiceChat_Notification
	(*ChatRoomClient_NotifyChatGroupUserStateChanged_Notification)(nil),                      // 137: steam.ChatRoomClient_NotifyChatGroupUserStateChanged_Notification
	(*ChatRoomClient_NotifyChatRoomDisconnect_Notification)(nil),                             // 138: steam.ChatRoomClient_NotifyChatRoomDisconnect_Notification
	(*CChatRoomMemberListView)(nil),                                                          // 139: steam.CChatRoomMemberListView
	(*CChatRoomMemberSummaryCounts)(nil),                                                     // 140: steam.CChatRoomMemberSummaryCounts
	(*CChatRoomClient_MemberListViewUpdated_Notification)(nil),                               // 141: steam.CChatRoomClient_MemberListViewUpdated_Notification
	(*CChatRoom_MessageReaction_Notification)(nil),                                           // 142: steam.CChatRoom_MessageReaction_Notification
	(*CChatUsability_ClientUsabilityMetrics_Notification)(nil),                               // 143: steam.CChatUsability_ClientUsabilityMetrics_Notification
	(*CChatUsability_RequestClientUsabilityMetrics_Notification)(nil),                        // 144: steam.CChatUsability_RequestClientUsabilityMetrics_Notification
	(*CChatRoom_GetMessageHistory_Response_ChatMessage)(nil),                                 // 145: steam.CChatRoom_GetMessageHistory_Response.ChatMessage
	(*CChatRoom_GetMessageHistory_Response_ChatMessage_MessageReaction)(nil),                 // 146: steam.CChatRoom_GetMessageHistory_Response.ChatMessage.MessageReaction
	(*CChatRoom_GetInviteLinksForGroup_Response_LinkInfo)(nil),                               // 147: steam.CChatRoom_GetInviteLinksForGroup_Response.LinkInfo
	(*CChatRoom_GetBanList_Response_BanInfo)(nil),                                            // 148: steam.CChatRoom_GetBanList_Response.BanInfo
	(*CChatRoom_SetUserChatGroupPreferences_Request_ChatGroupPreferences)(nil),               // 149: steam.CChatRoom_SetUserChatGroupPreferences_Request.ChatGroupPreferences
	(*CChatRoom_SetUserChatGroupPreferences_Request_ChatRoomPreferences)(nil),                // 150: steam.CChatRoom_SetUserChatGroupPreferences_Request.ChatRoomPreferences
	(*CChatRoom_DeleteChatMessages_Request_Message)(nil),                                     // 151: steam.CChatRoom_DeleteChatMessages_Request.Message
	(*CChatRoom_SearchMembers_Response_MemberMatch)(nil),                                     // 152: steam.CChatRoom_SearchMembers_Response.MemberMatch
	(*CChatRoom_ChatMessageModified_Notification_ChatMessage)(nil),                           // 153: steam.CChatRoom_ChatMessageModified_Notification.ChatMessage
	(*CChatRoomClient_MemberListViewUpdated_Notification_MemberListViewEntry)(nil),           // 154: steam.CChatRoomClient_MemberListViewUpdated_Notification.MemberListViewEntry
	(*CChatUsability_ClientUsabilityMetrics_Notification_Settings)(nil),                      // 155: steam.CChatUsability_ClientUsabilityMetrics_Notification.Settings
	(*CChatUsability_ClientUsabilityMetrics_Notification_VoiceSettings)(nil),                 // 156: steam.CChatUsability_ClientUsabilityMetrics_Notification.VoiceSettings
	(*CChatUsability_ClientUsabilityMetrics_Notification_UIState)(nil),                       // 157: steam.CChatUsability_ClientUsabilityMetrics_Notification.UIState
	(*CChatUsability_ClientUsabilityMetrics_Notification_Metrics)(nil),                       // 158: steam.CChatUsability_ClientUsabilityMetrics_Notification.Metrics
	(*CChatUsability_ClientUsabilityMetrics_Notification_UIState_CategoryCollapseState)(nil), // 159: steam.CChatUsability_ClientUsabilityMetrics_Notification.UIState.CategoryCollapseState
	(EContentReportReason)(0),                                                                // 160: steam.EContentReportReason
	(EContentReportSubjectType)(0),                                                           // 161: steam.EContentReportSubjectType
	(EContentReportResolution)(0),                                                            // 162: steam.EContentReportResolution
	(*CMsgClientPersonaState_Friend)(nil),                                                    // 163: steam.CMsgClientPersonaState.Friend
	(*NoResponse)(nil),                                                                       // 164: steam.NoResponse
}
var file_steammessages_chat_steamclient_proto_depIdxs = []int32{
	9,   // 0: steam.CChatRoomGroupHeaderState.roles:type_name -> steam.CChatRole
	10,  // 1: steam.CChatRoomGroupHeaderState.role_actions:type_name -> steam.CChatRoleActions
	11,  // 2: steam.CChatRoomGroupHeaderState.party_beacons:type_name -> steam.CChatPartyBeacon
	...
	12,  // 5: steam.CChatRoomGroupState.header_state:type_name -> steam.CChatRoomGroupHeaderState
	13,  // 6: steam.CChatRoomGroupState.members:type_name -> steam.CChatRoomMember
	14,  // 7: steam.CChatRoomGroupState.chat_rooms:type_name -> steam.CChatRoomState
	13,  // 8: steam.CChatRoomGroupState.kicked:type_name -> steam.CChatRoomMember
	...
	16,  // 11: steam.CUserChatRoomGroupState.user_chat_room_state:type_name -> steam.CUserChatRoomState
	...
	15,  // 14: steam.CChatRoom_CreateChatRoomGroup_Response.state:type_name -> steam.CChatRoomGroupState
	17,  // 15: steam.CChatRoom_CreateChatRoomGroup_Response.user_chat_state:type_name -> steam.CUserChatRoomGroupState
	10,  // 16: steam.CChatRoom_CreateRole_Response.actions:type_name -> steam.CChatRoleActions
	9,   // 17: steam.CChatRoom_GetRoles_Response.roles:type_name -> steam.CChatRole
	10,  // 18: steam.CChatRoom_GetRoleActions_Response.actions:type_name -> steam.CChatRoleActions
	10,  // 19: steam.CChatRoom_ReplaceRoleActions_Request.actions:type_name -> steam.CChatRoleActions
	15,  // 20: steam.CChatRoom_JoinChatRoomGroup_Response.state:type_name -> steam.CChatRoomGroupState
	17,  // 21: steam.CChatRoom_JoinChatRoomGroup_Response.user_chat_state:type_name -> steam.CUserChatRoomGroupState
	14,  // 22: steam.CChatRoom_CreateChatRoom_Response.chat_room:type_name -> steam.CChatRoomState
	3,   // 23: steam.ServerMessage.message:type_name -> steam.EChatRoomServerMessage
	145, // 24: steam.CChatRoom_GetMessageHistory_Response.messages:type_name -> steam.CChatRoom_GetMessageHistory_Response.ChatMessage
	14,  // 25: steam.CChatRoom_GetChatRoomGroupSummary_Response.chat_rooms:type_name -> steam.CChatRoomState
	1,   // 26: steam.CChatRoom_GetChatRoomGroupSummary_Response.rank:type_name -> steam.EChatRoomGroupRank
	10,  // 27: steam.CChatRoom_GetChatRoomGroupSummary_Response.role_actions:type_name -> steam.CChatRoleActions
	11,  // 28: steam.CChatRoom_GetChatRoomGroupSummary_Response.party_beacons:type_name -> steam.CChatPartyBeacon
	17,  // 29: steam.CChatRoomSummaryPair.user_chat_group_state:type_name -> steam.CUserChatRoomGroupState
	85,  // 30: steam.CChatRoomSummaryPair.group_summary:type_name -> steam.CChatRoom_GetChatRoomGroupSummary_Response
	86,  // 31: steam.CChatRoom_GetMyChatRoomGroups_Response.chat_room_groups:type_name -> steam.CChatRoomSummaryPair
	15,  // 32: steam.CChatRoom_GetChatRoomGroupState_Response.state:type_name -> steam.CChatRoomGroupState
	85,  // 33: steam.CChatRoom_GetInviteLinkInfo_Response.group_summary:type_name -> steam.CChatRoom_GetChatRoomGroupSummary_Response
	17,  // 34: steam.CChatRoom_GetInviteLinkInfo_Response.user_chat_group_state:type_name -> steam.CUserChatRoomGroupState
	85,  // 35: steam.CChatRoom_GetInviteInfo_Response.group_summary:type_name -> steam.CChatRoom_GetChatRoomGroupSummary_Response
	147, // 36: steam.CChatRoom_GetInviteLinksForGroup_Response.invite_links:type_name -> steam.CChatRoom_GetInviteLinksForGroup_Response.LinkInfo
	148, // 37: steam.CChatRoom_GetBanList_Response.bans:type_name -> steam.CChatRoom_GetBanList_Response.BanInfo
	105, // 38: steam.CChatRoom_GetInviteList_Response.invites:type_name -> steam.CChatRoomGroupInvite
	15,  // 39: steam.CChatRoom_SetSessionActiveChatRoomGroups_Response.chat_states:type_name -> steam.CChatRoomGroupState
	149, // 40: steam.CChatRoom_SetUserChatGroupPreferences_Request.chat_group_preferences:type_name -> steam.CChatRoom_SetUserChatGroupPreferences_Request.ChatGroupPreferences
	150, // 41: steam.CChatRoom_SetUserChatGroupPreferences_Request.chat_room_preferences:type_name -> steam.CChatRoom_SetUserChatGroupPreferences_Request.ChatRoomPreferences
	151, // 42: steam.CChatRoom_DeleteChatMessages_Request.messages:type_name -> steam.CChatRoom_DeleteChatMessages_Request.Message
	152, // 43: steam.CChatRoom_SearchMembers_Response.matching_members:type_name -> steam.CChatRoom_SearchMembers_Response.MemberMatch
	4,   // 44: steam.CChatRoom_UpdateMessageReaction_Request.reaction_type:type_name -> steam.EChatRoomMessageReactionType
	4,   // 45: steam.CChatRoom_GetMessageReactionReactors_Request.reaction_type:type_name -> steam.EChatRoomMessageReactionType
	160, // 46: steam.CChatRoom_ReportMessage_Request.report_reason:type_name -> steam.EContentReportReason
	161, // 47: steam.CChatRoom_ReportMessage_Request.subject_type:type_name -> steam.EContentReportSubjectType
	162, // 48: steam.CChatRoom_ResolveReport_Request.resolution:type_name -> steam.EContentReportResolution
	160, // 49: steam.CChatRoom_ResolveReport_Request.reason:type_name -> steam.EContentReportReason
	161, // 50: steam.CChatRoom_ResolveReport_Request.subject_type:type_name -> steam.EContentReportSubjectType
	85,  // 51: steam.CClanChatRooms_GetClanChatRoomInfo_Response.chat_group_summary:type_name -> steam.CChatRoom_GetChatRoomGroupSummary_Response
	130, // 52: steam.CChatRoom_IncomingChatMessage_Notification.mentions:type_name -> steam.CChatMentions
	82,  // 53: steam.CChatRoom_IncomingChatMessage_Notification.server_message:type_name -> steam.ServerMessage
	153, // 54: steam.CChatRoom_ChatMessageModified_Notification.messages:type_name -> steam.CChatRoom_ChatMessageModified_Notification.ChatMessage
	13,  // 55: steam.CChatRoom_MemberStateChange_Notification.member:type_name -> steam.CChatRoomMember
	5,   // 56: steam.CChatRoom_MemberStateChange_Notification.change:type_name -> steam.EChatRoomMemberStateChange
	12,  // 57: steam.CChatRoom_ChatRoomHeaderState_Notification.header_state:type_name -> steam.CChatRoomGroupHeaderState
	14,  // 58: steam.CChatRoom_ChatRoomGroupRoomsChange_Notification.chat_rooms:type_name -> steam.CChatRoomState
	17,  // 59: steam.ChatRoomClient_NotifyChatGroupUserStateChanged_Notification.user_chat_group_state:type_name -> steam.CUserChatRoomGroupState
	85,  // 60: steam.ChatRoomClient_NotifyChatGroupUserStateChanged_Notification.group_summary:type_name -> steam.CChatRoom_GetChatRoomGroupSummary_Response
	5,   // 61: steam.ChatRoomClient_NotifyChatGroupUserStateChanged_Notification.user_action:type_name -> steam.EChatRoomMemberStateChange
	139, // 62: steam.CChatRoomClient_MemberListViewUpdated_Notification.view:type_name -> steam.CChatRoomMemberListView
	154, // 63: steam.CChatRoomClient_MemberListViewUpdated_Notification.members:type_name -> steam.CChatRoomClient_MemberListViewUpdated_Notification.MemberListViewEntry
	140, // 64: steam.CChatRoomClient_MemberListViewUpdated_Notification.member_summary:type_name -> steam.CChatRoomMemberSummaryCounts
	163, // 65: steam.CChatRoomClient_MemberListViewUpdated_Notification.subscribed_personas:type_name -> steam.CMsgClientPersonaState.Friend
	4,   // 66: steam.CChatRoom_MessageReaction_Notification.reaction_type:type_name -> steam.EChatRoomMessageReactionType
	155, // 67: steam.CChatUsability_ClientUsabilityMetrics_Notification.settings:type_name -> steam.CChatUsability_ClientUsabilityMetrics_Notification.Settings
	156, // 68: steam.CChatUsability_ClientUsabilityMetrics_Notification.voice_settings:type_name -> steam.CChatUsability_ClientUsabilityMetrics_Notification.VoiceSettings
	157, // 69: steam.CChatUsability_ClientUsabilityMetrics_Notification.ui_state:type_name -> steam.CChatUsability_ClientUsabilityMetrics_Notification.UIState
	158, // 70: steam.CChatUsability_ClientUsabilityMetrics_Notification.metrics:type_name -> steam.CChatUsability_ClientUsabilityMetrics_Notification.Metrics
	82,  // 71: steam.CChatRoom_GetMessageHistory_Response.ChatMessage.server_message:type_name -> steam.ServerMessage
	146, // 72: steam.CChatRoom_GetMessageHistory_Response.ChatMessage.reactions:type_name -> steam.CChatRoom_GetMessageHistory_Response.ChatMessage.MessageReaction
	4,   // 73: steam.CChatRoom_GetMessageHistory_Response.ChatMessage.MessageReaction.reaction_type:type_name -> steam.EChatRoomMessageReactionType
	2,   // 74: steam.CChatRoom_SetUserChatGroupPreferences_Request.ChatGroupPreferences.desktop_notification_level:type_name -> steam.EChatRoomNotificationLevel
	2,   // 75: steam.CChatRoom_SetUserChatGroupPreferences_Request.ChatGroupPreferences.mobile_notification_level:type_name -> steam.EChatRoomNotificationLevel
	2,   // 76: steam.CChatRoom_SetUserChatGroupPreferences_Request.ChatRoomPreferences.desktop_notification_level:type_name -> steam.EChatRoomNotificationLevel
	2,   // 77: steam.CChatRoom_SetUserChatGroupPreferences_Request.ChatRoomPreferences.mobile_notification_level:type_name -> steam.EChatRoomNotificationLevel
	163, // 78: steam.CChatRoom_SearchMembers_Response.MemberMatch.persona:type_name -> steam.CMsgClientPersonaState.Friend
	163, // 79: steam.CChatRoomClient_MemberListViewUpdated_Notification.MemberListViewEntry.persona:type_name -> steam.CMsgClientPersonaState.Friend
	159, // 80: steam.CChatUsability_ClientUsabilityMetrics_Notification.UIState.category_collapse:type_name -> steam.CChatUsability_ClientUsabilityMetrics_Notification.UIState.CategoryCollapseState
	6,   // 81: steam.Chat.RequestFriendPersonaStates:input_type -> steam.CChat_RequestFriendPersonaStates_Request
	8,   // 82: steam.ChatRoom.CreateChatRoomGroup:input_type -> steam.CChatRoom_CreateChatRoomGroup_Request
	19,  // 83: steam.ChatRoom.SaveChatRoomGroup:input_type -> steam.CChatRoom_SaveChatRoomGroup_Request
	21,  // 84: steam.ChatRoom.RenameChatRoomGroup:input_type -> steam.CChatRoom_RenameChatRoomGroup_Request
	23,  // 85: steam.ChatRoom.SetChatRoomGroupTagline:input_type -> steam.CChatRoom_SetChatRoomGroupTagline_Request
	25,  // 86: steam.ChatRoom.SetChatRoomGroupAvatar:input_type -> steam.CChatRoom_SetChatRoomGroupAvatar_Request
	27,  // 87: steam.ChatRoom.SetChatRoomGroupWatchingBroadcast:input_type -> steam.CChatRoom_SetChatRoomGroupWatchingBroadcast_Request
	29,  // 88: steam.ChatRoom.JoinMiniGameForChatRoomGroup:input_type -> steam.CChatRoom_JoinMiniGameForChatRoomGroup_Request
	31,  // 89: steam.ChatRoom.EndMiniGameForChatRoomGroup:input_type -> steam.CChatRoom_EndMiniGameForChatRoomGroup_Request
	33,  // 90: steam.ChatRoom.MuteUserInGroup:input_type -> steam.CChatRoom_MuteUser_Request
	35,  // 91: steam.ChatRoom.KickUserFromGroup:input_type -> steam.CChatRoom_KickUser_Request
	37,  // 92: steam.ChatRoom.SetUserBanState:input_type -> steam.CChatRoom_SetUserBanState_Request
	39,  // 93: steam.ChatRoom.RevokeInviteToGroup:input_type -> steam.CChatRoom_RevokeInvite_Request
	41,  // 94: steam.ChatRoom.CreateRole:input_type -> steam.CChatRoom_CreateRole_Request
	43,  // 95: steam.ChatRoom.GetRoles:input_type -> steam.CChatRoom_GetRoles_Request
	45,  // 96: steam.ChatRoom.RenameRole:input_type -> steam.CChatRoom_RenameRole_Request
	47,  // 97: steam.ChatRoom.ReorderRole:input_type -> steam.CChatRoom_ReorderRole_Request
	49,  // 98: steam.ChatRoom.DeleteRole:input_type -> steam.CChatRoom_DeleteRole_Request
	51,  // 99: steam.ChatRoom.GetRoleActions:input_type -> steam.CChatRoom_GetRoleActions_Request
	53,  // 100: steam.ChatRoom.ReplaceRoleActions:input_type -> steam.CChatRoom_ReplaceRoleActions_Request
	55,  // 101: steam.ChatRoom.AddRoleToUser:input_type -> steam.CChatRoom_AddRoleToUser_Request
	57,  // 102: steam.ChatRoom.GetRolesForUser:input_type -> steam.CChatRoom_GetRolesForUser_Request
	59,  // 103: steam.ChatRoom.DeleteRoleFromUser:input_type -> steam.CChatRoom_DeleteRoleFromUser_Request
	61,  // 104: steam.ChatRoom.JoinChatRoomGroup:input_type -> steam.CChatRoom_JoinChatRoomGroup_Request
	63,  // 105: steam.ChatRoom.InviteFriendToChatRoomGroup:input_type -> steam.CChatRoom_InviteFriendToChatRoomGroup_Request
	65,  // 106: steam.ChatRoom.LeaveChatRoomGroup:input_type -> steam.CChatRoom_LeaveChatRoomGroup_Request
	67,  // 107: steam.ChatRoom.CreateChatRoom:input_type -> steam.CChatRoom_CreateChatRoom_Request
	69,  // 108: steam.ChatRoom.DeleteChatRoom:input_type -> steam.CChatRoom_DeleteChatRoom_Request
	71,  // 109: steam.ChatRoom.RenameChatRoom:input_type -> steam.CChatRoom_RenameChatRoom_Request
	73,  // 110: steam.ChatRoom.ReorderChatRoom:input_type -> steam.CChatRoom_ReorderChatRoom_Request
	75,  // 111: steam.ChatRoom.SendChatMessage:input_type -> steam.CChatRoom_SendChatMessage_Request
	77,  // 112: steam.ChatRoom.JoinVoiceChat:input_type -> steam.CChatRoom_JoinVoiceChat_Request
	79,  // 113: steam.ChatRoom.LeaveVoiceChat:input_type -> steam.CChatRoom_LeaveVoiceChat_Request
	81,  // 114: steam.ChatRoom.GetMessageHistory:input_type -> steam.CChatRoom_GetMessageHistory_Request
	84,  // 115: steam.ChatRoom.GetMyChatRoomGroups:input_type -> steam.CChatRoom_GetMyChatRoomGroups_Request
	88,  // 116: steam.ChatRoom.GetChatRoomGroupState:input_type -> steam.CChatRoom_GetChatRoomGroupState_Request
	90,  // 117: steam.ChatRoom.SetAppChatRoomGroupForceActive:input_type -> steam.CChatRoom_SetAppChatRoomGroupForceActive_Request
	92,  // 118: steam.ChatRoom.SetAppChatRoomGroupStopForceActive:input_type -> steam.CChatRoom_SetAppChatRoomGroupStopForceActive_Notification
	93,  // 119: steam.ChatRoom.AckChatMessage:input_type -> steam.CChatRoom_AckChatMessage_Notification
	94,  // 120: steam.ChatRoom.CreateInviteLink:input_type -> steam.CChatRoom_CreateInviteLink_Request
	96,  // 121: steam.ChatRoom.GetInviteLinkInfo:input_type -> steam.CChatRoom_GetInviteLinkInfo_Request
	98,  // 122: steam.ChatRoom.GetInviteInfo:input_type -> steam.CChatRoom_GetInviteInfo_Request
	100, // 123: steam.ChatRoom.GetInviteLinksForGroup:input_type -> steam.CChatRoom_GetInviteLinksForGroup_Request
	102, // 124: steam.ChatRoom.GetBanList:input_type -> steam.CChatRoom_GetBanList_Request
	104, // 125: steam.ChatRoom.GetInviteList:input_type -> steam.CChatRoom_GetInviteList_Request
	107, // 126: steam.ChatRoom.DeleteInviteLink:input_type -> steam.CChatRoom_DeleteInviteLink_Request
	109, // 127: steam.ChatRoom.SetSessionActiveChatRoomGroups:input_type -> steam.CChatRoom_SetSessionActiveChatRoomGroups_Request
	111, // 128: steam.ChatRoom.SetUserChatGroupPreferences:input_type -> steam.CChatRoom_SetUserChatGroupPreferences_Request
	113, // 129: steam.ChatRoom.DeleteChatMessages:input_type -> steam.CChatRoom_DeleteChatMessages_Request
	115, // 130: steam.ChatRoom.UpdateMemberListView:input_type -> steam.CChatRoom_UpdateMemberListView_Notification
	116, // 131: steam.ChatRoom.SearchMembers:input_type -> steam.CChatRoom_SearchMembers_Request
	118, // 132: steam.ChatRoom.UpdateMessageReaction:input_type -> steam.CChatRoom_UpdateMessageReaction_Request
	120, // 133: steam.ChatRoom.GetMessageReactionReactors:input_type -> steam.CChatRoom_GetMessageReactionReactors_Request
	122, // 134: steam.ChatRoom.ReportMessage:input_type -> steam.CChatRoom_ReportMessage_Request
	124, // 135: steam.ChatRoom.ResolveReport:input_type -> steam.CChatRoom_ResolveReport_Request
	126, // 136: steam.ClanChatRooms.GetClanChatRoomInfo:input_type -> steam.CClanChatRooms_GetClanChatRoomInfo_Request
	128, // 137: steam.ClanChatRooms.SetClanChatRoomPrivate:input_type -> steam.CClanChatRooms_SetClanChatRoomPrivate_Request
	131, // 138: steam.ChatRoomClient.NotifyIncomingChatMessage:input_type -> steam.CChatRoom_IncomingChatMessage_Notification
	132, // 139: steam.ChatRoomClient.NotifyChatMessageModified:input_type -> steam.CChatRoom_ChatMessageModified_Notification
	133, // 140: steam.ChatRoomClient.NotifyMemberStateChange:input_type -> steam.CChatRoom_MemberStateChange_Notification
	134, // 141: steam.ChatRoomClient.NotifyChatRoomHeaderStateChange:input_type -> steam.CChatRoom_ChatRoomHeaderState_Notification
	135, // 142: steam.ChatRoomClient.NotifyChatRoomGroupRoomsChange:input_type -> steam.CChatRoom_ChatRoomGroupRoomsChange_Notification
	136, // 143: steam.ChatRoomClient.NotifyShouldRejoinChatRoomVoiceChat:input_type -> steam.CChatRoom_NotifyShouldRejoinChatRoomVoiceChat_Notification
	137, // 144: steam.ChatRoomClient.NotifyChatGroupUserStateChanged:input_type -> steam.ChatRoomClient_NotifyChatGroupUserStateChanged_Notification
	93,  // 145: steam.ChatRoomClient.NotifyAckChatMessageEcho:input_type -> steam.CChatRoom_AckChatMessage_Notification
	138, // 146: steam.ChatRoomClient.NotifyChatRoomDisconnect:input_type -> steam.ChatRoomClient_NotifyChatRoomDisconnect_Notification
	141, // 147: steam.ChatRoomClient.NotifyMemberListViewUpdated:input_type -> steam.CChatRoomClient_MemberListViewUpdated_Notification
	142, // 148: steam.ChatRoomClient.NotifyMessageReaction:input_type -> steam.CChatRoom_MessageReaction_Notification
	143, // 149: steam.ChatUsability.NotifyClientUsabilityMetrics:input_type -> steam.CChatUsability_ClientUsabilityMetrics_Notification
	144, // 150: steam.ChatUsabilityClient.NotifyRequestClientUsabilityMetrics:input_type -> steam.CChatUsability_RequestClientUsabilityMetrics_Notification
	7,   // 151: steam.Chat.RequestFriendPersonaStates:output_type -> steam.CChat_RequestFriendPersonaStates_Response
	18,  // 152: steam.ChatRoom.CreateChatRoomGroup:output_type -> steam.CChatRoom_CreateChatRoomGroup_Response
	20,  // 153: steam.ChatRoom.SaveChatRoomGroup:output_type -> steam.CChatRoom_SaveChatRoomGroup_Response
	22,  // 154: steam.ChatRoom.RenameChatRoomGroup:output_type -> steam.CChatRoom_RenameChatRoomGroup_Response
	24,  // 155: steam.ChatRoom.SetChatRoomGroupTagline:output_type -> steam.CChatRoom_SetChatRoomGroupTagline_Response
	26,  // 156: steam.ChatRoom.SetChatRoomGroupAvatar:output_type -> steam.CChatRoom_SetChatRoomGroupAvatar_Response
	28,  // 157: steam.ChatRoom.SetChatRoomGroupWatchingBroadcast:output_type -> steam.CChatRoom_SetChatRoomGroupWatchingBroadcast_Response
	30,  // 158: steam.ChatRoom.JoinMiniGameForChatRoomGroup:output_type -> steam.CChatRoom_JoinMiniGameForChatRoomGroup_Response
	32,  // 159: steam.ChatRoom.EndMiniGameForChatRoomGroup:output_type -> steam.CChatRoom_EndMiniGameForChatRoomGroup_Response
	34,  // 160: steam.ChatRoom.MuteUserInGroup:output_type -> steam.CChatRoom_MuteUser_Response
	36,  // 161: steam.ChatRoom.KickUserFromGroup:output_type -> steam.CChatRoom_KickUser_Response
	38,  // 162: steam.ChatRoom.SetUserBanState:output_type -> steam.CChatRoom_SetUserBanState_Response
	40,  // 163: steam.ChatRoom.RevokeInviteToGroup:output_type -> steam.CChatRoom_RevokeInvite_Response
	42,  // 164: steam.ChatRoom.CreateRole:output_type -> steam.CChatRoom_CreateRole_Response
	44,  // 165: steam.ChatRoom.GetRoles:output_type -> steam.CChatRoom_GetRoles_Response
	46,  // 166: steam.ChatRoom.RenameRole:output_type -> steam.CChatRoom_RenameRole_Response
	48,  // 167: steam.ChatRoom.ReorderRole:output_type -> steam.CChatRoom_ReorderRole_Response
	50,  // 168: steam.ChatRoom.DeleteRole:output_type -> steam.CChatRoom_DeleteRole_Response
	52,  // 169: steam.ChatRoom.GetRoleActions:output_type -> steam.CChatRoom_GetRoleActions_Response
	54,  // 170: steam.ChatRoom.ReplaceRoleActions:output_type -> steam.CChatRoom_ReplaceRoleActions_Response
	56,  // 171: steam.ChatRoom.AddRoleToUser:output_type -> steam.CChatRoom_AddRoleToUser_Response
	58,  // 172: steam.ChatRoom.GetRolesForUser:output_type -> steam.CChatRoom_GetRolesForUser_Response
	60,  // 173: steam.ChatRoom.DeleteRoleFromUser:output_type -> steam.CChatRoom_DeleteRoleFromUser_Response
	62,  // 174: steam.ChatRoom.JoinChatRoomGroup:output_type -> steam.CChatRoom_JoinChatRoomGroup_Response
	64,  // 175: steam.ChatRoom.InviteFriendToChatRoomGroup:output_type -> steam.CChatRoom_InviteFriendToChatRoomGroup_Response
	66,  // 176: steam.ChatRoom.LeaveChatRoomGroup:output_type -> steam.CChatRoom_LeaveChatRoomGroup_Response
	68,  // 177: steam.ChatRoom.CreateChatRoom:output_type -> steam.CChatRoom_CreateChatRoom_Response
	70,  // 178: steam.ChatRoom.DeleteChatRoom:output_type -> steam.CChatRoom_DeleteChatRoom_Response
	72,  // 179: steam.ChatRoom.RenameChatRoom:output_type -> steam.CChatRoom_RenameChatRoom_Response
	74,  // 180: steam.ChatRoom.ReorderChatRoom:output_type -> steam.CChatRoom_ReorderChatRoom_Response
	76,  // 181: steam.ChatRoom.SendChatMessage:output_type -> steam.CChatRoom_SendChatMessage_Response
	78,  // 182: steam.ChatRoom.JoinVoiceChat:output_type -> steam.CChatRoom_JoinVoiceChat_Response
	80,  // 183: steam.ChatRoom.LeaveVoiceChat:output_type -> steam.CChatRoom_LeaveVoiceChat_Response
	83,  // 184: steam.ChatRoom.GetMessageHistory:output_type -> steam.CChatRoom_GetMessageHistory_Response
	87,  // 185: steam.ChatRoom.GetMyChatRoomGroups:output_type -> steam.CChatRoom_GetMyChatRoomGroups_Response
	89,  // 186: steam.ChatRoom.GetChatRoomGroupState:output_type -> steam.CChatRoom_GetChatRoomGroupState_Response
	91,  // 187: steam.ChatRoom.SetAppChatRoomGroupForceActive:output_type -> steam.CChatRoom_SetAppChatRoomGroupForceActive_Response
	164, // 188: steam.ChatRoom.SetAppChatRoomGroupStopForceActive:output_type -> steam.NoResponse
	164, // 189: steam.ChatRoom.AckChatMessage:output_type -> steam.NoResponse
	95,  // 190: steam.ChatRoom.CreateInviteLink:output_type -> steam.CChatRoom_CreateInviteLink_Response
	97,  // 191: steam.ChatRoom.GetInviteLinkInfo:output_type -> steam.CChatRoom_GetInviteLinkInfo_Response
	99,  // 192: steam.ChatRoom.GetInviteInfo:output_type -> steam.CChatRoom_GetInviteInfo_Response
	101, // 193: steam.ChatRoom.GetInviteLinksForGroup:output_type -> steam.CChatRoom_GetInviteLinksForGroup_Response
	103, // 194: steam.ChatRoom.GetBanList:output_type -> steam.CChatRoom_GetBanList_Response
	106, // 195: steam.ChatRoom.GetInviteList:output_type -> steam.CChatRoom_GetInviteList_Response
	108, // 196: steam.ChatRoom.DeleteInviteLink:output_type -> steam.CChatRoom_DeleteInviteLink_Response
	110, // 197: steam.ChatRoom.SetSessionActiveChatRoomGroups:output_type -> steam.CChatRoom_SetSessionActiveChatRoomGroups_Response
	112, // 198: steam.ChatRoom.SetUserChatGroupPreferences:output_type -> steam.CChatRoom_SetUserChatGroupPreferences_Response
	114, // 199: steam.ChatRoom.DeleteChatMessages:output_type -> steam.CChatRoom_DeleteChatMessages_Response
	164, // 200: steam.ChatRoom.UpdateMemberListView:output_type -> steam.NoResponse
	117, // 201: steam.ChatRoom.SearchMembers:output_type -> steam.CChatRoom_SearchMembers_Response
	119, // 202: steam.ChatRoom.UpdateMessageReaction:output_type -> steam.CChatRoom_UpdateMessageReaction_Response
	121, // 203: steam.ChatRoom.GetMessageReactionReactors:output_type -> steam.CChatRoom_GetMessageReactionReactors_Response
	123, // 204: steam.ChatRoom.ReportMessage:output_type -> steam.CChatRoom_ReportMessage_Response
	125, // 205: steam.ChatRoom.ResolveReport:output_type -> steam.CChatRoom_ResolveReport_Response
	127, // 206: steam.ClanChatRooms.GetClanChatRoomInfo:output_type -> steam.CClanChatRooms_GetClanChatRoomInfo_Response
	129, // 207: steam.ClanChatRooms.SetClanChatRoomPrivate:output_type -> steam.CClanChatRooms_SetClanChatRoomPrivate_Response
	164, // 208: steam.ChatRoomClient.NotifyIncomingChatMessage:output_type -> steam.NoResponse
	164, // 209: steam.ChatRoomClient.NotifyChatMessageModified:output_type -> steam.NoResponse
	164, // 210: steam.ChatRoomClient.NotifyMemberStateChange:output_type -> steam.NoResponse
	164, // 211: steam.ChatRoomClient.NotifyChatRoomHeaderStateChange:output_type -> steam.NoResponse
	164, // 212: steam.ChatRoomClient.NotifyChatRoomGroupRoomsChange:output_type -> steam.NoResponse
	164, // 213: steam.ChatRoomClient.NotifyShouldRejoinChatRoomVoiceChat:output_type -> steam.NoResponse
	164, // 214: steam.ChatRoomClient.NotifyChatGroupUserStateChanged:output_type -> steam.NoResponse
	164, // 215: steam.ChatRoomClient.NotifyAckChatMessageEcho:output_type -> steam.NoResponse
	164, // 216: steam.ChatRoomClient.NotifyChatRoomDisconnect:output_type -> steam.NoResponse
	164, // 217: steam.ChatRoomClient.NotifyMemberListViewUpdated:output_type -> steam.NoResponse
	164, // 218: steam.ChatRoomClient.NotifyMessageReaction:output_type -> steam.NoResponse
	164, // 219: steam.ChatUsability.NotifyClientUsabilityMetrics:output_type -> steam.NoResponse
	164, // 220: steam.ChatUsabilityClient.NotifyRequestClientUsabilityMetrics:output_type -> steam.NoResponse
