...
type LobbyMatchmakingLegacy_GetLobbyStatus_Response struct {
	...
	AppId         *uint32                `protobuf:"varint,1,opt,name=app_id,json=appId" json:"app_id,omitempty"`
	SteamidLobby  *uint64                `protobuf:"fixed64,2,opt,name=steamid_lobby,json=steamidLobby" json:"steamid_lobby,omitempty"`
	LobbyStatus   *ELobbyStatus          `protobuf:"varint,3,opt,name=lobby_status,json=lobbyStatus,enum=steam.ELobbyStatus,def=0" json:"lobby_status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_steammessages_lobbymatchmaking_steamclient_proto_rawDesc = "" +
	"\n" +
	"0steammessages_lobbymatchmaking.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"\xe0\x01\n" +
	...
	"\x06app_id\x18\x01 \x01(\rR\x05appId\x12#\n" +
	"\rsteamid_lobby\x18\x02 \x01(\x06R\fsteamidLobby\x12M\n" +
	"\flobby_status\x18\x03 \x01(\x0e2\x13.steam.ELobbyStatus:\x15k_ELobbyStatusInvalidR\vlobbyStatus*\x81\x01\n" +
	...
	"\x18k_ELobbyStatusNotAMember\x10\x032\x97\x01\n" +
	"\x16LobbyMatchmakingLegacy\x12}\n" +
	"\x0eGetLobbyStatus\x124.steam.LobbyMatchmakingLegacy_GetLobbyStatus_Request\x1a5.steam.LobbyMatchmakingLegacy_GetLobbyStatus_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_lobbymatchmaking_steamclient_proto_goTypes = []any{
	(ELobbyStatus)(0), // 0: steam.ELobbyStatus
	(*LobbyMatchmakingLegacy_GetLobbyStatus_Request)(nil),  // 1: steam.LobbyMatchmakingLegacy_GetLobbyStatus_Request
	(*LobbyMatchmakingLegacy_GetLobbyStatus_Response)(nil), // 2: steam.LobbyMatchmakingLegacy_GetLobbyStatus_Response
}
var file_steammessages_lobbymatchmaking_steamclient_proto_depIdxs = []int32{
	0, // 0: steam.LobbyMatchmakingLegacy_GetLobbyStatus_Response.lobby_status:type_name -> steam.ELobbyStatus
	1, // 1: steam.LobbyMatchmakingLegacy.GetLobbyStatus:input_type -> steam.LobbyMatchmakingLegacy_GetLobbyStatus_Request
	2, // 2: steam.LobbyMatchmakingLegacy.GetLobbyStatus:output_type -> steam.LobbyMatchmakingLegacy_GetLobbyStatus_Response
