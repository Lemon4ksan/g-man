...
type CGameRecording_TimelineChanged_Notification struct {
	state            protoimpl.MessageState           `protogen:"open.v1"`
	NotificationType *ETimelineChangeNotificationType `protobuf:"varint,1,opt,name=notification_type,json=notificationType,enum=steam.ETimelineChangeNotificationType,def=1" json:"notification_type,omitempty"`
...
type CGameRecording_RecordingSessionChanged_Notification struct {
	state            protoimpl.MessageState                   `protogen:"open.v1"`
	NotificationType *ERecordingSessionChangeNotificationType `protobuf:"varint,1,opt,name=notification_type,json=notificationType,enum=steam.ERecordingSessionChangeNotificationType,def=1" json:"notification_type,omitempty"`
	TimelineId       *string                                  `protobuf:"bytes,2,opt,name=timeline_id,json=timelineId" json:"timeline_id,omitempty"`
	...
	RecordingType    *EGameRecordingType                      `protobuf:"varint,8,opt,name=recording_type,json=recordingType,enum=steam.EGameRecordingType,def=0" json:"recording_type,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type CTimelineEntry struct {
	...
	Type              *ETimelineEntryType    `protobuf:"varint,4,opt,name=type,enum=steam.ETimelineEntryType,def=0" json:"type,omitempty"`
...
type CGameRecording_ExportClip_Settings struct {
	...
	Codec           *EExportCodec          `protobuf:"varint,5,opt,name=codec,enum=steam.EExportCodec,def=0" json:"codec,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type CGameRecording_GetTotalDiskSpaceUsage_Request struct {
	...
	Type          *EDiskSpaceType        `protobuf:"varint,2,opt,name=type,enum=steam.EDiskSpaceType,def=0" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CGameRecording_GetThumbnails_Request struct {
	...
	TimePrecision *EThumbnailTimePrecision `protobuf:"varint,6,opt,name=time_precision,json=timePrecision,enum=steam.EThumbnailTimePrecision,def=0" json:"time_precision,omitempty"`
	Format        *EThumbnailFormat        `protobuf:"varint,8,opt,name=format,enum=steam.EThumbnailFormat,def=1" json:"format,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CGameRecording_GetAppsWithBackgroundVideo_Response_App struct {
	...
	RecordingType           *EGameRecordingType    `protobuf:"varint,3,opt,name=recording_type,json=recordingType,enum=steam.EGameRecordingType,def=0" json:"recording_type,omitempty"`
...
type CGameRecording_QueryPhases_Response_Phase struct {
	...
	Type                *EPhaseResultType                                              `protobuf:"varint,11,opt,name=type,enum=steam.EPhaseResultType,def=1" json:"type,omitempty"`
...
const file_webuimessages_gamerecording_proto_rawDesc = "" +
	"\n" +
	"!webuimessages_gamerecording.proto\x12\x05steam\x1a\venums.proto\x1a\x18steammessages_base.proto\x1a\x18webuimessages_base.proto\x1a&webuimessages_gamerecordingfiles.proto\"3\n" +
	"1CGameRecording_GetAppsWithBackgroundVideo_Request\"\xe9\x03\n" +
	"2CGameRecording_GetAppsWithBackgroundVideo_Response\x12Q\n" +
	"\x04apps\x18\x01 \x03(\v2=.steam.CGameRecording_GetAppsWithBackgroundVideo_Response.AppR\x04apps\x1a\xdf\x02\n" +
	"\x03App\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x04R\x06gameId\x123\n" +
	"\x16most_recent_start_time\x18\x02 \x01(\rR\x13mostRecentStartTime\x12^\n" +
	"\x0erecording_type\x18\x03 \x01(\x0e2\x19.steam.EGameRecordingType:\x1ck_EGameRecordingType_UnknownR\rrecordingType\x124\n" +
	...
	"\agame_id\x18\x01 \x01(\x04R\x06gameId\"q\n" +
	"*CGameRecording_GetTimelinesForApp_Response\x12C\n" +
	"\ttimelines\x18\x01 \x03(\v2%.steam.CGameRecordingTimelineMetadataR\ttimelines\"E\n" +
	"*CGameRecording_GetTimelinesForClip_Request\x12\x17\n" +
	"\aclip_id\x18\x01 \x01(\tR\x06clipId\"\xcf\x01\n" +
	"+CGameRecording_GetTimelinesForClip_Response\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x04R\x06gameId\x12C\n" +
	"\ttimelines\x18\x02 \x03(\v2%.steam.CGameRecordingTimelineMetadataR\ttimelines\x12B\n" +
	"\x1efirst_timeline_start_offset_ms\x18\x03 \x01(\x04R\x1afirstTimelineStartOffsetMs\"\xce\x02\n" +
	...
	"\x14filter_search_string\x18\v \x01(\tR\x12filterSearchString\x12N\n" +
	"\vfilter_tags\x18\f \x03(\v2-.steam.CGameRecording_QueryPhases_Request.TagR\n" +
	"filterTags\x12&\n" +
	...
	"#CGameRecording_QueryPhases_Response\x12H\n" +
	"\x06phases\x18\x01 \x03(\v20.steam.CGameRecording_QueryPhases_Response.PhaseR\x06phases\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\rR\n" +
	"totalCount\x1a\x89\x06\n" +
	"\x05Phase\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x04R\x06gameId\x12#\n" +
	"\rdate_recorded\x18\x05 \x01(\rR\fdateRecorded\x12\x1f\n" +
	"\vduration_ms\x18\x06 \x01(\x04R\n" +
	"durationMs\x12'\n" +
	"\x04tags\x18\a \x03(\v2\x13.steam.CTimelineTagR\x04tags\x12:\n" +
	"\x0econtained_tags\x18\b \x03(\v2\x13.steam.CTimelineTagR\rcontainedTags\x12w\n" +
	"\x14background_recording\x18\t \x01(\v2D.steam.CGameRecording_QueryPhases_Response.Phase.BackgroundRecordingR\x13backgroundRecording\x12\x19\n" +
	"\bclip_ids\x18\n" +
	" \x03(\tR\aclipIds\x12I\n" +
	"\x04type\x18\v \x01(\x0e2\x17.steam.EPhaseResultType:\x1ck_EPhaseResultType_AutomaticR\x04type\x12\x19\n" +
	...
	"\bphase_id\x18\x0f \x01(\tR\aphaseId\x12D\n" +
	"\x12significant_events\x18\x10 \x03(\v2\x15.steam.CTimelineEntryR\x11significantEvents\x126\n" +
	"\n" +
	"attributes\x18\x11 \x03(\v2\x16.steam.CPhaseAttributeR\n" +
	"attributes\x1ao\n" +
	...
	"\agame_id\x18\x01 \x01(\x04R\x06gameId\"J\n" +
	"\x1fCGameRecording_GetTags_Response\x12'\n" +
	"\x04tags\x18\x01 \x03(\v2\x13.steam.CTimelineTagR\x04tags\"+\n" +
	...
	"\x04size\x18\x01 \x01(\x01R\x04size\"\xa7\x02\n" +
	"+CGameRecording_TimelineChanged_Notification\x12~\n" +
	"\x11notification_type\x18\x01 \x01(\x0e2&.steam.ETimelineChangeNotificationType:)k_ETimelineChangeNotificationType_StartedR\x10notificationType\x12\x1f\n" +
	...
	"durationMs\"\xc3\x03\n" +
	"3CGameRecording_RecordingSessionChanged_Notification\x12\x8e\x01\n" +
	"\x11notification_type\x18\x01 \x01(\x0e2..steam.ERecordingSessionChangeNotificationType:1k_ERecordingSessionChangeNotificationType_StartedR\x10notificationType\x12\x1f\n" +
	"\vtimeline_id\x18\x02 \x01(\tR\n" +
	"timelineId\x12\x17\n" +
	...
	"durationMs\x12^\n" +
	"\x0erecording_type\x18\b \x01(\x0e2\x19.steam.EGameRecordingType:\x1ck_EGameRecordingType_UnknownR\rrecordingType\"\xb6\x05\n" +
	"\x0eCTimelineEntry\x12\x1f\n" +
	"\vtimeline_id\x18\x01 \x01(\tR\n" +
	"timelineId\x12\x19\n" +
	"\bentry_id\x18\x02 \x01(\x04R\aentryId\x12\x12\n" +
	"\x04time\x18\x03 \x01(\x04R\x04time\x12K\n" +
	"\x04type\x18\x04 \x01(\x0e2\x19.steam.ETimelineEntryType:\x1ck_ETimelineEntryType_InvalidR\x04type\x12\x1b\n" +
	...
	"\x10achievement_name\x18\x10 \x01(\tR\x0fachievementName\x12%\n" +
	"\x03tag\x18\x11 \x03(\v2\x13.steam.CTimelineTagR\x03tag\x12\x19\n" +
	"\bphase_id\x18\x12 \x01(\tR\aphaseId\x126\n" +
	"\n" +
	"attributes\x18\x13 \x03(\v2\x16.steam.CPhaseAttributeR\n" +
	"attributes\"x\n" +
	"0CGameRecording_TimelineEntryChanged_Notification\x12+\n" +
	"\x05entry\x18\x01 \x01(\v2\x15.steam.CTimelineEntryR\x05entry\x12\x17\n" +
	...
	"\x10thumbnail_height\x18\x11 \x01(\rR\x0fthumbnailHeight\"\x89\x03\n" +
	"\x1fCGameRecording_SaveClip_Request\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x04R\x06gameId\x12E\n" +
	"\x05start\x18\x02 \x01(\v2/.steam.CGameRecording_SaveClip_Request.PositionR\x05start\x12A\n" +
	"\x03end\x18\x03 \x01(\v2/.steam.CGameRecording_SaveClip_Request.PositionR\x03end\x12\x12\n" +
	...
	"\vtimeline_id\x18\x01 \x01(\tR\n" +
	"timelineId\x12\x1b\n" +
	"\toffset_ms\x18\x02 \x01(\x04R\boffsetMs\"_\n" +
	" CGameRecording_SaveClip_Response\x12;\n" +
	"\asummary\x18\x01 \x01(\v2!.steam.CGameRecording_ClipSummaryR\asummary\"<\n" +
	"!CGameRecording_DeleteClip_Request\x12\x17\n" +
	"\aclip_id\x18\x01 \x01(\tR\x06clipId\"$\n" +
	"\"CGameRecording_DeleteClip_Response\"\xe4\x01\n" +
	...
	"\x11frames_per_second\x18\x04 \x01(\x05R\x0fframesPerSecond\x12A\n" +
	"\x05codec\x18\x05 \x01(\x0e2\x13.steam.EExportCodec:\x16k_EExportCodec_DefaultR\x05codec\"\xdb\x01\n" +
	"!CGameRecording_ExportClip_Request\x12\x17\n" +
	"\aclip_id\x18\x01 \x01(\tR\x06clipId\x12&\n" +
	"\x0fexport_mp4_path\x18\x02 \x01(\tR\rexportMp4Path\x12E\n" +
	"\bsettings\x18\x03 \x01(\v2).steam.CGameRecording_ExportClip_SettingsR\bsettings\x12.\n" +
	"\x13use_unique_filename\x18\x04 \x01(\bR\x11useUniqueFilename\"$\n" +
	"\"CGameRecording_ExportClip_Response\"\xb6\x01\n" +
	"(CGameRecording_ExportClipPreview_Request\x12\x17\n" +
	"\aclip_id\x18\x01 \x01(\tR\x06clipId\x12E\n" +
	"\bsettings\x18\x02 \x01(\v2).steam.CGameRecording_ExportClip_SettingsR\bsettings\x12*\n" +
	"\x11run_policy_checks\x18\x03 \x01(\bR\x0frunPolicyChecks\"\x99\x01\n" +
	")CGameRecording_ExportClipPreview_Response\x12%\n" +
	"\x0eestimated_size\x18\x01 \x01(\x04R\restimatedSize\x12E\n" +
	"\bsettings\x18\x02 \x01(\v2).steam.CGameRecording_ExportClip_SettingsR\bsettings\"\xb5\x01\n" +
	...
	"\asummary\x18\x01 \x01(\v2!.steam.CGameRecording_ClipSummaryR\asummary\"9\n" +
	...
	"\x11include_temporary\x18\x03 \x01(\bR\x10includeTemporary\"Y\n" +
	" CGameRecording_GetClips_Response\x125\n" +
	"\x04clip\x18\x01 \x03(\v2!.steam.CGameRecording_ClipSummaryR\x04clip\"s\n" +
	"3CGameRecording_GetAndTrimPostGameHighlights_Request\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x04R\x06gameId\x12#\n" +
	"\rcreated_after\x18\x02 \x01(\rR\fcreatedAfter\"r\n" +
	"4CGameRecording_GetAndTrimPostGameHighlights_Response\x12:\n" +
	"\x06events\x18\x01 \x03(\v2\".steam.CGameRecordingTimelineEventR\x06events\"\x8c\x01\n" +
	"+CGameRecording_UserAddTimelineEntry_Request\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x04R\x06gameId\x12+\n" +
	"\x05entry\x18\x02 \x01(\v2\x15.steam.CTimelineEntryR\x05entry\x12\x17\n" +
	"\aclip_id\x18\x03 \x01(\tR\x06clipId\"I\n" +
	",CGameRecording_UserAddTimelineEntry_Response\x12\x19\n" +
	"\bentry_id\x18\x01 \x01(\x04R\aentryId\"\x8f\x01\n" +
	...
	"7CGameRecording_ManuallyDeleteRecordingsForApps_Response\"\x97\x01\n" +
	"-CGameRecording_GetTotalDiskSpaceUsage_Request\x12\x1f\n" +
	"\vfolder_path\x18\x01 \x01(\tR\n" +
	"folderPath\x12E\n" +
	"\x04type\x18\x02 \x01(\x0e2\x15.steam.EDiskSpaceType:\x1ak_eDiskSpaceType_RecordingR\x04type\"D\n" +
	".CGameRecording_GetTotalDiskSpaceUsage_Response\x12\x12\n" +
	"\x04size\x18\x01 \x01(\x04R\x04size\"\xdc\x02\n" +
	...
	"\n" +
	"major_axis\x18\x05 \x01(\r:\x03512R\tmajorAxis\x12Q\n" +
	"\x0etime_precision\x18\x06 \x01(\x0e2\x1e.steam.EThumbnailTimePrecision:\n" +
	"k_ePreciseR\rtimePrecision\x128\n" +
	"\x06format\x18\b \x01(\x0e2\x17.steam.EThumbnailFormat:\ak_eJPEGR\x06format\"\xd9\x01\n" +
	"%CGameRecording_GetThumbnails_Response\x12V\n" +
	"\n" +
	"thumbnails\x18\x01 \x03(\v26.steam.CGameRecording_GetThumbnails_Response.ThumbnailR\n" +
	"thumbnails\x1aX\n" +
	"\tThumbnail\x12\x1d\n" +
	"\n" +
	...
	"\asummary\x18\x01 \x01(\v2!.steam.CGameRecording_ClipSummaryR\asummary\"B\n" +
	...
	"\x19per_process_audio_capture\x18\x01 \x01(\bR\x16perProcessAudioCapture\"f\n" +
	...
	")CGameRecording_GetPerGameSettings_Request\"o\n" +
	"*CGameRecording_GetPerGameSettings_Response\x12A\n" +
	"\bsettings\x18\x01 \x03(\v2%.steam.CGameRecording_PerGameSettingsR\bsettings\"w\n" +
	")CGameRecording_SetPerGameSettings_Request\x12J\n" +
	"\rgame_settings\x18\x01 \x01(\v2%.steam.CGameRecording_PerGameSettingsR\fgameSettings\",\n" +
	...
	"\n" +
	"\x06k_eRGB\x10\x022\xe1(\n" +
	"\rGameRecording\x12\x91\x01\n" +
	"\x1aGetAppsWithBackgroundVideo\x128.steam.CGameRecording_GetAppsWithBackgroundVideo_Request\x1a9.steam.CGameRecording_GetAppsWithBackgroundVideo_Response\x12y\n" +
	"\x12GetTimelinesForApp\x120.steam.CGameRecording_GetTimelinesForApp_Request\x1a1.steam.CGameRecording_GetTimelinesForApp_Response\x12|\n" +
	"\x13GetTimelinesForClip\x121.steam.CGameRecording_GetTimelinesForClip_Request\x1a2.steam.CGameRecording_GetTimelinesForClip_Response\x12d\n" +
	"\vQueryPhases\x12).steam.CGameRecording_QueryPhases_Request\x1a*.steam.CGameRecording_QueryPhases_Response\x12X\n" +
	"\aGetTags\x12%.steam.CGameRecording_GetTags_Request\x1a&.steam.CGameRecording_GetTags_Response\x12y\n" +
	"\x12GetEnoughDiskSpace\x120.steam.CGameRecording_GetEnoughDiskSpace_Request\x1a1.steam.CGameRecording_GetEnoughDiskSpace_Response\x12\x82\x01\n" +
	"\x15GetAvailableDiskSpace\x123.steam.CGameRecording_GetAvailableDiskSpace_Request\x1a4.steam.CGameRecording_GetAvailableDiskSpace_Response\x12[\n" +
	"\bSaveClip\x12&.steam.CGameRecording_SaveClip_Request\x1a'.steam.CGameRecording_SaveClip_Response\x12a\n" +
	"\n" +
	"DeleteClip\x12(.steam.CGameRecording_DeleteClip_Request\x1a).steam.CGameRecording_DeleteClip_Response\x12[\n" +
	"\bGetClips\x12&.steam.CGameRecording_GetClips_Request\x1a'.steam.CGameRecording_GetClips_Response\x12v\n" +
	"\x11UploadClipToSteam\x12/.steam.CGameRecording_UploadClipToSteam_Request\x1a0.steam.CGameRecording_UploadClipToSteam_Response\x12a\n" +
	"\n" +
	"ExportClip\x12(.steam.CGameRecording_ExportClip_Request\x1a).steam.CGameRecording_ExportClip_Response\x12v\n" +
	"\x11ExportClipPreview\x12/.steam.CGameRecording_ExportClipPreview_Request\x1a0.steam.CGameRecording_ExportClipPreview_Response\x12m\n" +
	"\x0eTakeScreenshot\x12,.steam.CGameRecording_TakeScreenshot_Request\x1a-.steam.CGameRecording_TakeScreenshot_Response\x12X\n" +
	"\aZipClip\x12%.steam.CGameRecording_ZipClip_Request\x1a&.steam.CGameRecording_ZipClip_Response\x12m\n" +
	"\x0eStartRecording\x12,.steam.CGameRecording_StartRecording_Request\x1a-.steam.CGameRecording_StartRecording_Response\x12j\n" +
	"\rStopRecording\x12+.steam.CGameRecording_StopRecording_Request\x1a,.steam.CGameRecording_StopRecording_Response\x12\x81\x01\n" +
	"\x1eGetBackgroundRecordingFileSize\x12..steam.CGameRecording_GetRecordingSize_Request\x1a/.steam.CGameRecording_GetRecordingSize_Response\x12\x94\x01\n" +
	"\x1bCleanupBackgroundRecordings\x129.steam.CGameRecording_CleanupBackgroundRecordings_Request\x1a:.steam.CGameRecording_CleanupBackgroundRecordings_Response\x12\x97\x01\n" +
	"\x1cGetAndTrimPostGameHighlights\x12:.steam.CGameRecording_GetAndTrimPostGameHighlights_Request\x1a;.steam.CGameRecording_GetAndTrimPostGameHighlights_Response\x12j\n" +
	"\rGetThumbnails\x12+.steam.CGameRecording_GetThumbnails_Request\x1a,.steam.CGameRecording_GetThumbnails_Response\x12\x88\x01\n" +
	"\x17GetPlatformCapabilities\x125.steam.CGameRecording_GetPlatformCapabilities_Request\x1a6.steam.CGameRecording_GetPlatformCapabilities_Response\x12c\n" +
	"\x15NotifyTimelineChanged\x122.steam.CGameRecording_TimelineChanged_Notification\x1a\x16.steam.WebUINoResponse\x12s\n" +
	"\x1dNotifyRecordingSessionChanged\x12:.steam.CGameRecording_RecordingSessionChanged_Notification\x1a\x16.steam.WebUINoResponse\x12m\n" +
	"\x1aNotifyTimelineEntryChanged\x127.steam.CGameRecording_TimelineEntryChanged_Notification\x1a\x16.steam.WebUINoResponse\x12m\n" +
	"\x1aNotifyTimelineEntryRemoved\x127.steam.CGameRecording_TimelineEntryRemoved_Notification\x1a\x16.steam.WebUINoResponse\x12[\n" +
	"\x11NotifyClipCreated\x12..steam.CGameRecording_ClipCreated_Notification\x1a\x16.steam.WebUINoResponse\x12[\n" +
	"\x11NotifyClipDeleted\x12..steam.CGameRecording_ClipDeleted_Notification\x1a\x16.steam.WebUINoResponse\x12a\n" +
	"\x14NotifyExportProgress\x121.steam.CGameRecording_ExportProgress_Notification\x1a\x16.steam.WebUINoResponse\x12a\n" +
	"\x14NotifyUploadProgress\x121.steam.CGameRecording_UploadProgress_Notification\x1a\x16.steam.WebUINoResponse\x12]\n" +
	"\x12NotifyLowDiskSpace\x12/.steam.CGameRecording_LowDiskSpace_Notification\x1a\x16.steam.WebUINoResponse\x12w\n" +
	"\x1fNotifyPostGameHighlightsChanged\x12<.steam.CGameRecording_PostGameHighlightsChanged_Notification\x1a\x16.steam.WebUINoResponse\x12q\n" +
	"\x1cNotifyOpenOverlayToGamePhase\x129.steam.CGameRecording_OpenOverlayToGamePhase_Notification\x1a\x16.steam.WebUINoResponse\x12y\n" +
	" NotifyOpenOverlayToTimelineEvent\x12=.steam.CGameRecording_OpenOverlayToTimelineEvent_Notification\x1a\x16.steam.WebUINoResponse\x12e\n" +
	"\x16NotifyPhaseListChanged\x123.steam.CGameRecording_PhaseListChanged_Notification\x1a\x16.steam.WebUINoResponse\x12y\n" +
	"\x12GetPerGameSettings\x120.steam.CGameRecording_GetPerGameSettings_Request\x1a1.steam.CGameRecording_GetPerGameSettings_Response\x12y\n" +
	"\x12SetPerGameSettings\x120.steam.CGameRecording_SetPerGameSettings_Request\x1a1.steam.CGameRecording_SetPerGameSettings_Response\x12\x82\x01\n" +
	"\x15DeletePerGameSettings\x123.steam.CGameRecording_DeletePerGameSettings_Request\x1a4.steam.CGameRecording_DeletePerGameSettings_Response\x12\x7f\n" +
	"\x14UserAddTimelineEntry\x122.steam.CGameRecording_UserAddTimelineEntry_Request\x1a3.steam.CGameRecording_UserAddTimelineEntry_Response\x12\x88\x01\n" +
	"\x17UserUpdateTimelineEntry\x125.steam.CGameRecording_UserUpdateTimelineEntry_Request\x1a6.steam.CGameRecording_UserUpdateTimelineEntry_Response\x12\x88\x01\n" +
	"\x17UserRemoveTimelineEntry\x125.steam.CGameRecording_UserRemoveTimelineEntry_Request\x1a6.steam.CGameRecording_UserRemoveTimelineEntry_Response\x12\xa0\x01\n" +
	"\x1fManuallyDeleteRecordingsForApps\x12=.steam.CGameRecording_ManuallyDeleteRecordingsForApps_Request\x1a>.steam.CGameRecording_ManuallyDeleteRecordingsForApps_Response\x12\x85\x01\n" +
	"\x16GetTotalDiskSpaceUsage\x124.steam.CGameRecording_GetTotalDiskSpaceUsage_Request\x1a5.steam.CGameRecording_GetTotalDiskSpaceUsage_Response\x12\x9a\x01\n" +
	"\x1dSwitchBackgroundRecordingGame\x12;.steam.CGameRecording_SwitchBackgroundRecordingGame_Request\x1a<.steam.CGameRecording_SwitchBackgroundRecordingGame_Response\x1a\x04\x80\x97\"\x01B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_webuimessages_gamerecording_proto_goTypes = []any{
	(ETimelineEntryType)(0),                                               // 0: steam.ETimelineEntryType
	(EPhaseResultType)(0),                                                 // 1: steam.EPhaseResultType
	(ETimelineChangeNotificationType)(0),                                  // 2: steam.ETimelineChangeNotificationType
	(ERecordingSessionChangeNotificationType)(0),                          // 3: steam.ERecordingSessionChangeNotificationType
	(EDiskSpaceType)(0),                                                   // 4: steam.EDiskSpaceType
	(EThumbnailTimePrecision)(0),                                          // 5: steam.EThumbnailTimePrecision
	(EThumbnailFormat)(0),                                                 // 6: steam.EThumbnailFormat
	(*CGameRecording_GetAppsWithBackgroundVideo_Request)(nil),             // 7: steam.CGameRecording_GetAppsWithBackgroundVideo_Request
	(*CGameRecording_GetAppsWithBackgroundVideo_Response)(nil),            // 8: steam.CGameRecording_GetAppsWithBackgroundVideo_Response
	(*CGameRecording_GetTimelinesForApp_Request)(nil),                     // 9: steam.CGameRecording_GetTimelinesForApp_Request
	(*CGameRecording_GetTimelinesForApp_Response)(nil),                    // 10: steam.CGameRecording_GetTimelinesForApp_Response
	(*CGameRecording_GetTimelinesForClip_Request)(nil),                    // 11: steam.CGameRecording_GetTimelinesForClip_Request
	(*CGameRecording_GetTimelinesForClip_Response)(nil),                   // 12: steam.CGameRecording_GetTimelinesForClip_Response
	(*CGameRecording_QueryPhases_Request)(nil),                            // 13: steam.CGameRecording_QueryPhases_Request
	(*CGameRecording_QueryPhases_Response)(nil),                           // 14: steam.CGameRecording_QueryPhases_Response
	(*CGameRecording_GetTags_Request)(nil),                                // 15: steam.CGameRecording_GetTags_Request
	(*CGameRecording_GetTags_Response)(nil),                               // 16: steam.CGameRecording_GetTags_Response
	(*CGameRecording_GetEnoughDiskSpace_Request)(nil),                     // 17: steam.CGameRecording_GetEnoughDiskSpace_Request
	(*CGameRecording_GetEnoughDiskSpace_Response)(nil),                    // 18: steam.CGameRecording_GetEnoughDiskSpace_Response
	(*CGameRecording_GetAvailableDiskSpace_Request)(nil),                  // 19: steam.CGameRecording_GetAvailableDiskSpace_Request
	(*CGameRecording_GetAvailableDiskSpace_Response)(nil),                 // 20: steam.CGameRecording_GetAvailableDiskSpace_Response
	(*CGameRecording_TimelineChanged_Notification)(nil),                   // 21: steam.CGameRecording_TimelineChanged_Notification
	(*CGameRecording_RecordingSessionChanged_Notification)(nil),           // 22: steam.CGameRecording_RecordingSessionChanged_Notification
	(*CTimelineEntry)(nil),                                                // 23: steam.CTimelineEntry
	(*CGameRecording_TimelineEntryChanged_Notification)(nil),              // 24: steam.CGameRecording_TimelineEntryChanged_Notification
	(*CGameRecording_TimelineEntryRemoved_Notification)(nil),              // 25: steam.CGameRecording_TimelineEntryRemoved_Notification
	(*CGameRecording_LowDiskSpace_Notification)(nil),                      // 26: steam.CGameRecording_LowDiskSpace_Notification
	(*CGameRecording_PostGameHighlightsChanged_Notification)(nil),         // 27: steam.CGameRecording_PostGameHighlightsChanged_Notification
	(*CGameRecording_OpenOverlayToGamePhase_Notification)(nil),            // 28: steam.CGameRecording_OpenOverlayToGamePhase_Notification
	(*CGameRecording_OpenOverlayToTimelineEvent_Notification)(nil),        // 29: steam.CGameRecording_OpenOverlayToTimelineEvent_Notification
	(*CGameRecording_PhaseListChanged_Notification)(nil),                  // 30: steam.CGameRecording_PhaseListChanged_Notification
	(*CGameRecording_ClipSummary)(nil),                                    // 31: steam.CGameRecording_ClipSummary
	(*CGameRecording_SaveClip_Request)(nil),                               // 32: steam.CGameRecording_SaveClip_Request
	(*CGameRecording_SaveClip_Response)(nil),                              // 33: steam.CGameRecording_SaveClip_Response
	(*CGameRecording_DeleteClip_Request)(nil),                             // 34: steam.CGameRecording_DeleteClip_Request
	(*CGameRecording_DeleteClip_Response)(nil),                            // 35: steam.CGameRecording_DeleteClip_Response
	(*CGameRecording_ExportClip_Settings)(nil),                            // 36: steam.CGameRecording_ExportClip_Settings
	(*CGameRecording_ExportClip_Request)(nil),                             // 37: steam.CGameRecording_ExportClip_Request
	(*CGameRecording_ExportClip_Response)(nil),                            // 38: steam.CGameRecording_ExportClip_Response
	(*CGameRecording_ExportClipPreview_Request)(nil),                      // 39: steam.CGameRecording_ExportClipPreview_Request
	(*CGameRecording_ExportClipPreview_Response)(nil),                     // 40: steam.CGameRecording_ExportClipPreview_Response
	(*CGameRecording_TakeScreenshot_Request)(nil),                         // 41: steam.CGameRecording_TakeScreenshot_Request
	(*CGameRecording_TakeScreenshot_Response)(nil),                        // 42: steam.CGameRecording_TakeScreenshot_Response
	(*CGameRecording_UploadClipToSteam_Request)(nil),                      // 43: steam.CGameRecording_UploadClipToSteam_Request
	(*CGameRecording_UploadClipToSteam_Response)(nil),                     // 44: steam.CGameRecording_UploadClipToSteam_Response
	(*CGameRecording_ZipClip_Request)(nil),                                // 45: steam.CGameRecording_ZipClip_Request
	(*CGameRecording_ZipClip_Response)(nil),                               // 46: steam.CGameRecording_ZipClip_Response
	(*CGameRecording_GetClips_Request)(nil),                               // 47: steam.CGameRecording_GetClips_Request
	(*CGameRecording_GetClips_Response)(nil),                              // 48: steam.CGameRecording_GetClips_Response
	(*CGameRecording_GetAndTrimPostGameHighlights_Request)(nil),           // 49: steam.CGameRecording_GetAndTrimPostGameHighlights_Request
	(*CGameRecording_GetAndTrimPostGameHighlights_Response)(nil),          // 50: steam.CGameRecording_GetAndTrimPostGameHighlights_Response
	(*CGameRecording_UserAddTimelineEntry_Request)(nil),                   // 51: steam.CGameRecording_UserAddTimelineEntry_Request
	(*CGameRecording_UserAddTimelineEntry_Response)(nil),                  // 52: steam.CGameRecording_UserAddTimelineEntry_Response
	(*CGameRecording_UserUpdateTimelineEntry_Request)(nil),                // 53: steam.CGameRecording_UserUpdateTimelineEntry_Request
	(*CGameRecording_UserUpdateTimelineEntry_Response)(nil),               // 54: steam.CGameRecording_UserUpdateTimelineEntry_Response
	(*CGameRecording_UserRemoveTimelineEntry_Request)(nil),                // 55: steam.CGameRecording_UserRemoveTimelineEntry_Request
	(*CGameRecording_UserRemoveTimelineEntry_Response)(nil),               // 56: steam.CGameRecording_UserRemoveTimelineEntry_Response
	(*CGameRecording_ManuallyDeleteRecordingsForApps_Request)(nil),        // 57: steam.CGameRecording_ManuallyDeleteRecordingsForApps_Request
	(*CGameRecording_ManuallyDeleteRecordingsForApps_Response)(nil),       // 58: steam.CGameRecording_ManuallyDeleteRecordingsForApps_Response
	(*CGameRecording_GetTotalDiskSpaceUsage_Request)(nil),                 // 59: steam.CGameRecording_GetTotalDiskSpaceUsage_Request
	(*CGameRecording_GetTotalDiskSpaceUsage_Response)(nil),                // 60: steam.CGameRecording_GetTotalDiskSpaceUsage_Response
	(*CGameRecording_GetThumbnails_Request)(nil),                          // 61: steam.CGameRecording_GetThumbnails_Request
	(*CGameRecording_GetThumbnails_Response)(nil),                         // 62: steam.CGameRecording_GetThumbnails_Response
	(*CGameRecording_StartRecording_Request)(nil),                         // 63: steam.CGameRecording_StartRecording_Request
	(*CGameRecording_StartRecording_Response)(nil),                        // 64: steam.CGameRecording_StartRecording_Response
	(*CGameRecording_StopRecording_Request)(nil),                          // 65: steam.CGameRecording_StopRecording_Request
	(*CGameRecording_StopRecording_Response)(nil),                         // 66: steam.CGameRecording_StopRecording_Response
	(*CGameRecording_GetRecordingSize_Request)(nil),                       // 67: steam.CGameRecording_GetRecordingSize_Request
	(*CGameRecording_GetRecordingSize_Response)(nil),                      // 68: steam.CGameRecording_GetRecordingSize_Response
	(*CGameRecording_CleanupBackgroundRecordings_Request)(nil),            // 69: steam.CGameRecording_CleanupBackgroundRecordings_Request
	(*CGameRecording_CleanupBackgroundRecordings_Response)(nil),           // 70: steam.CGameRecording_CleanupBackgroundRecordings_Response
	(*CGameRecording_GetPlatformCapabilities_Request)(nil),                // 71: steam.CGameRecording_GetPlatformCapabilities_Request
	(*CGameRecording_GetPlatformCapabilities_Response)(nil),               // 72: steam.CGameRecording_GetPlatformCapabilities_Response
	(*CGameRecording_ClipCreated_Notification)(nil),                       // 73: steam.CGameRecording_ClipCreated_Notification
	(*CGameRecording_ClipDeleted_Notification)(nil),                       // 74: steam.CGameRecording_ClipDeleted_Notification
	(*CGameRecording_ExportProgress_Notification)(nil),                    // 75: steam.CGameRecording_ExportProgress_Notification
	(*CGameRecording_PerGameSettings)(nil),                                // 76: steam.CGameRecording_PerGameSettings
	(*CGameRecording_GetPerGameSettings_Request)(nil),                     // 77: steam.CGameRecording_GetPerGameSettings_Request
	(*CGameRecording_GetPerGameSettings_Response)(nil),                    // 78: steam.CGameRecording_GetPerGameSettings_Response
	(*CGameRecording_SetPerGameSettings_Request)(nil),                     // 79: steam.CGameRecording_SetPerGameSettings_Request
	(*CGameRecording_SetPerGameSettings_Response)(nil),                    // 80: steam.CGameRecording_SetPerGameSettings_Response
	(*CGameRecording_DeletePerGameSettings_Request)(nil),                  // 81: steam.CGameRecording_DeletePerGameSettings_Request
	(*CGameRecording_DeletePerGameSettings_Response)(nil),                 // 82: steam.CGameRecording_DeletePerGameSettings_Response
	(*CGameRecording_UploadProgress_Notification)(nil),                    // 83: steam.CGameRecording_UploadProgress_Notification
	(*CGameRecording_SwitchBackgroundRecordingGame_Request)(nil),          // 84: steam.CGameRecording_SwitchBackgroundRecordingGame_Request
	(*CGameRecording_SwitchBackgroundRecordingGame_Response)(nil),         // 85: steam.CGameRecording_SwitchBackgroundRecordingGame_Response
	(*CGameRecording_GetAppsWithBackgroundVideo_Response_App)(nil),        // 86: steam.CGameRecording_GetAppsWithBackgroundVideo_Response.App
	(*CGameRecording_QueryPhases_Request_Tag)(nil),                        // 87: steam.CGameRecording_QueryPhases_Request.Tag
	(*CGameRecording_QueryPhases_Response_Phase)(nil),                     // 88: steam.CGameRecording_QueryPhases_Response.Phase
	(*CGameRecording_QueryPhases_Response_Phase_BackgroundRecording)(nil), // 89: steam.CGameRecording_QueryPhases_Response.Phase.BackgroundRecording
	(*CGameRecording_SaveClip_Request_Position)(nil),                      // 90: steam.CGameRecording_SaveClip_Request.Position
	(*CGameRecording_GetThumbnails_Response_Thumbnail)(nil),               // 91: steam.CGameRecording_GetThumbnails_Response.Thumbnail
	(*CGameRecordingTimelineMetadata)(nil),                                // 92: steam.CGameRecordingTimelineMetadata
	(*CTimelineTag)(nil),                                                  // 93: steam.CTimelineTag
	(EGameRecordingType)(0),                                               // 94: steam.EGameRecordingType
	(*CPhaseAttribute)(nil),                                               // 95: steam.CPhaseAttribute
	(EExportCodec)(0),                                                     // 96: steam.EExportCodec
	(*CGameRecordingTimelineEvent)(nil),                                   // 97: steam.CGameRecordingTimelineEvent
	(*WebUINoResponse)(nil),                                               // 98: steam.WebUINoResponse
}
var file_webuimessages_gamerecording_proto_depIdxs = []int32{
	86, // 0: steam.CGameRecording_GetAppsWithBackgroundVideo_Response.apps:type_name -> steam.CGameRecording_GetAppsWithBackgroundVideo_Response.App
	92, // 1: steam.CGameRecording_GetTimelinesForApp_Response.timelines:type_name -> steam.CGameRecordingTimelineMetadata
	92, // 2: steam.CGameRecording_GetTimelinesForClip_Response.timelines:type_name -> steam.CGameRecordingTimelineMetadata
	87, // 3: steam.CGameRecording_QueryPhases_Request.filter_tags:type_name -> steam.CGameRecording_QueryPhases_Request.Tag
	88, // 4: steam.CGameRecording_QueryPhases_Response.phases:type_name -> steam.CGameRecording_QueryPhases_Response.Phase
	93, // 5: steam.CGameRecording_GetTags_Response.tags:type_name -> steam.CTimelineTag
	2,  // 6: steam.CGameRecording_TimelineChanged_Notification.notification_type:type_name -> steam.ETimelineChangeNotificationType
	3,  // 7: steam.CGameRecording_RecordingSessionChanged_Notification.notification_type:type_name -> steam.ERecordingSessionChangeNotificationType
	94, // 8: steam.CGameRecording_RecordingSessionChanged_Notification.recording_type:type_name -> steam.EGameRecordingType
	0,  // 9: steam.CTimelineEntry.type:type_name -> steam.ETimelineEntryType
	93, // 10: steam.CTimelineEntry.tag:type_name -> steam.CTimelineTag
	95, // 11: steam.CTimelineEntry.attributes:type_name -> steam.CPhaseAttribute
	23, // 12: steam.CGameRecording_TimelineEntryChanged_Notification.entry:type_name -> steam.CTimelineEntry
	90, // 13: steam.CGameRecording_SaveClip_Request.start:type_name -> steam.CGameRecording_SaveClip_Request.Position
	90, // 14: steam.CGameRecording_SaveClip_Request.end:type_name -> steam.CGameRecording_SaveClip_Request.Position
	31, // 15: steam.CGameRecording_SaveClip_Response.summary:type_name -> steam.CGameRecording_ClipSummary
	96, // 16: steam.CGameRecording_ExportClip_Settings.codec:type_name -> steam.EExportCodec
	36, // 17: steam.CGameRecording_ExportClip_Request.settings:type_name -> steam.CGameRecording_ExportClip_Settings
	36, // 18: steam.CGameRecording_ExportClipPreview_Request.settings:type_name -> steam.CGameRecording_ExportClip_Settings
	36, // 19: steam.CGameRecording_ExportClipPreview_Response.settings:type_name -> steam.CGameRecording_ExportClip_Settings
	31, // 20: steam.CGameRecording_UploadClipToSteam_Response.summary:type_name -> steam.CGameRecording_ClipSummary
	31, // 21: steam.CGameRecording_GetClips_Response.clip:type_name -> steam.CGameRecording_ClipSummary
	97, // 22: steam.CGameRecording_GetAndTrimPostGameHighlights_Response.events:type_name -> steam.CGameRecordingTimelineEvent
	23, // 23: steam.CGameRecording_UserAddTimelineEntry_Request.entry:type_name -> steam.CTimelineEntry
	23, // 24: steam.CGameRecording_UserUpdateTimelineEntry_Request.entry:type_name -> steam.CTimelineEntry
	4,  // 25: steam.CGameRecording_GetTotalDiskSpaceUsage_Request.type:type_name -> steam.EDiskSpaceType
	5,  // 26: steam.CGameRecording_GetThumbnails_Request.time_precision:type_name -> steam.EThumbnailTimePrecision
	6,  // 27: steam.CGameRecording_GetThumbnails_Request.format:type_name -> steam.EThumbnailFormat
	91, // 28: steam.CGameRecording_GetThumbnails_Response.thumbnails:type_name -> steam.CGameRecording_GetThumbnails_Response.Thumbnail
	31, // 29: steam.CGameRecording_StopRecording_Response.summary:type_name -> steam.CGameRecording_ClipSummary
	31, // 30: steam.CGameRecording_ClipCreated_Notification.summary:type_name -> steam.CGameRecording_ClipSummary
	76, // 31: steam.CGameRecording_GetPerGameSettings_Response.settings:type_name -> steam.CGameRecording_PerGameSettings
	76, // 32: steam.CGameRecording_SetPerGameSettings_Request.game_settings:type_name -> steam.CGameRecording_PerGameSettings
	94, // 33: steam.CGameRecording_GetAppsWithBackgroundVideo_Response.App.recording_type:type_name -> steam.EGameRecordingType
	93, // 34: steam.CGameRecording_QueryPhases_Response.Phase.tags:type_name -> steam.CTimelineTag
	93, // 35: steam.CGameRecording_QueryPhases_Response.Phase.contained_tags:type_name -> steam.CTimelineTag
	89, // 36: steam.CGameRecording_QueryPhases_Response.Phase.background_recording:type_name -> steam.CGameRecording_QueryPhases_Response.Phase.BackgroundRecording
	1,  // 37: steam.CGameRecording_QueryPhases_Response.Phase.type:type_name -> steam.EPhaseResultType
	23, // 38: steam.CGameRecording_QueryPhases_Response.Phase.significant_events:type_name -> steam.CTimelineEntry
	95, // 39: steam.CGameRecording_QueryPhases_Response.Phase.attributes:type_name -> steam.CPhaseAttribute
	7,  // 40: steam.GameRecording.GetAppsWithBackgroundVideo:input_type -> steam.CGameRecording_GetAppsWithBackgroundVideo_Request
	9,  // 41: steam.GameRecording.GetTimelinesForApp:input_type -> steam.CGameRecording_GetTimelinesForApp_Request
	11, // 42: steam.GameRecording.GetTimelinesForClip:input_type -> steam.CGameRecording_GetTimelinesForClip_Request
	13, // 43: steam.GameRecording.QueryPhases:input_type -> steam.CGameRecording_QueryPhases_Request
	15, // 44: steam.GameRecording.GetTags:input_type -> steam.CGameRecording_GetTags_Request
	17, // 45: steam.GameRecording.GetEnoughDiskSpace:input_type -> steam.CGameRecording_GetEnoughDiskSpace_Request
	19, // 46: steam.GameRecording.GetAvailableDiskSpace:input_type -> steam.CGameRecording_GetAvailableDiskSpace_Request
	32, // 47: steam.GameRecording.SaveClip:input_type -> steam.CGameRecording_SaveClip_Request
	34, // 48: steam.GameRecording.DeleteClip:input_type -> steam.CGameRecording_DeleteClip_Request
	47, // 49: steam.GameRecording.GetClips:input_type -> steam.CGameRecording_GetClips_Request
	43, // 50: steam.GameRecording.UploadClipToSteam:input_type -> steam.CGameRecording_UploadClipToSteam_Request
	37, // 51: steam.GameRecording.ExportClip:input_type -> steam.CGameRecording_ExportClip_Request
	39, // 52: steam.GameRecording.ExportClipPreview:input_type -> steam.CGameRecording_ExportClipPreview_Request
	41, // 53: steam.GameRecording.TakeScreenshot:input_type -> steam.CGameRecording_TakeScreenshot_Request
	45, // 54: steam.GameRecording.ZipClip:input_type -> steam.CGameRecording_ZipClip_Request
	63, // 55: steam.GameRecording.StartRecording:input_type -> steam.CGameRecording_StartRecording_Request
	65, // 56: steam.GameRecording.StopRecording:input_type -> steam.CGameRecording_StopRecording_Request
	67, // 57: steam.GameRecording.GetBackgroundRecordingFileSize:input_type -> steam.CGameRecording_GetRecordingSize_Request
	69, // 58: steam.GameRecording.CleanupBackgroundRecordings:input_type -> steam.CGameRecording_CleanupBackgroundRecordings_Request
	49, // 59: steam.GameRecording.GetAndTrimPostGameHighlights:input_type -> steam.CGameRecording_GetAndTrimPostGameHighlights_Request
	61, // 60: steam.GameRecording.GetThumbnails:input_type -> steam.CGameRecording_GetThumbnails_Request
	71, // 61: steam.GameRecording.GetPlatformCapabilities:input_type -> steam.CGameRecording_GetPlatformCapabilities_Request
	21, // 62: steam.GameRecording.NotifyTimelineChanged:input_type -> steam.CGameRecording_TimelineChanged_Notification
	22, // 63: steam.GameRecording.NotifyRecordingSessionChanged:input_type -> steam.CGameRecording_RecordingSessionChanged_Notification
	24, // 64: steam.GameRecording.NotifyTimelineEntryChanged:input_type -> steam.CGameRecording_TimelineEntryChanged_Notification
	25, // 65: steam.GameRecording.NotifyTimelineEntryRemoved:input_type -> steam.CGameRecording_TimelineEntryRemoved_Notification
	73, // 66: steam.GameRecording.NotifyClipCreated:input_type -> steam.CGameRecording_ClipCreated_Notification
	74, // 67: steam.GameRecording.NotifyClipDeleted:input_type -> steam.CGameRecording_ClipDeleted_Notification
	75, // 68: steam.GameRecording.NotifyExportProgress:input_type -> steam.CGameRecording_ExportProgress_Notification
	83, // 69: steam.GameRecording.NotifyUploadProgress:input_type -> steam.CGameRecording_UploadProgress_Notification
	26, // 70: steam.GameRecording.NotifyLowDiskSpace:input_type -> steam.CGameRecording_LowDiskSpace_Notification
	27, // 71: steam.GameRecording.NotifyPostGameHighlightsChanged:input_type -> steam.CGameRecording_PostGameHighlightsChanged_Notification
	28, // 72: steam.GameRecording.NotifyOpenOverlayToGamePhase:input_type -> steam.CGameRecording_OpenOverlayToGamePhase_Notification
	29, // 73: steam.GameRecording.NotifyOpenOverlayToTimelineEvent:input_type -> steam.CGameRecording_OpenOverlayToTimelineEvent_Notification
	30, // 74: steam.GameRecording.NotifyPhaseListChanged:input_type -> steam.CGameRecording_PhaseListChanged_Notification
	77, // 75: steam.GameRecording.GetPerGameSettings:input_type -> steam.CGameRecording_GetPerGameSettings_Request
	79, // 76: steam.GameRecording.SetPerGameSettings:input_type -> steam.CGameRecording_SetPerGameSettings_Request
	81, // 77: steam.GameRecording.DeletePerGameSettings:input_type -> steam.CGameRecording_DeletePerGameSettings_Request
	51, // 78: steam.GameRecording.UserAddTimelineEntry:input_type -> steam.CGameRecording_UserAddTimelineEntry_Request
	53, // 79: steam.GameRecording.UserUpdateTimelineEntry:input_type -> steam.CGameRecording_UserUpdateTimelineEntry_Request
	55, // 80: steam.GameRecording.UserRemoveTimelineEntry:input_type -> steam.CGameRecording_UserRemoveTimelineEntry_Request
	57, // 81: steam.GameRecording.ManuallyDeleteRecordingsForApps:input_type -> steam.CGameRecording_ManuallyDeleteRecordingsForApps_Request
	59, // 82: steam.GameRecording.GetTotalDiskSpaceUsage:input_type -> steam.CGameRecording_GetTotalDiskSpaceUsage_Request
	84, // 83: steam.GameRecording.SwitchBackgroundRecordingGame:input_type -> steam.CGameRecording_SwitchBackgroundRecordingGame_Request
	8,  // 84: steam.GameRecording.GetAppsWithBackgroundVideo:output_type -> steam.CGameRecording_GetAppsWithBackgroundVideo_Response
	10, // 85: steam.GameRecording.GetTimelinesForApp:output_type -> steam.CGameRecording_GetTimelinesForApp_Response
	12, // 86: steam.GameRecording.GetTimelinesForClip:output_type -> steam.CGameRecording_GetTimelinesForClip_Response
	14, // 87: steam.GameRecording.QueryPhases:output_type -> steam.CGameRecording_QueryPhases_Response
	16, // 88: steam.GameRecording.GetTags:output_type -> steam.CGameRecording_GetTags_Response
	18, // 89: steam.GameRecording.GetEnoughDiskSpace:output_type -> steam.CGameRecording_GetEnoughDiskSpace_Response
	20, // 90: steam.GameRecording.GetAvailableDiskSpace:output_type -> steam.CGameRecording_GetAvailableDiskSpace_Response
	33, // 91: steam.GameRecording.SaveClip:output_type -> steam.CGameRecording_SaveClip_Response
	35, // 92: steam.GameRecording.DeleteClip:output_type -> steam.CGameRecording_DeleteClip_Response
	48, // 93: steam.GameRecording.GetClips:output_type -> steam.CGameRecording_GetClips_Response
	44, // 94: steam.GameRecording.UploadClipToSteam:output_type -> steam.CGameRecording_UploadClipToSteam_Response
	38, // 95: steam.GameRecording.ExportClip:output_type -> steam.CGameRecording_ExportClip_Response
	40, // 96: steam.GameRecording.ExportClipPreview:output_type -> steam.CGameRecording_ExportClipPreview_Response
	42, // 97: steam.GameRecording.TakeScreenshot:output_type -> steam.CGameRecording_TakeScreenshot_Response
	46, // 98: steam.GameRecording.ZipClip:output_type -> steam.CGameRecording_ZipClip_Response
	64, // 99: steam.GameRecording.StartRecording:output_type -> steam.CGameRecording_StartRecording_Response
	66, // 100: steam.GameRecording.StopRecording:output_type -> steam.CGameRecording_StopRecording_Response
	68, // 101: steam.GameRecording.GetBackgroundRecordingFileSize:output_type -> steam.CGameRecording_GetRecordingSize_Response
	70, // 102: steam.GameRecording.CleanupBackgroundRecordings:output_type -> steam.CGameRecording_CleanupBackgroundRecordings_Response
	50, // 103: steam.GameRecording.GetAndTrimPostGameHighlights:output_type -> steam.CGameRecording_GetAndTrimPostGameHighlights_Response
	62, // 104: steam.GameRecording.GetThumbnails:output_type -> steam.CGameRecording_GetThumbnails_Response
	72, // 105: steam.GameRecording.GetPlatformCapabilities:output_type -> steam.CGameRecording_GetPlatformCapabilities_Response
	98, // 106: steam.GameRecording.NotifyTimelineChanged:output_type -> steam.WebUINoResponse
	98, // 107: steam.GameRecording.NotifyRecordingSessionChanged:output_type -> steam.WebUINoResponse
	98, // 108: steam.GameRecording.NotifyTimelineEntryChanged:output_type -> steam.WebUINoResponse
	98, // 109: steam.GameRecording.NotifyTimelineEntryRemoved:output_type -> steam.WebUINoResponse
	98, // 110: steam.GameRecording.NotifyClipCreated:output_type -> steam.WebUINoResponse
	98, // 111: steam.GameRecording.NotifyClipDeleted:output_type -> steam.WebUINoResponse
	98, // 112: steam.GameRecording.NotifyExportProgress:output_type -> steam.WebUINoResponse
	98, // 113: steam.GameRecording.NotifyUploadProgress:output_type -> steam.WebUINoResponse
	98, // 114: steam.GameRecording.NotifyLowDiskSpace:output_type -> steam.WebUINoResponse
	98, // 115: steam.GameRecording.NotifyPostGameHighlightsChanged:output_type -> steam.WebUINoResponse
	98, // 116: steam.GameRecording.NotifyOpenOverlayToGamePhase:output_type -> steam.WebUINoResponse
	98, // 117: steam.GameRecording.NotifyOpenOverlayToTimelineEvent:output_type -> steam.WebUINoResponse
	98, // 118: steam.GameRecording.NotifyPhaseListChanged:output_type -> steam.WebUINoResponse
	78, // 119: steam.GameRecording.GetPerGameSettings:output_type -> steam.CGameRecording_GetPerGameSettings_Response
	80, // 120: steam.GameRecording.SetPerGameSettings:output_type -> steam.CGameRecording_SetPerGameSettings_Response
	82, // 121: steam.GameRecording.DeletePerGameSettings:output_type -> steam.CGameRecording_DeletePerGameSettings_Response
	52, // 122: steam.GameRecording.UserAddTimelineEntry:output_type -> steam.CGameRecording_UserAddTimelineEntry_Response
	54, // 123: steam.GameRecording.UserUpdateTimelineEntry:output_type -> steam.CGameRecording_UserUpdateTimelineEntry_Response
	56, // 124: steam.GameRecording.UserRemoveTimelineEntry:output_type -> steam.CGameRecording_UserRemoveTimelineEntry_Response
	58, // 125: steam.GameRecording.ManuallyDeleteRecordingsForApps:output_type -> steam.CGameRecording_ManuallyDeleteRecordingsForApps_Response
	60, // 126: steam.GameRecording.GetTotalDiskSpaceUsage:output_type -> steam.CGameRecording_GetTotalDiskSpaceUsage_Response
	85, // 127: steam.GameRecording.SwitchBackgroundRecordingGame:output_type -> steam.CGameRecording_SwitchBackgroundRecordingGame_Response
