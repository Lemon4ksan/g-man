...
type CSteamTV_SetBroadcastChannelImage_Request struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	BroadcastChannelId *uint64                `protobuf:"fixed64,1,opt,name=broadcast_channel_id,json=broadcastChannelId" json:"broadcast_channel_id,omitempty"`
	ImageType          *EBroadcastImageType   `protobuf:"varint,2,opt,name=image_type,json=imageType,enum=steam.EBroadcastImageType,def=0" json:"image_type,omitempty"`
...
type CSteamTV_GetBroadcastChannelImages_Request struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	BroadcastChannelId *uint64                `protobuf:"fixed64,1,opt,name=broadcast_channel_id,json=broadcastChannelId" json:"broadcast_channel_id,omitempty"`
	ImageTypes         []EBroadcastImageType  `protobuf:"varint,2,rep,name=image_types,json=imageTypes,enum=steam.EBroadcastImageType" json:"image_types,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type CSteamTV_GetGames_Request struct {
	...
	Algorithm     *EGetGamesAlgorithm    `protobuf:"varint,2,opt,name=algorithm,enum=steam.EGetGamesAlgorithm,def=1" json:"algorithm,omitempty"`
...
type CSteamTV_GetChannels_Request struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Algorithm     *EGetChannelsAlgorithm `protobuf:"varint,1,opt,name=algorithm,enum=steam.EGetChannelsAlgorithm,def=1" json:"algorithm,omitempty"`
...
type CSteamTV_HomePageContentRow struct {
	state         protoimpl.MessageState                  `protogen:"open.v1"`
	TemplateType  *ESteamTVContentTemplate                `protobuf:"varint,1,opt,name=template_type,json=templateType,enum=steam.ESteamTVContentTemplate,def=0" json:"template_type,omitempty"`
...
type CSteamTV_GetBroadcastChannelImages_Response_Images struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ImageType     *EBroadcastImageType   `protobuf:"varint,1,opt,name=image_type,json=imageType,enum=steam.EBroadcastImageType,def=0" json:"image_type,omitempty"`
...
const file_steammessages_steamtv_steamclient_proto_rawDesc = "" +
	"\n" +
	"'steammessages_steamtv.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"J\n" +
	...
	"\fis_partnered\x18\n" +
	" \x01(\bR\visPartnered\"\x8e\x03\n" +
	")CSteamTV_SetBroadcastChannelImage_Request\x120\n" +
	"\x14broadcast_channel_id\x18\x01 \x01(\x06R\x12broadcastChannelId\x12U\n" +
	"\n" +
	"image_type\x18\x02 \x01(\x0e2\x1a.steam.EBroadcastImageType:\x1ak_EBroadcastImageType_NoneR\timageType\x12\x1f\n" +
	...
	"\x12replace_image_hash\x18\x01 \x01(\tR\x10replaceImageHash\"\x9b\x01\n" +
	"*CSteamTV_GetBroadcastChannelImages_Request\x120\n" +
	"\x14broadcast_channel_id\x18\x01 \x01(\x06R\x12broadcastChannelId\x12;\n" +
	"\vimage_types\x18\x02 \x03(\x0e2\x1a.steam.EBroadcastImageTypeR\n" +
	"imageTypes\"\xa2\x02\n" +
	"+CSteamTV_GetBroadcastChannelImages_Response\x12Q\n" +
	"\x06images\x18\x01 \x03(\v29.steam.CSteamTV_GetBroadcastChannelImages_Response.ImagesR\x06images\x1a\x9f\x01\n" +
	"\x06Images\x12U\n" +
	"\n" +
	"image_type\x18\x01 \x01(\x0e2\x1a.steam.EBroadcastImageType:\x1ak_EBroadcastImageType_NoneR\timageType\x12\x1d\n" +
	"\n" +
	"image_path\x18\x02 \x01(\tR\timagePath\x12\x1f\n" +
	"\vimage_index\x18\x03 \x01(\rR\n" +
	"imageIndex\"\xf1\x02\n" +
	"/CSteamTV_SetBroadcastChannelLinkRegions_Request\x120\n" +
	"\x14broadcast_channel_id\x18\x01 \x01(\x06R\x12broadcastChannelId\x12R\n" +
	"\x05links\x18\x02 \x03(\v2<.steam.CSteamTV_SetBroadcastChannelLinkRegions_Request.LinksR\x05links\x1a\xb7\x01\n" +
	"\x05Links\x12\x1d\n" +
	"\n" +
	...
	"\x14broadcast_channel_id\x18\x01 \x01(\x06R\x12broadcastChannelId\"\xb5\x02\n" +
	"*CSteamTV_GetBroadcastChannelLinks_Response\x12M\n" +
	"\x05links\x18\x01 \x03(\v27.steam.CSteamTV_GetBroadcastChannelLinks_Response.LinksR\x05links\x1a\xb7\x01\n" +
	"\x05Links\x12\x1d\n" +
	"\n" +
	"link_index\x18\x01 \x01(\rR\tlinkIndex\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x12)\n" +
	...
	"\x14broadcast_channel_id\x18\x01 \x01(\x06R\x12broadcastChannelId\"\xf9\x01\n" +
	"1CSteamTV_GetBroadcastChannelBroadcasters_Response\x12h\n" +
	"\fbroadcasters\x18\x01 \x03(\v2D.steam.CSteamTV_GetBroadcastChannelBroadcasters_Response.BroadcasterR\fbroadcasters\x1aZ\n" +
	...
	"\fis_partnered\x18\x13 \x01(\bR\visPartnered\"b\n" +
	"%CSteamTV_GetFollowedChannels_Response\x129\n" +
	"\aresults\x18\x01 \x03(\v2\x1f.steam.GetBroadcastChannelEntryR\aresults\"(\n" +
	"&CSteamTV_GetSubscribedChannels_Request\"d\n" +
	"'CSteamTV_GetSubscribedChannels_Response\x129\n" +
	"\aresults\x18\x01 \x03(\v2\x1f.steam.GetBroadcastChannelEntryR\aresults\"^\n" +
	...
	"\x0ethumbnail_path\x18\t \x01(\tR\rthumbnailPath\"\x8c\x01\n" +
	"*CSteamTV_GetBroadcastChannelClips_Response\x127\n" +
	"\x05clips\x18\x01 \x03(\v2!.steam.CSteamTV_BroadcastClipInfoR\x05clips\x12%\n" +
	...
	"\vis_followed\x18\x01 \x01(\bR\n" +
	"isFollowed\x12#\n" +
	"\ris_subscribed\x18\x02 \x01(\bR\fisSubscribed\"\x9e\x01\n" +
	"\x19CSteamTV_GetGames_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12U\n" +
	"\talgorithm\x18\x02 \x01(\x0e2\x19.steam.EGetGamesAlgorithm:\x1ck_EGetGamesAlgorithm_DefaultR\talgorithm\x12\x14\n" +
	"\x05count\x18\x03 \x01(\rR\x05count\"\x85\x02\n" +
	"\rCSteamTV_Game\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	"\x05image\x18\x03 \x01(\tR\x05image\x12\x18\n" +
	"\aviewers\x18\x04 \x01(\x04R\aviewers\x12;\n" +
	"\bchannels\x18\x05 \x03(\v2\x1f.steam.GetBroadcastChannelEntryR\bchannels\x12!\n" +
	"\frelease_date\x18\x06 \x01(\tR\vreleaseDate\x12\x1c\n" +
	"\tdeveloper\x18\a \x01(\tR\tdeveloper\x12\x1c\n" +
	"\tpublisher\x18\b \x01(\tR\tpublisher\"L\n" +
	"\x1aCSteamTV_GetGames_Response\x12.\n" +
	"\aresults\x18\x01 \x03(\v2\x14.steam.CSteamTV_GameR\aresults\"\xa7\x01\n" +
	"\x1cCSteamTV_GetChannels_Request\x12[\n" +
	"\talgorithm\x18\x01 \x01(\x0e2\x1c.steam.EGetChannelsAlgorithm:\x1fk_EGetChannelsAlgorithm_DefaultR\talgorithm\x12\x14\n" +
	"\x05count\x18\x02 \x01(\rR\x05count\x12\x14\n" +
	"\x05appid\x18\x03 \x01(\rR\x05appid\"Z\n" +
	"\x1dCSteamTV_GetChannels_Response\x129\n" +
	"\aresults\x18\x01 \x03(\v2\x1f.steam.GetBroadcastChannelEntryR\aresults\"\xc6\x01\n" +
	...
	"\x1dCSteamTV_GetChatBans_Response\x121\n" +
	"\aresults\x18\x01 \x03(\v2\x17.steam.CSteamTV_ChatBanR\aresults\"\x96\x01\n" +
	...
	"#CSteamTV_GetChatModerators_Response\x127\n" +
	"\aresults\x18\x01 \x03(\v2\x1d.steam.CSteamTV_ChatModeratorR\aresults\"w\n" +
	...
	"\x18CSteamTV_Search_Response\x129\n" +
	"\aresults\x18\x01 \x03(\v2\x1f.steam.GetBroadcastChannelEntryR\aresults\")\n" +
	...
	"'CSteamTV_GetMyBroadcastChannels_Request\"e\n" +
	"(CSteamTV_GetMyBroadcastChannels_Response\x129\n" +
	"\aresults\x18\x01 \x03(\v2\x1f.steam.GetBroadcastChannelEntryR\aresults\"&\n" +
	"$CSteamTV_GetHomePageContents_Request\"e\n" +
	"\"CSteamTV_HomePageTemplate_Takeover\x12?\n" +
	"\n" +
	"broadcasts\x18\x01 \x03(\v2\x1f.steam.GetBroadcastChannelEntryR\n" +
	"broadcasts\"\x93\x01\n" +
	...
	"\tbroadcast\x18\x03 \x01(\v2\x1f.steam.GetBroadcastChannelEntryR\tbroadcast\"j\n" +
	"\"CSteamTV_HomePageTemplate_GameList\x12.\n" +
	"\aentries\x18\x01 \x03(\v2\x14.steam.GameListEntryR\aentries\x12\x14\n" +
	...
	"\tbroadcast\x18\x01 \x01(\v2\x1f.steam.GetBroadcastChannelEntryR\tbroadcast\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\"\n" +
	"\rchat_group_id\x18\x03 \x01(\x04R\vchatGroupId\"z\n" +
	"#CSteamTV_HomePageTemplate_Developer\x12=\n" +
	"\tbroadcast\x18\x01 \x01(\v2\x1f.steam.GetBroadcastChannelEntryR\tbroadcast\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\"7\n" +
	"\x1fCSteamTV_HomePageTemplate_Event\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\"\xe0\x05\n" +
	"\x1bCSteamTV_HomePageContentRow\x12f\n" +
	"\rtemplate_type\x18\x01 \x01(\x0e2\x1e.steam.ESteamTVContentTemplate:!k_ESteamTVContentTemplate_InvalidR\ftemplateType\x12E\n" +
	"\btakeover\x18\x02 \x01(\v2).steam.CSteamTV_HomePageTemplate_TakeoverR\btakeover\x12L\n" +
	"\vsingle_game\x18\x03 \x01(\v2+.steam.CSteamTV_HomePageTemplate_SingleGameR\n" +
	"singleGame\x12F\n" +
	"\tgame_list\x18\x04 \x01(\v2).steam.CSteamTV_HomePageTemplate_GameListR\bgameList\x12R\n" +
	"\rquick_explore\x18\x05 \x01(\v2-.steam.CSteamTV_HomePageTemplate_QuickExploreR\fquickExplore\x12R\n" +
	"\rconveyor_belt\x18\x06 \x01(\v2-.steam.CSteamTV_HomePageTemplate_ConveyorBeltR\fconveyorBelt\x12L\n" +
	"\vwatch_party\x18\a \x01(\v2+.steam.CSteamTV_HomePageTemplate_WatchPartyR\n" +
	"watchParty\x12H\n" +
	"\tdeveloper\x18\b \x01(\v2*.steam.CSteamTV_HomePageTemplate_DeveloperR\tdeveloper\x12<\n" +
	"\x05event\x18\t \x01(\v2&.steam.CSteamTV_HomePageTemplate_EventR\x05event\"_\n" +
	"%CSteamTV_GetHomePageContents_Response\x126\n" +
	"\x04rows\x18\x01 \x03(\v2\".steam.CSteamTV_HomePageContentRowR\x04rows\"e\n" +
	"!CSteamTV_AppCheer_SingleCheerType\x12\x1d\n" +
	"\n" +
	"cheer_type\x18\x01 \x01(\rR\tcheerType\x12!\n" +
	"\fcheer_amount\x18\x02 \x01(\rR\vcheerAmount\"\x9c\x01\n" +
	...
	"\x06cheers\x18\x03 \x03(\v2(.steam.CSteamTV_AppCheer_SingleCheerTypeR\x06cheers\"N\n" +
	...
	"\x1fk_ESteamTVContentTemplate_Event\x10\b2\xef\x1c\n" +
	"\aSteamTV\x12y\n" +
	"\x16CreateBroadcastChannel\x12..steam.CSteamTV_CreateBroadcastChannel_Request\x1a/.steam.CSteamTV_CreateBroadcastChannel_Response\x12v\n" +
	"\x15GetBroadcastChannelID\x12-.steam.CSteamTV_GetBroadcastChannelID_Request\x1a..steam.CSteamTV_GetBroadcastChannelID_Response\x12\x85\x01\n" +
	"\x1aSetBroadcastChannelProfile\x122.steam.CSteamTV_SetBroadcastChannelProfile_Request\x1a3.steam.CSteamTV_SetBroadcastChannelProfile_Response\x12\x85\x01\n" +
	"\x1aGetBroadcastChannelProfile\x122.steam.CSteamTV_GetBroadcastChannelProfile_Request\x1a3.steam.CSteamTV_GetBroadcastChannelProfile_Response\x12\x7f\n" +
	"\x18SetBroadcastChannelImage\x120.steam.CSteamTV_SetBroadcastChannelImage_Request\x1a1.steam.CSteamTV_SetBroadcastChannelImage_Response\x12\x82\x01\n" +
	"\x19GetBroadcastChannelImages\x121.steam.CSteamTV_GetBroadcastChannelImages_Request\x1a2.steam.CSteamTV_GetBroadcastChannelImages_Response\x12\x91\x01\n" +
	"\x1eSetBroadcastChannelLinkRegions\x126.steam.CSteamTV_SetBroadcastChannelLinkRegions_Request\x1a7.steam.CSteamTV_SetBroadcastChannelLinkRegions_Response\x12\x7f\n" +
	"\x18GetBroadcastChannelLinks\x120.steam.CSteamTV_GetBroadcastChannelLinks_Request\x1a1.steam.CSteamTV_GetBroadcastChannelLinks_Response\x12\x94\x01\n" +
	"\x1fGetBroadcastChannelBroadcasters\x127.steam.CSteamTV_GetBroadcastChannelBroadcasters_Request\x1a8.steam.CSteamTV_GetBroadcastChannelBroadcasters_Response\x12p\n" +
	"\x13GetFollowedChannels\x12+.steam.CSteamTV_GetFollowedChannels_Request\x1a,.steam.CSteamTV_GetFollowedChannels_Response\x12v\n" +
	"\x15GetSubscribedChannels\x12-.steam.CSteamTV_GetSubscribedChannels_Request\x1a..steam.CSteamTV_GetSubscribedChannels_Response\x12\x82\x01\n" +
	"\x19GetBroadcastChannelStatus\x121.steam.CSteamTV_GetBroadcastChannelStatus_Request\x1a2.steam.CSteamTV_GetBroadcastChannelStatus_Response\x12y\n" +
	"\x16FollowBroadcastChannel\x12..steam.CSteamTV_FollowBroadcastChannel_Request\x1a/.steam.CSteamTV_FollowBroadcastChannel_Response\x12\x82\x01\n" +
	"\x19SubscribeBroadcastChannel\x121.steam.CSteamTV_SubscribeBroadcastChannel_Request\x1a2.steam.CSteamTV_SubscribeBroadcastChannel_Response\x12\x7f\n" +
	"\x18GetBroadcastChannelClips\x120.steam.CSteamTV_GetBroadcastChannelClips_Request\x1a1.steam.CSteamTV_GetBroadcastChannelClips_Response\x12y\n" +
	"\x16ReportBroadcastChannel\x12..steam.CSteamTV_ReportBroadcastChannel_Request\x1a/.steam.CSteamTV_ReportBroadcastChannel_Response\x12\x91\x01\n" +
	"\x1eGetBroadcastChannelInteraction\x126.steam.CSteamTV_GetBroadcastChannelInteraction_Request\x1a7.steam.CSteamTV_GetBroadcastChannelInteraction_Response\x12O\n" +
	"\bGetGames\x12 .steam.CSteamTV_GetGames_Request\x1a!.steam.CSteamTV_GetGames_Response\x12X\n" +
	"\vGetChannels\x12#.steam.CSteamTV_GetChannels_Request\x1a$.steam.CSteamTV_GetChannels_Response\x12U\n" +
	"\n" +
	"AddChatBan\x12\".steam.CSteamTV_AddChatBan_Request\x1a#.steam.CSteamTV_AddChatBan_Response\x12X\n" +
	"\vGetChatBans\x12#.steam.CSteamTV_GetChatBans_Request\x1a$.steam.CSteamTV_GetChatBans_Response\x12g\n" +
	"\x10AddChatModerator\x12(.steam.CSteamTV_AddChatModerator_Request\x1a).steam.CSteamTV_AddChatModerator_Response\x12j\n" +
	"\x11GetChatModerators\x12).steam.CSteamTV_GetChatModerators_Request\x1a*.steam.CSteamTV_GetChatModerators_Response\x12U\n" +
	"\n" +
	"AddWordBan\x12\".steam.CSteamTV_AddWordBan_Request\x1a#.steam.CSteamTV_AddWordBan_Response\x12X\n" +
	"\vGetWordBans\x12#.steam.CSteamTV_GetWordBans_Request\x1a$.steam.CSteamTV_GetWordBans_Response\x12O\n" +
	"\bJoinChat\x12 .steam.CSteamTV_JoinChat_Request\x1a!.steam.CSteamTV_JoinChat_Response\x12I\n" +
	"\x06Search\x12\x1e.steam.CSteamTV_Search_Request\x1a\x1f.steam.CSteamTV_Search_Response\x12y\n" +
	"\x16GetSteamTVUserSettings\x12..steam.CSteamTV_GetSteamTVUserSettings_Request\x1a/.steam.CSteamTV_GetSteamTVUserSettings_Response\x12y\n" +
	"\x16SetSteamTVUserSettings\x12..steam.CSteamTV_SetSteamTVUserSettings_Request\x1a/.steam.CSteamTV_SetSteamTVUserSettings_Response\x12y\n" +
	"\x16GetMyBroadcastChannels\x12..steam.CSteamTV_GetMyBroadcastChannels_Request\x1a/.steam.CSteamTV_GetMyBroadcastChannels_Response\x12p\n" +
	"\x13GetHomePageContents\x12+.steam.CSteamTV_GetHomePageContents_Request\x1a,.steam.CSteamTV_GetHomePageContents_Response\x12O\n" +
	"\bAppCheer\x12 .steam.CSteamTV_AppCheer_Request\x1a!.steam.CSteamTV_AppCheer_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_steamtv_steamclient_proto_goTypes = []any{
	(EBroadcastImageType)(0),                                              // 0: steam.EBroadcastImageType
	(EGetGamesAlgorithm)(0),                                               // 1: steam.EGetGamesAlgorithm
	(EGetChannelsAlgorithm)(0),                                            // 2: steam.EGetChannelsAlgorithm
	(ESteamTVContentTemplate)(0),                                          // 3: steam.ESteamTVContentTemplate
	(*CSteamTV_CreateBroadcastChannel_Request)(nil),                       // 4: steam.CSteamTV_CreateBroadcastChannel_Request
	(*CSteamTV_CreateBroadcastChannel_Response)(nil),                      // 5: steam.CSteamTV_CreateBroadcastChannel_Response
	(*CSteamTV_GetBroadcastChannelID_Request)(nil),                        // 6: steam.CSteamTV_GetBroadcastChannelID_Request
	(*CSteamTV_GetBroadcastChannelID_Response)(nil),                       // 7: steam.CSteamTV_GetBroadcastChannelID_Response
	(*CSteamTV_SetBroadcastChannelProfile_Request)(nil),                   // 8: steam.CSteamTV_SetBroadcastChannelProfile_Request
	(*CSteamTV_SetBroadcastChannelProfile_Response)(nil),                  // 9: steam.CSteamTV_SetBroadcastChannelProfile_Response
	(*CSteamTV_GetBroadcastChannelProfile_Request)(nil),                   // 10: steam.CSteamTV_GetBroadcastChannelProfile_Request
	(*CSteamTV_GetBroadcastChannelProfile_Response)(nil),                  // 11: steam.CSteamTV_GetBroadcastChannelProfile_Response
	(*CSteamTV_SetBroadcastChannelImage_Request)(nil),                     // 12: steam.CSteamTV_SetBroadcastChannelImage_Request
	(*CSteamTV_SetBroadcastChannelImage_Response)(nil),                    // 13: steam.CSteamTV_SetBroadcastChannelImage_Response
	(*CSteamTV_GetBroadcastChannelImages_Request)(nil),                    // 14: steam.CSteamTV_GetBroadcastChannelImages_Request
	(*CSteamTV_GetBroadcastChannelImages_Response)(nil),                   // 15: steam.CSteamTV_GetBroadcastChannelImages_Response
	(*CSteamTV_SetBroadcastChannelLinkRegions_Request)(nil),               // 16: steam.CSteamTV_SetBroadcastChannelLinkRegions_Request
	(*CSteamTV_SetBroadcastChannelLinkRegions_Response)(nil),              // 17: steam.CSteamTV_SetBroadcastChannelLinkRegions_Response
	(*CSteamTV_GetBroadcastChannelLinks_Request)(nil),                     // 18: steam.CSteamTV_GetBroadcastChannelLinks_Request
	(*CSteamTV_GetBroadcastChannelLinks_Response)(nil),                    // 19: steam.CSteamTV_GetBroadcastChannelLinks_Response
	(*CSteamTV_GetBroadcastChannelBroadcasters_Request)(nil),              // 20: steam.CSteamTV_GetBroadcastChannelBroadcasters_Request
	(*CSteamTV_GetBroadcastChannelBroadcasters_Response)(nil),             // 21: steam.CSteamTV_GetBroadcastChannelBroadcasters_Response
	(*CSteamTV_GetFollowedChannels_Request)(nil),                          // 22: steam.CSteamTV_GetFollowedChannels_Request
	(*GetBroadcastChannelEntry)(nil),                                      // 23: steam.GetBroadcastChannelEntry
	(*CSteamTV_GetFollowedChannels_Response)(nil),                         // 24: steam.CSteamTV_GetFollowedChannels_Response
	(*CSteamTV_GetSubscribedChannels_Request)(nil),                        // 25: steam.CSteamTV_GetSubscribedChannels_Request
	(*CSteamTV_GetSubscribedChannels_Response)(nil),                       // 26: steam.CSteamTV_GetSubscribedChannels_Response
	(*CSteamTV_GetBroadcastChannelStatus_Request)(nil),                    // 27: steam.CSteamTV_GetBroadcastChannelStatus_Request
	(*CSteamTV_GetBroadcastChannelStatus_Response)(nil),                   // 28: steam.CSteamTV_GetBroadcastChannelStatus_Response
	(*CSteamTV_FollowBroadcastChannel_Request)(nil),                       // 29: steam.CSteamTV_FollowBroadcastChannel_Request
	(*CSteamTV_FollowBroadcastChannel_Response)(nil),                      // 30: steam.CSteamTV_FollowBroadcastChannel_Response
	(*CSteamTV_SubscribeBroadcastChannel_Request)(nil),                    // 31: steam.CSteamTV_SubscribeBroadcastChannel_Request
	(*CSteamTV_SubscribeBroadcastChannel_Response)(nil),                   // 32: steam.CSteamTV_SubscribeBroadcastChannel_Response
	(*CSteamTV_GetBroadcastChannelClips_Request)(nil),                     // 33: steam.CSteamTV_GetBroadcastChannelClips_Request
	(*CSteamTV_BroadcastClipInfo)(nil),                                    // 34: steam.CSteamTV_BroadcastClipInfo
	(*CSteamTV_GetBroadcastChannelClips_Response)(nil),                    // 35: steam.CSteamTV_GetBroadcastChannelClips_Response
	(*CSteamTV_ReportBroadcastChannel_Request)(nil),                       // 36: steam.CSteamTV_ReportBroadcastChannel_Request
	(*CSteamTV_ReportBroadcastChannel_Response)(nil),                      // 37: steam.CSteamTV_ReportBroadcastChannel_Response
	(*CSteamTV_GetBroadcastChannelInteraction_Request)(nil),               // 38: steam.CSteamTV_GetBroadcastChannelInteraction_Request
	(*CSteamTV_GetBroadcastChannelInteraction_Response)(nil),              // 39: steam.CSteamTV_GetBroadcastChannelInteraction_Response
	(*CSteamTV_GetGames_Request)(nil),                                     // 40: steam.CSteamTV_GetGames_Request
	(*CSteamTV_Game)(nil),                                                 // 41: steam.CSteamTV_Game
	(*CSteamTV_GetGames_Response)(nil),                                    // 42: steam.CSteamTV_GetGames_Response
	(*CSteamTV_GetChannels_Request)(nil),                                  // 43: steam.CSteamTV_GetChannels_Request
	(*CSteamTV_GetChannels_Response)(nil),                                 // 44: steam.CSteamTV_GetChannels_Response
	(*CSteamTV_AddChatBan_Request)(nil),                                   // 45: steam.CSteamTV_AddChatBan_Request
	(*CSteamTV_AddChatBan_Response)(nil),                                  // 46: steam.CSteamTV_AddChatBan_Response
	(*CSteamTV_GetChatBans_Request)(nil),                                  // 47: steam.CSteamTV_GetChatBans_Request
	(*CSteamTV_ChatBan)(nil),                                              // 48: steam.CSteamTV_ChatBan
	(*CSteamTV_GetChatBans_Response)(nil),                                 // 49: steam.CSteamTV_GetChatBans_Response
	(*CSteamTV_AddChatModerator_Request)(nil),                             // 50: steam.CSteamTV_AddChatModerator_Request
	(*CSteamTV_AddChatModerator_Response)(nil),                            // 51: steam.CSteamTV_AddChatModerator_Response
	(*CSteamTV_GetChatModerators_Request)(nil),                            // 52: steam.CSteamTV_GetChatModerators_Request
	(*CSteamTV_ChatModerator)(nil),                                        // 53: steam.CSteamTV_ChatModerator
	(*CSteamTV_GetChatModerators_Response)(nil),                           // 54: steam.CSteamTV_GetChatModerators_Response
	(*CSteamTV_AddWordBan_Request)(nil),                                   // 55: steam.CSteamTV_AddWordBan_Request
	(*CSteamTV_AddWordBan_Response)(nil),                                  // 56: steam.CSteamTV_AddWordBan_Response
	(*CSteamTV_GetWordBans_Request)(nil),                                  // 57: steam.CSteamTV_GetWordBans_Request
	(*CSteamTV_GetWordBans_Response)(nil),                                 // 58: steam.CSteamTV_GetWordBans_Response
	(*CSteamTV_JoinChat_Request)(nil),                                     // 59: steam.CSteamTV_JoinChat_Request
	(*CSteamTV_JoinChat_Response)(nil),                                    // 60: steam.CSteamTV_JoinChat_Response
	(*CSteamTV_Search_Request)(nil),                                       // 61: steam.CSteamTV_Search_Request
	(*CSteamTV_Search_Response)(nil),                                      // 62: steam.CSteamTV_Search_Response
	(*CSteamTV_GetSteamTVUserSettings_Request)(nil),                       // 63: steam.CSteamTV_GetSteamTVUserSettings_Request
	(*CSteamTV_GetSteamTVUserSettings_Response)(nil),                      // 64: steam.CSteamTV_GetSteamTVUserSettings_Response
	(*CSteamTV_SetSteamTVUserSettings_Request)(nil),                       // 65: steam.CSteamTV_SetSteamTVUserSettings_Request
	(*CSteamTV_SetSteamTVUserSettings_Response)(nil),                      // 66: steam.CSteamTV_SetSteamTVUserSettings_Response
	(*CSteamTV_GetMyBroadcastChannels_Request)(nil),                       // 67: steam.CSteamTV_GetMyBroadcastChannels_Request
	(*CSteamTV_GetMyBroadcastChannels_Response)(nil),                      // 68: steam.CSteamTV_GetMyBroadcastChannels_Response
	(*CSteamTV_GetHomePageContents_Request)(nil),                          // 69: steam.CSteamTV_GetHomePageContents_Request
	(*CSteamTV_HomePageTemplate_Takeover)(nil),                            // 70: steam.CSteamTV_HomePageTemplate_Takeover
	(*CSteamTV_HomePageTemplate_SingleGame)(nil),                          // 71: steam.CSteamTV_HomePageTemplate_SingleGame
	(*GameListEntry)(nil),                                                 // 72: steam.GameListEntry
	(*CSteamTV_HomePageTemplate_GameList)(nil),                            // 73: steam.CSteamTV_HomePageTemplate_GameList
	(*CSteamTV_HomePageTemplate_QuickExplore)(nil),                        // 74: steam.CSteamTV_HomePageTemplate_QuickExplore
	(*CSteamTV_HomePageTemplate_ConveyorBelt)(nil),                        // 75: steam.CSteamTV_HomePageTemplate_ConveyorBelt
	(*CSteamTV_HomePageTemplate_WatchParty)(nil),                          // 76: steam.CSteamTV_HomePageTemplate_WatchParty
	(*CSteamTV_HomePageTemplate_Developer)(nil),                           // 77: steam.CSteamTV_HomePageTemplate_Developer
	(*CSteamTV_HomePageTemplate_Event)(nil),                               // 78: steam.CSteamTV_HomePageTemplate_Event
	(*CSteamTV_HomePageContentRow)(nil),                                   // 79: steam.CSteamTV_HomePageContentRow
	(*CSteamTV_GetHomePageContents_Response)(nil),                         // 80: steam.CSteamTV_GetHomePageContents_Response
	(*CSteamTV_AppCheer_SingleCheerType)(nil),                             // 81: steam.CSteamTV_AppCheer_SingleCheerType
	(*CSteamTV_AppCheer_Request)(nil),                                     // 82: steam.CSteamTV_AppCheer_Request
	(*CSteamTV_AppCheer_Response)(nil),                                    // 83: steam.CSteamTV_AppCheer_Response
	(*CSteamTV_GetBroadcastChannelImages_Response_Images)(nil),            // 84: steam.CSteamTV_GetBroadcastChannelImages_Response.Images
	(*CSteamTV_SetBroadcastChannelLinkRegions_Request_Links)(nil),         // 85: steam.CSteamTV_SetBroadcastChannelLinkRegions_Request.Links
	(*CSteamTV_GetBroadcastChannelLinks_Response_Links)(nil),              // 86: steam.CSteamTV_GetBroadcastChannelLinks_Response.Links
	(*CSteamTV_GetBroadcastChannelBroadcasters_Response_Broadcaster)(nil), // 87: steam.CSteamTV_GetBroadcastChannelBroadcasters_Response.Broadcaster
}
var file_steammessages_steamtv_steamclient_proto_depIdxs = []int32{
	0,  // 0: steam.CSteamTV_SetBroadcastChannelImage_Request.image_type:type_name -> steam.EBroadcastImageType
	0,  // 1: steam.CSteamTV_GetBroadcastChannelImages_Request.image_types:type_name -> steam.EBroadcastImageType
	84, // 2: steam.CSteamTV_GetBroadcastChannelImages_Response.images:type_name -> steam.CSteamTV_GetBroadcastChannelImages_Response.Images
	85, // 3: steam.CSteamTV_SetBroadcastChannelLinkRegions_Request.links:type_name -> steam.CSteamTV_SetBroadcastChannelLinkRegions_Request.Links
	86, // 4: steam.CSteamTV_GetBroadcastChannelLinks_Response.links:type_name -> steam.CSteamTV_GetBroadcastChannelLinks_Response.Links
	87, // 5: steam.CSteamTV_GetBroadcastChannelBroadcasters_Response.broadcasters:type_name -> steam.CSteamTV_GetBroadcastChannelBroadcasters_Response.Broadcaster
	23, // 6: steam.CSteamTV_GetFollowedChannels_Response.results:type_name -> steam.GetBroadcastChannelEntry
	23, // 7: steam.CSteamTV_GetSubscribedChannels_Response.results:type_name -> steam.GetBroadcastChannelEntry
	34, // 8: steam.CSteamTV_GetBroadcastChannelClips_Response.clips:type_name -> steam.CSteamTV_BroadcastClipInfo
	1,  // 9: steam.CSteamTV_GetGames_Request.algorithm:type_name -> steam.EGetGamesAlgorithm
	23, // 10: steam.CSteamTV_Game.channels:type_name -> steam.GetBroadcastChannelEntry
	41, // 11: steam.CSteamTV_GetGames_Response.results:type_name -> steam.CSteamTV_Game
	2,  // 12: steam.CSteamTV_GetChannels_Request.algorithm:type_name -> steam.EGetChannelsAlgorithm
	23, // 13: steam.CSteamTV_GetChannels_Response.results:type_name -> steam.GetBroadcastChannelEntry
	48, // 14: steam.CSteamTV_GetChatBans_Response.results:type_name -> steam.CSteamTV_ChatBan
	53, // 15: steam.CSteamTV_GetChatModerators_Response.results:type_name -> steam.CSteamTV_ChatModerator
	23, // 16: steam.CSteamTV_Search_Response.results:type_name -> steam.GetBroadcastChannelEntry
	23, // 17: steam.CSteamTV_GetMyBroadcastChannels_Response.results:type_name -> steam.GetBroadcastChannelEntry
	23, // 18: steam.CSteamTV_HomePageTemplate_Takeover.broadcasts:type_name -> steam.GetBroadcastChannelEntry
	23, // 19: steam.CSteamTV_HomePageTemplate_SingleGame.broadcasts:type_name -> steam.GetBroadcastChannelEntry
	23, // 20: steam.GameListEntry.broadcast:type_name -> steam.GetBroadcastChannelEntry
	72, // 21: steam.CSteamTV_HomePageTemplate_GameList.entries:type_name -> steam.GameListEntry
	23, // 22: steam.CSteamTV_HomePageTemplate_QuickExplore.broadcasts:type_name -> steam.GetBroadcastChannelEntry
	23, // 23: steam.CSteamTV_HomePageTemplate_ConveyorBelt.broadcasts:type_name -> steam.GetBroadcastChannelEntry
	23, // 24: steam.CSteamTV_HomePageTemplate_WatchParty.broadcast:type_name -> steam.GetBroadcastChannelEntry
	23, // 25: steam.CSteamTV_HomePageTemplate_Developer.broadcast:type_name -> steam.GetBroadcastChannelEntry
	3,  // 26: steam.CSteamTV_HomePageContentRow.template_type:type_name -> steam.ESteamTVContentTemplate
	70, // 27: steam.CSteamTV_HomePageContentRow.takeover:type_name -> steam.CSteamTV_HomePageTemplate_Takeover
	71, // 28: steam.CSteamTV_HomePageContentRow.single_game:type_name -> steam.CSteamTV_HomePageTemplate_SingleGame
	73, // 29: steam.CSteamTV_HomePageContentRow.game_list:type_name -> steam.CSteamTV_HomePageTemplate_GameList
	74, // 30: steam.CSteamTV_HomePageContentRow.quick_explore:type_name -> steam.CSteamTV_HomePageTemplate_QuickExplore
	75, // 31: steam.CSteamTV_HomePageContentRow.conveyor_belt:type_name -> steam.CSteamTV_HomePageTemplate_ConveyorBelt
	76, // 32: steam.CSteamTV_HomePageContentRow.watch_party:type_name -> steam.CSteamTV_HomePageTemplate_WatchParty
	77, // 33: steam.CSteamTV_HomePageContentRow.developer:type_name -> steam.CSteamTV_HomePageTemplate_Developer
	78, // 34: steam.CSteamTV_HomePageContentRow.event:type_name -> steam.CSteamTV_HomePageTemplate_Event
	79, // 35: steam.CSteamTV_GetHomePageContents_Response.rows:type_name -> steam.CSteamTV_HomePageContentRow
	81, // 36: steam.CSteamTV_AppCheer_Request.cheers:type_name -> steam.CSteamTV_AppCheer_SingleCheerType
	0,  // 37: steam.CSteamTV_GetBroadcastChannelImages_Response.Images.image_type:type_name -> steam.EBroadcastImageType
	4,  // 38: steam.SteamTV.CreateBroadcastChannel:input_type -> steam.CSteamTV_CreateBroadcastChannel_Request
	6,  // 39: steam.SteamTV.GetBroadcastChannelID:input_type -> steam.CSteamTV_GetBroadcastChannelID_Request
	8,  // 40: steam.SteamTV.SetBroadcastChannelProfile:input_type -> steam.CSteamTV_SetBroadcastChannelProfile_Request
	10, // 41: steam.SteamTV.GetBroadcastChannelProfile:input_type -> steam.CSteamTV_GetBroadcastChannelProfile_Request
	12, // 42: steam.SteamTV.SetBroadcastChannelImage:input_type -> steam.CSteamTV_SetBroadcastChannelImage_Request
	14, // 43: steam.SteamTV.GetBroadcastChannelImages:input_type -> steam.CSteamTV_GetBroadcastChannelImages_Request
	16, // 44: steam.SteamTV.SetBroadcastChannelLinkRegions:input_type -> steam.CSteamTV_SetBroadcastChannelLinkRegions_Request
	18, // 45: steam.SteamTV.GetBroadcastChannelLinks:input_type -> steam.CSteamTV_GetBroadcastChannelLinks_Request
	20, // 46: steam.SteamTV.GetBroadcastChannelBroadcasters:input_type -> steam.CSteamTV_GetBroadcastChannelBroadcasters_Request
	22, // 47: steam.SteamTV.GetFollowedChannels:input_type -> steam.CSteamTV_GetFollowedChannels_Request
	25, // 48: steam.SteamTV.GetSubscribedChannels:input_type -> steam.CSteamTV_GetSubscribedChannels_Request
	27, // 49: steam.SteamTV.GetBroadcastChannelStatus:input_type -> steam.CSteamTV_GetBroadcastChannelStatus_Request
	29, // 50: steam.SteamTV.FollowBroadcastChannel:input_type -> steam.CSteamTV_FollowBroadcastChannel_Request
	31, // 51: steam.SteamTV.SubscribeBroadcastChannel:input_type -> steam.CSteamTV_SubscribeBroadcastChannel_Request
	33, // 52: steam.SteamTV.GetBroadcastChannelClips:input_type -> steam.CSteamTV_GetBroadcastChannelClips_Request
	36, // 53: steam.SteamTV.ReportBroadcastChannel:input_type -> steam.CSteamTV_ReportBroadcastChannel_Request
	38, // 54: steam.SteamTV.GetBroadcastChannelInteraction:input_type -> steam.CSteamTV_GetBroadcastChannelInteraction_Request
	40, // 55: steam.SteamTV.GetGames:input_type -> steam.CSteamTV_GetGames_Request
	43, // 56: steam.SteamTV.GetChannels:input_type -> steam.CSteamTV_GetChannels_Request
	45, // 57: steam.SteamTV.AddChatBan:input_type -> steam.CSteamTV_AddChatBan_Request
	47, // 58: steam.SteamTV.GetChatBans:input_type -> steam.CSteamTV_GetChatBans_Request
	50, // 59: steam.SteamTV.AddChatModerator:input_type -> steam.CSteamTV_AddChatModerator_Request
	52, // 60: steam.SteamTV.GetChatModerators:input_type -> steam.CSteamTV_GetChatModerators_Request
	55, // 61: steam.SteamTV.AddWordBan:input_type -> steam.CSteamTV_AddWordBan_Request
	57, // 62: steam.SteamTV.GetWordBans:input_type -> steam.CSteamTV_GetWordBans_Request
	59, // 63: steam.SteamTV.JoinChat:input_type -> steam.CSteamTV_JoinChat_Request
	61, // 64: steam.SteamTV.Search:input_type -> steam.CSteamTV_Search_Request
	63, // 65: steam.SteamTV.GetSteamTVUserSettings:input_type -> steam.CSteamTV_GetSteamTVUserSettings_Request
	65, // 66: steam.SteamTV.SetSteamTVUserSettings:input_type -> steam.CSteamTV_SetSteamTVUserSettings_Request
	67, // 67: steam.SteamTV.GetMyBroadcastChannels:input_type -> steam.CSteamTV_GetMyBroadcastChannels_Request
	69, // 68: steam.SteamTV.GetHomePageContents:input_type -> steam.CSteamTV_GetHomePageContents_Request
	82, // 69: steam.SteamTV.AppCheer:input_type -> steam.CSteamTV_AppCheer_Request
	5,  // 70: steam.SteamTV.CreateBroadcastChannel:output_type -> steam.CSteamTV_CreateBroadcastChannel_Response
	7,  // 71: steam.SteamTV.GetBroadcastChannelID:output_type -> steam.CSteamTV_GetBroadcastChannelID_Response
	9,  // 72: steam.SteamTV.SetBroadcastChannelProfile:output_type -> steam.CSteamTV_SetBroadcastChannelProfile_Response
	11, // 73: steam.SteamTV.GetBroadcastChannelProfile:output_type -> steam.CSteamTV_GetBroadcastChannelProfile_Response
	13, // 74: steam.SteamTV.SetBroadcastChannelImage:output_type -> steam.CSteamTV_SetBroadcastChannelImage_Response
	15, // 75: steam.SteamTV.GetBroadcastChannelImages:output_type -> steam.CSteamTV_GetBroadcastChannelImages_Response
	17, // 76: steam.SteamTV.SetBroadcastChannelLinkRegions:output_type -> steam.CSteamTV_SetBroadcastChannelLinkRegions_Response
	19, // 77: steam.SteamTV.GetBroadcastChannelLinks:output_type -> steam.CSteamTV_GetBroadcastChannelLinks_Response
	21, // 78: steam.SteamTV.GetBroadcastChannelBroadcasters:output_type -> steam.CSteamTV_GetBroadcastChannelBroadcasters_Response
	24, // 79: steam.SteamTV.GetFollowedChannels:output_type -> steam.CSteamTV_GetFollowedChannels_Response
	26, // 80: steam.SteamTV.GetSubscribedChannels:output_type -> steam.CSteamTV_GetSubscribedChannels_Response
	28, // 81: steam.SteamTV.GetBroadcastChannelStatus:output_type -> steam.CSteamTV_GetBroadcastChannelStatus_Response
	30, // 82: steam.SteamTV.FollowBroadcastChannel:output_type -> steam.CSteamTV_FollowBroadcastChannel_Response
	32, // 83: steam.SteamTV.SubscribeBroadcastChannel:output_type -> steam.CSteamTV_SubscribeBroadcastChannel_Response
	35, // 84: steam.SteamTV.GetBroadcastChannelClips:output_type -> steam.CSteamTV_GetBroadcastChannelClips_Response
	37, // 85: steam.SteamTV.ReportBroadcastChannel:output_type -> steam.CSteamTV_ReportBroadcastChannel_Response
	39, // 86: steam.SteamTV.GetBroadcastChannelInteraction:output_type -> steam.CSteamTV_GetBroadcastChannelInteraction_Response
	42, // 87: steam.SteamTV.GetGames:output_type -> steam.CSteamTV_GetGames_Response
	44, // 88: steam.SteamTV.GetChannels:output_type -> steam.CSteamTV_GetChannels_Response
	46, // 89: steam.SteamTV.AddChatBan:output_type -> steam.CSteamTV_AddChatBan_Response
	49, // 90: steam.SteamTV.GetChatBans:output_type -> steam.CSteamTV_GetChatBans_Response
	51, // 91: steam.SteamTV.AddChatModerator:output_type -> steam.CSteamTV_AddChatModerator_Response
	54, // 92: steam.SteamTV.GetChatModerators:output_type -> steam.CSteamTV_GetChatModerators_Response
	56, // 93: steam.SteamTV.AddWordBan:output_type -> steam.CSteamTV_AddWordBan_Response
	58, // 94: steam.SteamTV.GetWordBans:output_type -> steam.CSteamTV_GetWordBans_Response
	60, // 95: steam.SteamTV.JoinChat:output_type -> steam.CSteamTV_JoinChat_Response
	62, // 96: steam.SteamTV.Search:output_type -> steam.CSteamTV_Search_Response
	64, // 97: steam.SteamTV.GetSteamTVUserSettings:output_type -> steam.CSteamTV_GetSteamTVUserSettings_Response
	66, // 98: steam.SteamTV.SetSteamTVUserSettings:output_type -> steam.CSteamTV_SetSteamTVUserSettings_Response
	68, // 99: steam.SteamTV.GetMyBroadcastChannels:output_type -> steam.CSteamTV_GetMyBroadcastChannels_Response
	80, // 100: steam.SteamTV.GetHomePageContents:output_type -> steam.CSteamTV_GetHomePageContents_Response
	83, // 101: steam.SteamTV.AppCheer:output_type -> steam.CSteamTV_AppCheer_Response
