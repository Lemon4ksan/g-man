...
const file_steammessages_gamenotifications_steamclient_proto_rawDesc = "" +
	"\n" +
	"1steammessages_gamenotifications.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"E\n" +
	...
	"\tvariables\x18\x02 \x03(\v2\".steam.CGameNotifications_VariableR\tvariables\x12#\n" +
	"\rrendered_text\x18\x03 \x01(\tR\frenderedText\"\xd1\x01\n" +
	"\x1dCGameNotifications_UserStatus\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12\x14\n" +
	"\x05state\x18\x02 \x01(\tR\x05state\x12=\n" +
	"\x05title\x18\x03 \x01(\v2'.steam.CGameNotifications_LocalizedTextR\x05title\x12A\n" +
	"\amessage\x18\x04 \x01(\v2'.steam.CGameNotifications_LocalizedTextR\amessage\"\xef\x01\n" +
	"(CGameNotifications_CreateSession_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12\x18\n" +
	"\acontext\x18\x02 \x01(\x04R\acontext\x12=\n" +
	"\x05title\x18\x03 \x01(\v2'.steam.CGameNotifications_LocalizedTextR\x05title\x12:\n" +
	"\x05users\x18\x04 \x03(\v2$.steam.CGameNotifications_UserStatusR\x05users\x12\x18\n" +
	...
	")CGameNotifications_DeleteSession_Response\"\xf3\x01\n" +
	...
	"\blanguage\x18\x05 \x01(\tR\blanguage\"\xb6\x02\n" +
	"\x1aCGameNotifications_Session\x12\x1c\n" +
	"\tsessionid\x18\x01 \x01(\x04R\tsessionid\x12\x14\n" +
	"\x05appid\x18\x02 \x01(\x04R\x05appid\x12\x18\n" +
	"\acontext\x18\x03 \x01(\x04R\acontext\x12=\n" +
	"\x05title\x18\x04 \x01(\v2'.steam.CGameNotifications_LocalizedTextR\x05title\x12!\n" +
	"\ftime_created\x18\x05 \x01(\rR\vtimeCreated\x12!\n" +
	"\ftime_updated\x18\x06 \x01(\rR\vtimeUpdated\x12E\n" +
	"\vuser_status\x18\a \x03(\v2$.steam.CGameNotifications_UserStatusR\n" +
	"userStatus\"n\n" +
	"-CGameNotifications_EnumerateSessions_Response\x12=\n" +
	"\bsessions\x18\x01 \x03(\v2!.steam.CGameNotifications_SessionR\bsessions\"\xaf\x02\n" +
	",CGameNotifications_GetSessionDetails_Request\x12`\n" +
	"\bsessions\x18\x01 \x03(\v2D.steam.CGameNotifications_GetSessionDetails_Request.RequestedSessionR\bsessions\x12\x14\n" +
	...
	"\x19include_auth_user_message\x18\x03 \x01(\bR\x16includeAuthUserMessage\"n\n" +
	"-CGameNotifications_GetSessionDetails_Response\x12=\n" +
	"\bsessions\x18\x01 \x03(\v2!.steam.CGameNotifications_SessionR\bsessions\"a\n" +
	"\x18GameNotificationSettings\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12/\n" +
	"\x13allow_notifications\x18\x02 \x01(\bR\x12allowNotifications\"\x96\x01\n" +
	"5CGameNotifications_UpdateNotificationSettings_Request\x12]\n" +
	"\x1agame_notification_settings\x18\x01 \x03(\v2\x1f.steam.GameNotificationSettingsR\x18gameNotificationSettings\"8\n" +
	...
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12\x14\n" +
	"\x05appid\x18\x02 \x01(\rR\x05appid\"\xdb\x01\n" +
	...
	"\x06status\x18\x04 \x01(\v2$.steam.CGameNotifications_UserStatusR\x06status\x12\x18\n" +
	"\aremoved\x18\x05 \x01(\bR\aremoved2\x97\x06\n" +
	"\x11GameNotifications\x12v\n" +
	"\x11UserCreateSession\x12/.steam.CGameNotifications_CreateSession_Request\x1a0.steam.CGameNotifications_CreateSession_Response\x12v\n" +
	"\x11UserDeleteSession\x12/.steam.CGameNotifications_DeleteSession_Request\x1a0.steam.CGameNotifications_DeleteSession_Response\x12v\n" +
	"\x11UserUpdateSession\x12/.steam.CGameNotifications_UpdateSession_Request\x1a0.steam.CGameNotifications_UpdateSession_Response\x12~\n" +
	"\x11EnumerateSessions\x123.steam.CGameNotifications_EnumerateSessions_Request\x1a4.steam.CGameNotifications_EnumerateSessions_Response\x12~\n" +
	"\x11GetSessionDetails\x123.steam.CGameNotifications_GetSessionDetails_Request\x1a4.steam.CGameNotifications_GetSessionDetails_Response\x12\x99\x01\n" +
	"\x1aUpdateNotificationSettings\x12<.steam.CGameNotifications_UpdateNotificationSettings_Request\x1a=.steam.CGameNotifications_UpdateNotificationSettings_Response2\xf5\x01\n" +
	"\x17GameNotificationsClient\x12n\n" +
	"\x18OnNotificationsRequested\x12?.steam.CGameNotifications_OnNotificationsRequested_Notification\x1a\x11.steam.NoResponse\x12d\n" +
	"\x13OnUserStatusChanged\x12:.steam.CGameNotifications_OnUserStatusChanged_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x02B3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
