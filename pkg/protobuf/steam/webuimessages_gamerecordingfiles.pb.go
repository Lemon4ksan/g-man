...
type CGameRecordingTimelineMetadata_Recording struct {
	...
	RecordingType                 *EGameRecordingType    `protobuf:"varint,4,opt,name=recording_type,json=recordingType,enum=steam.EGameRecordingType,def=0" json:"recording_type,omitempty"`
...
const file_webuimessages_gamerecordingfiles_proto_rawDesc = "" +
	"\n" +
	"&webuimessages_gamerecordingfiles.proto\x12\x05steam\x1a\venums.proto\x1a\x18steammessages_base.proto\x1a\x18webuimessages_base.proto\"\xff\x01\n" +
	"\x12CGameRecordingFile\x12C\n" +
	"\ttimelines\x18\x01 \x03(\v2%.steam.CGameRecordingTimelineMetadataR\ttimelines\x12M\n" +
	"\x0fpostgame_events\x18\x02 \x03(\v2$.steam.CGameRecordingPostGameSummaryR\x0epostgameEvents\x12'\n" +
	"\x0ftemporary_clips\x18\x03 \x03(\tR\x0etemporaryClips\x12,\n" +
	"\x04tags\x18\x04 \x03(\v2\x18.steam.CGameRecordingTagR\x04tags\"\xa8\x05\n" +
	"\x16CGameRecordingClipFile\x12C\n" +
	"\ttimelines\x18\x01 \x03(\v2%.steam.CGameRecordingTimelineMetadataR\ttimelines\x12B\n" +
	...
	"\x04tags\x18\x0e \x03(\v2\x18.steam.CGameRecordingTagR\x04tags\x122\n" +
	"\x06phases\x18\x0f \x03(\v2\x1a.steam.CGameRecordingPhaseR\x06phases\"\xf7\x06\n" +
	...
	"durationMs\x12O\n" +
	"\n" +
	"recordings\x18\x05 \x03(\v2/.steam.CGameRecordingTimelineMetadata.RecordingR\n" +
	"recordings\x122\n" +
	"\x06phases\x18\x06 \x03(\v2\x1a.steam.CGameRecordingPhaseR\x06phases\x12Q\n" +
	"\x12significant_events\x18\a \x03(\v2\".steam.CGameRecordingTimelineEventR\x11significantEvents\x1a\xfc\x03\n" +
	"\tRecording\x12!\n" +
	...
	"durationMs\x12^\n" +
	"\x0erecording_type\x18\x04 \x01(\x0e2\x19.steam.EGameRecordingType:\x1ck_EGameRecordingType_UnknownR\rrecordingType\x12*\n" +
	...
	" \x01(\x04R\x1drecordingZeroTimelineOffsetMs\"t\n" +
	"\x1dCGameRecordingPostGameSummary\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x04R\x06gameId\x12:\n" +
	"\x06events\x18\x02 \x03(\v2\".steam.CGameRecordingTimelineEventR\x06events\"\xea\x02\n" +
	...
	"\agame_id\x18\x01 \x01(\x04R\x06gameId\x12%\n" +
	"\x03tag\x18\x02 \x01(\v2\x13.steam.CTimelineTagR\x03tag\x12A\n" +
	"\n" +
	"references\x18\x03 \x03(\v2!.steam.CGameRecordingTag.TimelineR\n" +
	"references\x1aa\n" +
	"\bTimeline\x12\x17\n" +
	...
	"durationMs\x122\n" +
	"\x04tags\x18\x06 \x03(\v2\x1e.steam.CGameRecordingPhase.TagR\x04tags\x12E\n" +
	"\x0econtained_tags\x18\a \x03(\v2\x1e.steam.CGameRecordingPhase.TagR\rcontainedTags\x12<\n" +
	"\x1abackground_timeline_offset\x18\b \x01(\x04R\x18backgroundTimelineOffset\x126\n" +
	"\n" +
	"attributes\x18\t \x03(\v2\x16.steam.CPhaseAttributeR\n" +
	"attributes\x1a/\n" +
	"\x03Tag\x12\x12\n" +
	...
	"\bpriority\x18\x03 \x01(\rR\bpriorityB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_webuimessages_gamerecordingfiles_proto_goTypes = []any{
	(*CGameRecordingFile)(nil),                       // 0: steam.CGameRecordingFile
	(*CGameRecordingClipFile)(nil),                   // 1: steam.CGameRecordingClipFile
	(*CGameRecordingTimelineMetadata)(nil),           // 2: steam.CGameRecordingTimelineMetadata
	(*CGameRecordingPostGameSummary)(nil),            // 3: steam.CGameRecordingPostGameSummary
	(*CGameRecordingTimelineEvent)(nil),              // 4: steam.CGameRecordingTimelineEvent
	(*CGameRecordingTag)(nil),                        // 5: steam.CGameRecordingTag
	(*CGameRecordingTagInstance)(nil),                // 6: steam.CGameRecordingTagInstance
	(*CGameRecordingPhase)(nil),                      // 7: steam.CGameRecordingPhase
	(*CTimelineTag)(nil),                             // 8: steam.CTimelineTag
	(*CPhaseAttribute)(nil),                          // 9: steam.CPhaseAttribute
	(*CGameRecordingTimelineMetadata_Recording)(nil), // 10: steam.CGameRecordingTimelineMetadata.Recording
	(*CGameRecordingTag_Timeline)(nil),               // 11: steam.CGameRecordingTag.Timeline
	(*CGameRecordingPhase_Tag)(nil),                  // 12: steam.CGameRecordingPhase.Tag
	(EGameRecordingType)(0),                          // 13: steam.EGameRecordingType
}
var file_webuimessages_gamerecordingfiles_proto_depIdxs = []int32{
	2,  // 0: steam.CGameRecordingFile.timelines:type_name -> steam.CGameRecordingTimelineMetadata
	3,  // 1: steam.CGameRecordingFile.postgame_events:type_name -> steam.CGameRecordingPostGameSummary
	5,  // 2: steam.CGameRecordingFile.tags:type_name -> steam.CGameRecordingTag
	2,  // 3: steam.CGameRecordingClipFile.timelines:type_name -> steam.CGameRecordingTimelineMetadata
	5,  // 4: steam.CGameRecordingClipFile.tags:type_name -> steam.CGameRecordingTag
	7,  // 5: steam.CGameRecordingClipFile.phases:type_name -> steam.CGameRecordingPhase
	10, // 6: steam.CGameRecordingTimelineMetadata.recordings:type_name -> steam.CGameRecordingTimelineMetadata.Recording
	7,  // 7: steam.CGameRecordingTimelineMetadata.phases:type_name -> steam.CGameRecordingPhase
	4,  // 8: steam.CGameRecordingTimelineMetadata.significant_events:type_name -> steam.CGameRecordingTimelineEvent
	4,  // 9: steam.CGameRecordingPostGameSummary.events:type_name -> steam.CGameRecordingTimelineEvent
	8,  // 10: steam.CGameRecordingTag.tag:type_name -> steam.CTimelineTag
	11, // 11: steam.CGameRecordingTag.references:type_name -> steam.CGameRecordingTag.Timeline
	12, // 12: steam.CGameRecordingPhase.tags:type_name -> steam.CGameRecordingPhase.Tag
	12, // 13: steam.CGameRecordingPhase.contained_tags:type_name -> steam.CGameRecordingPhase.Tag
	9,  // 14: steam.CGameRecordingPhase.attributes:type_name -> steam.CPhaseAttribute
	13, // 15: steam.CGameRecordingTimelineMetadata.Recording.recording_type:type_name -> steam.EGameRecordingType
