...
const file_webuimessages_sharedjscontext_proto_rawDesc = "" +
	"\n" +
	"#webuimessages_sharedjscontext.proto\x12\x05steam\x1a\venums.proto\x1a\x18steammessages_base.proto\x1a\x18webuimessages_base.proto\"3\n" +
	...
	" \x01(\bR\x15gamepaduiViaGamescope\"o\n" +
	"2CSharedJSContext_GetDesiredSteamUIWindows_Response\x129\n" +
	"\awindows\x18\x01 \x03(\v2\x1f.steam.CMsgSteamUIBrowserWindowR\awindows2\xa9\x01\n" +
	"\x0fSharedJSContext\x12\x8f\x01\n" +
	"\x18GetDesiredSteamUIWindows\x128.steam.CSharedJSContext_GetDesiredSteamUIWindows_Request\x1a9.steam.CSharedJSContext_GetDesiredSteamUIWindows_Response\x1a\x04\x80\x97\"\x01B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_webuimessages_sharedjscontext_proto_goTypes = []any{
	(*CSharedJSContext_GetDesiredSteamUIWindows_Request)(nil),  // 0: steam.CSharedJSContext_GetDesiredSteamUIWindows_Request
	(*CMsgSteamUIBrowserWindow)(nil),                           // 1: steam.CMsgSteamUIBrowserWindow
	(*CSharedJSContext_GetDesiredSteamUIWindows_Response)(nil), // 2: steam.CSharedJSContext_GetDesiredSteamUIWindows_Response
}
var file_webuimessages_sharedjscontext_proto_depIdxs = []int32{
	1, // 0: steam.CSharedJSContext_GetDesiredSteamUIWindows_Response.windows:type_name -> steam.CMsgSteamUIBrowserWindow
	0, // 1: steam.SharedJSContext.GetDesiredSteamUIWindows:input_type -> steam.CSharedJSContext_GetDesiredSteamUIWindows_Request
	2, // 2: steam.SharedJSContext.GetDesiredSteamUIWindows:output_type -> steam.CSharedJSContext_GetDesiredSteamUIWindows_Response
