...
const file_steammessages_accounthardware_steamclient_proto_rawDesc = "" +
	"\n" +
	"/steammessages_accounthardware.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"\x80\x01\n" +
	...
	"\x15registration_complete\x18\x02 \x01(\bR\x14registrationComplete\"\x99\x01\n" +
	"9CAccountHardware_QueryAccountsRegisteredToSerial_Response\x12\\\n" +
	"\baccounts\x18\x01 \x03(\v2@.steam.CAccountHardware_QueryAccountsRegisteredToSerial_AccountsR\baccounts\"\xfc\x01\n" +
	"4CAccountHardware_UpdateControllerUsageReport_Request\x12h\n" +
	"\vcontrollers\x18\x01 \x03(\v2F.steam.CAccountHardware_UpdateControllerUsageReport_Request.ControllerR\vcontrollers\x1aZ\n" +
	"\n" +
	"Controller\x12#\n" +
	"\rserial_number\x18\x01 \x01(\tR\fserialNumber\x12'\n" +
	...
	"\ftemplatename\x18\x03 \x01(\tR\ftemplatename\"\xee\x02\n" +
	"1CAccountHardware_SteamControllerSetConfig_Request\x12#\n" +
	"\rserial_number\x18\x01 \x01(\tR\fserialNumber\x12'\n" +
	"\x0fcontroller_code\x18\x02 \x01(\tR\x0econtrollerCode\x12\x1c\n" +
	"\taccountid\x18\x03 \x01(\rR\taccountid\x12i\n" +
	"\x0econfigurations\x18\x04 \x03(\v2A.steam.CAccountHardware_SteamControllerSetConfig_ControllerConfigR\x0econfigurations\x12*\n" +
	...
	"\bautosave\x18\x05 \x01(\b:\x05falseR\bautosave\"\x9f\x01\n" +
	"2CAccountHardware_SteamControllerGetConfig_Response\x12i\n" +
	"\x0econfigurations\x18\x01 \x03(\v2A.steam.CAccountHardware_SteamControllerGetConfig_ControllerConfigR\x0econfigurations\"\xa0\x01\n" +
	...
	"\x0fpublishedfileid\x18\x01 \x01(\x04R\x0fpublishedfileid\"\xd5\x01\n" +
	"-CAccountHardware_VRCompatibilityCheck_Request\x12!\n" +
	"\fproduct_name\x18\x01 \x01(\tR\vproductName\x12Q\n" +
	"\x06values\x18\x02 \x03(\v29.steam.CAccountHardware_VRCompatibilityCheck_Request.PairR\x06values\x1a.\n" +
	"\x04Pair\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"\xf0\x02\n" +
	".CAccountHardware_VRCompatibilityCheck_Response\x12R\n" +
	"\x06values\x18\x01 \x03(\v2:.steam.CAccountHardware_VRCompatibilityCheck_Response.PairR\x06values\x12f\n" +
	"\n" +
	"components\x18\x02 \x03(\v2F.steam.CAccountHardware_VRCompatibilityCheck_Response.ComponentDisplayR\n" +
	"components\x1a.\n" +
	"\x04Pair\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x05value\x18\x03 \x01(\tR\x05value\"\xdf\x02\n" +
	...
	"\x0ecomponent_code\x18\x03 \x01(\tR\rcomponentCode\x12a\n" +
	"\x0ecomponent_type\x18\x04 \x01(\x0e2\x1b.steam.EValveIndexComponent:\x1dk_EValveIndexComponentUnknownR\rcomponentType\x12:\n" +
	...
	"\x0fjson_components\x18\x01 \x01(\tR\x0ejsonComponents\"\xbf\x01\n" +
	"%CAccountHardware_SaveHardware_Request\x12#\n" +
	"\rfriendly_name\x18\x01 \x01(\tR\ffriendlyName\x12=\n" +
	"\vsystem_info\x18\x02 \x01(\v2\x1c.steam.UserSystemInformationR\n" +
	"systemInfo\x122\n" +
	...
	"\asteamid\x18\x01 \x01(\x06R\asteamid\"\x8a\x02\n" +
	...
	"\x13hardware_cluster_id\x18\x04 \x01(\x04R\x11hardwareClusterId\x12=\n" +
	"\vsystem_info\x18\x05 \x01(\v2\x1c.steam.UserSystemInformationR\n" +
	"systemInfo\"\x86\x01\n" +
	".CAccountHardware_GetSavedHardwareList_Response\x12T\n" +
	"\x0esaved_hardware\x18\x01 \x03(\v2-.steam.CAccountHardware_SavedHardware_DetailsR\rsavedHardware\"w\n" +
	...
	"/k_EValveIndexComponentSteamFrameWirelessAdapter\x10\a2\xb7\x12\n" +
	"\x0fAccountHardware\x12\x8c\x01\n" +
	"\x17RegisterSteamController\x127.steam.CAccountHardware_RegisterSteamController_Request\x1a8.steam.CAccountHardware_RegisterSteamController_Response\x12\xb0\x01\n" +
	"#CompleteSteamControllerRegistration\x12C.steam.CAccountHardware_CompleteSteamControllerRegistration_Request\x1aD.steam.CAccountHardware_CompleteSteamControllerRegistration_Response\x12\xa8\x01\n" +
	"#QueryAccountsRegisteredToController\x12?.steam.CAccountHardware_QueryAccountsRegisteredToSerial_Request\x1a@.steam.CAccountHardware_QueryAccountsRegisteredToSerial_Response\x12\x98\x01\n" +
	"\x1bUpdateControllerUsageReport\x12;.steam.CAccountHardware_UpdateControllerUsageReport_Request\x1a<.steam.CAccountHardware_UpdateControllerUsageReport_Response\x12\x97\x01\n" +
	" SetDesiredControllerConfigForApp\x128.steam.CAccountHardware_SteamControllerSetConfig_Request\x1a9.steam.CAccountHardware_SteamControllerSetConfig_Response\x12\x97\x01\n" +
	" GetDesiredControllerConfigForApp\x128.steam.CAccountHardware_SteamControllerGetConfig_Request\x1a9.steam.CAccountHardware_SteamControllerGetConfig_Response\x12\x92\x01\n" +
	"\x19DeRegisterSteamController\x129.steam.CAccountHardware_DeRegisterSteamController_Request\x1a:.steam.CAccountHardware_DeRegisterSteamController_Response\x12\x93\x01\n" +
	" SetControllerPersonalizationFile\x126.steam.CAccountHardware_SetPersonalizationFile_Request\x1a7.steam.CAccountHardware_SetPersonalizationFile_Response\x12\x93\x01\n" +
	" GetControllerPersonalizationFile\x126.steam.CAccountHardware_GetPersonalizationFile_Request\x1a7.steam.CAccountHardware_GetPersonalizationFile_Response\x12\x83\x01\n" +
	"\x14VRCompatibilityCheck\x124.steam.CAccountHardware_VRCompatibilityCheck_Request\x1a5.steam.CAccountHardware_VRCompatibilityCheck_Response\x12\x98\x01\n" +
	"\x1bRegisterValveIndexComponent\x12;.steam.CAccountHardware_RegisterValveIndexComponent_Request\x1a<.steam.CAccountHardware_RegisterValveIndexComponent_Response\x12\x89\x01\n" +
	"\x16GetSteamDeckComponents\x126.steam.CAccountHardware_GetSteamDeckComponents_Request\x1a7.steam.CAccountHardware_GetSteamDeckComponents_Response\x12k\n" +
	"\fSaveHardware\x12,.steam.CAccountHardware_SaveHardware_Request\x1a-.steam.CAccountHardware_SaveHardware_Response\x12\x80\x01\n" +
	"\x13ManageSavedHardware\x123.steam.CAccountHardware_ManageSavedHardware_Request\x1a4.steam.CAccountHardware_ManageSavedHardware_Response\x12\x83\x01\n" +
	"\x14GetSavedHardwareList\x124.steam.CAccountHardware_GetSavedHardwareList_Request\x1a5.steam.CAccountHardware_GetSavedHardwareList_Response\x12\x83\x01\n" +
	"\x14RegisterSteamMachine\x124.steam.CAccountHardware_RegisterSteamMachine_Request\x1a5.steam.CAccountHardware_RegisterSteamMachine_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_accounthardware_steamclient_proto_goTypes = []any{
	...
	(*CAccountHardware_UpdateControllerUsageReport_Request)(nil),            // 8: steam.CAccountHardware_UpdateControllerUsageReport_Request
	(*CAccountHardware_UpdateControllerUsageReport_Response)(nil),           // 9: steam.CAccountHardware_UpdateControllerUsageReport_Response
	(*CAccountHardware_SteamControllerSetConfig_ControllerConfig)(nil),      // 10: steam.CAccountHardware_SteamControllerSetConfig_ControllerConfig
	(*CAccountHardware_SteamControllerSetConfig_Request)(nil),               // 11: steam.CAccountHardware_SteamControllerSetConfig_Request
	(*CAccountHardware_SteamControllerSetConfig_Response)(nil),              // 12: steam.CAccountHardware_SteamControllerSetConfig_Response
	(*CAccountHardware_SteamControllerGetConfig_Request)(nil),               // 13: steam.CAccountHardware_SteamControllerGetConfig_Request
	(*CAccountHardware_SteamControllerGetConfig_ControllerConfig)(nil),      // 14: steam.CAccountHardware_SteamControllerGetConfig_ControllerConfig
	(*CAccountHardware_SteamControllerGetConfig_Response)(nil),              // 15: steam.CAccountHardware_SteamControllerGetConfig_Response
	(*CAccountHardware_DeRegisterSteamController_Request)(nil),              // 16: steam.CAccountHardware_DeRegisterSteamController_Request
	(*CAccountHardware_DeRegisterSteamController_Response)(nil),             // 17: steam.CAccountHardware_DeRegisterSteamController_Response
	(*CAccountHardware_SetPersonalizationFile_Request)(nil),                 // 18: steam.CAccountHardware_SetPersonalizationFile_Request
	(*CAccountHardware_SetPersonalizationFile_Response)(nil),                // 19: steam.CAccountHardware_SetPersonalizationFile_Response
	(*CAccountHardware_GetPersonalizationFile_Request)(nil),                 // 20: steam.CAccountHardware_GetPersonalizationFile_Request
	(*CAccountHardware_GetPersonalizationFile_Response)(nil),                // 21: steam.CAccountHardware_GetPersonalizationFile_Response
	(*CAccountHardware_VRCompatibilityCheck_Request)(nil),                   // 22: steam.CAccountHardware_VRCompatibilityCheck_Request
	(*CAccountHardware_VRCompatibilityCheck_Response)(nil),                  // 23: steam.CAccountHardware_VRCompatibilityCheck_Response
	(*CAccountHardware_RegisterValveIndexComponent_Request)(nil),            // 24: steam.CAccountHardware_RegisterValveIndexComponent_Request
	(*CAccountHardware_RegisterValveIndexComponent_Response)(nil),           // 25: steam.CAccountHardware_RegisterValveIndexComponent_Response
	(*CAccountHardware_GetSteamDeckComponents_Request)(nil),                 // 26: steam.CAccountHardware_GetSteamDeckComponents_Request
	(*CAccountHardware_GetSteamDeckComponents_Response)(nil),                // 27: steam.CAccountHardware_GetSteamDeckComponents_Response
	(*CAccountHardware_SaveHardware_Request)(nil),                           // 28: steam.CAccountHardware_SaveHardware_Request
	(*CAccountHardware_SaveHardware_Response)(nil),                          // 29: steam.CAccountHardware_SaveHardware_Response
	(*CAccountHardware_ManageSavedHardware_Request)(nil),                    // 30: steam.CAccountHardware_ManageSavedHardware_Request
	(*CAccountHardware_ManageSavedHardware_Response)(nil),                   // 31: steam.CAccountHardware_ManageSavedHardware_Response
	(*CAccountHardware_GetSavedHardwareList_Request)(nil),                   // 32: steam.CAccountHardware_GetSavedHardwareList_Request
	(*CAccountHardware_SavedHardware_Details)(nil),                          // 33: steam.CAccountHardware_SavedHardware_Details
	(*CAccountHardware_GetSavedHardwareList_Response)(nil),                  // 34: steam.CAccountHardware_GetSavedHardwareList_Response
	(*CAccountHardware_RegisterSteamMachine_Request)(nil),                   // 35: steam.CAccountHardware_RegisterSteamMachine_Request
	(*CAccountHardware_RegisterSteamMachine_Response)(nil),                  // 36: steam.CAccountHardware_RegisterSteamMachine_Response
	(*CAccountHardware_UpdateControllerUsageReport_Request_Controller)(nil), // 37: steam.CAccountHardware_UpdateControllerUsageReport_Request.Controller
	(*CAccountHardware_VRCompatibilityCheck_Request_Pair)(nil),              // 38: steam.CAccountHardware_VRCompatibilityCheck_Request.Pair
	(*CAccountHardware_VRCompatibilityCheck_Response_Pair)(nil),             // 39: steam.CAccountHardware_VRCompatibilityCheck_Response.Pair
	(*CAccountHardware_VRCompatibilityCheck_Response_ComponentDisplay)(nil), // 40: steam.CAccountHardware_VRCompatibilityCheck_Response.ComponentDisplay
	(*UserSystemInformation)(nil),                                           // 41: steam.UserSystemInformation
}
var file_steammessages_accounthardware_steamclient_proto_depIdxs = []int32{
	...
	37, // 1: steam.CAccountHardware_UpdateControllerUsageReport_Request.controllers:type_name -> steam.CAccountHardware_UpdateControllerUsageReport_Request.Controller
	10, // 2: steam.CAccountHardware_SteamControllerSetConfig_Request.configurations:type_name -> steam.CAccountHardware_SteamControllerSetConfig_ControllerConfig
	14, // 3: steam.CAccountHardware_SteamControllerGetConfig_Response.configurations:type_name -> steam.CAccountHardware_SteamControllerGetConfig_ControllerConfig
	38, // 4: steam.CAccountHardware_VRCompatibilityCheck_Request.values:type_name -> steam.CAccountHardware_VRCompatibilityCheck_Request.Pair
	39, // 5: steam.CAccountHardware_VRCompatibilityCheck_Response.values:type_name -> steam.CAccountHardware_VRCompatibilityCheck_Response.Pair
	40, // 6: steam.CAccountHardware_VRCompatibilityCheck_Response.components:type_name -> steam.CAccountHardware_VRCompatibilityCheck_Response.ComponentDisplay
	0,  // 7: steam.CAccountHardware_RegisterValveIndexComponent_Request.component_type:type_name -> steam.EValveIndexComponent
	41, // 8: steam.CAccountHardware_SaveHardware_Request.system_info:type_name -> steam.UserSystemInformation
	41, // 9: steam.CAccountHardware_SavedHardware_Details.system_info:type_name -> steam.UserSystemInformation
	33, // 10: steam.CAccountHardware_GetSavedHardwareList_Response.saved_hardware:type_name -> steam.CAccountHardware_SavedHardware_Details
	1,  // 11: steam.AccountHardware.RegisterSteamController:input_type -> steam.CAccountHardware_RegisterSteamController_Request
	3,  // 12: steam.AccountHardware.CompleteSteamControllerRegistration:input_type -> steam.CAccountHardware_CompleteSteamControllerRegistration_Request
	5,  // 13: steam.AccountHardware.QueryAccountsRegisteredToController:input_type -> steam.CAccountHardware_QueryAccountsRegisteredToSerial_Request
	8,  // 14: steam.AccountHardware.UpdateControllerUsageReport:input_type -> steam.CAccountHardware_UpdateControllerUsageReport_Request
	11, // 15: steam.AccountHardware.SetDesiredControllerConfigForApp:input_type -> steam.CAccountHardware_SteamControllerSetConfig_Request
	13, // 16: steam.AccountHardware.GetDesiredControllerConfigForApp:input_type -> steam.CAccountHardware_SteamControllerGetConfig_Request
	16, // 17: steam.AccountHardware.DeRegisterSteamController:input_type -> steam.CAccountHardware_DeRegisterSteamController_Request
	18, // 18: steam.AccountHardware.SetControllerPersonalizationFile:input_type -> steam.CAccountHardware_SetPersonalizationFile_Request
	20, // 19: steam.AccountHardware.GetControllerPersonalizationFile:input_type -> steam.CAccountHardware_GetPersonalizationFile_Request
	22, // 20: steam.AccountHardware.VRCompatibilityCheck:input_type -> steam.CAccountHardware_VRCompatibilityCheck_Request
	24, // 21: steam.AccountHardware.RegisterValveIndexComponent:input_type -> steam.CAccountHardware_RegisterValveIndexComponent_Request
	26, // 22: steam.AccountHardware.GetSteamDeckComponents:input_type -> steam.CAccountHardware_GetSteamDeckComponents_Request
	28, // 23: steam.AccountHardware.SaveHardware:input_type -> steam.CAccountHardware_SaveHardware_Request
	30, // 24: steam.AccountHardware.ManageSavedHardware:input_type -> steam.CAccountHardware_ManageSavedHardware_Request
	32, // 25: steam.AccountHardware.GetSavedHardwareList:input_type -> steam.CAccountHardware_GetSavedHardwareList_Request
	35, // 26: steam.AccountHardware.RegisterSteamMachine:input_type -> steam.CAccountHardware_RegisterSteamMachine_Request
	2,  // 27: steam.AccountHardware.RegisterSteamController:output_type -> steam.CAccountHardware_RegisterSteamController_Response
	4,  // 28: steam.AccountHardware.CompleteSteamControllerRegistration:output_type -> steam.CAccountHardware_CompleteSteamControllerRegistration_Response
	7,  // 29: steam.AccountHardware.QueryAccountsRegisteredToController:output_type -> steam.CAccountHardware_QueryAccountsRegisteredToSerial_Response
	9,  // 30: steam.AccountHardware.UpdateControllerUsageReport:output_type -> steam.CAccountHardware_UpdateControllerUsageReport_Response
	12, // 31: steam.AccountHardware.SetDesiredControllerConfigForApp:output_type -> steam.CAccountHardware_SteamControllerSetConfig_Response
	15, // 32: steam.AccountHardware.GetDesiredControllerConfigForApp:output_type -> steam.CAccountHardware_SteamControllerGetConfig_Response
	17, // 33: steam.AccountHardware.DeRegisterSteamController:output_type -> steam.CAccountHardware_DeRegisterSteamController_Response
	19, // 34: steam.AccountHardware.SetControllerPersonalizationFile:output_type -> steam.CAccountHardware_SetPersonalizationFile_Response
	21, // 35: steam.AccountHardware.GetControllerPersonalizationFile:output_type -> steam.CAccountHardware_GetPersonalizationFile_Response
	23, // 36: steam.AccountHardware.VRCompatibilityCheck:output_type -> steam.CAccountHardware_VRCompatibilityCheck_Response
	25, // 37: steam.AccountHardware.RegisterValveIndexComponent:output_type -> steam.CAccountHardware_RegisterValveIndexComponent_Response
	27, // 38: steam.AccountHardware.GetSteamDeckComponents:output_type -> steam.CAccountHardware_GetSteamDeckComponents_Response
	29, // 39: steam.AccountHardware.SaveHardware:output_type -> steam.CAccountHardware_SaveHardware_Response
	31, // 40: steam.AccountHardware.ManageSavedHardware:output_type -> steam.CAccountHardware_ManageSavedHardware_Response
	34, // 41: steam.AccountHardware.GetSavedHardwareList:output_type -> steam.CAccountHardware_GetSavedHardwareList_Response
	36, // 42: steam.AccountHardware.RegisterSteamMachine:output_type -> steam.CAccountHardware_RegisterSteamMachine_Response
