...
type FamilyGroupMember struct {
	...
	Role                     *EFamilyGroupRole      `protobuf:"varint,2,opt,name=role,enum=steam.EFamilyGroupRole,def=0" json:"role,omitempty"`
...
type CFamilyGroups_InviteToFamilyGroup_Request struct {
	...
	ReceiverRole    *EFamilyGroupRole      `protobuf:"varint,3,opt,name=receiver_role,json=receiverRole,enum=steam.EFamilyGroupRole,def=0" json:"receiver_role,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type CFamilyGroups_InviteToFamilyGroup_Response struct {
	...
	TwoFactorMethod *EFamilyGroupsTwoFactorMethod `protobuf:"varint,2,opt,name=two_factor_method,json=twoFactorMethod,enum=steam.EFamilyGroupsTwoFactorMethod,def=0" json:"two_factor_method,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type PurchaseRequest struct {
	...
	ResponseAction      *EPurchaseRequestAction `protobuf:"varint,6,opt,name=response_action,json=responseAction,enum=steam.EPurchaseRequestAction,def=0" json:"response_action,omitempty"`
...
type CFamilyGroups_RespondToRequestedPurchase_Request struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	FamilyGroupid *uint64                 `protobuf:"varint,1,opt,name=family_groupid,json=familyGroupid" json:"family_groupid,omitempty"`
	Action        *EPurchaseRequestAction `protobuf:"varint,3,opt,name=action,enum=steam.EPurchaseRequestAction,def=0" json:"action,omitempty"`
...
type CFamilyGroups_GetChangeLog_Response_Change struct {
	...
	Type          *EFamilyGroupChangeLogType `protobuf:"varint,3,opt,name=type,enum=steam.EFamilyGroupChangeLogType,def=0" json:"type,omitempty"`
...
type CFamilyGroups_GetSharedLibraryApps_Response_SharedApp struct {
	...
	ExcludeReason      *ESharedLibraryExcludeReason `protobuf:"varint,10,opt,name=exclude_reason,json=excludeReason,enum=steam.ESharedLibraryExcludeReason,def=0" json:"exclude_reason,omitempty"`
	...
	AppType            *EProtoAppType               `protobuf:"varint,14,opt,name=app_type,json=appType,enum=steam.EProtoAppType,def=1" json:"app_type,omitempty"`
...
const file_steammessages_familygroups_steamclient_proto_rawDesc = "" +
	"\n" +
	",steammessages_familygroups.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\x1a\venums.proto\"W\n" +
	...
	"\x11send_running_apps\x18\x02 \x01(\bR\x0fsendRunningApps\"\xd2\x01\n" +
	"\x11FamilyGroupMember\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12D\n" +
	"\x04role\x18\x02 \x01(\x0e2\x17.steam.EFamilyGroupRole:\x17k_EFamilyGroupRole_NoneR\x04role\x12\x1f\n" +
	"\vtime_joined\x18\x03 \x01(\rR\n" +
	"timeJoined\x12<\n" +
	"\x1acooldown_seconds_remaining\x18\x04 \x01(\rR\x18cooldownSecondsRemaining\"z\n" +
	"\x18FamilyGroupPendingInvite\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12D\n" +
	"\x04role\x18\x02 \x01(\x0e2\x17.steam.EFamilyGroupRole:\x17k_EFamilyGroupRole_NoneR\x04role\"3\n" +
	"\x17FamilyGroupFormerMember\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\"\xb8\x03\n" +
	"%CFamilyGroups_GetFamilyGroup_Response\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x122\n" +
	"\amembers\x18\x02 \x03(\v2\x18.steam.FamilyGroupMemberR\amembers\x12H\n" +
	"\x0fpending_invites\x18\x03 \x03(\v2\x1f.steam.FamilyGroupPendingInviteR\x0ependingInvites\x12\x1d\n" +
	"\n" +
	"free_spots\x18\x04 \x01(\rR\tfreeSpots\x12\x18\n" +
	"\acountry\x18\x05 \x01(\tR\acountry\x12E\n" +
	"\x1fslot_cooldown_remaining_seconds\x18\x06 \x01(\rR\x1cslotCooldownRemainingSeconds\x12E\n" +
	"\x0eformer_members\x18\a \x03(\v2\x1e.steam.FamilyGroupFormerMemberR\rformerMembers\x126\n" +
	...
	"\x1dinclude_family_group_response\x18\x02 \x01(\bR\x1aincludeFamilyGroupResponse\"\xf7\x01\n" +
	"\x1fFamilyGroupPendingInviteForUser\x12%\n" +
	"\x0efamily_groupid\x18\x01 \x01(\x04R\rfamilyGroupid\x12D\n" +
	"\x04role\x18\x02 \x01(\x0e2\x17.steam.EFamilyGroupRole:\x17k_EFamilyGroupRole_NoneR\x04role\x12'\n" +
	...
	"\fparticipated\x18\x05 \x01(\bR\fparticipated\"\x91\x05\n" +
	...
	"\x1clatest_joined_family_groupid\x18\x04 \x01(\x04R\x19latestJoinedFamilyGroupid\x12Z\n" +
	"\x15pending_group_invites\x18\x05 \x03(\v2&.steam.FamilyGroupPendingInviteForUserR\x13pendingGroupInvites\x12\x12\n" +
	"\x04role\x18\x06 \x01(\rR\x04role\x12<\n" +
	"\x1acooldown_seconds_remaining\x18\a \x01(\rR\x18cooldownSecondsRemaining\x12O\n" +
	"\ffamily_group\x18\b \x01(\v2,.steam.CFamilyGroups_GetFamilyGroup_ResponseR\vfamilyGroup\x12D\n" +
	"\x1fcan_undelete_last_joined_family\x18\t \x01(\bR\x1bcanUndeleteLastJoinedFamily\x12K\n" +
	"\x12membership_history\x18\n" +
	" \x03(\v2\x1c.steam.FamilyGroupMembershipR\x11membershipHistory\"k\n" +
	...
	"/CFamilyGroups_ModifyFamilyGroupDetails_Response\"\xd4\x01\n" +
	")CFamilyGroups_InviteToFamilyGroup_Request\x12%\n" +
	"\x0efamily_groupid\x18\x01 \x01(\x04R\rfamilyGroupid\x12)\n" +
	"\x10receiver_steamid\x18\x02 \x01(\x06R\x0freceiverSteamid\x12U\n" +
	"\rreceiver_role\x18\x03 \x01(\x0e2\x17.steam.EFamilyGroupRole:\x17k_EFamilyGroupRole_NoneR\freceiverRole\"\xbe\x01\n" +
	"*CFamilyGroups_InviteToFamilyGroup_Response\x12\x1b\n" +
	"\tinvite_id\x18\x01 \x01(\x04R\binviteId\x12s\n" +
	"\x11two_factor_method\x18\x02 \x01(\x0e2#.steam.EFamilyGroupsTwoFactorMethod:\"k_EFamilyGroupsTwoFactorMethodNoneR\x0ftwoFactorMethod\"\x8c\x01\n" +
	...
	"\x05nonce\x18\x02 \x01(\x04R\x05nonce\"\xc7\x02\n" +
	"&CFamilyGroups_JoinFamilyGroup_Response\x12s\n" +
	"\x11two_factor_method\x18\x02 \x01(\x0e2#.steam.EFamilyGroupsTwoFactorMethod:\"k_EFamilyGroupsTwoFactorMethodNoneR\x0ftwoFactorMethod\x122\n" +
	...
	"\x0eseconds_played\x18\x05 \x01(\rR\rsecondsPlayed\"\xb7\x01\n" +
	")CFamilyGroups_GetPlaytimeSummary_Response\x12<\n" +
	"\aentries\x18\x01 \x03(\v2\".steam.CFamilyGroups_PlaytimeEntryR\aentries\x12L\n" +
	"\x10entries_by_owner\x18\x02 \x03(\v2\".steam.CFamilyGroups_PlaytimeEntryR\x0eentriesByOwner\"\xd0\x01\n" +
	...
	"requestIds\x12;\n" +
	"\x1art_include_completed_since\x18\x04 \x01(\rR\x17rtIncludeCompletedSince\"\xd4\x04\n" +
	...
	"\x11responder_steamid\x18\x05 \x01(\x06R\x10responderSteamid\x12e\n" +
	"\x0fresponse_action\x18\x06 \x01(\x0e2\x1d.steam.EPurchaseRequestAction:\x1dk_EPurchaseRequestAction_NoneR\x0eresponseAction\x12!\n" +
	...
	"\x13purchased_bundleids\x18\f \x03(\rR\x12purchasedBundleids\"`\n" +
	"*CFamilyGroups_GetPurchaseRequests_Response\x122\n" +
	"\brequests\x18\x01 \x03(\v2\x16.steam.PurchaseRequestR\brequests\"\xce\x01\n" +
	"0CFamilyGroups_RespondToRequestedPurchase_Request\x12%\n" +
	"\x0efamily_groupid\x18\x01 \x01(\x04R\rfamilyGroupid\x12T\n" +
	"\x06action\x18\x03 \x01(\x0e2\x1d.steam.EPurchaseRequestAction:\x1dk_EPurchaseRequestAction_NoneR\x06action\x12\x1d\n" +
	"\n" +
	...
	"\x0efamily_groupid\x18\x01 \x01(\x04R\rfamilyGroupid\"\xbe\x02\n" +
	"#CFamilyGroups_GetChangeLog_Response\x12K\n" +
	"\achanges\x18\x01 \x03(\v21.steam.CFamilyGroups_GetChangeLog_Response.ChangeR\achanges\x1a\xc9\x01\n" +
	"\x06Change\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\x06R\ttimestamp\x12#\n" +
	"\ractor_steamid\x18\x02 \x01(\x06R\factorSteamid\x12I\n" +
	"\x04type\x18\x03 \x01(\x0e2 .steam.EFamilyGroupChangeLogType:\x13k_InvalidChangeTypeR\x04type\x12\x12\n" +
	...
	"\asteamid\x18\b \x01(\x06R\asteamid\"\xb4\x05\n" +
	"+CFamilyGroups_GetSharedLibraryApps_Response\x12P\n" +
	"\x04apps\x18\x01 \x03(\v2<.steam.CFamilyGroups_GetSharedLibraryApps_Response.SharedAppR\x04apps\x12#\n" +
	"\rowner_steamid\x18\x02 \x01(\x06R\fownerSteamid\x1a\x8d\x04\n" +
	"\tSharedApp\x12\x14\n" +
	...
	"\rimg_icon_hash\x18\t \x01(\tR\vimgIconHash\x12d\n" +
	"\x0eexclude_reason\x18\n" +
	" \x01(\x0e2\".steam.ESharedLibraryExcludeReason:\x19k_ESharedLibrary_IncludedR\rexcludeReason\x12(\n" +
	...
	"rtPlaytime\x12?\n" +
	"\bapp_type\x18\x0e \x01(\x0e2\x14.steam.EProtoAppType:\x0ek_EAppTypeGameR\aappType\x12/\n" +
	...
	"\x0efamily_groupid\x18\x01 \x01(\x04R\rfamilyGroupid\"\xdb\x01\n" +
	"*CFamilyGroups_GetPreferredLenders_Response\x12X\n" +
	"\amembers\x18\x01 \x03(\v2>.steam.CFamilyGroups_GetPreferredLenders_Response.FamilyMemberR\amembers\x1aS\n" +
	...
	"*CFamilyGroups_RollbackFamilyGroup_Response\"\xb8\x03\n" +
	"2CFamilyGroupsClient_NotifyRunningApps_Notification\x12%\n" +
	"\x0efamily_groupid\x18\x01 \x01(\x04R\rfamilyGroupid\x12g\n" +
	"\frunning_apps\x18\x02 \x03(\v2D.steam.CFamilyGroupsClient_NotifyRunningApps_Notification.RunningAppR\vrunningApps\x1a[\n" +
	"\rPlayingMember\x12%\n" +
	"\x0emember_steamid\x18\x01 \x01(\x06R\rmemberSteamid\x12#\n" +
	"\rowner_steamid\x18\x02 \x01(\x06R\fownerSteamid\x1a\x94\x01\n" +
	"\n" +
	"RunningApp\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12p\n" +
	"\x0fplaying_members\x18\x03 \x03(\v2G.steam.CFamilyGroupsClient_NotifyRunningApps_Notification.PlayingMemberR\x0eplayingMembers\"/\n" +
	...
	")k_ESharedLibrary_LicenseExcluded_Inactive\x10\x1e2\xef\x1a\n" +
	"\fFamilyGroups\x12t\n" +
	"\x11CreateFamilyGroup\x12..steam.CFamilyGroups_CreateFamilyGroup_Request\x1a/.steam.CFamilyGroups_CreateFamilyGroup_Response\x12k\n" +
	"\x0eGetFamilyGroup\x12+.steam.CFamilyGroups_GetFamilyGroup_Request\x1a,.steam.CFamilyGroups_GetFamilyGroup_Response\x12\x80\x01\n" +
	"\x15GetFamilyGroupForUser\x122.steam.CFamilyGroups_GetFamilyGroupForUser_Request\x1a3.steam.CFamilyGroups_GetFamilyGroupForUser_Response\x12\x89\x01\n" +
	"\x18ModifyFamilyGroupDetails\x125.steam.CFamilyGroups_ModifyFamilyGroupDetails_Request\x1a6.steam.CFamilyGroups_ModifyFamilyGroupDetails_Response\x12z\n" +
	"\x13InviteToFamilyGroup\x120.steam.CFamilyGroups_InviteToFamilyGroup_Request\x1a1.steam.CFamilyGroups_InviteToFamilyGroup_Response\x12\x8f\x01\n" +
	"\x1aConfirmInviteToFamilyGroup\x127.steam.CFamilyGroups_ConfirmInviteToFamilyGroup_Request\x1a8.steam.CFamilyGroups_ConfirmInviteToFamilyGroup_Response\x12\x98\x01\n" +
	"\x1dResendInvitationToFamilyGroup\x12:.steam.CFamilyGroups_ResendInvitationToFamilyGroup_Request\x1a;.steam.CFamilyGroups_ResendInvitationToFamilyGroup_Response\x12n\n" +
	"\x0fJoinFamilyGroup\x12,.steam.CFamilyGroups_JoinFamilyGroup_Request\x1a-.steam.CFamilyGroups_JoinFamilyGroup_Response\x12\x83\x01\n" +
	"\x16ConfirmJoinFamilyGroup\x123.steam.CFamilyGroups_ConfirmJoinFamilyGroup_Request\x1a4.steam.CFamilyGroups_ConfirmJoinFamilyGroup_Response\x12\x80\x01\n" +
	"\x15RemoveFromFamilyGroup\x122.steam.CFamilyGroups_RemoveFromFamilyGroup_Request\x1a3.steam.CFamilyGroups_RemoveFromFamilyGroup_Response\x12\x86\x01\n" +
	"\x17CancelFamilyGroupInvite\x124.steam.CFamilyGroups_CancelFamilyGroupInvite_Request\x1a5.steam.CFamilyGroups_CancelFamilyGroupInvite_Response\x12\x80\x01\n" +
	"\x15GetUsersSharingDevice\x122.steam.CFamilyGroups_GetUsersSharingDevice_Request\x1a3.steam.CFamilyGroups_GetUsersSharingDevice_Response\x12t\n" +
	"\x11DeleteFamilyGroup\x12..steam.CFamilyGroups_DeleteFamilyGroup_Request\x1a/.steam.CFamilyGroups_DeleteFamilyGroup_Response\x12z\n" +
	"\x13UndeleteFamilyGroup\x120.steam.CFamilyGroups_UndeleteFamilyGroup_Request\x1a1.steam.CFamilyGroups_UndeleteFamilyGroup_Response\x12w\n" +
	"\x12GetPlaytimeSummary\x12/.steam.CFamilyGroups_GetPlaytimeSummary_Request\x1a0.steam.CFamilyGroups_GetPlaytimeSummary_Response\x12n\n" +
	"\x0fRequestPurchase\x12,.steam.CFamilyGroups_RequestPurchase_Request\x1a-.steam.CFamilyGroups_RequestPurchase_Response\x12z\n" +
	"\x13GetPurchaseRequests\x120.steam.CFamilyGroups_GetPurchaseRequests_Request\x1a1.steam.CFamilyGroups_GetPurchaseRequests_Response\x12\x8f\x01\n" +
	"\x1aRespondToRequestedPurchase\x127.steam.CFamilyGroups_RespondToRequestedPurchase_Request\x1a8.steam.CFamilyGroups_RespondToRequestedPurchase_Response\x12e\n" +
	"\fGetChangeLog\x12).steam.CFamilyGroups_GetChangeLog_Request\x1a*.steam.CFamilyGroups_GetChangeLog_Response\x12\x8f\x01\n" +
	"\x1aSetFamilyCooldownOverrides\x127.steam.CFamilyGroups_SetFamilyCooldownOverrides_Request\x1a8.steam.CFamilyGroups_SetFamilyCooldownOverrides_Response\x12}\n" +
	"\x14GetSharedLibraryApps\x121.steam.CFamilyGroups_GetSharedLibraryApps_Request\x1a2.steam.CFamilyGroups_GetSharedLibraryApps_Response\x12w\n" +
	"\x12SetPreferredLender\x12/.steam.CFamilyGroups_SetPreferredLender_Request\x1a0.steam.CFamilyGroups_SetPreferredLender_Response\x12z\n" +
	"\x13GetPreferredLenders\x120.steam.CFamilyGroups_GetPreferredLenders_Request\x1a1.steam.CFamilyGroups_GetPreferredLenders_Response\x12t\n" +
	"\x11ForceAcceptInvite\x12..steam.CFamilyGroups_ForceAcceptInvite_Request\x1a/.steam.CFamilyGroups_ForceAcceptInvite_Response\x12\x80\x01\n" +
	"\x15GetInviteCheckResults\x122.steam.CFamilyGroups_GetInviteCheckResults_Request\x1a3.steam.CFamilyGroups_GetInviteCheckResults_Response\x12t\n" +
	"\x11ClearCooldownSkip\x12..steam.CFamilyGroups_ClearCooldownSkip_Request\x1a/.steam.CFamilyGroups_ClearCooldownSkip_Response\x12z\n" +
	"\x13RollbackFamilyGroup\x120.steam.CFamilyGroups_RollbackFamilyGroup_Request\x1a1.steam.CFamilyGroups_RollbackFamilyGroup_Response2\xbb\x02\n" +
	"\x12FamilyGroupsClient\x12a\n" +
	"\x11NotifyRunningApps\x129.steam.CFamilyGroupsClient_NotifyRunningApps_Notification\x1a\x11.steam.NoResponse\x12]\n" +
	"\x12NotifyInviteStatus\x124.steam.CFamilyGroupsClient_InviteStatus_Notification\x1a\x11.steam.NoResponse\x12]\n" +
	"\x12NotifyGroupChanged\x124.steam.CFamilyGroupsClient_GroupChanged_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x02B3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_familygroups_steamclient_proto_goTypes = []any{
	(EFamilyGroupRole)(0),                                                    // 0: steam.EFamilyGroupRole
	(EFamilyGroupsTwoFactorMethod)(0),                                        // 1: steam.EFamilyGroupsTwoFactorMethod
	(EPurchaseRequestAction)(0),                                              // 2: steam.EPurchaseRequestAction
	(EFamilyGroupChangeLogType)(0),                                           // 3: steam.EFamilyGroupChangeLogType
	(ESharedLibraryExcludeReason)(0),                                         // 4: steam.ESharedLibraryExcludeReason
	(*CFamilyGroups_CreateFamilyGroup_Request)(nil),                          // 5: steam.CFamilyGroups_CreateFamilyGroup_Request
	(*CFamilyGroups_CreateFamilyGroup_Response)(nil),                         // 6: steam.CFamilyGroups_CreateFamilyGroup_Response
	(*CFamilyGroups_GetFamilyGroup_Request)(nil),                             // 7: steam.CFamilyGroups_GetFamilyGroup_Request
	(*FamilyGroupMember)(nil),                                                // 8: steam.FamilyGroupMember
	(*FamilyGroupPendingInvite)(nil),                                         // 9: steam.FamilyGroupPendingInvite
	(*FamilyGroupFormerMember)(nil),                                          // 10: steam.FamilyGroupFormerMember
	(*CFamilyGroups_GetFamilyGroup_Response)(nil),                            // 11: steam.CFamilyGroups_GetFamilyGroup_Response
	(*CFamilyGroups_GetFamilyGroupForUser_Request)(nil),                      // 12: steam.CFamilyGroups_GetFamilyGroupForUser_Request
	(*FamilyGroupPendingInviteForUser)(nil),                                  // 13: steam.FamilyGroupPendingInviteForUser
	(*FamilyGroupMembership)(nil),                                            // 14: steam.FamilyGroupMembership
	(*CFamilyGroups_GetFamilyGroupForUser_Response)(nil),                     // 15: steam.CFamilyGroups_GetFamilyGroupForUser_Response
	(*CFamilyGroups_ModifyFamilyGroupDetails_Request)(nil),                   // 16: steam.CFamilyGroups_ModifyFamilyGroupDetails_Request
	(*CFamilyGroups_ModifyFamilyGroupDetails_Response)(nil),                  // 17: steam.CFamilyGroups_ModifyFamilyGroupDetails_Response
	(*CFamilyGroups_InviteToFamilyGroup_Request)(nil),                        // 18: steam.CFamilyGroups_InviteToFamilyGroup_Request
	(*CFamilyGroups_InviteToFamilyGroup_Response)(nil),                       // 19: steam.CFamilyGroups_InviteToFamilyGroup_Response
	(*CFamilyGroups_ConfirmInviteToFamilyGroup_Request)(nil),                 // 20: steam.CFamilyGroups_ConfirmInviteToFamilyGroup_Request
	(*CFamilyGroups_ConfirmInviteToFamilyGroup_Response)(nil),                // 21: steam.CFamilyGroups_ConfirmInviteToFamilyGroup_Response
	(*CFamilyGroups_ResendInvitationToFamilyGroup_Request)(nil),              // 22: steam.CFamilyGroups_ResendInvitationToFamilyGroup_Request
	(*CFamilyGroups_ResendInvitationToFamilyGroup_Response)(nil),             // 23: steam.CFamilyGroups_ResendInvitationToFamilyGroup_Response
	(*CFamilyGroups_JoinFamilyGroup_Request)(nil),                            // 24: steam.CFamilyGroups_JoinFamilyGroup_Request
	(*CFamilyGroups_JoinFamilyGroup_Response)(nil),                           // 25: steam.CFamilyGroups_JoinFamilyGroup_Response
	(*CFamilyGroups_ConfirmJoinFamilyGroup_Request)(nil),                     // 26: steam.CFamilyGroups_ConfirmJoinFamilyGroup_Request
	(*CFamilyGroups_ConfirmJoinFamilyGroup_Response)(nil),                    // 27: steam.CFamilyGroups_ConfirmJoinFamilyGroup_Response
	(*CFamilyGroups_RemoveFromFamilyGroup_Request)(nil),                      // 28: steam.CFamilyGroups_RemoveFromFamilyGroup_Request
	(*CFamilyGroups_RemoveFromFamilyGroup_Response)(nil),                     // 29: steam.CFamilyGroups_RemoveFromFamilyGroup_Response
	(*CFamilyGroups_CancelFamilyGroupInvite_Request)(nil),                    // 30: steam.CFamilyGroups_CancelFamilyGroupInvite_Request
	(*CFamilyGroups_CancelFamilyGroupInvite_Response)(nil),                   // 31: steam.CFamilyGroups_CancelFamilyGroupInvite_Response
	(*CFamilyGroups_GetUsersSharingDevice_Request)(nil),                      // 32: steam.CFamilyGroups_GetUsersSharingDevice_Request
	(*CFamilyGroups_GetUsersSharingDevice_Response)(nil),                     // 33: steam.CFamilyGroups_GetUsersSharingDevice_Response
	(*CFamilyGroups_DeleteFamilyGroup_Request)(nil),                          // 34: steam.CFamilyGroups_DeleteFamilyGroup_Request
	(*CFamilyGroups_DeleteFamilyGroup_Response)(nil),                         // 35: steam.CFamilyGroups_DeleteFamilyGroup_Response
	(*CFamilyGroups_UndeleteFamilyGroup_Request)(nil),                        // 36: steam.CFamilyGroups_UndeleteFamilyGroup_Request
	(*CFamilyGroups_UndeleteFamilyGroup_Response)(nil),                       // 37: steam.CFamilyGroups_UndeleteFamilyGroup_Response
	(*CFamilyGroups_GetPlaytimeSummary_Request)(nil),                         // 38: steam.CFamilyGroups_GetPlaytimeSummary_Request
	(*CFamilyGroups_PlaytimeEntry)(nil),                                      // 39: steam.CFamilyGroups_PlaytimeEntry
	(*CFamilyGroups_GetPlaytimeSummary_Response)(nil),                        // 40: steam.CFamilyGroups_GetPlaytimeSummary_Response
	(*CFamilyGroups_RequestPurchase_Request)(nil),                            // 41: steam.CFamilyGroups_RequestPurchase_Request
	(*CFamilyGroups_RequestPurchase_Response)(nil),                           // 42: steam.CFamilyGroups_RequestPurchase_Response
	(*CFamilyGroups_GetPurchaseRequests_Request)(nil),                        // 43: steam.CFamilyGroups_GetPurchaseRequests_Request
	(*PurchaseRequest)(nil),                                                  // 44: steam.PurchaseRequest
	(*CFamilyGroups_GetPurchaseRequests_Response)(nil),                       // 45: steam.CFamilyGroups_GetPurchaseRequests_Response
	(*CFamilyGroups_RespondToRequestedPurchase_Request)(nil),                 // 46: steam.CFamilyGroups_RespondToRequestedPurchase_Request
	(*CFamilyGroups_RespondToRequestedPurchase_Response)(nil),                // 47: steam.CFamilyGroups_RespondToRequestedPurchase_Response
	(*CFamilyGroups_GetChangeLog_Request)(nil),                               // 48: steam.CFamilyGroups_GetChangeLog_Request
	(*CFamilyGroups_GetChangeLog_Response)(nil),                              // 49: steam.CFamilyGroups_GetChangeLog_Response
	(*CFamilyGroups_SetFamilyCooldownOverrides_Request)(nil),                 // 50: steam.CFamilyGroups_SetFamilyCooldownOverrides_Request
	(*CFamilyGroups_SetFamilyCooldownOverrides_Response)(nil),                // 51: steam.CFamilyGroups_SetFamilyCooldownOverrides_Response
	(*CFamilyGroups_GetSharedLibraryApps_Request)(nil),                       // 52: steam.CFamilyGroups_GetSharedLibraryApps_Request
	(*CFamilyGroups_GetSharedLibraryApps_Response)(nil),                      // 53: steam.CFamilyGroups_GetSharedLibraryApps_Response
	(*CFamilyGroups_SetPreferredLender_Request)(nil),                         // 54: steam.CFamilyGroups_SetPreferredLender_Request
	(*CFamilyGroups_SetPreferredLender_Response)(nil),                        // 55: steam.CFamilyGroups_SetPreferredLender_Response
	(*CFamilyGroups_GetPreferredLenders_Request)(nil),                        // 56: steam.CFamilyGroups_GetPreferredLenders_Request
	(*CFamilyGroups_GetPreferredLenders_Response)(nil),                       // 57: steam.CFamilyGroups_GetPreferredLenders_Response
	(*CFamilyGroups_ForceAcceptInvite_Request)(nil),                          // 58: steam.CFamilyGroups_ForceAcceptInvite_Request
	(*CFamilyGroups_ForceAcceptInvite_Response)(nil),                         // 59: steam.CFamilyGroups_ForceAcceptInvite_Response
	(*CFamilyGroups_GetInviteCheckResults_Request)(nil),                      // 60: steam.CFamilyGroups_GetInviteCheckResults_Request
	(*CFamilyGroups_GetInviteCheckResults_Response)(nil),                     // 61: steam.CFamilyGroups_GetInviteCheckResults_Response
	(*CFamilyGroups_ClearCooldownSkip_Request)(nil),                          // 62: steam.CFamilyGroups_ClearCooldownSkip_Request
	(*CFamilyGroups_ClearCooldownSkip_Response)(nil),                         // 63: steam.CFamilyGroups_ClearCooldownSkip_Response
	(*CFamilyGroups_RollbackFamilyGroup_Request)(nil),                        // 64: steam.CFamilyGroups_RollbackFamilyGroup_Request
	(*CFamilyGroups_RollbackFamilyGroup_Response)(nil),                       // 65: steam.CFamilyGroups_RollbackFamilyGroup_Response
	(*CFamilyGroupsClient_NotifyRunningApps_Notification)(nil),               // 66: steam.CFamilyGroupsClient_NotifyRunningApps_Notification
	(*CFamilyGroupsClient_InviteStatus_Notification)(nil),                    // 67: steam.CFamilyGroupsClient_InviteStatus_Notification
	(*CFamilyGroupsClient_GroupChanged_Notification)(nil),                    // 68: steam.CFamilyGroupsClient_GroupChanged_Notification
	(*CFamilyGroups_GetChangeLog_Response_Change)(nil),                       // 69: steam.CFamilyGroups_GetChangeLog_Response.Change
	(*CFamilyGroups_GetSharedLibraryApps_Response_SharedApp)(nil),            // 70: steam.CFamilyGroups_GetSharedLibraryApps_Response.SharedApp
	(*CFamilyGroups_GetPreferredLenders_Response_FamilyMember)(nil),          // 71: steam.CFamilyGroups_GetPreferredLenders_Response.FamilyMember
	(*CFamilyGroupsClient_NotifyRunningApps_Notification_PlayingMember)(nil), // 72: steam.CFamilyGroupsClient_NotifyRunningApps_Notification.PlayingMember
	(*CFamilyGroupsClient_NotifyRunningApps_Notification_RunningApp)(nil),    // 73: steam.CFamilyGroupsClient_NotifyRunningApps_Notification.RunningApp
	(EProtoAppType)(0), // 74: steam.EProtoAppType
	(*NoResponse)(nil), // 75: steam.NoResponse
}
var file_steammessages_familygroups_steamclient_proto_depIdxs = []int32{
	0,  // 0: steam.FamilyGroupMember.role:type_name -> steam.EFamilyGroupRole
	0,  // 1: steam.FamilyGroupPendingInvite.role:type_name -> steam.EFamilyGroupRole
	8,  // 2: steam.CFamilyGroups_GetFamilyGroup_Response.members:type_name -> steam.FamilyGroupMember
	9,  // 3: steam.CFamilyGroups_GetFamilyGroup_Response.pending_invites:type_name -> steam.FamilyGroupPendingInvite
	10, // 4: steam.CFamilyGroups_GetFamilyGroup_Response.former_members:type_name -> steam.FamilyGroupFormerMember
	0,  // 5: steam.FamilyGroupPendingInviteForUser.role:type_name -> steam.EFamilyGroupRole
	13, // 6: steam.CFamilyGroups_GetFamilyGroupForUser_Response.pending_group_invites:type_name -> steam.FamilyGroupPendingInviteForUser
	11, // 7: steam.CFamilyGroups_GetFamilyGroupForUser_Response.family_group:type_name -> steam.CFamilyGroups_GetFamilyGroup_Response
	14, // 8: steam.CFamilyGroups_GetFamilyGroupForUser_Response.membership_history:type_name -> steam.FamilyGroupMembership
	0,  // 9: steam.CFamilyGroups_InviteToFamilyGroup_Request.receiver_role:type_name -> steam.EFamilyGroupRole
	1,  // 10: steam.CFamilyGroups_InviteToFamilyGroup_Response.two_factor_method:type_name -> steam.EFamilyGroupsTwoFactorMethod
	1,  // 11: steam.CFamilyGroups_JoinFamilyGroup_Response.two_factor_method:type_name -> steam.EFamilyGroupsTwoFactorMethod
	39, // 12: steam.CFamilyGroups_GetPlaytimeSummary_Response.entries:type_name -> steam.CFamilyGroups_PlaytimeEntry
	39, // 13: steam.CFamilyGroups_GetPlaytimeSummary_Response.entries_by_owner:type_name -> steam.CFamilyGroups_PlaytimeEntry
	2,  // 14: steam.PurchaseRequest.response_action:type_name -> steam.EPurchaseRequestAction
	44, // 15: steam.CFamilyGroups_GetPurchaseRequests_Response.requests:type_name -> steam.PurchaseRequest
	2,  // 16: steam.CFamilyGroups_RespondToRequestedPurchase_Request.action:type_name -> steam.EPurchaseRequestAction
	69, // 17: steam.CFamilyGroups_GetChangeLog_Response.changes:type_name -> steam.CFamilyGroups_GetChangeLog_Response.Change
	70, // 18: steam.CFamilyGroups_GetSharedLibraryApps_Response.apps:type_name -> steam.CFamilyGroups_GetSharedLibraryApps_Response.SharedApp
	71, // 19: steam.CFamilyGroups_GetPreferredLenders_Response.members:type_name -> steam.CFamilyGroups_GetPreferredLenders_Response.FamilyMember
	73, // 20: steam.CFamilyGroupsClient_NotifyRunningApps_Notification.running_apps:type_name -> steam.CFamilyGroupsClient_NotifyRunningApps_Notification.RunningApp
	3,  // 21: steam.CFamilyGroups_GetChangeLog_Response.Change.type:type_name -> steam.EFamilyGroupChangeLogType
	4,  // 22: steam.CFamilyGroups_GetSharedLibraryApps_Response.SharedApp.exclude_reason:type_name -> steam.ESharedLibraryExcludeReason
	74, // 23: steam.CFamilyGroups_GetSharedLibraryApps_Response.SharedApp.app_type:type_name -> steam.EProtoAppType
	72, // 24: steam.CFamilyGroupsClient_NotifyRunningApps_Notification.RunningApp.playing_members:type_name -> steam.CFamilyGroupsClient_NotifyRunningApps_Notification.PlayingMember
	5,  // 25: steam.FamilyGroups.CreateFamilyGroup:input_type -> steam.CFamilyGroups_CreateFamilyGroup_Request
	7,  // 26: steam.FamilyGroups.GetFamilyGroup:input_type -> steam.CFamilyGroups_GetFamilyGroup_Request
	12, // 27: steam.FamilyGroups.GetFamilyGroupForUser:input_type -> steam.CFamilyGroups_GetFamilyGroupForUser_Request
	16, // 28: steam.FamilyGroups.ModifyFamilyGroupDetails:input_type -> steam.CFamilyGroups_ModifyFamilyGroupDetails_Request
	18, // 29: steam.FamilyGroups.InviteToFamilyGroup:input_type -> steam.CFamilyGroups_InviteToFamilyGroup_Request
	20, // 30: steam.FamilyGroups.ConfirmInviteToFamilyGroup:input_type -> steam.CFamilyGroups_ConfirmInviteToFamilyGroup_Request
	22, // 31: steam.FamilyGroups.ResendInvitationToFamilyGroup:input_type -> steam.CFamilyGroups_ResendInvitationToFamilyGroup_Request
	24, // 32: steam.FamilyGroups.JoinFamilyGroup:input_type -> steam.CFamilyGroups_JoinFamilyGroup_Request
	26, // 33: steam.FamilyGroups.ConfirmJoinFamilyGroup:input_type -> steam.CFamilyGroups_ConfirmJoinFamilyGroup_Request
	28, // 34: steam.FamilyGroups.RemoveFromFamilyGroup:input_type -> steam.CFamilyGroups_RemoveFromFamilyGroup_Request
	30, // 35: steam.FamilyGroups.CancelFamilyGroupInvite:input_type -> steam.CFamilyGroups_CancelFamilyGroupInvite_Request
	32, // 36: steam.FamilyGroups.GetUsersSharingDevice:input_type -> steam.CFamilyGroups_GetUsersSharingDevice_Request
	34, // 37: steam.FamilyGroups.DeleteFamilyGroup:input_type -> steam.CFamilyGroups_DeleteFamilyGroup_Request
	36, // 38: steam.FamilyGroups.UndeleteFamilyGroup:input_type -> steam.CFamilyGroups_UndeleteFamilyGroup_Request
	38, // 39: steam.FamilyGroups.GetPlaytimeSummary:input_type -> steam.CFamilyGroups_GetPlaytimeSummary_Request
	41, // 40: steam.FamilyGroups.RequestPurchase:input_type -> steam.CFamilyGroups_RequestPurchase_Request
	43, // 41: steam.FamilyGroups.GetPurchaseRequests:input_type -> steam.CFamilyGroups_GetPurchaseRequests_Request
	46, // 42: steam.FamilyGroups.RespondToRequestedPurchase:input_type -> steam.CFamilyGroups_RespondToRequestedPurchase_Request
	48, // 43: steam.FamilyGroups.GetChangeLog:input_type -> steam.CFamilyGroups_GetChangeLog_Request
	50, // 44: steam.FamilyGroups.SetFamilyCooldownOverrides:input_type -> steam.CFamilyGroups_SetFamilyCooldownOverrides_Request
	52, // 45: steam.FamilyGroups.GetSharedLibraryApps:input_type -> steam.CFamilyGroups_GetSharedLibraryApps_Request
	54, // 46: steam.FamilyGroups.SetPreferredLender:input_type -> steam.CFamilyGroups_SetPreferredLender_Request
	56, // 47: steam.FamilyGroups.GetPreferredLenders:input_type -> steam.CFamilyGroups_GetPreferredLenders_Request
	58, // 48: steam.FamilyGroups.ForceAcceptInvite:input_type -> steam.CFamilyGroups_ForceAcceptInvite_Request
	60, // 49: steam.FamilyGroups.GetInviteCheckResults:input_type -> steam.CFamilyGroups_GetInviteCheckResults_Request
	62, // 50: steam.FamilyGroups.ClearCooldownSkip:input_type -> steam.CFamilyGroups_ClearCooldownSkip_Request
	64, // 51: steam.FamilyGroups.RollbackFamilyGroup:input_type -> steam.CFamilyGroups_RollbackFamilyGroup_Request
	66, // 52: steam.FamilyGroupsClient.NotifyRunningApps:input_type -> steam.CFamilyGroupsClient_NotifyRunningApps_Notification
	67, // 53: steam.FamilyGroupsClient.NotifyInviteStatus:input_type -> steam.CFamilyGroupsClient_InviteStatus_Notification
	68, // 54: steam.FamilyGroupsClient.NotifyGroupChanged:input_type -> steam.CFamilyGroupsClient_GroupChanged_Notification
	6,  // 55: steam.FamilyGroups.CreateFamilyGroup:output_type -> steam.CFamilyGroups_CreateFamilyGroup_Response
	11, // 56: steam.FamilyGroups.GetFamilyGroup:output_type -> steam.CFamilyGroups_GetFamilyGroup_Response
	15, // 57: steam.FamilyGroups.GetFamilyGroupForUser:output_type -> steam.CFamilyGroups_GetFamilyGroupForUser_Response
	17, // 58: steam.FamilyGroups.ModifyFamilyGroupDetails:output_type -> steam.CFamilyGroups_ModifyFamilyGroupDetails_Response
	19, // 59: steam.FamilyGroups.InviteToFamilyGroup:output_type -> steam.CFamilyGroups_InviteToFamilyGroup_Response
	21, // 60: steam.FamilyGroups.ConfirmInviteToFamilyGroup:output_type -> steam.CFamilyGroups_ConfirmInviteToFamilyGroup_Response
	23, // 61: steam.FamilyGroups.ResendInvitationToFamilyGroup:output_type -> steam.CFamilyGroups_ResendInvitationToFamilyGroup_Response
	25, // 62: steam.FamilyGroups.JoinFamilyGroup:output_type -> steam.CFamilyGroups_JoinFamilyGroup_Response
	27, // 63: steam.FamilyGroups.ConfirmJoinFamilyGroup:output_type -> steam.CFamilyGroups_ConfirmJoinFamilyGroup_Response
	29, // 64: steam.FamilyGroups.RemoveFromFamilyGroup:output_type -> steam.CFamilyGroups_RemoveFromFamilyGroup_Response
	31, // 65: steam.FamilyGroups.CancelFamilyGroupInvite:output_type -> steam.CFamilyGroups_CancelFamilyGroupInvite_Response
	33, // 66: steam.FamilyGroups.GetUsersSharingDevice:output_type -> steam.CFamilyGroups_GetUsersSharingDevice_Response
	35, // 67: steam.FamilyGroups.DeleteFamilyGroup:output_type -> steam.CFamilyGroups_DeleteFamilyGroup_Response
	37, // 68: steam.FamilyGroups.UndeleteFamilyGroup:output_type -> steam.CFamilyGroups_UndeleteFamilyGroup_Response
	40, // 69: steam.FamilyGroups.GetPlaytimeSummary:output_type -> steam.CFamilyGroups_GetPlaytimeSummary_Response
	42, // 70: steam.FamilyGroups.RequestPurchase:output_type -> steam.CFamilyGroups_RequestPurchase_Response
	45, // 71: steam.FamilyGroups.GetPurchaseRequests:output_type -> steam.CFamilyGroups_GetPurchaseRequests_Response
	47, // 72: steam.FamilyGroups.RespondToRequestedPurchase:output_type -> steam.CFamilyGroups_RespondToRequestedPurchase_Response
	49, // 73: steam.FamilyGroups.GetChangeLog:output_type -> steam.CFamilyGroups_GetChangeLog_Response
	51, // 74: steam.FamilyGroups.SetFamilyCooldownOverrides:output_type -> steam.CFamilyGroups_SetFamilyCooldownOverrides_Response
	53, // 75: steam.FamilyGroups.GetSharedLibraryApps:output_type -> steam.CFamilyGroups_GetSharedLibraryApps_Response
	55, // 76: steam.FamilyGroups.SetPreferredLender:output_type -> steam.CFamilyGroups_SetPreferredLender_Response
	57, // 77: steam.FamilyGroups.GetPreferredLenders:output_type -> steam.CFamilyGroups_GetPreferredLenders_Response
	59, // 78: steam.FamilyGroups.ForceAcceptInvite:output_type -> steam.CFamilyGroups_ForceAcceptInvite_Response
	61, // 79: steam.FamilyGroups.GetInviteCheckResults:output_type -> steam.CFamilyGroups_GetInviteCheckResults_Response
	63, // 80: steam.FamilyGroups.ClearCooldownSkip:output_type -> steam.CFamilyGroups_ClearCooldownSkip_Response
	65, // 81: steam.FamilyGroups.RollbackFamilyGroup:output_type -> steam.CFamilyGroups_RollbackFamilyGroup_Response
	75, // 82: steam.FamilyGroupsClient.NotifyRunningApps:output_type -> steam.NoResponse
	75, // 83: steam.FamilyGroupsClient.NotifyInviteStatus:output_type -> steam.NoResponse
	75, // 84: steam.FamilyGroupsClient.NotifyGroupChanged:output_type -> steam.NoResponse
