...
type CMsgSteamDatagramConnectionClosed struct {
	...
	RelayMode                      *CMsgSteamDatagramConnectionClosed_ERelayMode `protobuf:"varint,4,opt,name=relay_mode,json=relayMode,enum=steam.CMsgSteamDatagramConnectionClosed_ERelayMode,def=0" json:"relay_mode,omitempty"`
...
type CMsgSteamDatagramRouterPingReply_AltAddress struct {
	...
	Penalty       *uint32                                               `protobuf:"varint,3,opt,name=penalty" json:"penalty,omitempty"`
	Protocol      *CMsgSteamDatagramRouterPingReply_AltAddress_Protocol `protobuf:"varint,4,opt,name=protocol,enum=steam.CMsgSteamDatagramRouterPingReply_AltAddress_Protocol,def=0" json:"protocol,omitempty"`
...
const file_steamdatagram_messages_sdr_proto_rawDesc = "" +
	"\n" +
	" steamdatagram_messages_sdr.proto\x12\x05steam\x1a+steamnetworkingsockets_messages_certs.proto\x1a%steamnetworkingsockets_messages.proto\">\n" +
	"\x1cCMsgSteamNetworkingIPAddress\x12\x0e\n" +
	"\x02v4\x18\x01 \x01(\aR\x02v4\x12\x0e\n" +
	"\x02v6\x18\x02 \x01(\fR\x02v6\"\xc3\x01\n" +
	"%CMsgSteamDatagramSignedMessageGeneric\x12=\n" +
	"\x04cert\x18\x01 \x01(\v2).steam.CMsgSteamDatagramCertificateSignedR\x04cert\x12\x1f\n" +
	"\vsigned_data\x18\x02 \x01(\fR\n" +
	"signedData\x12\x1c\n" +
	"\tsignature\x18\x03 \x01(\fR\tsignature\x12\x1c\n" +
	"\tdummy_pad\x18\xff\a \x01(\fR\bdummyPad\"\x97\v\n" +
	...
	"\x05flags\x18\f \x01(\rR\x05flags\x12a\n" +
	"\x10route_exceptions\x18\n" +
	" \x03(\v26.steam.CMsgSteamDatagramRouterPingReply.RouteExceptionR\x0frouteExceptions\x12W\n" +
	"\ralt_addresses\x18\r \x03(\v22.steam.CMsgSteamDatagramRouterPingReply.AltAddressR\faltAddresses\x12\x1b\n" +
	...
	"\apenalty\x18\x03 \x01(\rR\apenalty\x1a\xe9\x01\n" +
	"\n" +
	"AltAddress\x12\x12\n" +
	"\x04ipv4\x18\x01 \x01(\aR\x04ipv4\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x18\n" +
	"\apenalty\x18\x03 \x01(\rR\apenalty\x12h\n" +
	"\bprotocol\x18\x04 \x01(\x0e2;.steam.CMsgSteamDatagramRouterPingReply.AltAddress.Protocol:\x0fDefaultProtocolR\bprotocol\x12\x0e\n" +
	"\x02id\x18\x05 \x01(\tR\x02id\"\x1f\n" +
	"\bProtocol\x12\x13\n" +
	"\x0fDefaultProtocol\x10\x00\"L\n" +
	"\x05Flags\x12 \n" +
	"\x1cFLAG_MAYBE_MORE_DATA_CENTERS\x10\x01\x12!\n" +
	"\x1dFLAG_MAYBE_MORE_ALT_ADDRESSES\x10\x02\"\xe1\x02\n" +
	"*CMsgSteamDatagramGameserverPingRequestBody\x12\x1f\n" +
	"\vrelay_popid\x18\x01 \x01(\aR\n" +
	"relayPopid\x12I\n" +
	"\x0eyour_public_ip\x18\x02 \x01(\v2#.steam.CMsgSteamNetworkingIPAddressR\fyourPublicIp\x12(\n" +
	...
	"\x06my_ips\x18\x06 \x03(\v2#.steam.CMsgSteamNetworkingIPAddressR\x05myIps\x12\x12\n" +
	"\x04echo\x18\b \x01(\fR\x04echo\"\xce\x03\n" +
	".CMsgSteamDatagramGameserverPingRequestEnvelope\x12=\n" +
	"\x04cert\x18\x06 \x01(\v2).steam.CMsgSteamDatagramCertificateSignedR\x04cert\x12\x1f\n" +
	...
	"\rconnection_id\x18\x01 \x01(\aR\fconnectionId\"\xe2\n" +
	"\n" +
	...
	"\x03tos\x18\x06 \x01(\v2\x17.steam.CMsgTOSTreatmentR\x03tos\x12E\n" +
	"\x04pops\x18\x02 \x03(\v21.steam.CMsgSteamDatagramClientPingSampleReply.POPR\x04pops\x12n\n" +
	"\x13legacy_data_centers\x18\x03 \x03(\v2>.steam.CMsgSteamDatagramClientPingSampleReply.LegacyDataCenterR\x11legacyDataCenters\x1a\xe3\x06\n" +
	"\x03POP\x12\x15\n" +
	"\x06pop_id\x18\x01 \x01(\aR\x05popId\x121\n" +
	"\x15default_front_ping_ms\x18\x02 \x01(\rR\x12defaultFrontPingMs\x12'\n" +
	"\x0fcluster_penalty\x18\x04 \x01(\rR\x0eclusterPenalty\x12a\n" +
	"\ralt_addresses\x18\a \x03(\v2<.steam.CMsgSteamDatagramClientPingSampleReply.POP.AltAddressR\faltAddresses\x12-\n" +
	...
	"\x0fbest_dc_ping_ms\x18\x03 \x01(\rR\fbestDcPingMs\"\x87\a\n" +
	...
	"\x06gap_ms\x18\b \x01(\rR\x05gapMs\x12e\n" +
	"\x10from_quality_now\x18\t \x01(\v2;.steam.CMsgSteamDatagramClientSwitchedPrimary.RouterQualityR\x0efromQualityNow\x12a\n" +
	"\x0eto_quality_now\x18\n" +
	" \x01(\v2;.steam.CMsgSteamDatagramClientSwitchedPrimary.RouterQualityR\ftoQualityNow\x12g\n" +
	"\x11from_quality_then\x18\v \x01(\v2;.steam.CMsgSteamDatagramClientSwitchedPrimary.RouterQualityR\x0ffromQualityThen\x12c\n" +
	"\x0fto_quality_then\x18\f \x01(\v2;.steam.CMsgSteamDatagramClientSwitchedPrimary.RouterQualityR\rtoQualityThen\x1a\x8f\x01\n" +
	...
	"\x12seconds_until_down\x18\x04 \x01(\rR\x10secondsUntilDown\"\xcc\x03\n" +
	...
	"\x1bgameserver_relay_session_id\x18\x02 \x01(\rR\x18gameserverRelaySessionId\x12D\n" +
	"\x05crypt\x18\x06 \x01(\v2..steam.CMsgSteamDatagramSessionCryptInfoSignedR\x05crypt\x12=\n" +
	"\x04cert\x18\a \x01(\v2).steam.CMsgSteamDatagramCertificateSignedR\x04cert\x12%\n" +
	"\x0erouting_secret\x18\n" +
	" \x01(\x06R\rroutingSecret\x123\n" +
	"\x16legacy_client_steam_id\x18\x03 \x01(\x06R\x13legacyClientSteamId\"\x93\x03\n" +
	...
	"\x1bgameserver_relay_session_id\x18\x02 \x01(\rR\x18gameserverRelaySessionId\x12D\n" +
	"\x05crypt\x18\x05 \x01(\v2..steam.CMsgSteamDatagramSessionCryptInfoSignedR\x05crypt\x12=\n" +
	"\x04cert\x18\x06 \x01(\v2).steam.CMsgSteamDatagramCertificateSignedR\x04cert\"\xa0\x05\n" +
	...
	"\x10selected_seconds\x18\b \x01(\rR\x0fselectedSeconds\"\xa5\x01\n" +
	"\"CMsgSteamDatagramP2PRoutingSummary\x12=\n" +
	"\x03ice\x18\x02 \x01(\v2+.steam.CMsgSteamNetworkingICESessionSummaryR\x03ice\x12@\n" +
	"\x03sdr\x18\x03 \x01(\v2..steam.CMsgSteamNetworkingP2PSDRRoutingSummaryR\x03sdr\"\xfe\t\n" +
	...
	"\x14from_identity_string\x18\x0f \x01(\tR\x12fromIdentityString\x12m\n" +
	"\x1blegacy_from_identity_binary\x18\r \x01(\v2..steam.CMsgSteamNetworkingIdentityLegacyBinaryR\x18legacyFromIdentityBinary\x12/\n" +
	...
	"\x17forward_target_revision\x18\f \x01(\rR\x15forwardTargetRevision\x12X\n" +
	"\n" +
	"relay_mode\x18\x04 \x01(\x0e23.steam.CMsgSteamDatagramConnectionClosed.ERelayMode:\x04NoneR\trelayMode\x12\x14\n" +
	...
	"\x15relay_override_active\x18\x16 \x01(\bR\x13relayOverrideActive\x12N\n" +
	"\rquality_relay\x18\x11 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12J\n" +
	"\vquality_e2e\x18\x12 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x12Y\n" +
	"\x13p2p_routing_summary\x18\x15 \x01(\v2).steam.CMsgSteamDatagramP2PRoutingSummaryR\x11p2pRoutingSummary\"6\n" +
	"\n" +
	"ERelayMode\x12\b\n" +
	"\x04None\x10\x00\x12\f\n" +
	"\bEndToEnd\x10\x01\x12\x10\n" +
	"\fClosedByPeer\x10\x02\"\xfa\x06\n" +
	...
	"\x15relay_override_active\x18\x11 \x01(\bR\x13relayOverrideActive\x12N\n" +
	"\rquality_relay\x18\r \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12J\n" +
	"\vquality_e2e\x18\x0e \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x12Y\n" +
	"\x13p2p_routing_summary\x18\x10 \x01(\v2).steam.CMsgSteamDatagramP2PRoutingSummaryR\x11p2pRoutingSummary\x12%\n" +
	"\x0erouting_secret\x18\v \x01(\x06R\rroutingSecret\x12\x1c\n" +
	"\tdummy_pad\x18\xff\a \x01(\aR\bdummyPad\"\x8a\x04\n" +
	...
	"\x05build\x18\n" +
	" \x01(\tR\x05build\x126\n" +
	"\x17dev_gameserver_identity\x18d \x01(\tR\x15devGameserverIdentity\x12Q\n" +
	"\x0fdev_client_cert\x18e \x01(\v2).steam.CMsgSteamDatagramCertificateSignedR\rdevClientCert\"\xe5\x02\n" +
	...
	"\x19legacy_gameserver_steamid\x18\x03 \x01(\x06R\x17legacyGameserverSteamid\"\x9c\x04\n" +
	".CMsgSteamDatagramConnectionStatsClientToRouter\x12N\n" +
	"\rquality_relay\x18\x01 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12J\n" +
	"\vquality_e2e\x18\x02 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x12\x1b\n" +
	...
	"\x15CLIENT_RELAY_OVERRIDE\x10 \"\xc0\x05\n" +
	".CMsgSteamDatagramConnectionStatsRouterToClient\x12N\n" +
	"\rquality_relay\x18\x01 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12J\n" +
	"\vquality_e2e\x18\x02 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x124\n" +
	...
	"\x11ACK_REQUEST_RELAY\x10\x01\x12\x13\n" +
	"\x0fACK_REQUEST_E2E\x10\x02\x12\x19\n" +
	"\x15ACK_REQUEST_IMMEDIATE\x10\x04\"\xd5\x05\n" +
	".CMsgSteamDatagramConnectionStatsRouterToServer\x12N\n" +
	"\rquality_relay\x18\x01 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12J\n" +
	"\vquality_e2e\x18\x02 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x12\x1b\n" +
	"\tack_relay\x18\n" +
	...
	"\x11ACK_REQUEST_RELAY\x10\x01\x12\x13\n" +
	"\x0fACK_REQUEST_E2E\x10\x02\x12\x19\n" +
	"\x15ACK_REQUEST_IMMEDIATE\x10\x04\"\xc3\x04\n" +
	".CMsgSteamDatagramConnectionStatsServerToRouter\x12N\n" +
	"\rquality_relay\x18\x01 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12J\n" +
	"\vquality_e2e\x18\x02 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x12\x1b\n" +
	...
	"\rEncryptedData\x120\n" +
	"\x14peer_identity_string\x18\x01 \x01(\tR\x12peerIdentityString\"\x95\x01\n" +
	"\"CMsgSteamDatagramP2PSessionRequest\x12=\n" +
	"\x04cert\x18\x01 \x01(\v2).steam.CMsgSteamDatagramCertificateSignedR\x04cert\x12\x12\n" +
	...
	"\vseq_num_r2c\x18\x05 \x01(\rR\tseqNumR2c\"\xe1\x06\n" +
	"1CMsgSteamDatagramConnectionStatsP2PClientToRouter\x12N\n" +
	"\rquality_relay\x18\x01 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12J\n" +
	"\vquality_e2e\x18\x02 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x12Y\n" +
	"\x13p2p_routing_summary\x18\x0e \x01(\v2).steam.CMsgSteamDatagramP2PRoutingSummaryR\x11p2pRoutingSummary\x12\x1b\n" +
	...
	"\x15CLIENT_RELAY_OVERRIDE\x10 \"\xe5\x06\n" +
	"1CMsgSteamDatagramConnectionStatsP2PRouterToClient\x12N\n" +
	"\rquality_relay\x18\x01 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12J\n" +
	"\vquality_e2e\x18\x02 \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x124\n" +
	"\x16seconds_until_shutdown\x18\x03 \x01(\rR\x14secondsUntilShutdown\x12,\n" +
	...
	"\n" +
	"kludge_pad\x18c \x01(\x06R\tkludgePad\"\x85\x04\n" +
	"\x1aCMsgSteamDatagramP2PRoutes\x12U\n" +
	"\x0erelay_clusters\x18\x01 \x03(\v2..steam.CMsgSteamDatagramP2PRoutes.RelayClusterR\rrelayClusters\x12?\n" +
	"\x06routes\x18\x02 \x03(\v2'.steam.CMsgSteamDatagramP2PRoutes.RouteR\x06routes\x12\x1a\n" +
	...
	")k_ESteamDatagramMsg_RelayToRelayPingReply\x10\"B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steamdatagram_messages_sdr_proto_goTypes = []any{
	(ESteamDatagramMsgID)(0),                                        // 0: steam.ESteamDatagramMsgID
	(CMsgSteamDatagramRouterPingReply_Flags)(0),                     // 1: steam.CMsgSteamDatagramRouterPingReply.Flags
	(CMsgSteamDatagramRouterPingReply_AltAddress_Protocol)(0),       // 2: steam.CMsgSteamDatagramRouterPingReply.AltAddress.Protocol
	(CMsgSteamDatagramConnectionClosed_ERelayMode)(0),               // 3: steam.CMsgSteamDatagramConnectionClosed.ERelayMode
	(CMsgSteamDatagramConnectionStatsClientToRouter_Flags)(0),       // 4: steam.CMsgSteamDatagramConnectionStatsClientToRouter.Flags
	(CMsgSteamDatagramConnectionStatsRouterToClient_Flags)(0),       // 5: steam.CMsgSteamDatagramConnectionStatsRouterToClient.Flags
	(CMsgSteamDatagramConnectionStatsRouterToServer_Flags)(0),       // 6: steam.CMsgSteamDatagramConnectionStatsRouterToServer.Flags
	(CMsgSteamDatagramConnectionStatsServerToRouter_Flags)(0),       // 7: steam.CMsgSteamDatagramConnectionStatsServerToRouter.Flags
	(CMsgSteamDatagramConnectionStatsP2PClientToRouter_Flags)(0),    // 8: steam.CMsgSteamDatagramConnectionStatsP2PClientToRouter.Flags
	(CMsgSteamDatagramConnectionStatsP2PRouterToClient_Flags)(0),    // 9: steam.CMsgSteamDatagramConnectionStatsP2PRouterToClient.Flags
	(*CMsgSteamNetworkingIPAddress)(nil),                            // 10: steam.CMsgSteamNetworkingIPAddress
	(*CMsgSteamDatagramSignedMessageGeneric)(nil),                   // 11: steam.CMsgSteamDatagramSignedMessageGeneric
	(*CMsgSteamDatagramRouterPingReply)(nil),                        // 12: steam.CMsgSteamDatagramRouterPingReply
	(*CMsgSteamDatagramGameserverPingRequestBody)(nil),              // 13: steam.CMsgSteamDatagramGameserverPingRequestBody
	(*CMsgSteamDatagramGameserverPingRequestEnvelope)(nil),          // 14: steam.CMsgSteamDatagramGameserverPingRequestEnvelope
	(*CMsgSteamDatagramGameserverPingReplyData)(nil),                // 15: steam.CMsgSteamDatagramGameserverPingReplyData
	(*CMsgSteamDatagramNoSessionRelayToClient)(nil),                 // 16: steam.CMsgSteamDatagramNoSessionRelayToClient
	(*CMsgSteamDatagramNoSessionRelayToPeer)(nil),                   // 17: steam.CMsgSteamDatagramNoSessionRelayToPeer
	(*CMsgTOSTreatment)(nil),                                        // 18: steam.CMsgTOSTreatment
	(*CMsgSteamDatagramClientPingSampleRequest)(nil),                // 19: steam.CMsgSteamDatagramClientPingSampleRequest
	(*CMsgSteamDatagramClientPingSampleReply)(nil),                  // 20: steam.CMsgSteamDatagramClientPingSampleReply
	(*CMsgSteamDatagramClientSwitchedPrimary)(nil),                  // 21: steam.CMsgSteamDatagramClientSwitchedPrimary
	(*CMsgSteamDatagramConnectRequest)(nil),                         // 22: steam.CMsgSteamDatagramConnectRequest
	(*CMsgSteamDatagramConnectOK)(nil),                              // 23: steam.CMsgSteamDatagramConnectOK
	(*CMsgSteamNetworkingP2PSDRRoutingSummary)(nil),                 // 24: steam.CMsgSteamNetworkingP2PSDRRoutingSummary
	(*CMsgSteamDatagramP2PRoutingSummary)(nil),                      // 25: steam.CMsgSteamDatagramP2PRoutingSummary
	(*CMsgSteamDatagramConnectionClosed)(nil),                       // 26: steam.CMsgSteamDatagramConnectionClosed
	(*CMsgSteamDatagramNoConnection)(nil),                           // 27: steam.CMsgSteamDatagramNoConnection
	(*CMsgSteamDatagramGameserverSessionRequest)(nil),               // 28: steam.CMsgSteamDatagramGameserverSessionRequest
	(*CMsgSteamDatagramGameserverSessionEstablished)(nil),           // 29: steam.CMsgSteamDatagramGameserverSessionEstablished
	(*CMsgSteamDatagramConnectionStatsClientToRouter)(nil),          // 30: steam.CMsgSteamDatagramConnectionStatsClientToRouter
	(*CMsgSteamDatagramConnectionStatsRouterToClient)(nil),          // 31: steam.CMsgSteamDatagramConnectionStatsRouterToClient
	(*CMsgSteamDatagramConnectionStatsRouterToServer)(nil),          // 32: steam.CMsgSteamDatagramConnectionStatsRouterToServer
	(*CMsgSteamDatagramConnectionStatsServerToRouter)(nil),          // 33: steam.CMsgSteamDatagramConnectionStatsServerToRouter
	(*CMsgSteamDatagramP2PSessionRequestBody)(nil),                  // 34: steam.CMsgSteamDatagramP2PSessionRequestBody
	(*CMsgSteamDatagramP2PSessionRequest)(nil),                      // 35: steam.CMsgSteamDatagramP2PSessionRequest
	(*CMsgSteamDatagramP2PSessionEstablished)(nil),                  // 36: steam.CMsgSteamDatagramP2PSessionEstablished
	(*CMsgSteamDatagramConnectionStatsP2PClientToRouter)(nil),       // 37: steam.CMsgSteamDatagramConnectionStatsP2PClientToRouter
	(*CMsgSteamDatagramConnectionStatsP2PRouterToClient)(nil),       // 38: steam.CMsgSteamDatagramConnectionStatsP2PRouterToClient
	(*CMsgSteamDatagramP2PBadRouteRouterToClient)(nil),              // 39: steam.CMsgSteamDatagramP2PBadRouteRouterToClient
	(*CMsgSteamDatagramP2PRoutes)(nil),                              // 40: steam.CMsgSteamDatagramP2PRoutes
	(*CMsgSteamDatagramSetSecondaryAddressRequest)(nil),             // 41: steam.CMsgSteamDatagramSetSecondaryAddressRequest
	(*CMsgSteamDatagramSetSecondaryAddressResult)(nil),              // 42: steam.CMsgSteamDatagramSetSecondaryAddressResult
	(*CMsgSteamDatagramRouterPingReply_RouteException)(nil),         // 43: steam.CMsgSteamDatagramRouterPingReply.RouteException
	(*CMsgSteamDatagramRouterPingReply_AltAddress)(nil),             // 44: steam.CMsgSteamDatagramRouterPingReply.AltAddress
	(*CMsgSteamDatagramClientPingSampleReply_POP)(nil),              // 45: steam.CMsgSteamDatagramClientPingSampleReply.POP
	(*CMsgSteamDatagramClientPingSampleReply_LegacyDataCenter)(nil), // 46: steam.CMsgSteamDatagramClientPingSampleReply.LegacyDataCenter
	(*CMsgSteamDatagramClientPingSampleReply_POP_AltAddress)(nil),   // 47: steam.CMsgSteamDatagramClientPingSampleReply.POP.AltAddress
	(*CMsgSteamDatagramClientSwitchedPrimary_RouterQuality)(nil),    // 48: steam.CMsgSteamDatagramClientSwitchedPrimary.RouterQuality
	(*CMsgSteamDatagramP2PSessionRequestBody_EncryptedData)(nil),    // 49: steam.CMsgSteamDatagramP2PSessionRequestBody.EncryptedData
	(*CMsgSteamDatagramP2PRoutes_RelayCluster)(nil),                 // 50: steam.CMsgSteamDatagramP2PRoutes.RelayCluster
	(*CMsgSteamDatagramP2PRoutes_Route)(nil),                        // 51: steam.CMsgSteamDatagramP2PRoutes.Route
	(*CMsgSteamDatagramCertificateSigned)(nil),                      // 52: steam.CMsgSteamDatagramCertificateSigned
	(*CMsgSteamDatagramSessionCryptInfoSigned)(nil),                 // 53: steam.CMsgSteamDatagramSessionCryptInfoSigned
	(*CMsgSteamNetworkingICESessionSummary)(nil),                    // 54: steam.CMsgSteamNetworkingICESessionSummary
	(*CMsgSteamNetworkingIdentityLegacyBinary)(nil),                 // 55: steam.CMsgSteamNetworkingIdentityLegacyBinary
	(*CMsgSteamDatagramConnectionQuality)(nil),                      // 56: steam.CMsgSteamDatagramConnectionQuality
}
var file_steamdatagram_messages_sdr_proto_depIdxs = []int32{
	52, // 0: steam.CMsgSteamDatagramSignedMessageGeneric.cert:type_name -> steam.CMsgSteamDatagramCertificateSigned
	43, // 1: steam.CMsgSteamDatagramRouterPingReply.route_exceptions:type_name -> steam.CMsgSteamDatagramRouterPingReply.RouteException
	44, // 2: steam.CMsgSteamDatagramRouterPingReply.alt_addresses:type_name -> steam.CMsgSteamDatagramRouterPingReply.AltAddress
	10, // 3: steam.CMsgSteamDatagramGameserverPingRequestBody.your_public_ip:type_name -> steam.CMsgSteamNetworkingIPAddress
	10, // 4: steam.CMsgSteamDatagramGameserverPingRequestBody.my_ips:type_name -> steam.CMsgSteamNetworkingIPAddress
	52, // 5: steam.CMsgSteamDatagramGameserverPingRequestEnvelope.cert:type_name -> steam.CMsgSteamDatagramCertificateSigned
	18, // 6: steam.CMsgSteamDatagramClientPingSampleReply.tos:type_name -> steam.CMsgTOSTreatment
	45, // 7: steam.CMsgSteamDatagramClientPingSampleReply.pops:type_name -> steam.CMsgSteamDatagramClientPingSampleReply.POP
	46, // 8: steam.CMsgSteamDatagramClientPingSampleReply.legacy_data_centers:type_name -> steam.CMsgSteamDatagramClientPingSampleReply.LegacyDataCenter
	48, // 9: steam.CMsgSteamDatagramClientSwitchedPrimary.from_quality_now:type_name -> steam.CMsgSteamDatagramClientSwitchedPrimary.RouterQuality
	48, // 10: steam.CMsgSteamDatagramClientSwitchedPrimary.to_quality_now:type_name -> steam.CMsgSteamDatagramClientSwitchedPrimary.RouterQuality
	48, // 11: steam.CMsgSteamDatagramClientSwitchedPrimary.from_quality_then:type_name -> steam.CMsgSteamDatagramClientSwitchedPrimary.RouterQuality
	48, // 12: steam.CMsgSteamDatagramClientSwitchedPrimary.to_quality_then:type_name -> steam.CMsgSteamDatagramClientSwitchedPrimary.RouterQuality
	53, // 13: steam.CMsgSteamDatagramConnectRequest.crypt:type_name -> steam.CMsgSteamDatagramSessionCryptInfoSigned
	52, // 14: steam.CMsgSteamDatagramConnectRequest.cert:type_name -> steam.CMsgSteamDatagramCertificateSigned
	53, // 15: steam.CMsgSteamDatagramConnectOK.crypt:type_name -> steam.CMsgSteamDatagramSessionCryptInfoSigned
	52, // 16: steam.CMsgSteamDatagramConnectOK.cert:type_name -> steam.CMsgSteamDatagramCertificateSigned
	54, // 17: steam.CMsgSteamDatagramP2PRoutingSummary.ice:type_name -> steam.CMsgSteamNetworkingICESessionSummary
	24, // 18: steam.CMsgSteamDatagramP2PRoutingSummary.sdr:type_name -> steam.CMsgSteamNetworkingP2PSDRRoutingSummary
	55, // 19: steam.CMsgSteamDatagramConnectionClosed.legacy_from_identity_binary:type_name -> steam.CMsgSteamNetworkingIdentityLegacyBinary
	3,  // 20: steam.CMsgSteamDatagramConnectionClosed.relay_mode:type_name -> steam.CMsgSteamDatagramConnectionClosed.ERelayMode
	56, // 21: steam.CMsgSteamDatagramConnectionClosed.quality_relay:type_name -> steam.CMsgSteamDatagramConnectionQuality
	56, // 22: steam.CMsgSteamDatagramConnectionClosed.quality_e2e:type_name -> steam.CMsgSteamDatagramConnectionQuality
	25, // 23: steam.CMsgSteamDatagramConnectionClosed.p2p_routing_summary:type_name -> steam.CMsgSteamDatagramP2PRoutingSummary
	56, // 24: steam.CMsgSteamDatagramNoConnection.quality_relay:type_name -> steam.CMsgSteamDatagramConnectionQuality
	56, // 25: steam.CMsgSteamDatagramNoConnection.quality_e2e:type_name -> steam.CMsgSteamDatagramConnectionQuality
	25, // 26: steam.CMsgSteamDatagramNoConnection.p2p_routing_summary:type_name -> steam.CMsgSteamDatagramP2PRoutingSummary
	52, // 27: steam.CMsgSteamDatagramGameserverSessionRequest.dev_client_cert:type_name -> steam.CMsgSteamDatagramCertificateSigned
	56, // 28: steam.CMsgSteamDatagramConnectionStatsClientToRouter.quality_relay:type_name -> steam.CMsgSteamDatagramConnectionQuality
	56, // 29: steam.CMsgSteamDatagramConnectionStatsClientToRouter.quality_e2e:type_name -> steam.CMsgSteamDatagramConnectionQuality
	56, // 30: steam.CMsgSteamDatagramConnectionStatsRouterToClient.quality_relay:type_name -> steam.CMsgSteamDatagramConnectionQuality
	56, // 31: steam.CMsgSteamDatagramConnectionStatsRouterToClient.quality_e2e:type_name -> steam.CMsgSteamDatagramConnectionQuality
	56, // 32: steam.CMsgSteamDatagramConnectionStatsRouterToServer.quality_relay:type_name -> steam.CMsgSteamDatagramConnectionQuality
	56, // 33: steam.CMsgSteamDatagramConnectionStatsRouterToServer.quality_e2e:type_name -> steam.CMsgSteamDatagramConnectionQuality
	56, // 34: steam.CMsgSteamDatagramConnectionStatsServerToRouter.quality_relay:type_name -> steam.CMsgSteamDatagramConnectionQuality
	56, // 35: steam.CMsgSteamDatagramConnectionStatsServerToRouter.quality_e2e:type_name -> steam.CMsgSteamDatagramConnectionQuality
	52, // 36: steam.CMsgSteamDatagramP2PSessionRequest.cert:type_name -> steam.CMsgSteamDatagramCertificateSigned
	56, // 37: steam.CMsgSteamDatagramConnectionStatsP2PClientToRouter.quality_relay:type_name -> steam.CMsgSteamDatagramConnectionQuality
	56, // 38: steam.CMsgSteamDatagramConnectionStatsP2PClientToRouter.quality_e2e:type_name -> steam.CMsgSteamDatagramConnectionQuality
	25, // 39: steam.CMsgSteamDatagramConnectionStatsP2PClientToRouter.p2p_routing_summary:type_name -> steam.CMsgSteamDatagramP2PRoutingSummary
	56, // 40: steam.CMsgSteamDatagramConnectionStatsP2PRouterToClient.quality_relay:type_name -> steam.CMsgSteamDatagramConnectionQuality
	56, // 41: steam.CMsgSteamDatagramConnectionStatsP2PRouterToClient.quality_e2e:type_name -> steam.CMsgSteamDatagramConnectionQuality
	50, // 42: steam.CMsgSteamDatagramP2PRoutes.relay_clusters:type_name -> steam.CMsgSteamDatagramP2PRoutes.RelayCluster
	51, // 43: steam.CMsgSteamDatagramP2PRoutes.routes:type_name -> steam.CMsgSteamDatagramP2PRoutes.Route
	2,  // 44: steam.CMsgSteamDatagramRouterPingReply.AltAddress.protocol:type_name -> steam.CMsgSteamDatagramRouterPingReply.AltAddress.Protocol
	47, // 45: steam.CMsgSteamDatagramClientPingSampleReply.POP.alt_addresses:type_name -> steam.CMsgSteamDatagramClientPingSampleReply.POP.AltAddress
