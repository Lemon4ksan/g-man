...
type CSteamInputService_ShouldTritonPairInOobe_Response struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	PairType        *ETritonPairType       `protobuf:"varint,1,opt,name=pair_type,json=pairType,enum=steam.ETritonPairType,def=0" json:"pair_type,omitempty"`
...
type CSteamInputService_GetTritonPairingInfo_Response struct {
	...
	ConnectionType *ETritonConnectionType                                   `protobuf:"varint,2,opt,name=connection_type,json=connectionType,enum=steam.ETritonConnectionType,def=0" json:"connection_type,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type CSteamInputService_GetTritonPairingInfo_Response_Slot struct {
	...
	Type          *ETritonConnectionType `protobuf:"varint,3,opt,name=type,enum=steam.ETritonConnectionType,def=0" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_webuimessages_steaminput_proto_rawDesc = "" +
	"\n" +
	"\x1ewebuimessages_steaminput.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a\x18webuimessages_base.proto\"\xa8\v\n" +
	...
	"\x04roll\x18\x03 \x01(\x02R\x04roll\"\xdf\x04\n" +
	"9CSteamInputService_ControllerAxesStateChange_Notification\x12)\n" +
	"\x10controller_index\x18\x01 \x01(\rR\x0fcontrollerIndex\x12=\n" +
	"\rjoystick_left\x18\x02 \x01(\v2\x18.steam.ControllerVector2R\fjoystickLeft\x12?\n" +
	"\x0ejoystick_right\x18\x03 \x01(\v2\x18.steam.ControllerVector2R\rjoystickRight\x12=\n" +
	"\rtrackpad_left\x18\x04 \x01(\v2\x18.steam.ControllerVector2R\ftrackpadLeft\x12?\n" +
	"\x0etrackpad_right\x18\x05 \x01(\v2\x18.steam.ControllerVector2R\rtrackpadRight\x12A\n" +
	"\x0ftrackpad_center\x18\x06 \x01(\v2\x18.steam.ControllerVector2R\x0etrackpadCenter\x124\n" +
	...
	"\rtrigger_right\x18\n" +
	" \x01(\x02R\ftriggerRight\"\x8a\x03\n" +
	"5CSteamInputService_GyroQuaternionChanged_Notification\x12)\n" +
	"\x10controller_index\x18\x01 \x01(\rR\x0fcontrollerIndex\x12\x1b\n" +
	"\timu_index\x18\x02 \x01(\rR\bimuIndex\x12K\n" +
	"\x13gyro_raw_quaternion\x18\x03 \x01(\v2\x1b.steam.ControllerQuaternionR\x11gyroRawQuaternion\x12U\n" +
	"\x18gyro_filtered_quaternion\x18\x04 \x01(\v2\x1b.steam.ControllerQuaternionR\x16gyroFilteredQuaternion\x121\n" +
	"\x15imu_sensor_delta_time\x18\x05 \x01(\rR\x12imuSensorDeltaTime\x122\n" +
	"\x15estimated_packet_rate\x18\x06 \x01(\rR\x13estimatedPacketRate\"\x94\x02\n" +
	"0CSteamInputService_GyroSpeedChanged_Notification\x12)\n" +
	"\x10controller_index\x18\x01 \x01(\rR\x0fcontrollerIndex\x12\x1b\n" +
	"\timu_index\x18\x02 \x01(\rR\bimuIndex\x12F\n" +
	"\x0egyro_raw_speed\x18\x03 \x01(\v2 .steam.ControllerGyroEulerAnglesR\fgyroRawSpeed\x12P\n" +
	"\x13gyro_filtered_speed\x18\x04 \x01(\v2 .steam.ControllerGyroEulerAnglesR\x11gyroFilteredSpeed\"\x8d\x02\n" +
	"8CSteamInputService_GyroAccelerometerChanged_Notification\x12)\n" +
	"\x10controller_index\x18\x01 \x01(\rR\x0fcontrollerIndex\x12\x1b\n" +
	"\timu_index\x18\x02 \x01(\rR\bimuIndex\x12A\n" +
	"\x0facceleromter_1g\x18\x04 \x01(\v2\x18.steam.ControllerVector3R\x0eacceleromter1g\x12F\n" +
	"\x12trusted_gravity_1g\x18\x05 \x01(\v2\x18.steam.ControllerVector3R\x10trustedGravity1g\"\xb1\x03\n" +
	...
	"\rinclude_bonds\x18\x01 \x01(\bR\fincludeBonds\"\xc3\x03\n" +
	"&CSteamInputService_GetDongles_Response\x12.\n" +
	"\x13steam_controller_v1\x18\x01 \x01(\bR\x11steamControllerV1\x12Y\n" +
	"\ribex_internal\x18\x02 \x03(\v24.steam.CSteamInputService_GetDongles_Response.DongleR\fibexInternal\x12Y\n" +
	"\ribex_external\x18\x03 \x03(\v24.steam.CSteamInputService_GetDongles_Response.DongleR\fibexExternal\x1a\xb2\x01\n" +
	"\x06Dongle\x12\x14\n" +
	...
	"@CSteamInputService_WaitInitialControllerStateEnumerated_Response\"\xd2\x01\n" +
	"2CSteamInputService_ShouldTritonPairInOobe_Response\x12N\n" +
	"\tpair_type\x18\x01 \x01(\x0e2\x16.steam.ETritonPairType:\x19k_ETritonPairType_UnknownR\bpairType\x12)\n" +
	...
	"\x05input\x18\x04 \x01(\x05R\x05input\"z\n" +
	"\x1eCControllerAccessibilityString\x12-\n" +
	"\x03key\x18\x01 \x01(\v2\x1b.steam.CControllerOriginKeyR\x03key\x12)\n" +
	"\x10localized_string\x18\x02 \x01(\tR\x0flocalizedString\";\n" +
	"9CSteamInputService_ControllerAccessibilityStrings_Request\"}\n" +
	":CSteamInputService_ControllerAccessibilityStrings_Response\x12?\n" +
	"\astrings\x18\x01 \x03(\v2%.steam.CControllerAccessibilityStringR\astrings\"G\n" +
	...
	"\x10controller_index\x18\x01 \x01(\rR\x0fcontrollerIndex\"\x85\x03\n" +
	"0CSteamInputService_GetTritonPairingInfo_Response\x12P\n" +
	"\x04slot\x18\x01 \x03(\v2<.steam.CSteamInputService_GetTritonPairingInfo_Response.SlotR\x04slot\x12f\n" +
	"\x0fconnection_type\x18\x02 \x01(\x0e2\x1c.steam.ETritonConnectionType:\x1fk_ETritonConnectionType_UnknownR\x0econnectionType\x1a\x96\x01\n" +
	"\x04Slot\x12#\n" +
	"\rserial_number\x18\x01 \x01(\tR\fserialNumber\x12\x16\n" +
	"\x06active\x18\x02 \x01(\bR\x06active\x12Q\n" +
	"\x04type\x18\x03 \x01(\x0e2\x1c.steam.ETritonConnectionType:\x1fk_ETritonConnectionType_UnknownR\x04type\"~\n" +
	...
	",CSteamInputService_GetControllerList_Request\"\x84\x01\n" +
	"-CSteamInputService_GetControllerList_Response\x12S\n" +
	"\vcontrollers\x18\x01 \x03(\v21.steam.CSteamInputService_RawControllerDetailItemR\vcontrollers\"@\n" +
	...
	"\x0ebackup_channel\x18\b \x01(\rR\rbackupChannel\"\x87\x01\n" +
	")CSteamInputService_TritonQos_Notification\x12)\n" +
	"\x10controller_index\x18\x01 \x01(\rR\x0fcontrollerIndex\x12/\n" +
	"\x06status\x18\x02 \x01(\v2\x17.steam.CTritonQosStatusR\x06status\"o\n" +
	...
	"\x1ak_ETritonConnectionType_BT\x10\x042\xd9\"\n" +
	"\x11SteamInputManager\x12w\n" +
	"\x18NotifyButtonStateChanged\x12C.steam.CSteamInputService_ControllerButtonStateChanged_Notification\x1a\x16.steam.WebUINoResponse\x12r\n" +
	"\x16NotifyAxesStateChanged\x12@.steam.CSteamInputService_ControllerAxesStateChange_Notification\x1a\x16.steam.WebUINoResponse\x12x\n" +
	" NotifyGyroQuaternionStateChanged\x12<.steam.CSteamInputService_GyroQuaternionChanged_Notification\x1a\x16.steam.WebUINoResponse\x12n\n" +
	"\x1bNotifyGyroSpeedStateChanged\x127.steam.CSteamInputService_GyroSpeedChanged_Notification\x1a\x16.steam.WebUINoResponse\x12~\n" +
	"#NotifyGyroAccelerometerStateChanged\x12?.steam.CSteamInputService_GyroAccelerometerChanged_Notification\x1a\x16.steam.WebUINoResponse\x12s\n" +
	"!NotifyGyroCalibrationStateChanged\x126.steam.CSteamInputService_GyroCalibration_Notification\x1a\x16.steam.WebUINoResponse\x12o\n" +
	"\x19NotifyControllerPowerMenu\x12:.steam.CSteamInputService_ControllerPowerMenu_Notification\x1a\x16.steam.WebUINoResponse\x12w\n" +
	"\x1dNotifyUnpairedTritonPluggedIn\x12>.steam.CSteamInputService_UnpairedTritonPluggedIn_Notification\x1a\x16.steam.WebUINoResponse\x12q\n" +
	"\x1aNotifyUnpairedTritonDocked\x12;.steam.CSteamInputService_UnpairedTritonDocked_Notification\x1a\x16.steam.WebUINoResponse\x12e\n" +
	"\x14NotifyTritonUndocked\x125.steam.CSteamInputService_TritonUndocked_Notification\x1a\x16.steam.WebUINoResponse\x12q\n" +
	"\x1aNotifyTritonDonglesChanged\x12;.steam.CSteamInputService_TritonDonglesChanged_Notification\x1a\x16.steam.WebUINoResponse\x12u\n" +
	"\x1cNotifyControllerDisconnected\x12=.steam.CSteamInputService_ControllerDisconnected_Notification\x1a\x16.steam.WebUINoResponse\x12y\n" +
	"\x1eNotifyControllerPairingChanged\x12?.steam.CSteamInputService_ControllerPairingChanged_Notification\x1a\x16.steam.WebUINoResponse\x12s\n" +
	"\x1bNotifyControllerListChanged\x12<.steam.CSteamInputService_ControllerListChanged_Notification\x1a\x16.steam.WebUINoResponse\x12u\n" +
	"\x1cNotifyControllerBatteryState\x12=.steam.CSteamInputService_ControllerBatteryState_Notification\x1a\x16.steam.WebUINoResponse\x12\x85\x01\n" +
	"$NotifyFirstSteamControllerConnection\x12E.steam.CSteamInputService_FirstSteamControllerConnection_Notification\x1a\x16.steam.WebUINoResponse\x12[\n" +
	"\x0fNotifyTritonQos\x120.steam.CSteamInputService_TritonQos_Notification\x1a\x16.steam.WebUINoResponse\x12\x89\x01\n" +
	"\x18StartControllerStateFlow\x125.steam.CSteamInputService_ControllerStateFlow_Request\x1a6.steam.CSteamInputService_ControllerStateFlow_Response\x12\x87\x01\n" +
	"\x16EndControllerStateFlow\x125.steam.CSteamInputService_ControllerStateFlow_Request\x1a6.steam.CSteamInputService_ControllerStateFlow_Response\x12\xa8\x01\n" +
	"!GetControllerAccessibilityStrings\x12@.steam.CSteamInputService_ControllerAccessibilityStrings_Request\x1aA.steam.CSteamInputService_ControllerAccessibilityStrings_Response\x12\x95\x01\n" +
	"\x1cStartGyroSoftwareCalibration\x129.steam.CSteamInputService_GyroSoftwareCalibration_Request\x1a:.steam.CSteamInputService_GyroSoftwareCalibration_Response\x12\x96\x01\n" +
	"\x1dCancelGyroSoftwareCalibration\x129.steam.CSteamInputService_GyroSoftwareCalibration_Request\x1a:.steam.CSteamInputService_GyroSoftwareCalibration_Response\x12\x96\x01\n" +
	"\x19PairDongleTritonConnected\x12;.steam.CSteamInputService_PairDongleTritonConnected_Request\x1a<.steam.CSteamInputService_PairDongleTritonConnected_Response\x12\x8d\x01\n" +
	"\x16PairDongleTritonDocked\x128.steam.CSteamInputService_PairDongleTritonDocked_Request\x1a9.steam.CSteamInputService_PairDongleTritonDocked_Response\x12i\n" +
	"\n" +
	"GetDongles\x12,.steam.CSteamInputService_GetDongles_Request\x1a-.steam.CSteamInputService_GetDongles_Response\x12\x8d\x01\n" +
	"\x16ShouldTritonPairInOobe\x128.steam.CSteamInputService_ShouldTritonPairInOobe_Request\x1a9.steam.CSteamInputService_ShouldTritonPairInOobe_Response\x12\xb7\x01\n" +
	"$WaitInitialControllerStateEnumerated\x12F.steam.CSteamInputService_WaitInitialControllerStateEnumerated_Request\x1aG.steam.CSteamInputService_WaitInitialControllerStateEnumerated_Response\x12\x87\x01\n" +
	"\x14GetTritonPairingInfo\x126.steam.CSteamInputService_GetTritonPairingInfo_Request\x1a7.steam.CSteamInputService_GetTritonPairingInfo_Response\x12\x90\x01\n" +
	"\x17ForgetTritonPairingBond\x129.steam.CSteamInputService_ForgetTritonPairingBond_Request\x1a:.steam.CSteamInputService_ForgetTritonPairingBond_Response\x12\x90\x01\n" +
	"\x17ForgetDonglePairingBond\x129.steam.CSteamInputService_ForgetDonglePairingBond_Request\x1a:.steam.CSteamInputService_ForgetDonglePairingBond_Response\x12~\n" +
	"\x11GetControllerName\x123.steam.CSteamInputService_GetControllerName_Request\x1a4.steam.CSteamInputService_GetControllerName_Response\x12~\n" +
	"\x11GetControllerList\x123.steam.CSteamInputService_GetControllerList_Request\x1a4.steam.CSteamInputService_GetControllerList_Response\x12~\n" +
	"\x11EnableDockedInput\x123.steam.CSteamInputService_EnableDockedInput_Request\x1a4.steam.CSteamInputService_EnableDockedInput_Response\x12x\n" +
	"\x0fEnableQosStatus\x121.steam.CSteamInputService_EnableQosStatus_Request\x1a2.steam.CSteamInputService_EnableQosStatus_Response\x1a\x04\x80\x97\"\x02B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_webuimessages_steaminput_proto_goTypes = []any{
	(ETritonPairType)(0),       // 0: steam.ETritonPairType
	(ETritonConnectionType)(0), // 1: steam.ETritonConnectionType
	(*CSteamInputService_ControllerButtonStateChanged_Notification)(nil), // 2: steam.CSteamInputService_ControllerButtonStateChanged_Notification
	(*ControllerVector2)(nil),                                                // 3: steam.ControllerVector2
	(*ControllerVector3)(nil),                                                // 4: steam.ControllerVector3
	(*ControllerQuaternion)(nil),                                             // 5: steam.ControllerQuaternion
	(*ControllerGyroEulerAngles)(nil),                                        // 6: steam.ControllerGyroEulerAngles
	(*CSteamInputService_ControllerAxesStateChange_Notification)(nil),        // 7: steam.CSteamInputService_ControllerAxesStateChange_Notification
	(*CSteamInputService_GyroQuaternionChanged_Notification)(nil),            // 8: steam.CSteamInputService_GyroQuaternionChanged_Notification
	(*CSteamInputService_GyroSpeedChanged_Notification)(nil),                 // 9: steam.CSteamInputService_GyroSpeedChanged_Notification
	(*CSteamInputService_GyroAccelerometerChanged_Notification)(nil),         // 10: steam.CSteamInputService_GyroAccelerometerChanged_Notification
	(*CSteamInputService_GyroCalibration_Notification)(nil),                  // 11: steam.CSteamInputService_GyroCalibration_Notification
	(*CSteamInputService_ControllerStateFlow_Request)(nil),                   // 12: steam.CSteamInputService_ControllerStateFlow_Request
	(*CSteamInputService_ControllerStateFlow_Response)(nil),                  // 13: steam.CSteamInputService_ControllerStateFlow_Response
	(*CSteamInputService_GyroSoftwareCalibration_Request)(nil),               // 14: steam.CSteamInputService_GyroSoftwareCalibration_Request
	(*CSteamInputService_GyroSoftwareCalibration_Response)(nil),              // 15: steam.CSteamInputService_GyroSoftwareCalibration_Response
	(*CSteamInputService_PairDongleTritonConnected_Request)(nil),             // 16: steam.CSteamInputService_PairDongleTritonConnected_Request
	(*CSteamInputService_PairDongleTritonConnected_Response)(nil),            // 17: steam.CSteamInputService_PairDongleTritonConnected_Response
	(*CSteamInputService_TritonDonglesChanged_Notification)(nil),             // 18: steam.CSteamInputService_TritonDonglesChanged_Notification
	(*CSteamInputService_UnpairedTritonPluggedIn_Notification)(nil),          // 19: steam.CSteamInputService_UnpairedTritonPluggedIn_Notification
	(*CSteamInputService_UnpairedTritonDocked_Notification)(nil),             // 20: steam.CSteamInputService_UnpairedTritonDocked_Notification
	(*CSteamInputService_TritonUndocked_Notification)(nil),                   // 21: steam.CSteamInputService_TritonUndocked_Notification
	(*CSteamInputService_ControllerPairingChanged_Notification)(nil),         // 22: steam.CSteamInputService_ControllerPairingChanged_Notification
	(*CSteamInputService_PairDongleTritonDocked_Request)(nil),                // 23: steam.CSteamInputService_PairDongleTritonDocked_Request
	(*CSteamInputService_PairDongleTritonDocked_Response)(nil),               // 24: steam.CSteamInputService_PairDongleTritonDocked_Response
	(*CSteamInputService_GetDongles_Request)(nil),                            // 25: steam.CSteamInputService_GetDongles_Request
	(*CSteamInputService_GetDongles_Response)(nil),                           // 26: steam.CSteamInputService_GetDongles_Response
	(*CSteamInputService_ShouldTritonPairInOobe_Request)(nil),                // 27: steam.CSteamInputService_ShouldTritonPairInOobe_Request
	(*CSteamInputService_WaitInitialControllerStateEnumerated_Request)(nil),  // 28: steam.CSteamInputService_WaitInitialControllerStateEnumerated_Request
	(*CSteamInputService_WaitInitialControllerStateEnumerated_Response)(nil), // 29: steam.CSteamInputService_WaitInitialControllerStateEnumerated_Response
	(*CSteamInputService_ShouldTritonPairInOobe_Response)(nil),               // 30: steam.CSteamInputService_ShouldTritonPairInOobe_Response
	(*CControllerOriginKey)(nil),                                             // 31: steam.CControllerOriginKey
	(*CControllerAccessibilityString)(nil),                                   // 32: steam.CControllerAccessibilityString
	(*CSteamInputService_ControllerAccessibilityStrings_Request)(nil),        // 33: steam.CSteamInputService_ControllerAccessibilityStrings_Request
	(*CSteamInputService_ControllerAccessibilityStrings_Response)(nil),       // 34: steam.CSteamInputService_ControllerAccessibilityStrings_Response
	(*CSteamInputService_ControllerPowerMenu_Notification)(nil),              // 35: steam.CSteamInputService_ControllerPowerMenu_Notification
	(*CSteamInputService_ControllerDisconnected_Notification)(nil),           // 36: steam.CSteamInputService_ControllerDisconnected_Notification
	(*CSteamInputService_GetTritonPairingInfo_Request)(nil),                  // 37: steam.CSteamInputService_GetTritonPairingInfo_Request
	(*CSteamInputService_GetTritonPairingInfo_Response)(nil),                 // 38: steam.CSteamInputService_GetTritonPairingInfo_Response
	(*CSteamInputService_ForgetTritonPairingBond_Request)(nil),               // 39: steam.CSteamInputService_ForgetTritonPairingBond_Request
	(*CSteamInputService_ForgetTritonPairingBond_Response)(nil),              // 40: steam.CSteamInputService_ForgetTritonPairingBond_Response
	(*CSteamInputService_ForgetDonglePairingBond_Request)(nil),               // 41: steam.CSteamInputService_ForgetDonglePairingBond_Request
	(*CSteamInputService_ForgetDonglePairingBond_Response)(nil),              // 42: steam.CSteamInputService_ForgetDonglePairingBond_Response
	(*CSteamInputService_GetControllerName_Request)(nil),                     // 43: steam.CSteamInputService_GetControllerName_Request
	(*CSteamInputService_GetControllerName_Response)(nil),                    // 44: steam.CSteamInputService_GetControllerName_Response
	(*CSteamInputService_EnableDockedInput_Request)(nil),                     // 45: steam.CSteamInputService_EnableDockedInput_Request
	(*CSteamInputService_EnableDockedInput_Response)(nil),                    // 46: steam.CSteamInputService_EnableDockedInput_Response
	(*CSteamInputService_RawControllerDetailItem)(nil),                       // 47: steam.CSteamInputService_RawControllerDetailItem
	(*CSteamInputService_ControllerListChanged_Notification)(nil),            // 48: steam.CSteamInputService_ControllerListChanged_Notification
	(*CSteamInputService_InitControllerList_Request)(nil),                    // 49: steam.CSteamInputService_InitControllerList_Request
	(*CSteamInputService_InitControllerList_Response)(nil),                   // 50: steam.CSteamInputService_InitControllerList_Response
	(*CSteamInputService_GetControllerList_Request)(nil),                     // 51: steam.CSteamInputService_GetControllerList_Request
	(*CSteamInputService_GetControllerList_Response)(nil),                    // 52: steam.CSteamInputService_GetControllerList_Response
	(*CSteamInputService_FirstSteamControllerConnection_Notification)(nil),   // 53: steam.CSteamInputService_FirstSteamControllerConnection_Notification
	(*CTritonQosStatus)(nil),                                                 // 54: steam.CTritonQosStatus
	(*CSteamInputService_TritonQos_Notification)(nil),                        // 55: steam.CSteamInputService_TritonQos_Notification
	(*CSteamInputService_EnableQosStatus_Request)(nil),                       // 56: steam.CSteamInputService_EnableQosStatus_Request
	(*CSteamInputService_EnableQosStatus_Response)(nil),                      // 57: steam.CSteamInputService_EnableQosStatus_Response
	(*CSteamInputService_ControllerBatteryState_Notification)(nil),           // 58: steam.CSteamInputService_ControllerBatteryState_Notification
	(*CSteamInputService_GetDongles_Response_Dongle)(nil),                    // 59: steam.CSteamInputService_GetDongles_Response.Dongle
	(*CSteamInputService_GetTritonPairingInfo_Response_Slot)(nil),            // 60: steam.CSteamInputService_GetTritonPairingInfo_Response.Slot
	(*WebUINoResponse)(nil),                                                  // 61: steam.WebUINoResponse
}
var file_webuimessages_steaminput_proto_depIdxs = []int32{
	3,  // 0: steam.CSteamInputService_ControllerAxesStateChange_Notification.joystick_left:type_name -> steam.ControllerVector2
	3,  // 1: steam.CSteamInputService_ControllerAxesStateChange_Notification.joystick_right:type_name -> steam.ControllerVector2
	3,  // 2: steam.CSteamInputService_ControllerAxesStateChange_Notification.trackpad_left:type_name -> steam.ControllerVector2
	3,  // 3: steam.CSteamInputService_ControllerAxesStateChange_Notification.trackpad_right:type_name -> steam.ControllerVector2
	3,  // 4: steam.CSteamInputService_ControllerAxesStateChange_Notification.trackpad_center:type_name -> steam.ControllerVector2
	5,  // 5: steam.CSteamInputService_GyroQuaternionChanged_Notification.gyro_raw_quaternion:type_name -> steam.ControllerQuaternion
	5,  // 6: steam.CSteamInputService_GyroQuaternionChanged_Notification.gyro_filtered_quaternion:type_name -> steam.ControllerQuaternion
	6,  // 7: steam.CSteamInputService_GyroSpeedChanged_Notification.gyro_raw_speed:type_name -> steam.ControllerGyroEulerAngles
	6,  // 8: steam.CSteamInputService_GyroSpeedChanged_Notification.gyro_filtered_speed:type_name -> steam.ControllerGyroEulerAngles
	4,  // 9: steam.CSteamInputService_GyroAccelerometerChanged_Notification.acceleromter_1g:type_name -> steam.ControllerVector3
	4,  // 10: steam.CSteamInputService_GyroAccelerometerChanged_Notification.trusted_gravity_1g:type_name -> steam.ControllerVector3
	59, // 11: steam.CSteamInputService_GetDongles_Response.ibex_internal:type_name -> steam.CSteamInputService_GetDongles_Response.Dongle
	59, // 12: steam.CSteamInputService_GetDongles_Response.ibex_external:type_name -> steam.CSteamInputService_GetDongles_Response.Dongle
	0,  // 13: steam.CSteamInputService_ShouldTritonPairInOobe_Response.pair_type:type_name -> steam.ETritonPairType
	31, // 14: steam.CControllerAccessibilityString.key:type_name -> steam.CControllerOriginKey
	32, // 15: steam.CSteamInputService_ControllerAccessibilityStrings_Response.strings:type_name -> steam.CControllerAccessibilityString
	60, // 16: steam.CSteamInputService_GetTritonPairingInfo_Response.slot:type_name -> steam.CSteamInputService_GetTritonPairingInfo_Response.Slot
	1,  // 17: steam.CSteamInputService_GetTritonPairingInfo_Response.connection_type:type_name -> steam.ETritonConnectionType
	47, // 18: steam.CSteamInputService_GetControllerList_Response.controllers:type_name -> steam.CSteamInputService_RawControllerDetailItem
	54, // 19: steam.CSteamInputService_TritonQos_Notification.status:type_name -> steam.CTritonQosStatus
	1,  // 20: steam.CSteamInputService_GetTritonPairingInfo_Response.Slot.type:type_name -> steam.ETritonConnectionType
	2,  // 21: steam.SteamInputManager.NotifyButtonStateChanged:input_type -> steam.CSteamInputService_ControllerButtonStateChanged_Notification
	7,  // 22: steam.SteamInputManager.NotifyAxesStateChanged:input_type -> steam.CSteamInputService_ControllerAxesStateChange_Notification
	8,  // 23: steam.SteamInputManager.NotifyGyroQuaternionStateChanged:input_type -> steam.CSteamInputService_GyroQuaternionChanged_Notification
	9,  // 24: steam.SteamInputManager.NotifyGyroSpeedStateChanged:input_type -> steam.CSteamInputService_GyroSpeedChanged_Notification
	10, // 25: steam.SteamInputManager.NotifyGyroAccelerometerStateChanged:input_type -> steam.CSteamInputService_GyroAccelerometerChanged_Notification
	11, // 26: steam.SteamInputManager.NotifyGyroCalibrationStateChanged:input_type -> steam.CSteamInputService_GyroCalibration_Notification
	35, // 27: steam.SteamInputManager.NotifyControllerPowerMenu:input_type -> steam.CSteamInputService_ControllerPowerMenu_Notification
	19, // 28: steam.SteamInputManager.NotifyUnpairedTritonPluggedIn:input_type -> steam.CSteamInputService_UnpairedTritonPluggedIn_Notification
	20, // 29: steam.SteamInputManager.NotifyUnpairedTritonDocked:input_type -> steam.CSteamInputService_UnpairedTritonDocked_Notification
	21, // 30: steam.SteamInputManager.NotifyTritonUndocked:input_type -> steam.CSteamInputService_TritonUndocked_Notification
	18, // 31: steam.SteamInputManager.NotifyTritonDonglesChanged:input_type -> steam.CSteamInputService_TritonDonglesChanged_Notification
	36, // 32: steam.SteamInputManager.NotifyControllerDisconnected:input_type -> steam.CSteamInputService_ControllerDisconnected_Notification
	22, // 33: steam.SteamInputManager.NotifyControllerPairingChanged:input_type -> steam.CSteamInputService_ControllerPairingChanged_Notification
	48, // 34: steam.SteamInputManager.NotifyControllerListChanged:input_type -> steam.CSteamInputService_ControllerListChanged_Notification
	58, // 35: steam.SteamInputManager.NotifyControllerBatteryState:input_type -> steam.CSteamInputService_ControllerBatteryState_Notification
	53, // 36: steam.SteamInputManager.NotifyFirstSteamControllerConnection:input_type -> steam.CSteamInputService_FirstSteamControllerConnection_Notification
	55, // 37: steam.SteamInputManager.NotifyTritonQos:input_type -> steam.CSteamInputService_TritonQos_Notification
	12, // 38: steam.SteamInputManager.StartControllerStateFlow:input_type -> steam.CSteamInputService_ControllerStateFlow_Request
	12, // 39: steam.SteamInputManager.EndControllerStateFlow:input_type -> steam.CSteamInputService_ControllerStateFlow_Request
	33, // 40: steam.SteamInputManager.GetControllerAccessibilityStrings:input_type -> steam.CSteamInputService_ControllerAccessibilityStrings_Request
	14, // 41: steam.SteamInputManager.StartGyroSoftwareCalibration:input_type -> steam.CSteamInputService_GyroSoftwareCalibration_Request
	14, // 42: steam.SteamInputManager.CancelGyroSoftwareCalibration:input_type -> steam.CSteamInputService_GyroSoftwareCalibration_Request
	16, // 43: steam.SteamInputManager.PairDongleTritonConnected:input_type -> steam.CSteamInputService_PairDongleTritonConnected_Request
	23, // 44: steam.SteamInputManager.PairDongleTritonDocked:input_type -> steam.CSteamInputService_PairDongleTritonDocked_Request
	25, // 45: steam.SteamInputManager.GetDongles:input_type -> steam.CSteamInputService_GetDongles_Request
	27, // 46: steam.SteamInputManager.ShouldTritonPairInOobe:input_type -> steam.CSteamInputService_ShouldTritonPairInOobe_Request
	28, // 47: steam.SteamInputManager.WaitInitialControllerStateEnumerated:input_type -> steam.CSteamInputService_WaitInitialControllerStateEnumerated_Request
	37, // 48: steam.SteamInputManager.GetTritonPairingInfo:input_type -> steam.CSteamInputService_GetTritonPairingInfo_Request
	39, // 49: steam.SteamInputManager.ForgetTritonPairingBond:input_type -> steam.CSteamInputService_ForgetTritonPairingBond_Request
	41, // 50: steam.SteamInputManager.ForgetDonglePairingBond:input_type -> steam.CSteamInputService_ForgetDonglePairingBond_Request
	43, // 51: steam.SteamInputManager.GetControllerName:input_type -> steam.CSteamInputService_GetControllerName_Request
	51, // 52: steam.SteamInputManager.GetControllerList:input_type -> steam.CSteamInputService_GetControllerList_Request
	45, // 53: steam.SteamInputManager.EnableDockedInput:input_type -> steam.CSteamInputService_EnableDockedInput_Request
	56, // 54: steam.SteamInputManager.EnableQosStatus:input_type -> steam.CSteamInputService_EnableQosStatus_Request
	61, // 55: steam.SteamInputManager.NotifyButtonStateChanged:output_type -> steam.WebUINoResponse
	61, // 56: steam.SteamInputManager.NotifyAxesStateChanged:output_type -> steam.WebUINoResponse
	61, // 57: steam.SteamInputManager.NotifyGyroQuaternionStateChanged:output_type -> steam.WebUINoResponse
	61, // 58: steam.SteamInputManager.NotifyGyroSpeedStateChanged:output_type -> steam.WebUINoResponse
	61, // 59: steam.SteamInputManager.NotifyGyroAccelerometerStateChanged:output_type -> steam.WebUINoResponse
	61, // 60: steam.SteamInputManager.NotifyGyroCalibrationStateChanged:output_type -> steam.WebUINoResponse
	61, // 61: steam.SteamInputManager.NotifyControllerPowerMenu:output_type -> steam.WebUINoResponse
	61, // 62: steam.SteamInputManager.NotifyUnpairedTritonPluggedIn:output_type -> steam.WebUINoResponse
	61, // 63: steam.SteamInputManager.NotifyUnpairedTritonDocked:output_type -> steam.WebUINoResponse
	61, // 64: steam.SteamInputManager.NotifyTritonUndocked:output_type -> steam.WebUINoResponse
	61, // 65: steam.SteamInputManager.NotifyTritonDonglesChanged:output_type -> steam.WebUINoResponse
	61, // 66: steam.SteamInputManager.NotifyControllerDisconnected:output_type -> steam.WebUINoResponse
	61, // 67: steam.SteamInputManager.NotifyControllerPairingChanged:output_type -> steam.WebUINoResponse
	61, // 68: steam.SteamInputManager.NotifyControllerListChanged:output_type -> steam.WebUINoResponse
	61, // 69: steam.SteamInputManager.NotifyControllerBatteryState:output_type -> steam.WebUINoResponse
	61, // 70: steam.SteamInputManager.NotifyFirstSteamControllerConnection:output_type -> steam.WebUINoResponse
	61, // 71: steam.SteamInputManager.NotifyTritonQos:output_type -> steam.WebUINoResponse
	13, // 72: steam.SteamInputManager.StartControllerStateFlow:output_type -> steam.CSteamInputService_ControllerStateFlow_Response
	13, // 73: steam.SteamInputManager.EndControllerStateFlow:output_type -> steam.CSteamInputService_ControllerStateFlow_Response
	34, // 74: steam.SteamInputManager.GetControllerAccessibilityStrings:output_type -> steam.CSteamInputService_ControllerAccessibilityStrings_Response
	15, // 75: steam.SteamInputManager.StartGyroSoftwareCalibration:output_type -> steam.CSteamInputService_GyroSoftwareCalibration_Response
	15, // 76: steam.SteamInputManager.CancelGyroSoftwareCalibration:output_type -> steam.CSteamInputService_GyroSoftwareCalibration_Response
	17, // 77: steam.SteamInputManager.PairDongleTritonConnected:output_type -> steam.CSteamInputService_PairDongleTritonConnected_Response
	24, // 78: steam.SteamInputManager.PairDongleTritonDocked:output_type -> steam.CSteamInputService_PairDongleTritonDocked_Response
	26, // 79: steam.SteamInputManager.GetDongles:output_type -> steam.CSteamInputService_GetDongles_Response
	30, // 80: steam.SteamInputManager.ShouldTritonPairInOobe:output_type -> steam.CSteamInputService_ShouldTritonPairInOobe_Response
	29, // 81: steam.SteamInputManager.WaitInitialControllerStateEnumerated:output_type -> steam.CSteamInputService_WaitInitialControllerStateEnumerated_Response
	38, // 82: steam.SteamInputManager.GetTritonPairingInfo:output_type -> steam.CSteamInputService_GetTritonPairingInfo_Response
	40, // 83: steam.SteamInputManager.ForgetTritonPairingBond:output_type -> steam.CSteamInputService_ForgetTritonPairingBond_Response
	42, // 84: steam.SteamInputManager.ForgetDonglePairingBond:output_type -> steam.CSteamInputService_ForgetDonglePairingBond_Response
	44, // 85: steam.SteamInputManager.GetControllerName:output_type -> steam.CSteamInputService_GetControllerName_Response
	52, // 86: steam.SteamInputManager.GetControllerList:output_type -> steam.CSteamInputService_GetControllerList_Response
	46, // 87: steam.SteamInputManager.EnableDockedInput:output_type -> steam.CSteamInputService_EnableDockedInput_Response
	57, // 88: steam.SteamInputManager.EnableQosStatus:output_type -> steam.CSteamInputService_EnableQosStatus_Response
