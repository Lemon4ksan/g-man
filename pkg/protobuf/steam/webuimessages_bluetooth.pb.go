...
const file_webuimessages_bluetooth_proto_rawDesc = "" +
	"\n" +
	"\x1dwebuimessages_bluetooth.proto\x12\x05steam\x1a\venums.proto\x1a\x18steammessages_base.proto\x1a\x18webuimessages_base.proto\"$\n" +
	"\"CBluetoothManager_GetState_Request\"1\n" +
	"\x1fCMsgBluetoothManagerAdapterInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\"\x8f\x02\n" +
	"\x1eCMsgBluetoothManagerDeviceInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12(\n" +
	"\x10should_hide_hint\x18\x02 \x01(\bR\x0eshouldHideHint\x12P\n" +
	"\x05etype\x18\x03 \x01(\x0e2\x1b.steam.EBluetoothDeviceType:\x1dk_BluetoothDeviceType_InvalidR\x05etype\x12!\n" +
	"\fis_connected\x18\x04 \x01(\bR\visConnected\x12\x1b\n" +
	"\tis_paired\x18\x05 \x01(\bR\bisPaired\x12!\n" +
	"\fstrength_raw\x18\x06 \x01(\x05R\vstrengthRaw\"\xa2\x02\n" +
	...
	"\x0eis_discovering\x18\x03 \x01(\bR\risDiscovering\x12B\n" +
	"\badapters\x18\x04 \x03(\v2&.steam.CMsgBluetoothManagerAdapterInfoR\badapters\x12?\n" +
	"\adevices\x18\x05 \x03(\v2%.steam.CMsgBluetoothManagerDeviceInfoR\adevices\"=\n" +
	...
	"\x0eis_discovering\x18\x05 \x01(\bR\risDiscovering\"s\n" +
	",CBluetoothManager_GetAdapterDetails_Response\x12C\n" +
	"\aadapter\x18\x01 \x01(\v2).steam.CMsgBluetoothManagerAdapterDetailsR\aadapter\"<\n" +
	"*CBluetoothManager_GetDeviceDetails_Request\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\"\x84\x04\n" +
	...
	"\n" +
	"is_trusted\x18\r \x01(\bR\tisTrusted\"o\n" +
	"+CBluetoothManager_GetDeviceDetails_Response\x12@\n" +
	"\x06device\x18\x01 \x01(\v2(.steam.CMsgBluetoothManagerDeviceDetailsR\x06device\"-\n" +
	...
	"%CBluetoothManager_SetTrusted_Response2\x94\v\n" +
	"\x10BluetoothManager\x12a\n" +
	"\bGetState\x12).steam.CBluetoothManager_GetState_Request\x1a*.steam.CBluetoothManager_GetState_Response\x12|\n" +
	"\x11GetAdapterDetails\x122.steam.CBluetoothManager_GetAdapterDetails_Request\x1a3.steam.CBluetoothManager_GetAdapterDetails_Response\x12y\n" +
	"\x10GetDeviceDetails\x121.steam.CBluetoothManager_GetDeviceDetails_Request\x1a2.steam.CBluetoothManager_GetDeviceDetails_Response\x12`\n" +
	"\x12NotifyStateChanged\x122.steam.CBluetoothManager_StateChanged_Notification\x1a\x16.steam.WebUINoResponse\x12s\n" +
	"\x0eSetDiscovering\x12/.steam.CBluetoothManager_SetDiscovering_Request\x1a0.steam.CBluetoothManager_SetDiscovering_Response\x12\x82\x01\n" +
	"\x13SetLoginAdvertising\x124.steam.CBluetoothManager_SetLoginAdvertising_Request\x1a5.steam.CBluetoothManager_SetLoginAdvertising_Response\x12U\n" +
	"\x04Pair\x12%.steam.CBluetoothManager_Pair_Request\x1a&.steam.CBluetoothManager_Pair_Response\x12g\n" +
	"\n" +
	"CancelPair\x12+.steam.CBluetoothManager_CancelPair_Request\x1a,.steam.CBluetoothManager_CancelPair_Response\x12[\n" +
	"\x06Forget\x12'.steam.CBluetoothManager_Forget_Request\x1a(.steam.CBluetoothManager_Forget_Response\x12^\n" +
	"\aConnect\x12(.steam.CBluetoothManager_Connect_Request\x1a).steam.CBluetoothManager_Connect_Response\x12g\n" +
	"\n" +
	"Disconnect\x12+.steam.CBluetoothManager_Disconnect_Request\x1a,.steam.CBluetoothManager_Disconnect_Response\x12s\n" +
	"\x0eSetWakeAllowed\x12/.steam.CBluetoothManager_SetWakeAllowed_Request\x1a0.steam.CBluetoothManager_SetWakeAllowed_Response\x12g\n" +
	"\n" +
	"SetTrusted\x12+.steam.CBluetoothManager_SetTrusted_Request\x1a,.steam.CBluetoothManager_SetTrusted_Response\x1a\x04\x80\x97\"\x01B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_webuimessages_bluetooth_proto_goTypes = []any{
	(*CBluetoothManager_GetState_Request)(nil),             // 0: steam.CBluetoothManager_GetState_Request
	(*CMsgBluetoothManagerAdapterInfo)(nil),                // 1: steam.CMsgBluetoothManagerAdapterInfo
	(*CMsgBluetoothManagerDeviceInfo)(nil),                 // 2: steam.CMsgBluetoothManagerDeviceInfo
	(*CBluetoothManager_GetState_Response)(nil),            // 3: steam.CBluetoothManager_GetState_Response
	(*CBluetoothManager_GetAdapterDetails_Request)(nil),    // 4: steam.CBluetoothManager_GetAdapterDetails_Request
	(*CMsgBluetoothManagerAdapterDetails)(nil),             // 5: steam.CMsgBluetoothManagerAdapterDetails
	(*CBluetoothManager_GetAdapterDetails_Response)(nil),   // 6: steam.CBluetoothManager_GetAdapterDetails_Response
	(*CBluetoothManager_GetDeviceDetails_Request)(nil),     // 7: steam.CBluetoothManager_GetDeviceDetails_Request
	(*CMsgBluetoothManagerDeviceDetails)(nil),              // 8: steam.CMsgBluetoothManagerDeviceDetails
	(*CBluetoothManager_GetDeviceDetails_Response)(nil),    // 9: steam.CBluetoothManager_GetDeviceDetails_Response
	(*CBluetoothManager_StateChanged_Notification)(nil),    // 10: steam.CBluetoothManager_StateChanged_Notification
	(*CBluetoothManager_SetDiscovering_Request)(nil),       // 11: steam.CBluetoothManager_SetDiscovering_Request
	(*CBluetoothManager_SetDiscovering_Response)(nil),      // 12: steam.CBluetoothManager_SetDiscovering_Response
	(*CBluetoothManager_SetLoginAdvertising_Request)(nil),  // 13: steam.CBluetoothManager_SetLoginAdvertising_Request
	(*CBluetoothManager_SetLoginAdvertising_Response)(nil), // 14: steam.CBluetoothManager_SetLoginAdvertising_Response
	(*CBluetoothManager_Pair_Request)(nil),                 // 15: steam.CBluetoothManager_Pair_Request
	(*CBluetoothManager_Pair_Response)(nil),                // 16: steam.CBluetoothManager_Pair_Response
	(*CBluetoothManager_CancelPair_Request)(nil),           // 17: steam.CBluetoothManager_CancelPair_Request
	(*CBluetoothManager_CancelPair_Response)(nil),          // 18: steam.CBluetoothManager_CancelPair_Response
	(*CBluetoothManager_Forget_Request)(nil),               // 19: steam.CBluetoothManager_Forget_Request
	(*CBluetoothManager_Forget_Response)(nil),              // 20: steam.CBluetoothManager_Forget_Response
	(*CBluetoothManager_Connect_Request)(nil),              // 21: steam.CBluetoothManager_Connect_Request
	(*CBluetoothManager_Connect_Response)(nil),             // 22: steam.CBluetoothManager_Connect_Response
	(*CBluetoothManager_Disconnect_Request)(nil),           // 23: steam.CBluetoothManager_Disconnect_Request
	(*CBluetoothManager_Disconnect_Response)(nil),          // 24: steam.CBluetoothManager_Disconnect_Response
	(*CBluetoothManager_SetWakeAllowed_Request)(nil),       // 25: steam.CBluetoothManager_SetWakeAllowed_Request
	(*CBluetoothManager_SetWakeAllowed_Response)(nil),      // 26: steam.CBluetoothManager_SetWakeAllowed_Response
	(*CBluetoothManager_SetTrusted_Request)(nil),           // 27: steam.CBluetoothManager_SetTrusted_Request
	(*CBluetoothManager_SetTrusted_Response)(nil),          // 28: steam.CBluetoothManager_SetTrusted_Response
	(EBluetoothDeviceType)(0),                              // 29: steam.EBluetoothDeviceType
	(*WebUINoResponse)(nil),                                // 30: steam.WebUINoResponse
}
var file_webuimessages_bluetooth_proto_depIdxs = []int32{
	29, // 0: steam.CMsgBluetoothManagerDeviceInfo.etype:type_name -> steam.EBluetoothDeviceType
	1,  // 1: steam.CBluetoothManager_GetState_Response.adapters:type_name -> steam.CMsgBluetoothManagerAdapterInfo
	2,  // 2: steam.CBluetoothManager_GetState_Response.devices:type_name -> steam.CMsgBluetoothManagerDeviceInfo
	5,  // 3: steam.CBluetoothManager_GetAdapterDetails_Response.adapter:type_name -> steam.CMsgBluetoothManagerAdapterDetails
	29, // 4: steam.CMsgBluetoothManagerDeviceDetails.etype:type_name -> steam.EBluetoothDeviceType
	8,  // 5: steam.CBluetoothManager_GetDeviceDetails_Response.device:type_name -> steam.CMsgBluetoothManagerDeviceDetails
	0,  // 6: steam.BluetoothManager.GetState:input_type -> steam.CBluetoothManager_GetState_Request
	4,  // 7: steam.BluetoothManager.GetAdapterDetails:input_type -> steam.CBluetoothManager_GetAdapterDetails_Request
	7,  // 8: steam.BluetoothManager.GetDeviceDetails:input_type -> steam.CBluetoothManager_GetDeviceDetails_Request
	10, // 9: steam.BluetoothManager.NotifyStateChanged:input_type -> steam.CBluetoothManager_StateChanged_Notification
	11, // 10: steam.BluetoothManager.SetDiscovering:input_type -> steam.CBluetoothManager_SetDiscovering_Request
	13, // 11: steam.BluetoothManager.SetLoginAdvertising:input_type -> steam.CBluetoothManager_SetLoginAdvertising_Request
	15, // 12: steam.BluetoothManager.Pair:input_type -> steam.CBluetoothManager_Pair_Request
	17, // 13: steam.BluetoothManager.CancelPair:input_type -> steam.CBluetoothManager_CancelPair_Request
	19, // 14: steam.BluetoothManager.Forget:input_type -> steam.CBluetoothManager_Forget_Request
	21, // 15: steam.BluetoothManager.Connect:input_type -> steam.CBluetoothManager_Connect_Request
	23, // 16: steam.BluetoothManager.Disconnect:input_type -> steam.CBluetoothManager_Disconnect_Request
	25, // 17: steam.BluetoothManager.SetWakeAllowed:input_type -> steam.CBluetoothManager_SetWakeAllowed_Request
	27, // 18: steam.BluetoothManager.SetTrusted:input_type -> steam.CBluetoothManager_SetTrusted_Request
	3,  // 19: steam.BluetoothManager.GetState:output_type -> steam.CBluetoothManager_GetState_Response
	6,  // 20: steam.BluetoothManager.GetAdapterDetails:output_type -> steam.CBluetoothManager_GetAdapterDetails_Response
	9,  // 21: steam.BluetoothManager.GetDeviceDetails:output_type -> steam.CBluetoothManager_GetDeviceDetails_Response
	30, // 22: steam.BluetoothManager.NotifyStateChanged:output_type -> steam.WebUINoResponse
	12, // 23: steam.BluetoothManager.SetDiscovering:output_type -> steam.CBluetoothManager_SetDiscovering_Response
	14, // 24: steam.BluetoothManager.SetLoginAdvertising:output_type -> steam.CBluetoothManager_SetLoginAdvertising_Response
	16, // 25: steam.BluetoothManager.Pair:output_type -> steam.CBluetoothManager_Pair_Response
	18, // 26: steam.BluetoothManager.CancelPair:output_type -> steam.CBluetoothManager_CancelPair_Response
	20, // 27: steam.BluetoothManager.Forget:output_type -> steam.CBluetoothManager_Forget_Response
	22, // 28: steam.BluetoothManager.Connect:output_type -> steam.CBluetoothManager_Connect_Response
	24, // 29: steam.BluetoothManager.Disconnect:output_type -> steam.CBluetoothManager_Disconnect_Response
	26, // 30: steam.BluetoothManager.SetWakeAllowed:output_type -> steam.CBluetoothManager_SetWakeAllowed_Response
	28, // 31: steam.BluetoothManager.SetTrusted:output_type -> steam.CBluetoothManager_SetTrusted_Response
