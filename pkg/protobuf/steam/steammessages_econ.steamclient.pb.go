...
type CEconItem_AssetPropertySchema struct {
	...
	Name                *string                `protobuf:"bytes,2,opt,name=name" json:"name,omitempty"`
	Type                *EAssetPropertyType    `protobuf:"varint,3,opt,name=type,enum=steam.EAssetPropertyType,def=0" json:"type,omitempty"`
...
const file_steammessages_econ_steamclient_proto_rawDesc = "" +
	"\n" +
	"$steammessages_econ.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"\xf2\x04\n" +
	...
	"\afilters\x18\x06 \x01(\v2D.steam.CEcon_GetInventoryItemsWithDescriptions_Request.FilterOptionsR\afilters\x12#\n" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name\"\xb6\f\n" +
	...
	"\x0eicon_url_large\x18\a \x01(\tR\ficonUrlLarge\x12D\n" +
	"\fdescriptions\x18\b \x03(\v2 .steam.CEconItem_DescriptionLineR\fdescriptions\x12\x1a\n" +
	"\btradable\x18\t \x01(\bR\btradable\x121\n" +
	"\aactions\x18\n" +
	" \x03(\v2\x17.steam.CEconItem_ActionR\aactions\x12O\n" +
	"\x12owner_descriptions\x18\v \x03(\v2 .steam.CEconItem_DescriptionLineR\x11ownerDescriptions\x12<\n" +
	"\rowner_actions\x18\f \x03(\v2\x17.steam.CEconItem_ActionR\fownerActions\x12$\n" +
	...
	"\x0econtained_item\x18\x14 \x01(\v2\x1c.steam.CEconItem_DescriptionR\rcontainedItem\x12>\n" +
	"\x0emarket_actions\x18\x15 \x03(\v2\x17.steam.CEconItem_ActionR\rmarketActions\x12\x1c\n" +
	...
	"marketable\x12(\n" +
	"\x04tags\x18\x1a \x03(\v2\x14.steam.CEconItem_TagR\x04tags\x12'\n" +
	...
	"\x06sealed\x18  \x01(\bR\x06sealed\x12W\n" +
	"\x14container_properties\x18! \x01(\v2$.steam.CEconItem_ContainerPropertiesR\x13containerProperties\x127\n" +
	...
	"instanceid\"\xa2\x01\n" +
	"\x1dCEconItem_ContainerProperties\x12J\n" +
	"\x0fcontained_items\x18\x01 \x03(\v2!.steam.CEconItem_ClassIdentifiersR\x0econtainedItems\x125\n" +
	"\vsearch_tags\x18\x02 \x03(\v2\x14.steam.CEconItem_TagR\n" +
	"searchTags\"\x9a\x01\n" +
	...
	"floatValue\x12!\n" +
	"\fstring_value\x18\x04 \x01(\tR\vstringValue\"\xdf\x02\n" +
	"\x18CEconItem_AssetAccessory\x12\x18\n" +
	"\aclassid\x18\x01 \x01(\x04R\aclassid\x12\x1e\n" +
	"\n" +
	"instanceid\x18\x02 \x01(\x04R\n" +
	"instanceid\x12S\n" +
	"\x15standalone_properties\x18\x03 \x03(\v2\x1e.steam.CEconItem_AssetPropertyR\x14standaloneProperties\x12d\n" +
	"\x1eparent_relationship_properties\x18\x04 \x03(\v2\x1e.steam.CEconItem_AssetPropertyR\x1cparentRelationshipProperties\x12N\n" +
	"\x12nested_accessories\x18\x05 \x03(\v2\x1f.steam.CEconItem_AssetAccessoryR\x11nestedAccessories\"\x82\x02\n" +
	"\x19CEconItem_AssetProperties\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12\x1c\n" +
	"\tcontextid\x18\x02 \x01(\x04R\tcontextid\x12\x18\n" +
	"\aassetid\x18\x03 \x01(\x04R\aassetid\x12I\n" +
	"\x10asset_properties\x18\x04 \x03(\v2\x1e.steam.CEconItem_AssetPropertyR\x0fassetProperties\x12L\n" +
	"\x11asset_accessories\x18\x05 \x03(\v2\x1f.steam.CEconItem_AssetAccessoryR\x10assetAccessories\"\x9e\x03\n" +
	"0CEcon_GetInventoryItemsWithDescriptions_Response\x12*\n" +
	"\x06assets\x18\x01 \x03(\v2\x12.steam.CEcon_AssetR\x06assets\x12@\n" +
	"\fdescriptions\x18\x02 \x03(\v2\x1c.steam.CEconItem_DescriptionR\fdescriptions\x129\n" +
	"\x0emissing_assets\x18\x03 \x03(\v2\x12.steam.CEcon_AssetR\rmissingAssets\x12K\n" +
	"\x10asset_properties\x18\a \x03(\v2 .steam.CEconItem_AssetPropertiesR\x0fassetProperties\x12\x1d\n" +
	"\n" +
	...
	"\aclasses\x18\x03 \x03(\v2!.steam.CEconItem_ClassIdentifiersR\aclasses\x12\x19\n" +
	"\bhigh_pri\x18\x04 \x01(\bR\ahighPri\"d\n" +
	" CEcon_GetAssetClassInfo_Response\x12@\n" +
	"\fdescriptions\x18\x01 \x03(\v2\x1c.steam.CEconItem_DescriptionR\fdescriptions\"X\n" +
	...
	"\x04type\x18\x03 \x01(\x0e2\x19.steam.EAssetPropertyType:\x1ck_EAssetPropertyType_UnknownR\x04type\x12\x1b\n" +
	...
	"\x15hide_from_description\x18\t \x01(\bR\x13hideFromDescription\"x\n" +
	"%CEcon_GetAssetPropertySchema_Response\x12O\n" +
	"\x10property_schemas\x18\x01 \x03(\v2$.steam.CEconItem_AssetPropertySchemaR\x0fpropertySchemas*\xb3\x01\n" +
	...
	"\x18k_EAssetPropertyType_MAX\x10\x042\x84\x05\n" +
	"\x04Econ\x12\x94\x01\n" +
	"!GetInventoryItemsWithDescriptions\x126.steam.CEcon_GetInventoryItemsWithDescriptions_Request\x1a7.steam.CEcon_GetInventoryItemsWithDescriptions_Response\x12y\n" +
	"\x18GetTradeOfferAccessToken\x12-.steam.CEcon_GetTradeOfferAccessToken_Request\x1a..steam.CEcon_GetTradeOfferAccessToken_Response\x12\x8e\x01\n" +
	"\x1fClientGetItemShopOverlayAuthURL\x124.steam.CEcon_ClientGetItemShopOverlayAuthURL_Request\x1a5.steam.CEcon_ClientGetItemShopOverlayAuthURL_Response\x12d\n" +
	"\x11GetAssetClassInfo\x12&.steam.CEcon_GetAssetClassInfo_Request\x1a'.steam.CEcon_GetAssetClassInfo_Response\x12s\n" +
	"\x16GetAssetPropertySchema\x12+.steam.CEcon_GetAssetPropertySchema_Request\x1a,.steam.CEcon_GetAssetPropertySchema_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_econ_steamclient_proto_goTypes = []any{
	(EAssetPropertyType)(0),                                               // 0: steam.EAssetPropertyType
	(*CEcon_GetInventoryItemsWithDescriptions_Request)(nil),               // 1: steam.CEcon_GetInventoryItemsWithDescriptions_Request
	(*CEcon_Asset)(nil),                                                   // 2: steam.CEcon_Asset
	(*CEconItem_DescriptionLine)(nil),                                     // 3: steam.CEconItem_DescriptionLine
	(*CEconItem_Action)(nil),                                              // 4: steam.CEconItem_Action
	(*CEconItem_Description)(nil),                                         // 5: steam.CEconItem_Description
	(*CEconItem_Tag)(nil),                                                 // 6: steam.CEconItem_Tag
	(*CEconItem_ClassIdentifiers)(nil),                                    // 7: steam.CEconItem_ClassIdentifiers
	(*CEconItem_ContainerProperties)(nil),                                 // 8: steam.CEconItem_ContainerProperties
	(*CEconItem_AssetProperty)(nil),                                       // 9: steam.CEconItem_AssetProperty
	(*CEconItem_AssetAccessory)(nil),                                      // 10: steam.CEconItem_AssetAccessory
	(*CEconItem_AssetProperties)(nil),                                     // 11: steam.CEconItem_AssetProperties
	(*CEcon_GetInventoryItemsWithDescriptions_Response)(nil),              // 12: steam.CEcon_GetInventoryItemsWithDescriptions_Response
	(*CEcon_GetTradeOfferAccessToken_Request)(nil),                        // 13: steam.CEcon_GetTradeOfferAccessToken_Request
	(*CEcon_GetTradeOfferAccessToken_Response)(nil),                       // 14: steam.CEcon_GetTradeOfferAccessToken_Response
	(*CEcon_ClientGetItemShopOverlayAuthURL_Request)(nil),                 // 15: steam.CEcon_ClientGetItemShopOverlayAuthURL_Request
	(*CEcon_ClientGetItemShopOverlayAuthURL_Response)(nil),                // 16: steam.CEcon_ClientGetItemShopOverlayAuthURL_Response
	(*CEcon_GetAssetClassInfo_Request)(nil),                               // 17: steam.CEcon_GetAssetClassInfo_Request
	(*CEcon_GetAssetClassInfo_Response)(nil),                              // 18: steam.CEcon_GetAssetClassInfo_Response
	(*CEcon_GetAssetPropertySchema_Request)(nil),                          // 19: steam.CEcon_GetAssetPropertySchema_Request
	(*CEconItem_AssetPropertySchema)(nil),                                 // 20: steam.CEconItem_AssetPropertySchema
	(*CEcon_GetAssetPropertySchema_Response)(nil),                         // 21: steam.CEcon_GetAssetPropertySchema_Response
	(*CEcon_GetInventoryItemsWithDescriptions_Request_FilterOptions)(nil), // 22: steam.CEcon_GetInventoryItemsWithDescriptions_Request.FilterOptions
}
var file_steammessages_econ_steamclient_proto_depIdxs = []int32{
	22, // 0: steam.CEcon_GetInventoryItemsWithDescriptions_Request.filters:type_name -> steam.CEcon_GetInventoryItemsWithDescriptions_Request.FilterOptions
	3,  // 1: steam.CEconItem_Description.descriptions:type_name -> steam.CEconItem_DescriptionLine
	4,  // 2: steam.CEconItem_Description.actions:type_name -> steam.CEconItem_Action
	3,  // 3: steam.CEconItem_Description.owner_descriptions:type_name -> steam.CEconItem_DescriptionLine
	4,  // 4: steam.CEconItem_Description.owner_actions:type_name -> steam.CEconItem_Action
	5,  // 5: steam.CEconItem_Description.contained_item:type_name -> steam.CEconItem_Description
	4,  // 6: steam.CEconItem_Description.market_actions:type_name -> steam.CEconItem_Action
	6,  // 7: steam.CEconItem_Description.tags:type_name -> steam.CEconItem_Tag
	8,  // 8: steam.CEconItem_Description.container_properties:type_name -> steam.CEconItem_ContainerProperties
	7,  // 9: steam.CEconItem_ContainerProperties.contained_items:type_name -> steam.CEconItem_ClassIdentifiers
	6,  // 10: steam.CEconItem_ContainerProperties.search_tags:type_name -> steam.CEconItem_Tag
	9,  // 11: steam.CEconItem_AssetAccessory.standalone_properties:type_name -> steam.CEconItem_AssetProperty
	9,  // 12: steam.CEconItem_AssetAccessory.parent_relationship_properties:type_name -> steam.CEconItem_AssetProperty
	10, // 13: steam.CEconItem_AssetAccessory.nested_accessories:type_name -> steam.CEconItem_AssetAccessory
	9,  // 14: steam.CEconItem_AssetProperties.asset_properties:type_name -> steam.CEconItem_AssetProperty
	10, // 15: steam.CEconItem_AssetProperties.asset_accessories:type_name -> steam.CEconItem_AssetAccessory
	2,  // 16: steam.CEcon_GetInventoryItemsWithDescriptions_Response.assets:type_name -> steam.CEcon_Asset
	5,  // 17: steam.CEcon_GetInventoryItemsWithDescriptions_Response.descriptions:type_name -> steam.CEconItem_Description
	2,  // 18: steam.CEcon_GetInventoryItemsWithDescriptions_Response.missing_assets:type_name -> steam.CEcon_Asset
	11, // 19: steam.CEcon_GetInventoryItemsWithDescriptions_Response.asset_properties:type_name -> steam.CEconItem_AssetProperties
	7,  // 20: steam.CEcon_GetAssetClassInfo_Request.classes:type_name -> steam.CEconItem_ClassIdentifiers
	5,  // 21: steam.CEcon_GetAssetClassInfo_Response.descriptions:type_name -> steam.CEconItem_Description
	0,  // 22: steam.CEconItem_AssetPropertySchema.type:type_name -> steam.EAssetPropertyType
	20, // 23: steam.CEcon_GetAssetPropertySchema_Response.property_schemas:type_name -> steam.CEconItem_AssetPropertySchema
	1,  // 24: steam.Econ.GetInventoryItemsWithDescriptions:input_type -> steam.CEcon_GetInventoryItemsWithDescriptions_Request
	13, // 25: steam.Econ.GetTradeOfferAccessToken:input_type -> steam.CEcon_GetTradeOfferAccessToken_Request
	15, // 26: steam.Econ.ClientGetItemShopOverlayAuthURL:input_type -> steam.CEcon_ClientGetItemShopOverlayAuthURL_Request
	17, // 27: steam.Econ.GetAssetClassInfo:input_type -> steam.CEcon_GetAssetClassInfo_Request
	19, // 28: steam.Econ.GetAssetPropertySchema:input_type -> steam.CEcon_GetAssetPropertySchema_Request
	12, // 29: steam.Econ.GetInventoryItemsWithDescriptions:output_type -> steam.CEcon_GetInventoryItemsWithDescriptions_Response
	14, // 30: steam.Econ.GetTradeOfferAccessToken:output_type -> steam.CEcon_GetTradeOfferAccessToken_Response
	16, // 31: steam.Econ.ClientGetItemShopOverlayAuthURL:output_type -> steam.CEcon_ClientGetItemShopOverlayAuthURL_Response
	18, // 32: steam.Econ.GetAssetClassInfo:output_type -> steam.CEcon_GetAssetClassInfo_Response
	21, // 33: steam.Econ.GetAssetPropertySchema:output_type -> steam.CEcon_GetAssetPropertySchema_Response
