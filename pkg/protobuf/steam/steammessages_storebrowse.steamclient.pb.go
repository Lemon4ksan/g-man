...
type StoreItem struct {
	state                           protoimpl.MessageState         `protogen:"open.v1"`
	ItemType                        *EStoreItemType                `protobuf:"varint,1,opt,name=item_type,json=itemType,enum=steam.EStoreItemType,def=-1" json:"item_type,omitempty"`
	...
	Type                            *EStoreAppType                 `protobuf:"varint,10,opt,name=type,enum=steam.EStoreAppType,def=0" json:"type,omitempty"`
	IncludedTypes                   []EStoreAppType                `protobuf:"varint,11,rep,name=included_types,json=includedTypes,enum=steam.EStoreAppType" json:"included_types,omitempty"`
	...
	ContentDescriptorids            []EContentDescriptorID         `protobuf:"varint,20,rep,name=content_descriptorids,json=contentDescriptorids,enum=steam.EContentDescriptorID" json:"content_descriptorids,omitempty"`
...
type StoreBrowseFilterFailure struct {
	state                        protoimpl.MessageState     `protogen:"open.v1"`
	FilterFailure                *EStoreBrowseFilterFailure `protobuf:"varint,1,opt,name=filter_failure,json=filterFailure,enum=steam.EStoreBrowseFilterFailure,def=0" json:"filter_failure,omitempty"`
	...
	ExcludedContentDescriptorids []EContentDescriptorID     `protobuf:"varint,30,rep,name=excluded_content_descriptorids,json=excludedContentDescriptorids,enum=steam.EContentDescriptorID" json:"excluded_content_descriptorids,omitempty"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
type CStoreBrowse_GetContentHubConfig_Request struct {
	...
	ExcludedContentDescriptorids []EContentDescriptorID `protobuf:"varint,2,rep,name=excluded_content_descriptorids,json=excludedContentDescriptorids,enum=steam.EContentDescriptorID" json:"excluded_content_descriptorids,omitempty"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
type StoreItem_Platforms struct {
	...
	SteamDeckCompatCategory *ESteamDeckCompatibilityCategory `protobuf:"varint,11,opt,name=steam_deck_compat_category,json=steamDeckCompatCategory,enum=steam.ESteamDeckCompatibilityCategory,def=0" json:"steam_deck_compat_category,omitempty"`
	SteamOsCompatCategory   *ESteamOSCompatibilityCategory   `protobuf:"varint,12,opt,name=steam_os_compat_category,json=steamOsCompatCategory,enum=steam.ESteamOSCompatibilityCategory,def=0" json:"steam_os_compat_category,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
type StoreItem_Link struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	LinkType      *EStoreLinkType        `protobuf:"varint,1,opt,name=link_type,json=linkType,enum=steam.EStoreLinkType,def=0" json:"link_type,omitempty"`
...
type StoreItem_Reviews_StoreReviewSummary struct {
	...
	ReviewScore      *EUserReviewScore      `protobuf:"varint,3,opt,name=review_score,json=reviewScore,enum=steam.EUserReviewScore,def=0" json:"review_score,omitempty"`
...
type StoreItem_Trailers_Trailer struct {
	...
	TrailerCategory  *ETrailerCategory                     `protobuf:"varint,13,opt,name=trailer_category,json=trailerCategory,enum=steam.ETrailerCategory,def=0" json:"trailer_category,omitempty"`
...
type CStoreBrowse_GetStoreCategories_Response_Category struct {
	...
	Type          *EStoreCategoryType    `protobuf:"varint,2,opt,name=type,enum=steam.EStoreCategoryType,def=0" json:"type,omitempty"`
...
const file_steammessages_storebrowse_steamclient_proto_rawDesc = "" +
	"\n" +
	"+steammessages_storebrowse.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\x1a\x17enums_productinfo.proto\x1a\venums.proto\x1a\x11contenthubs.proto\"\xb7\x01\n" +
	...
	"\fcountry_code\x18\x03 \x01(\tR\vcountryCode\"\x8e\a\n" +
	...
	"\x16include_included_items\x18\r \x01(\bR\x14includeIncludedItems\x12^\n" +
	"\x1aincluded_item_data_request\x18\x0e \x01(\v2!.steam.StoreBrowseItemDataRequestR\x17includedItemDataRequest\x12G\n" +
	...
	"\rinclude_links\x18\x11 \x01(\bR\fincludeLinks\"\xc0\x01\n" +
	"\x1dCStoreBrowse_GetItems_Request\x12$\n" +
	"\x03ids\x18\x01 \x03(\v2\x12.steam.StoreItemIDR\x03ids\x123\n" +
	"\acontext\x18\x02 \x01(\v2\x19.steam.StoreBrowseContextR\acontext\x12D\n" +
	"\fdata_request\x18\x03 \x01(\v2!.steam.StoreBrowseItemDataRequestR\vdataRequest\"\xffG\n" +
	"\tStoreItem\x12L\n" +
	"\titem_type\x18\x01 \x01(\x0e2\x15.steam.EStoreItemType:\x18k_EStoreItemType_InvalidR\bitemType\x12\x0e\n" +
	...
	"\x05appid\x18\t \x01(\rR\x05appid\x12>\n" +
	"\x04type\x18\n" +
	" \x01(\x0e2\x14.steam.EStoreAppType:\x14k_EStoreAppType_GameR\x04type\x12;\n" +
	"\x0eincluded_types\x18\v \x03(\x0e2\x14.steam.EStoreAppTypeR\rincludedTypes\x12'\n" +
	"\x0fincluded_appids\x18\f \x03(\rR\x0eincludedAppids\x12\x17\n" +
	"\ais_free\x18\r \x01(\bR\x06isFree\x12&\n" +
	"\x0fis_early_access\x18\x0e \x01(\bR\risEarlyAccess\x12B\n" +
	"\rrelated_items\x18\x0f \x01(\v2\x1d.steam.StoreItem.RelatedItemsR\frelatedItems\x12E\n" +
	"\x0eincluded_items\x18\x10 \x01(\v2\x1e.steam.StoreItem.IncludedItemsR\rincludedItems\x12P\n" +
	"\x15content_descriptorids\x18\x14 \x03(\x0e2\x1b.steam.EContentDescriptorIDR\x14contentDescriptorids\x12\x16\n" +
	"\x06tagids\x18\x15 \x03(\rR\x06tagids\x12;\n" +
	"\n" +
	"categories\x18\x16 \x01(\v2\x1b.steam.StoreItem.CategoriesR\n" +
	"categories\x122\n" +
	"\areviews\x18\x17 \x01(\v2\x18.steam.StoreItem.ReviewsR\areviews\x129\n" +
	"\n" +
	"basic_info\x18\x18 \x01(\v2\x1a.steam.StoreItem.BasicInfoR\tbasicInfo\x12(\n" +
	"\x04tags\x18\x19 \x03(\v2\x14.steam.StoreItem.TagR\x04tags\x12/\n" +
	"\x06assets\x18\x1e \x01(\v2\x17.steam.StoreItem.AssetsR\x06assets\x126\n" +
	"\arelease\x18\x1f \x01(\v2\x1c.steam.StoreItem.ReleaseInfoR\arelease\x128\n" +
	"\tplatforms\x18  \x01(\v2\x1a.steam.StoreItem.PlatformsR\tplatforms\x127\n" +
	"\vgame_rating\x18! \x01(\v2\x16.steam.StoreGameRatingR\n" +
	"gameRating\x12$\n" +
	"\x0eis_coming_soon\x18\" \x01(\bR\fisComingSoon\x12Q\n" +
	"\x14best_purchase_option\x18( \x01(\v2\x1f.steam.StoreItem.PurchaseOptionR\x12bestPurchaseOption\x12J\n" +
	"\x10purchase_options\x18) \x03(\v2\x1f.steam.StoreItem.PurchaseOptionR\x0fpurchaseOptions\x12A\n" +
	"\vaccessories\x18* \x03(\v2\x1f.steam.StoreItem.PurchaseOptionR\vaccessories\x12Q\n" +
	"\x14self_purchase_option\x18+ \x01(\v2\x1f.steam.StoreItem.PurchaseOptionR\x12selfPurchaseOption\x12Y\n" +
	"\x18invalid_purchase_options\x18, \x03(\v2\x1f.steam.StoreItem.PurchaseOptionR\x16invalidPurchaseOptions\x12>\n" +
	"\vscreenshots\x182 \x01(\v2\x1c.steam.StoreItem.ScreenshotsR\vscreenshots\x125\n" +
	"\btrailers\x183 \x01(\v2\x19.steam.StoreItem.TrailersR\btrailers\x12S\n" +
	"\x13supported_languages\x184 \x03(\v2\".steam.StoreItem.SupportedLanguageR\x12supportedLanguages\x125\n" +
	"\x17store_url_path_override\x185 \x01(\tR\x14storeUrlPathOverride\x12?\n" +
	"\ffree_weekend\x186 \x01(\v2\x1c.steam.StoreItem.FreeWeekendR\vfreeWeekend\x12\x1a\n" +
	...
	"\x13is_free_temporarily\x18; \x01(\bR\x11isFreeTemporarily\x12Q\n" +
	"\x18assets_without_overrides\x18< \x01(\v2\x17.steam.StoreItem.AssetsR\x16assetsWithoutOverrides\x12O\n" +
	"\x13user_filter_failure\x18F \x01(\v2\x1f.steam.StoreBrowseFilterFailureR\x11userFilterFailure\x12+\n" +
	"\x05links\x18G \x03(\v2\x15.steam.StoreItem.LinkR\x05links\x12>\n" +
	"\x1bpurchase_description_bbcode\x18H \x01(\tR\x19purchaseDescriptionBbcode\x1a\x84\x01\n" +
	"\fRelatedItems\x12!\n" +
	"\fparent_appid\x18\x01 \x01(\rR\vparentAppid\x12\x1d\n" +
	"\n" +
	"demo_appid\x18\x02 \x03(\rR\tdemoAppid\x122\n" +
	"\x15standalone_demo_appid\x18\x03 \x03(\rR\x13standaloneDemoAppid\x1a\xc2\x01\n" +
	"\rIncludedItems\x125\n" +
	"\rincluded_apps\x18\x01 \x03(\v2\x10.steam.StoreItemR\fincludedApps\x12=\n" +
	"\x11included_packages\x18\x02 \x03(\v2\x10.steam.StoreItemR\x10includedPackages\x12;\n" +
	"\x10included_bundles\x18\x03 \x03(\v2\x10.steam.StoreItemR\x0fincludedBundles\x1a\xb6\x01\n" +
	"\n" +
	"Categories\x12@\n" +
	...
	"\x16controller_categoryids\x18\x04 \x03(\rR\x15controllerCategoryids\x1a\x8e\x04\n" +
	"\aReviews\x12V\n" +
	"\x10summary_filtered\x18\x01 \x01(\v2+.steam.StoreItem.Reviews.StoreReviewSummaryR\x0fsummaryFiltered\x12Z\n" +
	"\x12summary_unfiltered\x18\x02 \x01(\v2+.steam.StoreItem.Reviews.StoreReviewSummaryR\x11summaryUnfiltered\x12g\n" +
	"\x19summary_language_specific\x18\x03 \x01(\v2+.steam.StoreItem.Reviews.StoreReviewSummaryR\x17summaryLanguageSpecific\x1a\xe5\x01\n" +
	"\x12StoreReviewSummary\x12!\n" +
	"\freview_count\x18\x01 \x01(\rR\vreviewCount\x12)\n" +
	"\x10percent_positive\x18\x02 \x01(\x05R\x0fpercentPositive\x12S\n" +
	"\freview_score\x18\x03 \x01(\x0e2\x17.steam.EUserReviewScore:\x17k_EUserReviewScore_NoneR\vreviewScore\x12,\n" +
	"\x12review_score_label\x18\x04 \x01(\tR\x10reviewScoreLabel\x1a\xa5\x03\n" +
	"\tBasicInfo\x12+\n" +
	"\x11short_description\x18\x01 \x01(\tR\x10shortDescription\x12J\n" +
	"\n" +
	"publishers\x18\x02 \x03(\v2*.steam.StoreItem.BasicInfo.CreatorHomeLinkR\n" +
	"publishers\x12J\n" +
	"\n" +
	"developers\x18\x03 \x03(\v2*.steam.StoreItem.BasicInfo.CreatorHomeLinkR\n" +
	"developers\x12J\n" +
	"\n" +
	"franchises\x18\x04 \x03(\v2*.steam.StoreItem.BasicInfo.CreatorHomeLinkR\n" +
	"franchises\x12)\n" +
	...
	"\x15limited_launch_active\x18\x16 \x01(\bR\x13limitedLaunchActive\x1a\xfa\x04\n" +
	"\tPlatforms\x12\x18\n" +
	"\awindows\x18\x01 \x01(\bR\awindows\x12\x10\n" +
	"\x03mac\x18\x02 \x01(\bR\x03mac\x12#\n" +
	"\rsteamos_linux\x18\x03 \x01(\bR\fsteamosLinux\x12C\n" +
	"\n" +
	"vr_support\x18\n" +
	" \x01(\v2$.steam.StoreItem.Platforms.VRSupportR\tvrSupport\x12\x8e\x01\n" +
	"\x1asteam_deck_compat_category\x18\v \x01(\x0e2&.steam.ESteamDeckCompatibilityCategory:)k_ESteamDeckCompatibilityCategory_UnknownR\x17steamDeckCompatCategory\x12\x86\x01\n" +
	"\x18steam_os_compat_category\x18\f \x01(\x0e2$.steam.ESteamOSCompatibilityCategory:'k_ESteamOSCompatibilityCategory_UnknownR\x15steamOsCompatCategory\x1a\xbc\x01\n" +
	"\tVRSupport\x12\x14\n" +
	...
	"&formatted_price_before_bundle_discount\x18\x0f \x01(\tR\"formattedPriceBeforeBundleDiscount\x12S\n" +
	"\x10active_discounts\x18\x14 \x03(\v2(.steam.StoreItem.PurchaseOption.DiscountR\x0factiveDiscounts\x128\n" +
	...
	"\x11requires_shipping\x18- \x01(\bR\x10requiresShipping\x12W\n" +
	"\x0frecurrence_info\x18. \x01(\v2..steam.StoreItem.PurchaseOption.RecurrenceInfoR\x0erecurrenceInfo\x12)\n" +
	...
	"\x17formatted_renewal_price\x18\x06 \x01(\tR\x15formattedRenewalPrice\x1a\x93\x02\n" +
	"\vScreenshots\x12Y\n" +
	"\x14all_ages_screenshots\x18\x02 \x03(\v2'.steam.StoreItem.Screenshots.ScreenshotR\x12allAgesScreenshots\x12e\n" +
	"\x1amature_content_screenshots\x18\x03 \x03(\v2'.steam.StoreItem.Screenshots.ScreenshotR\x18matureContentScreenshots\x1aB\n" +
	"\n" +
	"Screenshot\x12\x1a\n" +
	"\bfilename\x18\x01 \x01(\tR\bfilename\x12\x18\n" +
	"\aordinal\x18\x02 \x01(\x05R\aordinal\x1a\x99\x06\n" +
	"\bTrailers\x12A\n" +
	"\n" +
	"highlights\x18\x01 \x03(\v2!.steam.StoreItem.Trailers.TrailerR\n" +
	"highlights\x12H\n" +
	"\x0eother_trailers\x18\x02 \x03(\v2!.steam.StoreItem.Trailers.TrailerR\rotherTrailers\x1a=\n" +
	...
	"\bencoding\x18\x02 \x01(\tR\bencoding\x1a\xf6\x03\n" +
	"\aTrailer\x12!\n" +
	"\ftrailer_name\x18\x01 \x01(\tR\vtrailerName\x12,\n" +
	"\x12trailer_url_format\x18\x02 \x01(\tR\x10trailerUrlFormat\x12^\n" +
	"\x10trailer_category\x18\r \x01(\x0e2\x17.steam.ETrailerCategory:\x1ak_ETrailerCategory_InvalidR\x0ftrailerCategory\x12I\n" +
	"\fmicrotrailer\x18\x05 \x03(\v2%.steam.StoreItem.Trailers.VideoSourceR\fmicrotrailer\x12V\n" +
	"\x11adaptive_trailers\x18\x06 \x03(\v2).steam.StoreItem.Trailers.AdaptiveTrailerR\x10adaptiveTrailers\x12+\n" +
	...
	"\x04text\x18\x03 \x01(\tR\x04text\x1aw\n" +
	"\x04Link\x12I\n" +
	"\tlink_type\x18\x01 \x01(\x0e2\x15.steam.EStoreLinkType:\x15k_EStoreLinkType_NoneR\blinkType\x12\x10\n" +
	...
	"\fimage_target\x18\x15 \x01(\tR\vimageTarget\"\xf3\x04\n" +
	"\x18StoreBrowseFilterFailure\x12i\n" +
	"\x0efilter_failure\x18\x01 \x01(\x0e2 .steam.EStoreBrowseFilterFailure: k_EStoreBrowseFilterFailure_NoneR\rfilterFailure\x12#\n" +
	...
	"\x0fexcluded_tagids\x18\x15 \x03(\rR\x0eexcludedTagids\x12a\n" +
	"\x1eexcluded_content_descriptorids\x18\x1e \x03(\x0e2\x1b.steam.EContentDescriptorIDR\x1cexcludedContentDescriptorids\"S\n" +
	"\x1eCStoreBrowse_GetItems_Response\x121\n" +
	...
	"\telanguage\x18\x02 \x01(\x05:\x02-1R\telanguage\"\xe9\x03\n" +
	"(CStoreBrowse_GetStoreCategories_Response\x12X\n" +
	"\n" +
	"categories\x18\x01 \x03(\v28.steam.CStoreBrowse_GetStoreCategories_Response.CategoryR\n" +
	"categories\x1a\xe2\x02\n" +
	"\bCategory\x12\x1e\n" +
	"\n" +
	"categoryid\x18\x01 \x01(\rR\n" +
	"categoryid\x12L\n" +
	"\x04type\x18\x02 \x01(\x0e2\x19.steam.EStoreCategoryType:\x1dk_EStoreCategoryType_CategoryR\x04type\x12#\n" +
	...
	"\x0fedit_sort_order\x18\t \x01(\rR\reditSortOrder\"\xc2\x01\n" +
	"(CStoreBrowse_GetContentHubConfig_Request\x123\n" +
	"\acontext\x18\x01 \x01(\v2\x19.steam.StoreBrowseContextR\acontext\x12a\n" +
	"\x1eexcluded_content_descriptorids\x18\x02 \x03(\x0e2\x1b.steam.EContentDescriptorIDR\x1cexcludedContentDescriptorids\"\xfb\x03\n" +
	")CStoreBrowse_GetContentHubConfig_Response\x12a\n" +
	"\n" +
	"hubconfigs\x18\x01 \x03(\v2A.steam.CStoreBrowse_GetContentHubConfig_Response.ContentHubConfigR\n" +
	...
	"\rcurrency_code\x18\x02 \x01(\tR\fcurrencyCode\"\x81\x02\n" +
	"#CStoreBrowse_GetPriceStops_Response\x12U\n" +
	"\vprice_stops\x18\x01 \x03(\v24.steam.CStoreBrowse_GetPriceStops_Response.PriceStopR\n" +
	"priceStops\x12#\n" +
	"\rcurrency_code\x18\x02 \x01(\tR\fcurrencyCode\x1a^\n" +
	"\tPriceStop\x12)\n" +
	"\x10formatted_amount\x18\x01 \x01(\tR\x0fformattedAmount\x12&\n" +
	"\x0famount_in_cents\x18\x02 \x01(\x03R\ramountInCents\"\xe4\x01\n" +
	"\"CStoreBrowse_GetDLCForApps_Request\x123\n" +
	"\acontext\x18\x01 \x01(\v2\x19.steam.StoreBrowseContextR\acontext\x12C\n" +
	"\x11store_page_filter\x18\x02 \x01(\v2\x17.steam.CStorePageFilterR\x0fstorePageFilter\x12*\n" +
	"\x06appids\x18\x03 \x03(\v2\x12.steam.StoreItemIDR\x06appids\x12\x18\n" +
	"\asteamid\x18\x04 \x01(\x04R\asteamid\"\xfe\x03\n" +
	"#CStoreBrowse_GetDLCForApps_Response\x12M\n" +
	"\bdlc_data\x18\x01 \x03(\v22.steam.CStoreBrowse_GetDLCForApps_Response.DLCDataR\adlcData\x12U\n" +
	"\bplaytime\x18\x02 \x03(\v29.steam.CStoreBrowse_GetDLCForApps_Response.PlaytimeForAppR\bplaytime\x1a\xcb\x01\n" +
	"\aDLCData\x12\x14\n" +
	...
	"lastPlayed\"\xe8\x01\n" +
	"&CStoreBrowse_GetDLCForAppsSolr_Request\x123\n" +
	"\acontext\x18\x01 \x01(\v2\x19.steam.StoreBrowseContextR\acontext\x12\x16\n" +
	"\x06appids\x18\x02 \x03(\rR\x06appids\x12\x16\n" +
	"\x06flavor\x18\x03 \x01(\tR\x06flavor\x12\x14\n" +
	"\x05count\x18\x04 \x01(\rR\x05count\x12C\n" +
	"\x11store_page_filter\x18\x05 \x01(\v2\x17.steam.CStorePageFilterR\x0fstorePageFilter\"\xcb\x01\n" +
	"'CStoreBrowse_GetDLCForAppsSolr_Response\x12S\n" +
	"\tdlc_lists\x18\x01 \x03(\v26.steam.CStoreBrowse_GetDLCForAppsSolr_Response.DLCListR\bdlcLists\x1aK\n" +
	"\aDLCList\x12!\n" +
	"\fparent_appid\x18\x01 \x01(\rR\vparentAppid\x12\x1d\n" +
	"\n" +
	"dlc_appids\x18\x02 \x03(\rR\tdlcAppids\"z\n" +
	"%CStoreBrowse_GetHardwareItems_Request\x12\x1c\n" +
	"\tpackageid\x18\x01 \x03(\rR\tpackageid\x123\n" +
	"\acontext\x18\x02 \x01(\v2\x19.steam.StoreBrowseContextR\acontext\"\xf2\x06\n" +
	...
	"'estimated_delivery_latest_business_days\x18\x12 \x01(\rR#estimatedDeliveryLatestBusinessDays\"b\n" +
	"&CStoreBrowse_GetHardwareItems_Response\x128\n" +
	"\adetails\x18\x01 \x03(\v2\x1e.steam.CHardwarePackageDetailsR\adetails*\x80\x02\n" +
	...
	"\x18k_EStoreCategoryType_MAX\x10\x052\x8c\x06\n" +
	"\vStoreBrowse\x12W\n" +
	"\bGetItems\x12$.steam.CStoreBrowse_GetItems_Request\x1a%.steam.CStoreBrowse_GetItems_Response\x12u\n" +
	"\x12GetStoreCategories\x12..steam.CStoreBrowse_GetStoreCategories_Request\x1a/.steam.CStoreBrowse_GetStoreCategories_Response\x12x\n" +
	"\x13GetContentHubConfig\x12/.steam.CStoreBrowse_GetContentHubConfig_Request\x1a0.steam.CStoreBrowse_GetContentHubConfig_Response\x12f\n" +
	"\rGetPriceStops\x12).steam.CStoreBrowse_GetPriceStops_Request\x1a*.steam.CStoreBrowse_GetPriceStops_Response\x12f\n" +
	"\rGetDLCForApps\x12).steam.CStoreBrowse_GetDLCForApps_Request\x1a*.steam.CStoreBrowse_GetDLCForApps_Response\x12r\n" +
	"\x11GetDLCForAppsSolr\x12-.steam.CStoreBrowse_GetDLCForAppsSolr_Request\x1a..steam.CStoreBrowse_GetDLCForAppsSolr_Response\x12o\n" +
	"\x10GetHardwareItems\x12,.steam.CStoreBrowse_GetHardwareItems_Request\x1a-.steam.CStoreBrowse_GetHardwareItems_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_storebrowse_steamclient_proto_goTypes = []any{
	(EStoreItemType)(0),                                                // 0: steam.EStoreItemType
	(EStoreAppType)(0),                                                 // 1: steam.EStoreAppType
	(EUserReviewScore)(0),                                              // 2: steam.EUserReviewScore
	(ETrailerCategory)(0),                                              // 3: steam.ETrailerCategory
	(EStoreBrowseFilterFailure)(0),                                     // 4: steam.EStoreBrowseFilterFailure
	(EStoreLinkType)(0),                                                // 5: steam.EStoreLinkType
	(EStoreCategoryType)(0),                                            // 6: steam.EStoreCategoryType
	(*StoreItemID)(nil),                                                // 7: steam.StoreItemID
	(*StoreBrowseContext)(nil),                                         // 8: steam.StoreBrowseContext
	(*StoreBrowseItemDataRequest)(nil),                                 // 9: steam.StoreBrowseItemDataRequest
	(*CStoreBrowse_GetItems_Request)(nil),                              // 10: steam.CStoreBrowse_GetItems_Request
	(*StoreItem)(nil),                                                  // 11: steam.StoreItem
	(*StoreGameRating)(nil),                                            // 12: steam.StoreGameRating
	(*StoreBrowseFilterFailure)(nil),                                   // 13: steam.StoreBrowseFilterFailure
	(*CStoreBrowse_GetItems_Response)(nil),                             // 14: steam.CStoreBrowse_GetItems_Response
	(*CStoreBrowse_GetStoreCategories_Request)(nil),                    // 15: steam.CStoreBrowse_GetStoreCategories_Request
	(*CStoreBrowse_GetStoreCategories_Response)(nil),                   // 16: steam.CStoreBrowse_GetStoreCategories_Response
	(*CStoreBrowse_GetContentHubConfig_Request)(nil),                   // 17: steam.CStoreBrowse_GetContentHubConfig_Request
	(*CStoreBrowse_GetContentHubConfig_Response)(nil),                  // 18: steam.CStoreBrowse_GetContentHubConfig_Response
	(*CStoreBrowse_GetPriceStops_Request)(nil),                         // 19: steam.CStoreBrowse_GetPriceStops_Request
	(*CStoreBrowse_GetPriceStops_Response)(nil),                        // 20: steam.CStoreBrowse_GetPriceStops_Response
	(*CStoreBrowse_GetDLCForApps_Request)(nil),                         // 21: steam.CStoreBrowse_GetDLCForApps_Request
	(*CStoreBrowse_GetDLCForApps_Response)(nil),                        // 22: steam.CStoreBrowse_GetDLCForApps_Response
	(*CStoreBrowse_GetDLCForAppsSolr_Request)(nil),                     // 23: steam.CStoreBrowse_GetDLCForAppsSolr_Request
	(*CStoreBrowse_GetDLCForAppsSolr_Response)(nil),                    // 24: steam.CStoreBrowse_GetDLCForAppsSolr_Response
	(*CStoreBrowse_GetHardwareItems_Request)(nil),                      // 25: steam.CStoreBrowse_GetHardwareItems_Request
	(*CHardwarePackageDetails)(nil),                                    // 26: steam.CHardwarePackageDetails
	(*CStoreBrowse_GetHardwareItems_Response)(nil),                     // 27: steam.CStoreBrowse_GetHardwareItems_Response
	(*StoreItem_RelatedItems)(nil),                                     // 28: steam.StoreItem.RelatedItems
	(*StoreItem_IncludedItems)(nil),                                    // 29: steam.StoreItem.IncludedItems
	(*StoreItem_Categories)(nil),                                       // 30: steam.StoreItem.Categories
	(*StoreItem_Reviews)(nil),                                          // 31: steam.StoreItem.Reviews
	(*StoreItem_BasicInfo)(nil),                                        // 32: steam.StoreItem.BasicInfo
	(*StoreItem_Tag)(nil),                                              // 33: steam.StoreItem.Tag
	(*StoreItem_Assets)(nil),                                           // 34: steam.StoreItem.Assets
	(*StoreItem_ReleaseInfo)(nil),                                      // 35: steam.StoreItem.ReleaseInfo
	(*StoreItem_Platforms)(nil),                                        // 36: steam.StoreItem.Platforms
	(*StoreItem_PurchaseOption)(nil),                                   // 37: steam.StoreItem.PurchaseOption
	(*StoreItem_Screenshots)(nil),                                      // 38: steam.StoreItem.Screenshots
	(*StoreItem_Trailers)(nil),                                         // 39: steam.StoreItem.Trailers
	(*StoreItem_SupportedLanguage)(nil),                                // 40: steam.StoreItem.SupportedLanguage
	(*StoreItem_FreeWeekend)(nil),                                      // 41: steam.StoreItem.FreeWeekend
	(*StoreItem_Link)(nil),                                             // 42: steam.StoreItem.Link
	(*StoreItem_Reviews_StoreReviewSummary)(nil),                       // 43: steam.StoreItem.Reviews.StoreReviewSummary
	(*StoreItem_BasicInfo_CreatorHomeLink)(nil),                        // 44: steam.StoreItem.BasicInfo.CreatorHomeLink
	(*StoreItem_Platforms_VRSupport)(nil),                              // 45: steam.StoreItem.Platforms.VRSupport
	(*StoreItem_PurchaseOption_Discount)(nil),                          // 46: steam.StoreItem.PurchaseOption.Discount
	(*StoreItem_PurchaseOption_RecurrenceInfo)(nil),                    // 47: steam.StoreItem.PurchaseOption.RecurrenceInfo
	(*StoreItem_Screenshots_Screenshot)(nil),                           // 48: steam.StoreItem.Screenshots.Screenshot
	(*StoreItem_Trailers_VideoSource)(nil),                             // 49: steam.StoreItem.Trailers.VideoSource
	(*StoreItem_Trailers_AdaptiveTrailer)(nil),                         // 50: steam.StoreItem.Trailers.AdaptiveTrailer
	(*StoreItem_Trailers_Trailer)(nil),                                 // 51: steam.StoreItem.Trailers.Trailer
	(*CStoreBrowse_GetStoreCategories_Response_Category)(nil),          // 52: steam.CStoreBrowse_GetStoreCategories_Response.Category
	(*CStoreBrowse_GetContentHubConfig_Response_ContentHubConfig)(nil), // 53: steam.CStoreBrowse_GetContentHubConfig_Response.ContentHubConfig
	(*CStoreBrowse_GetPriceStops_Response_PriceStop)(nil),              // 54: steam.CStoreBrowse_GetPriceStops_Response.PriceStop
	(*CStoreBrowse_GetDLCForApps_Response_DLCData)(nil),                // 55: steam.CStoreBrowse_GetDLCForApps_Response.DLCData
	(*CStoreBrowse_GetDLCForApps_Response_PlaytimeForApp)(nil),         // 56: steam.CStoreBrowse_GetDLCForApps_Response.PlaytimeForApp
	(*CStoreBrowse_GetDLCForAppsSolr_Response_DLCList)(nil),            // 57: steam.CStoreBrowse_GetDLCForAppsSolr_Response.DLCList
	(EContentDescriptorID)(0),                                          // 58: steam.EContentDescriptorID
	(*CStorePageFilter)(nil),                                           // 59: steam.CStorePageFilter
	(ESteamDeckCompatibilityCategory)(0),                               // 60: steam.ESteamDeckCompatibilityCategory
	(ESteamOSCompatibilityCategory)(0),                                 // 61: steam.ESteamOSCompatibilityCategory
}
var file_steammessages_storebrowse_steamclient_proto_depIdxs = []int32{
	9,  // 0: steam.StoreBrowseItemDataRequest.included_item_data_request:type_name -> steam.StoreBrowseItemDataRequest
	7,  // 1: steam.CStoreBrowse_GetItems_Request.ids:type_name -> steam.StoreItemID
	8,  // 2: steam.CStoreBrowse_GetItems_Request.context:type_name -> steam.StoreBrowseContext
	9,  // 3: steam.CStoreBrowse_GetItems_Request.data_request:type_name -> steam.StoreBrowseItemDataRequest
	0,  // 4: steam.StoreItem.item_type:type_name -> steam.EStoreItemType
	1,  // 5: steam.StoreItem.type:type_name -> steam.EStoreAppType
	1,  // 6: steam.StoreItem.included_types:type_name -> steam.EStoreAppType
	28, // 7: steam.StoreItem.related_items:type_name -> steam.StoreItem.RelatedItems
	29, // 8: steam.StoreItem.included_items:type_name -> steam.StoreItem.IncludedItems
	58, // 9: steam.StoreItem.content_descriptorids:type_name -> steam.EContentDescriptorID
	30, // 10: steam.StoreItem.categories:type_name -> steam.StoreItem.Categories
	31, // 11: steam.StoreItem.reviews:type_name -> steam.StoreItem.Reviews
	32, // 12: steam.StoreItem.basic_info:type_name -> steam.StoreItem.BasicInfo
	33, // 13: steam.StoreItem.tags:type_name -> steam.StoreItem.Tag
	34, // 14: steam.StoreItem.assets:type_name -> steam.StoreItem.Assets
	35, // 15: steam.StoreItem.release:type_name -> steam.StoreItem.ReleaseInfo
	36, // 16: steam.StoreItem.platforms:type_name -> steam.StoreItem.Platforms
	12, // 17: steam.StoreItem.game_rating:type_name -> steam.StoreGameRating
	37, // 18: steam.StoreItem.best_purchase_option:type_name -> steam.StoreItem.PurchaseOption
	37, // 19: steam.StoreItem.purchase_options:type_name -> steam.StoreItem.PurchaseOption
	37, // 20: steam.StoreItem.accessories:type_name -> steam.StoreItem.PurchaseOption
	37, // 21: steam.StoreItem.self_purchase_option:type_name -> steam.StoreItem.PurchaseOption
	37, // 22: steam.StoreItem.invalid_purchase_options:type_name -> steam.StoreItem.PurchaseOption
	38, // 23: steam.StoreItem.screenshots:type_name -> steam.StoreItem.Screenshots
	39, // 24: steam.StoreItem.trailers:type_name -> steam.StoreItem.Trailers
	40, // 25: steam.StoreItem.supported_languages:type_name -> steam.StoreItem.SupportedLanguage
	41, // 26: steam.StoreItem.free_weekend:type_name -> steam.StoreItem.FreeWeekend
	34, // 27: steam.StoreItem.assets_without_overrides:type_name -> steam.StoreItem.Assets
	13, // 28: steam.StoreItem.user_filter_failure:type_name -> steam.StoreBrowseFilterFailure
	42, // 29: steam.StoreItem.links:type_name -> steam.StoreItem.Link
	4,  // 30: steam.StoreBrowseFilterFailure.filter_failure:type_name -> steam.EStoreBrowseFilterFailure
	58, // 31: steam.StoreBrowseFilterFailure.excluded_content_descriptorids:type_name -> steam.EContentDescriptorID
	11, // 32: steam.CStoreBrowse_GetItems_Response.store_items:type_name -> steam.StoreItem
	52, // 33: steam.CStoreBrowse_GetStoreCategories_Response.categories:type_name -> steam.CStoreBrowse_GetStoreCategories_Response.Category
	8,  // 34: steam.CStoreBrowse_GetContentHubConfig_Request.context:type_name -> steam.StoreBrowseContext
	58, // 35: steam.CStoreBrowse_GetContentHubConfig_Request.excluded_content_descriptorids:type_name -> steam.EContentDescriptorID
	53, // 36: steam.CStoreBrowse_GetContentHubConfig_Response.hubconfigs:type_name -> steam.CStoreBrowse_GetContentHubConfig_Response.ContentHubConfig
	54, // 37: steam.CStoreBrowse_GetPriceStops_Response.price_stops:type_name -> steam.CStoreBrowse_GetPriceStops_Response.PriceStop
	8,  // 38: steam.CStoreBrowse_GetDLCForApps_Request.context:type_name -> steam.StoreBrowseContext
	59, // 39: steam.CStoreBrowse_GetDLCForApps_Request.store_page_filter:type_name -> steam.CStorePageFilter
	7,  // 40: steam.CStoreBrowse_GetDLCForApps_Request.appids:type_name -> steam.StoreItemID
	55, // 41: steam.CStoreBrowse_GetDLCForApps_Response.dlc_data:type_name -> steam.CStoreBrowse_GetDLCForApps_Response.DLCData
	56, // 42: steam.CStoreBrowse_GetDLCForApps_Response.playtime:type_name -> steam.CStoreBrowse_GetDLCForApps_Response.PlaytimeForApp
	8,  // 43: steam.CStoreBrowse_GetDLCForAppsSolr_Request.context:type_name -> steam.StoreBrowseContext
	59, // 44: steam.CStoreBrowse_GetDLCForAppsSolr_Request.store_page_filter:type_name -> steam.CStorePageFilter
	57, // 45: steam.CStoreBrowse_GetDLCForAppsSolr_Response.dlc_lists:type_name -> steam.CStoreBrowse_GetDLCForAppsSolr_Response.DLCList
	8,  // 46: steam.CStoreBrowse_GetHardwareItems_Request.context:type_name -> steam.StoreBrowseContext
	26, // 47: steam.CStoreBrowse_GetHardwareItems_Response.details:type_name -> steam.CHardwarePackageDetails
	11, // 48: steam.StoreItem.IncludedItems.included_apps:type_name -> steam.StoreItem
	11, // 49: steam.StoreItem.IncludedItems.included_packages:type_name -> steam.StoreItem
	11, // 50: steam.StoreItem.IncludedItems.included_bundles:type_name -> steam.StoreItem
	43, // 51: steam.StoreItem.Reviews.summary_filtered:type_name -> steam.StoreItem.Reviews.StoreReviewSummary
	43, // 52: steam.StoreItem.Reviews.summary_unfiltered:type_name -> steam.StoreItem.Reviews.StoreReviewSummary
	43, // 53: steam.StoreItem.Reviews.summary_language_specific:type_name -> steam.StoreItem.Reviews.StoreReviewSummary
	44, // 54: steam.StoreItem.BasicInfo.publishers:type_name -> steam.StoreItem.BasicInfo.CreatorHomeLink
	44, // 55: steam.StoreItem.BasicInfo.developers:type_name -> steam.StoreItem.BasicInfo.CreatorHomeLink
	44, // 56: steam.StoreItem.BasicInfo.franchises:type_name -> steam.StoreItem.BasicInfo.CreatorHomeLink
	45, // 57: steam.StoreItem.Platforms.vr_support:type_name -> steam.StoreItem.Platforms.VRSupport
	60, // 58: steam.StoreItem.Platforms.steam_deck_compat_category:type_name -> steam.ESteamDeckCompatibilityCategory
	61, // 59: steam.StoreItem.Platforms.steam_os_compat_category:type_name -> steam.ESteamOSCompatibilityCategory
	46, // 60: steam.StoreItem.PurchaseOption.active_discounts:type_name -> steam.StoreItem.PurchaseOption.Discount
	47, // 61: steam.StoreItem.PurchaseOption.recurrence_info:type_name -> steam.StoreItem.PurchaseOption.RecurrenceInfo
	48, // 62: steam.StoreItem.Screenshots.all_ages_screenshots:type_name -> steam.StoreItem.Screenshots.Screenshot
	48, // 63: steam.StoreItem.Screenshots.mature_content_screenshots:type_name -> steam.StoreItem.Screenshots.Screenshot
	51, // 64: steam.StoreItem.Trailers.highlights:type_name -> steam.StoreItem.Trailers.Trailer
	51, // 65: steam.StoreItem.Trailers.other_trailers:type_name -> steam.StoreItem.Trailers.Trailer
	5,  // 66: steam.StoreItem.Link.link_type:type_name -> steam.EStoreLinkType
	2,  // 67: steam.StoreItem.Reviews.StoreReviewSummary.review_score:type_name -> steam.EUserReviewScore
	3,  // 68: steam.StoreItem.Trailers.Trailer.trailer_category:type_name -> steam.ETrailerCategory
	49, // 69: steam.StoreItem.Trailers.Trailer.microtrailer:type_name -> steam.StoreItem.Trailers.VideoSource
	50, // 70: steam.StoreItem.Trailers.Trailer.adaptive_trailers:type_name -> steam.StoreItem.Trailers.AdaptiveTrailer
	6,  // 71: steam.CStoreBrowse_GetStoreCategories_Response.Category.type:type_name -> steam.EStoreCategoryType
	10, // 72: steam.StoreBrowse.GetItems:input_type -> steam.CStoreBrowse_GetItems_Request
	15, // 73: steam.StoreBrowse.GetStoreCategories:input_type -> steam.CStoreBrowse_GetStoreCategories_Request
	17, // 74: steam.StoreBrowse.GetContentHubConfig:input_type -> steam.CStoreBrowse_GetContentHubConfig_Request
	19, // 75: steam.StoreBrowse.GetPriceStops:input_type -> steam.CStoreBrowse_GetPriceStops_Request
	21, // 76: steam.StoreBrowse.GetDLCForApps:input_type -> steam.CStoreBrowse_GetDLCForApps_Request
	23, // 77: steam.StoreBrowse.GetDLCForAppsSolr:input_type -> steam.CStoreBrowse_GetDLCForAppsSolr_Request
	25, // 78: steam.StoreBrowse.GetHardwareItems:input_type -> steam.CStoreBrowse_GetHardwareItems_Request
	14, // 79: steam.StoreBrowse.GetItems:output_type -> steam.CStoreBrowse_GetItems_Response
	16, // 80: steam.StoreBrowse.GetStoreCategories:output_type -> steam.CStoreBrowse_GetStoreCategories_Response
	18, // 81: steam.StoreBrowse.GetContentHubConfig:output_type -> steam.CStoreBrowse_GetContentHubConfig_Response
	20, // 82: steam.StoreBrowse.GetPriceStops:output_type -> steam.CStoreBrowse_GetPriceStops_Response
	22, // 83: steam.StoreBrowse.GetDLCForApps:output_type -> steam.CStoreBrowse_GetDLCForApps_Response
	24, // 84: steam.StoreBrowse.GetDLCForAppsSolr:output_type -> steam.CStoreBrowse_GetDLCForAppsSolr_Response
	27, // 85: steam.StoreBrowse.GetHardwareItems:output_type -> steam.CStoreBrowse_GetHardwareItems_Response
