...
type CMsgRemoteClientBroadcastStatus struct {
	...
	VrLinkCaps                 *EVRLinkCaps                            `protobuf:"varint,26,opt,name=vr_link_caps,json=vrLinkCaps,enum=steam.EVRLinkCaps,def=0" json:"vr_link_caps,omitempty"`
...
const file_steammessages_remoteclient_discovery_proto_rawDesc = "" +
	"\n" +
	"*steammessages_remoteclient_discovery.proto\x12\x05steam\"\x93\x02\n" +
	"\x1fCMsgRemoteClientBroadcastHeader\x12\x1b\n" +
	"\tclient_id\x18\x01 \x01(\x04R\bclientId\x12a\n" +
	"\bmsg_type\x18\x02 \x01(\x0e2 .steam.ERemoteClientBroadcastMsg:$k_ERemoteClientBroadcastMsgDiscoveryR\amsgType\x12\x1f\n" +
	"\vinstance_id\x18\x03 \x01(\x04R\n" +
	"instanceId\x12,\n" +
	"\x12device_id_OBSOLETE\x18\x04 \x01(\x04R\x10deviceIdOBSOLETE\x12!\n" +
	"\fdevice_token\x18\x05 \x01(\fR\vdeviceToken\"\xc4\t\n" +
	...
	"\ais64bit\x18\b \x01(\bR\ais64bit\x12A\n" +
	"\x05users\x18\t \x03(\v2+.steam.CMsgRemoteClientBroadcastStatus.UserR\x05users\x12\x1c\n" +
	...
	"\rsteam_version\x18\x19 \x01(\x04R\fsteamVersion\x12J\n" +
	"\fvr_link_caps\x18\x1a \x01(\x0e2\x12.steam.EVRLinkCaps:\x14k_EVRLinkCapsUnknownR\n" +
	"vrLinkCaps\x126\n" +
	...
	"\n" +
	"client_ids\x18\x02 \x03(\x04R\tclientIds\"\xa8\x05\n" +
	...
	"\n" +
	"request_id\x18\x05 \x01(\rR\trequestId\x1a\x9b\x03\n" +
	...
	"\ttimestamp\x18\x04 \x01(\rR\ttimestamp\x12s\n" +
	"\x05usage\x18\x05 \x01(\x0e2;.steam.CMsgRemoteDeviceAuthorizationRequest.EKeyEscrowUsage: k_EKeyEscrowUsageStreamingDeviceR\x05usage\x12\x1f\n" +
	...
	"*CMsgRemoteDeviceAuthorizationCancelRequest\"\xe5\x01\n" +
	"%CMsgRemoteDeviceAuthorizationResponse\x12d\n" +
	"\x06result\x18\x01 \x02(\x0e2'.steam.ERemoteDeviceAuthorizationResult:#k_ERemoteDeviceAuthorizationSuccessR\x06result\x12\x18\n" +
	"\asteamid\x18\x02 \x01(\x06R\asteamid\x12\x19\n" +
	"\bauth_key\x18\x03 \x01(\fR\aauthKey\x12!\n" +
	"\fdevice_token\x18\x04 \x01(\fR\vdeviceToken\"\x8e\x01\n" +
	"&CMsgRemoteDeviceAuthorizationConfirmed\x12d\n" +
	"\x06result\x18\x01 \x02(\x0e2'.steam.ERemoteDeviceAuthorizationResult:#k_ERemoteDeviceAuthorizationSuccessR\x06result\"\x8a\x01\n" +
	...
	"\x17last_known_pairing_time\x18\x03 \x01(\rR\x14lastKnownPairingTime\"\x9d\n" +
	"\n" +
	...
	"\tclient_id\x18\r \x01(\x04R\bclientId\x12H\n" +
	"\x13supported_transport\x18\x0e \x03(\x0e2\x17.steam.EStreamTransportR\x12supportedTransport\x12\x1e\n" +
	"\n" +
	"restricted\x18\x0f \x01(\bR\n" +
	"restricted\x12a\n" +
	"\vform_factor\x18\x10 \x01(\x0e2\x1e.steam.EStreamDeviceFormFactor: k_EStreamDeviceFormFactorUnknownR\n" +
	"formFactor\x12#\n" +
	"\rgamepad_count\x18\x11 \x01(\x05R\fgamepadCount\x12S\n" +
	"\bgamepads\x18\x12 \x03(\v27.steam.CMsgRemoteDeviceStreamingRequest.ReservedGamepadR\bgamepads\x12\x16\n" +
	"\x06gameid\x18\x13 \x01(\x04R\x06gameid\x12]\n" +
	"\x10stream_interface\x18\x14 \x01(\x0e2\x17.steam.EStreamInterface:\x19k_EStreamInterfaceDefaultR\x0fstreamInterface\x12>\n" +
	...
	"\bprogress\x18\x02 \x01(\x02R\bprogress\"\xed\x02\n" +
	"!CMsgRemoteDeviceStreamingResponse\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x02(\rR\trequestId\x12\\\n" +
	"\x06result\x18\x02 \x02(\x0e2#.steam.ERemoteDeviceStreamingResult:\x1fk_ERemoteDeviceStreamingSuccessR\x06result\x12\x12\n" +
	"\x04port\x18\x03 \x01(\rR\x04port\x122\n" +
	"\x15encrypted_session_key\x18\x04 \x01(\fR\x13encryptedSessionKey\x12L\n" +
	"\ttransport\x18\x06 \x01(\x0e2\x17.steam.EStreamTransport:\x15k_EStreamTransportUDPR\ttransport\x12!\n" +
	...
	"+k_ERemoteDeviceStreamingSteamVRNotInstalled\x10\x0fB2H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam"
...
var file_steammessages_remoteclient_discovery_proto_goTypes = []any{
	...
	(EVRLinkCaps)(0),                                               // 2: steam.EVRLinkCaps
	(ERemoteDeviceAuthorizationResult)(0),                          // 3: steam.ERemoteDeviceAuthorizationResult
	(EStreamDeviceFormFactor)(0),                                   // 4: steam.EStreamDeviceFormFactor
	(EStreamTransport)(0),                                          // 5: steam.EStreamTransport
	(EStreamInterface)(0),                                          // 6: steam.EStreamInterface
	(ERemoteDeviceStreamingResult)(0),                              // 7: steam.ERemoteDeviceStreamingResult
	(CMsgRemoteDeviceAuthorizationRequest_EKeyEscrowUsage)(0),      // 8: steam.CMsgRemoteDeviceAuthorizationRequest.EKeyEscrowUsage
	(*CMsgRemoteClientBroadcastHeader)(nil),                        // 9: steam.CMsgRemoteClientBroadcastHeader
	(*CMsgRemoteClientBroadcastStatus)(nil),                        // 10: steam.CMsgRemoteClientBroadcastStatus
	(*CMsgRemoteClientBroadcastDiscovery)(nil),                     // 11: steam.CMsgRemoteClientBroadcastDiscovery
	(*CMsgRemoteClientBroadcastClientIDDeconflict)(nil),            // 12: steam.CMsgRemoteClientBroadcastClientIDDeconflict
	(*CMsgRemoteDeviceAuthorizationRequest)(nil),                   // 13: steam.CMsgRemoteDeviceAuthorizationRequest
	(*CMsgRemoteDeviceAuthorizationCancelRequest)(nil),             // 14: steam.CMsgRemoteDeviceAuthorizationCancelRequest
	(*CMsgRemoteDeviceAuthorizationResponse)(nil),                  // 15: steam.CMsgRemoteDeviceAuthorizationResponse
	(*CMsgRemoteDeviceAuthorizationConfirmed)(nil),                 // 16: steam.CMsgRemoteDeviceAuthorizationConfirmed
	(*CMsgRemoteClientBroadcastClientPairingState)(nil),            // 17: steam.CMsgRemoteClientBroadcastClientPairingState
	(*CMsgRemoteClientBroadcastClientPairingExclusivity)(nil),      // 18: steam.CMsgRemoteClientBroadcastClientPairingExclusivity
	(*CMsgRemoteDeviceStreamingRequest)(nil),                       // 19: steam.CMsgRemoteDeviceStreamingRequest
	(*CMsgRemoteDeviceStreamingCancelRequest)(nil),                 // 20: steam.CMsgRemoteDeviceStreamingCancelRequest
	(*CMsgRemoteDeviceStreamingProgress)(nil),                      // 21: steam.CMsgRemoteDeviceStreamingProgress
	(*CMsgRemoteDeviceStreamingResponse)(nil),                      // 22: steam.CMsgRemoteDeviceStreamingResponse
	(*CMsgRemoteDeviceProofRequest)(nil),                           // 23: steam.CMsgRemoteDeviceProofRequest
	(*CMsgRemoteDeviceProofResponse)(nil),                          // 24: steam.CMsgRemoteDeviceProofResponse
	(*CMsgRemoteDeviceStreamTransportSignal)(nil),                  // 25: steam.CMsgRemoteDeviceStreamTransportSignal
	(*CMsgRemoteClientBroadcastStatus_User)(nil),                   // 26: steam.CMsgRemoteClientBroadcastStatus.User
	(*CMsgRemoteDeviceAuthorizationRequest_CKeyEscrow_Ticket)(nil), // 27: steam.CMsgRemoteDeviceAuthorizationRequest.CKeyEscrow_Ticket
	(*CMsgRemoteDeviceStreamingRequest_ReservedGamepad)(nil),       // 28: steam.CMsgRemoteDeviceStreamingRequest.ReservedGamepad
}
var file_steammessages_remoteclient_discovery_proto_depIdxs = []int32{
	...
	26, // 1: steam.CMsgRemoteClientBroadcastStatus.users:type_name -> steam.CMsgRemoteClientBroadcastStatus.User
	2,  // 2: steam.CMsgRemoteClientBroadcastStatus.vr_link_caps:type_name -> steam.EVRLinkCaps
	3,  // 3: steam.CMsgRemoteDeviceAuthorizationResponse.result:type_name -> steam.ERemoteDeviceAuthorizationResult
	3,  // 4: steam.CMsgRemoteDeviceAuthorizationConfirmed.result:type_name -> steam.ERemoteDeviceAuthorizationResult
	5,  // 5: steam.CMsgRemoteDeviceStreamingRequest.supported_transport:type_name -> steam.EStreamTransport
	4,  // 6: steam.CMsgRemoteDeviceStreamingRequest.form_factor:type_name -> steam.EStreamDeviceFormFactor
	28, // 7: steam.CMsgRemoteDeviceStreamingRequest.gamepads:type_name -> steam.CMsgRemoteDeviceStreamingRequest.ReservedGamepad
	6,  // 8: steam.CMsgRemoteDeviceStreamingRequest.stream_interface:type_name -> steam.EStreamInterface
	7,  // 9: steam.CMsgRemoteDeviceStreamingResponse.result:type_name -> steam.ERemoteDeviceStreamingResult
	5,  // 10: steam.CMsgRemoteDeviceStreamingResponse.transport:type_name -> steam.EStreamTransport
	8,  // 11: steam.CMsgRemoteDeviceAuthorizationRequest.CKeyEscrow_Ticket.usage:type_name -> steam.CMsgRemoteDeviceAuthorizationRequest.EKeyEscrowUsage
