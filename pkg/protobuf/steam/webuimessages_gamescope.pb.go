...
type CMsgDisplayInfo struct {
	...
	DisplayState          *EDisplayPowerState    `protobuf:"varint,9,opt,name=display_state,json=displayState,enum=steam.EDisplayPowerState,def=0" json:"display_state,omitempty"`
...
type CGamescope_SetBlurParams_Request struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Mode           *EGamescopeBlurMode    `protobuf:"varint,1,opt,name=mode,enum=steam.EGamescopeBlurMode,def=0" json:"mode,omitempty"`
...
type CGamescope_SetDisplayPowerState_Request struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Estate        *EDisplayPowerState    `protobuf:"varint,1,opt,name=estate,enum=steam.EDisplayPowerState,def=0" json:"estate,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_webuimessages_gamescope_proto_rawDesc = "" +
	"\n" +
	"\x1dwebuimessages_gamescope.proto\x12\x05steam\x1a\venums.proto\x1a\x18steammessages_base.proto\x1a\x18webuimessages_base.proto\"\x99\x03\n" +
	...
	"\x0eis_vrr_capable\x18\b \x01(\bR\fisVrrCapable\x12\\\n" +
	"\rdisplay_state\x18\t \x01(\x0e2\x19.steam.EDisplayPowerState:\x1ck_EDisplayPowerState_InvalidR\fdisplayState\"\xfa\x06\n" +
	...
	"\x1dis_app_refresh_rate_supported\x18\x04 \x01(\bR\x19isAppRefreshRateSupported\x12F\n" +
	"\x13active_display_info\x18\x05 \x01(\v2\x16.steam.CMsgDisplayInfoR\x11activeDisplayInfo\x12<\n" +
	...
	"\x1bCGamescope_GetState_Request\"O\n" +
	"\x1cCGamescope_GetState_Response\x12/\n" +
	"\x05state\x18\x01 \x01(\v2\x19.steam.CMsgGamescopeStateR\x05state\"&\n" +
	"$CGamescope_StateChanged_Notification\"\xb2\x01\n" +
	" CGamescope_SetBlurParams_Request\x12L\n" +
	"\x04mode\x18\x01 \x01(\x0e2\x19.steam.EGamescopeBlurMode:\x1dk_EGamescopeBlurMode_DisabledR\x04mode\x12\x16\n" +
	...
	"(CGamescope_ReArmMuraCalibration_Response\"z\n" +
	"'CGamescope_SetDisplayPowerState_Request\x12O\n" +
	"\x06estate\x18\x01 \x01(\x0e2\x19.steam.EDisplayPowerState:\x1ck_EDisplayPowerState_InvalidR\x06estate\"*\n" +
	...
	"\x17k_EDisplayPowerState_On\x10\x022\x97\x04\n" +
	"\tGamescope\x12S\n" +
	"\bGetState\x12\".steam.CGamescope_GetState_Request\x1a#.steam.CGamescope_GetState_Response\x12Y\n" +
	"\x12NotifyStateChanged\x12+.steam.CGamescope_StateChanged_Notification\x1a\x16.steam.WebUINoResponse\x12b\n" +
	"\rSetBlurParams\x12'.steam.CGamescope_SetBlurParams_Request\x1a(.steam.CGamescope_SetBlurParams_Response\x12w\n" +
	"\x14ReArmMuraCalibration\x12..steam.CGamescope_ReArmMuraCalibration_Request\x1a/.steam.CGamescope_ReArmMuraCalibration_Response\x12w\n" +
	"\x14SetDisplayPowerState\x12..steam.CGamescope_SetDisplayPowerState_Request\x1a/.steam.CGamescope_SetDisplayPowerState_Response\x1a\x04\x80\x97\"\x01B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_webuimessages_gamescope_proto_goTypes = []any{
	(EDisplayPowerState)(0),                          // 0: steam.EDisplayPowerState
	(*CMsgDisplayInfo)(nil),                          // 1: steam.CMsgDisplayInfo
	(*CMsgGamescopeState)(nil),                       // 2: steam.CMsgGamescopeState
	(*CGamescope_GetState_Request)(nil),              // 3: steam.CGamescope_GetState_Request
	(*CGamescope_GetState_Response)(nil),             // 4: steam.CGamescope_GetState_Response
	(*CGamescope_StateChanged_Notification)(nil),     // 5: steam.CGamescope_StateChanged_Notification
	(*CGamescope_SetBlurParams_Request)(nil),         // 6: steam.CGamescope_SetBlurParams_Request
	(*CGamescope_SetBlurParams_Response)(nil),        // 7: steam.CGamescope_SetBlurParams_Response
	(*CGamescope_ReArmMuraCalibration_Request)(nil),  // 8: steam.CGamescope_ReArmMuraCalibration_Request
	(*CGamescope_ReArmMuraCalibration_Response)(nil), // 9: steam.CGamescope_ReArmMuraCalibration_Response
	(*CGamescope_SetDisplayPowerState_Request)(nil),  // 10: steam.CGamescope_SetDisplayPowerState_Request
	(*CGamescope_SetDisplayPowerState_Response)(nil), // 11: steam.CGamescope_SetDisplayPowerState_Response
	(EGamescopeBlurMode)(0),                          // 12: steam.EGamescopeBlurMode
	(*WebUINoResponse)(nil),                          // 13: steam.WebUINoResponse
}
var file_webuimessages_gamescope_proto_depIdxs = []int32{
	0,  // 0: steam.CMsgDisplayInfo.display_state:type_name -> steam.EDisplayPowerState
	1,  // 1: steam.CMsgGamescopeState.active_display_info:type_name -> steam.CMsgDisplayInfo
	2,  // 2: steam.CGamescope_GetState_Response.state:type_name -> steam.CMsgGamescopeState
	12, // 3: steam.CGamescope_SetBlurParams_Request.mode:type_name -> steam.EGamescopeBlurMode
	0,  // 4: steam.CGamescope_SetDisplayPowerState_Request.estate:type_name -> steam.EDisplayPowerState
	3,  // 5: steam.Gamescope.GetState:input_type -> steam.CGamescope_GetState_Request
	5,  // 6: steam.Gamescope.NotifyStateChanged:input_type -> steam.CGamescope_StateChanged_Notification
	6,  // 7: steam.Gamescope.SetBlurParams:input_type -> steam.CGamescope_SetBlurParams_Request
	8,  // 8: steam.Gamescope.ReArmMuraCalibration:input_type -> steam.CGamescope_ReArmMuraCalibration_Request
	10, // 9: steam.Gamescope.SetDisplayPowerState:input_type -> steam.CGamescope_SetDisplayPowerState_Request
	4,  // 10: steam.Gamescope.GetState:output_type -> steam.CGamescope_GetState_Response
	13, // 11: steam.Gamescope.NotifyStateChanged:output_type -> steam.WebUINoResponse
	7,  // 12: steam.Gamescope.SetBlurParams:output_type -> steam.CGamescope_SetBlurParams_Response
	9,  // 13: steam.Gamescope.ReArmMuraCalibration:output_type -> steam.CGamescope_ReArmMuraCalibration_Response
	11, // 14: steam.Gamescope.SetDisplayPowerState:output_type -> steam.CGamescope_SetDisplayPowerState_Response
