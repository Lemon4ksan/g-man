...
const file_steammessages_clientserver_userstats_proto_rawDesc = "" +
	"\n" +
	"*steammessages_clientserver_userstats.proto\x12\x05steam\x1a\x18steammessages_base.proto\"\xab\x01\n" +
	...
	"\x11steam_id_for_user\x18\x04 \x01(\x06R\x0esteamIdForUser\"\xd6\x03\n" +
	...
	"\x06schema\x18\x04 \x01(\fR\x06schema\x12A\n" +
	"\x05stats\x18\x05 \x03(\v2+.steam.CMsgClientGetUserStatsResponse.StatsR\x05stats\x12g\n" +
	"\x12achievement_blocks\x18\x06 \x03(\v28.steam.CMsgClientGetUserStatsResponse.Achievement_BlocksR\x11achievementBlocks\x1a?\n" +
	"\x05Stats\x12\x17\n" +
	...
	"\agame_id\x18\x01 \x01(\x06R\x06gameId\x12\x1b\n" +
	"\aeresult\x18\x02 \x01(\x05:\x012R\aeresult\x12\x1b\n" +
	"\tcrc_stats\x18\x03 \x01(\rR\bcrcStats\x12w\n" +
	"\x17stats_failed_validation\x18\x04 \x03(\v2?.steam.CMsgClientStoreUserStatsResponse.Stats_Failed_ValidationR\x15statsFailedValidation\x12)\n" +
	...
	"\x13reverted_stat_value\x18\x02 \x01(\rR\x11revertedStatValue\"\xc7\x02\n" +
	...
	"\x0eexplicit_reset\x18\x05 \x01(\bR\rexplicitReset\x12<\n" +
	"\x05stats\x18\x06 \x03(\v2&.steam.CMsgClientStoreUserStats2.StatsR\x05stats\x1a?\n" +
	"\x05Stats\x12\x17\n" +
	"\astat_id\x18\x01 \x01(\rR\x06statId\x12\x1d\n" +
	"\n" +
	"stat_value\x18\x02 \x01(\rR\tstatValue\"\x84\x02\n" +
	"\x16CMsgClientStatsUpdated\x12\x19\n" +
	"\bsteam_id\x18\x01 \x01(\x06R\asteamId\x12\x17\n" +
	"\agame_id\x18\x02 \x01(\x06R\x06gameId\x12\x1b\n" +
	"\tcrc_stats\x18\x03 \x01(\rR\bcrcStats\x12P\n" +
	"\rupdated_stats\x18\x04 \x03(\v2+.steam.CMsgClientStatsUpdated.Updated_StatsR\fupdatedStats\x1aG\n" +
	"\rUpdated_Stats\x12\x17\n" +
	"\astat_id\x18\x01 \x01(\rR\x06statId\x12\x1d\n" +
	"\n" +
	"stat_value\x18\x02 \x01(\rR\tstatValueB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steammessages_clientserver_userstats_proto_goTypes = []any{
	(*CMsgClientGetUserStats)(nil),                                   // 0: steam.CMsgClientGetUserStats
	(*CMsgClientGetUserStatsResponse)(nil),                           // 1: steam.CMsgClientGetUserStatsResponse
	(*CMsgClientStoreUserStatsResponse)(nil),                         // 2: steam.CMsgClientStoreUserStatsResponse
	(*CMsgClientStoreUserStats2)(nil),                                // 3: steam.CMsgClientStoreUserStats2
	(*CMsgClientStatsUpdated)(nil),                                   // 4: steam.CMsgClientStatsUpdated
	(*CMsgClientGetUserStatsResponse_Stats)(nil),                     // 5: steam.CMsgClientGetUserStatsResponse.Stats
	(*CMsgClientGetUserStatsResponse_Achievement_Blocks)(nil),        // 6: steam.CMsgClientGetUserStatsResponse.Achievement_Blocks
	(*CMsgClientStoreUserStatsResponse_Stats_Failed_Validation)(nil), // 7: steam.CMsgClientStoreUserStatsResponse.Stats_Failed_Validation
	(*CMsgClientStoreUserStats2_Stats)(nil),                          // 8: steam.CMsgClientStoreUserStats2.Stats
	(*CMsgClientStatsUpdated_Updated_Stats)(nil),                     // 9: steam.CMsgClientStatsUpdated.Updated_Stats
}
var file_steammessages_clientserver_userstats_proto_depIdxs = []int32{
	5, // 0: steam.CMsgClientGetUserStatsResponse.stats:type_name -> steam.CMsgClientGetUserStatsResponse.Stats
	6, // 1: steam.CMsgClientGetUserStatsResponse.achievement_blocks:type_name -> steam.CMsgClientGetUserStatsResponse.Achievement_Blocks
	7, // 2: steam.CMsgClientStoreUserStatsResponse.stats_failed_validation:type_name -> steam.CMsgClientStoreUserStatsResponse.Stats_Failed_Validation
	8, // 3: steam.CMsgClientStoreUserStats2.stats:type_name -> steam.CMsgClientStoreUserStats2.Stats
	9, // 4: steam.CMsgClientStatsUpdated.updated_stats:type_name -> steam.CMsgClientStatsUpdated.Updated_Stats
