...
const file_steammessages_clientserver_appinfo_proto_rawDesc = "" +
	"\n" +
	"(steammessages_clientserver_appinfo.proto\x12\x05steam\x1a\x18steammessages_base.proto\"o\n" +
	...
	"\x06appIDs\x18\x03 \x03(\rR\x06appIDs\"\xe9\x01\n" +
	"\x18CMsgClientAppInfoRequest\x127\n" +
	"\x04apps\x18\x01 \x03(\v2#.steam.CMsgClientAppInfoRequest.AppR\x04apps\x120\n" +
	...
	"\x17num_package_info_cached\x18\x05 \x01(\rR\x14numPackageInfoCached\"\xb8\x05\n" +
	"\"CMsgClientPICSChangesSinceResponse\x122\n" +
	"\x15current_change_number\x18\x01 \x01(\rR\x13currentChangeNumber\x12.\n" +
	"\x13since_change_number\x18\x02 \x01(\rR\x11sinceChangeNumber\x12*\n" +
	"\x11force_full_update\x18\x03 \x01(\bR\x0fforceFullUpdate\x12`\n" +
	"\x0fpackage_changes\x18\x04 \x03(\v27.steam.CMsgClientPICSChangesSinceResponse.PackageChangeR\x0epackageChanges\x12T\n" +
	"\vapp_changes\x18\x05 \x03(\v23.steam.CMsgClientPICSChangesSinceResponse.AppChangeR\n" +
	"appChanges\x121\n" +
	...
	"\vneeds_token\x18\x03 \x01(\bR\n" +
	"needsToken\"\xe7\x04\n" +
	" CMsgClientPICSProductInfoRequest\x12O\n" +
	"\bpackages\x18\x01 \x03(\v23.steam.CMsgClientPICSProductInfoRequest.PackageInfoR\bpackages\x12C\n" +
	"\x04apps\x18\x02 \x03(\v2/.steam.CMsgClientPICSProductInfoRequest.AppInfoR\x04apps\x12$\n" +
	...
	"\tpackageid\x18\x01 \x01(\rR\tpackageid\x12!\n" +
	"\faccess_token\x18\x02 \x01(\x04R\vaccessToken\"\xaa\x06\n" +
	"!CMsgClientPICSProductInfoResponse\x12D\n" +
	"\x04apps\x18\x01 \x03(\v20.steam.CMsgClientPICSProductInfoResponse.AppInfoR\x04apps\x12%\n" +
	"\x0eunknown_appids\x18\x02 \x03(\rR\runknownAppids\x12P\n" +
	"\bpackages\x18\x03 \x03(\v24.steam.CMsgClientPICSProductInfoResponse.PackageInfoR\bpackages\x12-\n" +
	...
	"packageids\x12\x16\n" +
	"\x06appids\x18\x02 \x03(\rR\x06appids\"\xe3\x03\n" +
	"!CMsgClientPICSAccessTokenResponse\x12i\n" +
	"\x15package_access_tokens\x18\x01 \x03(\v25.steam.CMsgClientPICSAccessTokenResponse.PackageTokenR\x13packageAccessTokens\x122\n" +
	"\x15package_denied_tokens\x18\x02 \x03(\rR\x13packageDeniedTokens\x12]\n" +
	"\x11app_access_tokens\x18\x03 \x03(\v21.steam.CMsgClientPICSAccessTokenResponse.AppTokenR\x0fappAccessTokens\x12*\n" +
	...
	"\rdepot_section\x18\x02 \x01(\fR\fdepotSectionB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steammessages_clientserver_appinfo_proto_goTypes = []any{
	(*CMsgClientAppInfoUpdate)(nil),                          // 0: steam.CMsgClientAppInfoUpdate
	(*CMsgClientAppInfoChanges)(nil),                         // 1: steam.CMsgClientAppInfoChanges
	(*CMsgClientAppInfoRequest)(nil),                         // 2: steam.CMsgClientAppInfoRequest
	(*CMsgClientPICSChangesSinceRequest)(nil),                // 3: steam.CMsgClientPICSChangesSinceRequest
	(*CMsgClientPICSChangesSinceResponse)(nil),               // 4: steam.CMsgClientPICSChangesSinceResponse
	(*CMsgClientPICSProductInfoRequest)(nil),                 // 5: steam.CMsgClientPICSProductInfoRequest
	(*CMsgClientPICSProductInfoResponse)(nil),                // 6: steam.CMsgClientPICSProductInfoResponse
	(*CMsgClientPICSAccessTokenRequest)(nil),                 // 7: steam.CMsgClientPICSAccessTokenRequest
	(*CMsgClientPICSAccessTokenResponse)(nil),                // 8: steam.CMsgClientPICSAccessTokenResponse
	(*CMsgClientPICSPrivateBetaRequest)(nil),                 // 9: steam.CMsgClientPICSPrivateBetaRequest
	(*CMsgClientPICSPrivateBetaResponse)(nil),                // 10: steam.CMsgClientPICSPrivateBetaResponse
	(*CMsgClientAppInfoRequest_App)(nil),                     // 11: steam.CMsgClientAppInfoRequest.App
	(*CMsgClientPICSChangesSinceResponse_PackageChange)(nil), // 12: steam.CMsgClientPICSChangesSinceResponse.PackageChange
	(*CMsgClientPICSChangesSinceResponse_AppChange)(nil),     // 13: steam.CMsgClientPICSChangesSinceResponse.AppChange
	(*CMsgClientPICSProductInfoRequest_AppInfo)(nil),         // 14: steam.CMsgClientPICSProductInfoRequest.AppInfo
	(*CMsgClientPICSProductInfoRequest_PackageInfo)(nil),     // 15: steam.CMsgClientPICSProductInfoRequest.PackageInfo
	(*CMsgClientPICSProductInfoResponse_AppInfo)(nil),        // 16: steam.CMsgClientPICSProductInfoResponse.AppInfo
	(*CMsgClientPICSProductInfoResponse_PackageInfo)(nil),    // 17: steam.CMsgClientPICSProductInfoResponse.PackageInfo
	(*CMsgClientPICSAccessTokenResponse_PackageToken)(nil),   // 18: steam.CMsgClientPICSAccessTokenResponse.PackageToken
	(*CMsgClientPICSAccessTokenResponse_AppToken)(nil),       // 19: steam.CMsgClientPICSAccessTokenResponse.AppToken
}
var file_steammessages_clientserver_appinfo_proto_depIdxs = []int32{
	11, // 0: steam.CMsgClientAppInfoRequest.apps:type_name -> steam.CMsgClientAppInfoRequest.App
	12, // 1: steam.CMsgClientPICSChangesSinceResponse.package_changes:type_name -> steam.CMsgClientPICSChangesSinceResponse.PackageChange
	13, // 2: steam.CMsgClientPICSChangesSinceResponse.app_changes:type_name -> steam.CMsgClientPICSChangesSinceResponse.AppChange
	15, // 3: steam.CMsgClientPICSProductInfoRequest.packages:type_name -> steam.CMsgClientPICSProductInfoRequest.PackageInfo
	14, // 4: steam.CMsgClientPICSProductInfoRequest.apps:type_name -> steam.CMsgClientPICSProductInfoRequest.AppInfo
	16, // 5: steam.CMsgClientPICSProductInfoResponse.apps:type_name -> steam.CMsgClientPICSProductInfoResponse.AppInfo
	17, // 6: steam.CMsgClientPICSProductInfoResponse.packages:type_name -> steam.CMsgClientPICSProductInfoResponse.PackageInfo
	18, // 7: steam.CMsgClientPICSAccessTokenResponse.package_access_tokens:type_name -> steam.CMsgClientPICSAccessTokenResponse.PackageToken
	19, // 8: steam.CMsgClientPICSAccessTokenResponse.app_access_tokens:type_name -> steam.CMsgClientPICSAccessTokenResponse.AppToken
