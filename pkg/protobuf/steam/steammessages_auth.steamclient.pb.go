...
const file_steammessages_auth_steamclient_proto_rawDesc = "" +
	"\n" +
	"$steammessages_auth.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\x1a\venums.proto\"T\n" +
	...
	"\x0finclude_revoked\x18\x01 \x01(\b:\x05falseR\x0eincludeRevoked\"\xab\t\n" +
	...
	"\x11minutes_remaining\x18\x02 \x01(\rR\x10minutesRemaining\"e\n" +
	"&CCloudGaming_GetTimeRemaining_Response\x12;\n" +
	"\aentries\x18\x02 \x03(\v2!.steam.CCloudGaming_TimeRemainingR\aentries*\xb9\x01\n" +
	...
	"\x1bk_EAuthTokenRevokeAutomatic\x10\a2\xbd\x0f\n" +
	"\x0eAuthentication\x12\x8a\x01\n" +
	"\x17GetPasswordRSAPublicKey\x126.steam.CAuthentication_GetPasswordRSAPublicKey_Request\x1a7.steam.CAuthentication_GetPasswordRSAPublicKey_Response\x12\x84\x01\n" +
	"\x15BeginAuthSessionViaQR\x124.steam.CAuthentication_BeginAuthSessionViaQR_Request\x1a5.steam.CAuthentication_BeginAuthSessionViaQR_Response\x12\x9f\x01\n" +
	"\x1eBeginAuthSessionViaCredentials\x12=.steam.CAuthentication_BeginAuthSessionViaCredentials_Request\x1a>.steam.CAuthentication_BeginAuthSessionViaCredentials_Response\x12\x84\x01\n" +
	"\x15PollAuthSessionStatus\x124.steam.CAuthentication_PollAuthSessionStatus_Request\x1a5.steam.CAuthentication_PollAuthSessionStatus_Response\x12{\n" +
	"\x12GetAuthSessionInfo\x121.steam.CAuthentication_GetAuthSessionInfo_Request\x1a2.steam.CAuthentication_GetAuthSessionInfo_Response\x12\x87\x01\n" +
	"\x16GetAuthSessionRiskInfo\x125.steam.CAuthentication_GetAuthSessionRiskInfo_Request\x1a6.steam.CAuthentication_GetAuthSessionRiskInfo_Response\x12e\n" +
	"\x15NotifyRiskQuizResults\x129.steam.CAuthentication_NotifyRiskQuizResults_Notification\x1a\x11.steam.NoResponse\x12\xba\x01\n" +
	"'UpdateAuthSessionWithMobileConfirmation\x12F.steam.CAuthentication_UpdateAuthSessionWithMobileConfirmation_Request\x1aG.steam.CAuthentication_UpdateAuthSessionWithMobileConfirmation_Response\x12\xae\x01\n" +
	"#UpdateAuthSessionWithSteamGuardCode\x12B.steam.CAuthentication_UpdateAuthSessionWithSteamGuardCode_Request\x1aC.steam.CAuthentication_UpdateAuthSessionWithSteamGuardCode_Response\x12\x92\x01\n" +
	"\x19GenerateAccessTokenForApp\x129.steam.CAuthentication_AccessToken_GenerateForApp_Request\x1a:.steam.CAuthentication_AccessToken_GenerateForApp_Response\x12\x80\x01\n" +
	"\x0fEnumerateTokens\x125.steam.CAuthentication_RefreshToken_Enumerate_Request\x1a6.steam.CAuthentication_RefreshToken_Enumerate_Response\x12\x90\x01\n" +
	"\x19GetAuthSessionsForAccount\x128.steam.CAuthentication_GetAuthSessionsForAccount_Request\x1a9.steam.CAuthentication_GetAuthSessionsForAccount_Response\x12h\n" +
	"\vRevokeToken\x12+.steam.CAuthentication_Token_Revoke_Request\x1a,.steam.CAuthentication_Token_Revoke_Response\x12}\n" +
	"\x12RevokeRefreshToken\x122.steam.CAuthentication_RefreshToken_Revoke_Request\x1a3.steam.CAuthentication_RefreshToken_Revoke_Response2\xde\x05\n" +
	"\x15AuthenticationSupport\x12\xa4\x01\n" +
	"\x1bQueryRefreshTokensByAccount\x12A.steam.CAuthenticationSupport_QueryRefreshTokensByAccount_Request\x1aB.steam.CAuthenticationSupport_QueryRefreshTokensByAccount_Response\x12\x92\x01\n" +
	"\x15QueryRefreshTokenByID\x12;.steam.CAuthenticationSupport_QueryRefreshTokenByID_Request\x1a<.steam.CAuthenticationSupport_QueryRefreshTokenByID_Response\x12t\n" +
	"\vRevokeToken\x121.steam.CAuthenticationSupport_RevokeToken_Request\x1a2.steam.CAuthenticationSupport_RevokeToken_Response\x12\x80\x01\n" +
	"\x0fGetTokenHistory\x125.steam.CAuthenticationSupport_GetTokenHistory_Request\x1a6.steam.CAuthenticationSupport_GetTokenHistory_Response\x12\x8f\x01\n" +
	"\x14MarkTokenCompromised\x12:.steam.CAuthenticationSupport_MarkTokenCompromised_Request\x1a;.steam.CAuthenticationSupport_MarkTokenCompromised_Response2\xe0\x01\n" +
	"\vCloudGaming\x12`\n" +
	"\vCreateNonce\x12'.steam.CCloudGaming_CreateNonce_Request\x1a(.steam.CCloudGaming_CreateNonce_Response\x12o\n" +
	"\x10GetTimeRemaining\x12,.steam.CCloudGaming_GetTimeRemaining_Request\x1a-.steam.CCloudGaming_GetTimeRemaining_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_auth_steamclient_proto_goTypes = []any{
	...
	(EAuthTokenAppType)(0),                                                          // 1: steam.EAuthTokenAppType
	(EAuthSessionGuardType)(0),                                                      // 2: steam.EAuthSessionGuardType
	(EAuthSessionSecurityHistory)(0),                                                // 3: steam.EAuthSessionSecurityHistory
	(ETokenRenewalType)(0),                                                          // 4: steam.ETokenRenewalType
	(EAuthenticationType)(0),                                                        // 5: steam.EAuthenticationType
	(EAuthTokenState)(0),                                                            // 6: steam.EAuthTokenState
	(EAuthTokenRevokeAction)(0),                                                     // 7: steam.EAuthTokenRevokeAction
	(*CAuthentication_GetPasswordRSAPublicKey_Request)(nil),                         // 8: steam.CAuthentication_GetPasswordRSAPublicKey_Request
	(*CAuthentication_GetPasswordRSAPublicKey_Response)(nil),                        // 9: steam.CAuthentication_GetPasswordRSAPublicKey_Response
	(*CAuthentication_DeviceDetails)(nil),                                           // 10: steam.CAuthentication_DeviceDetails
	(*CAuthentication_BeginAuthSessionViaQR_Request)(nil),                           // 11: steam.CAuthentication_BeginAuthSessionViaQR_Request
	(*CAuthentication_AllowedConfirmation)(nil),                                     // 12: steam.CAuthentication_AllowedConfirmation
	(*CAuthentication_BeginAuthSessionViaQR_Response)(nil),                          // 13: steam.CAuthentication_BeginAuthSessionViaQR_Response
	(*CAuthentication_BeginAuthSessionViaCredentials_Request)(nil),                  // 14: steam.CAuthentication_BeginAuthSessionViaCredentials_Request
	(*CAuthentication_BeginAuthSessionViaCredentials_Response)(nil),                 // 15: steam.CAuthentication_BeginAuthSessionViaCredentials_Response
	(*CAuthentication_PollAuthSessionStatus_Request)(nil),                           // 16: steam.CAuthentication_PollAuthSessionStatus_Request
	(*CAuthentication_PollAuthSessionStatus_Response)(nil),                          // 17: steam.CAuthentication_PollAuthSessionStatus_Response
	(*CAuthentication_GetAuthSessionInfo_Request)(nil),                              // 18: steam.CAuthentication_GetAuthSessionInfo_Request
	(*CAuthentication_GetAuthSessionInfo_Response)(nil),                             // 19: steam.CAuthentication_GetAuthSessionInfo_Response
	(*CAuthentication_GetAuthSessionRiskInfo_Request)(nil),                          // 20: steam.CAuthentication_GetAuthSessionRiskInfo_Request
	(*CAuthentication_GetAuthSessionRiskInfo_Response)(nil),                         // 21: steam.CAuthentication_GetAuthSessionRiskInfo_Response
	(*CAuthentication_NotifyRiskQuizResults_Notification)(nil),                      // 22: steam.CAuthentication_NotifyRiskQuizResults_Notification
	(*CAuthentication_UpdateAuthSessionWithMobileConfirmation_Request)(nil),         // 23: steam.CAuthentication_UpdateAuthSessionWithMobileConfirmation_Request
	(*CAuthentication_UpdateAuthSessionWithMobileConfirmation_Response)(nil),        // 24: steam.CAuthentication_UpdateAuthSessionWithMobileConfirmation_Response
	(*CAuthentication_UpdateAuthSessionWithSteamGuardCode_Request)(nil),             // 25: steam.CAuthentication_UpdateAuthSessionWithSteamGuardCode_Request
	(*CAuthentication_UpdateAuthSessionWithSteamGuardCode_Response)(nil),            // 26: steam.CAuthentication_UpdateAuthSessionWithSteamGuardCode_Response
	(*CAuthentication_AccessToken_GenerateForApp_Request)(nil),                      // 27: steam.CAuthentication_AccessToken_GenerateForApp_Request
	(*CAuthentication_AccessToken_GenerateForApp_Response)(nil),                     // 28: steam.CAuthentication_AccessToken_GenerateForApp_Response
	(*CAuthentication_RefreshToken_Enumerate_Request)(nil),                          // 29: steam.CAuthentication_RefreshToken_Enumerate_Request
	(*CAuthentication_RefreshToken_Enumerate_Response)(nil),                         // 30: steam.CAuthentication_RefreshToken_Enumerate_Response
	(*CAuthentication_GetAuthSessionsForAccount_Request)(nil),                       // 31: steam.CAuthentication_GetAuthSessionsForAccount_Request
	(*CAuthentication_GetAuthSessionsForAccount_Response)(nil),                      // 32: steam.CAuthentication_GetAuthSessionsForAccount_Response
	(*CAuthentication_Token_Revoke_Request)(nil),                                    // 33: steam.CAuthentication_Token_Revoke_Request
	(*CAuthentication_Token_Revoke_Response)(nil),                                   // 34: steam.CAuthentication_Token_Revoke_Response
	(*CAuthentication_RefreshToken_Revoke_Request)(nil),                             // 35: steam.CAuthentication_RefreshToken_Revoke_Request
	(*CAuthentication_RefreshToken_Revoke_Response)(nil),                            // 36: steam.CAuthentication_RefreshToken_Revoke_Response
	(*CAuthenticationSupport_QueryRefreshTokensByAccount_Request)(nil),              // 37: steam.CAuthenticationSupport_QueryRefreshTokensByAccount_Request
	(*CSupportRefreshTokenDescription)(nil),                                         // 38: steam.CSupportRefreshTokenDescription
	(*CAuthenticationSupport_QueryRefreshTokensByAccount_Response)(nil),             // 39: steam.CAuthenticationSupport_QueryRefreshTokensByAccount_Response
	(*CAuthenticationSupport_QueryRefreshTokenByID_Request)(nil),                    // 40: steam.CAuthenticationSupport_QueryRefreshTokenByID_Request
	(*CAuthenticationSupport_QueryRefreshTokenByID_Response)(nil),                   // 41: steam.CAuthenticationSupport_QueryRefreshTokenByID_Response
	(*CAuthenticationSupport_RevokeToken_Request)(nil),                              // 42: steam.CAuthenticationSupport_RevokeToken_Request
	(*CAuthenticationSupport_RevokeToken_Response)(nil),                             // 43: steam.CAuthenticationSupport_RevokeToken_Response
	(*CAuthenticationSupport_GetTokenHistory_Request)(nil),                          // 44: steam.CAuthenticationSupport_GetTokenHistory_Request
	(*CSupportRefreshTokenAudit)(nil),                                               // 45: steam.CSupportRefreshTokenAudit
	(*CAuthenticationSupport_GetTokenHistory_Response)(nil),                         // 46: steam.CAuthenticationSupport_GetTokenHistory_Response
	(*CAuthenticationSupport_MarkTokenCompromised_Request)(nil),                     // 47: steam.CAuthenticationSupport_MarkTokenCompromised_Request
	(*CAuthenticationSupport_MarkTokenCompromised_Response)(nil),                    // 48: steam.CAuthenticationSupport_MarkTokenCompromised_Response
	(*CCloudGaming_CreateNonce_Request)(nil),                                        // 49: steam.CCloudGaming_CreateNonce_Request
	(*CCloudGaming_CreateNonce_Response)(nil),                                       // 50: steam.CCloudGaming_CreateNonce_Response
	(*CCloudGaming_GetTimeRemaining_Request)(nil),                                   // 51: steam.CCloudGaming_GetTimeRemaining_Request
	(*CCloudGaming_TimeRemaining)(nil),                                              // 52: steam.CCloudGaming_TimeRemaining
	(*CCloudGaming_GetTimeRemaining_Response)(nil),                                  // 53: steam.CCloudGaming_GetTimeRemaining_Response
	(*CAuthentication_NotifyRiskQuizResults_Notification_RiskQuizResults)(nil),      // 54: steam.CAuthentication_NotifyRiskQuizResults_Notification.RiskQuizResults
	(*CAuthentication_RefreshToken_Enumerate_Response_TokenUsageEvent)(nil),         // 55: steam.CAuthentication_RefreshToken_Enumerate_Response.TokenUsageEvent
	(*CAuthentication_RefreshToken_Enumerate_Response_RefreshTokenDescription)(nil), // 56: steam.CAuthentication_RefreshToken_Enumerate_Response.RefreshTokenDescription
	(*CSupportRefreshTokenDescription_TokenUsageEvent)(nil),                         // 57: steam.CSupportRefreshTokenDescription.TokenUsageEvent
	(ESessionPersistence)(0),                                                        // 58: steam.ESessionPersistence
	(*CMsgIPAddress)(nil),                                                           // 59: steam.CMsgIPAddress
	(*NoResponse)(nil),                                                              // 60: steam.NoResponse
}
var file_steammessages_auth_steamclient_proto_depIdxs = []int32{
	...
	1,  // 1: steam.CAuthentication_DeviceDetails.app_type:type_name -> steam.EAuthTokenAppType
	0,  // 2: steam.CAuthentication_BeginAuthSessionViaQR_Request.platform_type:type_name -> steam.EAuthTokenPlatformType
	10, // 3: steam.CAuthentication_BeginAuthSessionViaQR_Request.device_details:type_name -> steam.CAuthentication_DeviceDetails
	2,  // 4: steam.CAuthentication_AllowedConfirmation.confirmation_type:type_name -> steam.EAuthSessionGuardType
	12, // 5: steam.CAuthentication_BeginAuthSessionViaQR_Response.allowed_confirmations:type_name -> steam.CAuthentication_AllowedConfirmation
	0,  // 6: steam.CAuthentication_BeginAuthSessionViaCredentials_Request.platform_type:type_name -> steam.EAuthTokenPlatformType
	58, // 7: steam.CAuthentication_BeginAuthSessionViaCredentials_Request.persistence:type_name -> steam.ESessionPersistence
	10, // 8: steam.CAuthentication_BeginAuthSessionViaCredentials_Request.device_details:type_name -> steam.CAuthentication_DeviceDetails
	12, // 9: steam.CAuthentication_BeginAuthSessionViaCredentials_Response.allowed_confirmations:type_name -> steam.CAuthentication_AllowedConfirmation
	0,  // 10: steam.CAuthentication_GetAuthSessionInfo_Response.platform_type:type_name -> steam.EAuthTokenPlatformType
	3,  // 11: steam.CAuthentication_GetAuthSessionInfo_Response.login_history:type_name -> steam.EAuthSessionSecurityHistory
	58, // 12: steam.CAuthentication_GetAuthSessionInfo_Response.requested_persistence:type_name -> steam.ESessionPersistence
	1,  // 13: steam.CAuthentication_GetAuthSessionInfo_Response.app_type:type_name -> steam.EAuthTokenAppType
	0,  // 14: steam.CAuthentication_GetAuthSessionRiskInfo_Response.platform_type:type_name -> steam.EAuthTokenPlatformType
	54, // 15: steam.CAuthentication_NotifyRiskQuizResults_Notification.results:type_name -> steam.CAuthentication_NotifyRiskQuizResults_Notification.RiskQuizResults
	58, // 16: steam.CAuthentication_UpdateAuthSessionWithMobileConfirmation_Request.persistence:type_name -> steam.ESessionPersistence
	2,  // 17: steam.CAuthentication_UpdateAuthSessionWithSteamGuardCode_Request.code_type:type_name -> steam.EAuthSessionGuardType
	4,  // 18: steam.CAuthentication_AccessToken_GenerateForApp_Request.renewal_type:type_name -> steam.ETokenRenewalType
	56, // 19: steam.CAuthentication_RefreshToken_Enumerate_Response.refresh_tokens:type_name -> steam.CAuthentication_RefreshToken_Enumerate_Response.RefreshTokenDescription
	7,  // 20: steam.CAuthentication_Token_Revoke_Request.revoke_action:type_name -> steam.EAuthTokenRevokeAction
	7,  // 21: steam.CAuthentication_RefreshToken_Revoke_Request.revoke_action:type_name -> steam.EAuthTokenRevokeAction
	0,  // 22: steam.CSupportRefreshTokenDescription.platform_type:type_name -> steam.EAuthTokenPlatformType
	6,  // 23: steam.CSupportRefreshTokenDescription.token_state:type_name -> steam.EAuthTokenState
	57, // 24: steam.CSupportRefreshTokenDescription.first_seen:type_name -> steam.CSupportRefreshTokenDescription.TokenUsageEvent
	57, // 25: steam.CSupportRefreshTokenDescription.last_seen:type_name -> steam.CSupportRefreshTokenDescription.TokenUsageEvent
	38, // 26: steam.CAuthenticationSupport_QueryRefreshTokensByAccount_Response.refresh_tokens:type_name -> steam.CSupportRefreshTokenDescription
	38, // 27: steam.CAuthenticationSupport_QueryRefreshTokenByID_Response.refresh_tokens:type_name -> steam.CSupportRefreshTokenDescription
	59, // 28: steam.CSupportRefreshTokenAudit.ip:type_name -> steam.CMsgIPAddress
	45, // 29: steam.CAuthenticationSupport_GetTokenHistory_Response.history:type_name -> steam.CSupportRefreshTokenAudit
	52, // 30: steam.CCloudGaming_GetTimeRemaining_Response.entries:type_name -> steam.CCloudGaming_TimeRemaining
	59, // 31: steam.CAuthentication_RefreshToken_Enumerate_Response.TokenUsageEvent.ip:type_name -> steam.CMsgIPAddress
	0,  // 32: steam.CAuthentication_RefreshToken_Enumerate_Response.RefreshTokenDescription.platform_type:type_name -> steam.EAuthTokenPlatformType
	55, // 33: steam.CAuthentication_RefreshToken_Enumerate_Response.RefreshTokenDescription.first_seen:type_name -> steam.CAuthentication_RefreshToken_Enumerate_Response.TokenUsageEvent
	55, // 34: steam.CAuthentication_RefreshToken_Enumerate_Response.RefreshTokenDescription.last_seen:type_name -> steam.CAuthentication_RefreshToken_Enumerate_Response.TokenUsageEvent
	5,  // 35: steam.CAuthentication_RefreshToken_Enumerate_Response.RefreshTokenDescription.authentication_type:type_name -> steam.EAuthenticationType
	6,  // 36: steam.CAuthentication_RefreshToken_Enumerate_Response.RefreshTokenDescription.effective_token_state:type_name -> steam.EAuthTokenState
	59, // 37: steam.CSupportRefreshTokenDescription.TokenUsageEvent.ip:type_name -> steam.CMsgIPAddress
	8,  // 38: steam.Authentication.GetPasswordRSAPublicKey:input_type -> steam.CAuthentication_GetPasswordRSAPublicKey_Request
	11, // 39: steam.Authentication.BeginAuthSessionViaQR:input_type -> steam.CAuthentication_BeginAuthSessionViaQR_Request
	14, // 40: steam.Authentication.BeginAuthSessionViaCredentials:input_type -> steam.CAuthentication_BeginAuthSessionViaCredentials_Request
	16, // 41: steam.Authentication.PollAuthSessionStatus:input_type -> steam.CAuthentication_PollAuthSessionStatus_Request
	18, // 42: steam.Authentication.GetAuthSessionInfo:input_type -> steam.CAuthentication_GetAuthSessionInfo_Request
	20, // 43: steam.Authentication.GetAuthSessionRiskInfo:input_type -> steam.CAuthentication_GetAuthSessionRiskInfo_Request
	22, // 44: steam.Authentication.NotifyRiskQuizResults:input_type -> steam.CAuthentication_NotifyRiskQuizResults_Notification
	23, // 45: steam.Authentication.UpdateAuthSessionWithMobileConfirmation:input_type -> steam.CAuthentication_UpdateAuthSessionWithMobileConfirmation_Request
	25, // 46: steam.Authentication.UpdateAuthSessionWithSteamGuardCode:input_type -> steam.CAuthentication_UpdateAuthSessionWithSteamGuardCode_Request
	27, // 47: steam.Authentication.GenerateAccessTokenForApp:input_type -> steam.CAuthentication_AccessToken_GenerateForApp_Request
	29, // 48: steam.Authentication.EnumerateTokens:input_type -> steam.CAuthentication_RefreshToken_Enumerate_Request
	31, // 49: steam.Authentication.GetAuthSessionsForAccount:input_type -> steam.CAuthentication_GetAuthSessionsForAccount_Request
	33, // 50: steam.Authentication.RevokeToken:input_type -> steam.CAuthentication_Token_Revoke_Request
	35, // 51: steam.Authentication.RevokeRefreshToken:input_type -> steam.CAuthentication_RefreshToken_Revoke_Request
	37, // 52: steam.AuthenticationSupport.QueryRefreshTokensByAccount:input_type -> steam.CAuthenticationSupport_QueryRefreshTokensByAccount_Request
	40, // 53: steam.AuthenticationSupport.QueryRefreshTokenByID:input_type -> steam.CAuthenticationSupport_QueryRefreshTokenByID_Request
	42, // 54: steam.AuthenticationSupport.RevokeToken:input_type -> steam.CAuthenticationSupport_RevokeToken_Request
	44, // 55: steam.AuthenticationSupport.GetTokenHistory:input_type -> steam.CAuthenticationSupport_GetTokenHistory_Request
	47, // 56: steam.AuthenticationSupport.MarkTokenCompromised:input_type -> steam.CAuthenticationSupport_MarkTokenCompromised_Request
	49, // 57: steam.CloudGaming.CreateNonce:input_type -> steam.CCloudGaming_CreateNonce_Request
	51, // 58: steam.CloudGaming.GetTimeRemaining:input_type -> steam.CCloudGaming_GetTimeRemaining_Request
	9,  // 59: steam.Authentication.GetPasswordRSAPublicKey:output_type -> steam.CAuthentication_GetPasswordRSAPublicKey_Response
	13, // 60: steam.Authentication.BeginAuthSessionViaQR:output_type -> steam.CAuthentication_BeginAuthSessionViaQR_Response
	15, // 61: steam.Authentication.BeginAuthSessionViaCredentials:output_type -> steam.CAuthentication_BeginAuthSessionViaCredentials_Response
	17, // 62: steam.Authentication.PollAuthSessionStatus:output_type -> steam.CAuthentication_PollAuthSessionStatus_Response
	19, // 63: steam.Authentication.GetAuthSessionInfo:output_type -> steam.CAuthentication_GetAuthSessionInfo_Response
	21, // 64: steam.Authentication.GetAuthSessionRiskInfo:output_type -> steam.CAuthentication_GetAuthSessionRiskInfo_Response
	60, // 65: steam.Authentication.NotifyRiskQuizResults:output_type -> steam.NoResponse
	24, // 66: steam.Authentication.UpdateAuthSessionWithMobileConfirmation:output_type -> steam.CAuthentication_UpdateAuthSessionWithMobileConfirmation_Response
	26, // 67: steam.Authentication.UpdateAuthSessionWithSteamGuardCode:output_type -> steam.CAuthentication_UpdateAuthSessionWithSteamGuardCode_Response
	28, // 68: steam.Authentication.GenerateAccessTokenForApp:output_type -> steam.CAuthentication_AccessToken_GenerateForApp_Response
	30, // 69: steam.Authentication.EnumerateTokens:output_type -> steam.CAuthentication_RefreshToken_Enumerate_Response
	32, // 70: steam.Authentication.GetAuthSessionsForAccount:output_type -> steam.CAuthentication_GetAuthSessionsForAccount_Response
	34, // 71: steam.Authentication.RevokeToken:output_type -> steam.CAuthentication_Token_Revoke_Response
	36, // 72: steam.Authentication.RevokeRefreshToken:output_type -> steam.CAuthentication_RefreshToken_Revoke_Response
	39, // 73: steam.AuthenticationSupport.QueryRefreshTokensByAccount:output_type -> steam.CAuthenticationSupport_QueryRefreshTokensByAccount_Response
	41, // 74: steam.AuthenticationSupport.QueryRefreshTokenByID:output_type -> steam.CAuthenticationSupport_QueryRefreshTokenByID_Response
	43, // 75: steam.AuthenticationSupport.RevokeToken:output_type -> steam.CAuthenticationSupport_RevokeToken_Response
	46, // 76: steam.AuthenticationSupport.GetTokenHistory:output_type -> steam.CAuthenticationSupport_GetTokenHistory_Response
	48, // 77: steam.AuthenticationSupport.MarkTokenCompromised:output_type -> steam.CAuthenticationSupport_MarkTokenCompromised_Response
	50, // 78: steam.CloudGaming.CreateNonce:output_type -> steam.CCloudGaming_CreateNonce_Response
	53, // 79: steam.CloudGaming.GetTimeRemaining:output_type -> steam.CCloudGaming_GetTimeRemaining_Response
