...
type CVirtualControllerConfig struct {
	...
	DefaultMouseMode *EMouseMode                           `protobuf:"varint,3,opt,name=default_mouse_mode,json=defaultMouseMode,enum=steam.EMouseMode,def=2" json:"default_mouse_mode,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_steammessages_virtualcontroller_proto_rawDesc = "" +
	"\n" +
	"%steammessages_virtualcontroller.proto\x12\x05steam\"\xfc\x01\n" +
	"\x19CVirtualControllerElement\x12O\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1d.steam.EControllerElementType:\x1ck_EControllerElementTypeNoneR\x04type\x12\x18\n" +
	...
	"\x01a\x18\x04 \x01(\x02:\x011R\x01a\"\xd8\x01\n" +
	"\x18CVirtualControllerLayout\x12%\n" +
	"\x0elayout_version\x18\x01 \x01(\x05R\rlayoutVersion\x12!\n" +
	"\factionset_id\x18\x02 \x01(\x05R\vactionsetId\x12<\n" +
	"\belements\x18\x04 \x03(\v2 .steam.CVirtualControllerElementR\belements\x124\n" +
	"\x05color\x18\x05 \x01(\v2\x1e.steam.CVirtualControllerColorR\x05color\"\x8a\x04\n" +
	"\x19CVirtualControllerLayouts\x129\n" +
	"\alayouts\x18\x01 \x03(\v2\x1f.steam.CVirtualControllerLayoutR\alayouts\x12H\n" +
	"\n" +
	"input_mode\x18\x02 \x01(\x0e2\x11.steam.EInputMode:\x16k_EInputModeControllerR\tinputMode\x12E\n" +
	"\n" +
	"mouse_mode\x18\x03 \x01(\x0e2\x11.steam.EMouseMode:\x13k_EMouseModeUnknownR\tmouseMode\x124\n" +
	...
	" \x01(\bR\x0emouseOffscreen\"\xaa\a\n" +
	"\x18CVirtualControllerConfig\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12I\n" +
	"\n" +
	"actionsets\x18\x02 \x03(\v2).steam.CVirtualControllerConfig.ActionSetR\n" +
	"actionsets\x12[\n" +
	"\x12default_mouse_mode\x18\x03 \x01(\x0e2\x11.steam.EMouseMode:\x1ak_EMouseModeAbsoluteCursorR\x10defaultMouseMode\x1a\xbd\x04\n" +
	"\aControl\x12\x12\n" +
	...
	"\x0fdouble_press_ms\x18\x0f \x01(\x05R\rdoublePressMs\x1a\x91\x01\n" +
	"\tActionSet\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x1b\n" +
	"\tparent_id\x18\x02 \x01(\x05R\bparentId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12C\n" +
	"\bcontrols\x18\x04 \x03(\v2'.steam.CVirtualControllerConfig.ControlR\bcontrols\"\x98\x02\n" +
	...
	"\x0esaved_revision\x18\x04 \x01(\rR\rsavedRevision\x127\n" +
	"\x06config\x18\x05 \x01(\v2\x1f.steam.CVirtualControllerConfigR\x06config\x12:\n" +
	"\alayouts\x18\x06 \x01(\v2 .steam.CVirtualControllerLayoutsR\alayouts\"\x8b\x02\n" +
	...
	"\x1bk_EControllerElementTypeMax\x10#B0Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam"
