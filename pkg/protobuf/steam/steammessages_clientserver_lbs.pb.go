...
const file_steammessages_clientserver_lbs_proto_rawDesc = "" +
	"\n" +
	"$steammessages_clientserver_lbs.proto\x12\x05steam\x1a\x18steammessages_base.proto\"\xb5\x01\n" +
	...
	"\bsteamids\x18\x06 \x03(\x06R\bsteamids\"\xd8\x02\n" +
	"!CMsgClientLBSGetLBEntriesResponse\x12\x1b\n" +
	"\aeresult\x18\x01 \x01(\x05:\x012R\aeresult\x126\n" +
	"\x17leaderboard_entry_count\x18\x02 \x01(\x05R\x15leaderboardEntryCount\x12H\n" +
	"\aentries\x18\x03 \x03(\v2..steam.CMsgClientLBSGetLBEntriesResponse.EntryR\aentries\x1a\x93\x01\n" +
	"\x05Entry\x12\"\n" +
	...
	"\x06ugc_id\x18\x05 \x01(\x06R\x05ugcIdB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steammessages_clientserver_lbs_proto_goTypes = []any{
	(*CMsgClientLBSSetScore)(nil),                   // 0: steam.CMsgClientLBSSetScore
	(*CMsgClientLBSSetScoreResponse)(nil),           // 1: steam.CMsgClientLBSSetScoreResponse
	(*CMsgClientLBSSetUGC)(nil),                     // 2: steam.CMsgClientLBSSetUGC
	(*CMsgClientLBSSetUGCResponse)(nil),             // 3: steam.CMsgClientLBSSetUGCResponse
	(*CMsgClientLBSFindOrCreateLB)(nil),             // 4: steam.CMsgClientLBSFindOrCreateLB
	(*CMsgClientLBSFindOrCreateLBResponse)(nil),     // 5: steam.CMsgClientLBSFindOrCreateLBResponse
	(*CMsgClientLBSGetLBEntries)(nil),               // 6: steam.CMsgClientLBSGetLBEntries
	(*CMsgClientLBSGetLBEntriesResponse)(nil),       // 7: steam.CMsgClientLBSGetLBEntriesResponse
	(*CMsgClientLBSGetLBEntriesResponse_Entry)(nil), // 8: steam.CMsgClientLBSGetLBEntriesResponse.Entry
}
var file_steammessages_clientserver_lbs_proto_depIdxs = []int32{
	8, // 0: steam.CMsgClientLBSGetLBEntriesResponse.entries:type_name -> steam.CMsgClientLBSGetLBEntriesResponse.Entry
