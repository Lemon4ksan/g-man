...
const file_webuimessages_hardwareupdate_proto_rawDesc = "" +
	"\n" +
	"\"webuimessages_hardwareupdate.proto\x12\x05steam\x1a\venums.proto\x1a\x18steammessages_base.proto\x1a\x18webuimessages_base.proto\"\"\n" +
	...
	"\x10mandatory_update\x18\x06 \x01(\bR\x0fmandatoryUpdate\"h\n" +
	"(CHardwareUpdate_CheckForUpdates_Response\x12<\n" +
	"\aupdates\x18\x01 \x03(\v2\".steam.CMsgAvailableHardwareUpdateR\aupdates\"E\n" +
	...
	"\rserial_number\x18\x01 \x01(\tR\fserialNumber\"(\n" +
	"&CHardwareUpdate_PrepForUpdate_Response2\xe0\x05\n" +
	"\x0eHardwareUpdate\x12]\n" +
	"\bGetState\x12'.steam.CHardwareUpdate_GetState_Request\x1a(.steam.CHardwareUpdate_GetState_Response\x12^\n" +
	"\x12NotifyStateChanged\x120.steam.CHardwareUpdate_StateChanged_Notification\x1a\x16.steam.WebUINoResponse\x12r\n" +
	"\x0fCheckForUpdates\x12..steam.CHardwareUpdate_CheckForUpdates_Request\x1a/.steam.CHardwareUpdate_CheckForUpdates_Response\x12l\n" +
	"\rPrepForUpdate\x12,.steam.CHardwareUpdate_PrepForUpdate_Request\x1a-.steam.CHardwareUpdate_PrepForUpdate_Response\x12W\n" +
	"\x06Update\x12%.steam.CHardwareUpdate_Update_Request\x1a&.steam.CHardwareUpdate_Update_Response\x12b\n" +
	"\x14NotifyUpdateProgress\x122.steam.CHardwareUpdate_UpdateProgress_Notification\x1a\x16.steam.WebUINoResponse\x12j\n" +
	"\x18NotifyUpdateStateChanged\x126.steam.CHardwareUpdate_UpdateStateChanged_Notification\x1a\x16.steam.WebUINoResponse\x1a\x04\x80\x97\"\x01B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_webuimessages_hardwareupdate_proto_goTypes = []any{
	(*CHardwareUpdate_GetState_Request)(nil),                // 0: steam.CHardwareUpdate_GetState_Request
	(*CHardwareUpdate_GetState_Response)(nil),               // 1: steam.CHardwareUpdate_GetState_Response
	(*CHardwareUpdate_StateChanged_Notification)(nil),       // 2: steam.CHardwareUpdate_StateChanged_Notification
	(*CHardwareUpdate_CheckForUpdates_Request)(nil),         // 3: steam.CHardwareUpdate_CheckForUpdates_Request
	(*CMsgAvailableHardwareUpdate)(nil),                     // 4: steam.CMsgAvailableHardwareUpdate
	(*CHardwareUpdate_CheckForUpdates_Response)(nil),        // 5: steam.CHardwareUpdate_CheckForUpdates_Response
	(*CHardwareUpdate_Update_Request)(nil),                  // 6: steam.CHardwareUpdate_Update_Request
	(*CHardwareUpdate_Update_Response)(nil),                 // 7: steam.CHardwareUpdate_Update_Response
	(*CHardwareUpdate_UpdateProgress_Notification)(nil),     // 8: steam.CHardwareUpdate_UpdateProgress_Notification
	(*CHardwareUpdate_UpdateStateChanged_Notification)(nil), // 9: steam.CHardwareUpdate_UpdateStateChanged_Notification
	(*CHardwareUpdate_PrepForUpdate_Request)(nil),           // 10: steam.CHardwareUpdate_PrepForUpdate_Request
	(*CHardwareUpdate_PrepForUpdate_Response)(nil),          // 11: steam.CHardwareUpdate_PrepForUpdate_Response
	(*WebUINoResponse)(nil),                                 // 12: steam.WebUINoResponse
}
var file_webuimessages_hardwareupdate_proto_depIdxs = []int32{
	4,  // 0: steam.CHardwareUpdate_CheckForUpdates_Response.updates:type_name -> steam.CMsgAvailableHardwareUpdate
	0,  // 1: steam.HardwareUpdate.GetState:input_type -> steam.CHardwareUpdate_GetState_Request
	2,  // 2: steam.HardwareUpdate.NotifyStateChanged:input_type -> steam.CHardwareUpdate_StateChanged_Notification
	3,  // 3: steam.HardwareUpdate.CheckForUpdates:input_type -> steam.CHardwareUpdate_CheckForUpdates_Request
	10, // 4: steam.HardwareUpdate.PrepForUpdate:input_type -> steam.CHardwareUpdate_PrepForUpdate_Request
	6,  // 5: steam.HardwareUpdate.Update:input_type -> steam.CHardwareUpdate_Update_Request
	8,  // 6: steam.HardwareUpdate.NotifyUpdateProgress:input_type -> steam.CHardwareUpdate_UpdateProgress_Notification
	9,  // 7: steam.HardwareUpdate.NotifyUpdateStateChanged:input_type -> steam.CHardwareUpdate_UpdateStateChanged_Notification
	1,  // 8: steam.HardwareUpdate.GetState:output_type -> steam.CHardwareUpdate_GetState_Response
	12, // 9: steam.HardwareUpdate.NotifyStateChanged:output_type -> steam.WebUINoResponse
	5,  // 10: steam.HardwareUpdate.CheckForUpdates:output_type -> steam.CHardwareUpdate_CheckForUpdates_Response
	11, // 11: steam.HardwareUpdate.PrepForUpdate:output_type -> steam.CHardwareUpdate_PrepForUpdate_Response
	7,  // 12: steam.HardwareUpdate.Update:output_type -> steam.CHardwareUpdate_Update_Response
	12, // 13: steam.HardwareUpdate.NotifyUpdateProgress:output_type -> steam.WebUINoResponse
	12, // 14: steam.HardwareUpdate.NotifyUpdateStateChanged:output_type -> steam.WebUINoResponse
