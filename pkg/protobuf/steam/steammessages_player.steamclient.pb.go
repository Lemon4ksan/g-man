...
type CPlayer_GetProfileItemsOwned_Request struct {
	...
	Filters       []ECommunityItemClass  `protobuf:"varint,2,rep,name=filters,enum=steam.ECommunityItemClass" json:"filters,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ProfileCustomizationSlot struct {
	...
	BanCheckResult  *EBanContentCheckResult `protobuf:"varint,13,opt,name=ban_check_result,json=banCheckResult,enum=steam.EBanContentCheckResult,def=0" json:"ban_check_result,omitempty"`
...
type ProfileCustomization struct {
	state              protoimpl.MessageState      `protogen:"open.v1"`
	CustomizationType  *EProfileCustomizationType  `protobuf:"varint,1,opt,name=customization_type,json=customizationType,enum=steam.EProfileCustomizationType,def=0" json:"customization_type,omitempty"`
	...
	CustomizationStyle *EProfileCustomizationStyle `protobuf:"varint,5,opt,name=customization_style,json=customizationStyle,enum=steam.EProfileCustomizationStyle,def=0" json:"customization_style,omitempty"`
...
type CPlayer_AcceptSSA_Request struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AgreementType *EAgreementType        `protobuf:"varint,1,opt,name=agreement_type,json=agreementType,enum=steam.EAgreementType,def=-1" json:"agreement_type,omitempty"`
...
type CPlayer_CommunityPreferences struct {
	...
	TextFilterSetting       *ETextFilterSetting    `protobuf:"varint,5,opt,name=text_filter_setting,json=textFilterSetting,enum=steam.ETextFilterSetting,def=0" json:"text_filter_setting,omitempty"`
...
type CPlayer_GetNewSteamAnnouncementState_Response struct {
	state                protoimpl.MessageState      `protogen:"open.v1"`
	State                *ENewSteamAnnouncementState `protobuf:"varint,1,opt,name=state,enum=steam.ENewSteamAnnouncementState,def=0" json:"state,omitempty"`
...
type CPlayer_GetProfileCustomization_Response_PurchasedCustomization struct {
	...
	CustomizationType *EProfileCustomizationType `protobuf:"varint,2,opt,name=customization_type,json=customizationType,enum=steam.EProfileCustomizationType,def=0" json:"customization_type,omitempty"`
...
const file_steammessages_player_steamclient_proto_rawDesc = "" +
	"\n" +
	"&steammessages_player.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\x1a\venums.proto\"M\n" +
	"1CPlayer_GetRecentPlaytimeSessionsForChild_Request\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x04R\asteamid\"\xc4\x02\n" +
	"2CPlayer_GetRecentPlaytimeSessionsForChild_Response\x12e\n" +
	"\bsessions\x18\x01 \x03(\v2I.steam.CPlayer_GetRecentPlaytimeSessionsForChild_Response.PlaytimeSessionR\bsessions\x1a\xa6\x01\n" +
	...
	"\bsteamids\x18\x01 \x03(\x04R\bsteamids\"\x8f\x0e\n" +
	"%CPlayer_GetPlayerLinkDetails_Response\x12Z\n" +
	"\baccounts\x18\x01 \x03(\v2>.steam.CPlayer_GetPlayerLinkDetails_Response.PlayerLinkDetailsR\baccounts\x1a\x89\r\n" +
	"\x11PlayerLinkDetails\x12q\n" +
	"\vpublic_data\x18\x01 \x01(\v2P.steam.CPlayer_GetPlayerLinkDetails_Response.PlayerLinkDetails.AccountPublicDataR\n" +
	"publicData\x12t\n" +
	"\fprivate_data\x18\x02 \x01(\v2Q.steam.CPlayer_GetPlayerLinkDetails_Response.PlayerLinkDetails.AccountPrivateDataR\vprivateData\x1a\x9f\x03\n" +
	...
	"\x19mutual_friend_account_ids\x18\x02 \x03(\rR\x16mutualFriendAccountIds\"\xb4\x01\n" +
	"3CPlayer_GetMutualFriendsForIncomingInvites_Response\x12}\n" +
	"$incoming_invite_mutual_friends_lists\x18\x01 \x03(\v2-.steam.CPlayer_IncomingInviteMutualFriendListR incomingInviteMutualFriendsLists\"\xf6\x02\n" +
	...
	"\x18include_extended_appinfo\x18\b \x01(\bR\x16includeExtendedAppinfo\"\x9f\a\n" +
	"\x1eCPlayer_GetOwnedGames_Response\x12\x1d\n" +
	"\n" +
	"game_count\x18\x01 \x01(\rR\tgameCount\x12@\n" +
	"\x05games\x18\x02 \x03(\v2*.steam.CPlayer_GetOwnedGames_Response.GameR\x05games\x1a\x9b\x06\n" +
	"\x04Game\x12\x14\n" +
	...
	"\x05appid\x18\x01 \x01(\rR\x05appid\"\xc3\a\n" +
	"'CPlayer_GetFriendsGameplayInfo_Response\x12[\n" +
	"\tyour_info\x18\x01 \x01(\v2>.steam.CPlayer_GetFriendsGameplayInfo_Response.OwnGameplayInfoR\byourInfo\x12[\n" +
	"\ain_game\x18\x02 \x03(\v2B.steam.CPlayer_GetFriendsGameplayInfo_Response.FriendsGameplayInfoR\x06inGame\x12k\n" +
	"\x0fplayed_recently\x18\x03 \x03(\v2B.steam.CPlayer_GetFriendsGameplayInfo_Response.FriendsGameplayInfoR\x0eplayedRecently\x12c\n" +
	"\vplayed_ever\x18\x04 \x03(\v2B.steam.CPlayer_GetFriendsGameplayInfo_Response.FriendsGameplayInfoR\n" +
	"playedEver\x12V\n" +
	"\x04owns\x18\x05 \x03(\v2B.steam.CPlayer_GetFriendsGameplayInfo_Response.FriendsGameplayInfoR\x04owns\x12c\n" +
	"\vin_wishlist\x18\x06 \x03(\v2B.steam.CPlayer_GetFriendsGameplayInfo_Response.FriendsGameplayInfoR\n" +
	...
	"\fplayer_level\x18\x01 \x01(\rR\vplayerLevel\x12H\n" +
	"\x06badges\x18\x02 \x03(\v20.steam.CPlayer_GetGameBadgeLevels_Response.BadgeR\x06badges\x1aX\n" +
	"\x05Badge\x12\x14\n" +
	...
	"\blanguage\x18\x02 \x01(\tR\blanguage\"\x81\x05\n" +
	"\vProfileItem\x12(\n" +
	...
	"\x0eequipped_flags\x18\f \x01(\rR\requippedFlags\x12F\n" +
	"\x0eprofile_colors\x18\x0f \x03(\v2\x1f.steam.ProfileItem.ProfileColorR\rprofileColors\x12\x14\n" +
	...
	"%CPlayer_GetProfileBackground_Response\x12A\n" +
	"\x12profile_background\x18\x01 \x01(\v2\x12.steam.ProfileItemR\x11profileBackground\"P\n" +
	...
	")CPlayer_GetMiniProfileBackground_Response\x12A\n" +
	"\x12profile_background\x18\x01 \x01(\v2\x12.steam.ProfileItemR\x11profileBackground\"T\n" +
	...
	"\x1fCPlayer_GetAvatarFrame_Response\x125\n" +
	"\favatar_frame\x18\x01 \x01(\v2\x12.steam.ProfileItemR\vavatarFrame\"J\n" +
	...
	"\x06avatar\x18\x01 \x01(\v2\x12.steam.ProfileItemR\x06avatar\"M\n" +
	...
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\tR\blanguage\"x\n" +
	")CPlayer_GetSteamDeckKeyboardSkin_Response\x12K\n" +
	"\x18steam_deck_keyboard_skin\x18\x01 \x01(\v2\x12.steam.ProfileItemR\x15steamDeckKeyboardSkin\"T\n" +
	"(CPlayer_SetSteamDeckKeyboardSkin_Request\x12(\n" +
	"\x0fcommunityitemid\x18\x01 \x01(\x04R\x0fcommunityitemid\"+\n" +
	")CPlayer_SetSteamDeckKeyboardSkin_Response\"x\n" +
	"$CPlayer_GetProfileItemsOwned_Request\x12\x1a\n" +
	"\blanguage\x18\x01 \x01(\tR\blanguage\x124\n" +
	"\afilters\x18\x02 \x03(\x0e2\x1a.steam.ECommunityItemClassR\afilters\"\x91\x04\n" +
	"%CPlayer_GetProfileItemsOwned_Response\x12C\n" +
	"\x13profile_backgrounds\x18\x01 \x03(\v2\x12.steam.ProfileItemR\x12profileBackgrounds\x12L\n" +
	"\x18mini_profile_backgrounds\x18\x02 \x03(\v2\x12.steam.ProfileItemR\x16miniProfileBackgrounds\x127\n" +
	"\ravatar_frames\x18\x03 \x03(\v2\x12.steam.ProfileItemR\favatarFrames\x12=\n" +
	"\x10animated_avatars\x18\x04 \x03(\v2\x12.steam.ProfileItemR\x0fanimatedAvatars\x12?\n" +
	"\x11profile_modifiers\x18\x05 \x03(\v2\x12.steam.ProfileItemR\x10profileModifiers\x12M\n" +
	"\x19steam_deck_keyboard_skins\x18\x06 \x03(\v2\x12.steam.ProfileItemR\x16steamDeckKeyboardSkins\x12M\n" +
	"\x19steam_deck_startup_movies\x18\a \x03(\v2\x12.steam.ProfileItemR\x16steamDeckStartupMovies\"_\n" +
	"'CPlayer_GetProfileItemsEquipped_Request\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\tR\blanguage\"\xb9\x03\n" +
	"(CPlayer_GetProfileItemsEquipped_Response\x12A\n" +
	"\x12profile_background\x18\x01 \x01(\v2\x12.steam.ProfileItemR\x11profileBackground\x12J\n" +
	"\x17mini_profile_background\x18\x02 \x01(\v2\x12.steam.ProfileItemR\x15miniProfileBackground\x125\n" +
	"\favatar_frame\x18\x03 \x01(\v2\x12.steam.ProfileItemR\vavatarFrame\x12;\n" +
	"\x0fanimated_avatar\x18\x04 \x01(\v2\x12.steam.ProfileItemR\x0eanimatedAvatar\x12=\n" +
	"\x10profile_modifier\x18\x05 \x01(\v2\x12.steam.ProfileItemR\x0fprofileModifier\x12K\n" +
	"\x18steam_deck_keyboard_skin\x18\x06 \x01(\v2\x12.steam.ProfileItemR\x15steamDeckKeyboardSkin\"m\n" +
	...
	"\x1fCPlayer_GetEmoticonList_Request\"\xa7\x02\n" +
	" CPlayer_GetEmoticonList_Response\x12N\n" +
	"\temoticons\x18\x01 \x03(\v20.steam.CPlayer_GetEmoticonList_Response.EmoticonR\temoticons\x1a\xb2\x01\n" +
	"\bEmoticon\x12\x12\n" +
	...
	"\abadgeid\x18\x02 \x01(\x05R\abadgeid\"\xbe\x01\n" +
	"*CPlayer_GetCommunityBadgeProgress_Response\x12O\n" +
	"\x06quests\x18\x01 \x03(\v27.steam.CPlayer_GetCommunityBadgeProgress_Response.QuestR\x06quests\x1a?\n" +
	"\x05Quest\x12\x18\n" +
	...
	"\x06appids\x18\x04 \x03(\rR\x06appids\"\x91\x04\n" +
	"+CPlayer_GetTopAchievementsForGames_Response\x12M\n" +
	"\x05games\x18\x01 \x03(\v27.steam.CPlayer_GetTopAchievementsForGames_Response.GameR\x05games\x1a\xe0\x01\n" +
	...
	"\x17player_percent_unlocked\x18\b \x01(\tR\x15playerPercentUnlocked\x1a\xaf\x01\n" +
	"\x04Game\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12-\n" +
	"\x12total_achievements\x18\x02 \x01(\rR\x11totalAchievements\x12b\n" +
	"\fachievements\x18\x03 \x03(\v2>.steam.CPlayer_GetTopAchievementsForGames_Response.AchievementR\fachievements\"\xab\x01\n" +
	...
	"\x15include_unvetted_apps\x18\x04 \x01(\bR\x13includeUnvettedApps\"\xfc\x02\n" +
	"(CPlayer_GetAchievementsProgress_Response\x12v\n" +
	"\x14achievement_progress\x18\x01 \x03(\v2C.steam.CPlayer_GetAchievementsProgress_Response.AchievementProgressR\x13achievementProgress\x1a\xd7\x01\n" +
	...
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\tR\blanguage\"\x87\x03\n" +
	"$CPlayer_GetGameAchievements_Response\x12[\n" +
	"\fachievements\x18\x01 \x03(\v27.steam.CPlayer_GetGameAchievements_Response.AchievementR\fachievements\x1a\x81\x02\n" +
	"\vAchievement\x12#\n" +
	...
	"\tcrc_stats\x18\x04 \x01(\rR\bcrcStats\"\xa5\x03\n" +
	...
	"\x05stats\x18\x04 \x03(\v2*.steam.CPlayer_GetUserStats_Response.StatsR\x05stats\x1aW\n" +
	"\vUnlock_Time\x12'\n" +
	"\x0fachievement_bit\x18\x01 \x01(\rR\x0eachievementBit\x12\x1f\n" +
	"\vunlock_time\x18\x02 \x01(\aR\n" +
	"unlockTime\x1a\x94\x01\n" +
	"\x05Stats\x12\x17\n" +
	"\astat_id\x18\x01 \x01(\rR\x06statId\x12\x1d\n" +
	"\n" +
	"stat_value\x18\x02 \x01(\rR\tstatValue\x12S\n" +
	"\funlock_times\x18\x03 \x03(\v20.steam.CPlayer_GetUserStats_Response.Unlock_TimeR\vunlockTimes\"<\n" +
	...
	" include_purchased_customizations\x18\x03 \x01(\bR\x1eincludePurchasedCustomizations\"\x9a\x04\n" +
	...
	"\x0fitem_instanceid\x18\f \x01(\x04R\x0eitemInstanceid\x12l\n" +
	"\x10ban_check_result\x18\r \x01(\x0e2\x1d.steam.EBanContentCheckResult:#k_EBanContentCheckResult_NotScannedR\x0ebanCheckResult\x12\x1f\n" +
	"\vreplay_year\x18\x0e \x01(\rR\n" +
	"replayYear\"\x9f\x03\n" +
	"\x14ProfileCustomization\x12s\n" +
	"\x12customization_type\x18\x01 \x01(\x0e2 .steam.EProfileCustomizationType:\"k_EProfileCustomizationTypeInvalidR\x11customizationType\x12\x14\n" +
	"\x05large\x18\x02 \x01(\bR\x05large\x125\n" +
	"\x05slots\x18\x03 \x03(\v2\x1f.steam.ProfileCustomizationSlotR\x05slots\x12\x16\n" +
	"\x06active\x18\x04 \x01(\bR\x06active\x12w\n" +
	"\x13customization_style\x18\x05 \x01(\x0e2!.steam.EProfileCustomizationStyle:#k_EProfileCustomizationStyleDefaultR\x12customizationStyle\x12\x1e\n" +
	"\n" +
	...
	"\x13hide_profile_awards\x18\x01 \x01(\bR\x11hideProfileAwards\"\xe8\x04\n" +
	"(CPlayer_GetProfileCustomization_Response\x12C\n" +
	"\x0ecustomizations\x18\x01 \x03(\v2\x1b.steam.ProfileCustomizationR\x0ecustomizations\x12'\n" +
	"\x0fslots_available\x18\x02 \x01(\rR\x0eslotsAvailable\x128\n" +
	"\rprofile_theme\x18\x03 \x01(\v2\x13.steam.ProfileThemeR\fprofileTheme\x12\x81\x01\n" +
	"\x18purchased_customizations\x18\x04 \x03(\v2F.steam.CPlayer_GetProfileCustomization_Response.PurchasedCustomizationR\x17purchasedCustomizations\x12J\n" +
	"\x13profile_preferences\x18\x05 \x01(\v2\x19.steam.ProfilePreferencesR\x12profilePreferences\x1a\xc3\x01\n" +
	"\x16PurchasedCustomization\x12\x1e\n" +
	"\n" +
	"purchaseid\x18\x01 \x01(\x04R\n" +
	"purchaseid\x12s\n" +
	"\x12customization_type\x18\x02 \x01(\x0e2 .steam.EProfileCustomizationType:\"k_EProfileCustomizationTypeInvalidR\x11customizationType\x12\x14\n" +
	"\x05level\x18\x03 \x01(\rR\x05level\"M\n" +
	"1CPlayer_GetPurchasedProfileCustomizations_Request\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\"\xf2\x02\n" +
	"2CPlayer_GetPurchasedProfileCustomizations_Response\x12\x8b\x01\n" +
	"\x18purchased_customizations\x18\x01 \x03(\v2P.steam.CPlayer_GetPurchasedProfileCustomizations_Response.PurchasedCustomizationR\x17purchasedCustomizations\x1a\xad\x01\n" +
	"\x16PurchasedCustomization\x12\x1e\n" +
	"\n" +
	"purchaseid\x18\x01 \x01(\x04R\n" +
	"purchaseid\x12s\n" +
	"\x12customization_type\x18\x02 \x01(\x0e2 .steam.EProfileCustomizationType:\"k_EProfileCustomizationTypeInvalidR\x11customizationType\"X\n" +
	"<CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Request\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\"\xb9\x05\n" +
	"=CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response\x12\x96\x01\n" +
	"\x18purchased_customizations\x18\x01 \x03(\v2[.steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response.PurchasedCustomizationR\x17purchasedCustomizations\x12\x93\x01\n" +
	"\x17upgraded_customizations\x18\x02 \x03(\v2Z.steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response.UpgradedCustomizationR\x16upgradedCustomizations\x1a\xa3\x01\n" +
	"\x16PurchasedCustomization\x12s\n" +
	"\x12customization_type\x18\x01 \x01(\x0e2 .steam.EProfileCustomizationType:\"k_EProfileCustomizationTypeInvalidR\x11customizationType\x12\x14\n" +
	"\x05count\x18\x02 \x01(\rR\x05count\x1a\xa2\x01\n" +
	"\x15UpgradedCustomization\x12s\n" +
	"\x12customization_type\x18\x01 \x01(\x0e2 .steam.EProfileCustomizationType:\"k_EProfileCustomizationTypeInvalidR\x11customizationType\x12\x14\n" +
	"\x05level\x18\x02 \x01(\rR\x05level\"+\n" +
	")CPlayer_GetProfileThemesAvailable_Request\"h\n" +
	"*CPlayer_GetProfileThemesAvailable_Response\x12:\n" +
	"\x0eprofile_themes\x18\x01 \x03(\v2\x13.steam.ProfileThemeR\rprofileThemes\"<\n" +
	"\x1fCPlayer_SetProfileTheme_Request\x12\x19\n" +
	"\btheme_id\x18\x01 \x01(\tR\athemeId\"\"\n" +
	" CPlayer_SetProfileTheme_Response\"s\n" +
	"%CPlayer_SetProfilePreferences_Request\x12J\n" +
	"\x13profile_preferences\x18\x01 \x01(\v2\x19.steam.ProfilePreferencesR\x12profilePreferences\"(\n" +
	...
	"\x0fmin_last_played\x18\x01 \x01(\rR\rminLastPlayed\"\xba\a\n" +
	"#CPlayer_GetLastPlayedTimes_Response\x12E\n" +
	"\x05games\x18\x01 \x03(\v2/.steam.CPlayer_GetLastPlayedTimes_Response.GameR\x05games\x1a\xcb\x06\n" +
	"\x04Game\x12\x14\n" +
	...
	"\x16time_chinassa_accepted\x18\x03 \x01(\rR\x14timeChinassaAccepted\"\x9b\x01\n" +
	"\x19CPlayer_AcceptSSA_Request\x12V\n" +
	"\x0eagreement_type\x18\x01 \x01(\x0e2\x15.steam.EAgreementType:\x18k_EAgreementType_InvalidR\ragreementType\x12&\n" +
	"\x0ftime_signed_utc\x18\x02 \x01(\rR\rtimeSignedUtc\"\x1c\n" +
	"\x1aCPlayer_AcceptSSA_Response\"!\n" +
	"\x1fCPlayer_GetNicknameList_Request\"\xc4\x01\n" +
	" CPlayer_GetNicknameList_Response\x12T\n" +
	"\tnicknames\x18\x01 \x03(\v26.steam.CPlayer_GetNicknameList_Response.PlayerNicknameR\tnicknames\x1aJ\n" +
	"\x0ePlayerNickname\x12\x1c\n" +
	"\taccountid\x18\x01 \x01(\aR\taccountid\x12\x1a\n" +
	"\bnickname\x18\x02 \x01(\tR\bnickname\")\n" +
	"'CPlayer_GetPerFriendPreferences_Request\"\xaf\a\n" +
	"\x14PerFriendPreferences\x12\x1c\n" +
	"\taccountid\x18\x01 \x01(\aR\taccountid\x12\x1a\n" +
	"\bnickname\x18\x02 \x01(\tR\bnickname\x12~\n" +
	"\x18notifications_showingame\x18\x03 \x01(\x0e2\x1b.steam.ENotificationSetting:&k_ENotificationSettingNotifyUseDefaultR\x17notificationsShowingame\x12~\n" +
	"\x18notifications_showonline\x18\x04 \x01(\x0e2\x1b.steam.ENotificationSetting:&k_ENotificationSettingNotifyUseDefaultR\x17notificationsShowonline\x12\x82\x01\n" +
	"\x1anotifications_showmessages\x18\x05 \x01(\x0e2\x1b.steam.ENotificationSetting:&k_ENotificationSettingNotifyUseDefaultR\x19notificationsShowmessages\x12p\n" +
	"\x11sounds_showingame\x18\x06 \x01(\x0e2\x1b.steam.ENotificationSetting:&k_ENotificationSettingNotifyUseDefaultR\x10soundsShowingame\x12p\n" +
	"\x11sounds_showonline\x18\a \x01(\x0e2\x1b.steam.ENotificationSetting:&k_ENotificationSettingNotifyUseDefaultR\x10soundsShowonline\x12t\n" +
	"\x13sounds_showmessages\x18\b \x01(\x0e2\x1b.steam.ENotificationSetting:&k_ENotificationSettingNotifyUseDefaultR\x12soundsShowmessages\x12~\n" +
	"\x18notifications_sendmobile\x18\t \x01(\x0e2\x1b.steam.ENotificationSetting:&k_ENotificationSettingNotifyUseDefaultR\x17notificationsSendmobile\"i\n" +
	"(CPlayer_GetPerFriendPreferences_Response\x12=\n" +
	"\vpreferences\x18\x01 \x03(\v2\x1b.steam.PerFriendPreferencesR\vpreferences\"h\n" +
	"'CPlayer_SetPerFriendPreferences_Request\x12=\n" +
	"\vpreferences\x18\x01 \x01(\v2\x1b.steam.PerFriendPreferencesR\vpreferences\"*\n" +
	...
	"'CPlayer_GetCommunityPreferences_Request\"\xfa\x02\n" +
	"\x1cCPlayer_CommunityPreferences\x12<\n" +
	"\x16parenthesize_nicknames\x18\x04 \x01(\b:\x05falseR\x15parenthesizeNicknames\x12o\n" +
	"\x13text_filter_setting\x18\x05 \x01(\x0e2\x19.steam.ETextFilterSetting:$k_ETextFilterSettingSteamLabOptedOutR\x11textFilterSetting\x12A\n" +
	...
	"\x11timestamp_updated\x18\x03 \x01(\rR\x10timestampUpdated\"\xe0\x01\n" +
	"(CPlayer_GetCommunityPreferences_Response\x12E\n" +
	"\vpreferences\x18\x01 \x01(\v2#.steam.CPlayer_CommunityPreferencesR\vpreferences\x12m\n" +
	"\x1econtent_descriptor_preferences\x18\x02 \x01(\v2'.steam.UserContentDescriptorPreferencesR\x1ccontentDescriptorPreferences\"p\n" +
	"'CPlayer_SetCommunityPreferences_Request\x12E\n" +
	"\vpreferences\x18\x01 \x01(\v2#.steam.CPlayer_CommunityPreferencesR\vpreferences\"*\n" +
	...
	"#CPlayer_GetTextFilterWords_Response\x124\n" +
	"\x05words\x18\x01 \x01(\v2\x1e.steam.CPlayer_TextFilterWordsR\x05words\"J\n" +
	",CPlayer_GetNewSteamAnnouncementState_Request\x12\x1a\n" +
	"\blanguage\x18\x01 \x01(\x05R\blanguage\"\xba\x02\n" +
	"-CPlayer_GetNewSteamAnnouncementState_Response\x12]\n" +
	"\x05state\x18\x01 \x01(\x0e2!.steam.ENewSteamAnnouncementState:$k_ENewSteamAnnouncementState_InvalidR\x05state\x123\n" +
	...
	"\x19privacy_state_friendslist\x18\x06 \x01(\x05R\x17privacyStateFriendslist\"i\n" +
	"#CPlayer_GetPrivacySettings_Response\x12B\n" +
	"\x10privacy_settings\x18\x01 \x01(\v2\x17.steam.CPrivacySettingsR\x0fprivacySettings\":\n" +
	...
	"\fblock_minors\x18\b \x01(\bR\vblockMinors\"\xae\x02\n" +
	"*CPlayer_RecordDisconnectedPlaytime_Request\x12b\n" +
	"\rplay_sessions\x18\x03 \x03(\v2=.steam.CPlayer_RecordDisconnectedPlaytime_Request.PlayHistoryR\fplaySessions\x1a\x9b\x01\n" +
	...
	"+CPlayer_RecordDisconnectedPlaytime_Response\"m\n" +
	"$CPlayer_LastPlayedTimes_Notification\x12E\n" +
	"\x05games\x18\x01 \x03(\v2/.steam.CPlayer_GetLastPlayedTimes_Response.GameR\x05games\"\x8d\x01\n" +
	...
	"\taccountid\x18\x01 \x01(\aR\taccountid\"\xbb\x02\n" +
	...
	"\vtime_posted\x18\x04 \x01(\rR\n" +
	"timePosted\x12)\n" +
	"\x10announcement_gid\x18\x05 \x01(\x04R\x0fannouncementGid\"\xe8\x01\n" +
	"0CPlayer_CommunityPreferencesChanged_Notification\x12E\n" +
	"\vpreferences\x18\x01 \x01(\v2#.steam.CPlayer_CommunityPreferencesR\vpreferences\x12m\n" +
	"\x1econtent_descriptor_preferences\x18\x02 \x01(\v2'.steam.UserContentDescriptorPreferencesR\x1ccontentDescriptorPreferences\"c\n" +
	"+CPlayer_TextFilterWordsChanged_Notification\x124\n" +
	"\x05words\x18\x01 \x01(\v2\x1e.steam.CPlayer_TextFilterWordsR\x05words\"\x8f\x01\n" +
	"0CPlayer_PerFriendPreferencesChanged_Notification\x12\x1c\n" +
	"\taccountid\x18\x01 \x01(\aR\taccountid\x12=\n" +
	"\vpreferences\x18\x02 \x01(\v2\x1b.steam.PerFriendPreferencesR\vpreferences\"q\n" +
	"+CPlayer_PrivacySettingsChanged_Notification\x12B\n" +
	"\x10privacy_settings\x18\x01 \x01(\v2\x17.steam.CPrivacySettingsR\x0fprivacySettings*\x99\x02\n" +
	...
	"\x1ck_ETextFilterSettingDisabled\x10\x032\xaf1\n" +
	"\x06Player\x12\x98\x01\n" +
	"!GetRecentPlaytimeSessionsForChild\x128.steam.CPlayer_GetRecentPlaytimeSessionsForChild_Request\x1a9.steam.CPlayer_GetRecentPlaytimeSessionsForChild_Response\x12q\n" +
	"\x14GetPlayerLinkDetails\x12+.steam.CPlayer_GetPlayerLinkDetails_Request\x1a,.steam.CPlayer_GetPlayerLinkDetails_Response\x12\x9b\x01\n" +
	"\"GetMutualFriendsForIncomingInvites\x129.steam.CPlayer_GetMutualFriendsForIncomingInvites_Request\x1a:.steam.CPlayer_GetMutualFriendsForIncomingInvites_Response\x12\\\n" +
	"\rGetOwnedGames\x12$.steam.CPlayer_GetOwnedGames_Request\x1a%.steam.CPlayer_GetOwnedGames_Response\x12V\n" +
	"\vGetPlayNext\x12\".steam.CPlayer_GetPlayNext_Request\x1a#.steam.CPlayer_GetPlayNext_Response\x12w\n" +
	"\x16GetFriendsGameplayInfo\x12-.steam.CPlayer_GetFriendsGameplayInfo_Request\x1a..steam.CPlayer_GetFriendsGameplayInfo_Response\x12k\n" +
	"\x12GetGameBadgeLevels\x12).steam.CPlayer_GetGameBadgeLevels_Request\x1a*.steam.CPlayer_GetGameBadgeLevels_Response\x12q\n" +
	"\x14GetProfileBackground\x12+.steam.CPlayer_GetProfileBackground_Request\x1a,.steam.CPlayer_GetProfileBackground_Response\x12q\n" +
	"\x14SetProfileBackground\x12+.steam.CPlayer_SetProfileBackground_Request\x1a,.steam.CPlayer_SetProfileBackground_Response\x12}\n" +
	"\x18GetMiniProfileBackground\x12/.steam.CPlayer_GetMiniProfileBackground_Request\x1a0.steam.CPlayer_GetMiniProfileBackground_Response\x12}\n" +
	"\x18SetMiniProfileBackground\x12/.steam.CPlayer_SetMiniProfileBackground_Request\x1a0.steam.CPlayer_SetMiniProfileBackground_Response\x12_\n" +
	"\x0eGetAvatarFrame\x12%.steam.CPlayer_GetAvatarFrame_Request\x1a&.steam.CPlayer_GetAvatarFrame_Response\x12_\n" +
	"\x0eSetAvatarFrame\x12%.steam.CPlayer_SetAvatarFrame_Request\x1a&.steam.CPlayer_SetAvatarFrame_Response\x12h\n" +
	"\x11GetAnimatedAvatar\x12(.steam.CPlayer_GetAnimatedAvatar_Request\x1a).steam.CPlayer_GetAnimatedAvatar_Response\x12h\n" +
	"\x11SetAnimatedAvatar\x12(.steam.CPlayer_SetAnimatedAvatar_Request\x1a).steam.CPlayer_SetAnimatedAvatar_Response\x12}\n" +
	"\x18GetSteamDeckKeyboardSkin\x12/.steam.CPlayer_GetSteamDeckKeyboardSkin_Request\x1a0.steam.CPlayer_GetSteamDeckKeyboardSkin_Response\x12}\n" +
	"\x18SetSteamDeckKeyboardSkin\x12/.steam.CPlayer_SetSteamDeckKeyboardSkin_Request\x1a0.steam.CPlayer_SetSteamDeckKeyboardSkin_Response\x12q\n" +
	"\x14GetProfileItemsOwned\x12+.steam.CPlayer_GetProfileItemsOwned_Request\x1a,.steam.CPlayer_GetProfileItemsOwned_Response\x12z\n" +
	"\x17GetProfileItemsEquipped\x12..steam.CPlayer_GetProfileItemsEquipped_Request\x1a/.steam.CPlayer_GetProfileItemsEquipped_Response\x12\x86\x01\n" +
	"\x1bSetEquippedProfileItemFlags\x122.steam.CPlayer_SetEquippedProfileItemFlags_Request\x1a3.steam.CPlayer_SetEquippedProfileItemFlags_Response\x12b\n" +
	"\x0fGetEmoticonList\x12&.steam.CPlayer_GetEmoticonList_Request\x1a'.steam.CPlayer_GetEmoticonList_Response\x12\x80\x01\n" +
	"\x19GetCommunityBadgeProgress\x120.steam.CPlayer_GetCommunityBadgeProgress_Request\x1a1.steam.CPlayer_GetCommunityBadgeProgress_Response\x12\x83\x01\n" +
	"\x1aGetTopAchievementsForGames\x121.steam.CPlayer_GetTopAchievementsForGames_Request\x1a2.steam.CPlayer_GetTopAchievementsForGames_Response\x12z\n" +
	"\x17GetAchievementsProgress\x12..steam.CPlayer_GetAchievementsProgress_Request\x1a/.steam.CPlayer_GetAchievementsProgress_Response\x12n\n" +
	"\x13GetGameAchievements\x12*.steam.CPlayer_GetGameAchievements_Request\x1a+.steam.CPlayer_GetGameAchievements_Response\x12Y\n" +
	"\fGetUserStats\x12#.steam.CPlayer_GetUserStats_Request\x1a$.steam.CPlayer_GetUserStats_Response\x12e\n" +
	"\x10GetFavoriteBadge\x12'.steam.CPlayer_GetFavoriteBadge_Request\x1a(.steam.CPlayer_GetFavoriteBadge_Response\x12e\n" +
	"\x10SetFavoriteBadge\x12'.steam.CPlayer_SetFavoriteBadge_Request\x1a(.steam.CPlayer_SetFavoriteBadge_Response\x12z\n" +
	"\x17GetProfileCustomization\x12..steam.CPlayer_GetProfileCustomization_Request\x1a/.steam.CPlayer_GetProfileCustomization_Response\x12\x98\x01\n" +
	"!GetPurchasedProfileCustomizations\x128.steam.CPlayer_GetPurchasedProfileCustomizations_Request\x1a9.steam.CPlayer_GetPurchasedProfileCustomizations_Response\x12\xb9\x01\n" +
	",GetPurchasedAndUpgradedProfileCustomizations\x12C.steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Request\x1aD.steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response\x12\x80\x01\n" +
	"\x19GetProfileThemesAvailable\x120.steam.CPlayer_GetProfileThemesAvailable_Request\x1a1.steam.CPlayer_GetProfileThemesAvailable_Response\x12b\n" +
	"\x0fSetProfileTheme\x12&.steam.CPlayer_SetProfileTheme_Request\x1a'.steam.CPlayer_SetProfileTheme_Response\x12t\n" +
	"\x15SetProfilePreferences\x12,.steam.CPlayer_SetProfilePreferences_Request\x1a-.steam.CPlayer_SetProfilePreferences_Response\x12n\n" +
	"\x13PostStatusToFriends\x12*.steam.CPlayer_PostStatusToFriends_Request\x1a+.steam.CPlayer_PostStatusToFriends_Response\x12b\n" +
	"\x0fGetPostedStatus\x12&.steam.CPlayer_GetPostedStatus_Request\x1a'.steam.CPlayer_GetPostedStatus_Response\x12k\n" +
	"\x12DeletePostedStatus\x12).steam.CPlayer_DeletePostedStatus_Request\x1a*.steam.CPlayer_DeletePostedStatus_Response\x12q\n" +
	"\x18ClientGetLastPlayedTimes\x12).steam.CPlayer_GetLastPlayedTimes_Request\x1a*.steam.CPlayer_GetLastPlayedTimes_Response\x12k\n" +
	"\x12GetTimeSSAAccepted\x12).steam.CPlayer_GetTimeSSAAccepted_Request\x1a*.steam.CPlayer_GetTimeSSAAccepted_Response\x12P\n" +
	"\tAcceptSSA\x12 .steam.CPlayer_AcceptSSA_Request\x1a!.steam.CPlayer_AcceptSSA_Response\x12b\n" +
	"\x0fGetNicknameList\x12&.steam.CPlayer_GetNicknameList_Request\x1a'.steam.CPlayer_GetNicknameList_Response\x12z\n" +
	"\x17GetPerFriendPreferences\x12..steam.CPlayer_GetPerFriendPreferences_Request\x1a/.steam.CPlayer_GetPerFriendPreferences_Response\x12z\n" +
	"\x17SetPerFriendPreferences\x12..steam.CPlayer_SetPerFriendPreferences_Request\x1a/.steam.CPlayer_SetPerFriendPreferences_Response\x12P\n" +
	"\tAddFriend\x12 .steam.CPlayer_AddFriend_Request\x1a!.steam.CPlayer_AddFriend_Response\x12Y\n" +
	"\fRemoveFriend\x12#.steam.CPlayer_RemoveFriend_Request\x1a$.steam.CPlayer_RemoveFriend_Response\x12Y\n" +
	"\fIgnoreFriend\x12#.steam.CPlayer_IgnoreFriend_Request\x1a$.steam.CPlayer_IgnoreFriend_Response\x12z\n" +
	"\x17GetCommunityPreferences\x12..steam.CPlayer_GetCommunityPreferences_Request\x1a/.steam.CPlayer_GetCommunityPreferences_Response\x12z\n" +
	"\x17SetCommunityPreferences\x12..steam.CPlayer_SetCommunityPreferences_Request\x1a/.steam.CPlayer_SetCommunityPreferences_Response\x12k\n" +
	"\x12GetTextFilterWords\x12).steam.CPlayer_GetTextFilterWords_Request\x1a*.steam.CPlayer_GetTextFilterWords_Response\x12\x89\x01\n" +
	"\x1cGetNewSteamAnnouncementState\x123.steam.CPlayer_GetNewSteamAnnouncementState_Request\x1a4.steam.CPlayer_GetNewSteamAnnouncementState_Response\x12\x92\x01\n" +
	"\x1fUpdateSteamAnnouncementLastRead\x126.steam.CPlayer_UpdateSteamAnnouncementLastRead_Request\x1a7.steam.CPlayer_UpdateSteamAnnouncementLastRead_Response\x12k\n" +
	"\x12GetPrivacySettings\x12).steam.CPlayer_GetPrivacySettings_Request\x1a*.steam.CPlayer_GetPrivacySettings_Response\x12k\n" +
	"\x12GetDurationControl\x12).steam.CPlayer_GetDurationControl_Request\x1a*.steam.CPlayer_GetDurationControl_Response\x12\x83\x01\n" +
	"\x1aRecordDisconnectedPlaytime\x121.steam.CPlayer_RecordDisconnectedPlaytime_Request\x1a2.steam.CPlayer_RecordDisconnectedPlaytime_Response2\xf3\x06\n" +
	"\fPlayerClient\x12W\n" +
	"\x15NotifyLastPlayedTimes\x12+.steam.CPlayer_LastPlayedTimes_Notification\x1a\x11.steam.NoResponse\x12c\n" +
	"\x1bNotifyFriendNicknameChanged\x121.steam.CPlayer_FriendNicknameChanged_Notification\x1a\x11.steam.NoResponse\x12{\n" +
	"'NotifyFriendEquippedProfileItemsChanged\x12=.steam.CPlayer_FriendEquippedProfileItemsChanged_Notification\x1a\x11.steam.NoResponse\x12k\n" +
	"\x1fNotifyNewSteamAnnouncementState\x125.steam.CPlayer_NewSteamAnnouncementState_Notification\x1a\x11.steam.NoResponse\x12o\n" +
	"!NotifyCommunityPreferencesChanged\x127.steam.CPlayer_CommunityPreferencesChanged_Notification\x1a\x11.steam.NoResponse\x12e\n" +
	"\x1cNotifyTextFilterWordsChanged\x122.steam.CPlayer_TextFilterWordsChanged_Notification\x1a\x11.steam.NoResponse\x12o\n" +
	"!NotifyPerFriendPreferencesChanged\x127.steam.CPlayer_PerFriendPreferencesChanged_Notification\x1a\x11.steam.NoResponse\x12l\n" +
	"#NotifyPrivacyPrivacySettingsChanged\x122.steam.CPlayer_PrivacySettingsChanged_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x02B3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_player_steamclient_proto_goTypes = []any{
	(EProfileCustomizationStyle)(0),                                                              // 0: steam.EProfileCustomizationStyle
	(EAgreementType)(0),                                                                          // 1: steam.EAgreementType
	(ENotificationSetting)(0),                                                                    // 2: steam.ENotificationSetting
	(ETextFilterSetting)(0),                                                                      // 3: steam.ETextFilterSetting
	(*CPlayer_GetRecentPlaytimeSessionsForChild_Request)(nil),                                    // 4: steam.CPlayer_GetRecentPlaytimeSessionsForChild_Request
	(*CPlayer_GetRecentPlaytimeSessionsForChild_Response)(nil),                                   // 5: steam.CPlayer_GetRecentPlaytimeSessionsForChild_Response
	(*CPlayer_GetPlayerLinkDetails_Request)(nil),                                                 // 6: steam.CPlayer_GetPlayerLinkDetails_Request
	(*CPlayer_GetPlayerLinkDetails_Response)(nil),                                                // 7: steam.CPlayer_GetPlayerLinkDetails_Response
	(*CPlayer_GetMutualFriendsForIncomingInvites_Request)(nil),                                   // 8: steam.CPlayer_GetMutualFriendsForIncomingInvites_Request
	(*CPlayer_IncomingInviteMutualFriendList)(nil),                                               // 9: steam.CPlayer_IncomingInviteMutualFriendList
	(*CPlayer_GetMutualFriendsForIncomingInvites_Response)(nil),                                  // 10: steam.CPlayer_GetMutualFriendsForIncomingInvites_Response
	(*CPlayer_GetOwnedGames_Request)(nil),                                                        // 11: steam.CPlayer_GetOwnedGames_Request
	(*CPlayer_GetOwnedGames_Response)(nil),                                                       // 12: steam.CPlayer_GetOwnedGames_Response
	(*CPlayer_GetPlayNext_Request)(nil),                                                          // 13: steam.CPlayer_GetPlayNext_Request
	(*CPlayer_GetPlayNext_Response)(nil),                                                         // 14: steam.CPlayer_GetPlayNext_Response
	(*CPlayer_GetFriendsGameplayInfo_Request)(nil),                                               // 15: steam.CPlayer_GetFriendsGameplayInfo_Request
	(*CPlayer_GetFriendsGameplayInfo_Response)(nil),                                              // 16: steam.CPlayer_GetFriendsGameplayInfo_Response
	(*CPlayer_GetGameBadgeLevels_Request)(nil),                                                   // 17: steam.CPlayer_GetGameBadgeLevels_Request
	(*CPlayer_GetGameBadgeLevels_Response)(nil),                                                  // 18: steam.CPlayer_GetGameBadgeLevels_Response
	(*CPlayer_GetProfileBackground_Request)(nil),                                                 // 19: steam.CPlayer_GetProfileBackground_Request
	(*ProfileItem)(nil),                                                                          // 20: steam.ProfileItem
	(*CPlayer_GetProfileBackground_Response)(nil),                                                // 21: steam.CPlayer_GetProfileBackground_Response
	(*CPlayer_SetProfileBackground_Request)(nil),                                                 // 22: steam.CPlayer_SetProfileBackground_Request
	(*CPlayer_SetProfileBackground_Response)(nil),                                                // 23: steam.CPlayer_SetProfileBackground_Response
	(*CPlayer_GetMiniProfileBackground_Request)(nil),                                             // 24: steam.CPlayer_GetMiniProfileBackground_Request
	(*CPlayer_GetMiniProfileBackground_Response)(nil),                                            // 25: steam.CPlayer_GetMiniProfileBackground_Response
	(*CPlayer_SetMiniProfileBackground_Request)(nil),                                             // 26: steam.CPlayer_SetMiniProfileBackground_Request
	(*CPlayer_SetMiniProfileBackground_Response)(nil),                                            // 27: steam.CPlayer_SetMiniProfileBackground_Response
	(*CPlayer_GetAvatarFrame_Request)(nil),                                                       // 28: steam.CPlayer_GetAvatarFrame_Request
	(*CPlayer_GetAvatarFrame_Response)(nil),                                                      // 29: steam.CPlayer_GetAvatarFrame_Response
	(*CPlayer_SetAvatarFrame_Request)(nil),                                                       // 30: steam.CPlayer_SetAvatarFrame_Request
	(*CPlayer_SetAvatarFrame_Response)(nil),                                                      // 31: steam.CPlayer_SetAvatarFrame_Response
	(*CPlayer_GetAnimatedAvatar_Request)(nil),                                                    // 32: steam.CPlayer_GetAnimatedAvatar_Request
	(*CPlayer_GetAnimatedAvatar_Response)(nil),                                                   // 33: steam.CPlayer_GetAnimatedAvatar_Response
	(*CPlayer_SetAnimatedAvatar_Request)(nil),                                                    // 34: steam.CPlayer_SetAnimatedAvatar_Request
	(*CPlayer_SetAnimatedAvatar_Response)(nil),                                                   // 35: steam.CPlayer_SetAnimatedAvatar_Response
	(*CPlayer_GetSteamDeckKeyboardSkin_Request)(nil),                                             // 36: steam.CPlayer_GetSteamDeckKeyboardSkin_Request
	(*CPlayer_GetSteamDeckKeyboardSkin_Response)(nil),                                            // 37: steam.CPlayer_GetSteamDeckKeyboardSkin_Response
	(*CPlayer_SetSteamDeckKeyboardSkin_Request)(nil),                                             // 38: steam.CPlayer_SetSteamDeckKeyboardSkin_Request
	(*CPlayer_SetSteamDeckKeyboardSkin_Response)(nil),                                            // 39: steam.CPlayer_SetSteamDeckKeyboardSkin_Response
	(*CPlayer_GetProfileItemsOwned_Request)(nil),                                                 // 40: steam.CPlayer_GetProfileItemsOwned_Request
	(*CPlayer_GetProfileItemsOwned_Response)(nil),                                                // 41: steam.CPlayer_GetProfileItemsOwned_Response
	(*CPlayer_GetProfileItemsEquipped_Request)(nil),                                              // 42: steam.CPlayer_GetProfileItemsEquipped_Request
	(*CPlayer_GetProfileItemsEquipped_Response)(nil),                                             // 43: steam.CPlayer_GetProfileItemsEquipped_Response
	(*CPlayer_SetEquippedProfileItemFlags_Request)(nil),                                          // 44: steam.CPlayer_SetEquippedProfileItemFlags_Request
	(*CPlayer_SetEquippedProfileItemFlags_Response)(nil),                                         // 45: steam.CPlayer_SetEquippedProfileItemFlags_Response
	(*CPlayer_GetEmoticonList_Request)(nil),                                                      // 46: steam.CPlayer_GetEmoticonList_Request
	(*CPlayer_GetEmoticonList_Response)(nil),                                                     // 47: steam.CPlayer_GetEmoticonList_Response
	(*CPlayer_GetCommunityBadgeProgress_Request)(nil),                                            // 48: steam.CPlayer_GetCommunityBadgeProgress_Request
	(*CPlayer_GetCommunityBadgeProgress_Response)(nil),                                           // 49: steam.CPlayer_GetCommunityBadgeProgress_Response
	(*CPlayer_GetTopAchievementsForGames_Request)(nil),                                           // 50: steam.CPlayer_GetTopAchievementsForGames_Request
	(*CPlayer_GetTopAchievementsForGames_Response)(nil),                                          // 51: steam.CPlayer_GetTopAchievementsForGames_Response
	(*CPlayer_GetAchievementsProgress_Request)(nil),                                              // 52: steam.CPlayer_GetAchievementsProgress_Request
	(*CPlayer_GetAchievementsProgress_Response)(nil),                                             // 53: steam.CPlayer_GetAchievementsProgress_Response
	(*CPlayer_GetGameAchievements_Request)(nil),                                                  // 54: steam.CPlayer_GetGameAchievements_Request
	(*CPlayer_GetGameAchievements_Response)(nil),                                                 // 55: steam.CPlayer_GetGameAchievements_Response
	(*CPlayer_GetUserStats_Request)(nil),                                                         // 56: steam.CPlayer_GetUserStats_Request
	(*CPlayer_GetUserStats_Response)(nil),                                                        // 57: steam.CPlayer_GetUserStats_Response
	(*CPlayer_GetFavoriteBadge_Request)(nil),                                                     // 58: steam.CPlayer_GetFavoriteBadge_Request
	(*CPlayer_GetFavoriteBadge_Response)(nil),                                                    // 59: steam.CPlayer_GetFavoriteBadge_Response
	(*CPlayer_SetFavoriteBadge_Request)(nil),                                                     // 60: steam.CPlayer_SetFavoriteBadge_Request
	(*CPlayer_SetFavoriteBadge_Response)(nil),                                                    // 61: steam.CPlayer_SetFavoriteBadge_Response
	(*CPlayer_GetProfileCustomization_Request)(nil),                                              // 62: steam.CPlayer_GetProfileCustomization_Request
	(*ProfileCustomizationSlot)(nil),                                                             // 63: steam.ProfileCustomizationSlot
	(*ProfileCustomization)(nil),                                                                 // 64: steam.ProfileCustomization
	(*ProfileTheme)(nil),                                                                         // 65: steam.ProfileTheme
	(*ProfilePreferences)(nil),                                                                   // 66: steam.ProfilePreferences
	(*CPlayer_GetProfileCustomization_Response)(nil),                                             // 67: steam.CPlayer_GetProfileCustomization_Response
	(*CPlayer_GetPurchasedProfileCustomizations_Request)(nil),                                    // 68: steam.CPlayer_GetPurchasedProfileCustomizations_Request
	(*CPlayer_GetPurchasedProfileCustomizations_Response)(nil),                                   // 69: steam.CPlayer_GetPurchasedProfileCustomizations_Response
	(*CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Request)(nil),                         // 70: steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Request
	(*CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response)(nil),                        // 71: steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response
	(*CPlayer_GetProfileThemesAvailable_Request)(nil),                                            // 72: steam.CPlayer_GetProfileThemesAvailable_Request
	(*CPlayer_GetProfileThemesAvailable_Response)(nil),                                           // 73: steam.CPlayer_GetProfileThemesAvailable_Response
	(*CPlayer_SetProfileTheme_Request)(nil),                                                      // 74: steam.CPlayer_SetProfileTheme_Request
	(*CPlayer_SetProfileTheme_Response)(nil),                                                     // 75: steam.CPlayer_SetProfileTheme_Response
	(*CPlayer_SetProfilePreferences_Request)(nil),                                                // 76: steam.CPlayer_SetProfilePreferences_Request
	(*CPlayer_SetProfilePreferences_Response)(nil),                                               // 77: steam.CPlayer_SetProfilePreferences_Response
	(*CPlayer_PostStatusToFriends_Request)(nil),                                                  // 78: steam.CPlayer_PostStatusToFriends_Request
	(*CPlayer_PostStatusToFriends_Response)(nil),                                                 // 79: steam.CPlayer_PostStatusToFriends_Response
	(*CPlayer_GetPostedStatus_Request)(nil),                                                      // 80: steam.CPlayer_GetPostedStatus_Request
	(*CPlayer_GetPostedStatus_Response)(nil),                                                     // 81: steam.CPlayer_GetPostedStatus_Response
	(*CPlayer_DeletePostedStatus_Request)(nil),                                                   // 82: steam.CPlayer_DeletePostedStatus_Request
	(*CPlayer_DeletePostedStatus_Response)(nil),                                                  // 83: steam.CPlayer_DeletePostedStatus_Response
	(*CPlayer_GetLastPlayedTimes_Request)(nil),                                                   // 84: steam.CPlayer_GetLastPlayedTimes_Request
	(*CPlayer_GetLastPlayedTimes_Response)(nil),                                                  // 85: steam.CPlayer_GetLastPlayedTimes_Response
	(*CPlayer_GetTimeSSAAccepted_Request)(nil),                                                   // 86: steam.CPlayer_GetTimeSSAAccepted_Request
	(*CPlayer_GetTimeSSAAccepted_Response)(nil),                                                  // 87: steam.CPlayer_GetTimeSSAAccepted_Response
	(*CPlayer_AcceptSSA_Request)(nil),                                                            // 88: steam.CPlayer_AcceptSSA_Request
	(*CPlayer_AcceptSSA_Response)(nil),                                                           // 89: steam.CPlayer_AcceptSSA_Response
	(*CPlayer_GetNicknameList_Request)(nil),                                                      // 90: steam.CPlayer_GetNicknameList_Request
	(*CPlayer_GetNicknameList_Response)(nil),                                                     // 91: steam.CPlayer_GetNicknameList_Response
	(*CPlayer_GetPerFriendPreferences_Request)(nil),                                              // 92: steam.CPlayer_GetPerFriendPreferences_Request
	(*PerFriendPreferences)(nil),                                                                 // 93: steam.PerFriendPreferences
	(*CPlayer_GetPerFriendPreferences_Response)(nil),                                             // 94: steam.CPlayer_GetPerFriendPreferences_Response
	(*CPlayer_SetPerFriendPreferences_Request)(nil),                                              // 95: steam.CPlayer_SetPerFriendPreferences_Request
	(*CPlayer_SetPerFriendPreferences_Response)(nil),                                             // 96: steam.CPlayer_SetPerFriendPreferences_Response
	(*CPlayer_AddFriend_Request)(nil),                                                            // 97: steam.CPlayer_AddFriend_Request
	(*CPlayer_AddFriend_Response)(nil),                                                           // 98: steam.CPlayer_AddFriend_Response
	(*CPlayer_RemoveFriend_Request)(nil),                                                         // 99: steam.CPlayer_RemoveFriend_Request
	(*CPlayer_RemoveFriend_Response)(nil),                                                        // 100: steam.CPlayer_RemoveFriend_Response
	(*CPlayer_IgnoreFriend_Request)(nil),                                                         // 101: steam.CPlayer_IgnoreFriend_Request
	(*CPlayer_IgnoreFriend_Response)(nil),                                                        // 102: steam.CPlayer_IgnoreFriend_Response
	(*CPlayer_GetCommunityPreferences_Request)(nil),                                              // 103: steam.CPlayer_GetCommunityPreferences_Request
	(*CPlayer_CommunityPreferences)(nil),                                                         // 104: steam.CPlayer_CommunityPreferences
	(*CPlayer_GetCommunityPreferences_Response)(nil),                                             // 105: steam.CPlayer_GetCommunityPreferences_Response
	(*CPlayer_SetCommunityPreferences_Request)(nil),                                              // 106: steam.CPlayer_SetCommunityPreferences_Request
	(*CPlayer_SetCommunityPreferences_Response)(nil),                                             // 107: steam.CPlayer_SetCommunityPreferences_Response
	(*CPlayer_GetTextFilterWords_Request)(nil),                                                   // 108: steam.CPlayer_GetTextFilterWords_Request
	(*CPlayer_TextFilterWords)(nil),                                                              // 109: steam.CPlayer_TextFilterWords
	(*CPlayer_GetTextFilterWords_Response)(nil),                                                  // 110: steam.CPlayer_GetTextFilterWords_Response
	(*CPlayer_GetNewSteamAnnouncementState_Request)(nil),                                         // 111: steam.CPlayer_GetNewSteamAnnouncementState_Request
	(*CPlayer_GetNewSteamAnnouncementState_Response)(nil),                                        // 112: steam.CPlayer_GetNewSteamAnnouncementState_Response
	(*CPlayer_UpdateSteamAnnouncementLastRead_Request)(nil),                                      // 113: steam.CPlayer_UpdateSteamAnnouncementLastRead_Request
	(*CPlayer_UpdateSteamAnnouncementLastRead_Response)(nil),                                     // 114: steam.CPlayer_UpdateSteamAnnouncementLastRead_Response
	(*CPlayer_GetPrivacySettings_Request)(nil),                                                   // 115: steam.CPlayer_GetPrivacySettings_Request
	(*CPrivacySettings)(nil),                                                                     // 116: steam.CPrivacySettings
	(*CPlayer_GetPrivacySettings_Response)(nil),                                                  // 117: steam.CPlayer_GetPrivacySettings_Response
	(*CPlayer_GetDurationControl_Request)(nil),                                                   // 118: steam.CPlayer_GetDurationControl_Request
	(*CPlayer_GetDurationControl_Response)(nil),                                                  // 119: steam.CPlayer_GetDurationControl_Response
	(*CPlayer_RecordDisconnectedPlaytime_Request)(nil),                                           // 120: steam.CPlayer_RecordDisconnectedPlaytime_Request
	(*CPlayer_RecordDisconnectedPlaytime_Response)(nil),                                          // 121: steam.CPlayer_RecordDisconnectedPlaytime_Response
	(*CPlayer_LastPlayedTimes_Notification)(nil),                                                 // 122: steam.CPlayer_LastPlayedTimes_Notification
	(*CPlayer_FriendNicknameChanged_Notification)(nil),                                           // 123: steam.CPlayer_FriendNicknameChanged_Notification
	(*CPlayer_FriendEquippedProfileItemsChanged_Notification)(nil),                               // 124: steam.CPlayer_FriendEquippedProfileItemsChanged_Notification
	(*CPlayer_NewSteamAnnouncementState_Notification)(nil),                                       // 125: steam.CPlayer_NewSteamAnnouncementState_Notification
	(*CPlayer_CommunityPreferencesChanged_Notification)(nil),                                     // 126: steam.CPlayer_CommunityPreferencesChanged_Notification
	(*CPlayer_TextFilterWordsChanged_Notification)(nil),                                          // 127: steam.CPlayer_TextFilterWordsChanged_Notification
	(*CPlayer_PerFriendPreferencesChanged_Notification)(nil),                                     // 128: steam.CPlayer_PerFriendPreferencesChanged_Notification
	(*CPlayer_PrivacySettingsChanged_Notification)(nil),                                          // 129: steam.CPlayer_PrivacySettingsChanged_Notification
	(*CPlayer_GetRecentPlaytimeSessionsForChild_Response_PlaytimeSession)(nil),                   // 130: steam.CPlayer_GetRecentPlaytimeSessionsForChild_Response.PlaytimeSession
	(*CPlayer_GetPlayerLinkDetails_Response_PlayerLinkDetails)(nil),                              // 131: steam.CPlayer_GetPlayerLinkDetails_Response.PlayerLinkDetails
	(*CPlayer_GetPlayerLinkDetails_Response_PlayerLinkDetails_AccountPublicData)(nil),            // 132: steam.CPlayer_GetPlayerLinkDetails_Response.PlayerLinkDetails.AccountPublicData
	(*CPlayer_GetPlayerLinkDetails_Response_PlayerLinkDetails_AccountPrivateData)(nil),           // 133: steam.CPlayer_GetPlayerLinkDetails_Response.PlayerLinkDetails.AccountPrivateData
	(*CPlayer_GetOwnedGames_Response_Game)(nil),                                                  // 134: steam.CPlayer_GetOwnedGames_Response.Game
	(*CPlayer_GetFriendsGameplayInfo_Response_FriendsGameplayInfo)(nil),                          // 135: steam.CPlayer_GetFriendsGameplayInfo_Response.FriendsGameplayInfo
	(*CPlayer_GetFriendsGameplayInfo_Response_OwnGameplayInfo)(nil),                              // 136: steam.CPlayer_GetFriendsGameplayInfo_Response.OwnGameplayInfo
	(*CPlayer_GetGameBadgeLevels_Response_Badge)(nil),                                            // 137: steam.CPlayer_GetGameBadgeLevels_Response.Badge
	(*ProfileItem_ProfileColor)(nil),                                                             // 138: steam.ProfileItem.ProfileColor
	(*CPlayer_GetEmoticonList_Response_Emoticon)(nil),                                            // 139: steam.CPlayer_GetEmoticonList_Response.Emoticon
	(*CPlayer_GetCommunityBadgeProgress_Response_Quest)(nil),                                     // 140: steam.CPlayer_GetCommunityBadgeProgress_Response.Quest
	(*CPlayer_GetTopAchievementsForGames_Response_Achievement)(nil),                              // 141: steam.CPlayer_GetTopAchievementsForGames_Response.Achievement
	(*CPlayer_GetTopAchievementsForGames_Response_Game)(nil),                                     // 142: steam.CPlayer_GetTopAchievementsForGames_Response.Game
	(*CPlayer_GetAchievementsProgress_Response_AchievementProgress)(nil),                         // 143: steam.CPlayer_GetAchievementsProgress_Response.AchievementProgress
	(*CPlayer_GetGameAchievements_Response_Achievement)(nil),                                     // 144: steam.CPlayer_GetGameAchievements_Response.Achievement
	(*CPlayer_GetUserStats_Response_Unlock_Time)(nil),                                            // 145: steam.CPlayer_GetUserStats_Response.Unlock_Time
	(*CPlayer_GetUserStats_Response_Stats)(nil),                                                  // 146: steam.CPlayer_GetUserStats_Response.Stats
	(*CPlayer_GetProfileCustomization_Response_PurchasedCustomization)(nil),                      // 147: steam.CPlayer_GetProfileCustomization_Response.PurchasedCustomization
	(*CPlayer_GetPurchasedProfileCustomizations_Response_PurchasedCustomization)(nil),            // 148: steam.CPlayer_GetPurchasedProfileCustomizations_Response.PurchasedCustomization
	(*CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response_PurchasedCustomization)(nil), // 149: steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response.PurchasedCustomization
	(*CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response_UpgradedCustomization)(nil),  // 150: steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response.UpgradedCustomization
	(*CPlayer_GetLastPlayedTimes_Response_Game)(nil),                                             // 151: steam.CPlayer_GetLastPlayedTimes_Response.Game
	(*CPlayer_GetNicknameList_Response_PlayerNickname)(nil),                                      // 152: steam.CPlayer_GetNicknameList_Response.PlayerNickname
	(*CPlayer_RecordDisconnectedPlaytime_Request_PlayHistory)(nil),                               // 153: steam.CPlayer_RecordDisconnectedPlaytime_Request.PlayHistory
	(ECommunityItemClass)(0),                                                                     // 154: steam.ECommunityItemClass
	(EBanContentCheckResult)(0),                                                                  // 155: steam.EBanContentCheckResult
	(EProfileCustomizationType)(0),                                                               // 156: steam.EProfileCustomizationType
	(*UserContentDescriptorPreferences)(nil),                                                     // 157: steam.UserContentDescriptorPreferences
	(ENewSteamAnnouncementState)(0),                                                              // 158: steam.ENewSteamAnnouncementState
	(*NoResponse)(nil),                                                                           // 159: steam.NoResponse
}
var file_steammessages_player_steamclient_proto_depIdxs = []int32{
	130, // 0: steam.CPlayer_GetRecentPlaytimeSessionsForChild_Response.sessions:type_name -> steam.CPlayer_GetRecentPlaytimeSessionsForChild_Response.PlaytimeSession
	131, // 1: steam.CPlayer_GetPlayerLinkDetails_Response.accounts:type_name -> steam.CPlayer_GetPlayerLinkDetails_Response.PlayerLinkDetails
	9,   // 2: steam.CPlayer_GetMutualFriendsForIncomingInvites_Response.incoming_invite_mutual_friends_lists:type_name -> steam.CPlayer_IncomingInviteMutualFriendList
	134, // 3: steam.CPlayer_GetOwnedGames_Response.games:type_name -> steam.CPlayer_GetOwnedGames_Response.Game
	136, // 4: steam.CPlayer_GetFriendsGameplayInfo_Response.your_info:type_name -> steam.CPlayer_GetFriendsGameplayInfo_Response.OwnGameplayInfo
	135, // 5: steam.CPlayer_GetFriendsGameplayInfo_Response.in_game:type_name -> steam.CPlayer_GetFriendsGameplayInfo_Response.FriendsGameplayInfo
	135, // 6: steam.CPlayer_GetFriendsGameplayInfo_Response.played_recently:type_name -> steam.CPlayer_GetFriendsGameplayInfo_Response.FriendsGameplayInfo
	135, // 7: steam.CPlayer_GetFriendsGameplayInfo_Response.played_ever:type_name -> steam.CPlayer_GetFriendsGameplayInfo_Response.FriendsGameplayInfo
	135, // 8: steam.CPlayer_GetFriendsGameplayInfo_Response.owns:type_name -> steam.CPlayer_GetFriendsGameplayInfo_Response.FriendsGameplayInfo
	135, // 9: steam.CPlayer_GetFriendsGameplayInfo_Response.in_wishlist:type_name -> steam.CPlayer_GetFriendsGameplayInfo_Response.FriendsGameplayInfo
	137, // 10: steam.CPlayer_GetGameBadgeLevels_Response.badges:type_name -> steam.CPlayer_GetGameBadgeLevels_Response.Badge
	138, // 11: steam.ProfileItem.profile_colors:type_name -> steam.ProfileItem.ProfileColor
	20,  // 12: steam.CPlayer_GetProfileBackground_Response.profile_background:type_name -> steam.ProfileItem
	20,  // 13: steam.CPlayer_GetMiniProfileBackground_Response.profile_background:type_name -> steam.ProfileItem
	20,  // 14: steam.CPlayer_GetAvatarFrame_Response.avatar_frame:type_name -> steam.ProfileItem
	20,  // 15: steam.CPlayer_GetAnimatedAvatar_Response.avatar:type_name -> steam.ProfileItem
	20,  // 16: steam.CPlayer_GetSteamDeckKeyboardSkin_Response.steam_deck_keyboard_skin:type_name -> steam.ProfileItem
	154, // 17: steam.CPlayer_GetProfileItemsOwned_Request.filters:type_name -> steam.ECommunityItemClass
	20,  // 18: steam.CPlayer_GetProfileItemsOwned_Response.profile_backgrounds:type_name -> steam.ProfileItem
	20,  // 19: steam.CPlayer_GetProfileItemsOwned_Response.mini_profile_backgrounds:type_name -> steam.ProfileItem
	20,  // 20: steam.CPlayer_GetProfileItemsOwned_Response.avatar_frames:type_name -> steam.ProfileItem
	20,  // 21: steam.CPlayer_GetProfileItemsOwned_Response.animated_avatars:type_name -> steam.ProfileItem
	20,  // 22: steam.CPlayer_GetProfileItemsOwned_Response.profile_modifiers:type_name -> steam.ProfileItem
	20,  // 23: steam.CPlayer_GetProfileItemsOwned_Response.steam_deck_keyboard_skins:type_name -> steam.ProfileItem
	20,  // 24: steam.CPlayer_GetProfileItemsOwned_Response.steam_deck_startup_movies:type_name -> steam.ProfileItem
	20,  // 25: steam.CPlayer_GetProfileItemsEquipped_Response.profile_background:type_name -> steam.ProfileItem
	20,  // 26: steam.CPlayer_GetProfileItemsEquipped_Response.mini_profile_background:type_name -> steam.ProfileItem
	20,  // 27: steam.CPlayer_GetProfileItemsEquipped_Response.avatar_frame:type_name -> steam.ProfileItem
	20,  // 28: steam.CPlayer_GetProfileItemsEquipped_Response.animated_avatar:type_name -> steam.ProfileItem
	20,  // 29: steam.CPlayer_GetProfileItemsEquipped_Response.profile_modifier:type_name -> steam.ProfileItem
	20,  // 30: steam.CPlayer_GetProfileItemsEquipped_Response.steam_deck_keyboard_skin:type_name -> steam.ProfileItem
	139, // 31: steam.CPlayer_GetEmoticonList_Response.emoticons:type_name -> steam.CPlayer_GetEmoticonList_Response.Emoticon
	140, // 32: steam.CPlayer_GetCommunityBadgeProgress_Response.quests:type_name -> steam.CPlayer_GetCommunityBadgeProgress_Response.Quest
	142, // 33: steam.CPlayer_GetTopAchievementsForGames_Response.games:type_name -> steam.CPlayer_GetTopAchievementsForGames_Response.Game
	143, // 34: steam.CPlayer_GetAchievementsProgress_Response.achievement_progress:type_name -> steam.CPlayer_GetAchievementsProgress_Response.AchievementProgress
	144, // 35: steam.CPlayer_GetGameAchievements_Response.achievements:type_name -> steam.CPlayer_GetGameAchievements_Response.Achievement
	146, // 36: steam.CPlayer_GetUserStats_Response.stats:type_name -> steam.CPlayer_GetUserStats_Response.Stats
	155, // 37: steam.ProfileCustomizationSlot.ban_check_result:type_name -> steam.EBanContentCheckResult
	156, // 38: steam.ProfileCustomization.customization_type:type_name -> steam.EProfileCustomizationType
	63,  // 39: steam.ProfileCustomization.slots:type_name -> steam.ProfileCustomizationSlot
	0,   // 40: steam.ProfileCustomization.customization_style:type_name -> steam.EProfileCustomizationStyle
	64,  // 41: steam.CPlayer_GetProfileCustomization_Response.customizations:type_name -> steam.ProfileCustomization
	65,  // 42: steam.CPlayer_GetProfileCustomization_Response.profile_theme:type_name -> steam.ProfileTheme
	147, // 43: steam.CPlayer_GetProfileCustomization_Response.purchased_customizations:type_name -> steam.CPlayer_GetProfileCustomization_Response.PurchasedCustomization
	66,  // 44: steam.CPlayer_GetProfileCustomization_Response.profile_preferences:type_name -> steam.ProfilePreferences
	148, // 45: steam.CPlayer_GetPurchasedProfileCustomizations_Response.purchased_customizations:type_name -> steam.CPlayer_GetPurchasedProfileCustomizations_Response.PurchasedCustomization
	149, // 46: steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response.purchased_customizations:type_name -> steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response.PurchasedCustomization
	150, // 47: steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response.upgraded_customizations:type_name -> steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response.UpgradedCustomization
	65,  // 48: steam.CPlayer_GetProfileThemesAvailable_Response.profile_themes:type_name -> steam.ProfileTheme
	66,  // 49: steam.CPlayer_SetProfilePreferences_Request.profile_preferences:type_name -> steam.ProfilePreferences
	151, // 50: steam.CPlayer_GetLastPlayedTimes_Response.games:type_name -> steam.CPlayer_GetLastPlayedTimes_Response.Game
	1,   // 51: steam.CPlayer_AcceptSSA_Request.agreement_type:type_name -> steam.EAgreementType
	152, // 52: steam.CPlayer_GetNicknameList_Response.nicknames:type_name -> steam.CPlayer_GetNicknameList_Response.PlayerNickname
	2,   // 53: steam.PerFriendPreferences.notifications_showingame:type_name -> steam.ENotificationSetting
	2,   // 54: steam.PerFriendPreferences.notifications_showonline:type_name -> steam.ENotificationSetting
	2,   // 55: steam.PerFriendPreferences.notifications_showmessages:type_name -> steam.ENotificationSetting
	2,   // 56: steam.PerFriendPreferences.sounds_showingame:type_name -> steam.ENotificationSetting
	2,   // 57: steam.PerFriendPreferences.sounds_showonline:type_name -> steam.ENotificationSetting
	2,   // 58: steam.PerFriendPreferences.sounds_showmessages:type_name -> steam.ENotificationSetting
	2,   // 59: steam.PerFriendPreferences.notifications_sendmobile:type_name -> steam.ENotificationSetting
	93,  // 60: steam.CPlayer_GetPerFriendPreferences_Response.preferences:type_name -> steam.PerFriendPreferences
	93,  // 61: steam.CPlayer_SetPerFriendPreferences_Request.preferences:type_name -> steam.PerFriendPreferences
	3,   // 62: steam.CPlayer_CommunityPreferences.text_filter_setting:type_name -> steam.ETextFilterSetting
	104, // 63: steam.CPlayer_GetCommunityPreferences_Response.preferences:type_name -> steam.CPlayer_CommunityPreferences
	157, // 64: steam.CPlayer_GetCommunityPreferences_Response.content_descriptor_preferences:type_name -> steam.UserContentDescriptorPreferences
	104, // 65: steam.CPlayer_SetCommunityPreferences_Request.preferences:type_name -> steam.CPlayer_CommunityPreferences
	109, // 66: steam.CPlayer_GetTextFilterWords_Response.words:type_name -> steam.CPlayer_TextFilterWords
	158, // 67: steam.CPlayer_GetNewSteamAnnouncementState_Response.state:type_name -> steam.ENewSteamAnnouncementState
	116, // 68: steam.CPlayer_GetPrivacySettings_Response.privacy_settings:type_name -> steam.CPrivacySettings
	153, // 69: steam.CPlayer_RecordDisconnectedPlaytime_Request.play_sessions:type_name -> steam.CPlayer_RecordDisconnectedPlaytime_Request.PlayHistory
	151, // 70: steam.CPlayer_LastPlayedTimes_Notification.games:type_name -> steam.CPlayer_GetLastPlayedTimes_Response.Game
	158, // 71: steam.CPlayer_NewSteamAnnouncementState_Notification.state:type_name -> steam.ENewSteamAnnouncementState
	104, // 72: steam.CPlayer_CommunityPreferencesChanged_Notification.preferences:type_name -> steam.CPlayer_CommunityPreferences
	157, // 73: steam.CPlayer_CommunityPreferencesChanged_Notification.content_descriptor_preferences:type_name -> steam.UserContentDescriptorPreferences
	109, // 74: steam.CPlayer_TextFilterWordsChanged_Notification.words:type_name -> steam.CPlayer_TextFilterWords
	93,  // 75: steam.CPlayer_PerFriendPreferencesChanged_Notification.preferences:type_name -> steam.PerFriendPreferences
	116, // 76: steam.CPlayer_PrivacySettingsChanged_Notification.privacy_settings:type_name -> steam.CPrivacySettings
	132, // 77: steam.CPlayer_GetPlayerLinkDetails_Response.PlayerLinkDetails.public_data:type_name -> steam.CPlayer_GetPlayerLinkDetails_Response.PlayerLinkDetails.AccountPublicData
	133, // 78: steam.CPlayer_GetPlayerLinkDetails_Response.PlayerLinkDetails.private_data:type_name -> steam.CPlayer_GetPlayerLinkDetails_Response.PlayerLinkDetails.AccountPrivateData
	141, // 79: steam.CPlayer_GetTopAchievementsForGames_Response.Game.achievements:type_name -> steam.CPlayer_GetTopAchievementsForGames_Response.Achievement
	145, // 80: steam.CPlayer_GetUserStats_Response.Stats.unlock_times:type_name -> steam.CPlayer_GetUserStats_Response.Unlock_Time
	156, // 81: steam.CPlayer_GetProfileCustomization_Response.PurchasedCustomization.customization_type:type_name -> steam.EProfileCustomizationType
	156, // 82: steam.CPlayer_GetPurchasedProfileCustomizations_Response.PurchasedCustomization.customization_type:type_name -> steam.EProfileCustomizationType
	156, // 83: steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response.PurchasedCustomization.customization_type:type_name -> steam.EProfileCustomizationType
	156, // 84: steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response.UpgradedCustomization.customization_type:type_name -> steam.EProfileCustomizationType
	4,   // 85: steam.Player.GetRecentPlaytimeSessionsForChild:input_type -> steam.CPlayer_GetRecentPlaytimeSessionsForChild_Request
	6,   // 86: steam.Player.GetPlayerLinkDetails:input_type -> steam.CPlayer_GetPlayerLinkDetails_Request
	8,   // 87: steam.Player.GetMutualFriendsForIncomingInvites:input_type -> steam.CPlayer_GetMutualFriendsForIncomingInvites_Request
	11,  // 88: steam.Player.GetOwnedGames:input_type -> steam.CPlayer_GetOwnedGames_Request
	13,  // 89: steam.Player.GetPlayNext:input_type -> steam.CPlayer_GetPlayNext_Request
	15,  // 90: steam.Player.GetFriendsGameplayInfo:input_type -> steam.CPlayer_GetFriendsGameplayInfo_Request
	17,  // 91: steam.Player.GetGameBadgeLevels:input_type -> steam.CPlayer_GetGameBadgeLevels_Request
	19,  // 92: steam.Player.GetProfileBackground:input_type -> steam.CPlayer_GetProfileBackground_Request
	22,  // 93: steam.Player.SetProfileBackground:input_type -> steam.CPlayer_SetProfileBackground_Request
	24,  // 94: steam.Player.GetMiniProfileBackground:input_type -> steam.CPlayer_GetMiniProfileBackground_Request
	26,  // 95: steam.Player.SetMiniProfileBackground:input_type -> steam.CPlayer_SetMiniProfileBackground_Request
	28,  // 96: steam.Player.GetAvatarFrame:input_type -> steam.CPlayer_GetAvatarFrame_Request
	30,  // 97: steam.Player.SetAvatarFrame:input_type -> steam.CPlayer_SetAvatarFrame_Request
	32,  // 98: steam.Player.GetAnimatedAvatar:input_type -> steam.CPlayer_GetAnimatedAvatar_Request
	34,  // 99: steam.Player.SetAnimatedAvatar:input_type -> steam.CPlayer_SetAnimatedAvatar_Request
	36,  // 100: steam.Player.GetSteamDeckKeyboardSkin:input_type -> steam.CPlayer_GetSteamDeckKeyboardSkin_Request
	38,  // 101: steam.Player.SetSteamDeckKeyboardSkin:input_type -> steam.CPlayer_SetSteamDeckKeyboardSkin_Request
	40,  // 102: steam.Player.GetProfileItemsOwned:input_type -> steam.CPlayer_GetProfileItemsOwned_Request
	42,  // 103: steam.Player.GetProfileItemsEquipped:input_type -> steam.CPlayer_GetProfileItemsEquipped_Request
	44,  // 104: steam.Player.SetEquippedProfileItemFlags:input_type -> steam.CPlayer_SetEquippedProfileItemFlags_Request
	46,  // 105: steam.Player.GetEmoticonList:input_type -> steam.CPlayer_GetEmoticonList_Request
	48,  // 106: steam.Player.GetCommunityBadgeProgress:input_type -> steam.CPlayer_GetCommunityBadgeProgress_Request
	50,  // 107: steam.Player.GetTopAchievementsForGames:input_type -> steam.CPlayer_GetTopAchievementsForGames_Request
	52,  // 108: steam.Player.GetAchievementsProgress:input_type -> steam.CPlayer_GetAchievementsProgress_Request
	54,  // 109: steam.Player.GetGameAchievements:input_type -> steam.CPlayer_GetGameAchievements_Request
	56,  // 110: steam.Player.GetUserStats:input_type -> steam.CPlayer_GetUserStats_Request
	58,  // 111: steam.Player.GetFavoriteBadge:input_type -> steam.CPlayer_GetFavoriteBadge_Request
	60,  // 112: steam.Player.SetFavoriteBadge:input_type -> steam.CPlayer_SetFavoriteBadge_Request
	62,  // 113: steam.Player.GetProfileCustomization:input_type -> steam.CPlayer_GetProfileCustomization_Request
	68,  // 114: steam.Player.GetPurchasedProfileCustomizations:input_type -> steam.CPlayer_GetPurchasedProfileCustomizations_Request
	70,  // 115: steam.Player.GetPurchasedAndUpgradedProfileCustomizations:input_type -> steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Request
	72,  // 116: steam.Player.GetProfileThemesAvailable:input_type -> steam.CPlayer_GetProfileThemesAvailable_Request
	74,  // 117: steam.Player.SetProfileTheme:input_type -> steam.CPlayer_SetProfileTheme_Request
	76,  // 118: steam.Player.SetProfilePreferences:input_type -> steam.CPlayer_SetProfilePreferences_Request
	78,  // 119: steam.Player.PostStatusToFriends:input_type -> steam.CPlayer_PostStatusToFriends_Request
	80,  // 120: steam.Player.GetPostedStatus:input_type -> steam.CPlayer_GetPostedStatus_Request
	82,  // 121: steam.Player.DeletePostedStatus:input_type -> steam.CPlayer_DeletePostedStatus_Request
	84,  // 122: steam.Player.ClientGetLastPlayedTimes:input_type -> steam.CPlayer_GetLastPlayedTimes_Request
	86,  // 123: steam.Player.GetTimeSSAAccepted:input_type -> steam.CPlayer_GetTimeSSAAccepted_Request
	88,  // 124: steam.Player.AcceptSSA:input_type -> steam.CPlayer_AcceptSSA_Request
	90,  // 125: steam.Player.GetNicknameList:input_type -> steam.CPlayer_GetNicknameList_Request
	92,  // 126: steam.Player.GetPerFriendPreferences:input_type -> steam.CPlayer_GetPerFriendPreferences_Request
	95,  // 127: steam.Player.SetPerFriendPreferences:input_type -> steam.CPlayer_SetPerFriendPreferences_Request
	97,  // 128: steam.Player.AddFriend:input_type -> steam.CPlayer_AddFriend_Request
	99,  // 129: steam.Player.RemoveFriend:input_type -> steam.CPlayer_RemoveFriend_Request
	101, // 130: steam.Player.IgnoreFriend:input_type -> steam.CPlayer_IgnoreFriend_Request
	103, // 131: steam.Player.GetCommunityPreferences:input_type -> steam.CPlayer_GetCommunityPreferences_Request
	106, // 132: steam.Player.SetCommunityPreferences:input_type -> steam.CPlayer_SetCommunityPreferences_Request
	108, // 133: steam.Player.GetTextFilterWords:input_type -> steam.CPlayer_GetTextFilterWords_Request
	111, // 134: steam.Player.GetNewSteamAnnouncementState:input_type -> steam.CPlayer_GetNewSteamAnnouncementState_Request
	113, // 135: steam.Player.UpdateSteamAnnouncementLastRead:input_type -> steam.CPlayer_UpdateSteamAnnouncementLastRead_Request
	115, // 136: steam.Player.GetPrivacySettings:input_type -> steam.CPlayer_GetPrivacySettings_Request
	118, // 137: steam.Player.GetDurationControl:input_type -> steam.CPlayer_GetDurationControl_Request
	120, // 138: steam.Player.RecordDisconnectedPlaytime:input_type -> steam.CPlayer_RecordDisconnectedPlaytime_Request
	122, // 139: steam.PlayerClient.NotifyLastPlayedTimes:input_type -> steam.CPlayer_LastPlayedTimes_Notification
	123, // 140: steam.PlayerClient.NotifyFriendNicknameChanged:input_type -> steam.CPlayer_FriendNicknameChanged_Notification
	124, // 141: steam.PlayerClient.NotifyFriendEquippedProfileItemsChanged:input_type -> steam.CPlayer_FriendEquippedProfileItemsChanged_Notification
	125, // 142: steam.PlayerClient.NotifyNewSteamAnnouncementState:input_type -> steam.CPlayer_NewSteamAnnouncementState_Notification
	126, // 143: steam.PlayerClient.NotifyCommunityPreferencesChanged:input_type -> steam.CPlayer_CommunityPreferencesChanged_Notification
	127, // 144: steam.PlayerClient.NotifyTextFilterWordsChanged:input_type -> steam.CPlayer_TextFilterWordsChanged_Notification
	128, // 145: steam.PlayerClient.NotifyPerFriendPreferencesChanged:input_type -> steam.CPlayer_PerFriendPreferencesChanged_Notification
	129, // 146: steam.PlayerClient.NotifyPrivacyPrivacySettingsChanged:input_type -> steam.CPlayer_PrivacySettingsChanged_Notification
	5,   // 147: steam.Player.GetRecentPlaytimeSessionsForChild:output_type -> steam.CPlayer_GetRecentPlaytimeSessionsForChild_Response
	7,   // 148: steam.Player.GetPlayerLinkDetails:output_type -> steam.CPlayer_GetPlayerLinkDetails_Response
	10,  // 149: steam.Player.GetMutualFriendsForIncomingInvites:output_type -> steam.CPlayer_GetMutualFriendsForIncomingInvites_Response
	12,  // 150: steam.Player.GetOwnedGames:output_type -> steam.CPlayer_GetOwnedGames_Response
	14,  // 151: steam.Player.GetPlayNext:output_type -> steam.CPlayer_GetPlayNext_Response
	16,  // 152: steam.Player.GetFriendsGameplayInfo:output_type -> steam.CPlayer_GetFriendsGameplayInfo_Response
	18,  // 153: steam.Player.GetGameBadgeLevels:output_type -> steam.CPlayer_GetGameBadgeLevels_Response
	21,  // 154: steam.Player.GetProfileBackground:output_type -> steam.CPlayer_GetProfileBackground_Response
	23,  // 155: steam.Player.SetProfileBackground:output_type -> steam.CPlayer_SetProfileBackground_Response
	25,  // 156: steam.Player.GetMiniProfileBackground:output_type -> steam.CPlayer_GetMiniProfileBackground_Response
	27,  // 157: steam.Player.SetMiniProfileBackground:output_type -> steam.CPlayer_SetMiniProfileBackground_Response
	29,  // 158: steam.Player.GetAvatarFrame:output_type -> steam.CPlayer_GetAvatarFrame_Response
	31,  // 159: steam.Player.SetAvatarFrame:output_type -> steam.CPlayer_SetAvatarFrame_Response
	33,  // 160: steam.Player.GetAnimatedAvatar:output_type -> steam.CPlayer_GetAnimatedAvatar_Response
	35,  // 161: steam.Player.SetAnimatedAvatar:output_type -> steam.CPlayer_SetAnimatedAvatar_Response
	37,  // 162: steam.Player.GetSteamDeckKeyboardSkin:output_type -> steam.CPlayer_GetSteamDeckKeyboardSkin_Response
	39,  // 163: steam.Player.SetSteamDeckKeyboardSkin:output_type -> steam.CPlayer_SetSteamDeckKeyboardSkin_Response
	41,  // 164: steam.Player.GetProfileItemsOwned:output_type -> steam.CPlayer_GetProfileItemsOwned_Response
	43,  // 165: steam.Player.GetProfileItemsEquipped:output_type -> steam.CPlayer_GetProfileItemsEquipped_Response
	45,  // 166: steam.Player.SetEquippedProfileItemFlags:output_type -> steam.CPlayer_SetEquippedProfileItemFlags_Response
	47,  // 167: steam.Player.GetEmoticonList:output_type -> steam.CPlayer_GetEmoticonList_Response
	49,  // 168: steam.Player.GetCommunityBadgeProgress:output_type -> steam.CPlayer_GetCommunityBadgeProgress_Response
	51,  // 169: steam.Player.GetTopAchievementsForGames:output_type -> steam.CPlayer_GetTopAchievementsForGames_Response
	53,  // 170: steam.Player.GetAchievementsProgress:output_type -> steam.CPlayer_GetAchievementsProgress_Response
	55,  // 171: steam.Player.GetGameAchievements:output_type -> steam.CPlayer_GetGameAchievements_Response
	57,  // 172: steam.Player.GetUserStats:output_type -> steam.CPlayer_GetUserStats_Response
	59,  // 173: steam.Player.GetFavoriteBadge:output_type -> steam.CPlayer_GetFavoriteBadge_Response
	61,  // 174: steam.Player.SetFavoriteBadge:output_type -> steam.CPlayer_SetFavoriteBadge_Response
	67,  // 175: steam.Player.GetProfileCustomization:output_type -> steam.CPlayer_GetProfileCustomization_Response
	69,  // 176: steam.Player.GetPurchasedProfileCustomizations:output_type -> steam.CPlayer_GetPurchasedProfileCustomizations_Response
	71,  // 177: steam.Player.GetPurchasedAndUpgradedProfileCustomizations:output_type -> steam.CPlayer_GetPurchasedAndUpgradedProfileCustomizations_Response
	73,  // 178: steam.Player.GetProfileThemesAvailable:output_type -> steam.CPlayer_GetProfileThemesAvailable_Response
	75,  // 179: steam.Player.SetProfileTheme:output_type -> steam.CPlayer_SetProfileTheme_Response
	77,  // 180: steam.Player.SetProfilePreferences:output_type -> steam.CPlayer_SetProfilePreferences_Response
	79,  // 181: steam.Player.PostStatusToFriends:output_type -> steam.CPlayer_PostStatusToFriends_Response
	81,  // 182: steam.Player.GetPostedStatus:output_type -> steam.CPlayer_GetPostedStatus_Response
	83,  // 183: steam.Player.DeletePostedStatus:output_type -> steam.CPlayer_DeletePostedStatus_Response
	85,  // 184: steam.Player.ClientGetLastPlayedTimes:output_type -> steam.CPlayer_GetLastPlayedTimes_Response
	87,  // 185: steam.Player.GetTimeSSAAccepted:output_type -> steam.CPlayer_GetTimeSSAAccepted_Response
	89,  // 186: steam.Player.AcceptSSA:output_type -> steam.CPlayer_AcceptSSA_Response
	91,  // 187: steam.Player.GetNicknameList:output_type -> steam.CPlayer_GetNicknameList_Response
	94,  // 188: steam.Player.GetPerFriendPreferences:output_type -> steam.CPlayer_GetPerFriendPreferences_Response
	96,  // 189: steam.Player.SetPerFriendPreferences:output_type -> steam.CPlayer_SetPerFriendPreferences_Response
	98,  // 190: steam.Player.AddFriend:output_type -> steam.CPlayer_AddFriend_Response
	100, // 191: steam.Player.RemoveFriend:output_type -> steam.CPlayer_RemoveFriend_Response
	102, // 192: steam.Player.IgnoreFriend:output_type -> steam.CPlayer_IgnoreFriend_Response
	105, // 193: steam.Player.GetCommunityPreferences:output_type -> steam.CPlayer_GetCommunityPreferences_Response
	107, // 194: steam.Player.SetCommunityPreferences:output_type -> steam.CPlayer_SetCommunityPreferences_Response
	110, // 195: steam.Player.GetTextFilterWords:output_type -> steam.CPlayer_GetTextFilterWords_Response
	112, // 196: steam.Player.GetNewSteamAnnouncementState:output_type -> steam.CPlayer_GetNewSteamAnnouncementState_Response
	114, // 197: steam.Player.UpdateSteamAnnouncementLastRead:output_type -> steam.CPlayer_UpdateSteamAnnouncementLastRead_Response
	117, // 198: steam.Player.GetPrivacySettings:output_type -> steam.CPlayer_GetPrivacySettings_Response
	119, // 199: steam.Player.GetDurationControl:output_type -> steam.CPlayer_GetDurationControl_Response
	121, // 200: steam.Player.RecordDisconnectedPlaytime:output_type -> steam.CPlayer_RecordDisconnectedPlaytime_Response
	159, // 201: steam.PlayerClient.NotifyLastPlayedTimes:output_type -> steam.NoResponse
	159, // 202: steam.PlayerClient.NotifyFriendNicknameChanged:output_type -> steam.NoResponse
	159, // 203: steam.PlayerClient.NotifyFriendEquippedProfileItemsChanged:output_type -> steam.NoResponse
	159, // 204: steam.PlayerClient.NotifyNewSteamAnnouncementState:output_type -> steam.NoResponse
	159, // 205: steam.PlayerClient.NotifyCommunityPreferencesChanged:output_type -> steam.NoResponse
	159, // 206: steam.PlayerClient.NotifyTextFilterWordsChanged:output_type -> steam.NoResponse
	159, // 207: steam.PlayerClient.NotifyPerFriendPreferencesChanged:output_type -> steam.NoResponse
	159, // 208: steam.PlayerClient.NotifyPrivacyPrivacySettingsChanged:output_type -> steam.NoResponse
