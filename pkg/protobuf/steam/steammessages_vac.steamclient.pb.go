...
const file_steammessages_vac_steamclient_proto_rawDesc = "" +
	"\n" +
	"#steammessages_vac.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"\xe0\x02\n" +
	...
	"\x0eattempt_repair\x18\x01 \x01(\bR\rattemptRepair2\x85\x02\n" +
	"\x10FileVerification\x12s\n" +
	"\x0eSignatureCheck\x12/.steam.CFileVerification_SignatureCheck_Request\x1a0.steam.CFileVerification_SignatureCheck_Response\x12|\n" +
	"\x11SteamServiceCheck\x122.steam.CFileVerification_SteamServiceCheck_Request\x1a3.steam.CFileVerification_SteamServiceCheck_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_vac_steamclient_proto_goTypes = []any{
	(*CFileVerification_SignatureCheck_Request)(nil),     // 0: steam.CFileVerification_SignatureCheck_Request
	(*CFileVerification_SignatureCheck_Response)(nil),    // 1: steam.CFileVerification_SignatureCheck_Response
	(*CFileVerification_SteamServiceCheck_Request)(nil),  // 2: steam.CFileVerification_SteamServiceCheck_Request
	(*CFileVerification_SteamServiceCheck_Response)(nil), // 3: steam.CFileVerification_SteamServiceCheck_Response
}
var file_steammessages_vac_steamclient_proto_depIdxs = []int32{
	0, // 0: steam.FileVerification.SignatureCheck:input_type -> steam.CFileVerification_SignatureCheck_Request
	2, // 1: steam.FileVerification.SteamServiceCheck:input_type -> steam.CFileVerification_SteamServiceCheck_Request
	1, // 2: steam.FileVerification.SignatureCheck:output_type -> steam.CFileVerification_SignatureCheck_Response
	3, // 3: steam.FileVerification.SteamServiceCheck:output_type -> steam.CFileVerification_SteamServiceCheck_Response
