...
const file_steammessages_broadcast_steamclient_proto_rawDesc = "" +
	"\n" +
	")steammessages_broadcast.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"\xc1\x02\n" +
	...
	"\rupload_result\x18\x02 \x01(\rR\fuploadResult\"\xbc\x02\n" +
	...
	"clientCell\x12h\n" +
	"\x0ewatch_location\x18\x06 \x01(\x0e2\x1e.steam.EBroadcastWatchLocation:!k_EBroadcastWatchLocation_InvalidR\rwatchLocation\x12\x1b\n" +
	"\tis_webrtc\x18\a \x01(\bR\bisWebrtc\"\xa7\n" +
	"\n" +
	"\"CBroadcast_WatchBroadcast_Response\x12k\n" +
	"\bresponse\x18\x01 \x01(\x0e28.steam.CBroadcast_WatchBroadcast_Response.EWatchResponse:\x15k_EWatchResponseReadyR\bresponse\x12\x17\n" +
	...
	"\achat_id\x18\x01 \x01(\x06R\x06chatId\x12!\n" +
	"\fuser_steamid\x18\x02 \x03(\x06R\vuserSteamid\"\xe0\x01\n" +
	"-CBroadcast_GetBroadcastChatUserNames_Response\x12e\n" +
	"\rpersona_names\x18\x01 \x03(\v2@.steam.CBroadcast_GetBroadcastChatUserNames_Response.PersonaNameR\fpersonaNames\x1aH\n" +
	...
	"\x0frequired_app_id\x18\x05 \x01(\rR\rrequiredAppId\x12}\n" +
	"\x19broadcast_chat_permission\x18\x06 \x01(\x0e2\x1f.steam.EBroadcastChatPermission: k_EBroadcastChatPermissionPublicR\x17broadcastChatPermission\x12)\n" +
	...
	"\asteamid\x18\x02 \x01(\x06R\asteamid\"\xdd\x04\n" +
	...
	"\x0frequired_app_id\x18\x06 \x01(\rR\rrequiredAppId\x12}\n" +
	"\x19broadcast_chat_permission\x18\a \x01(\x0e2\x1f.steam.EBroadcastChatPermission: k_EBroadcastChatPermissionPublicR\x17broadcastChatPermission\x12)\n" +
	...
	"\tcandidate\x18\x03 \x01(\tR\tcandidate\"\x99\x01\n" +
	")CBroadcast_WebRTCAddHostCandidate_Request\x12*\n" +
	"\x11webrtc_session_id\x18\x01 \x01(\x06R\x0fwebrtcSessionId\x12@\n" +
	"\tcandidate\x18\x02 \x01(\v2\".steam.CBroadcast_WebRTC_CandidateR\tcandidate\",\n" +
	...
	"\tcandidate\x18\x03 \x01(\v2\".steam.CBroadcast_WebRTC_CandidateR\tcandidate\".\n" +
	...
	"\x14candidate_generation\x18\x03 \x01(\rR\x13candidateGeneration\"\xa4\x01\n" +
	"+CBroadcast_WebRTCGetHostCandidates_Response\x121\n" +
	"\x14candidate_generation\x18\x01 \x01(\rR\x13candidateGeneration\x12B\n" +
	"\n" +
	"candidates\x18\x02 \x03(\v2\".steam.CBroadcast_WebRTC_CandidateR\n" +
	"candidates\"\xc6\x01\n" +
	...
	"\n" +
	"session_id\x18\x05 \x01(\x04R\tsessionId\"\xfd\x06\n" +
	"+CBroadcast_GetBroadcastUploadStats_Response\x12a\n" +
	"\fupload_stats\x18\x01 \x03(\v2>.steam.CBroadcast_GetBroadcastUploadStats_Response.UploadStatsR\vuploadStats\x1a\xea\x05\n" +
	"\vUploadStats\x12#\n" +
	...
	"\asteamid\x18\x02 \x01(\x06R\asteamid\"\x8e\x03\n" +
	"+CBroadcast_GetBroadcastViewerStats_Response\x12a\n" +
	"\fviewer_stats\x18\x01 \x03(\v2>.steam.CBroadcast_GetBroadcastViewerStats_Response.ViewerStatsR\vviewerStats\x12d\n" +
	"\rcountry_stats\x18\x02 \x03(\v2?.steam.CBroadcast_GetBroadcastViewerStats_Response.CountryStatsR\fcountryStats\x1aB\n" +
	...
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12n\n" +
	"\x05state\x18\x02 \x01(\x0e2@.steam.CBroadcast_BroadcastViewerState_Notification.EViewerState:\x16k_EViewerNeedsApprovalR\x05state\"T\n" +
	...
	"\x14broadcast_session_id\x18\x01 \x01(\x06R\x12broadcastSessionId\x12*\n" +
	"\x11webrtc_session_id\x18\x02 \x01(\x06R\x0fwebrtcSessionId\x12\x16\n" +
	"\x06answer\x18\x03 \x01(\tR\x06answer\"\xd2\x01\n" +
	"0CBroadcast_WebRTCAddViewerCandidate_Notification\x120\n" +
	"\x14broadcast_session_id\x18\x01 \x01(\x06R\x12broadcastSessionId\x12*\n" +
	"\x11webrtc_session_id\x18\x02 \x01(\x06R\x0fwebrtcSessionId\x12@\n" +
	"\tcandidate\x18\x03 \x01(\v2\".steam.CBroadcast_WebRTC_CandidateR\tcandidate*\xd5\x05\n" +
	...
	"!k_EBroadcastChatPermissionOwnsApp\x10\x012\xd5\x1e\n" +
	"\tBroadcast\x12z\n" +
	"\x15BeginBroadcastSession\x12/.steam.CBroadcast_BeginBroadcastSession_Request\x1a0.steam.CBroadcast_BeginBroadcastSession_Response\x12t\n" +
	"\x13EndBroadcastSession\x12-.steam.CBroadcast_EndBroadcastSession_Request\x1a..steam.CBroadcast_EndBroadcastSession_Response\x12w\n" +
	"\x14StartBroadcastUpload\x12..steam.CBroadcast_StartBroadcastUpload_Request\x1a/.steam.CBroadcast_StartBroadcastUpload_Response\x12h\n" +
	"\x19NotifyBroadcastUploadStop\x128.steam.CBroadcast_NotifyBroadcastUploadStop_Notification\x1a\x11.steam.NoResponse\x12e\n" +
	"\x0eWatchBroadcast\x12(.steam.CBroadcast_WatchBroadcast_Request\x1a).steam.CBroadcast_WatchBroadcast_Response\x12Z\n" +
	"\x12HeartbeatBroadcast\x121.steam.CBroadcast_HeartbeatBroadcast_Notification\x1a\x11.steam.NoResponse\x12`\n" +
	"\x15StopWatchingBroadcast\x124.steam.CBroadcast_StopWatchingBroadcast_Notification\x1a\x11.steam.NoResponse\x12q\n" +
	"\x12GetBroadcastStatus\x12,.steam.CBroadcast_GetBroadcastStatus_Request\x1a-.steam.CBroadcast_GetBroadcastStatus_Response\x12z\n" +
	"\x15GetBroadcastThumbnail\x12/.steam.CBroadcast_GetBroadcastThumbnail_Request\x1a0.steam.CBroadcast_GetBroadcastThumbnail_Response\x12n\n" +
	"\x11InviteToBroadcast\x12+.steam.CBroadcast_InviteToBroadcast_Request\x1a,.steam.CBroadcast_InviteToBroadcast_Response\x12\x89\x01\n" +
	"\x1aSendBroadcastStateToServer\x124.steam.CBroadcast_SendBroadcastStateToServer_Request\x1a5.steam.CBroadcast_SendBroadcastStateToServer_Response\x12t\n" +
	"\x1fNotifyBroadcastSessionHeartbeat\x12>.steam.CBroadcast_NotifyBroadcastSessionHeartbeat_Notification\x1a\x11.steam.NoResponse\x12w\n" +
	"\x14GetBroadcastChatInfo\x12..steam.CBroadcast_GetBroadcastChatInfo_Request\x1a/.steam.CBroadcast_GetBroadcastChatInfo_Response\x12h\n" +
	"\x0fPostChatMessage\x12).steam.CBroadcast_PostChatMessage_Request\x1a*.steam.CBroadcast_PostChatMessage_Response\x12}\n" +
	"\x16UpdateChatMessageFlair\x120.steam.CBroadcast_UpdateChatMessageFlair_Request\x1a1.steam.CBroadcast_UpdateChatMessageFlair_Response\x12z\n" +
	"\x15MuteBroadcastChatUser\x12/.steam.CBroadcast_MuteBroadcastChatUser_Request\x1a0.steam.CBroadcast_MuteBroadcastChatUser_Response\x12q\n" +
	"\x12RemoveUserChatText\x12,.steam.CBroadcast_RemoveUserChatText_Request\x1a-.steam.CBroadcast_RemoveUserChatText_Response\x12\x86\x01\n" +
	"\x19GetBroadcastChatUserNames\x123.steam.CBroadcast_GetBroadcastChatUserNames_Request\x1a4.steam.CBroadcast_GetBroadcastChatUserNames_Response\x12e\n" +
	"\x0eStartBuildClip\x12(.steam.CBroadcast_StartBuildClip_Request\x1a).steam.CBroadcast_StartBuildClip_Response\x12q\n" +
	"\x12GetBuildClipStatus\x12,.steam.CBroadcast_GetBuildClipStatus_Request\x1a-.steam.CBroadcast_GetBuildClipStatus_Response\x12e\n" +
	"\x0eSetClipDetails\x12(.steam.CBroadcast_SetClipDetails_Request\x1a).steam.CBroadcast_SetClipDetails_Response\x12e\n" +
	"\x0eGetClipDetails\x12(.steam.CBroadcast_GetClipDetails_Request\x1a).steam.CBroadcast_GetClipDetails_Response\x12\\\n" +
	"\vSetRTMPInfo\x12%.steam.CBroadcast_SetRTMPInfo_Request\x1a&.steam.CBroadcast_SetRTMPInfo_Response\x12\\\n" +
	"\vGetRTMPInfo\x12%.steam.CBroadcast_GetRTMPInfo_Request\x1a&.steam.CBroadcast_GetRTMPInfo_Response\x12d\n" +
	"\x1aNotifyWebRTCHaveTURNServer\x123.steam.CBroadcast_WebRTCHaveTURNServer_Notification\x1a\x11.steam.NoResponse\x12n\n" +
	"\x11WebRTCStartResult\x12+.steam.CBroadcast_WebRTCStartResult_Request\x1a,.steam.CBroadcast_WebRTCStartResult_Response\x12b\n" +
	"\rWebRTCStopped\x12'.steam.CBroadcast_WebRTCStopped_Request\x1a(.steam.CBroadcast_WebRTCStopped_Response\x12h\n" +
	"\x0fWebRTCSetAnswer\x12).steam.CBroadcast_WebRTCSetAnswer_Request\x1a*.steam.CBroadcast_WebRTCSetAnswer_Response\x12}\n" +
	"\x16WebRTCLookupTURNServer\x120.steam.CBroadcast_WebRTCLookupTURNServer_Request\x1a1.steam.CBroadcast_WebRTCLookupTURNServer_Response\x12}\n" +
	"\x16WebRTCAddHostCandidate\x120.steam.CBroadcast_WebRTCAddHostCandidate_Request\x1a1.steam.CBroadcast_WebRTCAddHostCandidate_Response\x12\x83\x01\n" +
	"\x18WebRTCAddViewerCandidate\x122.steam.CBroadcast_WebRTCAddViewerCandidate_Request\x1a3.steam.CBroadcast_WebRTCAddViewerCandidate_Response\x12\x80\x01\n" +
	"\x17WebRTCGetHostCandidates\x121.steam.CBroadcast_WebRTCGetHostCandidates_Request\x1a2.steam.CBroadcast_WebRTCGetHostCandidates_Response\x12\x80\x01\n" +
	"\x17GetBroadcastUploadStats\x121.steam.CBroadcast_GetBroadcastUploadStats_Request\x1a2.steam.CBroadcast_GetBroadcastUploadStats_Response\x12\x80\x01\n" +
	"\x17GetBroadcastViewerStats\x121.steam.CBroadcast_GetBroadcastViewerStats_Request\x1a2.steam.CBroadcast_GetBroadcastViewerStats_Response2\x9b\n" +
	"\n" +
	"\x0fBroadcastClient\x12d\n" +
	"\x1aNotifyBroadcastViewerState\x123.steam.CBroadcast_BroadcastViewerState_Notification\x1a\x11.steam.NoResponse\x12h\n" +
	"\x1cNotifyWaitingBroadcastViewer\x125.steam.CBroadcast_WaitingBroadcastViewer_Notification\x1a\x11.steam.NoResponse\x12h\n" +
	"\x1cNotifyBroadcastUploadStarted\x125.steam.CBroadcast_BroadcastUploadStarted_Notification\x1a\x11.steam.NoResponse\x12b\n" +
	"\x19NotifyStopBroadcastUpload\x122.steam.CBroadcast_StopBroadcastUpload_Notification\x1a\x11.steam.NoResponse\x12V\n" +
	"\x13NotifySessionClosed\x12,.steam.CBroadcast_SessionClosed_Notification\x1a\x11.steam.NoResponse\x12f\n" +
	"\x1bNotifyViewerBroadcastInvite\x124.steam.CBroadcast_ViewerBroadcastInvite_Notification\x1a\x11.steam.NoResponse\x12Z\n" +
	"\x15NotifyBroadcastStatus\x12..steam.CBroadcast_BroadcastStatus_Notification\x1a\x11.steam.NoResponse\x12d\n" +
	"\x1aNotifyBroadcastChannelLive\x123.steam.CBroadcast_BroadcastChannelLive_Notification\x1a\x11.steam.NoResponse\x12^\n" +
	"\x14SendThumbnailToRelay\x123.steam.CBroadcast_SendThumbnailToRelay_Notification\x1a\x11.steam.NoResponse\x12d\n" +
	"\x1aNotifyWebRTCNeedTURNServer\x123.steam.CBroadcast_WebRTCNeedTURNServer_Notification\x1a\x11.steam.NoResponse\x12R\n" +
	"\x11NotifyWebRTCStart\x12*.steam.CBroadcast_WebRTCStart_Notification\x1a\x11.steam.NoResponse\x12Z\n" +
	"\x15NotifyWebRTCSetAnswer\x12..steam.CBroadcast_WebRTCSetAnswer_Notification\x1a\x11.steam.NoResponse\x12l\n" +
	"\x1eNotifyWebRTCAddViewerCandidate\x127.steam.CBroadcast_WebRTCAddViewerCandidate_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x02B3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
