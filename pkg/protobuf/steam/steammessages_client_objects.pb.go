...
type SteamMessagesClientIClientForcedEnumDependencies struct {
	...
	A             *EBluetoothDeviceType        `protobuf:"varint,1,opt,name=a,enum=steam.EBluetoothDeviceType,def=0" json:"a,omitempty"`
	B             *EStorageBlockContentType    `protobuf:"varint,2,opt,name=b,enum=steam.EStorageBlockContentType,def=0" json:"b,omitempty"`
	C             *EStorageBlockFileSystemType `protobuf:"varint,3,opt,name=c,enum=steam.EStorageBlockFileSystemType,def=0" json:"c,omitempty"`
	D             *ESDCardFormatStage          `protobuf:"varint,4,opt,name=d,enum=steam.ESDCardFormatStage,def=0" json:"d,omitempty"`
...
type CCloud_PendingRemoteOperation struct {
	state           protoimpl.MessageState        `protogen:"open.v1"`
	Operation       *ECloudPendingRemoteOperation `protobuf:"varint,1,opt,name=operation,enum=steam.ECloudPendingRemoteOperation,def=0" json:"operation,omitempty"`
...
type CMsgSystemPerfLimits struct {
	...
	GpuPerformanceLevelsAvailable        []EGPUPerformanceLevel `protobuf:"varint,10,rep,name=gpu_performance_levels_available,json=gpuPerformanceLevelsAvailable,enum=steam.EGPUPerformanceLevel" json:"gpu_performance_levels_available,omitempty"`
	...
	SplitScalingFiltersAvailable         []ESplitScalingFilter  `protobuf:"varint,26,rep,name=split_scaling_filters_available,json=splitScalingFiltersAvailable,enum=steam.ESplitScalingFilter" json:"split_scaling_filters_available,omitempty"`
	SplitScalingScalersAvailable         []ESplitScalingScaler  `protobuf:"varint,27,rep,name=split_scaling_scalers_available,json=splitScalingScalersAvailable,enum=steam.ESplitScalingScaler" json:"split_scaling_scalers_available,omitempty"`
...
type CMsgSystemPerfSettingsGlobal struct {
	...
	GraphicsProfilingServiceState      *ESystemServiceState       `protobuf:"varint,3,opt,name=graphics_profiling_service_state,json=graphicsProfilingServiceState,enum=steam.ESystemServiceState,def=0" json:"graphics_profiling_service_state,omitempty"`
	PerfOverlayServiceState            *ESystemServiceState       `protobuf:"varint,4,opt,name=perf_overlay_service_state,json=perfOverlayServiceState,enum=steam.ESystemServiceState,def=0" json:"perf_overlay_service_state,omitempty"`
	PerfOverlayLevel                   *EGraphicsPerfOverlayLevel `protobuf:"varint,5,opt,name=perf_overlay_level,json=perfOverlayLevel,enum=steam.EGraphicsPerfOverlayLevel,def=0" json:"perf_overlay_level,omitempty"`
	...
	HdrOnSdrTonemapOperator            *EHDRToneMapOperator       `protobuf:"varint,12,opt,name=hdr_on_sdr_tonemap_operator,json=hdrOnSdrTonemapOperator,enum=steam.EHDRToneMapOperator,def=0" json:"hdr_on_sdr_tonemap_operator,omitempty"`
...
type CMsgSystemPerfSettingsPerApp struct {
	...
	CpuGovernor                    *ECPUGovernor          `protobuf:"varint,6,opt,name=cpu_governor,json=cpuGovernor,enum=steam.ECPUGovernor,def=0" json:"cpu_governor,omitempty"`
	...
	GpuPerformanceLevel            *EGPUPerformanceLevel  `protobuf:"varint,15,opt,name=gpu_performance_level,json=gpuPerformanceLevel,enum=steam.EGPUPerformanceLevel,def=0" json:"gpu_performance_level,omitempty"`
	...
	SplitScalingFilter             *ESplitScalingFilter   `protobuf:"varint,24,opt,name=split_scaling_filter,json=splitScalingFilter,enum=steam.ESplitScalingFilter,def=0" json:"split_scaling_filter,omitempty"`
	SplitScalingScaler             *ESplitScalingScaler   `protobuf:"varint,25,opt,name=split_scaling_scaler,json=splitScalingScaler,enum=steam.ESplitScalingScaler,def=0" json:"split_scaling_scaler,omitempty"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
type CMsgSystemPerfSettingsV1 struct {
	state                             protoimpl.MessageState     `protogen:"open.v1"`
	DiagnosticUpdateRate              *float32                   `protobuf:"fixed32,1,opt,name=diagnostic_update_rate,json=diagnosticUpdateRate" json:"diagnostic_update_rate,omitempty"`
	SystemTraceServiceState           *ESystemServiceState       `protobuf:"varint,2,opt,name=system_trace_service_state,json=systemTraceServiceState,enum=steam.ESystemServiceState,def=0" json:"system_trace_service_state,omitempty"`
	GraphicsProfilingServiceState     *ESystemServiceState       `protobuf:"varint,3,opt,name=graphics_profiling_service_state,json=graphicsProfilingServiceState,enum=steam.ESystemServiceState,def=0" json:"graphics_profiling_service_state,omitempty"`
	PerfOverlayServiceState           *ESystemServiceState       `protobuf:"varint,4,opt,name=perf_overlay_service_state,json=perfOverlayServiceState,enum=steam.ESystemServiceState,def=0" json:"perf_overlay_service_state,omitempty"`
	PerfOverlayLevel                  *EGraphicsPerfOverlayLevel `protobuf:"varint,5,opt,name=perf_overlay_level,json=perfOverlayLevel,enum=steam.EGraphicsPerfOverlayLevel,def=0" json:"perf_overlay_level,omitempty"`
	GpuPerformanceLevel               *EGPUPerformanceLevel      `protobuf:"varint,6,opt,name=gpu_performance_level,json=gpuPerformanceLevel,enum=steam.EGPUPerformanceLevel,def=0" json:"gpu_performance_level,omitempty"`
	...
	CpuGovernor                       *ECPUGovernor              `protobuf:"varint,12,opt,name=cpu_governor,json=cpuGovernor,enum=steam.ECPUGovernor,def=0" json:"cpu_governor,omitempty"`
...
type CMsgSystemDockUpdateState struct {
	state                    protoimpl.MessageState `protogen:"open.v1"`
	State                    *EUpdaterState         `protobuf:"varint,1,opt,name=state,enum=steam.EUpdaterState,def=0" json:"state,omitempty"`
...
type CMsgSystemAudioManagerNode struct {
	...
	Edirection    *ESystemAudioDirection        `protobuf:"varint,6,opt,name=edirection,enum=steam.ESystemAudioDirection,def=0" json:"edirection,omitempty"`
...
type CMsgSystemAudioManagerPort struct {
	...
	Etype         *ESystemAudioPortType         `protobuf:"varint,6,opt,name=etype,enum=steam.ESystemAudioPortType,def=0" json:"etype,omitempty"`
	Edirection    *ESystemAudioPortDirection    `protobuf:"varint,7,opt,name=edirection,enum=steam.ESystemAudioPortDirection,def=0" json:"edirection,omitempty"`
...
type CMsgSystemDisplayManagerState struct {
	...
	CompatibilityMode        *ESystemDisplayCompatibilityMode `protobuf:"varint,3,opt,name=compatibility_mode,json=compatibilityMode,enum=steam.ESystemDisplayCompatibilityMode,def=0" json:"compatibility_mode,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
type CMsgSystemManagerSettings struct {
	...
	FanControlMode                     *ESystemFanControlMode `protobuf:"varint,28,opt,name=fan_control_mode,json=fanControlMode,enum=steam.ESystemFanControlMode,def=0" json:"fan_control_mode,omitempty"`
	...
	DisplayColorgamutLabelset          *EColorGamutLabelSet   `protobuf:"varint,38,opt,name=display_colorgamut_labelset,json=displayColorgamutLabelset,enum=steam.EColorGamutLabelSet,def=0" json:"display_colorgamut_labelset,omitempty"`
...
type CMsgSelectOSBranchParams struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Branch        *EOSBranch             `protobuf:"varint,1,opt,name=branch,enum=steam.EOSBranch,def=0" json:"branch,omitempty"`
...
type CMsgSystemUpdateCheckResult struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	Type                 *EUpdaterType          `protobuf:"varint,1,opt,name=type,enum=steam.EUpdaterType,def=0" json:"type,omitempty"`
...
type CMsgSystemUpdateApplyParams struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ApplyTypes    []EUpdaterType         `protobuf:"varint,1,rep,name=apply_types,json=applyTypes,enum=steam.EUpdaterType" json:"apply_types,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgStorageDevicesData_Drive struct {
	...
	MediaType     *EStorageDriveMediaType `protobuf:"varint,7,opt,name=media_type,json=mediaType,enum=steam.EStorageDriveMediaType,def=0" json:"media_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgStorageDevicesData_BlockDevice struct {
	...
	ContentType    *EStorageBlockContentType    `protobuf:"varint,10,opt,name=content_type,json=contentType,enum=steam.EStorageBlockContentType,def=0" json:"content_type,omitempty"`
	FilesystemType *EStorageBlockFileSystemType `protobuf:"varint,11,opt,name=filesystem_type,json=filesystemType,enum=steam.EStorageBlockFileSystemType,def=0" json:"filesystem_type,omitempty"`
...
type CMsgBluetoothDevicesData_Device struct {
	...
	Etype                *EBluetoothDeviceType  `protobuf:"varint,3,opt,name=etype,enum=steam.EBluetoothDeviceType,def=0" json:"etype,omitempty"`
	Mac                  *string                `protobuf:"bytes,4,opt,name=mac" json:"mac,omitempty"`
...
type CMsgSystemAudioVolume_ChannelEntry struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Echannel      *ESystemAudioChannel   `protobuf:"varint,1,opt,name=echannel,enum=steam.ESystemAudioChannel,def=0" json:"echannel,omitempty"`
...
const file_steammessages_client_objects_proto_rawDesc = "" +
	"\n" +
	"\"steammessages_client_objects.proto\x12\x05steam\x1a\venums.proto\"\xef\x02\n" +
	"0SteamMessagesClientIClientForcedEnumDependencies\x12H\n" +
	"\x01a\x18\x01 \x01(\x0e2\x1b.steam.EBluetoothDeviceType:\x1dk_BluetoothDeviceType_InvalidR\x01a\x12Q\n" +
	"\x01b\x18\x02 \x01(\x0e2\x1f.steam.EStorageBlockContentType:\"k_EStorageBlockContentType_InvalidR\x01b\x12W\n" +
	"\x01c\x18\x03 \x01(\x0e2\".steam.EStorageBlockFileSystemType:%k_EStorageBlockFileSystemType_InvalidR\x01c\x12E\n" +
	"\x01d\x18\x04 \x01(\x0e2\x19.steam.ESDCardFormatStage:\x1ck_ESDCardFormatStage_InvalidR\x01d\"J\n" +
	"\x1bCMsgNetworkDeviceIP4Address\x12\x11\n" +
	"\x02ip\x18\x01 \x01(\x05:\x010R\x02ip\x12\x18\n" +
	"\anetmask\x18\x02 \x01(\x05R\anetmask\"\x8c\x02\n" +
	"\x1aCMsgNetworkDeviceIP4Config\x12@\n" +
	"\taddresses\x18\x01 \x03(\v2\".steam.CMsgNetworkDeviceIP4AddressR\taddresses\x12\x15\n" +
	...
	"\x02ip\x18\x01 \x01(\tR\x02ip\"\x8c\x02\n" +
	"\x1aCMsgNetworkDeviceIP6Config\x12@\n" +
	"\taddresses\x18\x01 \x03(\v2\".steam.CMsgNetworkDeviceIP6AddressR\taddresses\x12\x15\n" +
	...
	"\x10is_default_route\x18\x05 \x01(\bR\x0eisDefaultRoute\x12$\n" +
	"\n" +
	"is_enabled\x18\x06 \x01(\b:\x05falseR\tisEnabled\"\xb7\t\n" +
	"\x16CMsgNetworkDevicesData\x12>\n" +
	"\adevices\x18\x01 \x03(\v2$.steam.CMsgNetworkDevicesData.DeviceR\adevices\x12&\n" +
	"\x0fis_wifi_enabled\x18\x02 \x01(\bR\risWifiEnabled\x127\n" +
	"\x18is_wifi_scanning_enabled\x18\x03 \x01(\bR\x15isWifiScanningEnabled\x1a\xfb\a\n" +
	"\x06Device\x12\x11\n" +
	...
	"\aproduct\x18\x06 \x01(\tR\aproduct\x123\n" +
	"\x03ip4\x18\a \x01(\v2!.steam.CMsgNetworkDeviceIP4ConfigR\x03ip4\x123\n" +
	"\x03ip6\x18\b \x01(\v2!.steam.CMsgNetworkDeviceIP6ConfigR\x03ip6\x12@\n" +
	"\x05wired\x18\t \x01(\v2*.steam.CMsgNetworkDevicesData.Device.WiredR\x05wired\x12I\n" +
	"\bwireless\x18\n" +
	" \x01(\v2-.steam.CMsgNetworkDevicesData.Device.WirelessR\bwireless\x1a|\n" +
	"\x05Wired\x12/\n" +
	"\x10is_cable_present\x18\x01 \x01(\b:\x05falseR\x0eisCablePresent\x12\x1d\n" +
	"\n" +
	"speed_mbit\x18\x02 \x01(\rR\tspeedMbit\x12#\n" +
	"\rfriendly_name\x18\x03 \x01(\tR\ffriendlyName\x1a\xf6\x03\n" +
	"\bWireless\x12B\n" +
	"\x03aps\x18\x01 \x03(\v20.steam.CMsgNetworkDevicesData.Device.Wireless.APR\x03aps\x12/\n" +
	...
	"\bis_saved\x18\f \x01(\bR\aisSaved\"\xa5\x05\n" +
	"\x18CMsgNetworkDeviceConnect\x12\x1e\n" +
	"\tdevice_id\x18\x01 \x01(\r:\x010R\bdeviceId\x12M\n" +
	"\vcredentials\x18\x04 \x01(\v2+.steam.CMsgNetworkDeviceConnect.CredentialsR\vcredentials\x123\n" +
	"\x03ip4\x18\x05 \x01(\v2!.steam.CMsgNetworkDeviceIP4ConfigR\x03ip4\x123\n" +
	"\x03ip6\x18\x06 \x01(\v2!.steam.CMsgNetworkDeviceIP6ConfigR\x03ip6\x12D\n" +
	"\bwireless\x18\a \x01(\v2(.steam.CMsgNetworkDeviceConnect.WirelessR\bwireless\x12D\n" +
	"\bap_known\x18\x02 \x01(\v2'.steam.CMsgNetworkDeviceConnect.KnownAPH\x00R\aapKnown\x12G\n" +
	"\tap_custom\x18\x03 \x01(\v2(.steam.CMsgNetworkDeviceConnect.CustomAPH\x00R\bapCustom\x1a\x1e\n" +
	"\aKnownAP\x12\x13\n" +
	...
	"bandFilterB\t\n" +
	"\aap_info\"\xcf\x01\n" +
	"\x1bCMsgNetworkDeviceSetOptions\x12G\n" +
	"\bwireless\x18\x02 \x01(\v2+.steam.CMsgNetworkDeviceSetOptions.WirelessR\bwireless\x1ag\n" +
	"\bWireless\x12\x13\n" +
	"\x05ap_id\x18\x01 \x02(\rR\x04apId\x12%\n" +
	"\x0eis_autoconnect\x18\x02 \x01(\bR\risAutoconnect\x12\x1f\n" +
	"\vband_filter\x18\x03 \x01(\tR\n" +
	"bandFilter\"\xc9\b\n" +
	"\x16CMsgStorageDevicesData\x12;\n" +
	"\x06drives\x18\x01 \x03(\v2#.steam.CMsgStorageDevicesData.DriveR\x06drives\x12N\n" +
	"\rblock_devices\x18\x02 \x03(\v2).steam.CMsgStorageDevicesData.BlockDeviceR\fblockDevices\x120\n" +
	...
	"\x0fis_trim_running\x18\x05 \x01(\bR\risTrimRunning\x1a\x82\x02\n" +
	"\x05Drive\x12\x11\n" +
	"\x02id\x18\x01 \x01(\r:\x010R\x02id\x12\x14\n" +
	...
	"\n" +
	"media_type\x18\a \x01(\x0e2\x1d.steam.EStorageDriveMediaType: k_EStorageDriveMediaType_InvalidR\tmediaType\x1a\x96\x04\n" +
	...
	"isReadOnly\x12$\n" +
	"\x0eis_root_device\x18\t \x01(\bR\fisRootDevice\x12f\n" +
	"\fcontent_type\x18\n" +
	" \x01(\x0e2\x1f.steam.EStorageBlockContentType:\"k_EStorageBlockContentType_InvalidR\vcontentType\x12r\n" +
	"\x0ffilesystem_type\x18\v \x01(\x0e2\".steam.EStorageBlockFileSystemType:%k_EStorageBlockFileSystemType_InvalidR\x0efilesystemType\x12\x1d\n" +
	"\n" +
	"mount_path\x18\f \x01(\tR\tmountPath\"\xac\x02\n" +
	"\x1dCCloud_PendingRemoteOperation\x12e\n" +
	"\toperation\x18\x01 \x01(\x0e2#.steam.ECloudPendingRemoteOperation:\"k_ECloudPendingRemoteOperationNoneR\toperation\x12!\n" +
	...
	"deviceType\"h\n" +
	" CMsgCloudPendingRemoteOperations\x12D\n" +
	"\n" +
	"operations\x18\x01 \x03(\v2$.steam.CCloud_PendingRemoteOperationR\n" +
	"operations\"\xc9\x06\n" +
	"\x18CMsgBluetoothDevicesData\x12C\n" +
	"\badapters\x18\x01 \x03(\v2'.steam.CMsgBluetoothDevicesData.AdapterR\badapters\x12@\n" +
	"\adevices\x18\x02 \x03(\v2&.steam.CMsgBluetoothDevicesData.DeviceR\adevices\x12A\n" +
	"\amanager\x18\x03 \x01(\v2'.steam.CMsgBluetoothDevicesData.ManagerR\amanager\x1a\x88\x01\n" +
	"\aAdapter\x12\x11\n" +
	...
	"\x0eis_discovering\x18\x05 \x01(\bR\risDiscovering\x1a\x9a\x03\n" +
	"\x06Device\x12\x11\n" +
	"\x02id\x18\x01 \x01(\r:\x010R\x02id\x12 \n" +
	"\n" +
	"adapter_id\x18\x02 \x01(\r:\x010R\tadapterId\x12P\n" +
	"\x05etype\x18\x03 \x01(\x0e2\x1b.steam.EBluetoothDeviceType:\x1dk_BluetoothDeviceType_InvalidR\x05etype\x12\x10\n" +
	...
	"\x10rx_bytes_per_sec\x18\x06 \x01(\x05R\rrxBytesPerSec\"\xcb\x01\n" +
	"\x1cCMsgSystemPerfDiagnosticInfo\x12>\n" +
	"\aentries\x18\x01 \x03(\v2$.steam.CMsgSystemPerfDiagnosticEntryR\aentries\x12E\n" +
	"\n" +
	"interfaces\x18\x02 \x03(\v2%.steam.CMsgSystemPerfNetworkInterfaceR\n" +
	"interfaces\x12$\n" +
	"\x0ebattery_temp_c\x18\x03 \x01(\x02R\fbatteryTempC\"\xd8\v\n" +
	...
	"(is_manual_display_refresh_rate_available\x18\t \x01(\bR#isManualDisplayRefreshRateAvailable\x12d\n" +
	" gpu_performance_levels_available\x18\n" +
	" \x03(\x0e2\x1b.steam.EGPUPerformanceLevelR\x1dgpuPerformanceLevelsAvailable\x12@\n" +
	...
	"*is_dynamic_refresh_rate_in_steam_supported\x18\x18 \x01(\bR$isDynamicRefreshRateInSteamSupported\x12a\n" +
	"\x1fsplit_scaling_filters_available\x18\x1a \x03(\x0e2\x1a.steam.ESplitScalingFilterR\x1csplitScalingFiltersAvailable\x12a\n" +
	"\x1fsplit_scaling_scalers_available\x18\x1b \x03(\x0e2\x1a.steam.ESplitScalingScalerR\x1csplitScalingScalersAvailable\x12E\n" +
	"\x1fdisable_refresh_rate_management\x18\x1e \x01(\bR\x1cdisableRefreshRateManagement\"\xa8\b\n" +
	"\x1cCMsgSystemPerfSettingsGlobal\x124\n" +
	"\x16diagnostic_update_rate\x18\x01 \x01(\x02R\x14diagnosticUpdateRate\x12\x86\x01\n" +
	" graphics_profiling_service_state\x18\x03 \x01(\x0e2\x1a.steam.ESystemServiceState:!k_ESystemServiceState_UnavailableR\x1dgraphicsProfilingServiceState\x12z\n" +
	"\x1aperf_overlay_service_state\x18\x04 \x01(\x0e2\x1a.steam.ESystemServiceState:!k_ESystemServiceState_UnavailableR\x17perfOverlayServiceState\x12r\n" +
	"\x12perf_overlay_level\x18\x05 \x01(\x0e2 .steam.EGraphicsPerfOverlayLevel:\"k_EGraphicsPerfOverlayLevel_HiddenR\x10perfOverlayLevel\x12R\n" +
	...
	"&allow_external_display_refresh_control\x18\b \x01(\bR\"allowExternalDisplayRefreshControl\x12w\n" +
	"\x1bhdr_on_sdr_tonemap_operator\x18\f \x01(\x0e2\x1a.steam.EHDRToneMapOperator:\x1dk_EHDRToneMapOperator_InvalidR\x17hdrOnSdrTonemapOperator\x12>\n" +
	...
	"\x1bis_color_management_enabled\x18\x15 \x01(\bR\x18isColorManagementEnabled\"\xf0\n" +
	"\n" +
	...
	"\ttdp_limit\x18\x05 \x01(\x05R\btdpLimit\x12N\n" +
	"\fcpu_governor\x18\x06 \x01(\x0e2\x13.steam.ECPUGovernor:\x16k_ECPUGovernor_InvalidR\vcpuGovernor\x125\n" +
	...
	"\x1cis_game_perf_profile_enabled\x18\x0e \x01(\bR\x18isGamePerfProfileEnabled\x12o\n" +
	"\x15gpu_performance_level\x18\x0f \x01(\x0e2\x1b.steam.EGPUPerformanceLevel:\x1ek_EGPUPerformanceLevel_InvalidR\x13gpuPerformanceLevel\x12J\n" +
	...
	"!use_dynamic_refresh_rate_in_steam\x18\x17 \x01(\bR\x1cuseDynamicRefreshRateInSteam\x12k\n" +
	"\x14split_scaling_filter\x18\x18 \x01(\x0e2\x1a.steam.ESplitScalingFilter:\x1dk_ESplitScalingFilter_InvalidR\x12splitScalingFilter\x12k\n" +
	"\x14split_scaling_scaler\x18\x19 \x01(\x0e2\x1a.steam.ESplitScalingScaler:\x1dk_ESplitScalingScaler_InvalidR\x12splitScalingScaler\"\x93\x01\n" +
	"\x16CMsgSystemPerfSettings\x12;\n" +
	"\x06global\x18\x01 \x01(\v2#.steam.CMsgSystemPerfSettingsGlobalR\x06global\x12<\n" +
	"\aper_app\x18\x02 \x01(\v2#.steam.CMsgSystemPerfSettingsPerAppR\x06perApp\"\xfa\v\n" +
	"\x18CMsgSystemPerfSettingsV1\x124\n" +
	"\x16diagnostic_update_rate\x18\x01 \x01(\x02R\x14diagnosticUpdateRate\x12z\n" +
	"\x1asystem_trace_service_state\x18\x02 \x01(\x0e2\x1a.steam.ESystemServiceState:!k_ESystemServiceState_UnavailableR\x17systemTraceServiceState\x12\x86\x01\n" +
	" graphics_profiling_service_state\x18\x03 \x01(\x0e2\x1a.steam.ESystemServiceState:!k_ESystemServiceState_UnavailableR\x1dgraphicsProfilingServiceState\x12z\n" +
	"\x1aperf_overlay_service_state\x18\x04 \x01(\x0e2\x1a.steam.ESystemServiceState:!k_ESystemServiceState_UnavailableR\x17perfOverlayServiceState\x12r\n" +
	"\x12perf_overlay_level\x18\x05 \x01(\x0e2 .steam.EGraphicsPerfOverlayLevel:\"k_EGraphicsPerfOverlayLevel_HiddenR\x10perfOverlayLevel\x12o\n" +
	"\x15gpu_performance_level\x18\x06 \x01(\x0e2\x1b.steam.EGPUPerformanceLevel:\x1ek_EGPUPerformanceLevel_InvalidR\x13gpuPerformanceLevel\x12;\n" +
	...
	"\ttdp_limit\x18\v \x01(\x05R\btdpLimit\x12N\n" +
	"\fcpu_governor\x18\f \x01(\x0e2\x13.steam.ECPUGovernor:\x16k_ECPUGovernor_InvalidR\vcpuGovernor\x125\n" +
	...
	"\x1cis_game_perf_profile_enabled\x18\x15 \x01(\bR\x18isGamePerfProfileEnabled\"\xe2\x01\n" +
	"\x13CMsgSystemPerfState\x123\n" +
	"\x06limits\x18\x01 \x01(\v2\x1b.steam.CMsgSystemPerfLimitsR\x06limits\x129\n" +
	"\bsettings\x18\x02 \x01(\v2\x1d.steam.CMsgSystemPerfSettingsR\bsettings\x12&\n" +
	"\x0fcurrent_game_id\x18\x03 \x01(\x04R\rcurrentGameId\x123\n" +
	"\x16active_profile_game_id\x18\x04 \x01(\x04R\x13activeProfileGameId\"\xe4\x01\n" +
	...
	"\x10reset_to_default\x18\x02 \x01(\bH\x00R\x0eresetToDefault\x12F\n" +
	"\x0esettings_delta\x18\x03 \x01(\v2\x1d.steam.CMsgSystemPerfSettingsH\x00R\rsettingsDeltaB\b\n" +
	"\x06update\"\x8b\x01\n" +
	" CMsgSystemPerfLegacySettingEntry\x12&\n" +
	"\x0fprofile_game_id\x18\x01 \x01(\x04R\rprofileGameId\x12?\n" +
	"\bsettings\x18\x02 \x01(\v2#.steam.CMsgSystemPerfSettingsPerAppR\bsettings\"\xae\x01\n" +
	"\x1cCMsgSystemPerfLegacySettings\x12;\n" +
	"\x06global\x18\x01 \x01(\v2#.steam.CMsgSystemPerfSettingsGlobalR\x06global\x12Q\n" +
	"\x10per_app_settings\x18\x02 \x03(\v2'.steam.CMsgSystemPerfLegacySettingEntryR\x0eperAppSettings\"\xf5\x02\n" +
	"\x19CMsgSystemDockUpdateState\x12C\n" +
	"\x05state\x18\x01 \x01(\x0e2\x14.steam.EUpdaterState:\x17k_EUpdaterState_InvalidR\x05state\x12,\n" +
	...
	"\x11old_fw_workaround\x18\a \x01(\x05R\x0foldFwWorkaround\"Z\n" +
	"\x13CMsgSystemDockState\x12C\n" +
	"\fupdate_state\x18\x01 \x01(\v2 .steam.CMsgSystemDockUpdateStateR\vupdateState\"=\n" +
	"\x1cCMsgSystemDockUpdateFirmware\x12\x1d\n" +
	"\n" +
	"check_only\x18\x01 \x01(\bR\tcheckOnly\"\xf5\x01\n" +
	"\x15CMsgSystemAudioVolume\x12C\n" +
	"\aentries\x18\x01 \x03(\v2).steam.CMsgSystemAudioVolume.ChannelEntryR\aentries\x12\x19\n" +
	"\bis_muted\x18\x02 \x01(\bR\aisMuted\x1a|\n" +
	"\fChannelEntry\x12T\n" +
	"\bechannel\x18\x01 \x01(\x0e2\x1a.steam.ESystemAudioChannel:\x1ck_SystemAudioChannel_InvalidR\bechannel\x12\x16\n" +
	"\x06volume\x18\x02 \x01(\x02R\x06volume\"Z\n" +
	"\x1cCMsgSystemAudioManagerObject\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12*\n" +
	"\x11rtime_last_update\x18\x02 \x01(\aR\x0frtimeLastUpdate\"\xb3\x01\n" +
	"\x1cCMsgSystemAudioManagerDevice\x127\n" +
	"\x04base\x18\x01 \x01(\v2#.steam.CMsgSystemAudioManagerObjectR\x04base\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04nick\x18\x03 \x01(\tR\x04nick\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12\x10\n" +
	"\x03api\x18\x05 \x01(\tR\x03api\"\xd0\x02\n" +
	"\x1aCMsgSystemAudioManagerNode\x127\n" +
	"\x04base\x18\x01 \x01(\v2#.steam.CMsgSystemAudioManagerObjectR\x04base\x12\x1b\n" +
	"\tdevice_id\x18\x02 \x01(\rR\bdeviceId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x12\n" +
	"\x04nick\x18\x04 \x01(\tR\x04nick\x12 \n" +
	"\vdescription\x18\x05 \x01(\tR\vdescription\x12\\\n" +
	"\n" +
	"edirection\x18\x06 \x01(\x0e2\x1c.steam.ESystemAudioDirection:\x1ek_SystemAudioDirection_InvalidR\n" +
	"edirection\x124\n" +
	"\x06volume\x18\a \x01(\v2\x1c.steam.CMsgSystemAudioVolumeR\x06volume\"\xd0\x03\n" +
	"\x1aCMsgSystemAudioManagerPort\x127\n" +
	"\x04base\x18\x01 \x01(\v2#.steam.CMsgSystemAudioManagerObjectR\x04base\x12\x17\n" +
	"\anode_id\x18\x03 \x01(\rR\x06nodeId\x12\x12\n" +
	"\x04name\x18\x04 \x01(\tR\x04name\x12\x14\n" +
	"\x05alias\x18\x05 \x01(\tR\x05alias\x12P\n" +
	"\x05etype\x18\x06 \x01(\x0e2\x1b.steam.ESystemAudioPortType:\x1dk_SystemAudioPortType_InvalidR\x05etype\x12d\n" +
	"\n" +
	"edirection\x18\a \x01(\x0e2 .steam.ESystemAudioPortDirection:\"k_SystemAudioPortDirection_InvalidR\n" +
	"edirection\x12\x1f\n" +
	...
	"\n" +
	"is_monitor\x18\v \x01(\bR\tisMonitor\"\xe9\x01\n" +
	"\x1aCMsgSystemAudioManagerLink\x127\n" +
	"\x04base\x18\x01 \x01(\v2#.steam.CMsgSystemAudioManagerObjectR\x04base\x12$\n" +
	...
	"\rinput_port_id\x18\x05 \x01(\rR\vinputPortId\"\x89\x02\n" +
	"\x1dCMsgSystemAudioManagerStateHW\x12=\n" +
	"\adevices\x18\x01 \x03(\v2#.steam.CMsgSystemAudioManagerDeviceR\adevices\x127\n" +
	"\x05nodes\x18\x02 \x03(\v2!.steam.CMsgSystemAudioManagerNodeR\x05nodes\x127\n" +
	"\x05ports\x18\x03 \x03(\v2!.steam.CMsgSystemAudioManagerPortR\x05ports\x127\n" +
	"\x05links\x18\x04 \x03(\v2!.steam.CMsgSystemAudioManagerLinkR\x05links\"\x90\x01\n" +
	"\x1bCMsgSystemAudioManagerState\x12!\n" +
	"\frtime_filter\x18\x01 \x01(\aR\vrtimeFilter\x12\x18\n" +
	"\acounter\x18\x02 \x01(\x05R\acounter\x124\n" +
	"\x02hw\x18\x03 \x01(\v2$.steam.CMsgSystemAudioManagerStateHWR\x02hw\"A\n" +
	...
	"\n" +
	"refresh_hz\x18\x04 \x01(\x05R\trefreshHz\"\xb2\x05\n" +
	...
	" \x01(\x05R\rcurrentModeId\x122\n" +
	"\x05modes\x18\v \x03(\v2\x1c.steam.CMsgSystemDisplayModeR\x05modes\x12(\n" +
	...
	"\x17supported_refresh_rates\x18\x12 \x03(\x05R\x15supportedRefreshRates\"\x97\x02\n" +
	"\x1dCMsgSystemDisplayManagerState\x124\n" +
	"\bdisplays\x18\x01 \x03(\v2\x18.steam.CMsgSystemDisplayR\bdisplays\x12=\n" +
	"\x1bis_mode_switching_supported\x18\x02 \x01(\bR\x18isModeSwitchingSupported\x12\x80\x01\n" +
	"\x12compatibility_mode\x18\x03 \x01(\x0e2&.steam.ESystemDisplayCompatibilityMode:)k_ESystemDisplayCompatibilityMode_InvalidR\x11compatibilityMode\"Y\n" +
	"\x1fCMsgSystemDisplayManagerSetMode\x12\x1d\n" +
	"\n" +
	"display_id\x18\x01 \x01(\x05R\tdisplayId\x12\x17\n" +
	"\amode_id\x18\x02 \x01(\x05R\x06modeId\"\x9f\x11\n" +
	...
	"\x18is_fan_control_available\x18\x1b \x01(\bR\x15isFanControlAvailable\x12f\n" +
	"\x10fan_control_mode\x18\x1c \x01(\x0e2\x1c.steam.ESystemFanControlMode:\x1ek_SystemFanControlMode_InvalidR\x0efanControlMode\x12E\n" +
	...
	"\x19display_colortemp_enabled\x18% \x01(\bR\x17displayColortempEnabled\x12x\n" +
	"\x1bdisplay_colorgamut_labelset\x18& \x01(\x0e2\x1a.steam.EColorGamutLabelSet:\x1ck_ColorGamutLabelSet_DefaultR\x19displayColorgamutLabelset\x12R\n" +
	"&display_brightness_overdrive_hdr_split\x18' \x01(\x02R\"displayBrightnessOverdriveHdrSplit\"~\n" +
	"\x18CMsgSelectOSBranchParams\x12=\n" +
	"\x06branch\x18\x01 \x01(\x0e2\x10.steam.EOSBranch:\x13k_EOSBranch_UnknownR\x06branch\x12#\n" +
	...
	"\x1artime_estimated_completion\x18\x03 \x01(\aR\x18rtimeEstimatedCompletion\"\xb1\x02\n" +
	"\x1bCMsgSystemUpdateCheckResult\x12?\n" +
	"\x04type\x18\x01 \x01(\x0e2\x13.steam.EUpdaterType:\x16k_EUpdaterType_InvalidR\x04type\x12\x1b\n" +
	...
	"\x16system_restart_pending\x18\a \x01(\bR\x14systemRestartPending\"S\n" +
	"\x1bCMsgSystemUpdateApplyParams\x124\n" +
	"\vapply_types\x18\x01 \x03(\x0e2\x13.steam.EUpdaterTypeR\n" +
	"applyTypes\"\xf9\x01\n" +
	"\x1bCMsgSystemUpdateApplyResult\x12?\n" +
	"\x04type\x18\x01 \x01(\x0e2\x13.steam.EUpdaterType:\x16k_EUpdaterType_InvalidR\x04type\x12\x1b\n" +
	"\aeresult\x18\x02 \x01(\r:\x012R\aeresult\x12=\n" +
	"\x17requires_client_restart\x18\x03 \x01(\b:\x05falseR\x15requiresClientRestart\x12=\n" +
	"\x17requires_system_restart\x18\x04 \x01(\b:\x05falseR\x15requiresSystemRestart\"\xf5\x02\n" +
	"\x15CMsgSystemUpdateState\x12C\n" +
	"\x05state\x18\x01 \x01(\x0e2\x14.steam.EUpdaterState:\x17k_EUpdaterState_InvalidR\x05state\x12;\n" +
	"\bprogress\x18\x02 \x01(\v2\x1f.steam.CMsgSystemUpdateProgressR\bprogress\x12T\n" +
	"\x14update_check_results\x18\x03 \x03(\v2\".steam.CMsgSystemUpdateCheckResultR\x12updateCheckResults\x12T\n" +
	"\x14update_apply_results\x18\x04 \x03(\v2\".steam.CMsgSystemUpdateApplyResultR\x12updateApplyResults\x12.\n" +
	...
	"\fCMsgCellList\x12.\n" +
	"\x05cells\x18\x01 \x03(\v2\x18.steam.CMsgCellList.CellR\x05cells\x1a:\n" +
	"\x04Cell\x12\x17\n" +
	...
	"\x06sortas\x18\x15 \x01(\tR\x06sortas\"H\n" +
	"\x11CMsgShortcutInfos\x123\n" +
	"\bshorcuts\x18\x01 \x03(\v2\x17.steam.CMsgShortcutInfoR\bshorcuts\",\n" +
	"\x12CMsgShortcutAppIds\x12\x16\n" +
	"\x06appids\x18\x01 \x03(\rR\x06appids\"\xf4\x01\n" +
	"\x0fCMsgMonitorInfo\x120\n" +
	"\x14selected_device_name\x18\x01 \x02(\tR\x12selectedDeviceName\x12>\n" +
	"\bmonitors\x18\x02 \x03(\v2\".steam.CMsgMonitorInfo.MonitorInfoR\bmonitors\x1ao\n" +
	"\vMonitorInfo\x12.\n" +
	...
	"\x12time_last_reported\x18\x03 \x01(\x04R\x10timeLastReported\"Z\n" +
	"\x18CMsgClientShaderHitCache\x12>\n" +
	"\aentries\x18\x01 \x03(\v2$.steam.CMsgClientShaderHitCacheEntryR\aentries*\x96\x02\n" +
	...
	"%k_ESteamDeckKeyboardLayout_Indonesian\x10#B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steammessages_client_objects_proto_goTypes = []any{
	(ECloudPendingRemoteOperation)(0),                        // 0: steam.ECloudPendingRemoteOperation
	(ESteamDeckKeyboardLayout)(0),                            // 1: steam.ESteamDeckKeyboardLayout
	(*SteamMessagesClientIClientForcedEnumDependencies)(nil), // 2: steam.SteamMessagesClientIClientForcedEnumDependencies
	(*CMsgNetworkDeviceIP4Address)(nil),                      // 3: steam.CMsgNetworkDeviceIP4Address
	(*CMsgNetworkDeviceIP4Config)(nil),                       // 4: steam.CMsgNetworkDeviceIP4Config
	(*CMsgNetworkDeviceIP6Address)(nil),                      // 5: steam.CMsgNetworkDeviceIP6Address
	(*CMsgNetworkDeviceIP6Config)(nil),                       // 6: steam.CMsgNetworkDeviceIP6Config
	(*CMsgNetworkDevicesData)(nil),                           // 7: steam.CMsgNetworkDevicesData
	(*CMsgNetworkDeviceConnect)(nil),                         // 8: steam.CMsgNetworkDeviceConnect
	(*CMsgNetworkDeviceSetOptions)(nil),                      // 9: steam.CMsgNetworkDeviceSetOptions
	(*CMsgStorageDevicesData)(nil),                           // 10: steam.CMsgStorageDevicesData
	(*CCloud_PendingRemoteOperation)(nil),                    // 11: steam.CCloud_PendingRemoteOperation
	(*CMsgCloudPendingRemoteOperations)(nil),                 // 12: steam.CMsgCloudPendingRemoteOperations
	(*CMsgBluetoothDevicesData)(nil),                         // 13: steam.CMsgBluetoothDevicesData
	(*CMsgSystemPerfDiagnosticEntry)(nil),                    // 14: steam.CMsgSystemPerfDiagnosticEntry
	(*CMsgSystemPerfNetworkInterface)(nil),                   // 15: steam.CMsgSystemPerfNetworkInterface
	(*CMsgSystemPerfDiagnosticInfo)(nil),                     // 16: steam.CMsgSystemPerfDiagnosticInfo
	(*CMsgSystemPerfLimits)(nil),                             // 17: steam.CMsgSystemPerfLimits
	(*CMsgSystemPerfSettingsGlobal)(nil),                     // 18: steam.CMsgSystemPerfSettingsGlobal
	(*CMsgSystemPerfSettingsPerApp)(nil),                     // 19: steam.CMsgSystemPerfSettingsPerApp
	(*CMsgSystemPerfSettings)(nil),                           // 20: steam.CMsgSystemPerfSettings
	(*CMsgSystemPerfSettingsV1)(nil),                         // 21: steam.CMsgSystemPerfSettingsV1
	(*CMsgSystemPerfState)(nil),                              // 22: steam.CMsgSystemPerfState
	(*CMsgSystemPerfUpdateSettings)(nil),                     // 23: steam.CMsgSystemPerfUpdateSettings
	(*CMsgSystemPerfLegacySettingEntry)(nil),                 // 24: steam.CMsgSystemPerfLegacySettingEntry
	(*CMsgSystemPerfLegacySettings)(nil),                     // 25: steam.CMsgSystemPerfLegacySettings
	(*CMsgSystemDockUpdateState)(nil),                        // 26: steam.CMsgSystemDockUpdateState
	(*CMsgSystemDockState)(nil),                              // 27: steam.CMsgSystemDockState
	(*CMsgSystemDockUpdateFirmware)(nil),                     // 28: steam.CMsgSystemDockUpdateFirmware
	(*CMsgSystemAudioVolume)(nil),                            // 29: steam.CMsgSystemAudioVolume
	(*CMsgSystemAudioManagerObject)(nil),                     // 30: steam.CMsgSystemAudioManagerObject
	(*CMsgSystemAudioManagerDevice)(nil),                     // 31: steam.CMsgSystemAudioManagerDevice
	(*CMsgSystemAudioManagerNode)(nil),                       // 32: steam.CMsgSystemAudioManagerNode
	(*CMsgSystemAudioManagerPort)(nil),                       // 33: steam.CMsgSystemAudioManagerPort
	(*CMsgSystemAudioManagerLink)(nil),                       // 34: steam.CMsgSystemAudioManagerLink
	(*CMsgSystemAudioManagerStateHW)(nil),                    // 35: steam.CMsgSystemAudioManagerStateHW
	(*CMsgSystemAudioManagerState)(nil),                      // 36: steam.CMsgSystemAudioManagerState
	(*CMsgSystemAudioManagerUpdateSomething)(nil),            // 37: steam.CMsgSystemAudioManagerUpdateSomething
	(*CMsgSystemDisplayMode)(nil),                            // 38: steam.CMsgSystemDisplayMode
	(*CMsgSystemDisplay)(nil),                                // 39: steam.CMsgSystemDisplay
	(*CMsgSystemDisplayManagerState)(nil),                    // 40: steam.CMsgSystemDisplayManagerState
	(*CMsgSystemDisplayManagerSetMode)(nil),                  // 41: steam.CMsgSystemDisplayManagerSetMode
	(*CMsgSystemManagerSettings)(nil),                        // 42: steam.CMsgSystemManagerSettings
	(*CMsgSelectOSBranchParams)(nil),                         // 43: steam.CMsgSelectOSBranchParams
	(*CMsgSystemUpdateProgress)(nil),                         // 44: steam.CMsgSystemUpdateProgress
	(*CMsgSystemUpdateCheckResult)(nil),                      // 45: steam.CMsgSystemUpdateCheckResult
	(*CMsgSystemUpdateApplyParams)(nil),                      // 46: steam.CMsgSystemUpdateApplyParams
	(*CMsgSystemUpdateApplyResult)(nil),                      // 47: steam.CMsgSystemUpdateApplyResult
	(*CMsgSystemUpdateState)(nil),                            // 48: steam.CMsgSystemUpdateState
	(*CMsgAchievementChange)(nil),                            // 49: steam.CMsgAchievementChange
	(*CMsgCellList)(nil),                                     // 50: steam.CMsgCellList
	(*CMsgShortcutInfo)(nil),                                 // 51: steam.CMsgShortcutInfo
	(*CMsgShortcutInfos)(nil),                                // 52: steam.CMsgShortcutInfos
	(*CMsgShortcutAppIds)(nil),                               // 53: steam.CMsgShortcutAppIds
	(*CMsgMonitorInfo)(nil),                                  // 54: steam.CMsgMonitorInfo
	(*CMsgGenerateSystemReportReply)(nil),                    // 55: steam.CMsgGenerateSystemReportReply
	(*CMsgWebUITransportInfo)(nil),                           // 56: steam.CMsgWebUITransportInfo
	(*CMsgWebUITransportFailure)(nil),                        // 57: steam.CMsgWebUITransportFailure
	(*CMsgClientShaderHitCacheEntry)(nil),                    // 58: steam.CMsgClientShaderHitCacheEntry
	(*CMsgClientShaderHitCache)(nil),                         // 59: steam.CMsgClientShaderHitCache
	(*CMsgNetworkDevicesData_Device)(nil),                    // 60: steam.CMsgNetworkDevicesData.Device
	(*CMsgNetworkDevicesData_Device_Wired)(nil),              // 61: steam.CMsgNetworkDevicesData.Device.Wired
	(*CMsgNetworkDevicesData_Device_Wireless)(nil),           // 62: steam.CMsgNetworkDevicesData.Device.Wireless
	(*CMsgNetworkDevicesData_Device_Wireless_AP)(nil),        // 63: steam.CMsgNetworkDevicesData.Device.Wireless.AP
	(*CMsgNetworkDeviceConnect_KnownAP)(nil),                 // 64: steam.CMsgNetworkDeviceConnect.KnownAP
	(*CMsgNetworkDeviceConnect_CustomAP)(nil),                // 65: steam.CMsgNetworkDeviceConnect.CustomAP
	(*CMsgNetworkDeviceConnect_Credentials)(nil),             // 66: steam.CMsgNetworkDeviceConnect.Credentials
	(*CMsgNetworkDeviceConnect_Wireless)(nil),                // 67: steam.CMsgNetworkDeviceConnect.Wireless
	(*CMsgNetworkDeviceSetOptions_Wireless)(nil),             // 68: steam.CMsgNetworkDeviceSetOptions.Wireless
	(*CMsgStorageDevicesData_Drive)(nil),                     // 69: steam.CMsgStorageDevicesData.Drive
	(*CMsgStorageDevicesData_BlockDevice)(nil),               // 70: steam.CMsgStorageDevicesData.BlockDevice
	(*CMsgBluetoothDevicesData_Adapter)(nil),                 // 71: steam.CMsgBluetoothDevicesData.Adapter
	(*CMsgBluetoothDevicesData_Device)(nil),                  // 72: steam.CMsgBluetoothDevicesData.Device
	(*CMsgBluetoothDevicesData_Manager)(nil),                 // 73: steam.CMsgBluetoothDevicesData.Manager
	(*CMsgSystemAudioVolume_ChannelEntry)(nil),               // 74: steam.CMsgSystemAudioVolume.ChannelEntry
	(*CMsgCellList_Cell)(nil),                                // 75: steam.CMsgCellList.Cell
	(*CMsgMonitorInfo_MonitorInfo)(nil),                      // 76: steam.CMsgMonitorInfo.MonitorInfo
	(EBluetoothDeviceType)(0),                                // 77: steam.EBluetoothDeviceType
	(EStorageBlockContentType)(0),                            // 78: steam.EStorageBlockContentType
	(EStorageBlockFileSystemType)(0),                         // 79: steam.EStorageBlockFileSystemType
	(ESDCardFormatStage)(0),                                  // 80: steam.ESDCardFormatStage
	(EGPUPerformanceLevel)(0),                                // 81: steam.EGPUPerformanceLevel
	(ESplitScalingFilter)(0),                                 // 82: steam.ESplitScalingFilter
	(ESplitScalingScaler)(0),                                 // 83: steam.ESplitScalingScaler
	(ESystemServiceState)(0),                                 // 84: steam.ESystemServiceState
	(EGraphicsPerfOverlayLevel)(0),                           // 85: steam.EGraphicsPerfOverlayLevel
	(EHDRToneMapOperator)(0),                                 // 86: steam.EHDRToneMapOperator
	(ECPUGovernor)(0),                                        // 87: steam.ECPUGovernor
	(EUpdaterState)(0),                                       // 88: steam.EUpdaterState
	(ESystemAudioDirection)(0),                               // 89: steam.ESystemAudioDirection
	(ESystemAudioPortType)(0),                                // 90: steam.ESystemAudioPortType
	(ESystemAudioPortDirection)(0),                           // 91: steam.ESystemAudioPortDirection
	(ESystemDisplayCompatibilityMode)(0),                     // 92: steam.ESystemDisplayCompatibilityMode
	(ESystemFanControlMode)(0),                               // 93: steam.ESystemFanControlMode
	(EColorGamutLabelSet)(0),                                 // 94: steam.EColorGamutLabelSet
	(EOSBranch)(0),                                           // 95: steam.EOSBranch
	(EUpdaterType)(0),                                        // 96: steam.EUpdaterType
	(EStorageDriveMediaType)(0),                              // 97: steam.EStorageDriveMediaType
	(ESystemAudioChannel)(0),                                 // 98: steam.ESystemAudioChannel
}
var file_steammessages_client_objects_proto_depIdxs = []int32{
	77, // 0: steam.SteamMessagesClientIClientForcedEnumDependencies.a:type_name -> steam.EBluetoothDeviceType
	78, // 1: steam.SteamMessagesClientIClientForcedEnumDependencies.b:type_name -> steam.EStorageBlockContentType
	79, // 2: steam.SteamMessagesClientIClientForcedEnumDependencies.c:type_name -> steam.EStorageBlockFileSystemType
	80, // 3: steam.SteamMessagesClientIClientForcedEnumDependencies.d:type_name -> steam.ESDCardFormatStage
	3,  // 4: steam.CMsgNetworkDeviceIP4Config.addresses:type_name -> steam.CMsgNetworkDeviceIP4Address
	5,  // 5: steam.CMsgNetworkDeviceIP6Config.addresses:type_name -> steam.CMsgNetworkDeviceIP6Address
	60, // 6: steam.CMsgNetworkDevicesData.devices:type_name -> steam.CMsgNetworkDevicesData.Device
	66, // 7: steam.CMsgNetworkDeviceConnect.credentials:type_name -> steam.CMsgNetworkDeviceConnect.Credentials
	4,  // 8: steam.CMsgNetworkDeviceConnect.ip4:type_name -> steam.CMsgNetworkDeviceIP4Config
	6,  // 9: steam.CMsgNetworkDeviceConnect.ip6:type_name -> steam.CMsgNetworkDeviceIP6Config
	67, // 10: steam.CMsgNetworkDeviceConnect.wireless:type_name -> steam.CMsgNetworkDeviceConnect.Wireless
	64, // 11: steam.CMsgNetworkDeviceConnect.ap_known:type_name -> steam.CMsgNetworkDeviceConnect.KnownAP
	65, // 12: steam.CMsgNetworkDeviceConnect.ap_custom:type_name -> steam.CMsgNetworkDeviceConnect.CustomAP
	68, // 13: steam.CMsgNetworkDeviceSetOptions.wireless:type_name -> steam.CMsgNetworkDeviceSetOptions.Wireless
	69, // 14: steam.CMsgStorageDevicesData.drives:type_name -> steam.CMsgStorageDevicesData.Drive
	70, // 15: steam.CMsgStorageDevicesData.block_devices:type_name -> steam.CMsgStorageDevicesData.BlockDevice
	0,  // 16: steam.CCloud_PendingRemoteOperation.operation:type_name -> steam.ECloudPendingRemoteOperation
	11, // 17: steam.CMsgCloudPendingRemoteOperations.operations:type_name -> steam.CCloud_PendingRemoteOperation
	71, // 18: steam.CMsgBluetoothDevicesData.adapters:type_name -> steam.CMsgBluetoothDevicesData.Adapter
	72, // 19: steam.CMsgBluetoothDevicesData.devices:type_name -> steam.CMsgBluetoothDevicesData.Device
	73, // 20: steam.CMsgBluetoothDevicesData.manager:type_name -> steam.CMsgBluetoothDevicesData.Manager
	14, // 21: steam.CMsgSystemPerfDiagnosticInfo.entries:type_name -> steam.CMsgSystemPerfDiagnosticEntry
	15, // 22: steam.CMsgSystemPerfDiagnosticInfo.interfaces:type_name -> steam.CMsgSystemPerfNetworkInterface
	81, // 23: steam.CMsgSystemPerfLimits.gpu_performance_levels_available:type_name -> steam.EGPUPerformanceLevel
	82, // 24: steam.CMsgSystemPerfLimits.split_scaling_filters_available:type_name -> steam.ESplitScalingFilter
	83, // 25: steam.CMsgSystemPerfLimits.split_scaling_scalers_available:type_name -> steam.ESplitScalingScaler
	84, // 26: steam.CMsgSystemPerfSettingsGlobal.graphics_profiling_service_state:type_name -> steam.ESystemServiceState
	84, // 27: steam.CMsgSystemPerfSettingsGlobal.perf_overlay_service_state:type_name -> steam.ESystemServiceState
	85, // 28: steam.CMsgSystemPerfSettingsGlobal.perf_overlay_level:type_name -> steam.EGraphicsPerfOverlayLevel
	86, // 29: steam.CMsgSystemPerfSettingsGlobal.hdr_on_sdr_tonemap_operator:type_name -> steam.EHDRToneMapOperator
	87, // 30: steam.CMsgSystemPerfSettingsPerApp.cpu_governor:type_name -> steam.ECPUGovernor
	81, // 31: steam.CMsgSystemPerfSettingsPerApp.gpu_performance_level:type_name -> steam.EGPUPerformanceLevel
	82, // 32: steam.CMsgSystemPerfSettingsPerApp.split_scaling_filter:type_name -> steam.ESplitScalingFilter
	83, // 33: steam.CMsgSystemPerfSettingsPerApp.split_scaling_scaler:type_name -> steam.ESplitScalingScaler
	18, // 34: steam.CMsgSystemPerfSettings.global:type_name -> steam.CMsgSystemPerfSettingsGlobal
	19, // 35: steam.CMsgSystemPerfSettings.per_app:type_name -> steam.CMsgSystemPerfSettingsPerApp
	84, // 36: steam.CMsgSystemPerfSettingsV1.system_trace_service_state:type_name -> steam.ESystemServiceState
	84, // 37: steam.CMsgSystemPerfSettingsV1.graphics_profiling_service_state:type_name -> steam.ESystemServiceState
	84, // 38: steam.CMsgSystemPerfSettingsV1.perf_overlay_service_state:type_name -> steam.ESystemServiceState
	85, // 39: steam.CMsgSystemPerfSettingsV1.perf_overlay_level:type_name -> steam.EGraphicsPerfOverlayLevel
	81, // 40: steam.CMsgSystemPerfSettingsV1.gpu_performance_level:type_name -> steam.EGPUPerformanceLevel
	87, // 41: steam.CMsgSystemPerfSettingsV1.cpu_governor:type_name -> steam.ECPUGovernor
	17, // 42: steam.CMsgSystemPerfState.limits:type_name -> steam.CMsgSystemPerfLimits
	20, // 43: steam.CMsgSystemPerfState.settings:type_name -> steam.CMsgSystemPerfSettings
	20, // 44: steam.CMsgSystemPerfUpdateSettings.settings_delta:type_name -> steam.CMsgSystemPerfSettings
	19, // 45: steam.CMsgSystemPerfLegacySettingEntry.settings:type_name -> steam.CMsgSystemPerfSettingsPerApp
	18, // 46: steam.CMsgSystemPerfLegacySettings.global:type_name -> steam.CMsgSystemPerfSettingsGlobal
	24, // 47: steam.CMsgSystemPerfLegacySettings.per_app_settings:type_name -> steam.CMsgSystemPerfLegacySettingEntry
	88, // 48: steam.CMsgSystemDockUpdateState.state:type_name -> steam.EUpdaterState
	26, // 49: steam.CMsgSystemDockState.update_state:type_name -> steam.CMsgSystemDockUpdateState
	74, // 50: steam.CMsgSystemAudioVolume.entries:type_name -> steam.CMsgSystemAudioVolume.ChannelEntry
	30, // 51: steam.CMsgSystemAudioManagerDevice.base:type_name -> steam.CMsgSystemAudioManagerObject
	30, // 52: steam.CMsgSystemAudioManagerNode.base:type_name -> steam.CMsgSystemAudioManagerObject
	89, // 53: steam.CMsgSystemAudioManagerNode.edirection:type_name -> steam.ESystemAudioDirection
	29, // 54: steam.CMsgSystemAudioManagerNode.volume:type_name -> steam.CMsgSystemAudioVolume
	30, // 55: steam.CMsgSystemAudioManagerPort.base:type_name -> steam.CMsgSystemAudioManagerObject
	90, // 56: steam.CMsgSystemAudioManagerPort.etype:type_name -> steam.ESystemAudioPortType
	91, // 57: steam.CMsgSystemAudioManagerPort.edirection:type_name -> steam.ESystemAudioPortDirection
	30, // 58: steam.CMsgSystemAudioManagerLink.base:type_name -> steam.CMsgSystemAudioManagerObject
	31, // 59: steam.CMsgSystemAudioManagerStateHW.devices:type_name -> steam.CMsgSystemAudioManagerDevice
	32, // 60: steam.CMsgSystemAudioManagerStateHW.nodes:type_name -> steam.CMsgSystemAudioManagerNode
	33, // 61: steam.CMsgSystemAudioManagerStateHW.ports:type_name -> steam.CMsgSystemAudioManagerPort
	34, // 62: steam.CMsgSystemAudioManagerStateHW.links:type_name -> steam.CMsgSystemAudioManagerLink
	35, // 63: steam.CMsgSystemAudioManagerState.hw:type_name -> steam.CMsgSystemAudioManagerStateHW
	38, // 64: steam.CMsgSystemDisplay.modes:type_name -> steam.CMsgSystemDisplayMode
	39, // 65: steam.CMsgSystemDisplayManagerState.displays:type_name -> steam.CMsgSystemDisplay
	92, // 66: steam.CMsgSystemDisplayManagerState.compatibility_mode:type_name -> steam.ESystemDisplayCompatibilityMode
	93, // 67: steam.CMsgSystemManagerSettings.fan_control_mode:type_name -> steam.ESystemFanControlMode
	94, // 68: steam.CMsgSystemManagerSettings.display_colorgamut_labelset:type_name -> steam.EColorGamutLabelSet
	95, // 69: steam.CMsgSelectOSBranchParams.branch:type_name -> steam.EOSBranch
	96, // 70: steam.CMsgSystemUpdateCheckResult.type:type_name -> steam.EUpdaterType
	96, // 71: steam.CMsgSystemUpdateApplyParams.apply_types:type_name -> steam.EUpdaterType
	96, // 72: steam.CMsgSystemUpdateApplyResult.type:type_name -> steam.EUpdaterType
	88, // 73: steam.CMsgSystemUpdateState.state:type_name -> steam.EUpdaterState
	44, // 74: steam.CMsgSystemUpdateState.progress:type_name -> steam.CMsgSystemUpdateProgress
	45, // 75: steam.CMsgSystemUpdateState.update_check_results:type_name -> steam.CMsgSystemUpdateCheckResult
	47, // 76: steam.CMsgSystemUpdateState.update_apply_results:type_name -> steam.CMsgSystemUpdateApplyResult
	75, // 77: steam.CMsgCellList.cells:type_name -> steam.CMsgCellList.Cell
	51, // 78: steam.CMsgShortcutInfos.shorcuts:type_name -> steam.CMsgShortcutInfo
	76, // 79: steam.CMsgMonitorInfo.monitors:type_name -> steam.CMsgMonitorInfo.MonitorInfo
	58, // 80: steam.CMsgClientShaderHitCache.entries:type_name -> steam.CMsgClientShaderHitCacheEntry
	4,  // 81: steam.CMsgNetworkDevicesData.Device.ip4:type_name -> steam.CMsgNetworkDeviceIP4Config
	6,  // 82: steam.CMsgNetworkDevicesData.Device.ip6:type_name -> steam.CMsgNetworkDeviceIP6Config
	61, // 83: steam.CMsgNetworkDevicesData.Device.wired:type_name -> steam.CMsgNetworkDevicesData.Device.Wired
	62, // 84: steam.CMsgNetworkDevicesData.Device.wireless:type_name -> steam.CMsgNetworkDevicesData.Device.Wireless
	63, // 85: steam.CMsgNetworkDevicesData.Device.Wireless.aps:type_name -> steam.CMsgNetworkDevicesData.Device.Wireless.AP
	97, // 86: steam.CMsgStorageDevicesData.Drive.media_type:type_name -> steam.EStorageDriveMediaType
	78, // 87: steam.CMsgStorageDevicesData.BlockDevice.content_type:type_name -> steam.EStorageBlockContentType
	79, // 88: steam.CMsgStorageDevicesData.BlockDevice.filesystem_type:type_name -> steam.EStorageBlockFileSystemType
	77, // 89: steam.CMsgBluetoothDevicesData.Device.etype:type_name -> steam.EBluetoothDeviceType
	98, // 90: steam.CMsgSystemAudioVolume.ChannelEntry.echannel:type_name -> steam.ESystemAudioChannel
