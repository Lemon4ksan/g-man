...
type CMsgSteamDatagramSessionCryptInfo struct {
	...
	KeyType         *CMsgSteamDatagramSessionCryptInfo_EKeyType `protobuf:"varint,1,opt,name=key_type,json=keyType,enum=steam.CMsgSteamDatagramSessionCryptInfo_EKeyType,def=0" json:"key_type,omitempty"`
	...
	Ciphers         []ESteamNetworkingSocketsCipher             `protobuf:"varint,5,rep,name=ciphers,enum=steam.ESteamNetworkingSocketsCipher" json:"ciphers,omitempty"`
...
const file_steamnetworkingsockets_messages_proto_rawDesc = "" +
	"\n" +
	"%steamnetworkingsockets_messages.proto\x12\x05steam\x1a+steamnetworkingsockets_messages_certs.proto\"\xbf\x02\n" +
	"!CMsgSteamDatagramSessionCryptInfo\x12U\n" +
	"\bkey_type\x18\x01 \x01(\x0e21.steam.CMsgSteamDatagramSessionCryptInfo.EKeyType:\aINVALIDR\akeyType\x12\x19\n" +
	...
	"\aciphers\x18\x05 \x03(\x0e2$.steam.ESteamNetworkingSocketsCipherR\aciphers\"'\n" +
	"\bEKeyType\x12\v\n" +
	...
	"\x13jitter_histogram_20\x18B \x01(\rR\x11jitterHistogram20\"\xc1\x01\n" +
	"\"CMsgSteamDatagramConnectionQuality\x12T\n" +
	"\rinstantaneous\x18\x01 \x01(\v2..steam.CMsgSteamDatagramLinkInstantaneousStatsR\rinstantaneous\x12E\n" +
	"\blifetime\x18\x02 \x01(\v2).steam.CMsgSteamDatagramLinkLifetimeStatsR\blifetime\"0\n" +
	"\x10CMsgICECandidate\x12\x1c\n" +
	"\tcandidate\x18\x03 \x01(\tR\tcandidate\"\xa7\x01\n" +
	"\x11CMsgICERendezvous\x121\n" +
	"\x04auth\x18\x02 \x01(\v2\x1d.steam.CMsgICERendezvous.AuthR\x04auth\x12<\n" +
	"\radd_candidate\x18\x01 \x01(\v2\x17.steam.CMsgICECandidateR\faddCandidate\x1a!\n" +
	"\x04Auth\x12\x19\n" +
	"\bpwd_frag\x18\x01 \x01(\tR\apwdFrag\"\xd0\f\n" +
	...
	"iceEnabled\x120\n" +
	"\x14hosted_server_ticket\x18\x0e \x01(\fR\x12hostedServerTicket\x12_\n" +
	"\x0fconnect_request\x18\x04 \x01(\v26.steam.CMsgSteamNetworkingP2PRendezvous.ConnectRequestR\x0econnectRequest\x12P\n" +
	"\n" +
	"connect_ok\x18\x05 \x01(\v21.steam.CMsgSteamNetworkingP2PRendezvous.ConnectOKR\tconnectOk\x12e\n" +
	"\x11connection_closed\x18\x06 \x01(\v28.steam.CMsgSteamNetworkingP2PRendezvous.ConnectionClosedR\x10connectionClosed\x12(\n" +
	"\x10ack_reliable_msg\x18\v \x01(\rR\x0eackReliableMsg\x12,\n" +
	"\x12first_reliable_msg\x18\f \x01(\rR\x10firstReliableMsg\x12d\n" +
	"\x11reliable_messages\x18\r \x03(\v27.steam.CMsgSteamNetworkingP2PRendezvous.ReliableMessageR\x10reliableMessages\x12m\n" +
	"\x14application_messages\x18\x0f \x03(\v2:.steam.CMsgSteamNetworkingP2PRendezvous.ApplicationMessageR\x13applicationMessages\x1a\x8a\x02\n" +
	"\x0eConnectRequest\x12D\n" +
	...
	"+k_ESteamNetworkingSocketsCipher_AES_256_GCM\x10\x02B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steamnetworkingsockets_messages_proto_goTypes = []any{
	(ESteamNetworkingSocketsCipher)(0),                          // 0: steam.ESteamNetworkingSocketsCipher
	(CMsgSteamDatagramSessionCryptInfo_EKeyType)(0),             // 1: steam.CMsgSteamDatagramSessionCryptInfo.EKeyType
	(*CMsgSteamDatagramSessionCryptInfo)(nil),                   // 2: steam.CMsgSteamDatagramSessionCryptInfo
	(*CMsgSteamDatagramSessionCryptInfoSigned)(nil),             // 3: steam.CMsgSteamDatagramSessionCryptInfoSigned
	(*CMsgSteamDatagramDiagnostic)(nil),                         // 4: steam.CMsgSteamDatagramDiagnostic
	(*CMsgSteamDatagramLinkInstantaneousStats)(nil),             // 5: steam.CMsgSteamDatagramLinkInstantaneousStats
	(*CMsgSteamDatagramLinkLifetimeStats)(nil),                  // 6: steam.CMsgSteamDatagramLinkLifetimeStats
	(*CMsgSteamDatagramConnectionQuality)(nil),                  // 7: steam.CMsgSteamDatagramConnectionQuality
	(*CMsgICECandidate)(nil),                                    // 8: steam.CMsgICECandidate
	(*CMsgICERendezvous)(nil),                                   // 9: steam.CMsgICERendezvous
	(*CMsgSteamNetworkingP2PRendezvous)(nil),                    // 10: steam.CMsgSteamNetworkingP2PRendezvous
	(*CMsgSteamNetworkingICESessionSummary)(nil),                // 11: steam.CMsgSteamNetworkingICESessionSummary
	(*CMsgICERendezvous_Auth)(nil),                              // 12: steam.CMsgICERendezvous.Auth
	(*CMsgSteamNetworkingP2PRendezvous_ConnectRequest)(nil),     // 13: steam.CMsgSteamNetworkingP2PRendezvous.ConnectRequest
	(*CMsgSteamNetworkingP2PRendezvous_ConnectOK)(nil),          // 14: steam.CMsgSteamNetworkingP2PRendezvous.ConnectOK
	(*CMsgSteamNetworkingP2PRendezvous_ConnectionClosed)(nil),   // 15: steam.CMsgSteamNetworkingP2PRendezvous.ConnectionClosed
	(*CMsgSteamNetworkingP2PRendezvous_ReliableMessage)(nil),    // 16: steam.CMsgSteamNetworkingP2PRendezvous.ReliableMessage
	(*CMsgSteamNetworkingP2PRendezvous_ApplicationMessage)(nil), // 17: steam.CMsgSteamNetworkingP2PRendezvous.ApplicationMessage
	(*CMsgSteamDatagramCertificateSigned)(nil),                  // 18: steam.CMsgSteamDatagramCertificateSigned
}
var file_steamnetworkingsockets_messages_proto_depIdxs = []int32{
	1,  // 0: steam.CMsgSteamDatagramSessionCryptInfo.key_type:type_name -> steam.CMsgSteamDatagramSessionCryptInfo.EKeyType
	0,  // 1: steam.CMsgSteamDatagramSessionCryptInfo.ciphers:type_name -> steam.ESteamNetworkingSocketsCipher
	5,  // 2: steam.CMsgSteamDatagramConnectionQuality.instantaneous:type_name -> steam.CMsgSteamDatagramLinkInstantaneousStats
	6,  // 3: steam.CMsgSteamDatagramConnectionQuality.lifetime:type_name -> steam.CMsgSteamDatagramLinkLifetimeStats
	12, // 4: steam.CMsgICERendezvous.auth:type_name -> steam.CMsgICERendezvous.Auth
	8,  // 5: steam.CMsgICERendezvous.add_candidate:type_name -> steam.CMsgICECandidate
	13, // 6: steam.CMsgSteamNetworkingP2PRendezvous.connect_request:type_name -> steam.CMsgSteamNetworkingP2PRendezvous.ConnectRequest
	14, // 7: steam.CMsgSteamNetworkingP2PRendezvous.connect_ok:type_name -> steam.CMsgSteamNetworkingP2PRendezvous.ConnectOK
	15, // 8: steam.CMsgSteamNetworkingP2PRendezvous.connection_closed:type_name -> steam.CMsgSteamNetworkingP2PRendezvous.ConnectionClosed
	16, // 9: steam.CMsgSteamNetworkingP2PRendezvous.reliable_messages:type_name -> steam.CMsgSteamNetworkingP2PRendezvous.ReliableMessage
	17, // 10: steam.CMsgSteamNetworkingP2PRendezvous.application_messages:type_name -> steam.CMsgSteamNetworkingP2PRendezvous.ApplicationMessage
	3,  // 11: steam.CMsgSteamNetworkingP2PRendezvous.ConnectRequest.crypt:type_name -> steam.CMsgSteamDatagramSessionCryptInfoSigned
	18, // 12: steam.CMsgSteamNetworkingP2PRendezvous.ConnectRequest.cert:type_name -> steam.CMsgSteamDatagramCertificateSigned
	3,  // 13: steam.CMsgSteamNetworkingP2PRendezvous.ConnectOK.crypt:type_name -> steam.CMsgSteamDatagramSessionCryptInfoSigned
	18, // 14: steam.CMsgSteamNetworkingP2PRendezvous.ConnectOK.cert:type_name -> steam.CMsgSteamDatagramCertificateSigned
	9,  // 15: steam.CMsgSteamNetworkingP2PRendezvous.ReliableMessage.ice:type_name -> steam.CMsgICERendezvous
