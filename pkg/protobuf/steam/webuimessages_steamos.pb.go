...
type CSteamOSManagerState struct {
	...
	StartupMovieVariant                  *EStartupMovieVariant  `protobuf:"varint,4,opt,name=startup_movie_variant,json=startupMovieVariant,enum=steam.EStartupMovieVariant,def=0" json:"startup_movie_variant,omitempty"`
...
type CSteamOSManager_IsTelemetryHelperAvailable_Request struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Etype         *ESLSHelper            `protobuf:"varint,1,opt,name=etype,enum=steam.ESLSHelper,def=0" json:"etype,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_webuimessages_steamos_proto_rawDesc = "" +
	"\n" +
	"\x1bwebuimessages_steamos.proto\x12\x05steam\x1a\venums.proto\x1a\x18steammessages_base.proto\x1a\x18webuimessages_base.proto\"\xbe\x01\n" +
	...
	"\x1artime_estimated_completion\x18\x04 \x01(\aR\x18rtimeEstimatedCompletion\"\x9f\x0f\n" +
	...
	"\x1dis_mandatory_update_available\x18\x03 \x01(\bR\x1aisMandatoryUpdateAvailable\x12o\n" +
	"\x15startup_movie_variant\x18\x04 \x01(\x0e2\x1b.steam.EStartupMovieVariant:\x1ek_EStartupMovieVariant_InvalidR\x13startupMovieVariant\x12D\n" +
	"\x1fis_status_led_control_available\x18\x05 \x01(\bR\x1bisStatusLedControlAvailable\x12L\n" +
	"\x13factory_reset_state\x18\x06 \x01(\v2\x1c.steam.CMsgFactoryResetStateR\x11factoryResetState\x123\n" +
	...
	" CSteamOSManager_GetState_Request\"V\n" +
	"!CSteamOSManager_GetState_Response\x121\n" +
	"\x05state\x18\x01 \x01(\v2\x1b.steam.CSteamOSManagerStateR\x05state\"+\n" +
	")CSteamOSManager_StateChanged_Notification\"s\n" +
	"2CSteamOSManager_IsTelemetryHelperAvailable_Request\x12=\n" +
	"\x05etype\x18\x01 \x01(\x0e2\x11.steam.ESLSHelper:\x14k_ESLSHelper_InvalidR\x05etype\"S\n" +
	...
	"1CSteamOSManager_SetDefaultDesktopSession_Response\"\x94\x01\n" +
	"\x11CSteamOSSLSPlugin\x12=\n" +
	"\x05etype\x18\x01 \x01(\x0e2\x11.steam.ESLSHelper:\x14k_ESLSHelper_InvalidR\x05etype\x12!\n" +
	"\fis_available\x18\x02 \x01(\bR\visAvailable\x12\x1d\n" +
	"\n" +
	"is_enabled\x18\x03 \x01(\bR\tisEnabled\"\x88\x01\n" +
	"\x10CSteamOSSLSState\x12!\n" +
	"\fis_available\x18\x01 \x01(\bR\visAvailable\x12\x1d\n" +
	"\n" +
	"is_enabled\x18\x02 \x01(\bR\tisEnabled\x122\n" +
	"\aplugins\x18\x03 \x03(\v2\x18.steam.CSteamOSSLSPluginR\aplugins\"\x1e\n" +
	"\x1cCSteamOSSLS_GetState_Request\"N\n" +
	"\x1dCSteamOSSLS_GetState_Response\x12-\n" +
	"\x05state\x18\x01 \x01(\v2\x17.steam.CSteamOSSLSStateR\x05state\"'\n" +
	"%CSteamOSSLS_StateChanged_Notification\":\n" +
	"\x1eCSteamOSSLS_SetEnabled_Request\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\"!\n" +
	"\x1fCSteamOSSLS_SetEnabled_Response\"\x7f\n" +
	"$CSteamOSSLS_SetPluginEnabled_Request\x12=\n" +
	"\x05etype\x18\x01 \x01(\x0e2\x11.steam.ESLSHelper:\x14k_ESLSHelper_InvalidR\x05etype\x12\x18\n" +
	"\aenabled\x18\x02 \x01(\bR\aenabled\"'\n" +
	"%CSteamOSSLS_SetPluginEnabled_Response2\xd9\n" +
	"\n" +
	"\x0eSteamOSManager\x12]\n" +
	"\bGetState\x12'.steam.CSteamOSManager_GetState_Request\x1a(.steam.CSteamOSManager_GetState_Response\x12^\n" +
	"\x12NotifyStateChanged\x120.steam.CSteamOSManager_StateChanged_Notification\x1a\x16.steam.WebUINoResponse\x12\x8d\x01\n" +
	"\x18OptOutOfSideloadedClient\x127.steam.CSteamOSManager_OptOutOfSideloadedClient_Request\x1a8.steam.CSteamOSManager_OptOutOfSideloadedClient_Response\x12\x81\x01\n" +
	"\x14ApplyMandatoryUpdate\x123.steam.CSteamOSManager_ApplyMandatoryUpdate_Request\x1a4.steam.CSteamOSManager_ApplyMandatoryUpdate_Response\x12i\n" +
	"\fFactoryReset\x12+.steam.CSteamOSManager_FactoryReset_Request\x1a,.steam.CSteamOSManager_FactoryReset_Response\x12\x8a\x01\n" +
	"\x17PrepareFactoryImageTest\x126.steam.CSteamOSManager_PrepareFactoryImageTest_Request\x1a7.steam.CSteamOSManager_PrepareFactoryImageTest_Response\x12\x9c\x01\n" +
	"\x1dRefreshScreenReaderAutoLocale\x12<.steam.CSteamOSManager_RefreshScreenReaderAutoLocale_Request\x1a=.steam.CSteamOSManager_RefreshScreenReaderAutoLocale_Response\x12d\n" +
	"\x0fSetUserPassword\x12'.steam.CSteamOS_SetUserPassword_Request\x1a(.steam.CSteamOS_SetUserPassword_Response\x12m\n" +
	"\x12GetUserHasPassword\x12*.steam.CSteamOS_GetUserHasPassword_Request\x1a+.steam.CSteamOS_GetUserHasPassword_Response\x12r\n" +
	"\x0fSwitchToDesktop\x12..steam.CSteamOSManager_SwitchToDesktop_Request\x1a/.steam.CSteamOSManager_SwitchToDesktop_Response\x12\x8d\x01\n" +
	"\x18SetDefaultDesktopSession\x127.steam.CSteamOSManager_SetDefaultDesktopSession_Request\x1a8.steam.CSteamOSManager_SetDefaultDesktopSession_Response\x1a\x04\x80\x97\"\x012\x91\x03\n" +
	"\n" +
	"SteamOSSLS\x12U\n" +
	"\bGetState\x12#.steam.CSteamOSSLS_GetState_Request\x1a$.steam.CSteamOSSLS_GetState_Response\x12Z\n" +
	"\x12NotifyStateChanged\x12,.steam.CSteamOSSLS_StateChanged_Notification\x1a\x16.steam.WebUINoResponse\x12[\n" +
	"\n" +
	"SetEnabled\x12%.steam.CSteamOSSLS_SetEnabled_Request\x1a&.steam.CSteamOSSLS_SetEnabled_Response\x12m\n" +
	"\x10SetPluginEnabled\x12+.steam.CSteamOSSLS_SetPluginEnabled_Request\x1a,.steam.CSteamOSSLS_SetPluginEnabled_Response\x1a\x04\x80\x97\"\x01B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_webuimessages_steamos_proto_goTypes = []any{
	(*CMsgFactoryResetState)(nil),                                  // 0: steam.CMsgFactoryResetState
	(*CSteamOSManagerState)(nil),                                   // 1: steam.CSteamOSManagerState
	(*CSteamOSManager_GetState_Request)(nil),                       // 2: steam.CSteamOSManager_GetState_Request
	(*CSteamOSManager_GetState_Response)(nil),                      // 3: steam.CSteamOSManager_GetState_Response
	(*CSteamOSManager_StateChanged_Notification)(nil),              // 4: steam.CSteamOSManager_StateChanged_Notification
	(*CSteamOSManager_IsTelemetryHelperAvailable_Request)(nil),     // 5: steam.CSteamOSManager_IsTelemetryHelperAvailable_Request
	(*CSteamOSManager_IsTelemetryHelperAvailable_Response)(nil),    // 6: steam.CSteamOSManager_IsTelemetryHelperAvailable_Response
	(*CSteamOSManager_OptOutOfSideloadedClient_Request)(nil),       // 7: steam.CSteamOSManager_OptOutOfSideloadedClient_Request
	(*CSteamOSManager_OptOutOfSideloadedClient_Response)(nil),      // 8: steam.CSteamOSManager_OptOutOfSideloadedClient_Response
	(*CSteamOSManager_ApplyMandatoryUpdate_Request)(nil),           // 9: steam.CSteamOSManager_ApplyMandatoryUpdate_Request
	(*CSteamOSManager_ApplyMandatoryUpdate_Response)(nil),          // 10: steam.CSteamOSManager_ApplyMandatoryUpdate_Response
	(*CSteamOSManager_FactoryReset_Request)(nil),                   // 11: steam.CSteamOSManager_FactoryReset_Request
	(*CSteamOSManager_FactoryReset_Response)(nil),                  // 12: steam.CSteamOSManager_FactoryReset_Response
	(*CSteamOSManager_RefreshScreenReaderAutoLocale_Request)(nil),  // 13: steam.CSteamOSManager_RefreshScreenReaderAutoLocale_Request
	(*CSteamOSManager_RefreshScreenReaderAutoLocale_Response)(nil), // 14: steam.CSteamOSManager_RefreshScreenReaderAutoLocale_Response
	(*CSteamOS_SetUserPassword_Request)(nil),                       // 15: steam.CSteamOS_SetUserPassword_Request
	(*CSteamOS_SetUserPassword_Response)(nil),                      // 16: steam.CSteamOS_SetUserPassword_Response
	(*CSteamOS_GetUserHasPassword_Request)(nil),                    // 17: steam.CSteamOS_GetUserHasPassword_Request
	(*CSteamOS_GetUserHasPassword_Response)(nil),                   // 18: steam.CSteamOS_GetUserHasPassword_Response
	(*CSteamOSManager_PrepareFactoryImageTest_Request)(nil),        // 19: steam.CSteamOSManager_PrepareFactoryImageTest_Request
	(*CSteamOSManager_PrepareFactoryImageTest_Response)(nil),       // 20: steam.CSteamOSManager_PrepareFactoryImageTest_Response
	(*CSteamOSManager_SwitchToDesktop_Request)(nil),                // 21: steam.CSteamOSManager_SwitchToDesktop_Request
	(*CSteamOSManager_SwitchToDesktop_Response)(nil),               // 22: steam.CSteamOSManager_SwitchToDesktop_Response
	(*CSteamOSManager_SetDefaultDesktopSession_Request)(nil),       // 23: steam.CSteamOSManager_SetDefaultDesktopSession_Request
	(*CSteamOSManager_SetDefaultDesktopSession_Response)(nil),      // 24: steam.CSteamOSManager_SetDefaultDesktopSession_Response
	(*CSteamOSSLSPlugin)(nil),                                      // 25: steam.CSteamOSSLSPlugin
	(*CSteamOSSLSState)(nil),                                       // 26: steam.CSteamOSSLSState
	(*CSteamOSSLS_GetState_Request)(nil),                           // 27: steam.CSteamOSSLS_GetState_Request
	(*CSteamOSSLS_GetState_Response)(nil),                          // 28: steam.CSteamOSSLS_GetState_Response
	(*CSteamOSSLS_StateChanged_Notification)(nil),                  // 29: steam.CSteamOSSLS_StateChanged_Notification
	(*CSteamOSSLS_SetEnabled_Request)(nil),                         // 30: steam.CSteamOSSLS_SetEnabled_Request
	(*CSteamOSSLS_SetEnabled_Response)(nil),                        // 31: steam.CSteamOSSLS_SetEnabled_Response
	(*CSteamOSSLS_SetPluginEnabled_Request)(nil),                   // 32: steam.CSteamOSSLS_SetPluginEnabled_Request
	(*CSteamOSSLS_SetPluginEnabled_Response)(nil),                  // 33: steam.CSteamOSSLS_SetPluginEnabled_Response
	(EStartupMovieVariant)(0),                                      // 34: steam.EStartupMovieVariant
	(ESLSHelper)(0),                                                // 35: steam.ESLSHelper
	(*WebUINoResponse)(nil),                                        // 36: steam.WebUINoResponse
}
var file_webuimessages_steamos_proto_depIdxs = []int32{
	34, // 0: steam.CSteamOSManagerState.startup_movie_variant:type_name -> steam.EStartupMovieVariant
	0,  // 1: steam.CSteamOSManagerState.factory_reset_state:type_name -> steam.CMsgFactoryResetState
	1,  // 2: steam.CSteamOSManager_GetState_Response.state:type_name -> steam.CSteamOSManagerState
	35, // 3: steam.CSteamOSManager_IsTelemetryHelperAvailable_Request.etype:type_name -> steam.ESLSHelper
	35, // 4: steam.CSteamOSSLSPlugin.etype:type_name -> steam.ESLSHelper
	25, // 5: steam.CSteamOSSLSState.plugins:type_name -> steam.CSteamOSSLSPlugin
	26, // 6: steam.CSteamOSSLS_GetState_Response.state:type_name -> steam.CSteamOSSLSState
	35, // 7: steam.CSteamOSSLS_SetPluginEnabled_Request.etype:type_name -> steam.ESLSHelper
	2,  // 8: steam.SteamOSManager.GetState:input_type -> steam.CSteamOSManager_GetState_Request
	4,  // 9: steam.SteamOSManager.NotifyStateChanged:input_type -> steam.CSteamOSManager_StateChanged_Notification
	7,  // 10: steam.SteamOSManager.OptOutOfSideloadedClient:input_type -> steam.CSteamOSManager_OptOutOfSideloadedClient_Request
	9,  // 11: steam.SteamOSManager.ApplyMandatoryUpdate:input_type -> steam.CSteamOSManager_ApplyMandatoryUpdate_Request
	11, // 12: steam.SteamOSManager.FactoryReset:input_type -> steam.CSteamOSManager_FactoryReset_Request
	19, // 13: steam.SteamOSManager.PrepareFactoryImageTest:input_type -> steam.CSteamOSManager_PrepareFactoryImageTest_Request
	13, // 14: steam.SteamOSManager.RefreshScreenReaderAutoLocale:input_type -> steam.CSteamOSManager_RefreshScreenReaderAutoLocale_Request
	15, // 15: steam.SteamOSManager.SetUserPassword:input_type -> steam.CSteamOS_SetUserPassword_Request
	17, // 16: steam.SteamOSManager.GetUserHasPassword:input_type -> steam.CSteamOS_GetUserHasPassword_Request
	21, // 17: steam.SteamOSManager.SwitchToDesktop:input_type -> steam.CSteamOSManager_SwitchToDesktop_Request
	23, // 18: steam.SteamOSManager.SetDefaultDesktopSession:input_type -> steam.CSteamOSManager_SetDefaultDesktopSession_Request
	27, // 19: steam.SteamOSSLS.GetState:input_type -> steam.CSteamOSSLS_GetState_Request
	29, // 20: steam.SteamOSSLS.NotifyStateChanged:input_type -> steam.CSteamOSSLS_StateChanged_Notification
	30, // 21: steam.SteamOSSLS.SetEnabled:input_type -> steam.CSteamOSSLS_SetEnabled_Request
	32, // 22: steam.SteamOSSLS.SetPluginEnabled:input_type -> steam.CSteamOSSLS_SetPluginEnabled_Request
	3,  // 23: steam.SteamOSManager.GetState:output_type -> steam.CSteamOSManager_GetState_Response
	36, // 24: steam.SteamOSManager.NotifyStateChanged:output_type -> steam.WebUINoResponse
	8,  // 25: steam.SteamOSManager.OptOutOfSideloadedClient:output_type -> steam.CSteamOSManager_OptOutOfSideloadedClient_Response
	10, // 26: steam.SteamOSManager.ApplyMandatoryUpdate:output_type -> steam.CSteamOSManager_ApplyMandatoryUpdate_Response
	12, // 27: steam.SteamOSManager.FactoryReset:output_type -> steam.CSteamOSManager_FactoryReset_Response
	20, // 28: steam.SteamOSManager.PrepareFactoryImageTest:output_type -> steam.CSteamOSManager_PrepareFactoryImageTest_Response
	14, // 29: steam.SteamOSManager.RefreshScreenReaderAutoLocale:output_type -> steam.CSteamOSManager_RefreshScreenReaderAutoLocale_Response
	16, // 30: steam.SteamOSManager.SetUserPassword:output_type -> steam.CSteamOS_SetUserPassword_Response
	18, // 31: steam.SteamOSManager.GetUserHasPassword:output_type -> steam.CSteamOS_GetUserHasPassword_Response
	22, // 32: steam.SteamOSManager.SwitchToDesktop:output_type -> steam.CSteamOSManager_SwitchToDesktop_Response
	24, // 33: steam.SteamOSManager.SetDefaultDesktopSession:output_type -> steam.CSteamOSManager_SetDefaultDesktopSession_Response
	28, // 34: steam.SteamOSSLS.GetState:output_type -> steam.CSteamOSSLS_GetState_Response
	36, // 35: steam.SteamOSSLS.NotifyStateChanged:output_type -> steam.WebUINoResponse
	31, // 36: steam.SteamOSSLS.SetEnabled:output_type -> steam.CSteamOSSLS_SetEnabled_Response
	33, // 37: steam.SteamOSSLS.SetPluginEnabled:output_type -> steam.CSteamOSSLS_SetPluginEnabled_Response
