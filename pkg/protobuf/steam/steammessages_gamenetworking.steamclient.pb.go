...
const file_steammessages_gamenetworking_steamclient_proto_rawDesc = "" +
	"\n" +
	".steammessages_gamenetworking.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"e\n" +
	...
	"\n" +
	"fake_ports\x18\x03 \x03(\rR\tfakePorts2\xde\x01\n" +
	"\x0eGameNetworking\x12o\n" +
	"\x0eAllocateFakeIP\x12-.steam.CGameNetworking_AllocateFakeIP_Request\x1a..steam.CGameNetworking_AllocateFakeIP_Response\x12[\n" +
	"\x13NotifyReleaseFakeIP\x121.steam.CGameNetworking_ReleaseFakeIP_Notification\x1a\x11.steam.NoResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_gamenetworking_steamclient_proto_goTypes = []any{
	(*CGameNetworking_AllocateFakeIP_Request)(nil),     // 0: steam.CGameNetworking_AllocateFakeIP_Request
	(*CGameNetworking_AllocateFakeIP_Response)(nil),    // 1: steam.CGameNetworking_AllocateFakeIP_Response
	(*CGameNetworking_ReleaseFakeIP_Notification)(nil), // 2: steam.CGameNetworking_ReleaseFakeIP_Notification
	(*NoResponse)(nil), // 3: steam.NoResponse
}
var file_steammessages_gamenetworking_steamclient_proto_depIdxs = []int32{
	0, // 0: steam.GameNetworking.AllocateFakeIP:input_type -> steam.CGameNetworking_AllocateFakeIP_Request
	2, // 1: steam.GameNetworking.NotifyReleaseFakeIP:input_type -> steam.CGameNetworking_ReleaseFakeIP_Notification
	1, // 2: steam.GameNetworking.AllocateFakeIP:output_type -> steam.CGameNetworking_AllocateFakeIP_Response
	3, // 3: steam.GameNetworking.NotifyReleaseFakeIP:output_type -> steam.NoResponse
