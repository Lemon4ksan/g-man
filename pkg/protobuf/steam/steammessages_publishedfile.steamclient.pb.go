...
type CPublishedFile_GetSubSectionData_Request struct {
	...
	DesiredRevision    *EPublishedFileRevision `protobuf:"varint,4,opt,name=desired_revision,json=desiredRevision,enum=steam.EPublishedFileRevision,def=0" json:"desired_revision,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type PublishedFileDetails struct {
	...
	ContentDescriptorids       []EContentDescriptorID              `protobuf:"varint,72,rep,name=content_descriptorids,json=contentDescriptorids,enum=steam.EContentDescriptorID" json:"content_descriptorids,omitempty"`
	...
	BanTextCheckResult         *EBanContentCheckResult             `protobuf:"varint,71,opt,name=ban_text_check_result,json=banTextCheckResult,enum=steam.EBanContentCheckResult,def=0" json:"ban_text_check_result,omitempty"`
...
type CPublishedFile_GetUserFiles_Request struct {
	...
	ExcludedContentDescriptors []EContentDescriptorID                          `protobuf:"varint,37,rep,name=excluded_content_descriptors,json=excludedContentDescriptors,enum=steam.EContentDescriptorID" json:"excluded_content_descriptors,omitempty"`
...
type CPublishedFile_QueryFiles_Request struct {
	...
	ExcludedContentDescriptors []EContentDescriptorID                        `protobuf:"varint,46,rep,name=excluded_content_descriptors,json=excludedContentDescriptors,enum=steam.EContentDescriptorID" json:"excluded_content_descriptors,omitempty"`
...
type CPublishedFile_UpdateContentDescriptors_Request struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	Publishedfileid     *uint64                `protobuf:"fixed64,1,opt,name=publishedfileid" json:"publishedfileid,omitempty"`
	DescriptorsToAdd    []EContentDescriptorID `protobuf:"varint,2,rep,name=descriptors_to_add,json=descriptorsToAdd,enum=steam.EContentDescriptorID" json:"descriptors_to_add,omitempty"`
	DescriptorsToRemove []EContentDescriptorID `protobuf:"varint,3,rep,name=descriptors_to_remove,json=descriptorsToRemove,enum=steam.EContentDescriptorID" json:"descriptors_to_remove,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type CPublishedFile_FileSubscribed_Notification struct {
	...
	Revision        *EPublishedFileRevision                                    `protobuf:"varint,9,opt,name=revision,enum=steam.EPublishedFileRevision,def=0" json:"revision,omitempty"`
...
type CPublishedFile_GetItemInfo_Response_WorkshopItemInfo struct {
	...
	Revision        *EPublishedFileRevision        `protobuf:"varint,5,opt,name=revision,enum=steam.EPublishedFileRevision,def=0" json:"revision,omitempty"`
...
type CPublishedFile_GetContentDescriptors_Response_ContentDescriptor struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Descriptorid  *EContentDescriptorID  `protobuf:"varint,1,opt,name=descriptorid,enum=steam.EContentDescriptorID,def=1" json:"descriptorid,omitempty"`
...
const file_steammessages_publishedfile_steamclient_proto_rawDesc = "" +
	"\n" +
	"-steammessages_publishedfile.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\x1a\x17enums_productinfo.proto\"`\n" +
	...
	"\rcan_subscribe\x18\x01 \x01(\bR\fcanSubscribe\"\xa2\x02\n" +
	...
	"\x12specific_sectionid\x18\x03 \x01(\x04R\x11specificSectionid\x12j\n" +
	"\x10desired_revision\x18\x04 \x01(\x0e2\x1d.steam.EPublishedFileRevision: k_EPublishedFileRevision_DefaultR\x0fdesiredRevision\"\x97\x01\n" +
	...
	"\n" +
	"sort_order\x18\x04 \x01(\rR\tsortOrder\"n\n" +
	")CPublishedFile_GetSubSectionData_Response\x12A\n" +
	"\fsub_sections\x18\x01 \x03(\v2\x1e.steam.PublishedFileSubSectionR\vsubSections\"\xcf\x04\n" +
	...
	"\fredirect_uri\x18\x02 \x01(\tR\vredirectUri\"\x8d\x06\n" +
	...
	"\x18strip_description_bbcode\x18\x0f \x01(\bR\x16stripDescriptionBbcode\x12j\n" +
	"\x10desired_revision\x18\x10 \x01(\x0e2\x1d.steam.EPublishedFileRevision: k_EPublishedFileRevision_DefaultR\x0fdesiredRevision\x121\n" +
	...
	"numReports\x12?\n" +
	"\bpreviews\x183 \x03(\v2#.steam.PublishedFileDetails.PreviewR\bpreviews\x123\n" +
	"\x04tags\x184 \x03(\v2\x1f.steam.PublishedFileDetails.TagR\x04tags\x12=\n" +
	"\bchildren\x185 \x03(\v2!.steam.PublishedFileDetails.ChildR\bchildren\x129\n" +
	"\x06kvtags\x186 \x03(\v2!.steam.PublishedFileDetails.KVTagR\x06kvtags\x12A\n" +
	"\tvote_data\x187 \x01(\v2$.steam.PublishedFileDetails.VoteDataR\bvoteData\x12P\n" +
	"\x0eplaytime_stats\x18@ \x01(\v2).steam.PublishedFileDetails.PlaytimeStatsR\rplaytimeStats\x12'\n" +
	"\x0ftime_subscribed\x188 \x01(\rR\x0etimeSubscribed\x12K\n" +
	"\rfor_sale_data\x189 \x01(\v2'.steam.PublishedFileDetails.ForSaleDataR\vforSaleData\x12\x1a\n" +
	...
	"\x1cmaybe_inappropriate_violence\x18B \x01(\bR\x1amaybeInappropriateViolence\x12P\n" +
	"\x15content_descriptorids\x18H \x03(\x0e2\x1b.steam.EContentDescriptorIDR\x14contentDescriptorids\x124\n" +
	"\x16revision_change_number\x18C \x01(\x04R\x14revisionChangeNumber\x12[\n" +
	"\brevision\x18D \x01(\x0e2\x1d.steam.EPublishedFileRevision: k_EPublishedFileRevision_DefaultR\brevision\x12N\n" +
	"\x13available_revisions\x18E \x03(\x0e2\x1d.steam.EPublishedFileRevisionR\x12availableRevisions\x12B\n" +
	"\treactions\x18F \x03(\v2$.steam.PublishedFileDetails.ReactionR\treactions\x12u\n" +
	"\x15ban_text_check_result\x18G \x01(\x0e2\x1d.steam.EBanContentCheckResult:#k_EBanContentCheckResult_NotScannedR\x12banTextCheckResult\x12!\n" +
	"\fsearch_score\x18I \x01(\x02R\vsearchScore\x12*\n" +
	"\x11external_asset_id\x18J \x01(\x04R\x0fexternalAssetId\x12M\n" +
	"\x10author_snapshots\x18K \x03(\v2\".steam.PublishedFileAuthorSnapshotR\x0fauthorSnapshots\x1aX\n" +
	"\x03Tag\x12\x10\n" +
	...
	"\x12trusted_votes_down\x18\x06 \x01(\rR\x10trustedVotesDown\x1a\xc4\x02\n" +
	"\vForSaleData\x12\x1e\n" +
	"\vis_for_sale\x18\x01 \x01(\bR\tisForSale\x12%\n" +
	"\x0eprice_category\x18\x02 \x01(\rR\rpriceCategory\x12P\n" +
	"\aestatus\x18\x03 \x01(\x0e2\".steam.EPublishedFileForSaleStatus:\x12k_PFFSS_NotForSaleR\aestatus\x120\n" +
	...
	"\"CPublishedFile_GetDetails_Response\x12O\n" +
	"\x14publishedfiledetails\x18\x01 \x03(\v2\x1b.steam.PublishedFileDetailsR\x14publishedfiledetails\"\xfd\x03\n" +
	"\"CPublishedFile_GetItemInfo_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12*\n" +
	"\x11last_time_updated\x18\x02 \x01(\rR\x0flastTimeUpdated\x12]\n" +
	"\x0eworkshop_items\x18\x03 \x03(\v26.steam.CPublishedFile_GetItemInfo_Request.WorkshopItemR\rworkshopItems\x12j\n" +
	"\x10desired_revision\x18\x04 \x01(\x0e2\x1d.steam.EPublishedFileRevision: k_EPublishedFileRevision_DefaultR\x0fdesiredRevision\x1a\xc9\x01\n" +
	"\fWorkshopItem\x12*\n" +
	"\x11published_file_id\x18\x01 \x01(\x06R\x0fpublishedFileId\x12!\n" +
	"\ftime_updated\x18\x02 \x01(\rR\vtimeUpdated\x12j\n" +
	"\x10desired_revision\x18\x03 \x01(\x0e2\x1d.steam.EPublishedFileRevision: k_EPublishedFileRevision_DefaultR\x0fdesiredRevision\"\x96\x04\n" +
	"#CPublishedFile_GetItemInfo_Response\x12\x1f\n" +
	"\vupdate_time\x18\x01 \x01(\rR\n" +
	"updateTime\x12b\n" +
	"\x0eworkshop_items\x18\x02 \x03(\v2;.steam.CPublishedFile_GetItemInfo_Response.WorkshopItemInfoR\rworkshopItems\x12#\n" +
	"\rprivate_items\x18\x03 \x03(\x06R\fprivateItems\x1a\xc4\x02\n" +
	...
	"\brevision\x18\x05 \x01(\x0e2\x1d.steam.EPublishedFileRevision: k_EPublishedFileRevision_DefaultR\brevision\x12M\n" +
	"\x10author_snapshots\x18\x06 \x03(\v2\".steam.PublishedFileAuthorSnapshotR\x0fauthorSnapshots\"\xaa\r\n" +
	...
	"\fexcludedtags\x18\v \x03(\tR\fexcludedtags\x12Z\n" +
	"\x10required_kv_tags\x18\x1e \x03(\v20.steam.CPublishedFile_GetUserFiles_Request.KVTagR\x0erequiredKvTags\x12\x1a\n" +
	...
	"\blanguage\x18\x1d \x01(\x05:\x010R\blanguage\x12Q\n" +
	"\ttaggroups\x18\" \x03(\v23.steam.CPublishedFile_GetUserFiles_Request.TagGroupR\ttaggroups\x12]\n" +
	"\x1cexcluded_content_descriptors\x18% \x03(\x0e2\x1b.steam.EContentDescriptorIDR\x1aexcludedContentDescriptors\x12\x1f\n" +
	...
	"\x13startindex_override\x18\x19 \x01(\rR\x12startindexOverride\x12j\n" +
	"\x10desired_revision\x18! \x01(\x0e2\x1d.steam.EPublishedFileRevision: k_EPublishedFileRevision_DefaultR\x0fdesiredRevision\x12\x1f\n" +
	...
	"\bTagGroup\x12\x12\n" +
	"\x04tags\x18\x01 \x03(\tR\x04tags\"\xdd\x02\n" +
	"$CPublishedFile_GetUserFiles_Response\x12\x14\n" +
	"\x05total\x18\x01 \x01(\rR\x05total\x12\x1e\n" +
	"\n" +
	"startindex\x18\x02 \x01(\rR\n" +
	"startindex\x12O\n" +
	"\x14publishedfiledetails\x18\x03 \x03(\v2\x1b.steam.PublishedFileDetailsR\x14publishedfiledetails\x12C\n" +
	"\x04apps\x18\x04 \x03(\v2/.steam.CPublishedFile_GetUserFiles_Response.AppR\x04apps\x1ai\n" +
	"\x03App\x12\x14\n" +
	...
	"\x10workshopfiletype\x18\x05 \x01(\rR\x10workshopfiletype\"\xd8\x01\n" +
	"2CPublishedFile_AreFilesInSubscriptionList_Response\x12V\n" +
	"\x05files\x18\x01 \x03(\v2@.steam.CPublishedFile_AreFilesInSubscriptionList_Response.InListR\x05files\x1aJ\n" +
	"\x06InList\x12(\n" +
	...
	"\blanguage\x18\x05 \x01(\x05:\x010R\blanguage\"\xe4\x03\n" +
	"(CPublishedFile_GetChangeHistory_Response\x12S\n" +
	"\achanges\x18\x01 \x03(\v29.steam.CPublishedFile_GetChangeHistory_Response.ChangeLogR\achanges\x12\x14\n" +
	...
	"manifestId\x12\x1c\n" +
	"\taccountid\x18\b \x01(\rR\taccountid\"\xee\x02\n" +
	...
	"\x12desired_queue_size\x18\x06 \x01(\rR\x10desiredQueueSize\x12j\n" +
	"\x10desired_revision\x18\b \x01(\x0e2\x1d.steam.EPublishedFileRevision: k_EPublishedFileRevision_DefaultR\x0fdesiredRevision\",\n" +
	"*CPublishedFile_RefreshVotingQueue_Response\"\x87\x10\n" +
	...
	"\blanguage\x18! \x01(\x05:\x010R\blanguage\x12X\n" +
	"\x10required_kv_tags\x18\" \x03(\v2..steam.CPublishedFile_QueryFiles_Request.KVTagR\x0erequiredKvTags\x12O\n" +
	"\ttaggroups\x18* \x03(\v21.steam.CPublishedFile_QueryFiles_Request.TagGroupR\ttaggroups\x12`\n" +
	"\x12date_range_created\x18, \x01(\v22.steam.CPublishedFile_QueryFiles_Request.DateRangeR\x10dateRangeCreated\x12`\n" +
	"\x12date_range_updated\x18- \x01(\v22.steam.CPublishedFile_QueryFiles_Request.DateRangeR\x10dateRangeUpdated\x12]\n" +
	"\x1cexcluded_content_descriptors\x18. \x03(\x0e2\x1b.steam.EContentDescriptorIDR\x1aexcludedContentDescriptors\x12\x1f\n" +
	"\vadmin_query\x18/ \x01(\bR\n" +
	"adminQuery\x12\x1c\n" +
	...
	"\x18strip_description_bbcode\x18& \x01(\bR\x16stripDescriptionBbcode\x12j\n" +
	"\x10desired_revision\x18( \x01(\x0e2\x1d.steam.EPublishedFileRevision: k_EPublishedFileRevision_DefaultR\x0fdesiredRevision\x120\n" +
	...
	"\rtimestamp_end\x18\x02 \x01(\rR\ftimestampEnd\"\xac\x01\n" +
	"\"CPublishedFile_QueryFiles_Response\x12\x14\n" +
	"\x05total\x18\x01 \x01(\rR\x05total\x12O\n" +
	"\x14publishedfiledetails\x18\x02 \x03(\v2\x1b.steam.PublishedFileDetailsR\x14publishedfiledetails\x12\x1f\n" +
	...
	"\x0fpublishedfileid\x18\x01 \x01(\x04R\x0fpublishedfileid\"\xeb\x01\n" +
	"+CPublishedFile_GetAppRelationships_Response\x12o\n" +
	"\x11app_relationships\x18\x03 \x03(\v2B.steam.CPublishedFile_GetAppRelationships_Response.AppRelationshipR\x10appRelationships\x1aK\n" +
	...
	"\x13filter_relationship\x18\x02 \x01(\rR\x12filterRelationship\"\xda\x03\n" +
	"2CPublishedFile_GetAppRelationshipsBatched_Response\x12|\n" +
	"\rrelationships\x18\x01 \x03(\v2V.steam.CPublishedFile_GetAppRelationshipsBatched_Response.PublishedFileAppRelationshipR\rrelationships\x1aK\n" +
	"\x0fAppRelationship\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12\"\n" +
	"\frelationship\x18\x02 \x01(\rR\frelationship\x1a\xd8\x01\n" +
	"\x1cPublishedFileAppRelationship\x12(\n" +
	"\x0fpublishedfileid\x18\x01 \x01(\x04R\x0fpublishedfileid\x12\x16\n" +
	"\x06result\x18\x02 \x01(\rR\x06result\x12v\n" +
	"\x11app_relationships\x18\x03 \x03(\v2I.steam.CPublishedFile_GetAppRelationshipsBatched_Response.AppRelationshipR\x10appRelationships\"p\n" +
	...
	":CPublishedFile_StopPlaytimeTrackingForAllAppItems_Response\"\xc6\x02\n" +
	"6CPublishedFile_SetPlaytimeForControllerConfigs_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12\x8b\x01\n" +
	"\x17controller_config_usage\x18\x02 \x03(\v2S.steam.CPublishedFile_SetPlaytimeForControllerConfigs_Request.ControllerConfigUsageR\x15controllerConfigUsage\x1ah\n" +
	...
	"\x10publishedfileids\x18\x01 \x03(\x06R\x10publishedfileids\"\x9d\x02\n" +
	"*CPublishedFile_GetUserVoteSummary_Response\x12[\n" +
	"\tsummaries\x18\x01 \x03(\v2=.steam.CPublishedFile_GetUserVoteSummary_Response.VoteSummaryR\tsummaries\x1a\x91\x01\n" +
	"\vVoteSummary\x12(\n" +
	...
	"\breported\x18\x04 \x01(\bR\breported\"\xf9\x01\n" +
	"%CPublishedFile_GetItemChanges_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12*\n" +
	"\x11last_time_updated\x18\x02 \x01(\rR\x0flastTimeUpdated\x12\"\n" +
	"\rnum_items_max\x18\x03 \x01(\rR\vnumItemsMax\x12j\n" +
	"\x10desired_revision\x18\x04 \x01(\x0e2\x1d.steam.EPublishedFileRevision: k_EPublishedFileRevision_DefaultR\x0fdesiredRevision\"\x84\x03\n" +
	"&CPublishedFile_GetItemChanges_Response\x12\x1f\n" +
	"\vupdate_time\x18\x01 \x01(\rR\n" +
	"updateTime\x12e\n" +
	"\x0eworkshop_items\x18\x02 \x03(\v2>.steam.CPublishedFile_GetItemChanges_Response.WorkshopItemInfoR\rworkshopItems\x1a\xd1\x01\n" +
	"\x10WorkshopItemInfo\x12*\n" +
	"\x11published_file_id\x18\x01 \x01(\x06R\x0fpublishedFileId\x12!\n" +
	"\ftime_updated\x18\x02 \x01(\rR\vtimeUpdated\x12\x1f\n" +
	"\vmanifest_id\x18\x03 \x01(\x06R\n" +
	"manifestId\x12M\n" +
	"\x10author_snapshots\x18\x04 \x03(\v2\".steam.PublishedFileAuthorSnapshotR\x0fauthorSnapshots\"X\n" +
	",CPublishedFile_GetContentDescriptors_Request\x12(\n" +
	"\x0fpublishedfileid\x18\x01 \x01(\x06R\x0fpublishedfileid\"\x8c\x03\n" +
	"-CPublishedFile_GetContentDescriptors_Response\x12w\n" +
	"\x13content_descriptors\x18\x01 \x03(\v2F.steam.CPublishedFile_GetContentDescriptors_Response.ContentDescriptorR\x12contentDescriptors\x1a\xe1\x01\n" +
	"\x11ContentDescriptor\x12k\n" +
	"\fdescriptorid\x18\x01 \x01(\x0e2\x1b.steam.EContentDescriptorID:*k_EContentDescriptor_NudityOrSexualContentR\fdescriptorid\x12\x1c\n" +
	"\taccountid\x18\x02 \x01(\rR\taccountid\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\rR\ttimestamp\x12#\n" +
	"\rmoderator_set\x18\x04 \x01(\bR\fmoderatorSet\"\xf7\x01\n" +
	"/CPublishedFile_UpdateContentDescriptors_Request\x12(\n" +
	"\x0fpublishedfileid\x18\x01 \x01(\x06R\x0fpublishedfileid\x12I\n" +
	"\x12descriptors_to_add\x18\x02 \x03(\x0e2\x1b.steam.EContentDescriptorIDR\x10descriptorsToAdd\x12O\n" +
	"\x15descriptors_to_remove\x18\x03 \x03(\x0e2\x1b.steam.EContentDescriptorIDR\x13descriptorsToRemove\"_\n" +
	"0CPublishedFile_UpdateContentDescriptors_Response\x12+\n" +
	"\x11timestamp_updated\x18\x01 \x01(\rR\x10timestampUpdated\"\xee\x05\n" +
	...
	"\rrtime_updated\x18\a \x01(\rR\frtimeUpdated\x12[\n" +
	"\brevision\x18\t \x01(\x0e2\x1d.steam.EPublishedFileRevision: k_EPublishedFileRevision_DefaultR\brevision\x12\\\n" +
	"\trevisions\x18\b \x03(\v2>.steam.CPublishedFile_FileSubscribed_Notification.RevisionDataR\trevisions\x1a\x85\x02\n" +
	"\fRevisionData\x12[\n" +
	"\brevision\x18\x01 \x01(\x0e2\x1d.steam.EPublishedFileRevision: k_EPublishedFileRevision_DefaultR\brevision\x12#\n" +
	...
	"\x19k_PFFSS_TentativeApproval\x10\x052\xef\x1e\n" +
	"\rPublishedFile\x12O\n" +
	"\x04Vote\x12\".steam.CPublishedFile_Vote_Request\x1a#.steam.CPublishedFile_Vote_Response\x12^\n" +
	"\tSubscribe\x12'.steam.CPublishedFile_Subscribe_Request\x1a(.steam.CPublishedFile_Subscribe_Response\x12d\n" +
	"\vUnsubscribe\x12).steam.CPublishedFile_Unsubscribe_Request\x1a*.steam.CPublishedFile_Unsubscribe_Response\x12g\n" +
	"\fCanSubscribe\x12*.steam.CPublishedFile_CanSubscribe_Request\x1a+.steam.CPublishedFile_CanSubscribe_Response\x12v\n" +
	"\x11GetSubSectionData\x12/.steam.CPublishedFile_GetSubSectionData_Request\x1a0.steam.CPublishedFile_GetSubSectionData_Response\x12X\n" +
	"\aPublish\x12%.steam.CPublishedFile_Publish_Request\x1a&.steam.CPublishedFile_Publish_Response\x12a\n" +
	"\n" +
	"GetDetails\x12(.steam.CPublishedFile_GetDetails_Request\x1a).steam.CPublishedFile_GetDetails_Response\x12d\n" +
	"\vGetItemInfo\x12).steam.CPublishedFile_GetItemInfo_Request\x1a*.steam.CPublishedFile_GetItemInfo_Response\x12g\n" +
	"\fGetUserFiles\x12*.steam.CPublishedFile_GetUserFiles_Request\x1a+.steam.CPublishedFile_GetUserFiles_Response\x12k\n" +
	"\x10GetUserFileCount\x12*.steam.CPublishedFile_GetUserFiles_Request\x1a+.steam.CPublishedFile_GetUserFiles_Response\x12\x91\x01\n" +
	"\x1aAreFilesInSubscriptionList\x128.steam.CPublishedFile_AreFilesInSubscriptionList_Request\x1a9.steam.CPublishedFile_AreFilesInSubscriptionList_Response\x12U\n" +
	"\x06Update\x12$.steam.CPublishedFile_Update_Request\x1a%.steam.CPublishedFile_Update_Response\x12U\n" +
	"\x06Delete\x12$.steam.CPublishedFile_Delete_Request\x1a%.steam.CPublishedFile_Delete_Response\x12\x82\x01\n" +
	"\x15GetChangeHistoryEntry\x123.steam.CPublishedFile_GetChangeHistoryEntry_Request\x1a4.steam.CPublishedFile_GetChangeHistoryEntry_Response\x12s\n" +
	"\x10GetChangeHistory\x12..steam.CPublishedFile_GetChangeHistory_Request\x1a/.steam.CPublishedFile_GetChangeHistory_Response\x12y\n" +
	"\x12RefreshVotingQueue\x120.steam.CPublishedFile_RefreshVotingQueue_Request\x1a1.steam.CPublishedFile_RefreshVotingQueue_Response\x12a\n" +
	"\n" +
	"QueryFiles\x12(.steam.CPublishedFile_QueryFiles_Request\x1a).steam.CPublishedFile_QueryFiles_Response\x12y\n" +
	"\x12AddAppRelationship\x120.steam.CPublishedFile_AddAppRelationship_Request\x1a1.steam.CPublishedFile_AddAppRelationship_Response\x12\x82\x01\n" +
	"\x15RemoveAppRelationship\x123.steam.CPublishedFile_RemoveAppRelationship_Request\x1a4.steam.CPublishedFile_RemoveAppRelationship_Response\x12|\n" +
	"\x13GetAppRelationships\x121.steam.CPublishedFile_GetAppRelationships_Request\x1a2.steam.CPublishedFile_GetAppRelationships_Response\x12\x91\x01\n" +
	"\x1aGetAppRelationshipsBatched\x128.steam.CPublishedFile_GetAppRelationshipsBatched_Request\x1a9.steam.CPublishedFile_GetAppRelationshipsBatched_Response\x12\x82\x01\n" +
	"\x15StartPlaytimeTracking\x123.steam.CPublishedFile_StartPlaytimeTracking_Request\x1a4.steam.CPublishedFile_StartPlaytimeTracking_Response\x12\x7f\n" +
	"\x14StopPlaytimeTracking\x122.steam.CPublishedFile_StopPlaytimeTracking_Request\x1a3.steam.CPublishedFile_StopPlaytimeTracking_Response\x12\xa9\x01\n" +
	"\"StopPlaytimeTrackingForAllAppItems\x12@.steam.CPublishedFile_StopPlaytimeTrackingForAllAppItems_Request\x1aA.steam.CPublishedFile_StopPlaytimeTrackingForAllAppItems_Response\x12\xa0\x01\n" +
	"\x1fSetPlaytimeForControllerConfigs\x12=.steam.CPublishedFile_SetPlaytimeForControllerConfigs_Request\x1a>.steam.CPublishedFile_SetPlaytimeForControllerConfigs_Response\x12[\n" +
	"\bAddChild\x12&.steam.CPublishedFile_AddChild_Request\x1a'.steam.CPublishedFile_AddChild_Response\x12d\n" +
	"\vRemoveChild\x12).steam.CPublishedFile_RemoveChild_Request\x1a*.steam.CPublishedFile_RemoveChild_Response\x12\x82\x01\n" +
	"\x15SetCollectionChildren\x123.steam.CPublishedFile_SetCollectionChildren_Request\x1a4.steam.CPublishedFile_SetCollectionChildren_Response\x12\xa6\x01\n" +
	"!SetSubscriptionListFromCollection\x12?.steam.CPublishedFile_SetSubscriptionListFromCollection_Request\x1a@.steam.CPublishedFile_SetSubscriptionListFromCollection_Response\x12y\n" +
	"\x12GetUserVoteSummary\x120.steam.CPublishedFile_GetUserVoteSummary_Request\x1a1.steam.CPublishedFile_GetUserVoteSummary_Response\x12m\n" +
	"\x0eGetItemChanges\x12,.steam.CPublishedFile_GetItemChanges_Request\x1a-.steam.CPublishedFile_GetItemChanges_Response\x12\x82\x01\n" +
	"\x15GetContentDescriptors\x123.steam.CPublishedFile_GetContentDescriptors_Request\x1a4.steam.CPublishedFile_GetContentDescriptors_Response\x12\x8b\x01\n" +
	"\x18UpdateContentDescriptors\x126.steam.CPublishedFile_UpdateContentDescriptors_Request\x1a7.steam.CPublishedFile_UpdateContentDescriptors_Response2\xba\x02\n" +
	"\x13PublishedFileClient\x12\\\n" +
	"\x14NotifyFileSubscribed\x121.steam.CPublishedFile_FileSubscribed_Notification\x1a\x11.steam.NoResponse\x12`\n" +
	"\x16NotifyFileUnsubscribed\x123.steam.CPublishedFile_FileUnsubscribed_Notification\x1a\x11.steam.NoResponse\x12]\n" +
	"\x11NotifyFileDeleted\x125.steam.CPublishedFile_FileDeleted_Client_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x02B3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_publishedfile_steamclient_proto_goTypes = []any{
	...
	(*CPublishedFile_Vote_Request)(nil),                                                     // 2: steam.CPublishedFile_Vote_Request
	(*CPublishedFile_Vote_Response)(nil),                                                    // 3: steam.CPublishedFile_Vote_Response
	(*CPublishedFile_Subscribe_Request)(nil),                                                // 4: steam.CPublishedFile_Subscribe_Request
	(*CPublishedFile_Subscribe_Response)(nil),                                               // 5: steam.CPublishedFile_Subscribe_Response
	(*CPublishedFile_Unsubscribe_Request)(nil),                                              // 6: steam.CPublishedFile_Unsubscribe_Request
	(*CPublishedFile_Unsubscribe_Response)(nil),                                             // 7: steam.CPublishedFile_Unsubscribe_Response
	(*CPublishedFile_CanSubscribe_Request)(nil),                                             // 8: steam.CPublishedFile_CanSubscribe_Request
	(*CPublishedFile_CanSubscribe_Response)(nil),                                            // 9: steam.CPublishedFile_CanSubscribe_Response
	(*CPublishedFile_GetSubSectionData_Request)(nil),                                        // 10: steam.CPublishedFile_GetSubSectionData_Request
	(*PublishedFileSubSection)(nil),                                                         // 11: steam.PublishedFileSubSection
	(*CPublishedFile_GetSubSectionData_Response)(nil),                                       // 12: steam.CPublishedFile_GetSubSectionData_Response
	(*CPublishedFile_Publish_Request)(nil),                                                  // 13: steam.CPublishedFile_Publish_Request
	(*CPublishedFile_Publish_Response)(nil),                                                 // 14: steam.CPublishedFile_Publish_Response
	(*CPublishedFile_GetDetails_Request)(nil),                                               // 15: steam.CPublishedFile_GetDetails_Request
	(*PublishedFileAuthorSnapshot)(nil),                                                     // 16: steam.PublishedFileAuthorSnapshot
	(*PublishedFileDetails)(nil),                                                            // 17: steam.PublishedFileDetails
	(*CPublishedFile_GetDetails_Response)(nil),                                              // 18: steam.CPublishedFile_GetDetails_Response
	(*CPublishedFile_GetItemInfo_Request)(nil),                                              // 19: steam.CPublishedFile_GetItemInfo_Request
	(*CPublishedFile_GetItemInfo_Response)(nil),                                             // 20: steam.CPublishedFile_GetItemInfo_Response
	(*CPublishedFile_GetUserFiles_Request)(nil),                                             // 21: steam.CPublishedFile_GetUserFiles_Request
	(*CPublishedFile_GetUserFiles_Response)(nil),                                            // 22: steam.CPublishedFile_GetUserFiles_Response
	(*CPublishedFile_AreFilesInSubscriptionList_Request)(nil),                               // 23: steam.CPublishedFile_AreFilesInSubscriptionList_Request
	(*CPublishedFile_AreFilesInSubscriptionList_Response)(nil),                              // 24: steam.CPublishedFile_AreFilesInSubscriptionList_Response
	(*CPublishedFile_Update_Request)(nil),                                                   // 25: steam.CPublishedFile_Update_Request
	(*CPublishedFile_Update_Response)(nil),                                                  // 26: steam.CPublishedFile_Update_Response
	(*CPublishedFile_Delete_Request)(nil),                                                   // 27: steam.CPublishedFile_Delete_Request
	(*CPublishedFile_Delete_Response)(nil),                                                  // 28: steam.CPublishedFile_Delete_Response
	(*CPublishedFile_GetChangeHistoryEntry_Request)(nil),                                    // 29: steam.CPublishedFile_GetChangeHistoryEntry_Request
	(*CPublishedFile_GetChangeHistoryEntry_Response)(nil),                                   // 30: steam.CPublishedFile_GetChangeHistoryEntry_Response
	(*CPublishedFile_GetChangeHistory_Request)(nil),                                         // 31: steam.CPublishedFile_GetChangeHistory_Request
	(*CPublishedFile_GetChangeHistory_Response)(nil),                                        // 32: steam.CPublishedFile_GetChangeHistory_Response
	(*CPublishedFile_RefreshVotingQueue_Request)(nil),                                       // 33: steam.CPublishedFile_RefreshVotingQueue_Request
	(*CPublishedFile_RefreshVotingQueue_Response)(nil),                                      // 34: steam.CPublishedFile_RefreshVotingQueue_Response
	(*CPublishedFile_QueryFiles_Request)(nil),                                               // 35: steam.CPublishedFile_QueryFiles_Request
	(*CPublishedFile_QueryFiles_Response)(nil),                                              // 36: steam.CPublishedFile_QueryFiles_Response
	(*CPublishedFile_AddAppRelationship_Request)(nil),                                       // 37: steam.CPublishedFile_AddAppRelationship_Request
	(*CPublishedFile_AddAppRelationship_Response)(nil),                                      // 38: steam.CPublishedFile_AddAppRelationship_Response
	(*CPublishedFile_RemoveAppRelationship_Request)(nil),                                    // 39: steam.CPublishedFile_RemoveAppRelationship_Request
	(*CPublishedFile_RemoveAppRelationship_Response)(nil),                                   // 40: steam.CPublishedFile_RemoveAppRelationship_Response
	(*CPublishedFile_GetAppRelationships_Request)(nil),                                      // 41: steam.CPublishedFile_GetAppRelationships_Request
	(*CPublishedFile_GetAppRelationships_Response)(nil),                                     // 42: steam.CPublishedFile_GetAppRelationships_Response
	(*CPublishedFile_GetAppRelationshipsBatched_Request)(nil),                               // 43: steam.CPublishedFile_GetAppRelationshipsBatched_Request
	(*CPublishedFile_GetAppRelationshipsBatched_Response)(nil),                              // 44: steam.CPublishedFile_GetAppRelationshipsBatched_Response
	(*CPublishedFile_StartPlaytimeTracking_Request)(nil),                                    // 45: steam.CPublishedFile_StartPlaytimeTracking_Request
	(*CPublishedFile_StartPlaytimeTracking_Response)(nil),                                   // 46: steam.CPublishedFile_StartPlaytimeTracking_Response
	(*CPublishedFile_StopPlaytimeTracking_Request)(nil),                                     // 47: steam.CPublishedFile_StopPlaytimeTracking_Request
	(*CPublishedFile_StopPlaytimeTracking_Response)(nil),                                    // 48: steam.CPublishedFile_StopPlaytimeTracking_Response
	(*CPublishedFile_StopPlaytimeTrackingForAllAppItems_Request)(nil),                       // 49: steam.CPublishedFile_StopPlaytimeTrackingForAllAppItems_Request
	(*CPublishedFile_StopPlaytimeTrackingForAllAppItems_Response)(nil),                      // 50: steam.CPublishedFile_StopPlaytimeTrackingForAllAppItems_Response
	(*CPublishedFile_SetPlaytimeForControllerConfigs_Request)(nil),                          // 51: steam.CPublishedFile_SetPlaytimeForControllerConfigs_Request
	(*CPublishedFile_SetPlaytimeForControllerConfigs_Response)(nil),                         // 52: steam.CPublishedFile_SetPlaytimeForControllerConfigs_Response
	(*CPublishedFile_AddChild_Request)(nil),                                                 // 53: steam.CPublishedFile_AddChild_Request
	(*CPublishedFile_AddChild_Response)(nil),                                                // 54: steam.CPublishedFile_AddChild_Response
	(*CPublishedFile_RemoveChild_Request)(nil),                                              // 55: steam.CPublishedFile_RemoveChild_Request
	(*CPublishedFile_RemoveChild_Response)(nil),                                             // 56: steam.CPublishedFile_RemoveChild_Response
	(*CPublishedFile_SetCollectionChildren_Request)(nil),                                    // 57: steam.CPublishedFile_SetCollectionChildren_Request
	(*CPublishedFile_SetCollectionChildren_Response)(nil),                                   // 58: steam.CPublishedFile_SetCollectionChildren_Response
	(*CPublishedFile_SetSubscriptionListFromCollection_Request)(nil),                        // 59: steam.CPublishedFile_SetSubscriptionListFromCollection_Request
	(*CPublishedFile_SetSubscriptionListFromCollection_Response)(nil),                       // 60: steam.CPublishedFile_SetSubscriptionListFromCollection_Response
	(*CPublishedFile_GetUserVoteSummary_Request)(nil),                                       // 61: steam.CPublishedFile_GetUserVoteSummary_Request
	(*CPublishedFile_GetUserVoteSummary_Response)(nil),                                      // 62: steam.CPublishedFile_GetUserVoteSummary_Response
	(*CPublishedFile_GetItemChanges_Request)(nil),                                           // 63: steam.CPublishedFile_GetItemChanges_Request
	(*CPublishedFile_GetItemChanges_Response)(nil),                                          // 64: steam.CPublishedFile_GetItemChanges_Response
	(*CPublishedFile_GetContentDescriptors_Request)(nil),                                    // 65: steam.CPublishedFile_GetContentDescriptors_Request
	(*CPublishedFile_GetContentDescriptors_Response)(nil),                                   // 66: steam.CPublishedFile_GetContentDescriptors_Response
	(*CPublishedFile_UpdateContentDescriptors_Request)(nil),                                 // 67: steam.CPublishedFile_UpdateContentDescriptors_Request
	(*CPublishedFile_UpdateContentDescriptors_Response)(nil),                                // 68: steam.CPublishedFile_UpdateContentDescriptors_Response
	(*CPublishedFile_FileSubscribed_Notification)(nil),                                      // 69: steam.CPublishedFile_FileSubscribed_Notification
	(*CPublishedFile_FileUnsubscribed_Notification)(nil),                                    // 70: steam.CPublishedFile_FileUnsubscribed_Notification
	(*CPublishedFile_FileDeleted_Client_Notification)(nil),                                  // 71: steam.CPublishedFile_FileDeleted_Client_Notification
	(*PublishedFileDetails_Tag)(nil),                                                        // 72: steam.PublishedFileDetails.Tag
	(*PublishedFileDetails_Preview)(nil),                                                    // 73: steam.PublishedFileDetails.Preview
	(*PublishedFileDetails_Child)(nil),                                                      // 74: steam.PublishedFileDetails.Child
	(*PublishedFileDetails_KVTag)(nil),                                                      // 75: steam.PublishedFileDetails.KVTag
	(*PublishedFileDetails_VoteData)(nil),                                                   // 76: steam.PublishedFileDetails.VoteData
	(*PublishedFileDetails_ForSaleData)(nil),                                                // 77: steam.PublishedFileDetails.ForSaleData
	(*PublishedFileDetails_PlaytimeStats)(nil),                                              // 78: steam.PublishedFileDetails.PlaytimeStats
	(*PublishedFileDetails_Reaction)(nil),                                                   // 79: steam.PublishedFileDetails.Reaction
	(*CPublishedFile_GetItemInfo_Request_WorkshopItem)(nil),                                 // 80: steam.CPublishedFile_GetItemInfo_Request.WorkshopItem
	(*CPublishedFile_GetItemInfo_Response_WorkshopItemInfo)(nil),                            // 81: steam.CPublishedFile_GetItemInfo_Response.WorkshopItemInfo
	(*CPublishedFile_GetUserFiles_Request_KVTag)(nil),                                       // 82: steam.CPublishedFile_GetUserFiles_Request.KVTag
	(*CPublishedFile_GetUserFiles_Request_TagGroup)(nil),                                    // 83: steam.CPublishedFile_GetUserFiles_Request.TagGroup
	(*CPublishedFile_GetUserFiles_Response_App)(nil),                                        // 84: steam.CPublishedFile_GetUserFiles_Response.App
	(*CPublishedFile_AreFilesInSubscriptionList_Response_InList)(nil),                       // 85: steam.CPublishedFile_AreFilesInSubscriptionList_Response.InList
	(*CPublishedFile_GetChangeHistory_Response_ChangeLog)(nil),                              // 86: steam.CPublishedFile_GetChangeHistory_Response.ChangeLog
	(*CPublishedFile_QueryFiles_Request_KVTag)(nil),                                         // 87: steam.CPublishedFile_QueryFiles_Request.KVTag
	(*CPublishedFile_QueryFiles_Request_TagGroup)(nil),                                      // 88: steam.CPublishedFile_QueryFiles_Request.TagGroup
	(*CPublishedFile_QueryFiles_Request_DateRange)(nil),                                     // 89: steam.CPublishedFile_QueryFiles_Request.DateRange
	(*CPublishedFile_GetAppRelationships_Response_AppRelationship)(nil),                     // 90: steam.CPublishedFile_GetAppRelationships_Response.AppRelationship
	(*CPublishedFile_GetAppRelationshipsBatched_Response_AppRelationship)(nil),              // 91: steam.CPublishedFile_GetAppRelationshipsBatched_Response.AppRelationship
	(*CPublishedFile_GetAppRelationshipsBatched_Response_PublishedFileAppRelationship)(nil), // 92: steam.CPublishedFile_GetAppRelationshipsBatched_Response.PublishedFileAppRelationship
	(*CPublishedFile_SetPlaytimeForControllerConfigs_Request_ControllerConfigUsage)(nil),    // 93: steam.CPublishedFile_SetPlaytimeForControllerConfigs_Request.ControllerConfigUsage
	(*CPublishedFile_GetUserVoteSummary_Response_VoteSummary)(nil),                          // 94: steam.CPublishedFile_GetUserVoteSummary_Response.VoteSummary
	(*CPublishedFile_GetItemChanges_Response_WorkshopItemInfo)(nil),                         // 95: steam.CPublishedFile_GetItemChanges_Response.WorkshopItemInfo
	(*CPublishedFile_GetContentDescriptors_Response_ContentDescriptor)(nil),                 // 96: steam.CPublishedFile_GetContentDescriptors_Response.ContentDescriptor
	(*CPublishedFile_FileSubscribed_Notification_RevisionData)(nil),                         // 97: steam.CPublishedFile_FileSubscribed_Notification.RevisionData
	(EContentDescriptorID)(0),                                                               // 98: steam.EContentDescriptorID
	(EBanContentCheckResult)(0),                                                             // 99: steam.EBanContentCheckResult
	(*NoResponse)(nil),                                                                      // 100: steam.NoResponse
}
var file_steammessages_publishedfile_steamclient_proto_depIdxs = []int32{
	0,   // 0: steam.CPublishedFile_GetSubSectionData_Request.desired_revision:type_name -> steam.EPublishedFileRevision
	11,  // 1: steam.CPublishedFile_GetSubSectionData_Response.sub_sections:type_name -> steam.PublishedFileSubSection
	0,   // 2: steam.CPublishedFile_GetDetails_Request.desired_revision:type_name -> steam.EPublishedFileRevision
	73,  // 3: steam.PublishedFileDetails.previews:type_name -> steam.PublishedFileDetails.Preview
	72,  // 4: steam.PublishedFileDetails.tags:type_name -> steam.PublishedFileDetails.Tag
	74,  // 5: steam.PublishedFileDetails.children:type_name -> steam.PublishedFileDetails.Child
	75,  // 6: steam.PublishedFileDetails.kvtags:type_name -> steam.PublishedFileDetails.KVTag
	76,  // 7: steam.PublishedFileDetails.vote_data:type_name -> steam.PublishedFileDetails.VoteData
	78,  // 8: steam.PublishedFileDetails.playtime_stats:type_name -> steam.PublishedFileDetails.PlaytimeStats
	77,  // 9: steam.PublishedFileDetails.for_sale_data:type_name -> steam.PublishedFileDetails.ForSaleData
	98,  // 10: steam.PublishedFileDetails.content_descriptorids:type_name -> steam.EContentDescriptorID
	0,   // 11: steam.PublishedFileDetails.revision:type_name -> steam.EPublishedFileRevision
	0,   // 12: steam.PublishedFileDetails.available_revisions:type_name -> steam.EPublishedFileRevision
	79,  // 13: steam.PublishedFileDetails.reactions:type_name -> steam.PublishedFileDetails.Reaction
	99,  // 14: steam.PublishedFileDetails.ban_text_check_result:type_name -> steam.EBanContentCheckResult
	16,  // 15: steam.PublishedFileDetails.author_snapshots:type_name -> steam.PublishedFileAuthorSnapshot
	17,  // 16: steam.CPublishedFile_GetDetails_Response.publishedfiledetails:type_name -> steam.PublishedFileDetails
	80,  // 17: steam.CPublishedFile_GetItemInfo_Request.workshop_items:type_name -> steam.CPublishedFile_GetItemInfo_Request.WorkshopItem
	0,   // 18: steam.CPublishedFile_GetItemInfo_Request.desired_revision:type_name -> steam.EPublishedFileRevision
	81,  // 19: steam.CPublishedFile_GetItemInfo_Response.workshop_items:type_name -> steam.CPublishedFile_GetItemInfo_Response.WorkshopItemInfo
	82,  // 20: steam.CPublishedFile_GetUserFiles_Request.required_kv_tags:type_name -> steam.CPublishedFile_GetUserFiles_Request.KVTag
	83,  // 21: steam.CPublishedFile_GetUserFiles_Request.taggroups:type_name -> steam.CPublishedFile_GetUserFiles_Request.TagGroup
	98,  // 22: steam.CPublishedFile_GetUserFiles_Request.excluded_content_descriptors:type_name -> steam.EContentDescriptorID
	0,   // 23: steam.CPublishedFile_GetUserFiles_Request.desired_revision:type_name -> steam.EPublishedFileRevision
	17,  // 24: steam.CPublishedFile_GetUserFiles_Response.publishedfiledetails:type_name -> steam.PublishedFileDetails
	84,  // 25: steam.CPublishedFile_GetUserFiles_Response.apps:type_name -> steam.CPublishedFile_GetUserFiles_Response.App
	85,  // 26: steam.CPublishedFile_AreFilesInSubscriptionList_Response.files:type_name -> steam.CPublishedFile_AreFilesInSubscriptionList_Response.InList
	86,  // 27: steam.CPublishedFile_GetChangeHistory_Response.changes:type_name -> steam.CPublishedFile_GetChangeHistory_Response.ChangeLog
	0,   // 28: steam.CPublishedFile_RefreshVotingQueue_Request.desired_revision:type_name -> steam.EPublishedFileRevision
	87,  // 29: steam.CPublishedFile_QueryFiles_Request.required_kv_tags:type_name -> steam.CPublishedFile_QueryFiles_Request.KVTag
	88,  // 30: steam.CPublishedFile_QueryFiles_Request.taggroups:type_name -> steam.CPublishedFile_QueryFiles_Request.TagGroup
	89,  // 31: steam.CPublishedFile_QueryFiles_Request.date_range_created:type_name -> steam.CPublishedFile_QueryFiles_Request.DateRange
	89,  // 32: steam.CPublishedFile_QueryFiles_Request.date_range_updated:type_name -> steam.CPublishedFile_QueryFiles_Request.DateRange
	98,  // 33: steam.CPublishedFile_QueryFiles_Request.excluded_content_descriptors:type_name -> steam.EContentDescriptorID
	0,   // 34: steam.CPublishedFile_QueryFiles_Request.desired_revision:type_name -> steam.EPublishedFileRevision
	17,  // 35: steam.CPublishedFile_QueryFiles_Response.publishedfiledetails:type_name -> steam.PublishedFileDetails
	90,  // 36: steam.CPublishedFile_GetAppRelationships_Response.app_relationships:type_name -> steam.CPublishedFile_GetAppRelationships_Response.AppRelationship
	92,  // 37: steam.CPublishedFile_GetAppRelationshipsBatched_Response.relationships:type_name -> steam.CPublishedFile_GetAppRelationshipsBatched_Response.PublishedFileAppRelationship
	93,  // 38: steam.CPublishedFile_SetPlaytimeForControllerConfigs_Request.controller_config_usage:type_name -> steam.CPublishedFile_SetPlaytimeForControllerConfigs_Request.ControllerConfigUsage
	94,  // 39: steam.CPublishedFile_GetUserVoteSummary_Response.summaries:type_name -> steam.CPublishedFile_GetUserVoteSummary_Response.VoteSummary
	0,   // 40: steam.CPublishedFile_GetItemChanges_Request.desired_revision:type_name -> steam.EPublishedFileRevision
	95,  // 41: steam.CPublishedFile_GetItemChanges_Response.workshop_items:type_name -> steam.CPublishedFile_GetItemChanges_Response.WorkshopItemInfo
	96,  // 42: steam.CPublishedFile_GetContentDescriptors_Response.content_descriptors:type_name -> steam.CPublishedFile_GetContentDescriptors_Response.ContentDescriptor
	98,  // 43: steam.CPublishedFile_UpdateContentDescriptors_Request.descriptors_to_add:type_name -> steam.EContentDescriptorID
	98,  // 44: steam.CPublishedFile_UpdateContentDescriptors_Request.descriptors_to_remove:type_name -> steam.EContentDescriptorID
	0,   // 45: steam.CPublishedFile_FileSubscribed_Notification.revision:type_name -> steam.EPublishedFileRevision
	97,  // 46: steam.CPublishedFile_FileSubscribed_Notification.revisions:type_name -> steam.CPublishedFile_FileSubscribed_Notification.RevisionData
	1,   // 47: steam.PublishedFileDetails.ForSaleData.estatus:type_name -> steam.EPublishedFileForSaleStatus
	0,   // 48: steam.CPublishedFile_GetItemInfo_Request.WorkshopItem.desired_revision:type_name -> steam.EPublishedFileRevision
	0,   // 49: steam.CPublishedFile_GetItemInfo_Response.WorkshopItemInfo.revision:type_name -> steam.EPublishedFileRevision
	16,  // 50: steam.CPublishedFile_GetItemInfo_Response.WorkshopItemInfo.author_snapshots:type_name -> steam.PublishedFileAuthorSnapshot
	91,  // 51: steam.CPublishedFile_GetAppRelationshipsBatched_Response.PublishedFileAppRelationship.app_relationships:type_name -> steam.CPublishedFile_GetAppRelationshipsBatched_Response.AppRelationship
	16,  // 52: steam.CPublishedFile_GetItemChanges_Response.WorkshopItemInfo.author_snapshots:type_name -> steam.PublishedFileAuthorSnapshot
	98,  // 53: steam.CPublishedFile_GetContentDescriptors_Response.ContentDescriptor.descriptorid:type_name -> steam.EContentDescriptorID
	0,   // 54: steam.CPublishedFile_FileSubscribed_Notification.RevisionData.revision:type_name -> steam.EPublishedFileRevision
	2,   // 55: steam.PublishedFile.Vote:input_type -> steam.CPublishedFile_Vote_Request
	4,   // 56: steam.PublishedFile.Subscribe:input_type -> steam.CPublishedFile_Subscribe_Request
	6,   // 57: steam.PublishedFile.Unsubscribe:input_type -> steam.CPublishedFile_Unsubscribe_Request
	8,   // 58: steam.PublishedFile.CanSubscribe:input_type -> steam.CPublishedFile_CanSubscribe_Request
	10,  // 59: steam.PublishedFile.GetSubSectionData:input_type -> steam.CPublishedFile_GetSubSectionData_Request
	13,  // 60: steam.PublishedFile.Publish:input_type -> steam.CPublishedFile_Publish_Request
	15,  // 61: steam.PublishedFile.GetDetails:input_type -> steam.CPublishedFile_GetDetails_Request
	19,  // 62: steam.PublishedFile.GetItemInfo:input_type -> steam.CPublishedFile_GetItemInfo_Request
	21,  // 63: steam.PublishedFile.GetUserFiles:input_type -> steam.CPublishedFile_GetUserFiles_Request
	21,  // 64: steam.PublishedFile.GetUserFileCount:input_type -> steam.CPublishedFile_GetUserFiles_Request
	23,  // 65: steam.PublishedFile.AreFilesInSubscriptionList:input_type -> steam.CPublishedFile_AreFilesInSubscriptionList_Request
	25,  // 66: steam.PublishedFile.Update:input_type -> steam.CPublishedFile_Update_Request
	27,  // 67: steam.PublishedFile.Delete:input_type -> steam.CPublishedFile_Delete_Request
	29,  // 68: steam.PublishedFile.GetChangeHistoryEntry:input_type -> steam.CPublishedFile_GetChangeHistoryEntry_Request
	31,  // 69: steam.PublishedFile.GetChangeHistory:input_type -> steam.CPublishedFile_GetChangeHistory_Request
	33,  // 70: steam.PublishedFile.RefreshVotingQueue:input_type -> steam.CPublishedFile_RefreshVotingQueue_Request
	35,  // 71: steam.PublishedFile.QueryFiles:input_type -> steam.CPublishedFile_QueryFiles_Request
	37,  // 72: steam.PublishedFile.AddAppRelationship:input_type -> steam.CPublishedFile_AddAppRelationship_Request
	39,  // 73: steam.PublishedFile.RemoveAppRelationship:input_type -> steam.CPublishedFile_RemoveAppRelationship_Request
	41,  // 74: steam.PublishedFile.GetAppRelationships:input_type -> steam.CPublishedFile_GetAppRelationships_Request
	43,  // 75: steam.PublishedFile.GetAppRelationshipsBatched:input_type -> steam.CPublishedFile_GetAppRelationshipsBatched_Request
	45,  // 76: steam.PublishedFile.StartPlaytimeTracking:input_type -> steam.CPublishedFile_StartPlaytimeTracking_Request
	47,  // 77: steam.PublishedFile.StopPlaytimeTracking:input_type -> steam.CPublishedFile_StopPlaytimeTracking_Request
	49,  // 78: steam.PublishedFile.StopPlaytimeTrackingForAllAppItems:input_type -> steam.CPublishedFile_StopPlaytimeTrackingForAllAppItems_Request
	51,  // 79: steam.PublishedFile.SetPlaytimeForControllerConfigs:input_type -> steam.CPublishedFile_SetPlaytimeForControllerConfigs_Request
	53,  // 80: steam.PublishedFile.AddChild:input_type -> steam.CPublishedFile_AddChild_Request
	55,  // 81: steam.PublishedFile.RemoveChild:input_type -> steam.CPublishedFile_RemoveChild_Request
	57,  // 82: steam.PublishedFile.SetCollectionChildren:input_type -> steam.CPublishedFile_SetCollectionChildren_Request
	59,  // 83: steam.PublishedFile.SetSubscriptionListFromCollection:input_type -> steam.CPublishedFile_SetSubscriptionListFromCollection_Request
	61,  // 84: steam.PublishedFile.GetUserVoteSummary:input_type -> steam.CPublishedFile_GetUserVoteSummary_Request
	63,  // 85: steam.PublishedFile.GetItemChanges:input_type -> steam.CPublishedFile_GetItemChanges_Request
	65,  // 86: steam.PublishedFile.GetContentDescriptors:input_type -> steam.CPublishedFile_GetContentDescriptors_Request
	67,  // 87: steam.PublishedFile.UpdateContentDescriptors:input_type -> steam.CPublishedFile_UpdateContentDescriptors_Request
	69,  // 88: steam.PublishedFileClient.NotifyFileSubscribed:input_type -> steam.CPublishedFile_FileSubscribed_Notification
	70,  // 89: steam.PublishedFileClient.NotifyFileUnsubscribed:input_type -> steam.CPublishedFile_FileUnsubscribed_Notification
	71,  // 90: steam.PublishedFileClient.NotifyFileDeleted:input_type -> steam.CPublishedFile_FileDeleted_Client_Notification
	3,   // 91: steam.PublishedFile.Vote:output_type -> steam.CPublishedFile_Vote_Response
	5,   // 92: steam.PublishedFile.Subscribe:output_type -> steam.CPublishedFile_Subscribe_Response
	7,   // 93: steam.PublishedFile.Unsubscribe:output_type -> steam.CPublishedFile_Unsubscribe_Response
	9,   // 94: steam.PublishedFile.CanSubscribe:output_type -> steam.CPublishedFile_CanSubscribe_Response
	12,  // 95: steam.PublishedFile.GetSubSectionData:output_type -> steam.CPublishedFile_GetSubSectionData_Response
	14,  // 96: steam.PublishedFile.Publish:output_type -> steam.CPublishedFile_Publish_Response
	18,  // 97: steam.PublishedFile.GetDetails:output_type -> steam.CPublishedFile_GetDetails_Response
	20,  // 98: steam.PublishedFile.GetItemInfo:output_type -> steam.CPublishedFile_GetItemInfo_Response
	22,  // 99: steam.PublishedFile.GetUserFiles:output_type -> steam.CPublishedFile_GetUserFiles_Response
	22,  // 100: steam.PublishedFile.GetUserFileCount:output_type -> steam.CPublishedFile_GetUserFiles_Response
	24,  // 101: steam.PublishedFile.AreFilesInSubscriptionList:output_type -> steam.CPublishedFile_AreFilesInSubscriptionList_Response
	26,  // 102: steam.PublishedFile.Update:output_type -> steam.CPublishedFile_Update_Response
	28,  // 103: steam.PublishedFile.Delete:output_type -> steam.CPublishedFile_Delete_Response
	30,  // 104: steam.PublishedFile.GetChangeHistoryEntry:output_type -> steam.CPublishedFile_GetChangeHistoryEntry_Response
	32,  // 105: steam.PublishedFile.GetChangeHistory:output_type -> steam.CPublishedFile_GetChangeHistory_Response
	34,  // 106: steam.PublishedFile.RefreshVotingQueue:output_type -> steam.CPublishedFile_RefreshVotingQueue_Response
	36,  // 107: steam.PublishedFile.QueryFiles:output_type -> steam.CPublishedFile_QueryFiles_Response
	38,  // 108: steam.PublishedFile.AddAppRelationship:output_type -> steam.CPublishedFile_AddAppRelationship_Response
	40,  // 109: steam.PublishedFile.RemoveAppRelationship:output_type -> steam.CPublishedFile_RemoveAppRelationship_Response
	42,  // 110: steam.PublishedFile.GetAppRelationships:output_type -> steam.CPublishedFile_GetAppRelationships_Response
	44,  // 111: steam.PublishedFile.GetAppRelationshipsBatched:output_type -> steam.CPublishedFile_GetAppRelationshipsBatched_Response
	46,  // 112: steam.PublishedFile.StartPlaytimeTracking:output_type -> steam.CPublishedFile_StartPlaytimeTracking_Response
	48,  // 113: steam.PublishedFile.StopPlaytimeTracking:output_type -> steam.CPublishedFile_StopPlaytimeTracking_Response
	50,  // 114: steam.PublishedFile.StopPlaytimeTrackingForAllAppItems:output_type -> steam.CPublishedFile_StopPlaytimeTrackingForAllAppItems_Response
	52,  // 115: steam.PublishedFile.SetPlaytimeForControllerConfigs:output_type -> steam.CPublishedFile_SetPlaytimeForControllerConfigs_Response
	54,  // 116: steam.PublishedFile.AddChild:output_type -> steam.CPublishedFile_AddChild_Response
	56,  // 117: steam.PublishedFile.RemoveChild:output_type -> steam.CPublishedFile_RemoveChild_Response
	58,  // 118: steam.PublishedFile.SetCollectionChildren:output_type -> steam.CPublishedFile_SetCollectionChildren_Response
	60,  // 119: steam.PublishedFile.SetSubscriptionListFromCollection:output_type -> steam.CPublishedFile_SetSubscriptionListFromCollection_Response
	62,  // 120: steam.PublishedFile.GetUserVoteSummary:output_type -> steam.CPublishedFile_GetUserVoteSummary_Response
	64,  // 121: steam.PublishedFile.GetItemChanges:output_type -> steam.CPublishedFile_GetItemChanges_Response
	66,  // 122: steam.PublishedFile.GetContentDescriptors:output_type -> steam.CPublishedFile_GetContentDescriptors_Response
	68,  // 123: steam.PublishedFile.UpdateContentDescriptors:output_type -> steam.CPublishedFile_UpdateContentDescriptors_Response
	100, // 124: steam.PublishedFileClient.NotifyFileSubscribed:output_type -> steam.NoResponse
	100, // 125: steam.PublishedFileClient.NotifyFileUnsubscribed:output_type -> steam.NoResponse
	100, // 126: steam.PublishedFileClient.NotifyFileDeleted:output_type -> steam.NoResponse
