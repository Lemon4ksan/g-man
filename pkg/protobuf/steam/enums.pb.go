...
const file_enums_proto_rawDesc = "" +
	...
	"&k_ECommentDeleteReason_AccountDeletion\x10\x06B2H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam"
...
var file_enums_proto_goTypes = []any{
	(EPublishedFileQueryType)(0),                  // 0: steam.EPublishedFileQueryType
	(EPublishedFileInappropriateProvider)(0),      // 1: steam.EPublishedFileInappropriateProvider
	(EPublishedFileInappropriateResult)(0),        // 2: steam.EPublishedFileInappropriateResult
	(EPersonaStateFlag)(0),                        // 3: steam.EPersonaStateFlag
	(EContentCheckProvider)(0),                    // 4: steam.EContentCheckProvider
	(EProfileCustomizationType)(0),                // 5: steam.EProfileCustomizationType
	(EPublishedFileStorageSystem)(0),              // 6: steam.EPublishedFileStorageSystem
	(ECloudStoragePersistState)(0),                // 7: steam.ECloudStoragePersistState
	(ESDCardFormatStage)(0),                       // 8: steam.ESDCardFormatStage
	(EStorageFormatStage)(0),                      // 9: steam.EStorageFormatStage
	(ESystemFanControlMode)(0),                    // 10: steam.ESystemFanControlMode
	(EStartupMovieVariant)(0),                     // 11: steam.EStartupMovieVariant
	(EColorGamutLabelSet)(0),                      // 12: steam.EColorGamutLabelSet
	(EWindowStackingOrder)(0),                     // 13: steam.EWindowStackingOrder
	(EBluetoothDeviceType)(0),                     // 14: steam.EBluetoothDeviceType
	(ESystemAudioDirection)(0),                    // 15: steam.ESystemAudioDirection
	(ESystemAudioChannel)(0),                      // 16: steam.ESystemAudioChannel
	(ESystemAudioPortType)(0),                     // 17: steam.ESystemAudioPortType
	(ESystemAudioPortDirection)(0),                // 18: steam.ESystemAudioPortDirection
	(ESystemServiceState)(0),                      // 19: steam.ESystemServiceState
	(EGraphicsPerfOverlayLevel)(0),                // 20: steam.EGraphicsPerfOverlayLevel
	(EGPUPerformanceLevel)(0),                     // 21: steam.EGPUPerformanceLevel
	(ESplitScalingFilter)(0),                      // 22: steam.ESplitScalingFilter
	(ESplitScalingScaler)(0),                      // 23: steam.ESplitScalingScaler
	(EGamescopeBlurMode)(0),                       // 24: steam.EGamescopeBlurMode
	(ESLSHelper)(0),                               // 25: steam.ESLSHelper
	(EHDRVisualization)(0),                        // 26: steam.EHDRVisualization
	(EHDRToneMapOperator)(0),                      // 27: steam.EHDRToneMapOperator
	(ECPUGovernor)(0),                             // 28: steam.ECPUGovernor
	(EUpdaterType)(0),                             // 29: steam.EUpdaterType
	(EUpdaterState)(0),                            // 30: steam.EUpdaterState
	(EStorageBlockContentType)(0),                 // 31: steam.EStorageBlockContentType
	(EStorageBlockFileSystemType)(0),              // 32: steam.EStorageBlockFileSystemType
	(EStorageDriveMediaType)(0),                   // 33: steam.EStorageDriveMediaType
	(ESystemDisplayCompatibilityMode)(0),          // 34: steam.ESystemDisplayCompatibilityMode
	(ESteamOSCompatibilityCategory)(0),            // 35: steam.ESteamOSCompatibilityCategory
	(ESteamOSCompatibilityResultDisplayType)(0),   // 36: steam.ESteamOSCompatibilityResultDisplayType
	(ESteamDeckCompatibilityCategory)(0),          // 37: steam.ESteamDeckCompatibilityCategory
	(ESteamDeckCompatibilityResultDisplayType)(0), // 38: steam.ESteamDeckCompatibilityResultDisplayType
	(ESteamDeckCompatibilityTestResult)(0),        // 39: steam.ESteamDeckCompatibilityTestResult
	(EACState)(0),                                 // 40: steam.EACState
	(EBatteryState)(0),                            // 41: steam.EBatteryState
	(EOSBranch)(0),                                // 42: steam.EOSBranch
	(EBrowserGPUStatus)(0),                        // 43: steam.EBrowserGPUStatus
	(EBrowserFeatureStatus)(0),                    // 44: steam.EBrowserFeatureStatus
	(EGpuDriverId)(0),                             // 45: steam.EGpuDriverId
	(ECommunityItemClass)(0),                      // 46: steam.ECommunityItemClass
	(ESteamDeckCompatibilityFeedback)(0),          // 47: steam.ESteamDeckCompatibilityFeedback
	(EProvideDeckFeedbackPreference)(0),           // 48: steam.EProvideDeckFeedbackPreference
	(EHardwareCompatibilityFeedbackDetails)(0),    // 49: steam.EHardwareCompatibilityFeedbackDetails
	(EGameFrameRateReportingPreference)(0),        // 50: steam.EGameFrameRateReportingPreference
	(ETouchGesture)(0),                            // 51: steam.ETouchGesture
	(ESessionPersistence)(0),                      // 52: steam.ESessionPersistence
	(ENewSteamAnnouncementState)(0),               // 53: steam.ENewSteamAnnouncementState
	(EForumType)(0),                               // 54: steam.EForumType
	(ECommentThreadType)(0),                       // 55: steam.ECommentThreadType
	(EBroadcastPermission)(0),                     // 56: steam.EBroadcastPermission
	(EBroadcastEncoderSetting)(0),                 // 57: steam.EBroadcastEncoderSetting
	(ECloudGamingPlatform)(0),                     // 58: steam.ECloudGamingPlatform
	(ECompromiseDetectionType)(0),                 // 59: steam.ECompromiseDetectionType
	(EAsyncGameSessionUserState)(0),               // 60: steam.EAsyncGameSessionUserState
	(EAsyncGameSessionUserVisibility)(0),          // 61: steam.EAsyncGameSessionUserVisibility
	(EGameRecordingType)(0),                       // 62: steam.EGameRecordingType
	(EGRMode)(0),                                  // 63: steam.EGRMode
	(EExportCodec)(0),                             // 64: steam.EExportCodec
	(EProtoAppType)(0),                            // 65: steam.EProtoAppType
	(EChildProcessQueryCommand)(0),                // 66: steam.EChildProcessQueryCommand
	(EChildProcessQueryExitCode)(0),               // 67: steam.EChildProcessQueryExitCode
	(EWindowsUpdateInstallationImpact)(0),         // 68: steam.EWindowsUpdateInstallationImpact
	(EWindowsUpdateRebootBehavior)(0),             // 69: steam.EWindowsUpdateRebootBehavior
	(EExternalSaleEventType)(0),                   // 70: steam.EExternalSaleEventType
	(EEnhancedMarketAppearanceStatus)(0),          // 71: steam.EEnhancedMarketAppearanceStatus
	(EContentReportSubjectType)(0),                // 72: steam.EContentReportSubjectType
	(EControlledLegalCategoryStatus)(0),           // 73: steam.EControlledLegalCategoryStatus
	(EContentModeratorLevel)(0),                   // 74: steam.EContentModeratorLevel
	(EContentReportResolution)(0),                 // 75: steam.EContentReportResolution
	(EContentModerationSanction)(0),               // 76: steam.EContentModerationSanction
	(EContentReportSubjectAction)(0),              // 77: steam.EContentReportSubjectAction
	(EContentReportReason)(0),                     // 78: steam.EContentReportReason
	(EResolutionAutomation)(0),                    // 79: steam.EResolutionAutomation
	(EPressOutletAction)(0),                       // 80: steam.EPressOutletAction
	(EPressOutletMemberPendingState)(0),           // 81: steam.EPressOutletMemberPendingState
	(ECommentDeleteReason)(0),                     // 82: steam.ECommentDeleteReason
}
