...
const file_steammessages_shader_steamclient_proto_rawDesc = "" +
	"\n" +
	"&steammessages_shader.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"+\n" +
	...
	"\x13percent_to_rereport\x18\x02 \x01(\rR\x11percentToRereport\"\x90\x02\n" +
	...
	"driverDesc\x12F\n" +
	"\ashaders\x18\x04 \x03(\v2,.steam.CShader_RegisterShader_Request.ShaderR\ashaders\x1aT\n" +
	"\x06Shader\x12\"\n" +
	...
	"\x11requested_codeids\x18\x01 \x03(\rR\x10requestedCodeids\"\xd1\x01\n" +
	"\x1aCShader_SendShader_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12F\n" +
	"\ashaders\x18\x02 \x03(\v2,.steam.CShader_SendShader_Request.ShaderCodeR\ashaders\x1aU\n" +
	"\n" +
	"ShaderCode\x12&\n" +
	...
	"$CShader_ReportExternalBuild_Response2\xfc\x04\n" +
	"\x06Shader\x12\x80\x01\n" +
	"\x19GetShaderReportingCadence\x120.steam.CShader_GetShaderReportingCadence_Request\x1a1.steam.CShader_GetShaderReportingCadence_Response\x12_\n" +
	"\x0eRegisterShader\x12%.steam.CShader_RegisterShader_Request\x1a&.steam.CShader_RegisterShader_Response\x12S\n" +
	"\n" +
	"SendShader\x12!.steam.CShader_SendShader_Request\x1a\".steam.CShader_SendShader_Response\x12h\n" +
	"\x11GetBucketManifest\x12(.steam.CShader_GetBucketManifest_Request\x1a).steam.CShader_GetBucketManifest_Response\x12_\n" +
	"\x0eGetStaleBucket\x12%.steam.CShader_GetStaleBucket_Request\x1a&.steam.CShader_GetStaleBucket_Response\x12n\n" +
	"\x13ReportExternalBuild\x12*.steam.CShader_ReportExternalBuild_Request\x1a+.steam.CShader_ReportExternalBuild_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_shader_steamclient_proto_goTypes = []any{
	(*CShader_GetShaderReportingCadence_Request)(nil),  // 0: steam.CShader_GetShaderReportingCadence_Request
	(*CShader_GetShaderReportingCadence_Response)(nil), // 1: steam.CShader_GetShaderReportingCadence_Response
	(*CShader_RegisterShader_Request)(nil),             // 2: steam.CShader_RegisterShader_Request
	(*CShader_RegisterShader_Response)(nil),            // 3: steam.CShader_RegisterShader_Response
	(*CShader_SendShader_Request)(nil),                 // 4: steam.CShader_SendShader_Request
	(*CShader_SendShader_Response)(nil),                // 5: steam.CShader_SendShader_Response
	(*CShader_GetBucketManifest_Request)(nil),          // 6: steam.CShader_GetBucketManifest_Request
	(*CShader_GetBucketManifest_Response)(nil),         // 7: steam.CShader_GetBucketManifest_Response
	(*CShader_GetStaleBucket_Request)(nil),             // 8: steam.CShader_GetStaleBucket_Request
	(*CShader_GetStaleBucket_Response)(nil),            // 9: steam.CShader_GetStaleBucket_Response
	(*CShader_ReportExternalBuild_Request)(nil),        // 10: steam.CShader_ReportExternalBuild_Request
	(*CShader_ReportExternalBuild_Response)(nil),       // 11: steam.CShader_ReportExternalBuild_Response
	(*CShader_RegisterShader_Request_Shader)(nil),      // 12: steam.CShader_RegisterShader_Request.Shader
	(*CShader_SendShader_Request_ShaderCode)(nil),      // 13: steam.CShader_SendShader_Request.ShaderCode
}
var file_steammessages_shader_steamclient_proto_depIdxs = []int32{
	12, // 0: steam.CShader_RegisterShader_Request.shaders:type_name -> steam.CShader_RegisterShader_Request.Shader
	13, // 1: steam.CShader_SendShader_Request.shaders:type_name -> steam.CShader_SendShader_Request.ShaderCode
	0,  // 2: steam.Shader.GetShaderReportingCadence:input_type -> steam.CShader_GetShaderReportingCadence_Request
	2,  // 3: steam.Shader.RegisterShader:input_type -> steam.CShader_RegisterShader_Request
	4,  // 4: steam.Shader.SendShader:input_type -> steam.CShader_SendShader_Request
	6,  // 5: steam.Shader.GetBucketManifest:input_type -> steam.CShader_GetBucketManifest_Request
	8,  // 6: steam.Shader.GetStaleBucket:input_type -> steam.CShader_GetStaleBucket_Request
	10, // 7: steam.Shader.ReportExternalBuild:input_type -> steam.CShader_ReportExternalBuild_Request
	1,  // 8: steam.Shader.GetShaderReportingCadence:output_type -> steam.CShader_GetShaderReportingCadence_Response
	3,  // 9: steam.Shader.RegisterShader:output_type -> steam.CShader_RegisterShader_Response
	5,  // 10: steam.Shader.SendShader:output_type -> steam.CShader_SendShader_Response
	7,  // 11: steam.Shader.GetBucketManifest:output_type -> steam.CShader_GetBucketManifest_Response
	9,  // 12: steam.Shader.GetStaleBucket:output_type -> steam.CShader_GetStaleBucket_Response
	11, // 13: steam.Shader.ReportExternalBuild:output_type -> steam.CShader_ReportExternalBuild_Response
