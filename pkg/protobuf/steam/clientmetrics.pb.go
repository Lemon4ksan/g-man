...
const file_clientmetrics_proto_rawDesc = "" +
	"\n" +
	"\x13clientmetrics.proto\x12\x05steam\"\x95\x03\n" +
	...
	"\rtotal_time_ms\x18\x06 \x01(\rR\vtotalTimeMs\x12^\n" +
	"\x11manifest_requests\x18\a \x03(\v21.steam.CClientMetrics_ClientBootstrap_RequestInfoR\x10manifestRequests\x12\\\n" +
	"\x10package_requests\x18\b \x03(\v21.steam.CClientMetrics_ClientBootstrap_RequestInfoR\x0fpackageRequests\"\x86\x02\n" +
	...
	"noResponse\x12#\n" +
	"\rclass_unknown\x18\a \x01(\rR\fclassUnknown\"\xbe\x01\n" +
	...
	"sourceType\x12L\n" +
	"\x06counts\x18\x03 \x01(\v24.steam.CClientMetrics_ContentDownloadResponse_CountsR\x06counts\"~\n" +
	",CClientMetrics_ContentDownloadResponse_Hosts\x12N\n" +
	"\x05hosts\x18\x01 \x03(\v28.steam.CClientMetrics_ContentDownloadResponse_HostCountsR\x05hostsB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_clientmetrics_proto_goTypes = []any{
	(*CClientMetrics_ClientBootstrap_RequestInfo)(nil),        // 0: steam.CClientMetrics_ClientBootstrap_RequestInfo
	(*CClientMetrics_ClientBootstrap_Summary)(nil),            // 1: steam.CClientMetrics_ClientBootstrap_Summary
	(*CClientMetrics_ContentDownloadResponse_Counts)(nil),     // 2: steam.CClientMetrics_ContentDownloadResponse_Counts
	(*CClientMetrics_ContentDownloadResponse_HostCounts)(nil), // 3: steam.CClientMetrics_ContentDownloadResponse_HostCounts
	(*CClientMetrics_ContentDownloadResponse_Hosts)(nil),      // 4: steam.CClientMetrics_ContentDownloadResponse_Hosts
}
var file_clientmetrics_proto_depIdxs = []int32{
	0, // 0: steam.CClientMetrics_ClientBootstrap_Summary.manifest_requests:type_name -> steam.CClientMetrics_ClientBootstrap_RequestInfo
	0, // 1: steam.CClientMetrics_ClientBootstrap_Summary.package_requests:type_name -> steam.CClientMetrics_ClientBootstrap_RequestInfo
	2, // 2: steam.CClientMetrics_ContentDownloadResponse_HostCounts.counts:type_name -> steam.CClientMetrics_ContentDownloadResponse_Counts
	3, // 3: steam.CClientMetrics_ContentDownloadResponse_Hosts.hosts:type_name -> steam.CClientMetrics_ContentDownloadResponse_HostCounts
