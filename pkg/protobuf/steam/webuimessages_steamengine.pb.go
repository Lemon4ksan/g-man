...
const file_webuimessages_steamengine_proto_rawDesc = "" +
	"\n" +
	"\x1fwebuimessages_steamengine.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a\x18webuimessages_base.proto\"f\n" +
	...
	"\x06appids\x18\x01 \x03(\rR\x06appids2\x90\x06\n" +
	"\vSteamEngine\x12q\n" +
	"\x1aUpdateTextFilterDictionary\x12;.steam.CSteamEngine_UpdateTextFilterDictionary_Notification\x1a\x16.steam.WebUINoResponse\x12\x84\x01\n" +
	"\x17GetTextFilterDictionary\x123.steam.CSteamEngine_GetTextFilterDictionary_Request\x1a4.steam.CSteamEngine_GetTextFilterDictionary_Response\x12y\n" +
	"!NotifyTextFilterDictionaryChanged\x12<.steam.CSteamEngine_TextFilterDictionaryChanged_Notification\x1a\x16.steam.WebUINoResponse\x12l\n" +
	"\x0fGetGameIDForPID\x12+.steam.CSteamEngine_GetGameIDForPID_Request\x1a,.steam.CSteamEngine_GetGameIDForPID_Response\x12s\n" +
	"\x1bSetOverlayEscapeKeyHandling\x12<.steam.CSteamEngine_SetOverlayEscapeKeyHandling_Notification\x1a\x16.steam.WebUINoResponse\x12\xa2\x01\n" +
	"!SearchAppDataCacheByStoreKeywords\x12=.steam.CSteamEngine_SearchAppDataCacheByStoreKeywords_Request\x1a>.steam.CSteamEngine_SearchAppDataCacheByStoreKeywords_Response\x1a\x04\x80\x97\"\x02B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_webuimessages_steamengine_proto_goTypes = []any{
	(*CSteamEngine_UpdateTextFilterDictionary_Notification)(nil),    // 0: steam.CSteamEngine_UpdateTextFilterDictionary_Notification
	(*CSteamEngine_GetTextFilterDictionary_Request)(nil),            // 1: steam.CSteamEngine_GetTextFilterDictionary_Request
	(*CSteamEngine_GetTextFilterDictionary_Response)(nil),           // 2: steam.CSteamEngine_GetTextFilterDictionary_Response
	(*CSteamEngine_TextFilterDictionaryChanged_Notification)(nil),   // 3: steam.CSteamEngine_TextFilterDictionaryChanged_Notification
	(*CSteamEngine_GetGameIDForPID_Request)(nil),                    // 4: steam.CSteamEngine_GetGameIDForPID_Request
	(*CSteamEngine_GetGameIDForPID_Response)(nil),                   // 5: steam.CSteamEngine_GetGameIDForPID_Response
	(*CSteamEngine_SetOverlayEscapeKeyHandling_Notification)(nil),   // 6: steam.CSteamEngine_SetOverlayEscapeKeyHandling_Notification
	(*CSteamEngine_SearchAppDataCacheByStoreKeywords_Request)(nil),  // 7: steam.CSteamEngine_SearchAppDataCacheByStoreKeywords_Request
	(*CSteamEngine_SearchAppDataCacheByStoreKeywords_Response)(nil), // 8: steam.CSteamEngine_SearchAppDataCacheByStoreKeywords_Response
	(*WebUINoResponse)(nil),                                         // 9: steam.WebUINoResponse
}
var file_webuimessages_steamengine_proto_depIdxs = []int32{
	0, // 0: steam.SteamEngine.UpdateTextFilterDictionary:input_type -> steam.CSteamEngine_UpdateTextFilterDictionary_Notification
	1, // 1: steam.SteamEngine.GetTextFilterDictionary:input_type -> steam.CSteamEngine_GetTextFilterDictionary_Request
	3, // 2: steam.SteamEngine.NotifyTextFilterDictionaryChanged:input_type -> steam.CSteamEngine_TextFilterDictionaryChanged_Notification
	4, // 3: steam.SteamEngine.GetGameIDForPID:input_type -> steam.CSteamEngine_GetGameIDForPID_Request
	6, // 4: steam.SteamEngine.SetOverlayEscapeKeyHandling:input_type -> steam.CSteamEngine_SetOverlayEscapeKeyHandling_Notification
	7, // 5: steam.SteamEngine.SearchAppDataCacheByStoreKeywords:input_type -> steam.CSteamEngine_SearchAppDataCacheByStoreKeywords_Request
	9, // 6: steam.SteamEngine.UpdateTextFilterDictionary:output_type -> steam.WebUINoResponse
	2, // 7: steam.SteamEngine.GetTextFilterDictionary:output_type -> steam.CSteamEngine_GetTextFilterDictionary_Response
	9, // 8: steam.SteamEngine.NotifyTextFilterDictionaryChanged:output_type -> steam.WebUINoResponse
	5, // 9: steam.SteamEngine.GetGameIDForPID:output_type -> steam.CSteamEngine_GetGameIDForPID_Response
	9, // 10: steam.SteamEngine.SetOverlayEscapeKeyHandling:output_type -> steam.WebUINoResponse
	8, // 11: steam.SteamEngine.SearchAppDataCacheByStoreKeywords:output_type -> steam.CSteamEngine_SearchAppDataCacheByStoreKeywords_Response
