...
const file_steammessages_parties_steamclient_proto_rawDesc = "" +
	"\n" +
	"'steammessages_parties.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"S\n" +
	...
	"\x0enum_open_slots\x18\x02 \x01(\rR\fnumOpenSlots\x12<\n" +
	"\tlocations\x18\x03 \x03(\v2\x1e.steam.CParties_BeaconLocationR\tlocations\x12%\n" +
	...
	"\tbeacon_id\x18\x01 \x01(\x04R\bbeaconId2\xf0\x04\n" +
	"\aParties\x12R\n" +
	"\tJoinParty\x12!.steam.CParties_JoinParty_Request\x1a\".steam.CParties_JoinParty_Response\x12[\n" +
	"\fCreateBeacon\x12$.steam.CParties_CreateBeacon_Request\x1a%.steam.CParties_CreateBeacon_Response\x12y\n" +
	"\x16OnReservationCompleted\x12..steam.CParties_OnReservationCompleted_Request\x1a/.steam.CParties_OnReservationCompleted_Response\x12j\n" +
	"\x11CancelReservation\x12).steam.CParties_CancelReservation_Request\x1a*.steam.CParties_CancelReservation_Response\x12m\n" +
	"\x12ChangeNumOpenSlots\x12*.steam.CParties_ChangeNumOpenSlots_Request\x1a+.steam.CParties_ChangeNumOpenSlots_Response\x12^\n" +
	"\rDestroyBeacon\x12%.steam.CParties_DestroyBeacon_Request\x1a&.steam.CParties_DestroyBeacon_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
