...
const file_steammessages_clientserver_login_proto_rawDesc = "" +
	"\n" +
	"&steammessages_clientserver_login.proto\x12\x05steam\x1a\x18steammessages_base.proto\"4\n" +
	...
	"\x10protocol_version\x18\x01 \x01(\rR\x0fprotocolVersion\"\x96\x15\n" +
	...
	"\rdeprecated_10\x18\n" +
	" \x01(\rR\fdeprecated10\x12H\n" +
	"\x15obfuscated_private_ip\x18\v \x01(\v2\x14.steam.CMsgIPAddressR\x13obfuscatedPrivateIp\x120\n" +
	"\x14deprecated_public_ip\x18\x14 \x01(\rR\x12deprecatedPublicIp\x12\x1b\n" +
	"\tqos_level\x18\x15 \x01(\rR\bqosLevel\x127\n" +
	"\x18client_supplied_steam_id\x18\x16 \x01(\x06R\x15clientSuppliedSteamId\x121\n" +
	"\tpublic_ip\x18\x17 \x01(\v2\x14.steam.CMsgIPAddressR\bpublicIp\x12\x1d\n" +
	"\n" +
	...
	"\x0fpriority_reason\x18h \x01(\x05R\x0epriorityReason\x12M\n" +
	"\x16embedded_client_secret\x18i \x01(\v2\x17.steam.CMsgClientSecretR\x14embeddedClientSecret\x12<\n" +
	...
	"\x12gaming_device_type\x18o \x01(\rR\x10gamingDeviceType\"\x8e\n" +
	"\n" +
	...
	"\n" +
	"vanity_url\x18\x0e \x01(\tR\tvanityUrl\x121\n" +
	"\tpublic_ip\x18\x0f \x01(\v2\x14.steam.CMsgIPAddressR\bpublicIp\x12!\n" +
	...
	"\tchallenge\x18\x01 \x01(\x06R\tchallengeB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steammessages_clientserver_login_proto_goTypes = []any{
	...
	(*CMsgClientHello)(nil),                                      // 4: steam.CMsgClientHello
	(*CMsgClientLogon)(nil),                                      // 5: steam.CMsgClientLogon
	(*CMsgClientLogonResponse)(nil),                              // 6: steam.CMsgClientLogonResponse
	(*CMsgClientRequestWebAPIAuthenticateUserNonce)(nil),         // 7: steam.CMsgClientRequestWebAPIAuthenticateUserNonce
	(*CMsgClientRequestWebAPIAuthenticateUserNonceResponse)(nil), // 8: steam.CMsgClientRequestWebAPIAuthenticateUserNonceResponse
	(*CMsgClientLogOff)(nil),                                     // 9: steam.CMsgClientLogOff
	(*CMsgClientLoggedOff)(nil),                                  // 10: steam.CMsgClientLoggedOff
	(*CMsgClientNewLoginKey)(nil),                                // 11: steam.CMsgClientNewLoginKey
	(*CMsgClientNewLoginKeyAccepted)(nil),                        // 12: steam.CMsgClientNewLoginKeyAccepted
	(*CMsgClientAccountInfo)(nil),                                // 13: steam.CMsgClientAccountInfo
	(*CMsgClientChallengeRequest)(nil),                           // 14: steam.CMsgClientChallengeRequest
	(*CMsgClientChallengeResponse)(nil),                          // 15: steam.CMsgClientChallengeResponse
	(*CMsgIPAddress)(nil),                                        // 16: steam.CMsgIPAddress
}
var file_steammessages_clientserver_login_proto_depIdxs = []int32{
	16, // 0: steam.CMsgClientLogon.obfuscated_private_ip:type_name -> steam.CMsgIPAddress
	16, // 1: steam.CMsgClientLogon.public_ip:type_name -> steam.CMsgIPAddress
	3,  // 2: steam.CMsgClientLogon.embedded_client_secret:type_name -> steam.CMsgClientSecret
	16, // 3: steam.CMsgClientLogonResponse.public_ip:type_name -> steam.CMsgIPAddress
