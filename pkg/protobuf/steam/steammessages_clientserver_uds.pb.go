...
const file_steammessages_clientserver_uds_proto_rawDesc = "" +
	"\n" +
	"$steammessages_clientserver_uds.proto\x12\x05steam\x1a\x18steammessages_base.proto\"]\n" +
	...
	"\x1aCMsgClientGetClientDetails\"\x9c\x04\n" +
	...
	"\n" +
	"ip_private\x18\x05 \x01(\tR\tipPrivate\x12S\n" +
	"\rgames_running\x18\x06 \x03(\v2..steam.CMsgClientGetClientDetailsResponse.GameR\fgamesRunning\x12'\n" +
	...
	"\rfilter_appids\x18\b \x03(\rR\ffilterAppids\"\xf3\t\n" +
	"\"CMsgClientGetClientAppListResponse\x12A\n" +
	"\x04apps\x18\x01 \x03(\v2-.steam.CMsgClientGetClientAppListResponse.AppR\x04apps\x12'\n" +
	"\x0fbytes_available\x18\x02 \x01(\x04R\x0ebytesAvailable\x12J\n" +
	"\vclient_info\x18\x03 \x01(\v2).steam.CMsgClientGetClientDetailsResponseR\n" +
	"clientInfo\x1a\x94\b\n" +
	"\x03App\x12\x14\n" +
	...
	"\x13bytes_download_rate\x18\b \x01(\rR\x11bytesDownloadRate\x12E\n" +
	"\x04dlcs\x18\t \x03(\v21.steam.CMsgClientGetClientAppListResponse.App.DLCR\x04dlcs\x12'\n" +
	...
	"\x06result\x18\x01 \x01(\rR\x06resultB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steammessages_clientserver_uds_proto_goTypes = []any{
	(*CMsgClientUDSP2PSessionStarted)(nil),             // 0: steam.CMsgClientUDSP2PSessionStarted
	(*CMsgClientUDSP2PSessionEnded)(nil),               // 1: steam.CMsgClientUDSP2PSessionEnded
	(*CMsgClientGetClientDetails)(nil),                 // 2: steam.CMsgClientGetClientDetails
	(*CMsgClientGetClientDetailsResponse)(nil),         // 3: steam.CMsgClientGetClientDetailsResponse
	(*CMsgClientGetClientAppList)(nil),                 // 4: steam.CMsgClientGetClientAppList
	(*CMsgClientGetClientAppListResponse)(nil),         // 5: steam.CMsgClientGetClientAppListResponse
	(*CMsgClientInstallClientApp)(nil),                 // 6: steam.CMsgClientInstallClientApp
	(*CMsgClientInstallClientAppResponse)(nil),         // 7: steam.CMsgClientInstallClientAppResponse
	(*CMsgClientUninstallClientApp)(nil),               // 8: steam.CMsgClientUninstallClientApp
	(*CMsgClientUninstallClientAppResponse)(nil),       // 9: steam.CMsgClientUninstallClientAppResponse
	(*CMsgClientSetClientAppUpdateState)(nil),          // 10: steam.CMsgClientSetClientAppUpdateState
	(*CMsgClientSetClientAppUpdateStateResponse)(nil),  // 11: steam.CMsgClientSetClientAppUpdateStateResponse
	(*CMsgClientLaunchClientApp)(nil),                  // 12: steam.CMsgClientLaunchClientApp
	(*CMsgClientLaunchClientAppResponse)(nil),          // 13: steam.CMsgClientLaunchClientAppResponse
	(*CMsgClientEnableOrDisableDownloads)(nil),         // 14: steam.CMsgClientEnableOrDisableDownloads
	(*CMsgClientEnableOrDisableDownloadsResponse)(nil), // 15: steam.CMsgClientEnableOrDisableDownloadsResponse
	(*CMsgClientGetClientDetailsResponse_Game)(nil),    // 16: steam.CMsgClientGetClientDetailsResponse.Game
	(*CMsgClientGetClientAppListResponse_App)(nil),     // 17: steam.CMsgClientGetClientAppListResponse.App
	(*CMsgClientGetClientAppListResponse_App_DLC)(nil), // 18: steam.CMsgClientGetClientAppListResponse.App.DLC
}
var file_steammessages_clientserver_uds_proto_depIdxs = []int32{
	16, // 0: steam.CMsgClientGetClientDetailsResponse.games_running:type_name -> steam.CMsgClientGetClientDetailsResponse.Game
	17, // 1: steam.CMsgClientGetClientAppListResponse.apps:type_name -> steam.CMsgClientGetClientAppListResponse.App
	3,  // 2: steam.CMsgClientGetClientAppListResponse.client_info:type_name -> steam.CMsgClientGetClientDetailsResponse
	18, // 3: steam.CMsgClientGetClientAppListResponse.App.dlcs:type_name -> steam.CMsgClientGetClientAppListResponse.App.DLC
