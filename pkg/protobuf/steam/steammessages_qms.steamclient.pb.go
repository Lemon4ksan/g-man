...
const file_steammessages_qms_steamclient_proto_rawDesc = "" +
	"\n" +
	"#steammessages_qms.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"B\n" +
	"\x0fGameSearchParam\x12\x19\n" +
	"\bkey_name\x18\x01 \x01(\tR\akeyName\x12\x14\n" +
	"\x05value\x18\x02 \x03(\tR\x05value\"\xba\x02\n" +
	"(CQueuedMatchmaking_SearchForGame_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12J\n" +
	"\x06action\x18\x02 \x01(\x0e2\x18.steam.EGameSearchAction:\x18k_EGameSearchAction_NoneR\x06action\x12.\n" +
	"\x06params\x18\x03 \x03(\v2\x16.steam.GameSearchParamR\x06params\x12\x1d\n" +
	"\n" +
	...
	"\bsearchid\x18\a \x01(\x04R\bsearchid\"\xcb\x04\n" +
	")CQueuedMatchmaking_SearchForGame_Response\x12a\n" +
	"\x10gamesearchresult\x18\x01 \x01(\x0e2\x18.steam.EGameSearchResult:\x1bk_EGameSearchResult_InvalidR\x10gamesearchresult\x12\x1a\n" +
	...
	"\x17steamid_canceled_search\x18\r \x01(\x06R\x15steamidCanceledSearch\"\xff\x02\n" +
	...
	"\bsearchid\x18\b \x01(\x04R\bsearchid\"\xc4\x01\n" +
	"\vPlayerFound\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12J\n" +
	"\x06action\x18\x02 \x01(\x0e2\x18.steam.EGameSearchAction:\x18k_EGameSearchAction_NoneR\x06action\x12.\n" +
	"\x06params\x18\x03 \x03(\v2\x16.steam.GameSearchParamR\x06params\x12\x1f\n" +
	"\vteam_number\x18\x04 \x01(\rR\n" +
	"teamNumber\"\xeb\x02\n" +
	"4CQueuedMatchmakingGameHost_SearchForPlayers_Response\x12a\n" +
	"\x10gamesearchresult\x18\x01 \x01(\x0e2\x18.steam.EGameSearchResult:\x1bk_EGameSearchResult_InvalidR\x10gamesearchresult\x12\x1a\n" +
	...
	"\aplayers\x18\x05 \x03(\v2\x12.steam.PlayerFoundR\aplayers\x12(\n" +
	...
	"\x05value\x18\x02 \x01(\rR\x05value\"\xa3\x01\n" +
	...
	"\x0eplayer_results\x18\x03 \x03(\v2\x13.steam.PlayerResultR\rplayerResults\"8\n" +
	...
	"\"k_EGameSearchResult_SearchCanceled\x10\x062\x87\x01\n" +
	"\x11QueuedMatchmaking\x12r\n" +
	"\rSearchForGame\x12/.steam.CQueuedMatchmaking_SearchForGame_Request\x1a0.steam.CQueuedMatchmaking_SearchForGame_Response2\xaf\x03\n" +
	"\x19QueuedMatchmakingGameHost\x12\x8b\x01\n" +
	"\x10SearchForPlayers\x12:.steam.CQueuedMatchmakingGameHost_SearchForPlayers_Request\x1a;.steam.CQueuedMatchmakingGameHost_SearchForPlayers_Response\x12\x91\x01\n" +
	"\x12SubmitPlayerResult\x12<.steam.CQueuedMatchmakingGameHost_SubmitPlayerResult_Request\x1a=.steam.CQueuedMatchmakingGameHost_SubmitPlayerResult_Response\x12p\n" +
	"\aEndGame\x121.steam.CQueuedMatchmakingGameHost_EndGame_Request\x1a2.steam.CQueuedMatchmakingGameHost_EndGame_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
