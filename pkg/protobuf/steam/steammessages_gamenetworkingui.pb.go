...
const file_steammessages_gamenetworkingui_proto_rawDesc = "" +
	"\n" +
	"$steammessages_gamenetworkingui.proto\x12\x05steam\x1a%steamnetworkingsockets_messages.proto\x1a steamdatagram_messages_sdr.proto\"\x1f\n" +
	"\x1dCGameNetworkingUI_GlobalState\"\xd9\v\n" +
	...
	"\x0eaddress_remote\x18\x17 \x01(\tR\raddressRemote\x12J\n" +
	"\vp2p_routing\x18\x18 \x01(\v2).steam.CMsgSteamDatagramP2PRoutingSummaryR\n" +
	"p2pRouting\x12#\n" +
	"\rping_interior\x18\x19 \x01(\rR\fpingInterior\x12*\n" +
	"\x11ping_remote_front\x18\x1a \x01(\rR\x0fpingRemoteFront\x12=\n" +
	"\x1bping_default_internet_route\x18\x1b \x01(\rR\x18pingDefaultInternetRoute\x12U\n" +
	"\x11e2e_quality_local\x18\x1e \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\x0fe2eQualityLocal\x12W\n" +
	"\x12e2e_quality_remote\x18\x1f \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\x10e2eQualityRemote\x12P\n" +
	"%e2e_quality_remote_instantaneous_time\x18  \x01(\x04R!e2eQualityRemoteInstantaneousTime\x12F\n" +
	" e2e_quality_remote_lifetime_time\x18! \x01(\x04R\x1ce2eQualityRemoteLifetimeTime\x12Y\n" +
	"\x13front_quality_local\x18( \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\x11frontQualityLocal\x12[\n" +
	"\x14front_quality_remote\x18) \x01(\v2).steam.CMsgSteamDatagramConnectionQualityR\x12frontQualityRemote\x12T\n" +
	"'front_quality_remote_instantaneous_time\x18* \x01(\x04R#frontQualityRemoteInstantaneousTime\x12J\n" +
	"\"front_quality_remote_lifetime_time\x18+ \x01(\x04R\x1efrontQualityRemoteLifetimeTime\"p\n" +
	"\x19CGameNetworkingUI_Message\x12S\n" +
	"\x10connection_state\x18\x01 \x03(\v2(.steam.CGameNetworkingUI_ConnectionStateR\x0fconnectionState\"\xdc\x02\n" +
	...
	"\rip_was_shared\x18\a \x01(\bR\vipWasShared\"\xa4\x02\n" +
	...
	"\x12active_connections\x18\x14 \x01(\rR\x11activeConnections\x12E\n" +
	"\bmain_cxn\x18\x1e \x01(\v2*.steam.CGameNetworkingUI_ConnectionSummaryR\amainCxnB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_gamenetworkingui_proto_goTypes = []any{
	(*CGameNetworkingUI_GlobalState)(nil),       // 0: steam.CGameNetworkingUI_GlobalState
	(*CGameNetworkingUI_ConnectionState)(nil),   // 1: steam.CGameNetworkingUI_ConnectionState
	(*CGameNetworkingUI_Message)(nil),           // 2: steam.CGameNetworkingUI_Message
	(*CGameNetworkingUI_ConnectionSummary)(nil), // 3: steam.CGameNetworkingUI_ConnectionSummary
	(*CGameNetworkingUI_AppSummary)(nil),        // 4: steam.CGameNetworkingUI_AppSummary
	(*CMsgSteamDatagramP2PRoutingSummary)(nil),  // 5: steam.CMsgSteamDatagramP2PRoutingSummary
	(*CMsgSteamDatagramConnectionQuality)(nil),  // 6: steam.CMsgSteamDatagramConnectionQuality
}
var file_steammessages_gamenetworkingui_proto_depIdxs = []int32{
	5, // 0: steam.CGameNetworkingUI_ConnectionState.p2p_routing:type_name -> steam.CMsgSteamDatagramP2PRoutingSummary
	6, // 1: steam.CGameNetworkingUI_ConnectionState.e2e_quality_local:type_name -> steam.CMsgSteamDatagramConnectionQuality
	6, // 2: steam.CGameNetworkingUI_ConnectionState.e2e_quality_remote:type_name -> steam.CMsgSteamDatagramConnectionQuality
	6, // 3: steam.CGameNetworkingUI_ConnectionState.front_quality_local:type_name -> steam.CMsgSteamDatagramConnectionQuality
	6, // 4: steam.CGameNetworkingUI_ConnectionState.front_quality_remote:type_name -> steam.CMsgSteamDatagramConnectionQuality
	1, // 5: steam.CGameNetworkingUI_Message.connection_state:type_name -> steam.CGameNetworkingUI_ConnectionState
	3, // 6: steam.CGameNetworkingUI_AppSummary.main_cxn:type_name -> steam.CGameNetworkingUI_ConnectionSummary
