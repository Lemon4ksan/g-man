...
type CDepotContentDetection_GetAllDetectedAppContent_Request struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	DetectionType *EAppContentDetectionType `protobuf:"varint,1,opt,name=detection_type,json=detectionType,enum=steam.EAppContentDetectionType,def=0" json:"detection_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_steammessages_contentsystem_steamclient_proto_rawDesc = "" +
	"\n" +
	"-steammessages_contentsystem.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"\x83\x01\n" +
	...
	"\bhostname\x18\x03 \x01(\tR\bhostname\"\xce\x02\n" +
	...
	"ipv6Public\x12l\n" +
	"\x13current_connections\x18\x06 \x03(\v2;.steam.CContentServerDirectory_ConnectedSteamPipeServerInfoR\x12currentConnections\"\xc1\x04\n" +
	...
	"\x16bypass_proxies_of_type\x18\x10 \x03(\tR\x13bypassProxiesOfType\"\x9b\x01\n" +
	"7CContentServerDirectory_GetServersForSteamPipe_Response\x12C\n" +
	"\aservers\x18\x01 \x03(\v2).steam.CContentServerDirectory_ServerInfoR\aservers\x12\x1b\n" +
	...
	"\tip_public\x18\x02 \x01(\tR\bipPublic\"\xa2\x01\n" +
	"7CDepotContentDetection_GetAllDetectedAppContent_Request\x12g\n" +
	"\x0edetection_type\x18\x01 \x01(\x0e2\x1f.steam.EAppContentDetectionType:\x1fk_EAppContentDetectionType_NoneR\rdetectionType\"q\n" +
	"\x12DetectedAppContent\x12\x15\n" +
	"\x06app_id\x18\x01 \x01(\rR\x05appId\x12\x19\n" +
	"\bdepot_id\x18\x02 \x01(\rR\adepotId\x12)\n" +
	"\x10detected_content\x18\x03 \x01(\x05R\x0fdetectedContent\"\x87\x01\n" +
	"8CDepotContentDetection_GetAllDetectedAppContent_Response\x12K\n" +
	"\x14detected_app_content\x18\x01 \x03(\v2\x19.steam.DetectedAppContentR\x12detectedAppContent*\x94\x01\n" +
	...
	"%k_EAppContentDetectionType_GameEngine\x10\x022\x9e\b\n" +
	"\x16ContentServerDirectory\x12\x97\x01\n" +
	"\x16GetServersForSteamPipe\x12=.steam.CContentServerDirectory_GetServersForSteamPipe_Request\x1a>.steam.CContentServerDirectory_GetServersForSteamPipe_Response\x12\x88\x01\n" +
	"\x11GetDepotPatchInfo\x128.steam.CContentServerDirectory_GetDepotPatchInfo_Request\x1a9.steam.CContentServerDirectory_GetDepotPatchInfo_Response\x12\x91\x01\n" +
	"\x14GetClientUpdateHosts\x12;.steam.CContentServerDirectory_GetClientUpdateHosts_Request\x1a<.steam.CContentServerDirectory_GetClientUpdateHosts_Response\x12\x97\x01\n" +
	"\x16GetManifestRequestCode\x12=.steam.CContentServerDirectory_GetManifestRequestCode_Request\x1a>.steam.CContentServerDirectory_GetManifestRequestCode_Response\x12\x82\x01\n" +
	"\x0fGetCDNAuthToken\x126.steam.CContentServerDirectory_GetCDNAuthToken_Request\x1a7.steam.CContentServerDirectory_GetCDNAuthToken_Response\x12\x9d\x01\n" +
	"\x18RequestPeerContentServer\x12?.steam.CContentServerDirectory_RequestPeerContentServer_Request\x1a@.steam.CContentServerDirectory_RequestPeerContentServer_Response\x12\x8b\x01\n" +
	"\x12GetPeerContentInfo\x129.steam.CContentServerDirectory_GetPeerContentInfo_Request\x1a:.steam.CContentServerDirectory_GetPeerContentInfo_Response2\xb5\x01\n" +
	"\x15DepotContentDetection\x12\x9b\x01\n" +
	"\x18GetAllDetectedAppContent\x12>.steam.CDepotContentDetection_GetAllDetectedAppContent_Request\x1a?.steam.CDepotContentDetection_GetAllDetectedAppContent_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_contentsystem_steamclient_proto_goTypes = []any{
	(EAppContentDetectionType)(0),                                     // 0: steam.EAppContentDetectionType
	(*CContentServerDirectory_ConnectedSteamPipeServerInfo)(nil),      // 1: steam.CContentServerDirectory_ConnectedSteamPipeServerInfo
	(*CContentServerDirectory_GetServersForSteamPipe_Request)(nil),    // 2: steam.CContentServerDirectory_GetServersForSteamPipe_Request
	(*CContentServerDirectory_ServerInfo)(nil),                        // 3: steam.CContentServerDirectory_ServerInfo
	(*CContentServerDirectory_GetServersForSteamPipe_Response)(nil),   // 4: steam.CContentServerDirectory_GetServersForSteamPipe_Response
	(*CContentServerDirectory_GetDepotPatchInfo_Request)(nil),         // 5: steam.CContentServerDirectory_GetDepotPatchInfo_Request
	(*CContentServerDirectory_GetDepotPatchInfo_Response)(nil),        // 6: steam.CContentServerDirectory_GetDepotPatchInfo_Response
	(*CContentServerDirectory_GetClientUpdateHosts_Request)(nil),      // 7: steam.CContentServerDirectory_GetClientUpdateHosts_Request
	(*CContentServerDirectory_GetClientUpdateHosts_Response)(nil),     // 8: steam.CContentServerDirectory_GetClientUpdateHosts_Response
	(*CContentServerDirectory_GetManifestRequestCode_Request)(nil),    // 9: steam.CContentServerDirectory_GetManifestRequestCode_Request
	(*CContentServerDirectory_GetManifestRequestCode_Response)(nil),   // 10: steam.CContentServerDirectory_GetManifestRequestCode_Response
	(*CContentServerDirectory_GetCDNAuthToken_Request)(nil),           // 11: steam.CContentServerDirectory_GetCDNAuthToken_Request
	(*CContentServerDirectory_GetCDNAuthToken_Response)(nil),          // 12: steam.CContentServerDirectory_GetCDNAuthToken_Response
	(*CContentServerDirectory_RequestPeerContentServer_Request)(nil),  // 13: steam.CContentServerDirectory_RequestPeerContentServer_Request
	(*CContentServerDirectory_RequestPeerContentServer_Response)(nil), // 14: steam.CContentServerDirectory_RequestPeerContentServer_Response
	(*CContentServerDirectory_GetPeerContentInfo_Request)(nil),        // 15: steam.CContentServerDirectory_GetPeerContentInfo_Request
	(*CContentServerDirectory_GetPeerContentInfo_Response)(nil),       // 16: steam.CContentServerDirectory_GetPeerContentInfo_Response
	(*CDepotContentDetection_GetAllDetectedAppContent_Request)(nil),   // 17: steam.CDepotContentDetection_GetAllDetectedAppContent_Request
	(*DetectedAppContent)(nil),                                        // 18: steam.DetectedAppContent
	(*CDepotContentDetection_GetAllDetectedAppContent_Response)(nil),  // 19: steam.CDepotContentDetection_GetAllDetectedAppContent_Response
}
var file_steammessages_contentsystem_steamclient_proto_depIdxs = []int32{
	1,  // 0: steam.CContentServerDirectory_GetServersForSteamPipe_Request.current_connections:type_name -> steam.CContentServerDirectory_ConnectedSteamPipeServerInfo
	3,  // 1: steam.CContentServerDirectory_GetServersForSteamPipe_Response.servers:type_name -> steam.CContentServerDirectory_ServerInfo
	0,  // 2: steam.CDepotContentDetection_GetAllDetectedAppContent_Request.detection_type:type_name -> steam.EAppContentDetectionType
	18, // 3: steam.CDepotContentDetection_GetAllDetectedAppContent_Response.detected_app_content:type_name -> steam.DetectedAppContent
	2,  // 4: steam.ContentServerDirectory.GetServersForSteamPipe:input_type -> steam.CContentServerDirectory_GetServersForSteamPipe_Request
	5,  // 5: steam.ContentServerDirectory.GetDepotPatchInfo:input_type -> steam.CContentServerDirectory_GetDepotPatchInfo_Request
	7,  // 6: steam.ContentServerDirectory.GetClientUpdateHosts:input_type -> steam.CContentServerDirectory_GetClientUpdateHosts_Request
	9,  // 7: steam.ContentServerDirectory.GetManifestRequestCode:input_type -> steam.CContentServerDirectory_GetManifestRequestCode_Request
	11, // 8: steam.ContentServerDirectory.GetCDNAuthToken:input_type -> steam.CContentServerDirectory_GetCDNAuthToken_Request
	13, // 9: steam.ContentServerDirectory.RequestPeerContentServer:input_type -> steam.CContentServerDirectory_RequestPeerContentServer_Request
	15, // 10: steam.ContentServerDirectory.GetPeerContentInfo:input_type -> steam.CContentServerDirectory_GetPeerContentInfo_Request
	17, // 11: steam.DepotContentDetection.GetAllDetectedAppContent:input_type -> steam.CDepotContentDetection_GetAllDetectedAppContent_Request
	4,  // 12: steam.ContentServerDirectory.GetServersForSteamPipe:output_type -> steam.CContentServerDirectory_GetServersForSteamPipe_Response
	6,  // 13: steam.ContentServerDirectory.GetDepotPatchInfo:output_type -> steam.CContentServerDirectory_GetDepotPatchInfo_Response
	8,  // 14: steam.ContentServerDirectory.GetClientUpdateHosts:output_type -> steam.CContentServerDirectory_GetClientUpdateHosts_Response
	10, // 15: steam.ContentServerDirectory.GetManifestRequestCode:output_type -> steam.CContentServerDirectory_GetManifestRequestCode_Response
	12, // 16: steam.ContentServerDirectory.GetCDNAuthToken:output_type -> steam.CContentServerDirectory_GetCDNAuthToken_Response
	14, // 17: steam.ContentServerDirectory.RequestPeerContentServer:output_type -> steam.CContentServerDirectory_RequestPeerContentServer_Response
	16, // 18: steam.ContentServerDirectory.GetPeerContentInfo:output_type -> steam.CContentServerDirectory_GetPeerContentInfo_Response
	19, // 19: steam.DepotContentDetection.GetAllDetectedAppContent:output_type -> steam.CDepotContentDetection_GetAllDetectedAppContent_Response
