...
const file_steammessages_clientlanp2p_proto_rawDesc = "" +
	"\n" +
	" steammessages_clientlanp2p.proto\x12\x05steam\x1a\x18steammessages_base.proto\"\xa6\x01\n" +
	"\x1dCMsgClientLANP2PRequestChunks\x12L\n" +
	"\n" +
	"chunk_keys\x18\x01 \x03(\v2-.steam.CMsgClientLANP2PRequestChunks.ChunkKeyR\tchunkKeys\x1a7\n" +
	"\bChunkKey\x12\x19\n" +
	"\bdepot_id\x18\x01 \x01(\rR\adepotId\x12\x10\n" +
	"\x03sha\x18\x02 \x01(\fR\x03sha\"\xb8\x02\n" +
	"%CMsgClientLANP2PRequestChunksResponse\x12_\n" +
	"\x0fchunk_responses\x18\x01 \x03(\v26.steam.CMsgClientLANP2PRequestChunksResponse.ChunkDataR\x0echunkResponses\x1a\xad\x01\n" +
	"\tChunkData\x12\x16\n" +
	...
	"compressed\x12\x1d\n" +
	"\n" +
	"chunk_data\x18\a \x01(\fR\tchunkDataB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steammessages_clientlanp2p_proto_goTypes = []any{
	...
	(*CMsgClientPeerChunkRequest)(nil),                      // 2: steam.CMsgClientPeerChunkRequest
	(*CMsgClientPeerChunkResponse)(nil),                     // 3: steam.CMsgClientPeerChunkResponse
	(*CMsgClientLANP2PRequestChunks_ChunkKey)(nil),          // 4: steam.CMsgClientLANP2PRequestChunks.ChunkKey
	(*CMsgClientLANP2PRequestChunksResponse_ChunkData)(nil), // 5: steam.CMsgClientLANP2PRequestChunksResponse.ChunkData
}
var file_steammessages_clientlanp2p_proto_depIdxs = []int32{
	4, // 0: steam.CMsgClientLANP2PRequestChunks.chunk_keys:type_name -> steam.CMsgClientLANP2PRequestChunks.ChunkKey
	5, // 1: steam.CMsgClientLANP2PRequestChunksResponse.chunk_responses:type_name -> steam.CMsgClientLANP2PRequestChunksResponse.ChunkData
