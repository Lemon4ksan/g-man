...
type CTwoFactor_Status_Request struct {
	...
	Include       *ETwoFactorStatusFieldFlag `protobuf:"varint,2,opt,name=include,enum=steam.ETwoFactorStatusFieldFlag,def=0" json:"include,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CTwoFactor_UsageEvent struct {
	...
	UsageType          *ETwoFactorUsageType   `protobuf:"varint,2,opt,name=usage_type,json=usageType,enum=steam.ETwoFactorUsageType,def=0" json:"usage_type,omitempty"`
...
const file_steammessages_twofactor_steamclient_proto_rawDesc = "" +
	"\n" +
	")steammessages_twofactor.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\":\n" +
	...
	"\fmax_attempts\x18\t \x01(\rR\vmaxAttempts\"\x93\x01\n" +
	"\x19CTwoFactor_Status_Request\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12\\\n" +
	"\ainclude\x18\x02 \x01(\x0e2 .steam.ETwoFactorStatusFieldFlag: k_ETwoFactorStatusFieldFlag_NoneR\ainclude\"\xe3\x01\n" +
	"\x15CTwoFactor_UsageEvent\x12\x12\n" +
	"\x04time\x18\x01 \x01(\rR\x04time\x12X\n" +
	"\n" +
	"usage_type\x18\x02 \x01(\x0e2\x1a.steam.ETwoFactorUsageType:\x1dk_ETwoFactorUsageType_UnknownR\tusageType\x12+\n" +
	"\x11confirmation_type\x18\x03 \x01(\x05R\x10confirmationType\x12/\n" +
	"\x13confirmation_action\x18\x04 \x01(\x05R\x12confirmationAction\"\xec\x05\n" +
	...
	"\x17last_seen_auth_token_id\x18\x0f \x01(\x06R\x13lastSeenAuthTokenId\x124\n" +
	"\x06usages\x18\x10 \x03(\v2\x1c.steam.CTwoFactor_UsageEventR\x06usages\"\xaf\x02\n" +
	...
	"\asteamid\x18\f \x01(\x06R\asteamid\"\xc7\x01\n" +
	";CTwoFactor_RemoveAuthenticatorViaChallengeContinue_Response\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12n\n" +
	"\x11replacement_token\x18\x02 \x01(\v2A.steam.CRemoveAuthenticatorViaChallengeContinue_Replacement_TokenR\x10replacementToken*l\n" +
	...
	"\x1bk_ETwoFactorUsageType_Login\x10\x032\xe6\a\n" +
	"\tTwoFactor\x12L\n" +
	"\tQueryTime\x12\x1e.steam.CTwoFactor_Time_Request\x1a\x1f.steam.CTwoFactor_Time_Response\x12R\n" +
	"\vQueryStatus\x12 .steam.CTwoFactor_Status_Request\x1a!.steam.CTwoFactor_Status_Response\x12k\n" +
	"\x10AddAuthenticator\x12*.steam.CTwoFactor_AddAuthenticator_Request\x1a+.steam.CTwoFactor_AddAuthenticator_Response\x12\x83\x01\n" +
	"\x18FinalizeAddAuthenticator\x122.steam.CTwoFactor_FinalizeAddAuthenticator_Request\x1a3.steam.CTwoFactor_FinalizeAddAuthenticator_Response\x12q\n" +
	"\x12UpdateTokenVersion\x12,.steam.CTwoFactor_UpdateTokenVersion_Request\x1a-.steam.CTwoFactor_UpdateTokenVersion_Response\x12t\n" +
	"\x13RemoveAuthenticator\x12-.steam.CTwoFactor_RemoveAuthenticator_Request\x1a..steam.CTwoFactor_RemoveAuthenticator_Response\x12\xa7\x01\n" +
	"$RemoveAuthenticatorViaChallengeStart\x12>.steam.CTwoFactor_RemoveAuthenticatorViaChallengeStart_Request\x1a?.steam.CTwoFactor_RemoveAuthenticatorViaChallengeStart_Response\x12\xb0\x01\n" +
	"'RemoveAuthenticatorViaChallengeContinue\x12A.steam.CTwoFactor_RemoveAuthenticatorViaChallengeContinue_Request\x1aB.steam.CTwoFactor_RemoveAuthenticatorViaChallengeContinue_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_twofactor_steamclient_proto_goTypes = []any{
	(ETwoFactorStatusFieldFlag)(0),                                      // 0: steam.ETwoFactorStatusFieldFlag
	(ETwoFactorUsageType)(0),                                            // 1: steam.ETwoFactorUsageType
	(*CTwoFactor_Time_Request)(nil),                                     // 2: steam.CTwoFactor_Time_Request
	(*CTwoFactor_Time_Response)(nil),                                    // 3: steam.CTwoFactor_Time_Response
	(*CTwoFactor_Status_Request)(nil),                                   // 4: steam.CTwoFactor_Status_Request
	(*CTwoFactor_UsageEvent)(nil),                                       // 5: steam.CTwoFactor_UsageEvent
	(*CTwoFactor_Status_Response)(nil),                                  // 6: steam.CTwoFactor_Status_Response
	(*CTwoFactor_AddAuthenticator_Request)(nil),                         // 7: steam.CTwoFactor_AddAuthenticator_Request
	(*CTwoFactor_AddAuthenticator_Response)(nil),                        // 8: steam.CTwoFactor_AddAuthenticator_Response
	(*CTwoFactor_FinalizeAddAuthenticator_Request)(nil),                 // 9: steam.CTwoFactor_FinalizeAddAuthenticator_Request
	(*CTwoFactor_FinalizeAddAuthenticator_Response)(nil),                // 10: steam.CTwoFactor_FinalizeAddAuthenticator_Response
	(*CTwoFactor_UpdateTokenVersion_Request)(nil),                       // 11: steam.CTwoFactor_UpdateTokenVersion_Request
	(*CTwoFactor_UpdateTokenVersion_Response)(nil),                      // 12: steam.CTwoFactor_UpdateTokenVersion_Response
	(*CTwoFactor_RemoveAuthenticator_Request)(nil),                      // 13: steam.CTwoFactor_RemoveAuthenticator_Request
	(*CTwoFactor_RemoveAuthenticator_Response)(nil),                     // 14: steam.CTwoFactor_RemoveAuthenticator_Response
	(*CTwoFactor_RemoveAuthenticatorViaChallengeStart_Request)(nil),     // 15: steam.CTwoFactor_RemoveAuthenticatorViaChallengeStart_Request
	(*CTwoFactor_RemoveAuthenticatorViaChallengeStart_Response)(nil),    // 16: steam.CTwoFactor_RemoveAuthenticatorViaChallengeStart_Response
	(*CTwoFactor_RemoveAuthenticatorViaChallengeContinue_Request)(nil),  // 17: steam.CTwoFactor_RemoveAuthenticatorViaChallengeContinue_Request
	(*CRemoveAuthenticatorViaChallengeContinue_Replacement_Token)(nil),  // 18: steam.CRemoveAuthenticatorViaChallengeContinue_Replacement_Token
	(*CTwoFactor_RemoveAuthenticatorViaChallengeContinue_Response)(nil), // 19: steam.CTwoFactor_RemoveAuthenticatorViaChallengeContinue_Response
}
var file_steammessages_twofactor_steamclient_proto_depIdxs = []int32{
	0,  // 0: steam.CTwoFactor_Status_Request.include:type_name -> steam.ETwoFactorStatusFieldFlag
	1,  // 1: steam.CTwoFactor_UsageEvent.usage_type:type_name -> steam.ETwoFactorUsageType
	5,  // 2: steam.CTwoFactor_Status_Response.usages:type_name -> steam.CTwoFactor_UsageEvent
	18, // 3: steam.CTwoFactor_RemoveAuthenticatorViaChallengeContinue_Response.replacement_token:type_name -> steam.CRemoveAuthenticatorViaChallengeContinue_Replacement_Token
	2,  // 4: steam.TwoFactor.QueryTime:input_type -> steam.CTwoFactor_Time_Request
	4,  // 5: steam.TwoFactor.QueryStatus:input_type -> steam.CTwoFactor_Status_Request
	7,  // 6: steam.TwoFactor.AddAuthenticator:input_type -> steam.CTwoFactor_AddAuthenticator_Request
	9,  // 7: steam.TwoFactor.FinalizeAddAuthenticator:input_type -> steam.CTwoFactor_FinalizeAddAuthenticator_Request
	11, // 8: steam.TwoFactor.UpdateTokenVersion:input_type -> steam.CTwoFactor_UpdateTokenVersion_Request
	13, // 9: steam.TwoFactor.RemoveAuthenticator:input_type -> steam.CTwoFactor_RemoveAuthenticator_Request
	15, // 10: steam.TwoFactor.RemoveAuthenticatorViaChallengeStart:input_type -> steam.CTwoFactor_RemoveAuthenticatorViaChallengeStart_Request
	17, // 11: steam.TwoFactor.RemoveAuthenticatorViaChallengeContinue:input_type -> steam.CTwoFactor_RemoveAuthenticatorViaChallengeContinue_Request
	3,  // 12: steam.TwoFactor.QueryTime:output_type -> steam.CTwoFactor_Time_Response
	6,  // 13: steam.TwoFactor.QueryStatus:output_type -> steam.CTwoFactor_Status_Response
	8,  // 14: steam.TwoFactor.AddAuthenticator:output_type -> steam.CTwoFactor_AddAuthenticator_Response
	10, // 15: steam.TwoFactor.FinalizeAddAuthenticator:output_type -> steam.CTwoFactor_FinalizeAddAuthenticator_Response
	12, // 16: steam.TwoFactor.UpdateTokenVersion:output_type -> steam.CTwoFactor_UpdateTokenVersion_Response
	14, // 17: steam.TwoFactor.RemoveAuthenticator:output_type -> steam.CTwoFactor_RemoveAuthenticator_Response
	16, // 18: steam.TwoFactor.RemoveAuthenticatorViaChallengeStart:output_type -> steam.CTwoFactor_RemoveAuthenticatorViaChallengeStart_Response
	19, // 19: steam.TwoFactor.RemoveAuthenticatorViaChallengeContinue:output_type -> steam.CTwoFactor_RemoveAuthenticatorViaChallengeContinue_Response
