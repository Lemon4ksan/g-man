...
type CStreamVideoLimit struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Codec            *EStreamVideoCodec     `protobuf:"varint,1,opt,name=codec,enum=steam.EStreamVideoCodec,def=0" json:"codec,omitempty"`
...
type CStreamingClientCaps struct {
	...
	SupportedColorspaces          []EStreamColorspace    `protobuf:"varint,13,rep,name=supported_colorspaces,json=supportedColorspaces,enum=steam.EStreamColorspace" json:"supported_colorspaces,omitempty"`
	SupportedAudioCodecs          []EStreamAudioCodec    `protobuf:"varint,14,rep,name=supported_audio_codecs,json=supportedAudioCodecs,enum=steam.EStreamAudioCodec" json:"supported_audio_codecs,omitempty"`
	SupportedVideoCodecs          []EStreamVideoCodec    `protobuf:"varint,15,rep,name=supported_video_codecs,json=supportedVideoCodecs,enum=steam.EStreamVideoCodec" json:"supported_video_codecs,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
type CStreamingClientConfig struct {
	...
	P2PScope                       *EStreamP2PScope          `protobuf:"varint,19,opt,name=p2p_scope,json=p2pScope,enum=steam.EStreamP2PScope,def=0" json:"p2p_scope,omitempty"`
...
type CStreamingServerConfig struct {
	state                     protoimpl.MessageState          `protogen:"open.v1"`
	HostPlayAudio             *EStreamHostPlayAudioPreference `protobuf:"varint,1,opt,name=host_play_audio,json=hostPlayAudio,enum=steam.EStreamHostPlayAudioPreference,def=0" json:"host_play_audio,omitempty"`
	...
	DisplayResolutionSetting  *EStreamHostDisplaySetting      `protobuf:"varint,3,opt,name=display_resolution_setting,json=displayResolutionSetting,enum=steam.EStreamHostDisplaySetting,def=0" json:"display_resolution_setting,omitempty"`
	...
	DisplayRefreshRateSetting *EStreamHostDisplaySetting      `protobuf:"varint,6,opt,name=display_refresh_rate_setting,json=displayRefreshRateSetting,enum=steam.EStreamHostDisplaySetting,def=0" json:"display_refresh_rate_setting,omitempty"`
	...
	DisplayHdrSetting         *EStreamHostDisplaySetting      `protobuf:"varint,8,opt,name=display_hdr_setting,json=displayHdrSetting,enum=steam.EStreamHostDisplaySetting,def=0" json:"display_hdr_setting,omitempty"`
...
type CCaptureFailedMsg struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Reason        *ECaptureFailedReason  `protobuf:"varint,1,opt,name=reason,enum=steam.ECaptureFailedReason,def=0" json:"reason,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CControllerConfigMsg struct {
	state                   protoimpl.MessageState                                  `protogen:"open.v1"`
	Type                    *EStreamControllerConfigMsg                             `protobuf:"varint,1,req,name=type,enum=steam.EStreamControllerConfigMsg,def=0" json:"type,omitempty"`
...
const file_steammessages_remoteplay_proto_rawDesc = "" +
	"\n" +
	"\x1esteammessages_remoteplay.proto\x12\x05steam\"g\n" +
	...
	"\fnetwork_test\x18\x02 \x01(\x05R\vnetworkTest\"O\n" +
	"\x13CClientHandshakeMsg\x128\n" +
	"\x04info\x18\x01 \x02(\v2$.steam.CStreamingClientHandshakeInfoR\x04info\"1\n" +
	"\x1dCStreamingServerHandshakeInfo\x12\x10\n" +
	"\x03mtu\x18\x01 \x01(\x05R\x03mtu\"O\n" +
	"\x13CServerHandshakeMsg\x128\n" +
	"\x04info\x18\x01 \x02(\v2$.steam.CStreamingServerHandshakeInfoR\x04info\"\x92\x01\n" +
	"\x19CAuthenticationRequestMsg\x12\x14\n" +
	"\x05token\x18\x01 \x01(\fR\x05token\x12E\n" +
	"\aversion\x18\x02 \x01(\x0e2\x15.steam.EStreamVersion:\x14k_EStreamVersionNoneR\aversion\x12\x18\n" +
	"\asteamid\x18\x03 \x01(\x04R\asteamid\"\xf1\x01\n" +
	"\x1aCAuthenticationResponseMsg\x12Y\n" +
	"\x06result\x18\x01 \x01(\x0e26.steam.CAuthenticationResponseMsg.AuthenticationResult:\tSUCCEEDEDR\x06result\x12E\n" +
	"\aversion\x18\x02 \x01(\x0e2\x15.steam.EStreamVersion:\x14k_EStreamVersionNoneR\aversion\"1\n" +
	...
	"\x18refresh_rate_denominator\x18\x05 \x01(\rR\x16refreshRateDenominator\"\xda\x01\n" +
	"\x11CStreamVideoLimit\x12G\n" +
	"\x05codec\x18\x01 \x01(\x0e2\x18.steam.EStreamVideoCodec:\x17k_EStreamVideoCodecNoneR\x05codec\x12+\n" +
	"\x04mode\x18\x02 \x01(\v2\x17.steam.CStreamVideoModeR\x04mode\x12!\n" +
	"\fbitrate_kbps\x18\x03 \x01(\x05R\vbitrateKbps\x12,\n" +
	"\x12burst_bitrate_kbps\x18\x04 \x01(\x05R\x10burstBitrateKbps\"\x9e\a\n" +
	...
	"formFactor\x123\n" +
	"\x16has_on_screen_keyboard\x18\f \x01(\bR\x13hasOnScreenKeyboard\x12M\n" +
	"\x15supported_colorspaces\x18\r \x03(\x0e2\x18.steam.EStreamColorspaceR\x14supportedColorspaces\x12N\n" +
	"\x16supported_audio_codecs\x18\x0e \x03(\x0e2\x18.steam.EStreamAudioCodecR\x14supportedAudioCodecs\x12N\n" +
	"\x16supported_video_codecs\x18\x0f \x03(\x0e2\x18.steam.EStreamVideoCodecR\x14supportedVideoCodecs\"\xb0\f\n" +
	"\x16CStreamingClientConfig\x12S\n" +
	"\aquality\x18\x01 \x01(\x0e2\x1f.steam.EStreamQualityPreference:\x18k_EStreamQualityBalancedR\aquality\x120\n" +
	...
	" enable_touch_controller_OBSOLETE\x18\x11 \x01(\b:\x05falseR\x1denableTouchControllerOBSOLETE\x12O\n" +
	"\tp2p_scope\x18\x13 \x01(\x0e2\x16.steam.EStreamP2PScope:\x1ak_EStreamP2PScopeAutomaticR\bp2pScope\x12A\n" +
	"\x19enable_audio_uncompressed\x18\x14 \x01(\b:\x05falseR\x17enableAudioUncompressed\x12=\n" +
	"\rdisplay_limit\x18\x15 \x01(\v2\x18.steam.CStreamVideoLimitR\fdisplayLimit\x12=\n" +
	"\rquality_limit\x18\x16 \x01(\v2\x18.steam.CStreamVideoLimitR\fqualityLimit\x12=\n" +
	"\rruntime_limit\x18\x17 \x01(\v2\x18.steam.CStreamVideoLimitR\fruntimeLimit\x12=\n" +
	"\rdecoder_limit\x18\x18 \x03(\v2\x18.steam.CStreamVideoLimitR\fdecoderLimit\x129\n" +
	"\x15enable_unreliable_fec\x18\x19 \x01(\b:\x05falseR\x13enableUnreliableFec\x12/\n" +
	"\x10enable_video_av1\x18\x1a \x01(\b:\x05falseR\x0eenableVideoAv1\"\xfe\a\n" +
	"\x16CStreamingServerConfig\x12l\n" +
	"\x0fhost_play_audio\x18\x01 \x01(\x0e2%.steam.EStreamHostPlayAudioPreference:\x1dk_EStreamHostPlayAudioDefaultR\rhostPlayAudio\x122\n" +
	"\x15custom_display_device\x18\x02 \x01(\tR\x13customDisplayDevice\x12\x7f\n" +
	"\x1adisplay_resolution_setting\x18\x03 \x01(\x0e2 .steam.EStreamHostDisplaySetting:\x1fk_EStreamHostDisplaySettingNoneR\x18displayResolutionSetting\x12=\n" +
	"\x1bcustom_display_resolution_x\x18\x04 \x01(\x05R\x18customDisplayResolutionX\x12=\n" +
	"\x1bcustom_display_resolution_y\x18\x05 \x01(\x05R\x18customDisplayResolutionY\x12\x82\x01\n" +
	"\x1cdisplay_refresh_rate_setting\x18\x06 \x01(\x0e2 .steam.EStreamHostDisplaySetting:\x1fk_EStreamHostDisplaySettingNoneR\x19displayRefreshRateSetting\x12=\n" +
	"\x1bcustom_display_refresh_rate\x18\a \x01(\tR\x18customDisplayRefreshRate\x12q\n" +
	"\x13display_hdr_setting\x18\b \x01(\x0e2 .steam.EStreamHostDisplaySetting:\x1fk_EStreamHostDisplaySettingNoneR\x11displayHdrSetting\x12,\n" +
	...
	"\x17enable_traffic_priority\x18\r \x01(\bR\x15enableTrafficPriority\"\xee\x03\n" +
	"\x11CNegotiatedConfig\x12#\n" +
	"\rreliable_data\x18\x01 \x01(\bR\freliableData\x12c\n" +
	"\x14selected_audio_codec\x18\x02 \x01(\x0e2\x18.steam.EStreamAudioCodec:\x17k_EStreamAudioCodecNoneR\x12selectedAudioCodec\x12c\n" +
	"\x14selected_video_codec\x18\x03 \x01(\x0e2\x18.steam.EStreamVideoCodec:\x17k_EStreamVideoCodecNoneR\x12selectedVideoCodec\x12\\\n" +
	"\x1eavailable_video_modes_OBSOLETE\x18\x04 \x03(\v2\x17.steam.CStreamVideoModeR\x1bavailableVideoModesOBSOLETE\x12*\n" +
	"\x11enable_remote_hid\x18\x05 \x01(\bR\x0fenableRemoteHid\x12,\n" +
	"\x12enable_touch_input\x18\x06 \x01(\bR\x10enableTouchInput\x122\n" +
	"\x15disable_client_cursor\x18\a \x01(\bR\x13disableClientCursor\"\x83\x03\n" +
	"\x13CNegotiationInitMsg\x12#\n" +
	"\rreliable_data\x18\x01 \x01(\bR\freliableData\x12N\n" +
	"\x16supported_audio_codecs\x18\x02 \x03(\x0e2\x18.steam.EStreamAudioCodecR\x14supportedAudioCodecs\x12N\n" +
	"\x16supported_video_codecs\x18\x03 \x03(\x0e2\x18.steam.EStreamVideoCodecR\x14supportedVideoCodecs\x12.\n" +
	...
	"\x12gaming_device_type\x18\a \x01(\x05R\x10gamingDeviceType\"\xf4\x01\n" +
	"\x18CNegotiationSetConfigMsg\x120\n" +
	"\x06config\x18\x01 \x02(\v2\x18.steam.CNegotiatedConfigR\x06config\x12U\n" +
	"\x17streaming_client_config\x18\x02 \x01(\v2\x1d.steam.CStreamingClientConfigR\x15streamingClientConfig\x12O\n" +
	"\x15streaming_client_caps\x18\x03 \x01(\v2\x1b.steam.CStreamingClientCapsR\x13streamingClientCaps\"\x19\n" +
	"\x17CNegotiationCompleteMsg\"\xd0\x01\n" +
	"\x12CStartAudioDataMsg\x12\x18\n" +
	"\achannel\x18\x02 \x02(\rR\achannel\x12G\n" +
	"\x05codec\x18\x03 \x01(\x0e2\x18.steam.EStreamAudioCodec:\x17k_EStreamAudioCodecNoneR\x05codec\x12\x1d\n" +
	"\n" +
	...
	"\x11CStopAudioDataMsg\"\xc4\x01\n" +
	"\x12CStartVideoDataMsg\x12\x18\n" +
	"\achannel\x18\x01 \x02(\rR\achannel\x12G\n" +
	"\x05codec\x18\x02 \x01(\x0e2\x18.steam.EStreamVideoCodec:\x17k_EStreamVideoCodecNoneR\x05codec\x12\x1d\n" +
	"\n" +
	...
	"\x11CStopVideoDataMsg\"\x8a\x06\n" +
	"\x0eCRecordedInput\x12W\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1c.steam.EStreamControlMessage:%k_EStreamControlAuthenticationRequestR\x04type\x12\x1c\n" +
	"\ttimestamp\x18\x02 \x01(\rR\ttimestamp\x12B\n" +
	"\vfinger_down\x18\x03 \x01(\v2\x1f.steam.CInputTouchFingerDownMsgH\x00R\n" +
	"fingerDown\x12H\n" +
	"\rfinger_motion\x18\x04 \x01(\v2!.steam.CInputTouchFingerMotionMsgH\x00R\ffingerMotion\x12<\n" +
	"\tfinger_up\x18\x05 \x01(\v2\x1d.steam.CInputTouchFingerUpMsgH\x00R\bfingerUp\x12@\n" +
	"\fmouse_motion\x18\x06 \x01(\v2\x1b.steam.CInputMouseMotionMsgH\x00R\vmouseMotion\x12=\n" +
	"\vmouse_wheel\x18\a \x01(\v2\x1a.steam.CInputMouseWheelMsgH\x00R\n" +
	"mouseWheel\x12:\n" +
	"\n" +
	"mouse_down\x18\b \x01(\v2\x19.steam.CInputMouseDownMsgH\x00R\tmouseDown\x124\n" +
	"\bmouse_up\x18\t \x01(\v2\x17.steam.CInputMouseUpMsgH\x00R\amouseUp\x124\n" +
	"\bkey_down\x18\n" +
	" \x01(\v2\x17.steam.CInputKeyDownMsgH\x00R\akeyDown\x12.\n" +
	"\x06key_up\x18\v \x01(\v2\x15.steam.CInputKeyUpMsgH\x00R\x05keyUp\x12*\n" +
	"\x04text\x18\f \x01(\v2\x14.steam.CInputTextMsgH\x00R\x04text\x12(\n" +
	"\x03hid\x18\r \x01(\v2\x14.steam.CRemoteHIDMsgH\x00R\x03hidB\x06\n" +
	"\x04data\"G\n" +
	"\x14CRecordedInputStream\x12/\n" +
	"\aentries\x18\x01 \x03(\v2\x15.steam.CRecordedInputR\aentries\"K\n" +
	...
	"\x02dy\x18\x05 \x01(\x05R\x02dy\"\xa7\x01\n" +
	"\x13CInputMouseWheelMsg\x12\x1d\n" +
	"\n" +
	"input_mark\x18\x01 \x01(\rR\tinputMark\x12V\n" +
	"\tdirection\x18\x02 \x02(\x0e2!.steam.EStreamMouseWheelDirection:\x15k_EStreamMouseWheelUpR\tdirection\x12\x19\n" +
	"\x06amount\x18\x03 \x01(\x02:\x011R\x06amount\"\x80\x01\n" +
	"\x12CInputMouseDownMsg\x12\x1d\n" +
	"\n" +
	"input_mark\x18\x01 \x01(\rR\tinputMark\x12K\n" +
	"\x06button\x18\x02 \x02(\x0e2\x19.steam.EStreamMouseButton:\x18k_EStreamMouseButtonLeftR\x06button\"~\n" +
	"\x10CInputMouseUpMsg\x12\x1d\n" +
	"\n" +
	"input_mark\x18\x01 \x01(\rR\tinputMark\x12K\n" +
	"\x06button\x18\x02 \x02(\x0e2\x19.steam.EStreamMouseButton:\x18k_EStreamMouseButtonLeftR\x06button\"\x85\x01\n" +
	...
	"\x1caltgr_shift_capslock_keycode\x18\t \x01(\x05R\x19altgrShiftCapslockKeycode\"J\n" +
	"\x10CStreamingKeymap\x126\n" +
	"\aentries\x18\x01 \x03(\v2\x1c.steam.CStreamingKeymapEntryR\aentries\"@\n" +
	"\rCSetKeymapMsg\x12/\n" +
	"\x06keymap\x18\x01 \x01(\v2\x17.steam.CStreamingKeymapR\x06keymap\"\x0e\n" +
	"\fCStopRequest\"\x0e\n" +
	"\fCQuitRequest\"/\n" +
	"\x10CDeleteCursorMsg\x12\x1b\n" +
	"\tcursor_id\x18\x01 \x02(\x04R\bcursorId\"R\n" +
	"\x19CSetStreamingClientConfig\x125\n" +
	"\x06config\x18\x01 \x02(\v2\x1d.steam.CStreamingClientConfigR\x06config\"%\n" +
	"\n" +
	"CSetQoSMsg\x12\x17\n" +
	...
	"\n" +
	"gamma_ramp\x18\x01 \x01(\fR\tgammaRamp\"\xa7\x01\n" +
	"\x0fCSetActivityMsg\x12I\n" +
	"\bactivity\x18\x01 \x01(\x0e2\x16.steam.EStreamActivity:\x15k_EStreamActivityIdleR\bactivity\x12\x14\n" +
	...
	"\x04data\x18\x03 \x01(\fR\x04data\"\xbb\x04\n" +
	"!CRemotePlayTogetherGroupUpdateMsg\x12I\n" +
	"\aplayers\x18\x01 \x03(\v2/.steam.CRemotePlayTogetherGroupUpdateMsg.PlayerR\aplayers\x12!\n" +
	...
	"\x0econnect_params\x18\x01 \x01(\tR\rconnectParams\"d\n" +
	"\x11CCaptureFailedMsg\x12O\n" +
	"\x06reason\x18\x01 \x01(\x0e2\x1b.steam.ECaptureFailedReason:\x1ak_ECaptureFailedReasonNoneR\x06reason\".\n" +
	"\x12CStreamDataLostMsg\x12\x18\n" +
	"\apackets\x18\x01 \x03(\rR\apackets\"\x89\x01\n" +
	"\fCAudioFormat\x12?\n" +
	"\x06format\x18\x01 \x02(\x0e2\x13.steam.EAudioFormat:\x12k_EAudioFormatNoneR\x06format\x12\x1c\n" +
	"\tfrequency\x18\x02 \x01(\rR\tfrequency\x12\x1a\n" +
	"\bchannels\x18\x03 \x01(\rR\bchannels\"}\n" +
	"\fCVideoFormat\x12?\n" +
	"\x06format\x18\x01 \x02(\x0e2\x13.steam.EVideoFormat:\x12k_EVideoFormatNoneR\x06format\x12\x14\n" +
	"\x05width\x18\x02 \x01(\rR\x05width\x12\x16\n" +
	"\x06height\x18\x03 \x01(\rR\x06height\"z\n" +
	"\vCFrameEvent\x12M\n" +
	"\bevent_id\x18\x01 \x02(\x0e2\x18.steam.EStreamFrameEvent:\x18k_EStreamInputEventStartR\aeventId\x12\x1c\n" +
	"\ttimestamp\x18\x02 \x02(\rR\ttimestamp\"\xf1\x03\n" +
	"\vCFrameStats\x12\x19\n" +
	"\bframe_id\x18\x01 \x02(\rR\aframeId\x12\x1d\n" +
	"\n" +
	"input_mark\x18\x02 \x01(\rR\tinputMark\x12*\n" +
	"\x06events\x18\x03 \x03(\v2\x12.steam.CFrameEventR\x06events\x12N\n" +
	"\x06result\x18\x04 \x02(\x0e2\x19.steam.EStreamFrameResult:\x1bk_EStreamFrameResultPendingR\x06result\x12*\n" +
	...
	"packetLoss\x12\x1d\n" +
	"\n" +
	"frame_size\x18\f \x01(\rR\tframeSize\"\xb0\x01\n" +
	"\x1aCFrameStatAccumulatedValue\x12J\n" +
	"\tstat_type\x18\x01 \x02(\x0e2\x1c.steam.EFrameAccumulatedStat:\x0fk_EFrameStatFPSR\bstatType\x12\x14\n" +
	"\x05count\x18\x02 \x02(\x05R\x05count\x12\x18\n" +
	"\aaverage\x18\x03 \x02(\x02R\aaverage\x12\x16\n" +
	"\x06stddev\x18\x04 \x01(\x02R\x06stddev\"\x85\x02\n" +
	"\x12CFrameStatsListMsg\x12M\n" +
	"\tdata_type\x18\x01 \x02(\x0e2\x19.steam.EStreamingDataType:\x15k_EStreamingAudioDataR\bdataType\x12(\n" +
	"\x05stats\x18\x02 \x03(\v2\x12.steam.CFrameStatsR\x05stats\x12N\n" +
	"\x11accumulated_stats\x18\x03 \x03(\v2!.steam.CFrameStatAccumulatedValueR\x10accumulatedStats\x12&\n" +
	...
	"\rCLogUploadMsg\x12=\n" +
	"\x04type\x18\x01 \x01(\x0e2\x13.steam.ELogFileType:\x14k_ELogFileSystemBootR\x04type\x12\x12\n" +
	"\x04data\x18\x03 \x01(\fR\x04data\"\x92\x03\n" +
	"\x13CTransportSignalMsg\x12@\n" +
	"\x06webrtc\x18\x01 \x01(\v2(.steam.CTransportSignalMsg.WebRTCMessageR\x06webrtc\x12\x10\n" +
	"\x03sdr\x18\x02 \x03(\fR\x03sdr\x1a\xa6\x02\n" +
	"\rWebRTCMessage\x12\x1c\n" +
	"\bgreeting\x18\x01 \x01(\bH\x00R\bgreeting\x12\x16\n" +
	"\x05offer\x18\x02 \x01(\tH\x00R\x05offer\x12\x18\n" +
	"\x06answer\x18\x03 \x01(\tH\x00R\x06answer\x12R\n" +
	"\tcandidate\x18\x04 \x01(\v22.steam.CTransportSignalMsg.WebRTCMessage.CandidateH\x00R\tcandidate\x1aj\n" +
	"\tCandidate\x12\x17\n" +
	...
	"\x03msg\"\xa5\t\n" +
	"\x14CControllerConfigMsg\x12h\n" +
	"\x04type\x18\x01 \x02(\x0e2!.steam.EStreamControllerConfigMsg:1k_EStreamControllerConfigMsg_RequestConfigsForAppR\x04type\x12&\n" +
	"\x0econtrollerPath\x18\x02 \x01(\tR\x0econtrollerPath\x12\x14\n" +
	"\x05appid\x18\x03 \x01(\rR\x05appid\x12w\n" +
	"\x17personalizationResponse\x18\x04 \x01(\v2=.steam.CControllerConfigMsg.ControllerPersonalizationResponseR\x17personalizationResponse\x12\\\n" +
	"\x0econfigResponse\x18\x06 \x03(\v24.steam.CControllerConfigMsg.ControllerConfigResponseR\x0econfigResponse\x12k\n" +
	"\x15activeConfigChangeMsg\x18\a \x01(\v25.steam.CControllerConfigMsg.ControllerActiveConfigMsgR\x15activeConfigChangeMsg\x1a\xe8\x01\n" +
	...
	"0k_EStreamControllerConfigMsg_RequestActiveConfig\x10\x04B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steammessages_remoteplay_proto_goTypes = []any{
	...
	(EStreamColorspace)(0),                                            // 8: steam.EStreamColorspace
	(EStreamP2PScope)(0),                                              // 9: steam.EStreamP2PScope
	(EStreamHostPlayAudioPreference)(0),                               // 10: steam.EStreamHostPlayAudioPreference
	(EStreamHostDisplaySetting)(0),                                    // 11: steam.EStreamHostDisplaySetting
	(EStreamingDataType)(0),                                           // 12: steam.EStreamingDataType
	(EStreamMouseButton)(0),                                           // 13: steam.EStreamMouseButton
	(EStreamMouseWheelDirection)(0),                                   // 14: steam.EStreamMouseWheelDirection
	(EStreamFramerateLimiter)(0),                                      // 15: steam.EStreamFramerateLimiter
	(EStreamActivity)(0),                                              // 16: steam.EStreamActivity
	(ECaptureFailedReason)(0),                                         // 17: steam.ECaptureFailedReason
	(EStreamDataMessage)(0),                                           // 18: steam.EStreamDataMessage
	(EAudioFormat)(0),                                                 // 19: steam.EAudioFormat
	(EVideoFormat)(0),                                                 // 20: steam.EVideoFormat
	(EStreamStatsMessage)(0),                                          // 21: steam.EStreamStatsMessage
	(EStreamFrameEvent)(0),                                            // 22: steam.EStreamFrameEvent
	(EStreamFrameResult)(0),                                           // 23: steam.EStreamFrameResult
	(EFrameAccumulatedStat)(0),                                        // 24: steam.EFrameAccumulatedStat
	(ELogFileType)(0),                                                 // 25: steam.ELogFileType
	(EStreamControllerConfigMsg)(0),                                   // 26: steam.EStreamControllerConfigMsg
	(CAuthenticationResponseMsg_AuthenticationResult)(0),              // 27: steam.CAuthenticationResponseMsg.AuthenticationResult
	(*CDiscoveryPingRequest)(nil),                                     // 28: steam.CDiscoveryPingRequest
	(*CDiscoveryPingResponse)(nil),                                    // 29: steam.CDiscoveryPingResponse
	(*CStreamingClientHandshakeInfo)(nil),                             // 30: steam.CStreamingClientHandshakeInfo
	(*CClientHandshakeMsg)(nil),                                       // 31: steam.CClientHandshakeMsg
	(*CStreamingServerHandshakeInfo)(nil),                             // 32: steam.CStreamingServerHandshakeInfo
	(*CServerHandshakeMsg)(nil),                                       // 33: steam.CServerHandshakeMsg
	(*CAuthenticationRequestMsg)(nil),                                 // 34: steam.CAuthenticationRequestMsg
	(*CAuthenticationResponseMsg)(nil),                                // 35: steam.CAuthenticationResponseMsg
	(*CKeepAliveMsg)(nil),                                             // 36: steam.CKeepAliveMsg
	(*CStartNetworkTestMsg)(nil),                                      // 37: steam.CStartNetworkTestMsg
	(*CStreamVideoMode)(nil),                                          // 38: steam.CStreamVideoMode
	(*CStreamVideoLimit)(nil),                                         // 39: steam.CStreamVideoLimit
	(*CStreamingClientCaps)(nil),                                      // 40: steam.CStreamingClientCaps
	(*CStreamingClientConfig)(nil),                                    // 41: steam.CStreamingClientConfig
	(*CStreamingServerConfig)(nil),                                    // 42: steam.CStreamingServerConfig
	(*CNegotiatedConfig)(nil),                                         // 43: steam.CNegotiatedConfig
	(*CNegotiationInitMsg)(nil),                                       // 44: steam.CNegotiationInitMsg
	(*CNegotiationSetConfigMsg)(nil),                                  // 45: steam.CNegotiationSetConfigMsg
	(*CNegotiationCompleteMsg)(nil),                                   // 46: steam.CNegotiationCompleteMsg
	(*CStartAudioDataMsg)(nil),                                        // 47: steam.CStartAudioDataMsg
	(*CStopAudioDataMsg)(nil),                                         // 48: steam.CStopAudioDataMsg
	(*CStartVideoDataMsg)(nil),                                        // 49: steam.CStartVideoDataMsg
	(*CStopVideoDataMsg)(nil),                                         // 50: steam.CStopVideoDataMsg
	(*CRecordedInput)(nil),                                            // 51: steam.CRecordedInput
	(*CRecordedInputStream)(nil),                                      // 52: steam.CRecordedInputStream
	(*CInputLatencyTestMsg)(nil),                                      // 53: steam.CInputLatencyTestMsg
	(*CInputTouchFingerDownMsg)(nil),                                  // 54: steam.CInputTouchFingerDownMsg
	(*CInputTouchFingerMotionMsg)(nil),                                // 55: steam.CInputTouchFingerMotionMsg
	(*CInputTouchFingerUpMsg)(nil),                                    // 56: steam.CInputTouchFingerUpMsg
	(*CInputMouseMotionMsg)(nil),                                      // 57: steam.CInputMouseMotionMsg
	(*CInputMouseWheelMsg)(nil),                                       // 58: steam.CInputMouseWheelMsg
	(*CInputMouseDownMsg)(nil),                                        // 59: steam.CInputMouseDownMsg
	(*CInputMouseUpMsg)(nil),                                          // 60: steam.CInputMouseUpMsg
	(*CInputKeyDownMsg)(nil),                                          // 61: steam.CInputKeyDownMsg
	(*CInputKeyUpMsg)(nil),                                            // 62: steam.CInputKeyUpMsg
	(*CInputTextMsg)(nil),                                             // 63: steam.CInputTextMsg
	(*CSetTitleMsg)(nil),                                              // 64: steam.CSetTitleMsg
	(*CSetCaptureSizeMsg)(nil),                                        // 65: steam.CSetCaptureSizeMsg
	(*CSetIconMsg)(nil),                                               // 66: steam.CSetIconMsg
	(*CSetFlashStateMsg)(nil),                                         // 67: steam.CSetFlashStateMsg
	(*CShowCursorMsg)(nil),                                            // 68: steam.CShowCursorMsg
	(*CHideCursorMsg)(nil),                                            // 69: steam.CHideCursorMsg
	(*CSetCursorMsg)(nil),                                             // 70: steam.CSetCursorMsg
	(*CGetCursorImageMsg)(nil),                                        // 71: steam.CGetCursorImageMsg
	(*CSetCursorImageMsg)(nil),                                        // 72: steam.CSetCursorImageMsg
	(*CSetCursorScaleMsg)(nil),                                        // 73: steam.CSetCursorScaleMsg
	(*CVideoDecoderInfoMsg)(nil),                                      // 74: steam.CVideoDecoderInfoMsg
	(*CVideoEncoderInfoMsg)(nil),                                      // 75: steam.CVideoEncoderInfoMsg
	(*CPauseMsg)(nil),                                                 // 76: steam.CPauseMsg
	(*CResumeMsg)(nil),                                                // 77: steam.CResumeMsg
	(*CEnableHighResCaptureMsg)(nil),                                  // 78: steam.CEnableHighResCaptureMsg
	(*CDisableHighResCaptureMsg)(nil),                                 // 79: steam.CDisableHighResCaptureMsg
	(*CPauseControllerInputMsg)(nil),                                  // 80: steam.CPauseControllerInputMsg
	(*CResumeControllerInputMsg)(nil),                                 // 81: steam.CResumeControllerInputMsg
	(*CToggleMagnificationMsg)(nil),                                   // 82: steam.CToggleMagnificationMsg
	(*CSetCapslockMsg)(nil),                                           // 83: steam.CSetCapslockMsg
	(*CStreamingKeymapEntry)(nil),                                     // 84: steam.CStreamingKeymapEntry
	(*CStreamingKeymap)(nil),                                          // 85: steam.CStreamingKeymap
	(*CSetKeymapMsg)(nil),                                             // 86: steam.CSetKeymapMsg
	(*CStopRequest)(nil),                                              // 87: steam.CStopRequest
	(*CQuitRequest)(nil),                                              // 88: steam.CQuitRequest
	(*CDeleteCursorMsg)(nil),                                          // 89: steam.CDeleteCursorMsg
	(*CSetStreamingClientConfig)(nil),                                 // 90: steam.CSetStreamingClientConfig
	(*CSetQoSMsg)(nil),                                                // 91: steam.CSetQoSMsg
	(*CSetTargetFramerateMsg)(nil),                                    // 92: steam.CSetTargetFramerateMsg
	(*CSetTargetBitrateMsg)(nil),                                      // 93: steam.CSetTargetBitrateMsg
	(*COverlayEnabledMsg)(nil),                                        // 94: steam.COverlayEnabledMsg
	(*CSetGammaRampMsg)(nil),                                          // 95: steam.CSetGammaRampMsg
	(*CSetActivityMsg)(nil),                                           // 96: steam.CSetActivityMsg
	(*CSystemSuspendMsg)(nil),                                         // 97: steam.CSystemSuspendMsg
	(*CVirtualHereRequestMsg)(nil),                                    // 98: steam.CVirtualHereRequestMsg
	(*CVirtualHereReadyMsg)(nil),                                      // 99: steam.CVirtualHereReadyMsg
	(*CVirtualHereShareDeviceMsg)(nil),                                // 100: steam.CVirtualHereShareDeviceMsg
	(*CSetSpectatorModeMsg)(nil),                                      // 101: steam.CSetSpectatorModeMsg
	(*CRemoteHIDMsg)(nil),                                             // 102: steam.CRemoteHIDMsg
	(*CTouchConfigActiveMsg)(nil),                                     // 103: steam.CTouchConfigActiveMsg
	(*CGetTouchConfigDataMsg)(nil),                                    // 104: steam.CGetTouchConfigDataMsg
	(*CSetTouchConfigDataMsg)(nil),                                    // 105: steam.CSetTouchConfigDataMsg
	(*CSaveTouchConfigLayoutMsg)(nil),                                 // 106: steam.CSaveTouchConfigLayoutMsg
	(*CTouchActionSetActiveMsg)(nil),                                  // 107: steam.CTouchActionSetActiveMsg
	(*CTouchActionSetLayerAddedMsg)(nil),                              // 108: steam.CTouchActionSetLayerAddedMsg
	(*CTouchActionSetLayerRemovedMsg)(nil),                            // 109: steam.CTouchActionSetLayerRemovedMsg
	(*CGetTouchIconDataMsg)(nil),                                      // 110: steam.CGetTouchIconDataMsg
	(*CSetTouchIconDataMsg)(nil),                                      // 111: steam.CSetTouchIconDataMsg
	(*CRemotePlayTogetherGroupUpdateMsg)(nil),                         // 112: steam.CRemotePlayTogetherGroupUpdateMsg
	(*CSetInputTemporarilyDisabledMsg)(nil),                           // 113: steam.CSetInputTemporarilyDisabledMsg
	(*CSetQualityOverrideMsg)(nil),                                    // 114: steam.CSetQualityOverrideMsg
	(*CSetBitrateOverrideMsg)(nil),                                    // 115: steam.CSetBitrateOverrideMsg
	(*CShowOnScreenKeyboardMsg)(nil),                                  // 116: steam.CShowOnScreenKeyboardMsg
	(*CControllerPersonalizationUpdateMsg)(nil),                       // 117: steam.CControllerPersonalizationUpdateMsg
	(*CVRConnectionReady)(nil),                                        // 118: steam.CVRConnectionReady
	(*CCaptureFailedMsg)(nil),                                         // 119: steam.CCaptureFailedMsg
	(*CStreamDataLostMsg)(nil),                                        // 120: steam.CStreamDataLostMsg
	(*CAudioFormat)(nil),                                              // 121: steam.CAudioFormat
	(*CVideoFormat)(nil),                                              // 122: steam.CVideoFormat
	(*CFrameEvent)(nil),                                               // 123: steam.CFrameEvent
	(*CFrameStats)(nil),                                               // 124: steam.CFrameStats
	(*CFrameStatAccumulatedValue)(nil),                                // 125: steam.CFrameStatAccumulatedValue
	(*CFrameStatsListMsg)(nil),                                        // 126: steam.CFrameStatsListMsg
	(*CStreamingSessionStats)(nil),                                    // 127: steam.CStreamingSessionStats
	(*CDebugDumpMsg)(nil),                                             // 128: steam.CDebugDumpMsg
	(*CLogMsg)(nil),                                                   // 129: steam.CLogMsg
	(*CLogUploadMsg)(nil),                                             // 130: steam.CLogUploadMsg
	(*CTransportSignalMsg)(nil),                                       // 131: steam.CTransportSignalMsg
	(*CControllerConfigMsg)(nil),                                      // 132: steam.CControllerConfigMsg
	(*CRemotePlayTogetherGroupUpdateMsg_Player)(nil),                  // 133: steam.CRemotePlayTogetherGroupUpdateMsg.Player
	(*CTransportSignalMsg_WebRTCMessage)(nil),                         // 134: steam.CTransportSignalMsg.WebRTCMessage
	(*CTransportSignalMsg_WebRTCMessage_Candidate)(nil),               // 135: steam.CTransportSignalMsg.WebRTCMessage.Candidate
	(*CControllerConfigMsg_ControllerConfigResponse)(nil),             // 136: steam.CControllerConfigMsg.ControllerConfigResponse
	(*CControllerConfigMsg_ControllerPersonalizationResponse)(nil),    // 137: steam.CControllerConfigMsg.ControllerPersonalizationResponse
	(*CControllerConfigMsg_ControllerActiveConfigChangeResponse)(nil), // 138: steam.CControllerConfigMsg.ControllerActiveConfigChangeResponse
	(*CControllerConfigMsg_ControllerActiveConfigMsg)(nil),            // 139: steam.CControllerConfigMsg.ControllerActiveConfigMsg
}
var file_steammessages_remoteplay_proto_depIdxs = []int32{
	30,  // 0: steam.CClientHandshakeMsg.info:type_name -> steam.CStreamingClientHandshakeInfo
	32,  // 1: steam.CServerHandshakeMsg.info:type_name -> steam.CStreamingServerHandshakeInfo
	3,   // 2: steam.CAuthenticationRequestMsg.version:type_name -> steam.EStreamVersion
	27,  // 3: steam.CAuthenticationResponseMsg.result:type_name -> steam.CAuthenticationResponseMsg.AuthenticationResult
	3,   // 4: steam.CAuthenticationResponseMsg.version:type_name -> steam.EStreamVersion
	5,   // 5: steam.CStreamVideoLimit.codec:type_name -> steam.EStreamVideoCodec
	38,  // 6: steam.CStreamVideoLimit.mode:type_name -> steam.CStreamVideoMode
	8,   // 7: steam.CStreamingClientCaps.supported_colorspaces:type_name -> steam.EStreamColorspace
	4,   // 8: steam.CStreamingClientCaps.supported_audio_codecs:type_name -> steam.EStreamAudioCodec
	5,   // 9: steam.CStreamingClientCaps.supported_video_codecs:type_name -> steam.EStreamVideoCodec
	6,   // 10: steam.CStreamingClientConfig.quality:type_name -> steam.EStreamQualityPreference
	9,   // 11: steam.CStreamingClientConfig.p2p_scope:type_name -> steam.EStreamP2PScope
	39,  // 12: steam.CStreamingClientConfig.display_limit:type_name -> steam.CStreamVideoLimit
	39,  // 13: steam.CStreamingClientConfig.quality_limit:type_name -> steam.CStreamVideoLimit
	39,  // 14: steam.CStreamingClientConfig.runtime_limit:type_name -> steam.CStreamVideoLimit
	39,  // 15: steam.CStreamingClientConfig.decoder_limit:type_name -> steam.CStreamVideoLimit
	10,  // 16: steam.CStreamingServerConfig.host_play_audio:type_name -> steam.EStreamHostPlayAudioPreference
	11,  // 17: steam.CStreamingServerConfig.display_resolution_setting:type_name -> steam.EStreamHostDisplaySetting
	11,  // 18: steam.CStreamingServerConfig.display_refresh_rate_setting:type_name -> steam.EStreamHostDisplaySetting
	11,  // 19: steam.CStreamingServerConfig.display_hdr_setting:type_name -> steam.EStreamHostDisplaySetting
	4,   // 20: steam.CNegotiatedConfig.selected_audio_codec:type_name -> steam.EStreamAudioCodec
	5,   // 21: steam.CNegotiatedConfig.selected_video_codec:type_name -> steam.EStreamVideoCodec
	38,  // 22: steam.CNegotiatedConfig.available_video_modes_OBSOLETE:type_name -> steam.CStreamVideoMode
	4,   // 23: steam.CNegotiationInitMsg.supported_audio_codecs:type_name -> steam.EStreamAudioCodec
	5,   // 24: steam.CNegotiationInitMsg.supported_video_codecs:type_name -> steam.EStreamVideoCodec
	43,  // 25: steam.CNegotiationSetConfigMsg.config:type_name -> steam.CNegotiatedConfig
	41,  // 26: steam.CNegotiationSetConfigMsg.streaming_client_config:type_name -> steam.CStreamingClientConfig
	40,  // 27: steam.CNegotiationSetConfigMsg.streaming_client_caps:type_name -> steam.CStreamingClientCaps
	4,   // 28: steam.CStartAudioDataMsg.codec:type_name -> steam.EStreamAudioCodec
	5,   // 29: steam.CStartVideoDataMsg.codec:type_name -> steam.EStreamVideoCodec
	2,   // 30: steam.CRecordedInput.type:type_name -> steam.EStreamControlMessage
	54,  // 31: steam.CRecordedInput.finger_down:type_name -> steam.CInputTouchFingerDownMsg
	55,  // 32: steam.CRecordedInput.finger_motion:type_name -> steam.CInputTouchFingerMotionMsg
	56,  // 33: steam.CRecordedInput.finger_up:type_name -> steam.CInputTouchFingerUpMsg
	57,  // 34: steam.CRecordedInput.mouse_motion:type_name -> steam.CInputMouseMotionMsg
	58,  // 35: steam.CRecordedInput.mouse_wheel:type_name -> steam.CInputMouseWheelMsg
	59,  // 36: steam.CRecordedInput.mouse_down:type_name -> steam.CInputMouseDownMsg
	60,  // 37: steam.CRecordedInput.mouse_up:type_name -> steam.CInputMouseUpMsg
	61,  // 38: steam.CRecordedInput.key_down:type_name -> steam.CInputKeyDownMsg
	62,  // 39: steam.CRecordedInput.key_up:type_name -> steam.CInputKeyUpMsg
	63,  // 40: steam.CRecordedInput.text:type_name -> steam.CInputTextMsg
	102, // 41: steam.CRecordedInput.hid:type_name -> steam.CRemoteHIDMsg
	51,  // 42: steam.CRecordedInputStream.entries:type_name -> steam.CRecordedInput
	14,  // 43: steam.CInputMouseWheelMsg.direction:type_name -> steam.EStreamMouseWheelDirection
	13,  // 44: steam.CInputMouseDownMsg.button:type_name -> steam.EStreamMouseButton
	13,  // 45: steam.CInputMouseUpMsg.button:type_name -> steam.EStreamMouseButton
	84,  // 46: steam.CStreamingKeymap.entries:type_name -> steam.CStreamingKeymapEntry
	85,  // 47: steam.CSetKeymapMsg.keymap:type_name -> steam.CStreamingKeymap
	41,  // 48: steam.CSetStreamingClientConfig.config:type_name -> steam.CStreamingClientConfig
	16,  // 49: steam.CSetActivityMsg.activity:type_name -> steam.EStreamActivity
	133, // 50: steam.CRemotePlayTogetherGroupUpdateMsg.players:type_name -> steam.CRemotePlayTogetherGroupUpdateMsg.Player
	17,  // 51: steam.CCaptureFailedMsg.reason:type_name -> steam.ECaptureFailedReason
	19,  // 52: steam.CAudioFormat.format:type_name -> steam.EAudioFormat
	20,  // 53: steam.CVideoFormat.format:type_name -> steam.EVideoFormat
	22,  // 54: steam.CFrameEvent.event_id:type_name -> steam.EStreamFrameEvent
	123, // 55: steam.CFrameStats.events:type_name -> steam.CFrameEvent
	23,  // 56: steam.CFrameStats.result:type_name -> steam.EStreamFrameResult
	24,  // 57: steam.CFrameStatAccumulatedValue.stat_type:type_name -> steam.EFrameAccumulatedStat
	12,  // 58: steam.CFrameStatsListMsg.data_type:type_name -> steam.EStreamingDataType
	124, // 59: steam.CFrameStatsListMsg.stats:type_name -> steam.CFrameStats
	125, // 60: steam.CFrameStatsListMsg.accumulated_stats:type_name -> steam.CFrameStatAccumulatedValue
	25,  // 61: steam.CLogUploadMsg.type:type_name -> steam.ELogFileType
	134, // 62: steam.CTransportSignalMsg.webrtc:type_name -> steam.CTransportSignalMsg.WebRTCMessage
	26,  // 63: steam.CControllerConfigMsg.type:type_name -> steam.EStreamControllerConfigMsg
	137, // 64: steam.CControllerConfigMsg.personalizationResponse:type_name -> steam.CControllerConfigMsg.ControllerPersonalizationResponse
	136, // 65: steam.CControllerConfigMsg.configResponse:type_name -> steam.CControllerConfigMsg.ControllerConfigResponse
	139, // 66: steam.CControllerConfigMsg.activeConfigChangeMsg:type_name -> steam.CControllerConfigMsg.ControllerActiveConfigMsg
	135, // 67: steam.CTransportSignalMsg.WebRTCMessage.candidate:type_name -> steam.CTransportSignalMsg.WebRTCMessage.Candidate
