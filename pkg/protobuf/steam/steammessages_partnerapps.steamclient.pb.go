...
const file_steammessages_partnerapps_steamclient_proto_rawDesc = "" +
	"\n" +
	"+steammessages_partnerapps.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"[\n" +
	...
	"origFileId\"g\n" +
	"$CPartnerApps_FindDRMUploads_Response\x12?\n" +
	"\auploads\x18\x01 \x03(\v2%.steam.CPartnerApps_ExistingDRMUploadR\auploads\"O\n" +
	...
	"\x06app_id\x18\x02 \x01(\x05R\x05appId2\x91\n" +
	"\n" +
	"\vPartnerApps\x12{\n" +
	"\x18RequestKVSignUploadToken\x12..steam.CPartnerApps_RequestUploadToken_Request\x1a/.steam.CPartnerApps_RequestUploadToken_Response\x12x\n" +
	"\x15RequestDRMUploadToken\x12..steam.CPartnerApps_RequestUploadToken_Request\x1a/.steam.CPartnerApps_RequestUploadToken_Response\x12x\n" +
	"\x15RequestCEGUploadToken\x12..steam.CPartnerApps_RequestUploadToken_Request\x1a/.steam.CPartnerApps_RequestUploadToken_Response\x12z\n" +
	"\x17RequestDepotUploadToken\x12..steam.CPartnerApps_RequestUploadToken_Request\x1a/.steam.CPartnerApps_RequestUploadToken_Response\x12o\n" +
	"\x12FinishUploadKVSign\x12(.steam.CPartnerApps_FinishUpload_Request\x1a/.steam.CPartnerApps_FinishUploadKVSign_Response\x12~\n" +
	"\x15FinishUploadDRMUpload\x121.steam.CPartnerApps_FinishUploadLegacyDRM_Request\x1a2.steam.CPartnerApps_FinishUploadLegacyDRM_Response\x12l\n" +
	"\x15FinishUploadCEGUpload\x12(.steam.CPartnerApps_FinishUpload_Request\x1a).steam.CPartnerApps_FinishUpload_Response\x12x\n" +
	"\x17FinishUploadDepotUpload\x12-.steam.CPartnerApps_FinishUploadDepot_Request\x1a..steam.CPartnerApps_FinishUploadDepot_Response\x12x\n" +
	"\x13GetDepotBuildResult\x12/.steam.CPartnerApps_GetDepotBuildResult_Request\x1a0.steam.CPartnerApps_GetDepotBuildResult_Response\x12i\n" +
	"\x0eFindDRMUploads\x12*.steam.CPartnerApps_FindDRMUploads_Request\x1a+.steam.CPartnerApps_FindDRMUploads_Response\x12W\n" +
	"\bDownload\x12$.steam.CPartnerApps_Download_Request\x1a%.steam.CPartnerApps_Download_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
