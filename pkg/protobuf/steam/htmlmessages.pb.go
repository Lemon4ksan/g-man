...
type CMsgProcessInfoNotification struct {
	state                            protoimpl.MessageState `protogen:"open.v1"`
	Requestid                        *uint64                `protobuf:"varint,1,opt,name=requestid" json:"requestid,omitempty"`
	GpuStatus                        *EBrowserGPUStatus     `protobuf:"varint,2,opt,name=gpu_status,json=gpuStatus,enum=steam.EBrowserGPUStatus,def=0" json:"gpu_status,omitempty"`
	Canvas_2D                        *EBrowserFeatureStatus `protobuf:"varint,3,opt,name=canvas_2d,json=canvas2d,enum=steam.EBrowserFeatureStatus,def=0" json:"canvas_2d,omitempty"`
	CanvasOopRasterization           *EBrowserFeatureStatus `protobuf:"varint,4,opt,name=canvas_oop_rasterization,json=canvasOopRasterization,enum=steam.EBrowserFeatureStatus,def=0" json:"canvas_oop_rasterization,omitempty"`
	DirectRenderingDisplayCompositor *EBrowserFeatureStatus `protobuf:"varint,5,opt,name=direct_rendering_display_compositor,json=directRenderingDisplayCompositor,enum=steam.EBrowserFeatureStatus,def=0" json:"direct_rendering_display_compositor,omitempty"`
	GpuCompositing                   *EBrowserFeatureStatus `protobuf:"varint,6,opt,name=gpu_compositing,json=gpuCompositing,enum=steam.EBrowserFeatureStatus,def=0" json:"gpu_compositing,omitempty"`
	MultipleRasterThreads            *EBrowserFeatureStatus `protobuf:"varint,7,opt,name=multiple_raster_threads,json=multipleRasterThreads,enum=steam.EBrowserFeatureStatus,def=0" json:"multiple_raster_threads,omitempty"`
	Opengl                           *EBrowserFeatureStatus `protobuf:"varint,8,opt,name=opengl,enum=steam.EBrowserFeatureStatus,def=0" json:"opengl,omitempty"`
	Rasterization                    *EBrowserFeatureStatus `protobuf:"varint,9,opt,name=rasterization,enum=steam.EBrowserFeatureStatus,def=0" json:"rasterization,omitempty"`
	RawDraw                          *EBrowserFeatureStatus `protobuf:"varint,10,opt,name=raw_draw,json=rawDraw,enum=steam.EBrowserFeatureStatus,def=0" json:"raw_draw,omitempty"`
	SkiaGraphite                     *EBrowserFeatureStatus `protobuf:"varint,11,opt,name=skia_graphite,json=skiaGraphite,enum=steam.EBrowserFeatureStatus,def=0" json:"skia_graphite,omitempty"`
	VideoDecode                      *EBrowserFeatureStatus `protobuf:"varint,13,opt,name=video_decode,json=videoDecode,enum=steam.EBrowserFeatureStatus,def=0" json:"video_decode,omitempty"`
	VideoEncode                      *EBrowserFeatureStatus `protobuf:"varint,14,opt,name=video_encode,json=videoEncode,enum=steam.EBrowserFeatureStatus,def=0" json:"video_encode,omitempty"`
	Vulkan                           *EBrowserFeatureStatus `protobuf:"varint,15,opt,name=vulkan,enum=steam.EBrowserFeatureStatus,def=0" json:"vulkan,omitempty"`
	Webgl                            *EBrowserFeatureStatus `protobuf:"varint,16,opt,name=webgl,enum=steam.EBrowserFeatureStatus,def=0" json:"webgl,omitempty"`
	Webgl2                           *EBrowserFeatureStatus `protobuf:"varint,17,opt,name=webgl2,enum=steam.EBrowserFeatureStatus,def=0" json:"webgl2,omitempty"`
	Webgpu                           *EBrowserFeatureStatus `protobuf:"varint,18,opt,name=webgpu,enum=steam.EBrowserFeatureStatus,def=0" json:"webgpu,omitempty"`
	Webnn                            *EBrowserFeatureStatus `protobuf:"varint,19,opt,name=webnn,enum=steam.EBrowserFeatureStatus,def=0" json:"webnn,omitempty"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
type CMsgSetAccessibilitySettings struct {
	...
	PreferredContrast    *EAccessibilityContrastMode `protobuf:"varint,2,opt,name=preferred_contrast,json=preferredContrast,enum=steam.EAccessibilityContrastMode,def=0" json:"preferred_contrast,omitempty"`
...
const file_htmlmessages_proto_rawDesc = "" +
	"\n" +
	"\x12htmlmessages.proto\x12\x05steam\x1a\venums.proto\"\x90\x01\n" +
	"\tCMsgKeyUp\x12%\n" +
	...
	"\x0ebrowser_handle\x18\x01 \x01(\rR\rbrowserHandle\"\x8b\x03\n" +
	"\x1eCMsgSetLocalFileRequestMapping\x12%\n" +
	"\x0ebrowser_handle\x18\x01 \x01(\rR\rbrowserHandle\x12\x1f\n" +
	"\vrequest_url\x18\x02 \x01(\tR\n" +
	"requestUrl\x12,\n" +
	"\x12default_local_path\x18\x03 \x01(\tR\x10defaultLocalPath\x12M\n" +
	"\x06routes\x18\x04 \x03(\v25.steam.CMsgSetLocalFileRequestMapping.AdditionalRouteR\x06routes\x1a\xa3\x01\n" +
	...
	"\aentries\x18\x03 \x03(\v2\x14.steam.CHistoryEntryR\aentries\"\x94\x01\n" +
	"\rCMsgLoadError\x12%\n" +
	"\x0ebrowser_handle\x18\x01 \x01(\rR\rbrowserHandle\x12\x1d\n" +
	"\n" +
	...
	"\tpageTitle\x18\x03 \x01(\tR\tpageTitle\"\x98\x01\n" +
	"\x11CMsgLoadedRequest\x12%\n" +
	"\x0ebrowser_handle\x18\x01 \x01(\rR\rbrowserHandle\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x12\x1c\n" +
	"\tpageTitle\x18\x03 \x01(\tR\tpageTitle\x12,\n" +
	"\aheaders\x18\x05 \x03(\v2\x12.steam.CHTMLHeaderR\aheaders\"R\n" +
	"\x15CMsgFavIconURLChanged\x12%\n" +
	"\x0ebrowser_handle\x18\x01 \x01(\rR\rbrowserHandle\x12\x12\n" +
	"\x04urls\x18\x02 \x03(\tR\x04urls\";\n" +
	"\x12CMsgCtrlTabPressed\x12%\n" +
	"\x0ebrowser_handle\x18\x01 \x01(\rR\rbrowserHandle\"\x8e\x01\n" +
	"\x10CMsgPageSecurity\x12%\n" +
	"\x0ebrowser_handle\x18\x01 \x01(\rR\rbrowserHandle\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x12A\n" +
	"\rsecurity_info\x18\x03 \x01(\v2\x1c.steam.CHTMLPageSecurityInfoR\fsecurityInfo\"\xa1\x01\n" +
	...
	"\byhotspot\x18\a \x01(\rR\byhotspot\"\xa3\x03\n" +
	...
	"\x10choose_directory\x18\a \x01(\bR\x0fchooseDirectory\x12:\n" +
	"\afilters\x18\b \x03(\v2 .steam.CMsgFileLoadDialog.FilterR\afilters\x1aW\n" +
	"\x06Filter\x12\x12\n" +
	...
	"\trequestid\x18\x01 \x01(\x04R\trequestid\"\xc1\r\n" +
	"\x1bCMsgProcessInfoNotification\x12\x1c\n" +
	"\trequestid\x18\x01 \x01(\x04R\trequestid\x12T\n" +
	"\n" +
	"gpu_status\x18\x02 \x01(\x0e2\x18.steam.EBrowserGPUStatus:\x1bk_EBrowserGPUStatus_InvalidR\tgpuStatus\x12Z\n" +
	"\tcanvas_2d\x18\x03 \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\bcanvas2d\x12w\n" +
	"\x18canvas_oop_rasterization\x18\x04 \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\x16canvasOopRasterization\x12\x8c\x01\n" +
	"#direct_rendering_display_compositor\x18\x05 \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR directRenderingDisplayCompositor\x12f\n" +
	"\x0fgpu_compositing\x18\x06 \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\x0egpuCompositing\x12u\n" +
	"\x17multiple_raster_threads\x18\a \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\x15multipleRasterThreads\x12U\n" +
	"\x06opengl\x18\b \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\x06opengl\x12c\n" +
	"\rrasterization\x18\t \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\rrasterization\x12X\n" +
	"\braw_draw\x18\n" +
	" \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\arawDraw\x12b\n" +
	"\rskia_graphite\x18\v \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\fskiaGraphite\x12`\n" +
	"\fvideo_decode\x18\r \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\vvideoDecode\x12`\n" +
	"\fvideo_encode\x18\x0e \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\vvideoEncode\x12U\n" +
	"\x06vulkan\x18\x0f \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\x06vulkan\x12S\n" +
	"\x05webgl\x18\x10 \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\x05webgl\x12U\n" +
	"\x06webgl2\x18\x11 \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\x06webgl2\x12U\n" +
	"\x06webgpu\x18\x12 \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\x06webgpu\x12S\n" +
	"\x05webnn\x18\x13 \x01(\x0e2\x1c.steam.EBrowserFeatureStatus:\x1fk_EBrowserFeatureStatus_InvalidR\x05webnn\"L\n" +
	...
	"\x04path\x18\x04 \x01(\tR\x04path\"\x81\x01\n" +
	"\x1cCMsgGetCookiesForURLResponse\x12%\n" +
	"\x0ebrowser_handle\x18\x01 \x01(\rR\rbrowserHandle\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x12(\n" +
	"\acookies\x18\x03 \x03(\v2\x0e.steam.CCookieR\acookies\"\xac\x02\n" +
	...
	"\vmethod_type\x18\x03 \x01(\x0e2\x1c.steam.EJSRegisterMethodType:\x1fk_EJSRegisterMethodType_InvalidR\n" +
	"methodType\"\x8b\x04\n" +
	...
	"bytesValue\x12\x19\n" +
	"\bis_array\x18\b \x01(\bR\aisArray\x125\n" +
	"\farray_values\x18\t \x03(\v2\x12.steam.CMsgJSValueR\varrayValues\x12\x1b\n" +
	"\tis_object\x18\n" +
	" \x01(\bR\bisObject\x12P\n" +
	"\x11object_properties\x18\v \x03(\v2#.steam.CMsgJSValue.JSObjectPropertyR\x10objectProperties\x1aP\n" +
	"\x10JSObjectProperty\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12(\n" +
	"\x05value\x18\x02 \x01(\v2\x12.steam.CMsgJSValueR\x05value\"\xb3\x01\n" +
	...
	"\targuments\x18\x04 \x03(\v2\x12.steam.CMsgJSValueR\targuments\"\xcd\x01\n" +
	"\x15CMsgJSExecuteCallback\x12%\n" +
	"\x0ebrowser_handle\x18\x01 \x01(\rR\rbrowserHandle\x122\n" +
	"\x15owning_browser_handle\x18\x02 \x01(\rR\x13owningBrowserHandle\x12'\n" +
	"\x0ffunction_handle\x18\x03 \x01(\x04R\x0efunctionHandle\x120\n" +
	"\targuments\x18\x04 \x03(\v2\x12.steam.CMsgJSValueR\targuments\"\xed\x01\n" +
	...
	"\bargument\x18\x05 \x01(\v2\x12.steam.CMsgJSValueR\bargument\"\x9b\x01\n" +
	...
	"\x05state\x18\x01 \x01(\rR\x05state\"\xaa\x02\n" +
	"\x1bCMsgDraggableRegionsChanged\x12%\n" +
	"\x0ebrowser_handle\x18\x01 \x01(\rR\rbrowserHandle\x12G\n" +
	"\x05rects\x18\x02 \x03(\v21.steam.CMsgDraggableRegionsChanged.DraggableRectsR\x05rects\x1a\x9a\x01\n" +
	...
	"\x0ebrowser_handle\x18\x01 \x01(\rR\rbrowserHandle\"\x87\x04\n" +
	"\x1aCMsgShowBrowserContextMenu\x12%\n" +
	"\x0ebrowser_handle\x18\x01 \x01(\rR\rbrowserHandle\x12Y\n" +
	"\x0fcustom_commands\x18\x02 \x03(\v20.steam.CMsgShowBrowserContextMenu.ContextCommandR\x0ecustomCommands\x12\x1d\n" +
	"\n" +
	...
	"\x14CMsgRestartJSContext\"\xf7\x01\n" +
	"\x1cCMsgSetAccessibilitySettings\x124\n" +
	"\x16reduced_motion_enabled\x18\x01 \x01(\bR\x14reducedMotionEnabled\x12u\n" +
	"\x12preferred_contrast\x18\x02 \x01(\x0e2!.steam.EAccessibilityContrastMode:#k_EBrowserContrastMode_NoPreferenceR\x11preferredContrast\x12*\n" +
	...
	"\x1bk_EBrowserContrastMode_Less\x10\x02B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_htmlmessages_proto_goTypes = []any{
	...
	(EAccessibilityContrastMode)(0),                        // 1: steam.EAccessibilityContrastMode
	(*CMsgKeyUp)(nil),                                      // 2: steam.CMsgKeyUp
	(*CMsgKeyDown)(nil),                                    // 3: steam.CMsgKeyDown
	(*CMsgKeyChar)(nil),                                    // 4: steam.CMsgKeyChar
	(*CMsgMouseDown)(nil),                                  // 5: steam.CMsgMouseDown
	(*CMsgMouseUp)(nil),                                    // 6: steam.CMsgMouseUp
	(*CMsgMouseDblClick)(nil),                              // 7: steam.CMsgMouseDblClick
	(*CMsgMouseWheel)(nil),                                 // 8: steam.CMsgMouseWheel
	(*CMsgMouseMove)(nil),                                  // 9: steam.CMsgMouseMove
	(*CMsgMouseLeave)(nil),                                 // 10: steam.CMsgMouseLeave
	(*CMsgBrowserCreate)(nil),                              // 11: steam.CMsgBrowserCreate
	(*CMsgBrowserCreateResponse)(nil),                      // 12: steam.CMsgBrowserCreateResponse
	(*CMsgBrowserRemove)(nil),                              // 13: steam.CMsgBrowserRemove
	(*CMsgSetLocalFileRequestMapping)(nil),                 // 14: steam.CMsgSetLocalFileRequestMapping
	(*CMsgBrowserErrorStrings)(nil),                        // 15: steam.CMsgBrowserErrorStrings
	(*CMsgBrowserSetName)(nil),                             // 16: steam.CMsgBrowserSetName
	(*CMsgBrowserSize)(nil),                                // 17: steam.CMsgBrowserSize
	(*CMsgBrowserSetMinSize)(nil),                          // 18: steam.CMsgBrowserSetMinSize
	(*CMsgBrowserPosition)(nil),                            // 19: steam.CMsgBrowserPosition
	(*CMsgBrowserResized)(nil),                             // 20: steam.CMsgBrowserResized
	(*CMsgPostURL)(nil),                                    // 21: steam.CMsgPostURL
	(*CMsgAddHeader)(nil),                                  // 22: steam.CMsgAddHeader
	(*CMsgStopLoad)(nil),                                   // 23: steam.CMsgStopLoad
	(*CMsgReload)(nil),                                     // 24: steam.CMsgReload
	(*CMsgGoForward)(nil),                                  // 25: steam.CMsgGoForward
	(*CMsgGoBack)(nil),                                     // 26: steam.CMsgGoBack
	(*CMsgWasHidden)(nil),                                  // 27: steam.CMsgWasHidden
	(*CMsgSetWindowVisibility)(nil),                        // 28: steam.CMsgSetWindowVisibility
	(*CMsgClearHistory)(nil),                               // 29: steam.CMsgClearHistory
	(*CMsgClearAllBrowsingData)(nil),                       // 30: steam.CMsgClearAllBrowsingData
	(*CMsgCopy)(nil),                                       // 31: steam.CMsgCopy
	(*CMsgPaste)(nil),                                      // 32: steam.CMsgPaste
	(*CMsgExecuteJavaScript)(nil),                          // 33: steam.CMsgExecuteJavaScript
	(*CMsgSetFocus)(nil),                                   // 34: steam.CMsgSetFocus
	(*CMsgHorizontalScrollBarSize)(nil),                    // 35: steam.CMsgHorizontalScrollBarSize
	(*CMsgHorizontalScrollBarSizeResponse)(nil),            // 36: steam.CMsgHorizontalScrollBarSizeResponse
	(*CMsgVerticalScrollBarSize)(nil),                      // 37: steam.CMsgVerticalScrollBarSize
	(*CMsgVerticalScrollBarSizeResponse)(nil),              // 38: steam.CMsgVerticalScrollBarSizeResponse
	(*CMsgFind)(nil),                                       // 39: steam.CMsgFind
	(*CMsgStopFind)(nil),                                   // 40: steam.CMsgStopFind
	(*CMsgSetHorizontalScroll)(nil),                        // 41: steam.CMsgSetHorizontalScroll
	(*CMsgSetVerticalScroll)(nil),                          // 42: steam.CMsgSetVerticalScroll
	(*CMsgSetZoomLevel)(nil),                               // 43: steam.CMsgSetZoomLevel
	(*CMsgViewSource)(nil),                                 // 44: steam.CMsgViewSource
	(*CMsgBrowserReady)(nil),                               // 45: steam.CMsgBrowserReady
	(*CMsgURLChanged)(nil),                                 // 46: steam.CMsgURLChanged
	(*CHistoryEntry)(nil),                                  // 47: steam.CHistoryEntry
	(*CMsgHistoryChanged)(nil),                             // 48: steam.CMsgHistoryChanged
	(*CMsgLoadError)(nil),                                  // 49: steam.CMsgLoadError
	(*CHTMLHeader)(nil),                                    // 50: steam.CHTMLHeader
	(*CHTMLPageSecurityInfo)(nil),                          // 51: steam.CHTMLPageSecurityInfo
	(*CMsgFinishedRequest)(nil),                            // 52: steam.CMsgFinishedRequest
	(*CMsgLoadedRequest)(nil),                              // 53: steam.CMsgLoadedRequest
	(*CMsgFavIconURLChanged)(nil),                          // 54: steam.CMsgFavIconURLChanged
	(*CMsgCtrlTabPressed)(nil),                             // 55: steam.CMsgCtrlTabPressed
	(*CMsgPageSecurity)(nil),                               // 56: steam.CMsgPageSecurity
	(*CMsgStartRequest)(nil),                               // 57: steam.CMsgStartRequest
	(*CMsgStartRequestResponse)(nil),                       // 58: steam.CMsgStartRequestResponse
	(*CMsgShowPopup)(nil),                                  // 59: steam.CMsgShowPopup
	(*CMsgHidePopup)(nil),                                  // 60: steam.CMsgHidePopup
	(*CMsgSizePopup)(nil),                                  // 61: steam.CMsgSizePopup
	(*CMsgOpenNewTab)(nil),                                 // 62: steam.CMsgOpenNewTab
	(*CMsgPopupHTMLWindow)(nil),                            // 63: steam.CMsgPopupHTMLWindow
	(*CMsgPopupHTMLWindowResponse)(nil),                    // 64: steam.CMsgPopupHTMLWindowResponse
	(*CMsgSetHTMLTitle)(nil),                               // 65: steam.CMsgSetHTMLTitle
	(*CMsgLoadingResource)(nil),                            // 66: steam.CMsgLoadingResource
	(*CMsgStatusText)(nil),                                 // 67: steam.CMsgStatusText
	(*CMsgSetCursor)(nil),                                  // 68: steam.CMsgSetCursor
	(*CMsgFileLoadDialog)(nil),                             // 69: steam.CMsgFileLoadDialog
	(*CMsgFileLoadDialogResponse)(nil),                     // 70: steam.CMsgFileLoadDialogResponse
	(*CMsgRequestProcessInfo)(nil),                         // 71: steam.CMsgRequestProcessInfo
	(*CMsgProcessInfoNotification)(nil),                    // 72: steam.CMsgProcessInfoNotification
	(*CMsgShowToolTip)(nil),                                // 73: steam.CMsgShowToolTip
	(*CMsgUpdateToolTip)(nil),                              // 74: steam.CMsgUpdateToolTip
	(*CMsgHideToolTip)(nil),                                // 75: steam.CMsgHideToolTip
	(*CMsgSearchResults)(nil),                              // 76: steam.CMsgSearchResults
	(*CMsgClose)(nil),                                      // 77: steam.CMsgClose
	(*CMsgSetSharedPaintBuffers)(nil),                      // 78: steam.CMsgSetSharedPaintBuffers
	(*CMsgAckSharedPaintBuffers)(nil),                      // 79: steam.CMsgAckSharedPaintBuffers
	(*CMsgNeedsPaint)(nil),                                 // 80: steam.CMsgNeedsPaint
	(*CMsgComboNeedsPaint)(nil),                            // 81: steam.CMsgComboNeedsPaint
	(*CMsgNeedsSharedTexturePaint)(nil),                    // 82: steam.CMsgNeedsSharedTexturePaint
	(*CMsgGetZoom)(nil),                                    // 83: steam.CMsgGetZoom
	(*CMsgGetZoomResponse)(nil),                            // 84: steam.CMsgGetZoomResponse
	(*CMsgLinkAtPosition)(nil),                             // 85: steam.CMsgLinkAtPosition
	(*CMsgLinkAtPositionResponse)(nil),                     // 86: steam.CMsgLinkAtPositionResponse
	(*CMsgZoomToElementAtPosition)(nil),                    // 87: steam.CMsgZoomToElementAtPosition
	(*CMsgZoomToElementAtPositionResponse)(nil),            // 88: steam.CMsgZoomToElementAtPositionResponse
	(*CMsgScalePageToValue)(nil),                           // 89: steam.CMsgScalePageToValue
	(*CMsgForcePopupsToDirectHWND)(nil),                    // 90: steam.CMsgForcePopupsToDirectHWND
	(*CMsgScalePageToValueResponse)(nil),                   // 91: steam.CMsgScalePageToValueResponse
	(*CMsgSavePageToJPEG)(nil),                             // 92: steam.CMsgSavePageToJPEG
	(*CMsgSavePageToJPEGResponse)(nil),                     // 93: steam.CMsgSavePageToJPEGResponse
	(*CMsgJSAlert)(nil),                                    // 94: steam.CMsgJSAlert
	(*CMsgJSConfirm)(nil),                                  // 95: steam.CMsgJSConfirm
	(*CMsgJSDialogResponse)(nil),                           // 96: steam.CMsgJSDialogResponse
	(*CMsgCanGoBackAndForward)(nil),                        // 97: steam.CMsgCanGoBackAndForward
	(*CMsgOpenSteamURL)(nil),                               // 98: steam.CMsgOpenSteamURL
	(*CMsgSetCookie)(nil),                                  // 99: steam.CMsgSetCookie
	(*CMsgSetTargetFrameRate)(nil),                         // 100: steam.CMsgSetTargetFrameRate
	(*CMsgPauseRepaint)(nil),                               // 101: steam.CMsgPauseRepaint
	(*CMsgFullRepaint)(nil),                                // 102: steam.CMsgFullRepaint
	(*CMsgRequestFullScreen)(nil),                          // 103: steam.CMsgRequestFullScreen
	(*CMsgExitFullScreen)(nil),                             // 104: steam.CMsgExitFullScreen
	(*CMsgToggleFindInPageDialog)(nil),                     // 105: steam.CMsgToggleFindInPageDialog
	(*CMsgSetPIDShuttingDown)(nil),                         // 106: steam.CMsgSetPIDShuttingDown
	(*CMsgDisableBackgroundThrottling)(nil),                // 107: steam.CMsgDisableBackgroundThrottling
	(*CMsgAckPIDShuttingDown)(nil),                         // 108: steam.CMsgAckPIDShuttingDown
	(*CMsgGetCookiesForURL)(nil),                           // 109: steam.CMsgGetCookiesForURL
	(*CCookie)(nil),                                        // 110: steam.CCookie
	(*CMsgGetCookiesForURLResponse)(nil),                   // 111: steam.CMsgGetCookiesForURLResponse
	(*CMsgNodeHasFocus)(nil),                               // 112: steam.CMsgNodeHasFocus
	(*CMsgZoomToFocusedElement)(nil),                       // 113: steam.CMsgZoomToFocusedElement
	(*CMsgFocusedNodeText)(nil),                            // 114: steam.CMsgFocusedNodeText
	(*CMsgFocusedNodeTextResponse)(nil),                    // 115: steam.CMsgFocusedNodeTextResponse
	(*CMsgBuildID)(nil),                                    // 116: steam.CMsgBuildID
	(*CMsgOpenDevTools)(nil),                               // 117: steam.CMsgOpenDevTools
	(*CMsgCloseDevTools)(nil),                              // 118: steam.CMsgCloseDevTools
	(*CMsgUnlockH264)(nil),                                 // 119: steam.CMsgUnlockH264
	(*CMsgScreenInformationChanged)(nil),                   // 120: steam.CMsgScreenInformationChanged
	(*CMsgClearAllCookies)(nil),                            // 121: steam.CMsgClearAllCookies
	(*CMsgScreenDPI)(nil),                                  // 122: steam.CMsgScreenDPI
	(*CMsgAckScreenDPI)(nil),                               // 123: steam.CMsgAckScreenDPI
	(*CMsgAuthedSteamDomains)(nil),                         // 124: steam.CMsgAuthedSteamDomains
	(*CMsgSteamAuthNeeded)(nil),                            // 125: steam.CMsgSteamAuthNeeded
	(*CMsgSteamAuthCookiesSet)(nil),                        // 126: steam.CMsgSteamAuthCookiesSet
	(*CMsgJSRegisterMethod)(nil),                           // 127: steam.CMsgJSRegisterMethod
	(*CMsgJSValue)(nil),                                    // 128: steam.CMsgJSValue
	(*CMsgJSMethodCall)(nil),                               // 129: steam.CMsgJSMethodCall
	(*CMsgJSExecuteCallback)(nil),                          // 130: steam.CMsgJSExecuteCallback
	(*CMsgJSExecutePromise)(nil),                           // 131: steam.CMsgJSExecutePromise
	(*CMsgJSReleaseCallback)(nil),                          // 132: steam.CMsgJSReleaseCallback
	(*CMsgJSRaiseException)(nil),                           // 133: steam.CMsgJSRaiseException
	(*CMsgLoadLocalization)(nil),                           // 134: steam.CMsgLoadLocalization
	(*CMsgNotifyUserActivation)(nil),                       // 135: steam.CMsgNotifyUserActivation
	(*CMsgSetNetFakeLocalSystemState)(nil),                 // 136: steam.CMsgSetNetFakeLocalSystemState
	(*CMsgDraggableRegionsChanged)(nil),                    // 137: steam.CMsgDraggableRegionsChanged
	(*CMsgResizeGripChanged)(nil),                          // 138: steam.CMsgResizeGripChanged
	(*CMsgSetWindowPosition)(nil),                          // 139: steam.CMsgSetWindowPosition
	(*CMsgShowWindow)(nil),                                 // 140: steam.CMsgShowWindow
	(*CMsgHideWindow)(nil),                                 // 141: steam.CMsgHideWindow
	(*CMsgBringWindowToFront)(nil),                         // 142: steam.CMsgBringWindowToFront
	(*CMsgSetForegroundWindow)(nil),                        // 143: steam.CMsgSetForegroundWindow
	(*CMsgMaximizeRestoreWindow)(nil),                      // 144: steam.CMsgMaximizeRestoreWindow
	(*CMsgMinimizeWindow)(nil),                             // 145: steam.CMsgMinimizeWindow
	(*CMsgShowBrowserContextMenu)(nil),                     // 146: steam.CMsgShowBrowserContextMenu
	(*CMsgHandleContextMenuCommand)(nil),                   // 147: steam.CMsgHandleContextMenuCommand
	(*CMsgTouchGesture)(nil),                               // 148: steam.CMsgTouchGesture
	(*CMsgSetTouchGesturesToCancel)(nil),                   // 149: steam.CMsgSetTouchGesturesToCancel
	(*CMsgImeSetComposition)(nil),                          // 150: steam.CMsgImeSetComposition
	(*CMsgImeCommitText)(nil),                              // 151: steam.CMsgImeCommitText
	(*CMsgImeCancelComposition)(nil),                       // 152: steam.CMsgImeCancelComposition
	(*CMsgImeCompositionRangeChanged)(nil),                 // 153: steam.CMsgImeCompositionRangeChanged
	(*CMsgInspectElement)(nil),                             // 154: steam.CMsgInspectElement
	(*CMsgDisableF5)(nil),                                  // 155: steam.CMsgDisableF5
	(*CMsgStartDownload)(nil),                              // 156: steam.CMsgStartDownload
	(*CMsgSetWindowStackingOrder)(nil),                     // 157: steam.CMsgSetWindowStackingOrder
	(*CMsgBrowserViewPostMessageToParentRequest)(nil),      // 158: steam.CMsgBrowserViewPostMessageToParentRequest
	(*CMsgBlockedRequest)(nil),                             // 159: steam.CMsgBlockedRequest
	(*CMsgBrowserFocusChanged)(nil),                        // 160: steam.CMsgBrowserFocusChanged
	(*CMsgRenderProcessTerminated)(nil),                    // 161: steam.CMsgRenderProcessTerminated
	(*CMsgSetProtocolBlockList)(nil),                       // 162: steam.CMsgSetProtocolBlockList
	(*CMsgSetForceDeviceScaleFactors)(nil),                 // 163: steam.CMsgSetForceDeviceScaleFactors
	(*CMsgSetUIMode)(nil),                                  // 164: steam.CMsgSetUIMode
	(*CMsgSetSteamBetaName)(nil),                           // 165: steam.CMsgSetSteamBetaName
	(*CMsgSetSteamID)(nil),                                 // 166: steam.CMsgSetSteamID
	(*CMsgPopupCreated)(nil),                               // 167: steam.CMsgPopupCreated
	(*CMsgSetVRKeyboardVisibility)(nil),                    // 168: steam.CMsgSetVRKeyboardVisibility
	(*CMsgRestartJSContext)(nil),                           // 169: steam.CMsgRestartJSContext
	(*CMsgSetAccessibilitySettings)(nil),                   // 170: steam.CMsgSetAccessibilitySettings
	(*CMsgSetBrowserViewDomainRequestMapping)(nil),         // 171: steam.CMsgSetBrowserViewDomainRequestMapping
	(*CMsgSetLocalFileRequestMapping_AdditionalRoute)(nil), // 172: steam.CMsgSetLocalFileRequestMapping.AdditionalRoute
	(*CMsgFileLoadDialog_Filter)(nil),                      // 173: steam.CMsgFileLoadDialog.Filter
	(*CMsgJSValue_JSObjectProperty)(nil),                   // 174: steam.CMsgJSValue.JSObjectProperty
	(*CMsgDraggableRegionsChanged_DraggableRects)(nil),     // 175: steam.CMsgDraggableRegionsChanged.DraggableRects
	(*CMsgShowBrowserContextMenu_ContextCommand)(nil),      // 176: steam.CMsgShowBrowserContextMenu.ContextCommand
	(EBrowserGPUStatus)(0),                                 // 177: steam.EBrowserGPUStatus
	(EBrowserFeatureStatus)(0),                             // 178: steam.EBrowserFeatureStatus
}
var file_htmlmessages_proto_depIdxs = []int32{
	172, // 0: steam.CMsgSetLocalFileRequestMapping.routes:type_name -> steam.CMsgSetLocalFileRequestMapping.AdditionalRoute
	47,  // 1: steam.CMsgHistoryChanged.entries:type_name -> steam.CHistoryEntry
	50,  // 2: steam.CMsgLoadedRequest.headers:type_name -> steam.CHTMLHeader
	51,  // 3: steam.CMsgPageSecurity.security_info:type_name -> steam.CHTMLPageSecurityInfo
	173, // 4: steam.CMsgFileLoadDialog.filters:type_name -> steam.CMsgFileLoadDialog.Filter
	177, // 5: steam.CMsgProcessInfoNotification.gpu_status:type_name -> steam.EBrowserGPUStatus
	178, // 6: steam.CMsgProcessInfoNotification.canvas_2d:type_name -> steam.EBrowserFeatureStatus
	178, // 7: steam.CMsgProcessInfoNotification.canvas_oop_rasterization:type_name -> steam.EBrowserFeatureStatus
	178, // 8: steam.CMsgProcessInfoNotification.direct_rendering_display_compositor:type_name -> steam.EBrowserFeatureStatus
	178, // 9: steam.CMsgProcessInfoNotification.gpu_compositing:type_name -> steam.EBrowserFeatureStatus
	178, // 10: steam.CMsgProcessInfoNotification.multiple_raster_threads:type_name -> steam.EBrowserFeatureStatus
	178, // 11: steam.CMsgProcessInfoNotification.opengl:type_name -> steam.EBrowserFeatureStatus
	178, // 12: steam.CMsgProcessInfoNotification.rasterization:type_name -> steam.EBrowserFeatureStatus
	178, // 13: steam.CMsgProcessInfoNotification.raw_draw:type_name -> steam.EBrowserFeatureStatus
	178, // 14: steam.CMsgProcessInfoNotification.skia_graphite:type_name -> steam.EBrowserFeatureStatus
	178, // 15: steam.CMsgProcessInfoNotification.video_decode:type_name -> steam.EBrowserFeatureStatus
	178, // 16: steam.CMsgProcessInfoNotification.video_encode:type_name -> steam.EBrowserFeatureStatus
	178, // 17: steam.CMsgProcessInfoNotification.vulkan:type_name -> steam.EBrowserFeatureStatus
	178, // 18: steam.CMsgProcessInfoNotification.webgl:type_name -> steam.EBrowserFeatureStatus
	178, // 19: steam.CMsgProcessInfoNotification.webgl2:type_name -> steam.EBrowserFeatureStatus
	178, // 20: steam.CMsgProcessInfoNotification.webgpu:type_name -> steam.EBrowserFeatureStatus
	178, // 21: steam.CMsgProcessInfoNotification.webnn:type_name -> steam.EBrowserFeatureStatus
	110, // 22: steam.CMsgGetCookiesForURLResponse.cookies:type_name -> steam.CCookie
	0,   // 23: steam.CMsgJSRegisterMethod.method_type:type_name -> steam.EJSRegisterMethodType
	128, // 24: steam.CMsgJSValue.array_values:type_name -> steam.CMsgJSValue
	174, // 25: steam.CMsgJSValue.object_properties:type_name -> steam.CMsgJSValue.JSObjectProperty
	128, // 26: steam.CMsgJSMethodCall.arguments:type_name -> steam.CMsgJSValue
	128, // 27: steam.CMsgJSExecuteCallback.arguments:type_name -> steam.CMsgJSValue
	128, // 28: steam.CMsgJSExecutePromise.argument:type_name -> steam.CMsgJSValue
	175, // 29: steam.CMsgDraggableRegionsChanged.rects:type_name -> steam.CMsgDraggableRegionsChanged.DraggableRects
	176, // 30: steam.CMsgShowBrowserContextMenu.custom_commands:type_name -> steam.CMsgShowBrowserContextMenu.ContextCommand
	1,   // 31: steam.CMsgSetAccessibilitySettings.preferred_contrast:type_name -> steam.EAccessibilityContrastMode
	128, // 32: steam.CMsgJSValue.JSObjectProperty.value:type_name -> steam.CMsgJSValue
