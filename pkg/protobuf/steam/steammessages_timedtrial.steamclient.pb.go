...
const file_steammessages_timedtrial_steamclient_proto_rawDesc = "" +
	"\n" +
	"*steammessages_timedtrial.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"<\n" +
	...
	"\x0eseconds_played\x18\x01 \x01(\rR\rsecondsPlayed\x12'\n" +
	"\x0fseconds_allowed\x18\x02 \x01(\rR\x0esecondsAllowed2\xca\x02\n" +
	"\n" +
	"TimedTrial\x12m\n" +
	"\x10GetTimeRemaining\x12+.steam.CTimedTrial_GetTimeRemaining_Request\x1a,.steam.CTimedTrial_GetTimeRemaining_Response\x12g\n" +
	"\x0eRecordPlaytime\x12).steam.CTimedTrial_RecordPlaytime_Request\x1a*.steam.CTimedTrial_RecordPlaytime_Response\x12d\n" +
	"\rResetPlaytime\x12(.steam.CTimedTrial_ResetPlaytime_Request\x1a).steam.CTimedTrial_ResetPlaytime_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_timedtrial_steamclient_proto_goTypes = []any{
	(*CTimedTrial_GetTimeRemaining_Request)(nil),  // 0: steam.CTimedTrial_GetTimeRemaining_Request
	(*CTimedTrial_GetTimeRemaining_Response)(nil), // 1: steam.CTimedTrial_GetTimeRemaining_Response
	(*CTimedTrial_RecordPlaytime_Request)(nil),    // 2: steam.CTimedTrial_RecordPlaytime_Request
	(*CTimedTrial_RecordPlaytime_Response)(nil),   // 3: steam.CTimedTrial_RecordPlaytime_Response
	(*CTimedTrial_ResetPlaytime_Request)(nil),     // 4: steam.CTimedTrial_ResetPlaytime_Request
	(*CTimedTrial_ResetPlaytime_Response)(nil),    // 5: steam.CTimedTrial_ResetPlaytime_Response
}
var file_steammessages_timedtrial_steamclient_proto_depIdxs = []int32{
	0, // 0: steam.TimedTrial.GetTimeRemaining:input_type -> steam.CTimedTrial_GetTimeRemaining_Request
	2, // 1: steam.TimedTrial.RecordPlaytime:input_type -> steam.CTimedTrial_RecordPlaytime_Request
	4, // 2: steam.TimedTrial.ResetPlaytime:input_type -> steam.CTimedTrial_ResetPlaytime_Request
	1, // 3: steam.TimedTrial.GetTimeRemaining:output_type -> steam.CTimedTrial_GetTimeRemaining_Response
	3, // 4: steam.TimedTrial.RecordPlaytime:output_type -> steam.CTimedTrial_RecordPlaytime_Response
	5, // 5: steam.TimedTrial.ResetPlaytime:output_type -> steam.CTimedTrial_ResetPlaytime_Response
