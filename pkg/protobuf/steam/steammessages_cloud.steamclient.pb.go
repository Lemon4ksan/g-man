...
type CCloud_BeginUGCUpload_Response struct {
	state          protoimpl.MessageState                        `protogen:"open.v1"`
	StorageSystem  *EPublishedFileStorageSystem                  `protobuf:"varint,1,opt,name=storage_system,json=storageSystem,enum=steam.EPublishedFileStorageSystem,def=0" json:"storage_system,omitempty"`
...
type CCloud_AppFileInfo struct {
	...
	PersistState     *ECloudStoragePersistState `protobuf:"varint,5,opt,name=persist_state,json=persistState,enum=steam.ECloudStoragePersistState,def=0" json:"persist_state,omitempty"`
...
const file_steammessages_cloud_steamclient_proto_rawDesc = "" +
	"\n" +
	"%steammessages_cloud.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\x1a\venums.proto\x1a\"steammessages_client_objects.proto\"G\n" +
	...
	"\x0fupload_batch_id\x18\t \x01(\x04R\ruploadBatchId\"\xbe\x02\n" +
	...
	"\tuse_https\x18\x05 \x01(\bR\buseHttps\x12[\n" +
	"\x0frequest_headers\x18\x06 \x03(\v22.steam.CCloud_BeginHTTPUpload_Response.HTTPHeadersR\x0erequestHeaders\x1a7\n" +
	...
	"\fcontent_type\x18\x05 \x01(\tR\vcontentType\"\xad\x03\n" +
	"\x1eCCloud_BeginUGCUpload_Response\x12o\n" +
	"\x0estorage_system\x18\x01 \x01(\x0e2\".steam.EPublishedFileStorageSystem:$k_EPublishedFileStorageSystemInvalidR\rstorageSystem\x12\x14\n" +
	...
	"\tuse_https\x18\x06 \x01(\bR\buseHttps\x12Z\n" +
	"\x0frequest_headers\x18\a \x03(\v21.steam.CCloud_BeginUGCUpload_Response.HTTPHeadersR\x0erequestHeaders\x1a7\n" +
	"\vHTTPHeaders\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	...
	"\bfile_sha\x18\n" +
	" \x01(\tR\afileSha\x120\n" +
	"\x14compressed_file_size\x18\v \x01(\rR\x12compressedFileSize\"{\n" +
	"\x1eCCloud_GetFileDetails_Response\x120\n" +
	"\adetails\x18\x01 \x01(\v2\x16.steam.CCloud_UserFileR\adetails\x12'\n" +
	...
	"\x05files\x18\x01 \x03(\v2\x16.steam.CCloud_UserFileR\x05files\x12\x1f\n" +
	...
	"\x0fupload_batch_id\x18\r \x01(\x04R\ruploadBatchId\"\xcc\x03\n" +
	...
	"httpMethod\x12]\n" +
	"\x0frequest_headers\x18\x05 \x03(\v24.steam.ClientCloudFileUploadBlockDetails.HTTPHeadersR\x0erequestHeaders\x12!\n" +
	...
	"\fencrypt_file\x18\x01 \x01(\bR\vencryptFile\x12O\n" +
	"\x0eblock_requests\x18\x02 \x03(\v2(.steam.ClientCloudFileUploadBlockDetailsR\rblockRequests\"\xa3\x01\n" +
	...
	"\tuse_https\x18\t \x01(\bR\buseHttps\x12^\n" +
	"\x0frequest_headers\x18\n" +
	" \x03(\v25.steam.CCloud_ClientFileDownload_Response.HTTPHeadersR\x0erequestHeaders\x12\x1c\n" +
	...
	"\x14synced_change_number\x18\x02 \x01(\x04R\x12syncedChangeNumber\"\x82\x03\n" +
	...
	"\rraw_file_size\x18\x04 \x01(\rR\vrawFileSize\x12k\n" +
	"\rpersist_state\x18\x05 \x01(\x0e2 .steam.ECloudStoragePersistState:$k_ECloudStoragePersistStatePersistedR\fpersistState\x12*\n" +
	"\x11platforms_to_sync\x18\x06 \x01(\rR\x0fplatformsToSync\x12*\n" +
	"\x11path_prefix_index\x18\a \x01(\rR\x0fpathPrefixIndex\x12,\n" +
	"\x12machine_name_index\x18\b \x01(\rR\x10machineNameIndex\"\xa1\x02\n" +
	"$CCloud_GetAppFileChangelist_Response\x122\n" +
	"\x15current_change_number\x18\x01 \x01(\x04R\x13currentChangeNumber\x12/\n" +
	"\x05files\x18\x02 \x03(\v2\x19.steam.CCloud_AppFileInfoR\x05files\x12\"\n" +
	...
	"deviceType\"\x83\x01\n" +
	"\x1fCCloud_AppLaunchIntent_Response\x12`\n" +
	"\x19pending_remote_operations\x18\x01 \x03(\v2$.steam.CCloud_PendingRemoteOperationR\x17pendingRemoteOperations\"\xb0\x01\n" +
	...
	"\n" +
	"request_id\x18\x01 \x01(\x04R\trequestId2\xa2\x16\n" +
	"\x05Cloud\x12Z\n" +
	"\x14ClientLogUploadCheck\x12/.steam.CCloud_ClientLogUploadCheck_Notification\x1a\x11.steam.NoResponse\x12`\n" +
	"\x17ClientLogUploadComplete\x122.steam.CCloud_ClientLogUploadComplete_Notification\x1a\x11.steam.NoResponse\x12`\n" +
	"\x0fBeginHTTPUpload\x12%.steam.CCloud_BeginHTTPUpload_Request\x1a&.steam.CCloud_BeginHTTPUpload_Response\x12c\n" +
	"\x10CommitHTTPUpload\x12&.steam.CCloud_CommitHTTPUpload_Request\x1a'.steam.CCloud_CommitHTTPUpload_Response\x12]\n" +
	"\x0eBeginUGCUpload\x12$.steam.CCloud_BeginUGCUpload_Request\x1a%.steam.CCloud_BeginUGCUpload_Response\x12`\n" +
	"\x0fCommitUGCUpload\x12%.steam.CCloud_CommitUGCUpload_Request\x1a&.steam.CCloud_CommitUGCUpload_Response\x12]\n" +
	"\x0eGetFileDetails\x12$.steam.CCloud_GetFileDetails_Request\x1a%.steam.CCloud_GetFileDetails_Response\x12f\n" +
	"\x11GetSingleFileInfo\x12'.steam.CCloud_GetSingleFileInfo_Request\x1a(.steam.CCloud_GetSingleFileInfo_Response\x12N\n" +
	"\tShareFile\x12\x1f.steam.CCloud_ShareFile_Request\x1a .steam.CCloud_ShareFile_Response\x12i\n" +
	"\x12EnumerateUserFiles\x12(.steam.CCloud_EnumerateUserFiles_Request\x1a).steam.CCloud_EnumerateUserFiles_Response\x12E\n" +
	"\x06Delete\x12\x1c.steam.CCloud_Delete_Request\x1a\x1d.steam.CCloud_Delete_Response\x12u\n" +
	"\x16GetClientEncryptionKey\x12,.steam.CCloud_GetClientEncryptionKey_Request\x1a-.steam.CCloud_GetClientEncryptionKey_Response\x12D\n" +
	"\tCDNReport\x12$.steam.CCloud_CDNReport_Notification\x1a\x11.steam.NoResponse\x12l\n" +
	"\x1dExternalStorageTransferReport\x128.steam.CCloud_ExternalStorageTransferReport_Notification\x1a\x11.steam.NoResponse\x12l\n" +
	"\x13BeginAppUploadBatch\x12).steam.CCloud_BeginAppUploadBatch_Request\x1a*.steam.CCloud_BeginAppUploadBatch_Response\x12^\n" +
	"\x16CompleteAppUploadBatch\x121.steam.CCloud_CompleteAppUploadBatch_Notification\x1a\x11.steam.NoResponse\x12}\n" +
	"\x1eCompleteAppUploadBatchBlocking\x12,.steam.CCloud_CompleteAppUploadBatch_Request\x1a-.steam.CCloud_CompleteAppUploadBatch_Response\x12r\n" +
	"\x15ClientBeginFileUpload\x12+.steam.CCloud_ClientBeginFileUpload_Request\x1a,.steam.CCloud_ClientBeginFileUpload_Response\x12u\n" +
	"\x16ClientCommitFileUpload\x12,.steam.CCloud_ClientCommitFileUpload_Request\x1a-.steam.CCloud_ClientCommitFileUpload_Response\x12i\n" +
	"\x12ClientFileDownload\x12(.steam.CCloud_ClientFileDownload_Request\x1a).steam.CCloud_ClientFileDownload_Response\x12c\n" +
	"\x10ClientDeleteFile\x12&.steam.CCloud_ClientDeleteFile_Request\x1a'.steam.CCloud_ClientDeleteFile_Response\x12b\n" +
	"\x18ClientConflictResolution\x123.steam.CCloud_ClientConflictResolution_Notification\x1a\x11.steam.NoResponse\x12o\n" +
	"\x14GetAppFileChangelist\x12*.steam.CCloud_GetAppFileChangelist_Request\x1a+.steam.CCloud_GetAppFileChangelist_Response\x12f\n" +
	"\x11SuspendAppSession\x12'.steam.CCloud_AppSessionSuspend_Request\x1a(.steam.CCloud_AppSessionSuspend_Response\x12c\n" +
	"\x10ResumeAppSession\x12&.steam.CCloud_AppSessionResume_Request\x1a'.steam.CCloud_AppSessionResume_Response\x12f\n" +
	"\x15SignalAppLaunchIntent\x12%.steam.CCloud_AppLaunchIntent_Request\x1a&.steam.CCloud_AppLaunchIntent_Response\x12V\n" +
	"\x15SignalAppExitSyncDone\x12*.steam.CCloud_AppExitSyncDone_Notification\x1a\x11.steam.NoResponse\x12u\n" +
	"\x16ClientGetAppQuotaUsage\x12,.steam.CCloud_ClientGetAppQuotaUsage_Request\x1a-.steam.CCloud_ClientGetAppQuotaUsage_Response2\xce\x01\n" +
	"\vCloudClient\x12Y\n" +
	"\x14NotifyAppStateChange\x12..steam.CCloud_AppCloudStateChange_Notification\x1a\x11.steam.NoResponse\x12^\n" +
	"\x16ClientLogUploadRequest\x121.steam.CCloud_ClientLogUploadRequest_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x02B3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_cloud_steamclient_proto_goTypes = []any{
	(*CCloud_ClientLogUploadCheck_Notification)(nil),          // 0: steam.CCloud_ClientLogUploadCheck_Notification
	(*CCloud_ClientLogUploadComplete_Notification)(nil),       // 1: steam.CCloud_ClientLogUploadComplete_Notification
	...
	(*CCloud_BeginUGCUpload_Request)(nil),                     // 6: steam.CCloud_BeginUGCUpload_Request
	(*CCloud_BeginUGCUpload_Response)(nil),                    // 7: steam.CCloud_BeginUGCUpload_Response
	(*CCloud_CommitUGCUpload_Request)(nil),                    // 8: steam.CCloud_CommitUGCUpload_Request
	(*CCloud_CommitUGCUpload_Response)(nil),                   // 9: steam.CCloud_CommitUGCUpload_Response
	(*CCloud_GetFileDetails_Request)(nil),                     // 10: steam.CCloud_GetFileDetails_Request
	(*CCloud_UserFile)(nil),                                   // 11: steam.CCloud_UserFile
	(*CCloud_GetFileDetails_Response)(nil),                    // 12: steam.CCloud_GetFileDetails_Response
	(*CCloud_GetSingleFileInfo_Request)(nil),                  // 13: steam.CCloud_GetSingleFileInfo_Request
	(*CCloud_GetSingleFileInfo_Response)(nil),                 // 14: steam.CCloud_GetSingleFileInfo_Response
	(*CCloud_ShareFile_Request)(nil),                          // 15: steam.CCloud_ShareFile_Request
	(*CCloud_ShareFile_Response)(nil),                         // 16: steam.CCloud_ShareFile_Response
	(*CCloud_EnumerateUserFiles_Request)(nil),                 // 17: steam.CCloud_EnumerateUserFiles_Request
	(*CCloud_EnumerateUserFiles_Response)(nil),                // 18: steam.CCloud_EnumerateUserFiles_Response
	(*CCloud_Delete_Request)(nil),                             // 19: steam.CCloud_Delete_Request
	(*CCloud_Delete_Response)(nil),                            // 20: steam.CCloud_Delete_Response
	(*CCloud_GetClientEncryptionKey_Request)(nil),             // 21: steam.CCloud_GetClientEncryptionKey_Request
	(*CCloud_GetClientEncryptionKey_Response)(nil),            // 22: steam.CCloud_GetClientEncryptionKey_Response
	(*CCloud_CDNReport_Notification)(nil),                     // 23: steam.CCloud_CDNReport_Notification
	(*CCloud_ExternalStorageTransferReport_Notification)(nil), // 24: steam.CCloud_ExternalStorageTransferReport_Notification
	(*CCloud_BeginAppUploadBatch_Request)(nil),                // 25: steam.CCloud_BeginAppUploadBatch_Request
	(*CCloud_BeginAppUploadBatch_Response)(nil),               // 26: steam.CCloud_BeginAppUploadBatch_Response
	(*CCloud_CompleteAppUploadBatch_Notification)(nil),        // 27: steam.CCloud_CompleteAppUploadBatch_Notification
	(*CCloud_CompleteAppUploadBatch_Request)(nil),             // 28: steam.CCloud_CompleteAppUploadBatch_Request
	(*CCloud_CompleteAppUploadBatch_Response)(nil),            // 29: steam.CCloud_CompleteAppUploadBatch_Response
	(*CCloud_ClientBeginFileUpload_Request)(nil),              // 30: steam.CCloud_ClientBeginFileUpload_Request
	(*ClientCloudFileUploadBlockDetails)(nil),                 // 31: steam.ClientCloudFileUploadBlockDetails
	(*CCloud_ClientBeginFileUpload_Response)(nil),             // 32: steam.CCloud_ClientBeginFileUpload_Response
	(*CCloud_ClientCommitFileUpload_Request)(nil),             // 33: steam.CCloud_ClientCommitFileUpload_Request
	(*CCloud_ClientCommitFileUpload_Response)(nil),            // 34: steam.CCloud_ClientCommitFileUpload_Response
	(*CCloud_ClientFileDownload_Request)(nil),                 // 35: steam.CCloud_ClientFileDownload_Request
	(*CCloud_ClientFileDownload_Response)(nil),                // 36: steam.CCloud_ClientFileDownload_Response
	(*CCloud_ClientDeleteFile_Request)(nil),                   // 37: steam.CCloud_ClientDeleteFile_Request
	(*CCloud_ClientDeleteFile_Response)(nil),                  // 38: steam.CCloud_ClientDeleteFile_Response
	(*CCloud_ClientConflictResolution_Notification)(nil),      // 39: steam.CCloud_ClientConflictResolution_Notification
	(*CCloud_GetAppFileChangelist_Request)(nil),               // 40: steam.CCloud_GetAppFileChangelist_Request
	(*CCloud_AppFileInfo)(nil),                                // 41: steam.CCloud_AppFileInfo
	(*CCloud_GetAppFileChangelist_Response)(nil),              // 42: steam.CCloud_GetAppFileChangelist_Response
	(*CCloud_AppSessionSuspend_Request)(nil),                  // 43: steam.CCloud_AppSessionSuspend_Request
	(*CCloud_AppSessionSuspend_Response)(nil),                 // 44: steam.CCloud_AppSessionSuspend_Response
	(*CCloud_AppSessionResume_Request)(nil),                   // 45: steam.CCloud_AppSessionResume_Request
	(*CCloud_AppSessionResume_Response)(nil),                  // 46: steam.CCloud_AppSessionResume_Response
	(*CCloud_AppLaunchIntent_Request)(nil),                    // 47: steam.CCloud_AppLaunchIntent_Request
	(*CCloud_AppLaunchIntent_Response)(nil),                   // 48: steam.CCloud_AppLaunchIntent_Response
	(*CCloud_AppExitSyncDone_Notification)(nil),               // 49: steam.CCloud_AppExitSyncDone_Notification
	(*CCloud_ClientGetAppQuotaUsage_Request)(nil),             // 50: steam.CCloud_ClientGetAppQuotaUsage_Request
	(*CCloud_ClientGetAppQuotaUsage_Response)(nil),            // 51: steam.CCloud_ClientGetAppQuotaUsage_Response
	(*CCloud_AppCloudStateChange_Notification)(nil),           // 52: steam.CCloud_AppCloudStateChange_Notification
	(*CCloud_ClientLogUploadRequest_Notification)(nil),        // 53: steam.CCloud_ClientLogUploadRequest_Notification
	(*CCloud_BeginHTTPUpload_Response_HTTPHeaders)(nil),       // 54: steam.CCloud_BeginHTTPUpload_Response.HTTPHeaders
	(*CCloud_BeginUGCUpload_Response_HTTPHeaders)(nil),        // 55: steam.CCloud_BeginUGCUpload_Response.HTTPHeaders
	(*ClientCloudFileUploadBlockDetails_HTTPHeaders)(nil),     // 56: steam.ClientCloudFileUploadBlockDetails.HTTPHeaders
	(*CCloud_ClientFileDownload_Response_HTTPHeaders)(nil),    // 57: steam.CCloud_ClientFileDownload_Response.HTTPHeaders
	(EPublishedFileStorageSystem)(0),                          // 58: steam.EPublishedFileStorageSystem
	(ECloudStoragePersistState)(0),                            // 59: steam.ECloudStoragePersistState
	(*CCloud_PendingRemoteOperation)(nil),                     // 60: steam.CCloud_PendingRemoteOperation
	(*NoResponse)(nil),                                        // 61: steam.NoResponse
}
var file_steammessages_cloud_steamclient_proto_depIdxs = []int32{
	54, // 0: steam.CCloud_BeginHTTPUpload_Response.request_headers:type_name -> steam.CCloud_BeginHTTPUpload_Response.HTTPHeaders
	58, // 1: steam.CCloud_BeginUGCUpload_Response.storage_system:type_name -> steam.EPublishedFileStorageSystem
	55, // 2: steam.CCloud_BeginUGCUpload_Response.request_headers:type_name -> steam.CCloud_BeginUGCUpload_Response.HTTPHeaders
	11, // 3: steam.CCloud_GetFileDetails_Response.details:type_name -> steam.CCloud_UserFile
	11, // 4: steam.CCloud_EnumerateUserFiles_Response.files:type_name -> steam.CCloud_UserFile
	56, // 5: steam.ClientCloudFileUploadBlockDetails.request_headers:type_name -> steam.ClientCloudFileUploadBlockDetails.HTTPHeaders
	31, // 6: steam.CCloud_ClientBeginFileUpload_Response.block_requests:type_name -> steam.ClientCloudFileUploadBlockDetails
	57, // 7: steam.CCloud_ClientFileDownload_Response.request_headers:type_name -> steam.CCloud_ClientFileDownload_Response.HTTPHeaders
	59, // 8: steam.CCloud_AppFileInfo.persist_state:type_name -> steam.ECloudStoragePersistState
	41, // 9: steam.CCloud_GetAppFileChangelist_Response.files:type_name -> steam.CCloud_AppFileInfo
	60, // 10: steam.CCloud_AppLaunchIntent_Response.pending_remote_operations:type_name -> steam.CCloud_PendingRemoteOperation
	0,  // 11: steam.Cloud.ClientLogUploadCheck:input_type -> steam.CCloud_ClientLogUploadCheck_Notification
	1,  // 12: steam.Cloud.ClientLogUploadComplete:input_type -> steam.CCloud_ClientLogUploadComplete_Notification
	2,  // 13: steam.Cloud.BeginHTTPUpload:input_type -> steam.CCloud_BeginHTTPUpload_Request
	4,  // 14: steam.Cloud.CommitHTTPUpload:input_type -> steam.CCloud_CommitHTTPUpload_Request
	6,  // 15: steam.Cloud.BeginUGCUpload:input_type -> steam.CCloud_BeginUGCUpload_Request
	8,  // 16: steam.Cloud.CommitUGCUpload:input_type -> steam.CCloud_CommitUGCUpload_Request
	10, // 17: steam.Cloud.GetFileDetails:input_type -> steam.CCloud_GetFileDetails_Request
	13, // 18: steam.Cloud.GetSingleFileInfo:input_type -> steam.CCloud_GetSingleFileInfo_Request
	15, // 19: steam.Cloud.ShareFile:input_type -> steam.CCloud_ShareFile_Request
	17, // 20: steam.Cloud.EnumerateUserFiles:input_type -> steam.CCloud_EnumerateUserFiles_Request
	19, // 21: steam.Cloud.Delete:input_type -> steam.CCloud_Delete_Request
	21, // 22: steam.Cloud.GetClientEncryptionKey:input_type -> steam.CCloud_GetClientEncryptionKey_Request
	23, // 23: steam.Cloud.CDNReport:input_type -> steam.CCloud_CDNReport_Notification
	24, // 24: steam.Cloud.ExternalStorageTransferReport:input_type -> steam.CCloud_ExternalStorageTransferReport_Notification
	25, // 25: steam.Cloud.BeginAppUploadBatch:input_type -> steam.CCloud_BeginAppUploadBatch_Request
	27, // 26: steam.Cloud.CompleteAppUploadBatch:input_type -> steam.CCloud_CompleteAppUploadBatch_Notification
	28, // 27: steam.Cloud.CompleteAppUploadBatchBlocking:input_type -> steam.CCloud_CompleteAppUploadBatch_Request
	30, // 28: steam.Cloud.ClientBeginFileUpload:input_type -> steam.CCloud_ClientBeginFileUpload_Request
	33, // 29: steam.Cloud.ClientCommitFileUpload:input_type -> steam.CCloud_ClientCommitFileUpload_Request
	35, // 30: steam.Cloud.ClientFileDownload:input_type -> steam.CCloud_ClientFileDownload_Request
	37, // 31: steam.Cloud.ClientDeleteFile:input_type -> steam.CCloud_ClientDeleteFile_Request
	39, // 32: steam.Cloud.ClientConflictResolution:input_type -> steam.CCloud_ClientConflictResolution_Notification
	40, // 33: steam.Cloud.GetAppFileChangelist:input_type -> steam.CCloud_GetAppFileChangelist_Request
	43, // 34: steam.Cloud.SuspendAppSession:input_type -> steam.CCloud_AppSessionSuspend_Request
	45, // 35: steam.Cloud.ResumeAppSession:input_type -> steam.CCloud_AppSessionResume_Request
	47, // 36: steam.Cloud.SignalAppLaunchIntent:input_type -> steam.CCloud_AppLaunchIntent_Request
	49, // 37: steam.Cloud.SignalAppExitSyncDone:input_type -> steam.CCloud_AppExitSyncDone_Notification
	50, // 38: steam.Cloud.ClientGetAppQuotaUsage:input_type -> steam.CCloud_ClientGetAppQuotaUsage_Request
	52, // 39: steam.CloudClient.NotifyAppStateChange:input_type -> steam.CCloud_AppCloudStateChange_Notification
	53, // 40: steam.CloudClient.ClientLogUploadRequest:input_type -> steam.CCloud_ClientLogUploadRequest_Notification
	61, // 41: steam.Cloud.ClientLogUploadCheck:output_type -> steam.NoResponse
	61, // 42: steam.Cloud.ClientLogUploadComplete:output_type -> steam.NoResponse
	3,  // 43: steam.Cloud.BeginHTTPUpload:output_type -> steam.CCloud_BeginHTTPUpload_Response
	5,  // 44: steam.Cloud.CommitHTTPUpload:output_type -> steam.CCloud_CommitHTTPUpload_Response
	7,  // 45: steam.Cloud.BeginUGCUpload:output_type -> steam.CCloud_BeginUGCUpload_Response
	9,  // 46: steam.Cloud.CommitUGCUpload:output_type -> steam.CCloud_CommitUGCUpload_Response
	12, // 47: steam.Cloud.GetFileDetails:output_type -> steam.CCloud_GetFileDetails_Response
	14, // 48: steam.Cloud.GetSingleFileInfo:output_type -> steam.CCloud_GetSingleFileInfo_Response
	16, // 49: steam.Cloud.ShareFile:output_type -> steam.CCloud_ShareFile_Response
	18, // 50: steam.Cloud.EnumerateUserFiles:output_type -> steam.CCloud_EnumerateUserFiles_Response
	20, // 51: steam.Cloud.Delete:output_type -> steam.CCloud_Delete_Response
	22, // 52: steam.Cloud.GetClientEncryptionKey:output_type -> steam.CCloud_GetClientEncryptionKey_Response
	61, // 53: steam.Cloud.CDNReport:output_type -> steam.NoResponse
	61, // 54: steam.Cloud.ExternalStorageTransferReport:output_type -> steam.NoResponse
	26, // 55: steam.Cloud.BeginAppUploadBatch:output_type -> steam.CCloud_BeginAppUploadBatch_Response
	61, // 56: steam.Cloud.CompleteAppUploadBatch:output_type -> steam.NoResponse
	29, // 57: steam.Cloud.CompleteAppUploadBatchBlocking:output_type -> steam.CCloud_CompleteAppUploadBatch_Response
	32, // 58: steam.Cloud.ClientBeginFileUpload:output_type -> steam.CCloud_ClientBeginFileUpload_Response
	34, // 59: steam.Cloud.ClientCommitFileUpload:output_type -> steam.CCloud_ClientCommitFileUpload_Response
	36, // 60: steam.Cloud.ClientFileDownload:output_type -> steam.CCloud_ClientFileDownload_Response
	38, // 61: steam.Cloud.ClientDeleteFile:output_type -> steam.CCloud_ClientDeleteFile_Response
	61, // 62: steam.Cloud.ClientConflictResolution:output_type -> steam.NoResponse
	42, // 63: steam.Cloud.GetAppFileChangelist:output_type -> steam.CCloud_GetAppFileChangelist_Response
	44, // 64: steam.Cloud.SuspendAppSession:output_type -> steam.CCloud_AppSessionSuspend_Response
	46, // 65: steam.Cloud.ResumeAppSession:output_type -> steam.CCloud_AppSessionResume_Response
	48, // 66: steam.Cloud.SignalAppLaunchIntent:output_type -> steam.CCloud_AppLaunchIntent_Response
	61, // 67: steam.Cloud.SignalAppExitSyncDone:output_type -> steam.NoResponse
	51, // 68: steam.Cloud.ClientGetAppQuotaUsage:output_type -> steam.CCloud_ClientGetAppQuotaUsage_Response
	61, // 69: steam.CloudClient.NotifyAppStateChange:output_type -> steam.NoResponse
	61, // 70: steam.CloudClient.ClientLogUploadRequest:output_type -> steam.NoResponse
