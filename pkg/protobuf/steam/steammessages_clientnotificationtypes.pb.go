...
type CClientNotificationSystemUpdate struct {
	state         protoimpl.MessageState         `protogen:"open.v1"`
	Type          *ESystemUpdateNotificationType `protobuf:"varint,1,opt,name=type,enum=steam.ESystemUpdateNotificationType,def=0" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CClientNotificationGameRecordingError struct {
	...
	ErrorType     *EGameRecordingErrorType `protobuf:"varint,2,opt,name=error_type,json=errorType,enum=steam.EGameRecordingErrorType,def=1" json:"error_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_steammessages_clientnotificationtypes_proto_rawDesc = "" +
	"\n" +
	"+steammessages_clientnotificationtypes.proto\x12\x05steam\";\n" +
	...
	"\rpct_remaining\x18\x01 \x01(\x02R\fpctRemaining\"\x84\x01\n" +
	"\x1fCClientNotificationSystemUpdate\x12a\n" +
	"\x04type\x18\x01 \x01(\x0e2$.steam.ESystemUpdateNotificationType:'k_ESystemUpdateNotificationType_InvalidR\x04type\"\xe1\x01\n" +
	...
	"\x12playtime_remaining\x18\x02 \x01(\rR\x11playtimeRemaining\"\x9d\x01\n" +
	"%CClientNotificationGameRecordingError\x12\x17\n" +
	"\agame_id\x18\x01 \x01(\x06R\x06gameId\x12[\n" +
	"\n" +
	"error_type\x18\x02 \x01(\x0e2\x1e.steam.EGameRecordingErrorType:\x1ck_EGameRecordingErrorGeneralR\terrorType\"@\n" +
	...
	"\rpct_remaining\x18\x02 \x01(\x02R\fpctRemaining*\xb5\x17\n" +
	...
	"!k_EGameRecordingErrorLowDiskSpace\x10\x02B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_clientnotificationtypes_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_steammessages_clientnotificationtypes_proto_goTypes = []any{
	(EClientNotificationType)(0),                                       // 0: steam.EClientNotificationType
	(ESystemUpdateNotificationType)(0),                                 // 1: steam.ESystemUpdateNotificationType
	(EGameRecordingErrorType)(0),                                       // 2: steam.EGameRecordingErrorType
	(*CClientNotificationCloudSyncFailure)(nil),                        // 3: steam.CClientNotificationCloudSyncFailure
	(*CClientNotificationCloudSyncConflict)(nil),                       // 4: steam.CClientNotificationCloudSyncConflict
	(*CClientNotificationScreenshot)(nil),                              // 5: steam.CClientNotificationScreenshot
	(*CClientNotificationDownloadCompleted)(nil),                       // 6: steam.CClientNotificationDownloadCompleted
	(*CClientNotificationFriendInvite)(nil),                            // 7: steam.CClientNotificationFriendInvite
	(*CClientNotificationFriendInviteRollup)(nil),                      // 8: steam.CClientNotificationFriendInviteRollup
	(*CClientNotificationFriendInGame)(nil),                            // 9: steam.CClientNotificationFriendInGame
	(*CClientNotificationFriendOnline)(nil),                            // 10: steam.CClientNotificationFriendOnline
	(*CClientNotificationAchievement)(nil),                             // 11: steam.CClientNotificationAchievement
	(*CClientNotificationLowBattery)(nil),                              // 12: steam.CClientNotificationLowBattery
	(*CClientNotificationSystemUpdate)(nil),                            // 13: steam.CClientNotificationSystemUpdate
	(*CClientNotificationFriendMessage)(nil),                           // 14: steam.CClientNotificationFriendMessage
	(*CClientNotificationGroupChatMessage)(nil),                        // 15: steam.CClientNotificationGroupChatMessage
	(*CClientNotificationFamilySharingDeviceAuthorizationChanged)(nil), // 16: steam.CClientNotificationFamilySharingDeviceAuthorizationChanged
	(*CClientNotificationFamilySharingStopPlaying)(nil),                // 17: steam.CClientNotificationFamilySharingStopPlaying
	(*CClientNotificationFamilySharingLibraryAvailable)(nil),           // 18: steam.CClientNotificationFamilySharingLibraryAvailable
	(*CClientNotificationIncomingVoiceChat)(nil),                       // 19: steam.CClientNotificationIncomingVoiceChat
	(*CClientNotificationClaimSteamDeckRewards)(nil),                   // 20: steam.CClientNotificationClaimSteamDeckRewards
	(*CClientNotificationGiftReceived)(nil),                            // 21: steam.CClientNotificationGiftReceived
	(*CClientNotificationItemAnnouncement)(nil),                        // 22: steam.CClientNotificationItemAnnouncement
	(*CClientNotificationHardwareSurveyPending)(nil),                   // 23: steam.CClientNotificationHardwareSurveyPending
	(*CClientNotificationLowDiskSpace)(nil),                            // 24: steam.CClientNotificationLowDiskSpace
	(*CClientNotificationBatteryTemperature)(nil),                      // 25: steam.CClientNotificationBatteryTemperature
	(*CClientNotificationDockUnsupportedFirmware)(nil),                 // 26: steam.CClientNotificationDockUnsupportedFirmware
	(*CClientNotificationPeerContentUpload)(nil),                       // 27: steam.CClientNotificationPeerContentUpload
	(*CClientNotificationCannotReadControllerGuideButton)(nil),         // 28: steam.CClientNotificationCannotReadControllerGuideButton
	(*CClientNotificationOverlaySplashScreen)(nil),                     // 29: steam.CClientNotificationOverlaySplashScreen
	(*CClientNotificationBroadcastAvailableToWatch)(nil),               // 30: steam.CClientNotificationBroadcastAvailableToWatch
	(*CClientNotificationTimedTrialRemaining)(nil),                     // 31: steam.CClientNotificationTimedTrialRemaining
	(*CClientNotificationLoginRefresh)(nil),                            // 32: steam.CClientNotificationLoginRefresh
	(*CClientNotificationTimerExpired)(nil),                            // 33: steam.CClientNotificationTimerExpired
	(*CClientNotificationSteamInputActionSetChanged)(nil),              // 34: steam.CClientNotificationSteamInputActionSetChanged
	(*CClientNotificationRemoteClientConnection)(nil),                  // 35: steam.CClientNotificationRemoteClientConnection
	(*CClientNotificationRemoteClientStartStream)(nil),                 // 36: steam.CClientNotificationRemoteClientStartStream
	(*CClientNotificationStreamingClientConnection)(nil),               // 37: steam.CClientNotificationStreamingClientConnection
	(*CClientNotificationPlaytimeWarning)(nil),                         // 38: steam.CClientNotificationPlaytimeWarning
	(*CClientNotificationGameRecordingError)(nil),                      // 39: steam.CClientNotificationGameRecordingError
	(*CClientNotificationGameRecordingStart)(nil),                      // 40: steam.CClientNotificationGameRecordingStart
	(*CClientNotificationGameRecordingStop)(nil),                       // 41: steam.CClientNotificationGameRecordingStop
	(*CClientNotificationGameRecordingUserMarkerAdded)(nil),            // 42: steam.CClientNotificationGameRecordingUserMarkerAdded
	(*CClientNotificationGameRecordingInstantClip)(nil),                // 43: steam.CClientNotificationGameRecordingInstantClip
	(*CClientNotificationHardwareUpdateAvailable)(nil),                 // 44: steam.CClientNotificationHardwareUpdateAvailable
	(*CClientNotificationControllerLowBattery)(nil),                    // 45: steam.CClientNotificationControllerLowBattery
}
var file_steammessages_clientnotificationtypes_proto_depIdxs = []int32{
	1, // 0: steam.CClientNotificationSystemUpdate.type:type_name -> steam.ESystemUpdateNotificationType
	2, // 1: steam.CClientNotificationGameRecordingError.error_type:type_name -> steam.EGameRecordingErrorType
