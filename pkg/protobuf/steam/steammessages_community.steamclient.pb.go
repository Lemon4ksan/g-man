...
type CCommunity_GetCommentThread_Request struct {
	...
	CommentThreadType *ECommentThreadType    `protobuf:"varint,2,opt,name=comment_thread_type,json=commentThreadType,enum=steam.ECommentThreadType,def=0" json:"comment_thread_type,omitempty"`
...
type CCommunity_Comment struct {
	...
	DeleteReason     *ECommentDeleteReason          `protobuf:"varint,14,opt,name=delete_reason,json=deleteReason,enum=steam.ECommentDeleteReason,def=0" json:"delete_reason,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type CCommunity_GetClanLocGroupImages_Request struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Steamid       *uint64                `protobuf:"varint,1,opt,name=steamid" json:"steamid,omitempty"`
	Group         *EClanImageGroup       `protobuf:"varint,2,opt,name=group,enum=steam.EClanImageGroup,def=0" json:"group,omitempty"`
...
type CCommunity_ClanLocGroupImage struct {
	...
	FileType      *EClanImageFileType    `protobuf:"varint,4,opt,name=file_type,json=fileType,enum=steam.EClanImageFileType,def=0" json:"file_type,omitempty"`
	Group         *EClanImageGroup       `protobuf:"varint,5,opt,name=group,enum=steam.EClanImageGroup,def=0" json:"group,omitempty"`
...
type CCommunity_HideAndReportComment_Request struct {
	...
	ReportReason      *EContentReportReason  `protobuf:"varint,7,opt,name=report_reason,json=reportReason,enum=steam.EContentReportReason,def=0" json:"report_reason,omitempty"`
...
type CCommunity_GetUserPartnerEventNews_Request struct {
	...
	FilterEventType    []EProtoClanEventType  `protobuf:"varint,6,rep,name=filter_event_type,json=filterEventType,enum=steam.EProtoClanEventType" json:"filter_event_type,omitempty"`
...
type CCommunity_MarkPartnerEventsForUser_Request_PartnerEventMarking struct {
	...
	Clanid          *uint32                       `protobuf:"varint,1,opt,name=clanid" json:"clanid,omitempty"`
	EventGid        *uint64                       `protobuf:"fixed64,2,opt,name=event_gid,json=eventGid" json:"event_gid,omitempty"`
	DisplayLocation *EPartnerEventDisplayLocation `protobuf:"varint,3,opt,name=display_location,json=displayLocation,enum=steam.EPartnerEventDisplayLocation,def=0" json:"display_location,omitempty"`
...
const file_steammessages_community_steamclient_proto_rawDesc = "" +
	"\n" +
	")steammessages_community.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\x1a\venums.proto\"P\n" +
	"\x1aCCommunity_GetApps_Request\x12\x16\n" +
	"\x06appids\x18\x01 \x03(\x05R\x06appids\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\rR\blanguage\"N\n" +
	"\x1bCCommunity_GetApps_Response\x12/\n" +
	"\x04apps\x18\x01 \x03(\v2\x1b.steam.CCDDBAppDetailCommonR\x04apps\"e\n" +
	"1CCommunity_GetAppRichPresenceLocalization_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\x05R\x05appid\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\tR\blanguage\"\xe6\x02\n" +
	"2CCommunity_GetAppRichPresenceLocalization_Response\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\x05R\x05appid\x12d\n" +
	"\vtoken_lists\x18\x02 \x03(\v2C.steam.CCommunity_GetAppRichPresenceLocalization_Response.TokenListR\n" +
	"tokenLists\x1a1\n" +
	"\x05Token\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x1a\x80\x01\n" +
	"\tTokenList\x12\x1a\n" +
	"\blanguage\x18\x01 \x01(\tR\blanguage\x12W\n" +
	"\x06tokens\x18\x02 \x03(\v2?.steam.CCommunity_GetAppRichPresenceLocalization_Response.TokenR\x06tokens\"\xe8\x03\n" +
	"#CCommunity_GetCommentThread_Request\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12f\n" +
	"\x13comment_thread_type\x18\x02 \x01(\x0e2\x19.steam.ECommentThreadType:\x1bk_ECommentThreadTypeInvalidR\x11commentThreadType\x12\x1e\n" +
	"\n" +
	...
	"timeOldest\x12!\n" +
	"\foldest_first\x18\f \x01(\bR\voldestFirst\"\x83\x05\n" +
	...
	"\adeleted\x18\b \x01(\bR\adeleted\x122\n" +
	"\tipaddress\x18\t \x01(\v2\x14.steam.CMsgIPAddressR\tipaddress\x12!\n" +
	"\ftotal_hidden\x18\n" +
	" \x01(\x05R\vtotalHidden\x12&\n" +
	"\x0fupvoted_by_user\x18\v \x01(\bR\rupvotedByUser\x12@\n" +
	"\treactions\x18\f \x03(\v2\".steam.CCommunity_Comment.ReactionR\treactions\x12*\n" +
	"\x10gidparentcomment\x18\r \x01(\x06R\x10gidparentcomment\x12`\n" +
	"\rdelete_reason\x18\x0e \x01(\x0e2\x1b.steam.ECommentDeleteReason:\x1ek_ECommentDeleteReason_InvalidR\fdeleteReason\x1a@\n" +
	"\bReaction\x12\x1e\n" +
	"\n" +
	"reactionid\x18\x01 \x01(\rR\n" +
	"reactionid\x12\x14\n" +
	"\x05count\x18\x02 \x01(\rR\x05count\"\xbd\x05\n" +
	"$CCommunity_GetCommentThread_Response\x125\n" +
	"\bcomments\x18\x01 \x03(\v2\x19.steam.CCommunity_CommentR\bcomments\x12D\n" +
	"\x10deleted_comments\x18\x02 \x03(\v2\x19.steam.CCommunity_CommentR\x0fdeletedComments\x12\x18\n" +
	...
	"gidfeature\x12 \n" +
	"\vgidfeature2\x18\x12 \x01(\x06R\vgidfeature2\"\xa3\x03\n" +
	...
	"\aupvotes\x18\x04 \x01(\x05R\aupvotes\"\xac\x02\n" +
	...
	"profileUrl\x12\x14\n" +
	"\x05appid\x18\x04 \x01(\rR\x05appid\"\xca\x01\n" +
	"(CCommunity_GetClanLocGroupImages_Request\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x04R\asteamid\x12D\n" +
	"\x05group\x18\x02 \x01(\x0e2\x16.steam.EClanImageGroup:\x16k_EClanImageGroup_NoneR\x05group\x12\x1a\n" +
	"\blanguage\x18\x03 \x01(\rR\blanguage\x12\"\n" +
	"\rloc_group_ids\x18\x04 \x03(\x04R\vlocGroupIds\"\xf0\x02\n" +
	"\x1cCCommunity_ClanLocGroupImage\x12 \n" +
	"\floc_group_id\x18\x01 \x01(\x04R\n" +
	"locGroupId\x12\x1d\n" +
	"\n" +
	"image_hash\x18\x02 \x01(\tR\timageHash\x12%\n" +
	"\x0ethumbnail_hash\x18\x03 \x01(\tR\rthumbnailHash\x12T\n" +
	"\tfile_type\x18\x04 \x01(\x0e2\x19.steam.EClanImageFileType:\x1ck_EClanImageFileType_UnknownR\bfileType\x12D\n" +
	"\x05group\x18\x05 \x01(\x0e2\x16.steam.EClanImageGroup:\x16k_EClanImageGroup_NoneR\x05group\x12\x14\n" +
	...
	"\x06images\x18\x01 \x03(\v2#.steam.CCommunity_ClanLocGroupImageR\x06images\"z\n" +
	"#CCommunity_GetAvatarHistory_Request\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x129\n" +
	"\x19filter_user_uploaded_only\x18\x02 \x01(\bR\x16filterUserUploadedOnly\"\xea\x01\n" +
	"$CCommunity_GetAvatarHistory_Response\x12P\n" +
	"\aavatars\x18\x01 \x03(\v26.steam.CCommunity_GetAvatarHistory_Response.AvatarDataR\aavatars\x1ap\n" +
	"\n" +
	"AvatarData\x12\x1f\n" +
	...
	"/CCommunity_FetchTranslationFromCrowdIn_Response\"\xea\x02\n" +
	...
	"\rreport_reason\x18\a \x01(\x0e2\x1b.steam.EContentReportReason:\x1ek_EContentReportReason_InvalidR\freportReason\x12\x1f\n" +
	...
	"\x05appid\x18\x02 \x03(\rR\x05appid\"\xcd\x03\n" +
	...
	"\x13language_preference\x18\x05 \x03(\rR\x12languagePreference\x12F\n" +
	"\x11filter_event_type\x18\x06 \x03(\x0e2\x1a.steam.EProtoClanEventTypeR\x0ffilterEventType\x12&\n" +
	"\x0ffilter_to_appid\x18\a \x01(\bR\rfilterToAppid\x12.\n" +
	"\bapp_list\x18\b \x03(\v2\x13.steam.CAppPriorityR\aappList\x12\"\n" +
	"\vcount_after\x18\t \x01(\r:\x010R\n" +
	"countAfter\x12$\n" +
	"\fcount_before\x18\n" +
	" \x01(\r:\x010R\vcountBefore\"f\n" +
	"+CCommunity_GetUserPartnerEventNews_Response\x127\n" +
	"\aresults\x18\x01 \x03(\v2\x1d.steam.CClanMatchEventByRangeR\aresults\"\xd2\x01\n" +
	...
	"\x11user_app_priority\x18\a \x01(\x05R\x0fuserAppPriority\"j\n" +
	"(CCommunity_GetBestEventsForUser_Response\x12>\n" +
	"\aresults\x18\x01 \x03(\v2$.steam.CCommunity_PartnerEventResultR\aresults\"\x92\x03\n" +
	"+CCommunity_MarkPartnerEventsForUser_Request\x12b\n" +
	"\bmarkings\x18\x01 \x03(\v2F.steam.CCommunity_MarkPartnerEventsForUser_Request.PartnerEventMarkingR\bmarkings\x1a\xfe\x01\n" +
	"\x13PartnerEventMarking\x12\x16\n" +
	"\x06clanid\x18\x01 \x01(\rR\x06clanid\x12\x1b\n" +
	"\tevent_gid\x18\x02 \x01(\x06R\beventGid\x12v\n" +
	"\x10display_location\x18\x03 \x01(\x0e2#.steam.EPartnerEventDisplayLocation:&k_EPartnerEventDisplayLocation_InvalidR\x0fdisplayLocation\x12\x1d\n" +
	"\n" +
	...
	"\x18include_read_events_only\x18\x02 \x01(\bR\x15includeReadEventsOnly\"\xb6\x02\n" +
	"1CCommunity_GetUserPartnerEventViewStatus_Response\x12]\n" +
	"\x06events\x18\x01 \x03(\v2E.steam.CCommunity_GetUserPartnerEventViewStatus_Response.PartnerEventR\x06events\x1a\xa1\x01\n" +
	...
	"\x11user_app_priority\x18\x02 \x01(\x05R\x0fuserAppPriority\"\x83\x01\n" +
	"5CCommunity_GetUserPartnerEventsAppPriorities_Response\x12J\n" +
	"\n" +
	"priorities\x18\x01 \x03(\v2*.steam.CCommunity_PartnerEventsAppPriorityR\n" +
	"priorities\"N\n" +
	"6CCommunity_ClearSinglePartnerEventsAppPriority_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\"9\n" +
	"7CCommunity_ClearSinglePartnerEventsAppPriority_Response\"\x97\x02\n" +
	"3CCommunity_SetRecommendationBotReviewStatus_Request\x12k\n" +
	"\rreview_labels\x18\x01 \x03(\v2F.steam.CCommunity_SetRecommendationBotReviewStatus_Request.ReviewLabelR\freviewLabels\x1as\n" +
	...
	"2\x83\x1c\n" +
	"\tCommunity\x12P\n" +
	"\aGetApps\x12!.steam.CCommunity_GetApps_Request\x1a\".steam.CCommunity_GetApps_Response\x12\x95\x01\n" +
	"\x1eGetAppRichPresenceLocalization\x128.steam.CCommunity_GetAppRichPresenceLocalization_Request\x1a9.steam.CCommunity_GetAppRichPresenceLocalization_Response\x12k\n" +
	"\x10GetCommentThread\x12*.steam.CCommunity_GetCommentThread_Request\x1a+.steam.CCommunity_GetCommentThread_Response\x12t\n" +
	"\x13PostCommentToThread\x12-.steam.CCommunity_PostCommentToThread_Request\x1a..steam.CCommunity_PostCommentToThread_Response\x12\x80\x01\n" +
	"\x17DeleteCommentFromThread\x121.steam.CCommunity_DeleteCommentFromThread_Request\x1a2.steam.CCommunity_DeleteCommentFromThread_Response\x12n\n" +
	"\x11RateCommentThread\x12+.steam.CCommunity_RateCommentThread_Request\x1a,.steam.CCommunity_RateCommentThread_Response\x12\x80\x01\n" +
	"\x17GetCommentThreadRatings\x121.steam.CCommunity_GetCommentThreadRatings_Request\x1a2.steam.CCommunity_GetCommentThreadRatings_Response\x12w\n" +
	"\x14VerifyClanMembership\x12..steam.CCommunity_VerifyClanMembership_Request\x1a/.steam.CCommunity_VerifyClanMembership_Response\x12w\n" +
	"\x14RateClanAnnouncement\x12..steam.CCommunity_RateClanAnnouncement_Request\x1a/.steam.CCommunity_RateClanAnnouncement_Response\x12\x95\x01\n" +
	"\x1eGetClanAnnouncementVoteForUser\x128.steam.CCommunity_GetClanAnnouncementVoteForUser_Request\x1a9.steam.CCommunity_GetClanAnnouncementVoteForUser_Response\x12h\n" +
	"\x0fGetClanMetadata\x12).steam.CCommunity_GetClanMetadata_Request\x1a*.steam.CCommunity_GetClanMetadata_Response\x12z\n" +
	"\x15GetClanLocGroupImages\x12/.steam.CCommunity_GetClanLocGroupImages_Request\x1a0.steam.CCommunity_GetClanLocGroupImages_Response\x12k\n" +
	"\x10GetAvatarHistory\x12*.steam.CCommunity_GetAvatarHistory_Request\x1a+.steam.CCommunity_GetAvatarHistory_Response\x12\x8c\x01\n" +
	"\x1bGetClanEventCrowdInMetadata\x125.steam.CCommunity_GetClanEventCrowdInMetadata_Request\x1a6.steam.CCommunity_GetClanEventCrowdInMetadata_Response\x12}\n" +
	"\x16GetClanCrowdInMetadata\x120.steam.CCommunity_GetClanCrowdInMetadata_Request\x1a1.steam.CCommunity_GetClanCrowdInMetadata_Response\x12\x8c\x01\n" +
	"\x1bFetchTranslationFromCrowdIn\x125.steam.CCommunity_FetchTranslationFromCrowdIn_Request\x1a6.steam.CCommunity_FetchTranslationFromCrowdIn_Response\x12w\n" +
	"\x14HideAndReportComment\x12..steam.CCommunity_HideAndReportComment_Request\x1a/.steam.CCommunity_HideAndReportComment_Response\x12\x80\x01\n" +
	"\x17GetUserPartnerEventNews\x121.steam.CCommunity_GetUserPartnerEventNews_Request\x1a2.steam.CCommunity_GetUserPartnerEventNews_Response\x12w\n" +
	"\x14GetBestEventsForUser\x12..steam.CCommunity_GetBestEventsForUser_Request\x1a/.steam.CCommunity_GetBestEventsForUser_Response\x12\x83\x01\n" +
	"\x18MarkPartnerEventsForUser\x122.steam.CCommunity_MarkPartnerEventsForUser_Request\x1a3.steam.CCommunity_MarkPartnerEventsForUser_Response\x12\x92\x01\n" +
	"\x1dGetUserPartnerEventViewStatus\x127.steam.CCommunity_GetUserPartnerEventViewStatus_Request\x1a8.steam.CCommunity_GetUserPartnerEventViewStatus_Response\x12\x8c\x01\n" +
	"\x1bPartnerEventsShowMoreForApp\x125.steam.CCommunity_PartnerEventsShowMoreForApp_Request\x1a6.steam.CCommunity_PartnerEventsShowMoreForApp_Response\x12\x8c\x01\n" +
	"\x1bPartnerEventsShowLessForApp\x125.steam.CCommunity_PartnerEventsShowLessForApp_Request\x1a6.steam.CCommunity_PartnerEventsShowLessForApp_Response\x12\xa4\x01\n" +
	"#ClearUserPartnerEventsAppPriorities\x12=.steam.CCommunity_ClearUserPartnerEventsAppPriorities_Request\x1a>.steam.CCommunity_ClearUserPartnerEventsAppPriorities_Response\x12\x9e\x01\n" +
	"!GetUserPartnerEventsAppPriorities\x12;.steam.CCommunity_GetUserPartnerEventsAppPriorities_Request\x1a<.steam.CCommunity_GetUserPartnerEventsAppPriorities_Response\x12\xa4\x01\n" +
	"#ClearSinglePartnerEventsAppPriority\x12=.steam.CCommunity_ClearSinglePartnerEventsAppPriority_Request\x1a>.steam.CCommunity_ClearSinglePartnerEventsAppPriority_Response\x12\x9b\x01\n" +
	" SetRecommendationBotReviewStatus\x12:.steam.CCommunity_SetRecommendationBotReviewStatus_Request\x1a;.steam.CCommunity_SetRecommendationBotReviewStatus_ResponseB3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_community_steamclient_proto_goTypes = []any{
	(EClanImageGroup)(0),                                                    // 0: steam.EClanImageGroup
	(EClanImageFileType)(0),                                                 // 1: steam.EClanImageFileType
	(EPartnerEventDisplayLocation)(0),                                       // 2: steam.EPartnerEventDisplayLocation
	(*CCommunity_GetApps_Request)(nil),                                      // 3: steam.CCommunity_GetApps_Request
	(*CCommunity_GetApps_Response)(nil),                                     // 4: steam.CCommunity_GetApps_Response
	(*CCommunity_GetAppRichPresenceLocalization_Request)(nil),               // 5: steam.CCommunity_GetAppRichPresenceLocalization_Request
	(*CCommunity_GetAppRichPresenceLocalization_Response)(nil),              // 6: steam.CCommunity_GetAppRichPresenceLocalization_Response
	(*CCommunity_GetCommentThread_Request)(nil),                             // 7: steam.CCommunity_GetCommentThread_Request
	(*CCommunity_Comment)(nil),                                              // 8: steam.CCommunity_Comment
	(*CCommunity_GetCommentThread_Response)(nil),                            // 9: steam.CCommunity_GetCommentThread_Response
	(*CCommunity_PostCommentToThread_Request)(nil),                          // 10: steam.CCommunity_PostCommentToThread_Request
	(*CCommunity_PostCommentToThread_Response)(nil),                         // 11: steam.CCommunity_PostCommentToThread_Response
	(*CCommunity_DeleteCommentFromThread_Request)(nil),                      // 12: steam.CCommunity_DeleteCommentFromThread_Request
	(*CCommunity_DeleteCommentFromThread_Response)(nil),                     // 13: steam.CCommunity_DeleteCommentFromThread_Response
	(*CCommunity_RateCommentThread_Request)(nil),                            // 14: steam.CCommunity_RateCommentThread_Request
	(*CCommunity_RateCommentThread_Response)(nil),                           // 15: steam.CCommunity_RateCommentThread_Response
	(*CCommunity_GetCommentThreadRatings_Request)(nil),                      // 16: steam.CCommunity_GetCommentThreadRatings_Request
	(*CCommunity_GetCommentThreadRatings_Response)(nil),                     // 17: steam.CCommunity_GetCommentThreadRatings_Response
	(*CCommunity_VerifyClanMembership_Request)(nil),                         // 18: steam.CCommunity_VerifyClanMembership_Request
	(*CCommunity_VerifyClanMembership_Response)(nil),                        // 19: steam.CCommunity_VerifyClanMembership_Response
	(*CCommunity_RateClanAnnouncement_Request)(nil),                         // 20: steam.CCommunity_RateClanAnnouncement_Request
	(*CCommunity_RateClanAnnouncement_Response)(nil),                        // 21: steam.CCommunity_RateClanAnnouncement_Response
	(*CCommunity_GetClanAnnouncementVoteForUser_Request)(nil),               // 22: steam.CCommunity_GetClanAnnouncementVoteForUser_Request
	(*CCommunity_GetClanAnnouncementVoteForUser_Response)(nil),              // 23: steam.CCommunity_GetClanAnnouncementVoteForUser_Response
	(*CCommunity_GetClanMetadata_Request)(nil),                              // 24: steam.CCommunity_GetClanMetadata_Request
	(*CCommunity_GetClanMetadata_Response)(nil),                             // 25: steam.CCommunity_GetClanMetadata_Response
	(*CCommunity_GetClanLocGroupImages_Request)(nil),                        // 26: steam.CCommunity_GetClanLocGroupImages_Request
	(*CCommunity_ClanLocGroupImage)(nil),                                    // 27: steam.CCommunity_ClanLocGroupImage
	(*CCommunity_GetClanLocGroupImages_Response)(nil),                       // 28: steam.CCommunity_GetClanLocGroupImages_Response
	(*CCommunity_GetAvatarHistory_Request)(nil),                             // 29: steam.CCommunity_GetAvatarHistory_Request
	(*CCommunity_GetAvatarHistory_Response)(nil),                            // 30: steam.CCommunity_GetAvatarHistory_Response
	(*CCommunity_GetClanEventCrowdInMetadata_Request)(nil),                  // 31: steam.CCommunity_GetClanEventCrowdInMetadata_Request
	(*CCommunity_GetClanEventCrowdInMetadata_Response)(nil),                 // 32: steam.CCommunity_GetClanEventCrowdInMetadata_Response
	(*CCommunity_GetClanCrowdInMetadata_Request)(nil),                       // 33: steam.CCommunity_GetClanCrowdInMetadata_Request
	(*CCommunity_GetClanCrowdInMetadata_Response)(nil),                      // 34: steam.CCommunity_GetClanCrowdInMetadata_Response
	(*CCommunity_FetchTranslationFromCrowdIn_Request)(nil),                  // 35: steam.CCommunity_FetchTranslationFromCrowdIn_Request
	(*CCommunity_FetchTranslationFromCrowdIn_Response)(nil),                 // 36: steam.CCommunity_FetchTranslationFromCrowdIn_Response
	(*CCommunity_HideAndReportComment_Request)(nil),                         // 37: steam.CCommunity_HideAndReportComment_Request
	(*CCommunity_HideAndReportComment_Response)(nil),                        // 38: steam.CCommunity_HideAndReportComment_Response
	(*CAppPriority)(nil),                                                    // 39: steam.CAppPriority
	(*CCommunity_GetUserPartnerEventNews_Request)(nil),                      // 40: steam.CCommunity_GetUserPartnerEventNews_Request
	(*CCommunity_GetUserPartnerEventNews_Response)(nil),                     // 41: steam.CCommunity_GetUserPartnerEventNews_Response
	(*CCommunity_GetBestEventsForUser_Request)(nil),                         // 42: steam.CCommunity_GetBestEventsForUser_Request
	(*CCommunity_PartnerEventResult)(nil),                                   // 43: steam.CCommunity_PartnerEventResult
	(*CCommunity_GetBestEventsForUser_Response)(nil),                        // 44: steam.CCommunity_GetBestEventsForUser_Response
	(*CCommunity_MarkPartnerEventsForUser_Request)(nil),                     // 45: steam.CCommunity_MarkPartnerEventsForUser_Request
	(*CCommunity_MarkPartnerEventsForUser_Response)(nil),                    // 46: steam.CCommunity_MarkPartnerEventsForUser_Response
	(*CCommunity_GetUserPartnerEventViewStatus_Request)(nil),                // 47: steam.CCommunity_GetUserPartnerEventViewStatus_Request
	(*CCommunity_GetUserPartnerEventViewStatus_Response)(nil),               // 48: steam.CCommunity_GetUserPartnerEventViewStatus_Response
	(*CCommunity_PartnerEventsShowMoreForApp_Request)(nil),                  // 49: steam.CCommunity_PartnerEventsShowMoreForApp_Request
	(*CCommunity_PartnerEventsShowMoreForApp_Response)(nil),                 // 50: steam.CCommunity_PartnerEventsShowMoreForApp_Response
	(*CCommunity_PartnerEventsShowLessForApp_Request)(nil),                  // 51: steam.CCommunity_PartnerEventsShowLessForApp_Request
	(*CCommunity_PartnerEventsShowLessForApp_Response)(nil),                 // 52: steam.CCommunity_PartnerEventsShowLessForApp_Response
	(*CCommunity_ClearUserPartnerEventsAppPriorities_Request)(nil),          // 53: steam.CCommunity_ClearUserPartnerEventsAppPriorities_Request
	(*CCommunity_ClearUserPartnerEventsAppPriorities_Response)(nil),         // 54: steam.CCommunity_ClearUserPartnerEventsAppPriorities_Response
	(*CCommunity_GetUserPartnerEventsAppPriorities_Request)(nil),            // 55: steam.CCommunity_GetUserPartnerEventsAppPriorities_Request
	(*CCommunity_PartnerEventsAppPriority)(nil),                             // 56: steam.CCommunity_PartnerEventsAppPriority
	(*CCommunity_GetUserPartnerEventsAppPriorities_Response)(nil),           // 57: steam.CCommunity_GetUserPartnerEventsAppPriorities_Response
	(*CCommunity_ClearSinglePartnerEventsAppPriority_Request)(nil),          // 58: steam.CCommunity_ClearSinglePartnerEventsAppPriority_Request
	(*CCommunity_ClearSinglePartnerEventsAppPriority_Response)(nil),         // 59: steam.CCommunity_ClearSinglePartnerEventsAppPriority_Response
	(*CCommunity_SetRecommendationBotReviewStatus_Request)(nil),             // 60: steam.CCommunity_SetRecommendationBotReviewStatus_Request
	(*CCommunity_SetRecommendationBotReviewStatus_Response)(nil),            // 61: steam.CCommunity_SetRecommendationBotReviewStatus_Response
	(*CCommunity_GetAppRichPresenceLocalization_Response_Token)(nil),        // 62: steam.CCommunity_GetAppRichPresenceLocalization_Response.Token
	(*CCommunity_GetAppRichPresenceLocalization_Response_TokenList)(nil),    // 63: steam.CCommunity_GetAppRichPresenceLocalization_Response.TokenList
	(*CCommunity_Comment_Reaction)(nil),                                     // 64: steam.CCommunity_Comment.Reaction
	(*CCommunity_GetAvatarHistory_Response_AvatarData)(nil),                 // 65: steam.CCommunity_GetAvatarHistory_Response.AvatarData
	(*CCommunity_MarkPartnerEventsForUser_Request_PartnerEventMarking)(nil), // 66: steam.CCommunity_MarkPartnerEventsForUser_Request.PartnerEventMarking
	(*CCommunity_GetUserPartnerEventViewStatus_Response_PartnerEvent)(nil),  // 67: steam.CCommunity_GetUserPartnerEventViewStatus_Response.PartnerEvent
	(*CCommunity_SetRecommendationBotReviewStatus_Request_ReviewLabel)(nil), // 68: steam.CCommunity_SetRecommendationBotReviewStatus_Request.ReviewLabel
	(*CCDDBAppDetailCommon)(nil),                                            // 69: steam.CCDDBAppDetailCommon
	(ECommentThreadType)(0),                                                 // 70: steam.ECommentThreadType
	(*CMsgIPAddress)(nil),                                                   // 71: steam.CMsgIPAddress
	(ECommentDeleteReason)(0),                                               // 72: steam.ECommentDeleteReason
	(EContentReportReason)(0),                                               // 73: steam.EContentReportReason
	(EProtoClanEventType)(0),                                                // 74: steam.EProtoClanEventType
	(*CClanMatchEventByRange)(nil),                                          // 75: steam.CClanMatchEventByRange
}
var file_steammessages_community_steamclient_proto_depIdxs = []int32{
	69, // 0: steam.CCommunity_GetApps_Response.apps:type_name -> steam.CCDDBAppDetailCommon
	63, // 1: steam.CCommunity_GetAppRichPresenceLocalization_Response.token_lists:type_name -> steam.CCommunity_GetAppRichPresenceLocalization_Response.TokenList
	70, // 2: steam.CCommunity_GetCommentThread_Request.comment_thread_type:type_name -> steam.ECommentThreadType
	71, // 3: steam.CCommunity_Comment.ipaddress:type_name -> steam.CMsgIPAddress
	64, // 4: steam.CCommunity_Comment.reactions:type_name -> steam.CCommunity_Comment.Reaction
	72, // 5: steam.CCommunity_Comment.delete_reason:type_name -> steam.ECommentDeleteReason
	8,  // 6: steam.CCommunity_GetCommentThread_Response.comments:type_name -> steam.CCommunity_Comment
	8,  // 7: steam.CCommunity_GetCommentThread_Response.deleted_comments:type_name -> steam.CCommunity_Comment
	70, // 8: steam.CCommunity_PostCommentToThread_Request.comment_thread_type:type_name -> steam.ECommentThreadType
	70, // 9: steam.CCommunity_DeleteCommentFromThread_Request.comment_thread_type:type_name -> steam.ECommentThreadType
	0,  // 10: steam.CCommunity_GetClanLocGroupImages_Request.group:type_name -> steam.EClanImageGroup
	1,  // 11: steam.CCommunity_ClanLocGroupImage.file_type:type_name -> steam.EClanImageFileType
	0,  // 12: steam.CCommunity_ClanLocGroupImage.group:type_name -> steam.EClanImageGroup
	27, // 13: steam.CCommunity_GetClanLocGroupImages_Response.images:type_name -> steam.CCommunity_ClanLocGroupImage
	65, // 14: steam.CCommunity_GetAvatarHistory_Response.avatars:type_name -> steam.CCommunity_GetAvatarHistory_Response.AvatarData
	73, // 15: steam.CCommunity_HideAndReportComment_Request.report_reason:type_name -> steam.EContentReportReason
	74, // 16: steam.CCommunity_GetUserPartnerEventNews_Request.filter_event_type:type_name -> steam.EProtoClanEventType
	39, // 17: steam.CCommunity_GetUserPartnerEventNews_Request.app_list:type_name -> steam.CAppPriority
	75, // 18: steam.CCommunity_GetUserPartnerEventNews_Response.results:type_name -> steam.CClanMatchEventByRange
	43, // 19: steam.CCommunity_GetBestEventsForUser_Response.results:type_name -> steam.CCommunity_PartnerEventResult
	66, // 20: steam.CCommunity_MarkPartnerEventsForUser_Request.markings:type_name -> steam.CCommunity_MarkPartnerEventsForUser_Request.PartnerEventMarking
	67, // 21: steam.CCommunity_GetUserPartnerEventViewStatus_Response.events:type_name -> steam.CCommunity_GetUserPartnerEventViewStatus_Response.PartnerEvent
	56, // 22: steam.CCommunity_GetUserPartnerEventsAppPriorities_Response.priorities:type_name -> steam.CCommunity_PartnerEventsAppPriority
	68, // 23: steam.CCommunity_SetRecommendationBotReviewStatus_Request.review_labels:type_name -> steam.CCommunity_SetRecommendationBotReviewStatus_Request.ReviewLabel
	62, // 24: steam.CCommunity_GetAppRichPresenceLocalization_Response.TokenList.tokens:type_name -> steam.CCommunity_GetAppRichPresenceLocalization_Response.Token
	2,  // 25: steam.CCommunity_MarkPartnerEventsForUser_Request.PartnerEventMarking.display_location:type_name -> steam.EPartnerEventDisplayLocation
	3,  // 26: steam.Community.GetApps:input_type -> steam.CCommunity_GetApps_Request
	5,  // 27: steam.Community.GetAppRichPresenceLocalization:input_type -> steam.CCommunity_GetAppRichPresenceLocalization_Request
	7,  // 28: steam.Community.GetCommentThread:input_type -> steam.CCommunity_GetCommentThread_Request
	10, // 29: steam.Community.PostCommentToThread:input_type -> steam.CCommunity_PostCommentToThread_Request
	12, // 30: steam.Community.DeleteCommentFromThread:input_type -> steam.CCommunity_DeleteCommentFromThread_Request
	14, // 31: steam.Community.RateCommentThread:input_type -> steam.CCommunity_RateCommentThread_Request
	16, // 32: steam.Community.GetCommentThreadRatings:input_type -> steam.CCommunity_GetCommentThreadRatings_Request
	18, // 33: steam.Community.VerifyClanMembership:input_type -> steam.CCommunity_VerifyClanMembership_Request
	20, // 34: steam.Community.RateClanAnnouncement:input_type -> steam.CCommunity_RateClanAnnouncement_Request
	22, // 35: steam.Community.GetClanAnnouncementVoteForUser:input_type -> steam.CCommunity_GetClanAnnouncementVoteForUser_Request
	24, // 36: steam.Community.GetClanMetadata:input_type -> steam.CCommunity_GetClanMetadata_Request
	26, // 37: steam.Community.GetClanLocGroupImages:input_type -> steam.CCommunity_GetClanLocGroupImages_Request
	29, // 38: steam.Community.GetAvatarHistory:input_type -> steam.CCommunity_GetAvatarHistory_Request
	31, // 39: steam.Community.GetClanEventCrowdInMetadata:input_type -> steam.CCommunity_GetClanEventCrowdInMetadata_Request
	33, // 40: steam.Community.GetClanCrowdInMetadata:input_type -> steam.CCommunity_GetClanCrowdInMetadata_Request
	35, // 41: steam.Community.FetchTranslationFromCrowdIn:input_type -> steam.CCommunity_FetchTranslationFromCrowdIn_Request
	37, // 42: steam.Community.HideAndReportComment:input_type -> steam.CCommunity_HideAndReportComment_Request
	40, // 43: steam.Community.GetUserPartnerEventNews:input_type -> steam.CCommunity_GetUserPartnerEventNews_Request
	42, // 44: steam.Community.GetBestEventsForUser:input_type -> steam.CCommunity_GetBestEventsForUser_Request
	45, // 45: steam.Community.MarkPartnerEventsForUser:input_type -> steam.CCommunity_MarkPartnerEventsForUser_Request
	47, // 46: steam.Community.GetUserPartnerEventViewStatus:input_type -> steam.CCommunity_GetUserPartnerEventViewStatus_Request
	49, // 47: steam.Community.PartnerEventsShowMoreForApp:input_type -> steam.CCommunity_PartnerEventsShowMoreForApp_Request
	51, // 48: steam.Community.PartnerEventsShowLessForApp:input_type -> steam.CCommunity_PartnerEventsShowLessForApp_Request
	53, // 49: steam.Community.ClearUserPartnerEventsAppPriorities:input_type -> steam.CCommunity_ClearUserPartnerEventsAppPriorities_Request
	55, // 50: steam.Community.GetUserPartnerEventsAppPriorities:input_type -> steam.CCommunity_GetUserPartnerEventsAppPriorities_Request
	58, // 51: steam.Community.ClearSinglePartnerEventsAppPriority:input_type -> steam.CCommunity_ClearSinglePartnerEventsAppPriority_Request
	60, // 52: steam.Community.SetRecommendationBotReviewStatus:input_type -> steam.CCommunity_SetRecommendationBotReviewStatus_Request
	4,  // 53: steam.Community.GetApps:output_type -> steam.CCommunity_GetApps_Response
	6,  // 54: steam.Community.GetAppRichPresenceLocalization:output_type -> steam.CCommunity_GetAppRichPresenceLocalization_Response
	9,  // 55: steam.Community.GetCommentThread:output_type -> steam.CCommunity_GetCommentThread_Response
	11, // 56: steam.Community.PostCommentToThread:output_type -> steam.CCommunity_PostCommentToThread_Response
	13, // 57: steam.Community.DeleteCommentFromThread:output_type -> steam.CCommunity_DeleteCommentFromThread_Response
	15, // 58: steam.Community.RateCommentThread:output_type -> steam.CCommunity_RateCommentThread_Response
	17, // 59: steam.Community.GetCommentThreadRatings:output_type -> steam.CCommunity_GetCommentThreadRatings_Response
	19, // 60: steam.Community.VerifyClanMembership:output_type -> steam.CCommunity_VerifyClanMembership_Response
	21, // 61: steam.Community.RateClanAnnouncement:output_type -> steam.CCommunity_RateClanAnnouncement_Response
	23, // 62: steam.Community.GetClanAnnouncementVoteForUser:output_type -> steam.CCommunity_GetClanAnnouncementVoteForUser_Response
	25, // 63: steam.Community.GetClanMetadata:output_type -> steam.CCommunity_GetClanMetadata_Response
	28, // 64: steam.Community.GetClanLocGroupImages:output_type -> steam.CCommunity_GetClanLocGroupImages_Response
	30, // 65: steam.Community.GetAvatarHistory:output_type -> steam.CCommunity_GetAvatarHistory_Response
	32, // 66: steam.Community.GetClanEventCrowdInMetadata:output_type -> steam.CCommunity_GetClanEventCrowdInMetadata_Response
	34, // 67: steam.Community.GetClanCrowdInMetadata:output_type -> steam.CCommunity_GetClanCrowdInMetadata_Response
	36, // 68: steam.Community.FetchTranslationFromCrowdIn:output_type -> steam.CCommunity_FetchTranslationFromCrowdIn_Response
	38, // 69: steam.Community.HideAndReportComment:output_type -> steam.CCommunity_HideAndReportComment_Response
	41, // 70: steam.Community.GetUserPartnerEventNews:output_type -> steam.CCommunity_GetUserPartnerEventNews_Response
	44, // 71: steam.Community.GetBestEventsForUser:output_type -> steam.CCommunity_GetBestEventsForUser_Response
	46, // 72: steam.Community.MarkPartnerEventsForUser:output_type -> steam.CCommunity_MarkPartnerEventsForUser_Response
	48, // 73: steam.Community.GetUserPartnerEventViewStatus:output_type -> steam.CCommunity_GetUserPartnerEventViewStatus_Response
	50, // 74: steam.Community.PartnerEventsShowMoreForApp:output_type -> steam.CCommunity_PartnerEventsShowMoreForApp_Response
	52, // 75: steam.Community.PartnerEventsShowLessForApp:output_type -> steam.CCommunity_PartnerEventsShowLessForApp_Response
	54, // 76: steam.Community.ClearUserPartnerEventsAppPriorities:output_type -> steam.CCommunity_ClearUserPartnerEventsAppPriorities_Response
	57, // 77: steam.Community.GetUserPartnerEventsAppPriorities:output_type -> steam.CCommunity_GetUserPartnerEventsAppPriorities_Response
	59, // 78: steam.Community.ClearSinglePartnerEventsAppPriority:output_type -> steam.CCommunity_ClearSinglePartnerEventsAppPriority_Response
	61, // 79: steam.Community.SetRecommendationBotReviewStatus:output_type -> steam.CCommunity_SetRecommendationBotReviewStatus_Response
