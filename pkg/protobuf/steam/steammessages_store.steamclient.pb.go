...
type CStore_GetDiscoveryQueue_Request struct {
	state                 protoimpl.MessageState        `protogen:"open.v1"`
	QueueType             *EStoreDiscoveryQueueType     `protobuf:"varint,1,opt,name=queue_type,json=queueType,enum=steam.EStoreDiscoveryQueueType,def=0" json:"queue_type,omitempty"`
...
type CStore_GetUserGameInterestState_Response struct {
	...
	InQueues            []EStoreDiscoveryQueueType                          `protobuf:"varint,5,rep,name=in_queues,json=inQueues,enum=steam.EStoreDiscoveryQueueType" json:"in_queues,omitempty"`
	QueuesWithSkip      []EStoreDiscoveryQueueType                          `protobuf:"varint,6,rep,name=queues_with_skip,json=queuesWithSkip,enum=steam.EStoreDiscoveryQueueType" json:"queues_with_skip,omitempty"`
	...
	BetaStatus          *EPlaytestStatus                                    `protobuf:"varint,12,opt,name=beta_status,json=betaStatus,enum=steam.EPlaytestStatus,def=0" json:"beta_status,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type CStore_GetDiscoveryQueueSkippedApps_Request struct {
	state           protoimpl.MessageState    `protogen:"open.v1"`
	Steamid         *uint64                   `protobuf:"fixed64,1,opt,name=steamid" json:"steamid,omitempty"`
	QueueType       *EStoreDiscoveryQueueType `protobuf:"varint,2,opt,name=queue_type,json=queueType,enum=steam.EStoreDiscoveryQueueType,def=0" json:"queue_type,omitempty"`
	StorePageFilter *CStorePageFilter         `protobuf:"bytes,3,opt,name=store_page_filter,json=storePageFilter" json:"store_page_filter,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type CStore_ReportApp_Request struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Appid         *uint32                `protobuf:"varint,1,opt,name=appid" json:"appid,omitempty"`
	ReportType    *EAppReportType        `protobuf:"varint,2,opt,name=report_type,json=reportType,enum=steam.EAppReportType,def=0" json:"report_type,omitempty"`
...
type CStore_UserPreferences struct {
	...
	ProvideDeckFeedback                          *EProvideDeckFeedbackPreference    `protobuf:"varint,12,opt,name=provide_deck_feedback,json=provideDeckFeedback,enum=steam.EProvideDeckFeedbackPreference,def=0" json:"provide_deck_feedback,omitempty"`
	...
	GameFrameRateReporting                       *EGameFrameRateReportingPreference `protobuf:"varint,14,opt,name=game_frame_rate_reporting,json=gameFrameRateReporting,enum=steam.EGameFrameRateReportingPreference,def=0" json:"game_frame_rate_reporting,omitempty"`
...
type CStore_MigratePartnerLinkTracking_Notification struct {
	...
	BackfillSource *EPartnerLinkTrackingBackfillSource `protobuf:"varint,3,opt,name=backfill_source,json=backfillSource,enum=steam.EPartnerLinkTrackingBackfillSource,def=0" json:"backfill_source,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type CSteamDeckCompatibility_SetFeedback_Request struct {
	state           protoimpl.MessageState           `protogen:"open.v1"`
	Appid           *uint32                          `protobuf:"varint,1,opt,name=appid" json:"appid,omitempty"`
	Feedback        *ESteamDeckCompatibilityFeedback `protobuf:"varint,2,opt,name=feedback,enum=steam.ESteamDeckCompatibilityFeedback,def=0" json:"feedback,omitempty"`
...
type CSteamDeckCompatibility_ShouldPrompt_Response struct {
	...
	ExistingFeedback *ESteamDeckCompatibilityFeedback `protobuf:"varint,3,opt,name=existing_feedback,json=existingFeedback,enum=steam.ESteamDeckCompatibilityFeedback,def=0" json:"existing_feedback,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type CStore_GetUserGameInterestState_Response_InQueue struct {
	state              protoimpl.MessageState    `protogen:"open.v1"`
	Type               *EStoreDiscoveryQueueType `protobuf:"varint,1,opt,name=type,enum=steam.EStoreDiscoveryQueueType,def=0" json:"type,omitempty"`
...
const file_steammessages_store_steamclient_proto_rawDesc = "" +
	"\n" +
	"%steammessages_store.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\x1a\x11contenthubs.proto\x1a+steammessages_storebrowse.steamclient.proto\x1a\venums.proto\"\xa9\x01\n" +
	...
	"\x16is_request_from_client\x18\x03 \x01(\bR\x13isRequestFromClient\"\xb4\x06\n" +
	...
	"errorAppid\x12I\n" +
	"\n" +
	"line_items\x18\x12 \x03(\v2*.steam.CStore_PurchaseReceiptInfo.LineItemR\tlineItems\x1ar\n" +
	"\bLineItem\x12\x1c\n" +
	"\tpackageid\x18\x01 \x01(\rR\tpackageid\x12\x14\n" +
	"\x05appid\x18\x02 \x01(\rR\x05appid\x122\n" +
	"\x15line_item_description\x18\x03 \x01(\tR\x13lineItemDescription\"\xae\x01\n" +
	"\x1dCStore_RegisterCDKey_Response\x126\n" +
	"\x17purchase_result_details\x18\x01 \x01(\x05R\x15purchaseResultDetails\x12U\n" +
	"\x15purchase_receipt_info\x18\x02 \x01(\v2!.steam.CStore_PurchaseReceiptInfoR\x13purchaseReceiptInfo\"\x93\x01\n" +
	...
	"\x10favor_rarer_tags\x18\x04 \x01(\bR\x0efavorRarerTags\"\xbe\x01\n" +
	")CStore_GetRecommendedTagsForUser_Response\x12H\n" +
	"\x04tags\x18\x01 \x03(\v24.steam.CStore_GetRecommendedTagsForUser_Response.TagR\x04tags\x1aG\n" +
	"\x03Tag\x12\x14\n" +
	...
	"\blanguage\x18\x01 \x01(\tR\blanguage\"\x98\x01\n" +
	"\"CStore_GetMostPopularTags_Response\x12A\n" +
	"\x04tags\x18\x01 \x03(\v2-.steam.CStore_GetMostPopularTags_Response.TagR\x04tags\x1a/\n" +
	"\x03Tag\x12\x14\n" +
	"\x05tagid\x18\x01 \x01(\rR\x05tagid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"\\\n" +
	"&CStore_GetLocalizedNameForTags_Request\x12\x1a\n" +
	"\blanguage\x18\x01 \x01(\tR\blanguage\x12\x16\n" +
	"\x06tagids\x18\x02 \x03(\rR\x06tagids\"\xee\x01\n" +
	"'CStore_GetLocalizedNameForTags_Response\x12F\n" +
	"\x04tags\x18\x01 \x03(\v22.steam.CStore_GetLocalizedNameForTags_Response.TagR\x04tags\x1a{\n" +
	"\x03Tag\x12\x14\n" +
	...
	"\x11have_version_hash\x18\x02 \x01(\tR\x0fhaveVersionHash\"\xab\x01\n" +
	"\x1aCStore_GetTagList_Response\x12!\n" +
	"\fversion_hash\x18\x01 \x01(\tR\vversionHash\x129\n" +
	"\x04tags\x18\x02 \x03(\v2%.steam.CStore_GetTagList_Response.TagR\x04tags\x1a/\n" +
	"\x03Tag\x12\x14\n" +
	"\x05tagid\x18\x01 \x01(\rR\x05tagid\x12\x12\n" +
	...
	"\x0ffeatured_tagids\x18\x10 \x03(\rR\x0efeaturedTagids\"\xfc\x05\n" +
	" CStore_GetDiscoveryQueue_Request\x12]\n" +
	"\n" +
	"queue_type\x18\x01 \x01(\x0e2\x1f.steam.EStoreDiscoveryQueueType:\x1dk_EStoreDiscoveryQueueTypeNewR\tqueueType\x12!\n" +
	"\fcountry_code\x18\x02 \x01(\tR\vcountryCode\x12#\n" +
	"\rrebuild_queue\x18\x03 \x01(\bR\frebuildQueue\x12)\n" +
	"\x10settings_changed\x18\x04 \x01(\bR\x0fsettingsChanged\x12?\n" +
	"\bsettings\x18\x05 \x01(\v2#.steam.CStoreDiscoveryQueueSettingsR\bsettings\x123\n" +
	...
	"\x14debug_get_solr_query\x18\v \x01(\bR\x11debugGetSolrQuery\x12C\n" +
	"\x11store_page_filter\x18\f \x01(\v2\x17.steam.CStorePageFilterR\x0fstorePageFilter\x123\n" +
	"\acontext\x18\r \x01(\v2\x19.steam.StoreBrowseContextR\acontext\x12D\n" +
	"\fdata_request\x18\x0e \x01(\v2!.steam.StoreBrowseItemDataRequestR\vdataRequest\"\xe5\x02\n" +
	"!CStore_GetDiscoveryQueue_Response\x12\x16\n" +
	"\x06appids\x18\x01 \x03(\rR\x06appids\x12!\n" +
	"\fcountry_code\x18\x02 \x01(\tR\vcountryCode\x12?\n" +
	"\bsettings\x18\x03 \x01(\v2#.steam.CStoreDiscoveryQueueSettingsR\bsettings\x12\x18\n" +
	...
	"\x10debug_solr_query\x18\a \x01(\tR\x0edebugSolrQuery\x121\n" +
	"\vstore_items\x18\b \x03(\v2\x10.steam.StoreItemR\n" +
	"storeItems\"\xce\x01\n" +
	"(CStore_GetDiscoveryQueueSettings_Request\x12]\n" +
	"\n" +
	"queue_type\x18\x01 \x01(\x0e2\x1f.steam.EStoreDiscoveryQueueType:\x1dk_EStoreDiscoveryQueueTypeNewR\tqueueType\x12C\n" +
	"\x11store_page_filter\x18\x02 \x01(\v2\x17.steam.CStorePageFilterR\x0fstorePageFilter\"\x8f\x01\n" +
	")CStore_GetDiscoveryQueueSettings_Response\x12!\n" +
	"\fcountry_code\x18\x01 \x01(\tR\vcountryCode\x12?\n" +
	"\bsettings\x18\x02 \x01(\v2#.steam.CStoreDiscoveryQueueSettingsR\bsettings\"\xe1\x01\n" +
	"%CStore_SkipDiscoveryQueueItem_Request\x12]\n" +
	"\n" +
	"queue_type\x18\x01 \x01(\x0e2\x1f.steam.EStoreDiscoveryQueueType:\x1dk_EStoreDiscoveryQueueTypeNewR\tqueueType\x12\x14\n" +
	"\x05appid\x18\x02 \x01(\rR\x05appid\x12C\n" +
	"\x11store_page_filter\x18\x03 \x01(\v2\x17.steam.CStorePageFilterR\x0fstorePageFilter\"(\n" +
	...
	"storeAppid\x12\x1d\n" +
	"\n" +
	"beta_appid\x18\x03 \x01(\rR\tbetaAppid\"\xec\x06\n" +
	...
	"\tin_queues\x18\x05 \x03(\x0e2\x1f.steam.EStoreDiscoveryQueueTypeR\binQueues\x12I\n" +
	"\x10queues_with_skip\x18\x06 \x03(\x0e2\x1f.steam.EStoreDiscoveryQueueTypeR\x0equeuesWithSkip\x122\n" +
	...
	"\x11temporarily_owned\x18\t \x01(\bR\x10temporarilyOwned\x12O\n" +
	"\x06queues\x18\n" +
	" \x03(\v27.steam.CStore_GetUserGameInterestState_Response.InQueueR\x06queues\x12%\n" +
	"\x0eignored_reason\x18\v \x01(\x05R\rignoredReason\x12L\n" +
	"\vbeta_status\x18\f \x01(\x0e2\x16.steam.EPlaytestStatus:\x13k_ETesterStatusNoneR\n" +
	"betaStatus\x1a\xf0\x01\n" +
	"\aInQueue\x12R\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1f.steam.EStoreDiscoveryQueueType:\x1dk_EStoreDiscoveryQueueTypeNewR\x04type\x12\x18\n" +
	...
	"\x13followed_game_count\x18\x01 \x01(\rR\x11followedGameCount\"\xeb\x01\n" +
	"+CStore_GetDiscoveryQueueSkippedApps_Request\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12]\n" +
	"\n" +
	"queue_type\x18\x02 \x01(\x0e2\x1f.steam.EStoreDiscoveryQueueType:\x1dk_EStoreDiscoveryQueueTypeNewR\tqueueType\x12C\n" +
	"\x11store_page_filter\x18\x03 \x01(\v2\x17.steam.CStorePageFilterR\x0fstorePageFilter\"F\n" +
	",CStore_GetDiscoveryQueueSkippedApps_Response\x12\x16\n" +
	"\x06appids\x18\x01 \x03(\rR\x06appids\"\x9a\x01\n" +
	"\x18CStore_ReportApp_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12P\n" +
	"\vreport_type\x18\x02 \x01(\x0e2\x15.steam.EAppReportType:\x18k_EAppReportType_InvalidR\n" +
	"reportType\x12\x16\n" +
	"\x06report\x18\x03 \x01(\tR\x06report\"\x1b\n" +
	"\x19CStore_ReportApp_Response\"G\n" +
	"\"CStore_GetStorePreferences_Request\x12!\n" +
	"\fcountry_code\x18\x01 \x01(\tR\vcountryCode\"\xea\a\n" +
	...
	" \x01(\x0e2!.steam.EUserReviewScorePreference:\"k_EUserReviewScorePreference_UnsetR\x15reviewScorePreference\x12f\n" +
	"0timestamp_content_descriptor_preferences_updated\x18\v \x01(\x05R,timestampContentDescriptorPreferencesUpdated\x12\x81\x01\n" +
	"\x15provide_deck_feedback\x18\f \x01(\x0e2%.steam.EProvideDeckFeedbackPreference:&k_EProvideDeckFeedbackPreference_UnsetR\x13provideDeckFeedback\x121\n" +
	"\x14additional_languages\x18\r \x01(\tR\x13additionalLanguages\x12\x8e\x01\n" +
	"\x19game_frame_rate_reporting\x18\x0e \x01(\x0e2(.steam.EGameFrameRateReportingPreference:)k_EGameFrameRateReportingPreference_UnsetR\x16gameFrameRateReporting\x123\n" +
	"\x15disable_microtrailers\x18\x0f \x01(\bR\x14disableMicrotrailers\x12<\n" +
	"\x1adisable_animated_marketing\x18\x10 \x01(\bR\x18disableAnimatedMarketing\"\xc3\x01\n" +
	"\x19CStore_UserTagPreferences\x12L\n" +
	"\x0ftags_to_exclude\x18\x01 \x03(\v2$.steam.CStore_UserTagPreferences.TagR\rtagsToExclude\x1aX\n" +
	"\x03Tag\x12\x14\n" +
	"\x05tagid\x18\x01 \x01(\rR\x05tagid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12'\n" +
	"\x0ftimestamp_added\x18\x03 \x01(\rR\x0etimestampAdded\"\xa0\x02\n" +
	"#CStore_GetStorePreferences_Response\x12?\n" +
	"\vpreferences\x18\x01 \x01(\v2\x1d.steam.CStore_UserPreferencesR\vpreferences\x12I\n" +
	"\x0ftag_preferences\x18\x02 \x01(\v2 .steam.CStore_UserTagPreferencesR\x0etagPreferences\x12m\n" +
	"\x1econtent_descriptor_preferences\x18\x03 \x01(\v2'.steam.UserContentDescriptorPreferencesR\x1ccontentDescriptorPreferences\"o\n" +
	"*CStore_GetTrendingAppsAmongFriends_Request\x12\x19\n" +
	"\bnum_apps\x18\x01 \x01(\rR\anumApps\x12&\n" +
	"\x0fnum_top_friends\x18\x02 \x01(\rR\rnumTopFriends\"\x96\x02\n" +
	"+CStore_GetTrendingAppsAmongFriends_Response\x12g\n" +
	"\rtrending_apps\x18\x01 \x03(\v2B.steam.CStore_GetTrendingAppsAmongFriends_Response.TrendingAppDataR\ftrendingApps\x1a~\n" +
	...
	"\rtotal_friends\x18\x03 \x01(\rR\ftotalFriends\"\xeb\x01\n" +
	".CStore_MigratePartnerLinkTracking_Notification\x12\x1c\n" +
	"\taccountid\x18\x01 \x01(\rR\taccountid\x12\x1c\n" +
	"\tbrowserid\x18\x02 \x01(\x04R\tbrowserid\x12}\n" +
	"\x0fbackfill_source\x18\x03 \x01(\x0e2).steam.EPartnerLinkTrackingBackfillSource:)k_EPartnerLinkTrackingBackfillSource_NoneR\x0ebackfillSource\"\xb1\x01\n" +
	...
	")CStore_UpdatePackageReservations_Response\x12O\n" +
	"\x12reservation_status\x18\x01 \x03(\v2 .steam.CPackageReservationStatusR\x11reservationStatus\"\x8c\x01\n" +
	...
	"\rrtime_created\x18\a \x01(\rR\frtimeCreated\"n\n" +
	",CStore_SetReservationPositionMessage_Request\x12>\n" +
	"\bsettings\x18\x01 \x03(\v2\".steam.CReservationPositionMessageR\bsettings\"/\n" +
	...
	"0CStore_GetAllReservationPositionMessages_Request\"s\n" +
	"1CStore_GetAllReservationPositionMessages_Response\x12>\n" +
	"\bsettings\x18\x01 \x03(\v2\".steam.CReservationPositionMessageR\bsettings\":\n" +
	"8CStore_ReloadAllReservationPositionMessages_Notification\"\xdb\x01\n" +
	"+CSteamDeckCompatibility_SetFeedback_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12k\n" +
	"\bfeedback\x18\x02 \x01(\x0e2&.steam.ESteamDeckCompatibilityFeedback:'k_ESteamDeckCompatibilityFeedback_UnsetR\bfeedback\x12)\n" +
	...
	"\x05appid\x18\x01 \x01(\rR\x05appid\"\xf2\x01\n" +
	"-CSteamDeckCompatibility_ShouldPrompt_Response\x12\x16\n" +
	"\x06prompt\x18\x01 \x01(\bR\x06prompt\x12+\n" +
	"\x11feedback_eligible\x18\x02 \x01(\bR\x10feedbackEligible\x12|\n" +
	"\x11existing_feedback\x18\x03 \x01(\x0e2&.steam.ESteamDeckCompatibilityFeedback:'k_ESteamDeckCompatibilityFeedback_UnsetR\x10existingFeedback\"\xa8\x02\n" +
	"+CStore_StorePreferencesChanged_Notification\x12?\n" +
	"\vpreferences\x18\x01 \x01(\v2\x1d.steam.CStore_UserPreferencesR\vpreferences\x12I\n" +
	"\x0ftag_preferences\x18\x02 \x01(\v2 .steam.CStore_UserTagPreferencesR\x0etagPreferences\x12m\n" +
	"\x1econtent_descriptor_preferences\x18\x03 \x01(\v2'.steam.UserContentDescriptorPreferencesR\x1ccontentDescriptorPreferences*\xd6\x05\n" +
	...
	",k_EPartnerLinkTrackingBackfillSource_Desktop\x10\x032\xe7\x17\n" +
	"\x05Store\x12Z\n" +
	"\rRegisterCDKey\x12#.steam.CStore_RegisterCDKey_Request\x1a$.steam.CStore_RegisterCDKey_Response\x12~\n" +
	"\x19GetRecommendedTagsForUser\x12/.steam.CStore_GetRecommendedTagsForUser_Request\x1a0.steam.CStore_GetRecommendedTagsForUser_Response\x12i\n" +
	"\x12GetMostPopularTags\x12(.steam.CStore_GetMostPopularTags_Request\x1a).steam.CStore_GetMostPopularTags_Response\x12x\n" +
	"\x17GetLocalizedNameForTags\x12-.steam.CStore_GetLocalizedNameForTags_Request\x1a..steam.CStore_GetLocalizedNameForTags_Response\x12Q\n" +
	"\n" +
	"GetTagList\x12 .steam.CStore_GetTagList_Request\x1a!.steam.CStore_GetTagList_Response\x12f\n" +
	"\x11GetDiscoveryQueue\x12'.steam.CStore_GetDiscoveryQueue_Request\x1a(.steam.CStore_GetDiscoveryQueue_Response\x12~\n" +
	"\x19GetDiscoveryQueueSettings\x12/.steam.CStore_GetDiscoveryQueueSettings_Request\x1a0.steam.CStore_GetDiscoveryQueueSettings_Response\x12u\n" +
	"\x16SkipDiscoveryQueueItem\x12,.steam.CStore_SkipDiscoveryQueueItem_Request\x1a-.steam.CStore_SkipDiscoveryQueueItem_Response\x12{\n" +
	"\x18GetUserGameInterestState\x12..steam.CStore_GetUserGameInterestState_Request\x1a/.steam.CStore_GetUserGameInterestState_Response\x12c\n" +
	"\x10GetGamesFollowed\x12&.steam.CStore_GetGamesFollowed_Request\x1a'.steam.CStore_GetGamesFollowed_Response\x12r\n" +
	"\x15GetGamesFollowedCount\x12+.steam.CStore_GetGamesFollowedCount_Request\x1a,.steam.CStore_GetGamesFollowedCount_Response\x12\x87\x01\n" +
	"\x1cGetDiscoveryQueueSkippedApps\x122.steam.CStore_GetDiscoveryQueueSkippedApps_Request\x1a3.steam.CStore_GetDiscoveryQueueSkippedApps_Response\x12N\n" +
	"\tReportApp\x12\x1f.steam.CStore_ReportApp_Request\x1a .steam.CStore_ReportApp_Response\x12l\n" +
	"\x13GetStorePreferences\x12).steam.CStore_GetStorePreferences_Request\x1a*.steam.CStore_GetStorePreferences_Response\x12\x84\x01\n" +
	"\x1bGetTrendingAppsAmongFriends\x121.steam.CStore_GetTrendingAppsAmongFriends_Request\x1a2.steam.CStore_GetTrendingAppsAmongFriends_Response\x12f\n" +
	"\x1aMigratePartnerLinkTracking\x125.steam.CStore_MigratePartnerLinkTracking_Notification\x1a\x11.steam.NoResponse\x12~\n" +
	"\x19UpdatePackageReservations\x12/.steam.CStore_UpdatePackageReservations_Request\x1a0.steam.CStore_UpdatePackageReservations_Response\x12\x81\x01\n" +
	"\x1aGetWishlistDemoEmailStatus\x120.steam.CStore_GetWishlistDemoEmailStatus_Request\x1a1.steam.CStore_GetWishlistDemoEmailStatus_Response\x12\x87\x01\n" +
	"\x1cQueueWishlistDemoEmailToFire\x122.steam.CStore_QueueWishlistDemoEmailToFire_Request\x1a3.steam.CStore_QueueWishlistDemoEmailToFire_Response\x12\x8a\x01\n" +
	"\x1dSetReservationPositionMessage\x123.steam.CStore_SetReservationPositionMessage_Request\x1a4.steam.CStore_SetReservationPositionMessage_Response\x12\x93\x01\n" +
	" DeleteReservationPositionMessage\x126.steam.CStore_DeleteReservationPositionMessage_Request\x1a7.steam.CStore_DeleteReservationPositionMessage_Response\x12\x96\x01\n" +
	"!GetAllReservationPositionMessages\x127.steam.CStore_GetAllReservationPositionMessages_Request\x1a8.steam.CStore_GetAllReservationPositionMessages_Response\x12z\n" +
	"$ReloadAllReservationPositionMessages\x12?.steam.CStore_ReloadAllReservationPositionMessages_Notification\x1a\x11.steam.NoResponse\x12\x83\x01\n" +
	"\x18SetCompatibilityFeedback\x122.steam.CSteamDeckCompatibility_SetFeedback_Request\x1a3.steam.CSteamDeckCompatibility_SetFeedback_Response\x12\x91\x01\n" +
	"$ShouldPromptForCompatibilityFeedback\x123.steam.CSteamDeckCompatibility_ShouldPrompt_Request\x1a4.steam.CSteamDeckCompatibility_ShouldPrompt_Response2{\n" +
	"\vStoreClient\x12f\n" +
	"\x1dNotifyStorePreferencesChanged\x122.steam.CStore_StorePreferencesChanged_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x02B3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_store_steamclient_proto_goTypes = []any{
	(EStoreDiscoveryQueueType)(0),                                       // 0: steam.EStoreDiscoveryQueueType
	(EPlaytestStatus)(0),                                                // 1: steam.EPlaytestStatus
	(EAppReportType)(0),                                                 // 2: steam.EAppReportType
	(EUserReviewScorePreference)(0),                                     // 3: steam.EUserReviewScorePreference
	(EPartnerLinkTrackingBackfillSource)(0),                             // 4: steam.EPartnerLinkTrackingBackfillSource
	(*CStore_RegisterCDKey_Request)(nil),                                // 5: steam.CStore_RegisterCDKey_Request
	(*CStore_PurchaseReceiptInfo)(nil),                                  // 6: steam.CStore_PurchaseReceiptInfo
	(*CStore_RegisterCDKey_Response)(nil),                               // 7: steam.CStore_RegisterCDKey_Response
	(*CStore_GetRecommendedTagsForUser_Request)(nil),                    // 8: steam.CStore_GetRecommendedTagsForUser_Request
	(*CStore_GetRecommendedTagsForUser_Response)(nil),                   // 9: steam.CStore_GetRecommendedTagsForUser_Response
	(*CStore_GetMostPopularTags_Request)(nil),                           // 10: steam.CStore_GetMostPopularTags_Request
	(*CStore_GetMostPopularTags_Response)(nil),                          // 11: steam.CStore_GetMostPopularTags_Response
	(*CStore_GetLocalizedNameForTags_Request)(nil),                      // 12: steam.CStore_GetLocalizedNameForTags_Request
	(*CStore_GetLocalizedNameForTags_Response)(nil),                     // 13: steam.CStore_GetLocalizedNameForTags_Response
	(*CStore_GetTagList_Request)(nil),                                   // 14: steam.CStore_GetTagList_Request
	(*CStore_GetTagList_Response)(nil),                                  // 15: steam.CStore_GetTagList_Response
	(*CStoreDiscoveryQueueSettings)(nil),                                // 16: steam.CStoreDiscoveryQueueSettings
	(*CStore_GetDiscoveryQueue_Request)(nil),                            // 17: steam.CStore_GetDiscoveryQueue_Request
	(*CStore_GetDiscoveryQueue_Response)(nil),                           // 18: steam.CStore_GetDiscoveryQueue_Response
	(*CStore_GetDiscoveryQueueSettings_Request)(nil),                    // 19: steam.CStore_GetDiscoveryQueueSettings_Request
	(*CStore_GetDiscoveryQueueSettings_Response)(nil),                   // 20: steam.CStore_GetDiscoveryQueueSettings_Response
	(*CStore_SkipDiscoveryQueueItem_Request)(nil),                       // 21: steam.CStore_SkipDiscoveryQueueItem_Request
	(*CStore_SkipDiscoveryQueueItem_Response)(nil),                      // 22: steam.CStore_SkipDiscoveryQueueItem_Response
	(*CStore_GetUserGameInterestState_Request)(nil),                     // 23: steam.CStore_GetUserGameInterestState_Request
	(*CStore_GetUserGameInterestState_Response)(nil),                    // 24: steam.CStore_GetUserGameInterestState_Response
	(*CStore_GetGamesFollowed_Request)(nil),                             // 25: steam.CStore_GetGamesFollowed_Request
	(*CStore_GetGamesFollowed_Response)(nil),                            // 26: steam.CStore_GetGamesFollowed_Response
	(*CStore_GetGamesFollowedCount_Request)(nil),                        // 27: steam.CStore_GetGamesFollowedCount_Request
	(*CStore_GetGamesFollowedCount_Response)(nil),                       // 28: steam.CStore_GetGamesFollowedCount_Response
	(*CStore_GetDiscoveryQueueSkippedApps_Request)(nil),                 // 29: steam.CStore_GetDiscoveryQueueSkippedApps_Request
	(*CStore_GetDiscoveryQueueSkippedApps_Response)(nil),                // 30: steam.CStore_GetDiscoveryQueueSkippedApps_Response
	(*CStore_ReportApp_Request)(nil),                                    // 31: steam.CStore_ReportApp_Request
	(*CStore_ReportApp_Response)(nil),                                   // 32: steam.CStore_ReportApp_Response
	(*CStore_GetStorePreferences_Request)(nil),                          // 33: steam.CStore_GetStorePreferences_Request
	(*CStore_UserPreferences)(nil),                                      // 34: steam.CStore_UserPreferences
	(*CStore_UserTagPreferences)(nil),                                   // 35: steam.CStore_UserTagPreferences
	(*CStore_GetStorePreferences_Response)(nil),                         // 36: steam.CStore_GetStorePreferences_Response
	(*CStore_GetTrendingAppsAmongFriends_Request)(nil),                  // 37: steam.CStore_GetTrendingAppsAmongFriends_Request
	(*CStore_GetTrendingAppsAmongFriends_Response)(nil),                 // 38: steam.CStore_GetTrendingAppsAmongFriends_Response
	(*CStore_MigratePartnerLinkTracking_Notification)(nil),              // 39: steam.CStore_MigratePartnerLinkTracking_Notification
	(*CStore_UpdatePackageReservations_Request)(nil),                    // 40: steam.CStore_UpdatePackageReservations_Request
	(*CStore_UpdatePackageReservations_Response)(nil),                   // 41: steam.CStore_UpdatePackageReservations_Response
	(*CStore_GetWishlistDemoEmailStatus_Request)(nil),                   // 42: steam.CStore_GetWishlistDemoEmailStatus_Request
	(*CStore_GetWishlistDemoEmailStatus_Response)(nil),                  // 43: steam.CStore_GetWishlistDemoEmailStatus_Response
	(*CStore_QueueWishlistDemoEmailToFire_Request)(nil),                 // 44: steam.CStore_QueueWishlistDemoEmailToFire_Request
	(*CStore_QueueWishlistDemoEmailToFire_Response)(nil),                // 45: steam.CStore_QueueWishlistDemoEmailToFire_Response
	(*CReservationPositionMessage)(nil),                                 // 46: steam.CReservationPositionMessage
	(*CStore_SetReservationPositionMessage_Request)(nil),                // 47: steam.CStore_SetReservationPositionMessage_Request
	(*CStore_SetReservationPositionMessage_Response)(nil),               // 48: steam.CStore_SetReservationPositionMessage_Response
	(*CStore_DeleteReservationPositionMessage_Request)(nil),             // 49: steam.CStore_DeleteReservationPositionMessage_Request
	(*CStore_DeleteReservationPositionMessage_Response)(nil),            // 50: steam.CStore_DeleteReservationPositionMessage_Response
	(*CStore_GetAllReservationPositionMessages_Request)(nil),            // 51: steam.CStore_GetAllReservationPositionMessages_Request
	(*CStore_GetAllReservationPositionMessages_Response)(nil),           // 52: steam.CStore_GetAllReservationPositionMessages_Response
	(*CStore_ReloadAllReservationPositionMessages_Notification)(nil),    // 53: steam.CStore_ReloadAllReservationPositionMessages_Notification
	(*CSteamDeckCompatibility_SetFeedback_Request)(nil),                 // 54: steam.CSteamDeckCompatibility_SetFeedback_Request
	(*CSteamDeckCompatibility_SetFeedback_Response)(nil),                // 55: steam.CSteamDeckCompatibility_SetFeedback_Response
	(*CSteamDeckCompatibility_ShouldPrompt_Request)(nil),                // 56: steam.CSteamDeckCompatibility_ShouldPrompt_Request
	(*CSteamDeckCompatibility_ShouldPrompt_Response)(nil),               // 57: steam.CSteamDeckCompatibility_ShouldPrompt_Response
	(*CStore_StorePreferencesChanged_Notification)(nil),                 // 58: steam.CStore_StorePreferencesChanged_Notification
	(*CStore_PurchaseReceiptInfo_LineItem)(nil),                         // 59: steam.CStore_PurchaseReceiptInfo.LineItem
	(*CStore_GetRecommendedTagsForUser_Response_Tag)(nil),               // 60: steam.CStore_GetRecommendedTagsForUser_Response.Tag
	(*CStore_GetMostPopularTags_Response_Tag)(nil),                      // 61: steam.CStore_GetMostPopularTags_Response.Tag
	(*CStore_GetLocalizedNameForTags_Response_Tag)(nil),                 // 62: steam.CStore_GetLocalizedNameForTags_Response.Tag
	(*CStore_GetTagList_Response_Tag)(nil),                              // 63: steam.CStore_GetTagList_Response.Tag
	(*CStore_GetUserGameInterestState_Response_InQueue)(nil),            // 64: steam.CStore_GetUserGameInterestState_Response.InQueue
	(*CStore_UserTagPreferences_Tag)(nil),                               // 65: steam.CStore_UserTagPreferences.Tag
	(*CStore_GetTrendingAppsAmongFriends_Response_TrendingAppData)(nil), // 66: steam.CStore_GetTrendingAppsAmongFriends_Response.TrendingAppData
	(*CStorePageFilter)(nil),                                            // 67: steam.CStorePageFilter
	(*StoreBrowseContext)(nil),                                          // 68: steam.StoreBrowseContext
	(*StoreBrowseItemDataRequest)(nil),                                  // 69: steam.StoreBrowseItemDataRequest
	(*StoreItem)(nil),                                                   // 70: steam.StoreItem
	(EProvideDeckFeedbackPreference)(0),                                 // 71: steam.EProvideDeckFeedbackPreference
	(EGameFrameRateReportingPreference)(0),                              // 72: steam.EGameFrameRateReportingPreference
	(*UserContentDescriptorPreferences)(nil),                            // 73: steam.UserContentDescriptorPreferences
	(*CPackageReservationStatus)(nil),                                   // 74: steam.CPackageReservationStatus
	(ESteamDeckCompatibilityFeedback)(0),                                // 75: steam.ESteamDeckCompatibilityFeedback
	(*NoResponse)(nil),                                                  // 76: steam.NoResponse
}
var file_steammessages_store_steamclient_proto_depIdxs = []int32{
	59, // 0: steam.CStore_PurchaseReceiptInfo.line_items:type_name -> steam.CStore_PurchaseReceiptInfo.LineItem
	6,  // 1: steam.CStore_RegisterCDKey_Response.purchase_receipt_info:type_name -> steam.CStore_PurchaseReceiptInfo
	60, // 2: steam.CStore_GetRecommendedTagsForUser_Response.tags:type_name -> steam.CStore_GetRecommendedTagsForUser_Response.Tag
	61, // 3: steam.CStore_GetMostPopularTags_Response.tags:type_name -> steam.CStore_GetMostPopularTags_Response.Tag
	62, // 4: steam.CStore_GetLocalizedNameForTags_Response.tags:type_name -> steam.CStore_GetLocalizedNameForTags_Response.Tag
	63, // 5: steam.CStore_GetTagList_Response.tags:type_name -> steam.CStore_GetTagList_Response.Tag
	0,  // 6: steam.CStore_GetDiscoveryQueue_Request.queue_type:type_name -> steam.EStoreDiscoveryQueueType
	16, // 7: steam.CStore_GetDiscoveryQueue_Request.settings:type_name -> steam.CStoreDiscoveryQueueSettings
	67, // 8: steam.CStore_GetDiscoveryQueue_Request.store_page_filter:type_name -> steam.CStorePageFilter
	68, // 9: steam.CStore_GetDiscoveryQueue_Request.context:type_name -> steam.StoreBrowseContext
	69, // 10: steam.CStore_GetDiscoveryQueue_Request.data_request:type_name -> steam.StoreBrowseItemDataRequest
	16, // 11: steam.CStore_GetDiscoveryQueue_Response.settings:type_name -> steam.CStoreDiscoveryQueueSettings
	70, // 12: steam.CStore_GetDiscoveryQueue_Response.store_items:type_name -> steam.StoreItem
	0,  // 13: steam.CStore_GetDiscoveryQueueSettings_Request.queue_type:type_name -> steam.EStoreDiscoveryQueueType
	67, // 14: steam.CStore_GetDiscoveryQueueSettings_Request.store_page_filter:type_name -> steam.CStorePageFilter
	16, // 15: steam.CStore_GetDiscoveryQueueSettings_Response.settings:type_name -> steam.CStoreDiscoveryQueueSettings
	0,  // 16: steam.CStore_SkipDiscoveryQueueItem_Request.queue_type:type_name -> steam.EStoreDiscoveryQueueType
	67, // 17: steam.CStore_SkipDiscoveryQueueItem_Request.store_page_filter:type_name -> steam.CStorePageFilter
	0,  // 18: steam.CStore_GetUserGameInterestState_Response.in_queues:type_name -> steam.EStoreDiscoveryQueueType
	0,  // 19: steam.CStore_GetUserGameInterestState_Response.queues_with_skip:type_name -> steam.EStoreDiscoveryQueueType
	64, // 20: steam.CStore_GetUserGameInterestState_Response.queues:type_name -> steam.CStore_GetUserGameInterestState_Response.InQueue
	1,  // 21: steam.CStore_GetUserGameInterestState_Response.beta_status:type_name -> steam.EPlaytestStatus
	0,  // 22: steam.CStore_GetDiscoveryQueueSkippedApps_Request.queue_type:type_name -> steam.EStoreDiscoveryQueueType
	67, // 23: steam.CStore_GetDiscoveryQueueSkippedApps_Request.store_page_filter:type_name -> steam.CStorePageFilter
	2,  // 24: steam.CStore_ReportApp_Request.report_type:type_name -> steam.EAppReportType
	3,  // 25: steam.CStore_UserPreferences.review_score_preference:type_name -> steam.EUserReviewScorePreference
	71, // 26: steam.CStore_UserPreferences.provide_deck_feedback:type_name -> steam.EProvideDeckFeedbackPreference
	72, // 27: steam.CStore_UserPreferences.game_frame_rate_reporting:type_name -> steam.EGameFrameRateReportingPreference
	65, // 28: steam.CStore_UserTagPreferences.tags_to_exclude:type_name -> steam.CStore_UserTagPreferences.Tag
	34, // 29: steam.CStore_GetStorePreferences_Response.preferences:type_name -> steam.CStore_UserPreferences
	35, // 30: steam.CStore_GetStorePreferences_Response.tag_preferences:type_name -> steam.CStore_UserTagPreferences
	73, // 31: steam.CStore_GetStorePreferences_Response.content_descriptor_preferences:type_name -> steam.UserContentDescriptorPreferences
	66, // 32: steam.CStore_GetTrendingAppsAmongFriends_Response.trending_apps:type_name -> steam.CStore_GetTrendingAppsAmongFriends_Response.TrendingAppData
	4,  // 33: steam.CStore_MigratePartnerLinkTracking_Notification.backfill_source:type_name -> steam.EPartnerLinkTrackingBackfillSource
	74, // 34: steam.CStore_UpdatePackageReservations_Response.reservation_status:type_name -> steam.CPackageReservationStatus
	46, // 35: steam.CStore_SetReservationPositionMessage_Request.settings:type_name -> steam.CReservationPositionMessage
	46, // 36: steam.CStore_GetAllReservationPositionMessages_Response.settings:type_name -> steam.CReservationPositionMessage
	75, // 37: steam.CSteamDeckCompatibility_SetFeedback_Request.feedback:type_name -> steam.ESteamDeckCompatibilityFeedback
	75, // 38: steam.CSteamDeckCompatibility_ShouldPrompt_Response.existing_feedback:type_name -> steam.ESteamDeckCompatibilityFeedback
	34, // 39: steam.CStore_StorePreferencesChanged_Notification.preferences:type_name -> steam.CStore_UserPreferences
	35, // 40: steam.CStore_StorePreferencesChanged_Notification.tag_preferences:type_name -> steam.CStore_UserTagPreferences
	73, // 41: steam.CStore_StorePreferencesChanged_Notification.content_descriptor_preferences:type_name -> steam.UserContentDescriptorPreferences
	0,  // 42: steam.CStore_GetUserGameInterestState_Response.InQueue.type:type_name -> steam.EStoreDiscoveryQueueType
	5,  // 43: steam.Store.RegisterCDKey:input_type -> steam.CStore_RegisterCDKey_Request
	8,  // 44: steam.Store.GetRecommendedTagsForUser:input_type -> steam.CStore_GetRecommendedTagsForUser_Request
	10, // 45: steam.Store.GetMostPopularTags:input_type -> steam.CStore_GetMostPopularTags_Request
	12, // 46: steam.Store.GetLocalizedNameForTags:input_type -> steam.CStore_GetLocalizedNameForTags_Request
	14, // 47: steam.Store.GetTagList:input_type -> steam.CStore_GetTagList_Request
	17, // 48: steam.Store.GetDiscoveryQueue:input_type -> steam.CStore_GetDiscoveryQueue_Request
	19, // 49: steam.Store.GetDiscoveryQueueSettings:input_type -> steam.CStore_GetDiscoveryQueueSettings_Request
	21, // 50: steam.Store.SkipDiscoveryQueueItem:input_type -> steam.CStore_SkipDiscoveryQueueItem_Request
	23, // 51: steam.Store.GetUserGameInterestState:input_type -> steam.CStore_GetUserGameInterestState_Request
	25, // 52: steam.Store.GetGamesFollowed:input_type -> steam.CStore_GetGamesFollowed_Request
	27, // 53: steam.Store.GetGamesFollowedCount:input_type -> steam.CStore_GetGamesFollowedCount_Request
	29, // 54: steam.Store.GetDiscoveryQueueSkippedApps:input_type -> steam.CStore_GetDiscoveryQueueSkippedApps_Request
	31, // 55: steam.Store.ReportApp:input_type -> steam.CStore_ReportApp_Request
	33, // 56: steam.Store.GetStorePreferences:input_type -> steam.CStore_GetStorePreferences_Request
	37, // 57: steam.Store.GetTrendingAppsAmongFriends:input_type -> steam.CStore_GetTrendingAppsAmongFriends_Request
	39, // 58: steam.Store.MigratePartnerLinkTracking:input_type -> steam.CStore_MigratePartnerLinkTracking_Notification
	40, // 59: steam.Store.UpdatePackageReservations:input_type -> steam.CStore_UpdatePackageReservations_Request
	42, // 60: steam.Store.GetWishlistDemoEmailStatus:input_type -> steam.CStore_GetWishlistDemoEmailStatus_Request
	44, // 61: steam.Store.QueueWishlistDemoEmailToFire:input_type -> steam.CStore_QueueWishlistDemoEmailToFire_Request
	47, // 62: steam.Store.SetReservationPositionMessage:input_type -> steam.CStore_SetReservationPositionMessage_Request
	49, // 63: steam.Store.DeleteReservationPositionMessage:input_type -> steam.CStore_DeleteReservationPositionMessage_Request
	51, // 64: steam.Store.GetAllReservationPositionMessages:input_type -> steam.CStore_GetAllReservationPositionMessages_Request
	53, // 65: steam.Store.ReloadAllReservationPositionMessages:input_type -> steam.CStore_ReloadAllReservationPositionMessages_Notification
	54, // 66: steam.Store.SetCompatibilityFeedback:input_type -> steam.CSteamDeckCompatibility_SetFeedback_Request
	56, // 67: steam.Store.ShouldPromptForCompatibilityFeedback:input_type -> steam.CSteamDeckCompatibility_ShouldPrompt_Request
	58, // 68: steam.StoreClient.NotifyStorePreferencesChanged:input_type -> steam.CStore_StorePreferencesChanged_Notification
	7,  // 69: steam.Store.RegisterCDKey:output_type -> steam.CStore_RegisterCDKey_Response
	9,  // 70: steam.Store.GetRecommendedTagsForUser:output_type -> steam.CStore_GetRecommendedTagsForUser_Response
	11, // 71: steam.Store.GetMostPopularTags:output_type -> steam.CStore_GetMostPopularTags_Response
	13, // 72: steam.Store.GetLocalizedNameForTags:output_type -> steam.CStore_GetLocalizedNameForTags_Response
	15, // 73: steam.Store.GetTagList:output_type -> steam.CStore_GetTagList_Response
	18, // 74: steam.Store.GetDiscoveryQueue:output_type -> steam.CStore_GetDiscoveryQueue_Response
	20, // 75: steam.Store.GetDiscoveryQueueSettings:output_type -> steam.CStore_GetDiscoveryQueueSettings_Response
	22, // 76: steam.Store.SkipDiscoveryQueueItem:output_type -> steam.CStore_SkipDiscoveryQueueItem_Response
	24, // 77: steam.Store.GetUserGameInterestState:output_type -> steam.CStore_GetUserGameInterestState_Response
	26, // 78: steam.Store.GetGamesFollowed:output_type -> steam.CStore_GetGamesFollowed_Response
	28, // 79: steam.Store.GetGamesFollowedCount:output_type -> steam.CStore_GetGamesFollowedCount_Response
	30, // 80: steam.Store.GetDiscoveryQueueSkippedApps:output_type -> steam.CStore_GetDiscoveryQueueSkippedApps_Response
	32, // 81: steam.Store.ReportApp:output_type -> steam.CStore_ReportApp_Response
	36, // 82: steam.Store.GetStorePreferences:output_type -> steam.CStore_GetStorePreferences_Response
	38, // 83: steam.Store.GetTrendingAppsAmongFriends:output_type -> steam.CStore_GetTrendingAppsAmongFriends_Response
	76, // 84: steam.Store.MigratePartnerLinkTracking:output_type -> steam.NoResponse
	41, // 85: steam.Store.UpdatePackageReservations:output_type -> steam.CStore_UpdatePackageReservations_Response
	43, // 86: steam.Store.GetWishlistDemoEmailStatus:output_type -> steam.CStore_GetWishlistDemoEmailStatus_Response
	45, // 87: steam.Store.QueueWishlistDemoEmailToFire:output_type -> steam.CStore_QueueWishlistDemoEmailToFire_Response
	48, // 88: steam.Store.SetReservationPositionMessage:output_type -> steam.CStore_SetReservationPositionMessage_Response
	50, // 89: steam.Store.DeleteReservationPositionMessage:output_type -> steam.CStore_DeleteReservationPositionMessage_Response
	52, // 90: steam.Store.GetAllReservationPositionMessages:output_type -> steam.CStore_GetAllReservationPositionMessages_Response
	76, // 91: steam.Store.ReloadAllReservationPositionMessages:output_type -> steam.NoResponse
	55, // 92: steam.Store.SetCompatibilityFeedback:output_type -> steam.CSteamDeckCompatibility_SetFeedback_Response
	57, // 93: steam.Store.ShouldPromptForCompatibilityFeedback:output_type -> steam.CSteamDeckCompatibility_ShouldPrompt_Response
	76, // 94: steam.StoreClient.NotifyStorePreferencesChanged:output_type -> steam.NoResponse
