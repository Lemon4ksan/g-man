...
type ContentDeltaChunks struct {
	...
	ChunkDataLocation *EContentDeltaChunkDataLocation  `protobuf:"varint,5,opt,name=chunk_data_location,json=chunkDataLocation,enum=steam.EContentDeltaChunkDataLocation,def=0" json:"chunk_data_location,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
const file_content_manifest_proto_rawDesc = "" +
	"\n" +
	"\x16content_manifest.proto\x12\x05steam\"\xf6\x03\n" +
	"\x16ContentManifestPayload\x12E\n" +
	"\bmappings\x18\x01 \x03(\v2).steam.ContentManifestPayload.FileMappingR\bmappings\x1a\x94\x03\n" +
	...
	"shaContent\x12K\n" +
	"\x06chunks\x18\x06 \x03(\v23.steam.ContentManifestPayload.FileMapping.ChunkDataR\x06chunks\x12\x1e\n" +
	"\n" +
	...
	"\tsignature\x18\x01 \x01(\fR\tsignature\"\xa1\x04\n" +
	"\x12ContentDeltaChunks\x12\x19\n" +
	"\bdepot_id\x18\x01 \x01(\rR\adepotId\x12,\n" +
	"\x12manifest_id_source\x18\x02 \x01(\x04R\x10manifestIdSource\x12,\n" +
	"\x12manifest_id_target\x18\x03 \x01(\x04R\x10manifestIdTarget\x12F\n" +
	"\vdeltaChunks\x18\x04 \x03(\v2$.steam.ContentDeltaChunks.DeltaChunkR\vdeltaChunks\x12\x81\x01\n" +
	"\x13chunk_data_location\x18\x05 \x01(\x0e2%.steam.EContentDeltaChunkDataLocation:*k_EContentDeltaChunkDataLocationInProtobufR\x11chunkDataLocation\x1a\xc7\x01\n" +
	"\n" +
	"DeltaChunk\x12\x1d\n" +
	"\n" +
	...
	"-k_EContentDeltaChunkDataLocationAfterProtobuf\x10\x01B5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_content_manifest_proto_goTypes = []any{
	(EContentDeltaChunkDataLocation)(0),                  // 0: steam.EContentDeltaChunkDataLocation
	(*ContentManifestPayload)(nil),                       // 1: steam.ContentManifestPayload
	(*ContentManifestMetadata)(nil),                      // 2: steam.ContentManifestMetadata
	(*ContentManifestSignature)(nil),                     // 3: steam.ContentManifestSignature
	(*ContentDeltaChunks)(nil),                           // 4: steam.ContentDeltaChunks
	(*ContentManifestPayload_FileMapping)(nil),           // 5: steam.ContentManifestPayload.FileMapping
	(*ContentManifestPayload_FileMapping_ChunkData)(nil), // 6: steam.ContentManifestPayload.FileMapping.ChunkData
	(*ContentDeltaChunks_DeltaChunk)(nil),                // 7: steam.ContentDeltaChunks.DeltaChunk
}
var file_content_manifest_proto_depIdxs = []int32{
	5, // 0: steam.ContentManifestPayload.mappings:type_name -> steam.ContentManifestPayload.FileMapping
	7, // 1: steam.ContentDeltaChunks.deltaChunks:type_name -> steam.ContentDeltaChunks.DeltaChunk
	0, // 2: steam.ContentDeltaChunks.chunk_data_location:type_name -> steam.EContentDeltaChunkDataLocation
	6, // 3: steam.ContentManifestPayload.FileMapping.chunks:type_name -> steam.ContentManifestPayload.FileMapping.ChunkData
