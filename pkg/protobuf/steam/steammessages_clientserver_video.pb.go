...
const file_steammessages_clientserver_video_proto_rawDesc = "" +
	"\n" +
	"&steammessages_clientserver_video.proto\x12\x05steam\x1a\x18steammessages_base.proto\"\xe5\x03\n" +
	...
	" \x01(\rR\x12audioChannelConfig\x12I\n" +
	"\fsegment_info\x18\v \x03(\v2&.steam.CVideo_GameRecordingSegmentInfoR\vsegmentInfo\"\xfb\x01\n" +
	...
	"\tfile_type\x18\x04 \x01(\tR\bfileType\x12U\n" +
	"\x0frepresentations\x18\x05 \x03(\v2+.steam.CMsgVideoGameRecordingRepresentationR\x0frepresentations\"\xb3\x03\n" +
	...
	"\x10segment_duration\x18\x06 \x01(\rR\x0fsegmentDuration\x12F\n" +
	"\n" +
	"components\x18\a \x03(\v2&.steam.CMsgVideoGameRecordingComponentR\n" +
	"components\x12\"\n" +
	...
	"\x13representation_name\x18\x04 \x01(\tR\x12representationName\"\xe1\x02\n" +
	"%CVideo_GameRecordingSegmentUploadInfo\x12I\n" +
	"\fsegment_info\x18\x01 \x01(\v2&.steam.CVideo_GameRecordingSegmentInfoR\vsegmentInfo\x12\x19\n" +
	"\burl_host\x18\x02 \x01(\tR\aurlHost\x12\x19\n" +
	"\burl_path\x18\x03 \x01(\tR\aurlPath\x12\x1b\n" +
	"\tuse_https\x18\x04 \x01(\bR\buseHttps\x12a\n" +
	"\x0frequest_headers\x18\x05 \x03(\v28.steam.CVideo_GameRecordingSegmentUploadInfo.HTTPHeadersR\x0erequestHeaders\x1a7\n" +
	"\vHTTPHeaders\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05valueB5H\x01Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x00"
...
var file_steammessages_clientserver_video_proto_goTypes = []any{
	(*CMsgVideoGameRecordingRepresentation)(nil),              // 0: steam.CMsgVideoGameRecordingRepresentation
	(*CMsgVideoGameRecordingComponent)(nil),                   // 1: steam.CMsgVideoGameRecordingComponent
	(*CMsgVideoGameRecordingDef)(nil),                         // 2: steam.CMsgVideoGameRecordingDef
	(*CVideo_GameRecordingSegmentInfo)(nil),                   // 3: steam.CVideo_GameRecordingSegmentInfo
	(*CVideo_GameRecordingSegmentUploadInfo)(nil),             // 4: steam.CVideo_GameRecordingSegmentUploadInfo
	(*CVideo_GameRecordingSegmentUploadInfo_HTTPHeaders)(nil), // 5: steam.CVideo_GameRecordingSegmentUploadInfo.HTTPHeaders
}
var file_steammessages_clientserver_video_proto_depIdxs = []int32{
	3, // 0: steam.CMsgVideoGameRecordingRepresentation.segment_info:type_name -> steam.CVideo_GameRecordingSegmentInfo
	0, // 1: steam.CMsgVideoGameRecordingComponent.representations:type_name -> steam.CMsgVideoGameRecordingRepresentation
	1, // 2: steam.CMsgVideoGameRecordingDef.components:type_name -> steam.CMsgVideoGameRecordingComponent
	3, // 3: steam.CVideo_GameRecordingSegmentUploadInfo.segment_info:type_name -> steam.CVideo_GameRecordingSegmentInfo
	5, // 4: steam.CVideo_GameRecordingSegmentUploadInfo.request_headers:type_name -> steam.CVideo_GameRecordingSegmentUploadInfo.HTTPHeaders
