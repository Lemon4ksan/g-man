...
type SteamNotificationData struct {
	...
	NotificationType    *ESteamNotificationType `protobuf:"varint,3,opt,name=notification_type,json=notificationType,enum=steam.ESteamNotificationType,def=0" json:"notification_type,omitempty"`
...
type SteamNotificationPreference struct {
	state               protoimpl.MessageState  `protogen:"open.v1"`
	NotificationType    *ESteamNotificationType `protobuf:"varint,1,opt,name=notification_type,json=notificationType,enum=steam.ESteamNotificationType,def=0" json:"notification_type,omitempty"`
	NotificationTargets *uint32                 `protobuf:"varint,2,opt,name=notification_targets,json=notificationTargets" json:"notification_targets,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
const file_steammessages_notifications_steamclient_proto_rawDesc = "" +
	"\n" +
	"-steammessages_notifications.steamclient.proto\x12\x05steam\x1a\x18steammessages_base.proto\x1a,steammessages_unified_base.steamclient.proto\"\xf8\x02\n" +
	"\x15SteamNotificationData\x12'\n" +
	"\x0fnotification_id\x18\x01 \x01(\x04R\x0enotificationId\x121\n" +
	"\x14notification_targets\x18\x02 \x01(\rR\x13notificationTargets\x12l\n" +
	"\x11notification_type\x18\x03 \x01(\x0e2\x1d.steam.ESteamNotificationType: k_ESteamNotificationType_InvalidR\x10notificationType\x12\x1b\n" +
	...
	"\x06viewed\x18\v \x01(\rR\x06viewed\"\x9a\x02\n" +
	"5CSteamNotification_NotificationsReceived_Notification\x12B\n" +
	"\rnotifications\x18\x01 \x03(\v2\x1c.steam.SteamNotificationDataR\rnotifications\x12,\n" +
	...
	"\x1bpending_family_invite_count\x18\x04 \x01(\rR\x18pendingFamilyInviteCount\"\xbe\x01\n" +
	"\x1bSteamNotificationPreference\x12l\n" +
	"\x11notification_type\x18\x01 \x01(\x0e2\x1d.steam.ESteamNotificationType: k_ESteamNotificationType_InvalidR\x10notificationType\x121\n" +
	"\x14notification_targets\x18\x02 \x01(\rR\x13notificationTargets\"z\n" +
	"2CSteamNotification_PreferencesUpdated_Notification\x12D\n" +
	"\vpreferences\x18\x01 \x03(\v2\".steam.SteamNotificationPreferenceR\vpreferences*\x80\v\n" +
	...
	".k_ESteamNotificationType_ReportedContentAction\x10\x1e2\xed\x01\n" +
	"\x17SteamNotificationClient\x12h\n" +
	"\x15NotificationsReceived\x12<.steam.CSteamNotification_NotificationsReceived_Notification\x1a\x11.steam.NoResponse\x12b\n" +
	"\x12PreferencesUpdated\x129.steam.CSteamNotification_PreferencesUpdated_Notification\x1a\x11.steam.NoResponse\x1a\x04\xc0\xb5\x18\x02B3Z.github.com/lemon4ksan/g-man/pkg/protobuf/steam\x80\x01\x01"
...
var file_steammessages_notifications_steamclient_proto_goTypes = []any{
	(ESteamNotificationType)(0),                                   // 0: steam.ESteamNotificationType
	(*SteamNotificationData)(nil),                                 // 1: steam.SteamNotificationData
	(*CSteamNotification_NotificationsReceived_Notification)(nil), // 2: steam.CSteamNotification_NotificationsReceived_Notification
	(*SteamNotificationPreference)(nil),                           // 3: steam.SteamNotificationPreference
	(*CSteamNotification_PreferencesUpdated_Notification)(nil),    // 4: steam.CSteamNotification_PreferencesUpdated_Notification
	(*NoResponse)(nil),                                            // 5: steam.NoResponse
}
var file_steammessages_notifications_steamclient_proto_depIdxs = []int32{
	0, // 0: steam.SteamNotificationData.notification_type:type_name -> steam.ESteamNotificationType
	1, // 1: steam.CSteamNotification_NotificationsReceived_Notification.notifications:type_name -> steam.SteamNotificationData
	0, // 2: steam.SteamNotificationPreference.notification_type:type_name -> steam.ESteamNotificationType
	3, // 3: steam.CSteamNotification_PreferencesUpdated_Notification.preferences:type_name -> steam.SteamNotificationPreference
	2, // 4: steam.SteamNotificationClient.NotificationsReceived:input_type -> steam.CSteamNotification_NotificationsReceived_Notification
	4, // 5: steam.SteamNotificationClient.PreferencesUpdated:input_type -> steam.CSteamNotification_PreferencesUpdated_Notification
	5, // 6: steam.SteamNotificationClient.NotificationsReceived:output_type -> steam.NoResponse
	5, // 7: steam.SteamNotificationClient.PreferencesUpdated:output_type -> steam.NoResponse
